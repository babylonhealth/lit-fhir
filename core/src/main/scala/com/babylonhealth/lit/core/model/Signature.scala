...
/** Base StructureDefinition for Signature Type: A signature along with supporting context. The signature may be a digital
  ...
  *   of the extension.
  * @param sigFormat
  *   - A mime type that indicates the technical format of the signature. Important mime types are application/signature+xml for
  *   X ML DigSig, application/jose for JWS, and image/\* for a graphical image of a signature, etc.
  * @param onBehalfOf
