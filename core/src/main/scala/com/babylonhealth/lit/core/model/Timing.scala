...
object Timing extends CompanionFor[Timing] {
  ...
  object Repeat extends CompanionFor[Repeat] {
    ...
    val bounds: FHIRComponentFieldMeta[Option[Repeat.BoundsChoice]] =
      FHIRComponentFieldMeta("bounds", lTagOf[Option[Repeat.BoundsChoice]], true, lTagOf[Union_0731860109])
      ...
      checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
        Try(
          new Repeat(
            ...
            cursor.decodeOptRef[Union_0731860109]("bounds"),
...
/** Base StructureDefinition for Timing Type: Specifies an event that may occur multiple times. Timing schedules are
  * used to record when things are planned, expected or requested to occur. The most common usage is in dosage
  * instructions for medications. They are also used when planning care of various kinds, and may be used for reporting
  ...
  *   interpret the Timing, with the exception that .repeat.bounds still applies over the code (and is not contained in
  *   the code).
  * @param event
