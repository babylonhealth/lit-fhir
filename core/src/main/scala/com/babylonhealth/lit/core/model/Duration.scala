...
object Duration extends CompanionFor[Duration] {
  implicit def summonObjectAndCompanionDuration_681834359(o: Duration): ObjectAndCompanion[Duration, Duration.type] =
  ...
  def apply(
=======
object Duration extends CompanionFor[Duration[_]] {
  override type ResourceType[T] = Duration[T]
  override val baseType: CompanionFor[ResourceType[_]] = Duration
  override val profileUrl: Option[String]              = Some("http://hl7.org/fhir/StructureDefinition/Duration")
...
>>>>>>> 1bcce413 (experimentations with a type param on the fhir classes to denote partial objects)
  ...
  ): Duration[Stage] = new Duration[Stage](
    id,
    unit,
    code,
    value,
...
<<<<<<< HEAD
  ...
  override def fields(t: Duration): Seq[FHIRComponentField[_]] = Seq(
...
=======
  ...
  override def fields[Stage <: LifecycleStage: ValueOf](t: Duration[Stage]): Seq[FHIRComponentField[Stage, _]] = Seq(
...
>>>>>>> 1bcce413 (experimentations with a type param on the fhir classes to denote partial objects)
  ...
  def extractId(t: Duration[_]): Option[String]                             = t.id
  def extractUnit(t: Duration[_]): Option[String]                           = t.unit
  def extractCode(t: Duration[_]): Option[Code]                             = t.code
  def extractValue(t: Duration[_]): Option[BigDecimal]                      = t.value
  def extractSystem(t: Duration[_]): Option[UriStr]                         = t.system
  def extractExtension[Stage](t: Duration[Stage]): LitSeq[Extension[Stage]] = t.extension
  def extractComparator(t: Duration[_]): Option[QUANTITY_COMPARATOR]        = t.comparator
  override val thisName: String                                             = "Duration"
  override val searchParams: Map[String, Duration[_] => Seq[Any]]           = Quantity.searchParams
  def unapply[Stage <: LifecycleStage: ValueOf](o: Duration[
  ...
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Duration[Completed.type]] =
...
/** Base StructureDefinition for Duration Type: A length of time.
  ...
  */
@POJOBoilerplate
class Duration[Stage <: LifecycleStage: ValueOf](
    ...
    override val primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
      ...
      primitiveAttributes = primitiveAttributes) {
  override val thisTypeName: String = "Duration"
}
