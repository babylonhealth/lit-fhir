...
/** Base StructureDefinition for Coding Type: A reference to a code defined by a terminology system.
  ...
  *   spaces.
  * @param code
  *   \- A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the
  *   coding system (e.g. post-coordination).
  * @param system
  *   \- The identification of the code system that defines the meaning of the symbol in the code.
  * @param version
  *   \- The version of the code system which was used when choosing this code. Note that a well-maintained code system does not
  *   need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be
