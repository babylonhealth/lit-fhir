...
sealed class LitSeq[+T] private[core] (protected val _contents: Array[Object])
...
final class NonEmptyLitSeq[+T] private[core] (override protected val _contents: Array[Object], wasChecked: Boolean)
