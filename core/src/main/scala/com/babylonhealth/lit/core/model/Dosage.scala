...
/** Base StructureDefinition for Dosage Type: Indicates how the medication is/was taken or should be taken by the
  * patient.
  *
  ...
  *   - Supplemental instructions to the patient on how to take the medication (e.g. "with meals" or"take half to one
  *   hour before food") or warnings for the patient about the medication (e.g. "may cause drowsiness" or "avoid
