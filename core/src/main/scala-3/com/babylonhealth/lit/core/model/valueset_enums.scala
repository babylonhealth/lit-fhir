...
enum ALL_TYPES(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ALLERGYINTOLERANCE extends ALL_TYPES("AllergyIntolerance", Some("AllergyIntolerance"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case APPOINTMENTRESPONSE extends ALL_TYPES("AppointmentResponse", Some("AppointmentResponse"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case BIOLOGICALLYDERIVEDPRODUCT extends ALL_TYPES("BiologicallyDerivedProduct", Some("BiologicallyDerivedProduct"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case CAPABILITYSTATEMENT extends ALL_TYPES("CapabilityStatement", Some("CapabilityStatement"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case CHARGEITEMDEFINITION extends ALL_TYPES("ChargeItemDefinition", Some("ChargeItemDefinition"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case CLINICALIMPRESSION extends ALL_TYPES("ClinicalImpression", Some("ClinicalImpression"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case COMMUNICATIONREQUEST extends ALL_TYPES("CommunicationRequest", Some("CommunicationRequest"), Some("http://hl7.org/fhir/resource-types"))
  case COMPARTMENTDEFINITION extends ALL_TYPES("CompartmentDefinition", Some("CompartmentDefinition"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case COVERAGEELIGIBILITYREQUEST extends ALL_TYPES("CoverageEligibilityRequest", Some("CoverageEligibilityRequest"), Some("http://hl7.org/fhir/resource-types"))
  case COVERAGEELIGIBILITYRESPONSE extends ALL_TYPES("CoverageEligibilityResponse", Some("CoverageEligibilityResponse"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case DEVICEDEFINITION extends ALL_TYPES("DeviceDefinition", Some("DeviceDefinition"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case DEVICEUSESTATEMENT extends ALL_TYPES("DeviceUseStatement", Some("DeviceUseStatement"), Some("http://hl7.org/fhir/resource-types"))
  case DIAGNOSTICREPORT extends ALL_TYPES("DiagnosticReport", Some("DiagnosticReport"), Some("http://hl7.org/fhir/resource-types"))
  case DISTANCE extends ALL_TYPES("Distance", Some("Distance"), Some("http://hl7.org/fhir/data-types"))
  case DOCUMENTMANIFEST extends ALL_TYPES("DocumentManifest", Some("DocumentManifest"), Some("http://hl7.org/fhir/resource-types"))
  case DOCUMENTREFERENCE extends ALL_TYPES("DocumentReference", Some("DocumentReference"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case EFFECTEVIDENCESYNTHESIS extends ALL_TYPES("EffectEvidenceSynthesis", Some("EffectEvidenceSynthesis"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case ENROLLMENTREQUEST extends ALL_TYPES("EnrollmentRequest", Some("EnrollmentRequest"), Some("http://hl7.org/fhir/resource-types"))
  case ENROLLMENTRESPONSE extends ALL_TYPES("EnrollmentResponse", Some("EnrollmentResponse"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case EVIDENCEVARIABLE extends ALL_TYPES("EvidenceVariable", Some("EvidenceVariable"), Some("http://hl7.org/fhir/resource-types"))
  case EXAMPLESCENARIO extends ALL_TYPES("ExampleScenario", Some("ExampleScenario"), Some("http://hl7.org/fhir/resource-types"))
  case EXPLANATIONOFBENEFIT extends ALL_TYPES("ExplanationOfBenefit", Some("ExplanationOfBenefit"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case FAMILYMEMBERHISTORY extends ALL_TYPES("FamilyMemberHistory", Some("FamilyMemberHistory"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case GUIDANCERESPONSE extends ALL_TYPES("GuidanceResponse", Some("GuidanceResponse"), Some("http://hl7.org/fhir/resource-types"))
  case HEALTHCARESERVICE extends ALL_TYPES("HealthcareService", Some("HealthcareService"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case IMMUNIZATIONEVALUATION extends ALL_TYPES("ImmunizationEvaluation", Some("ImmunizationEvaluation"), Some("http://hl7.org/fhir/resource-types"))
  case IMMUNIZATIONRECOMMENDATION extends ALL_TYPES("ImmunizationRecommendation", Some("ImmunizationRecommendation"), Some("http://hl7.org/fhir/resource-types"))
  case IMPLEMENTATIONGUIDE extends ALL_TYPES("ImplementationGuide", Some("ImplementationGuide"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case MEDICATIONADMINISTRATION extends ALL_TYPES("MedicationAdministration", Some("MedicationAdministration"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICATIONDISPENSE extends ALL_TYPES("MedicationDispense", Some("MedicationDispense"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICATIONKNOWLEDGE extends ALL_TYPES("MedicationKnowledge", Some("MedicationKnowledge"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICATIONREQUEST extends ALL_TYPES("MedicationRequest", Some("MedicationRequest"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICATIONSTATEMENT extends ALL_TYPES("MedicationStatement", Some("MedicationStatement"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICINALPRODUCT extends ALL_TYPES("MedicinalProduct", Some("MedicinalProduct"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICINALPRODUCTAUTHORIZATION extends ALL_TYPES("MedicinalProductAuthorization", Some("MedicinalProductAuthorization"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICINALPRODUCTCONTRAINDICATION extends ALL_TYPES("MedicinalProductContraindication", Some("MedicinalProductContraindication"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICINALPRODUCTINDICATION extends ALL_TYPES("MedicinalProductIndication", Some("MedicinalProductIndication"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICINALPRODUCTINGREDIENT extends ALL_TYPES("MedicinalProductIngredient", Some("MedicinalProductIngredient"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICINALPRODUCTINTERACTION extends ALL_TYPES("MedicinalProductInteraction", Some("MedicinalProductInteraction"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICINALPRODUCTMANUFACTURED extends ALL_TYPES("MedicinalProductManufactured", Some("MedicinalProductManufactured"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICINALPRODUCTPACKAGED extends ALL_TYPES("MedicinalProductPackaged", Some("MedicinalProductPackaged"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICINALPRODUCTPHARMACEUTICAL extends ALL_TYPES("MedicinalProductPharmaceutical", Some("MedicinalProductPharmaceutical"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICINALPRODUCTUNDESIRABLEEFFECT extends ALL_TYPES("MedicinalProductUndesirableEffect", Some("MedicinalProductUndesirableEffect"), Some("http://hl7.org/fhir/resource-types"))
  case MESSAGEDEFINITION extends ALL_TYPES("MessageDefinition", Some("MessageDefinition"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case MOLECULARSEQUENCE extends ALL_TYPES("MolecularSequence", Some("MolecularSequence"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case OBSERVATIONDEFINITION extends ALL_TYPES("ObservationDefinition", Some("ObservationDefinition"), Some("http://hl7.org/fhir/resource-types"))
  case OID extends ALL_TYPES("oid", Some("oid"), Some("http://hl7.org/fhir/data-types"))
  case OPERATIONDEFINITION extends ALL_TYPES("OperationDefinition", Some("OperationDefinition"), Some("http://hl7.org/fhir/resource-types"))
  case OPERATIONOUTCOME extends ALL_TYPES("OperationOutcome", Some("OperationOutcome"), Some("http://hl7.org/fhir/resource-types"))
  case ORGANIZATION extends ALL_TYPES("Organization", Some("Organization"), Some("http://hl7.org/fhir/resource-types"))
  case ORGANIZATIONAFFILIATION extends ALL_TYPES("OrganizationAffiliation", Some("OrganizationAffiliation"), Some("http://hl7.org/fhir/resource-types"))
  case PARAMETERDEFINITION extends ALL_TYPES("ParameterDefinition", Some("ParameterDefinition"), Some("http://hl7.org/fhir/data-types"))
  ...
  case PAYMENTRECONCILIATION extends ALL_TYPES("PaymentReconciliation", Some("PaymentReconciliation"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case PRACTITIONERROLE extends ALL_TYPES("PractitionerRole", Some("PractitionerRole"), Some("http://hl7.org/fhir/resource-types"))
  case PROCEDURE extends ALL_TYPES("Procedure", Some("Procedure"), Some("http://hl7.org/fhir/resource-types"))
  case PRODCHARACTERISTIC extends ALL_TYPES("ProdCharacteristic", Some("ProdCharacteristic"), Some("http://hl7.org/fhir/data-types"))
  ...
  case QUESTIONNAIRERESPONSE extends ALL_TYPES("QuestionnaireResponse", Some("QuestionnaireResponse"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case RESEARCHDEFINITION extends ALL_TYPES("ResearchDefinition", Some("ResearchDefinition"), Some("http://hl7.org/fhir/resource-types"))
  case RESEARCHELEMENTDEFINITION extends ALL_TYPES("ResearchElementDefinition", Some("ResearchElementDefinition"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case RISKEVIDENCESYNTHESIS extends ALL_TYPES("RiskEvidenceSynthesis", Some("RiskEvidenceSynthesis"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case SPECIMENDEFINITION extends ALL_TYPES("SpecimenDefinition", Some("SpecimenDefinition"), Some("http://hl7.org/fhir/resource-types"))
  case STRING extends ALL_TYPES("string", Some("string"), Some("http://hl7.org/fhir/data-types"))
  case STRUCTUREDEFINITION extends ALL_TYPES("StructureDefinition", Some("StructureDefinition"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case SUBSTANCENUCLEICACID extends ALL_TYPES("SubstanceNucleicAcid", Some("SubstanceNucleicAcid"), Some("http://hl7.org/fhir/resource-types"))
  case SUBSTANCEPOLYMER extends ALL_TYPES("SubstancePolymer", Some("SubstancePolymer"), Some("http://hl7.org/fhir/resource-types"))
  case SUBSTANCEPROTEIN extends ALL_TYPES("SubstanceProtein", Some("SubstanceProtein"), Some("http://hl7.org/fhir/resource-types"))
  case SUBSTANCEREFERENCEINFORMATION extends ALL_TYPES("SubstanceReferenceInformation", Some("SubstanceReferenceInformation"), Some("http://hl7.org/fhir/resource-types"))
  case SUBSTANCESOURCEMATERIAL extends ALL_TYPES("SubstanceSourceMaterial", Some("SubstanceSourceMaterial"), Some("http://hl7.org/fhir/resource-types"))
  case SUBSTANCESPECIFICATION extends ALL_TYPES("SubstanceSpecification", Some("SubstanceSpecification"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case TERMINOLOGYCAPABILITIES extends ALL_TYPES("TerminologyCapabilities", Some("TerminologyCapabilities"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case VERIFICATIONRESULT extends ALL_TYPES("VerificationResult", Some("VerificationResult"), Some("http://hl7.org/fhir/resource-types"))
  case VISIONPRESCRIPTION extends ALL_TYPES("VisionPrescription", Some("VisionPrescription"), Some("http://hl7.org/fhir/resource-types"))
...
enum RELATED_ARTIFACT_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case DOCUMENTATION extends RELATED_ARTIFACT_TYPE("documentation", Some("Documentation"), Some("http://hl7.org/fhir/related-artifact-type"))
  case JUSTIFICATION extends RELATED_ARTIFACT_TYPE("justification", Some("Justification"), Some("http://hl7.org/fhir/related-artifact-type"))
  case PREDECESSOR extends RELATED_ARTIFACT_TYPE("predecessor", Some("Predecessor"), Some("http://hl7.org/fhir/related-artifact-type"))
