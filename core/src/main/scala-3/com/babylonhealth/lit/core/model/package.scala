...
object UnionAliases {
  ...
  type UnionAll = Address | Age | Annotation | Attachment | Base64Binary | BigDecimal | Boolean | Canonical | Code |
    ...
    Duration | Expression | FHIRDate | FHIRDateTime | HumanName | Id | Identifier | Int | LocalTime | Long | Markdown | Meta |
    Money | OID | ParameterDefinition | Period | PositiveInt | Quantity | Range | Ratio | Reference | RelatedArtifact |
