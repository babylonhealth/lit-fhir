...
//import com.babylonhealth.lit.core.model.{ CodeableConcept, Coding, Observation, Period, Quantity, Timing }
//
//object SharedVals {
...
//}
//import com.babylonhealth.lit.core.SharedVals._
//
...
//  //  [error] Error while emitting com/babylonhealth/lit/core/ParseTest
//  //  [error] Method too large: com/babylonhealth/lit/core/ParseTest.<init> ()V
...
//  // C'est la vie.
//  def observations_pt1: Seq[Observation] = Seq(
//    new Observation(
//      meta = None,
