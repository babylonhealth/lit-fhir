...
public interface QICoreCareTeamOrBuilder
    extends
   ...
   * </code>
   */
  java.util.List<com.google.fhir.r4.qicore.QICoreCareTeam.Participant> getParticipantList();
  /**
   * <code>
   * repeated .google.fhir.r4.qicore.QICoreCareTeam.Participant participant = 17 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR, (.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())", (.google.fhir.proto.fhir_path_constraint) = "onBehalfOf.exists() implies (member.resolve() is Practitioner)"];
   * </code>
   ...
   * </code>
   */
  com.google.fhir.r4.qicore.QICoreCareTeam.ParticipantOrBuilder getParticipantOrBuilder(int index);
