...
public interface LinkageOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.fhir.r4.core.Linkage)
   ...
   * </code>
   */
  java.util.List<com.google.fhir.r4.core.Linkage.Item> getItemList();
  /**
   * <code>
   * repeated .google.fhir.r4.core.Linkage.Item item = 12 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];
   * </code>
   */
  com.google.fhir.r4.core.Linkage.Item getItem(int index);
  /**
   * <code>
   * repeated .google.fhir.r4.core.Linkage.Item item = 12 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];
   * </code>
   ...
   * </code>
   */
  java.util.List<? extends com.google.fhir.r4.core.Linkage.ItemOrBuilder> getItemOrBuilderList();
  /**
   * <code>
   * repeated .google.fhir.r4.core.Linkage.Item item = 12 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];
   * </code>
   */
  com.google.fhir.r4.core.Linkage.ItemOrBuilder getItemOrBuilder(int index);
}
