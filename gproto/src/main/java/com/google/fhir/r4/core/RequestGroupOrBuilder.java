...
public interface RequestGroupOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.fhir.r4.core.Reference replaces = 14 [(.google.fhir.proto.valid_reference_type) = "Resource"];</code>
   */
  java.util.List<com.google.fhir.r4.core.Reference> 
      getReplacesList();
  /**
  ...
  /**
   * <code>.google.fhir.r4.core.RequestGroup.StatusCode status = 16 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
  ...
  /**
   * <code>.google.fhir.r4.core.RequestGroup.IntentCode intent = 17 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   ...
   * </pre>
   *
   * <code>.google.fhir.r4.core.Reference encounter = 21 [(.google.fhir.proto.valid_reference_type) = "Encounter"];</code>
   ...
   * </pre>
   *
   * <code>.google.fhir.r4.core.Reference author = 23 [(.google.fhir.proto.valid_reference_type) = "Device", (.google.fhir.proto.valid_reference_type) = "Practitioner", (.google.fhir.proto.valid_reference_type) = "PractitionerRole"];</code>
   ...
   * </pre>
   *
   * <code>repeated .google.fhir.r4.core.Reference reason_reference = 25 [(.google.fhir.proto.valid_reference_type) = "Condition", (.google.fhir.proto.valid_reference_type) = "Observation", (.google.fhir.proto.valid_reference_type) = "DiagnosticReport", (.google.fhir.proto.valid_reference_type) = "DocumentReference"];</code>
   */
  java.util.List<com.google.fhir.r4.core.Reference> 
   ...
   */
  java.util.List<com.google.fhir.r4.core.RequestGroup.Action> 
      getActionList();
  /**
   * <code>repeated .google.fhir.r4.core.RequestGroup.Action action = 27;</code>
   */
   ...
   * <code>repeated .google.fhir.r4.core.RequestGroup.Action action = 27;</code>
   */
  com.google.fhir.r4.core.RequestGroup.ActionOrBuilder getActionOrBuilder(
      int index);
}
