...
public interface EventDefinitionOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.r4.core.EventDefinition)
   ...
   * @return The status.
   */
  com.google.fhir.r4.core.EventDefinition.StatusCode getStatus();
  /**
   * <code>.google.fhir.r4.core.EventDefinition.StatusCode status = 16 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.r4.core.EventDefinition.StatusCodeOrBuilder getStatusOrBuilder();
   ...
   * @return The subject.
   */
  com.google.fhir.r4.core.EventDefinition.SubjectX getSubject();
  /**
   * <code>.google.fhir.r4.core.EventDefinition.SubjectX subject = 18;</code>
   */
  com.google.fhir.r4.core.EventDefinition.SubjectXOrBuilder getSubjectOrBuilder();
   ...
   */
  java.util.List<com.google.fhir.r4.core.TriggerDefinition> 
      getTriggerList();
  /**
   * <pre>
   * "when" the event occurs (multiple = 'or')
   ...
   * <code>repeated .google.fhir.r4.core.TriggerDefinition trigger = 37 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.r4.core.TriggerDefinition getTrigger(int index);
  /**
   * <pre>
   * "when" the event occurs (multiple = 'or')
   * </pre>
   ...
   * <code>repeated .google.fhir.r4.core.TriggerDefinition trigger = 37 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  java.util.List<? extends com.google.fhir.r4.core.TriggerDefinitionOrBuilder> 
   ...
   * <code>repeated .google.fhir.r4.core.TriggerDefinition trigger = 37 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.r4.core.TriggerDefinitionOrBuilder getTriggerOrBuilder(
      int index);
}
