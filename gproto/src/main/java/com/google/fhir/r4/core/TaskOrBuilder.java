...
public interface TaskOrBuilder
   ...
   *
   * <code>
   * repeated .google.fhir.r4.core.Reference part_of = 15 [(.google.fhir.proto.valid_reference_type) = "Task"];
   * </code>
   */
  ...
  /**
   * <code>
   * .google.fhir.r4.core.Task.StatusCode status = 16 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];
   * </code>
   *
  ...
  /**
   * <code>
   * .google.fhir.r4.core.Task.IntentCode intent = 19 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];
   * </code>
   *
   ...
   *
   * <code>
   * .google.fhir.r4.core.Reference focus = 23 [(.google.fhir.proto.valid_reference_type) = "Resource"];
   * </code>
   *
   ...
   *
   * <code>
   * .google.fhir.r4.core.Reference for_value = 24[json_name = "for", (.google.fhir.proto.valid_reference_type) = "Resource"];
   * </code>
   *
   ...
   *
   * <code>
   * .google.fhir.r4.core.Reference location = 32 [(.google.fhir.proto.valid_reference_type) = "Location"];
   * </code>
   *
   ...
   *
   * <code>
   * .google.fhir.r4.core.Reference reason_reference = 34 [(.google.fhir.proto.valid_reference_type) = "Resource"];
   * </code>
   *
   ...
   *
   * <code>
   * repeated .google.fhir.r4.core.Reference insurance = 35 [(.google.fhir.proto.valid_reference_type) = "Coverage", (.google.fhir.proto.valid_reference_type) = "ClaimResponse"];
   * </code>
   */
  ...
  java.util.List<com.google.fhir.r4.core.Task.Parameter> getInputList();
  /** <code>repeated .google.fhir.r4.core.Task.Parameter input = 39;</code> */
  com.google.fhir.r4.core.Task.Parameter getInput(int index);
  /** <code>repeated .google.fhir.r4.core.Task.Parameter input = 39;</code> */
  int getInputCount();
  /** <code>repeated .google.fhir.r4.core.Task.Parameter input = 39;</code> */
  java.util.List<? extends com.google.fhir.r4.core.Task.ParameterOrBuilder> getInputOrBuilderList();
  /** <code>repeated .google.fhir.r4.core.Task.Parameter input = 39;</code> */
  com.google.fhir.r4.core.Task.ParameterOrBuilder getInputOrBuilder(int index);

  /** <code>repeated .google.fhir.r4.core.Task.Output output = 40;</code> */
  java.util.List<com.google.fhir.r4.core.Task.Output> getOutputList();
  /** <code>repeated .google.fhir.r4.core.Task.Output output = 40;</code> */
  com.google.fhir.r4.core.Task.Output getOutput(int index);
  /** <code>repeated .google.fhir.r4.core.Task.Output output = 40;</code> */
  int getOutputCount();
  /** <code>repeated .google.fhir.r4.core.Task.Output output = 40;</code> */
  java.util.List<? extends com.google.fhir.r4.core.Task.OutputOrBuilder> getOutputOrBuilderList();
  /** <code>repeated .google.fhir.r4.core.Task.Output output = 40;</code> */
  com.google.fhir.r4.core.Task.OutputOrBuilder getOutputOrBuilder(int index);
}
