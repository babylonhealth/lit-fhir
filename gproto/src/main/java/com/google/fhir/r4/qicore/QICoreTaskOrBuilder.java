...
public interface QICoreTaskOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.fhir.r4.core.Reference based_on = 12 [(.google.fhir.proto.valid_reference_type) = "Resource"];</code>
   */
   ...
   * </pre>
   *
   * <code>repeated .google.fhir.r4.core.Reference part_of = 14 [(.google.fhir.proto.valid_reference_type) = "Task"];</code>
   */
  java.util.List<com.google.fhir.r4.core.Reference> 
      getPartOfList();
  /**
   ...
   * </pre>
   *
   * <code>.google.fhir.r4.core.Reference focus = 18 [(.google.fhir.proto.valid_reference_type) = "Resource"];</code>
   ...
   * </pre>
   *
   * <code>.google.fhir.r4.core.Reference for_value = 19 [json_name = "for", (.google.fhir.proto.valid_reference_type) = "Resource"];</code>
   ...
   * </pre>
   *
   * <code>.google.fhir.r4.core.Reference location = 26 [(.google.fhir.proto.valid_reference_type) = "Location"];</code>
   ...
   * </pre>
   *
   * <code>.google.fhir.r4.core.Reference reason_reference = 28 [(.google.fhir.proto.valid_reference_type) = "Resource"];</code>
   ...
   * </pre>
   *
   * <code>repeated .google.fhir.r4.core.Reference insurance = 29 [(.google.fhir.proto.valid_reference_type) = "Coverage", (.google.fhir.proto.valid_reference_type) = "ClaimResponse"];</code>
   */
  java.util.List<com.google.fhir.r4.core.Reference> 
      getInsuranceList();
  /**
   ...
   * </pre>
   *
   * <code>repeated .google.fhir.r4.core.Reference relevant_history = 31 [(.google.fhir.proto.valid_reference_type) = "Provenance"];</code>
   */
  java.util.List<com.google.fhir.r4.core.Reference> 
  ...
  /**
   * <code>.google.fhir.r4.qicore.QICoreTask.Restriction restriction = 32 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
  ...
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreTask.Parameter input = 33 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
  java.util.List<com.google.fhir.r4.qicore.QICoreTask.Parameter> 
      getInputList();
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreTask.Parameter input = 33 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
   ...
   * <code>repeated .google.fhir.r4.qicore.QICoreTask.Parameter input = 33 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
  com.google.fhir.r4.qicore.QICoreTask.ParameterOrBuilder getInputOrBuilder(
      int index);

  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreTask.Output output = 34 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
  java.util.List<com.google.fhir.r4.qicore.QICoreTask.Output> 
      getOutputList();
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreTask.Output output = 34 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
   ...
   * <code>repeated .google.fhir.r4.qicore.QICoreTask.Output output = 34 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
  com.google.fhir.r4.qicore.QICoreTask.OutputOrBuilder getOutputOrBuilder(
      int index);
}
