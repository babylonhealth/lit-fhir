...
public interface CarePlanOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.r4.core.CarePlan)
  ...
  /**
   * <code>.google.fhir.r4.core.CarePlan.StatusCode status = 16 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   ...
   * @return The status.
   */
  com.google.fhir.r4.core.CarePlan.StatusCode getStatus();
  /**
   * <code>.google.fhir.r4.core.CarePlan.StatusCode status = 16 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.r4.core.CarePlan.StatusCodeOrBuilder getStatusOrBuilder();

  /**
   * <code>.google.fhir.r4.core.CarePlan.IntentCode intent = 17 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   ...
   * @return The intent.
   */
  com.google.fhir.r4.core.CarePlan.IntentCode getIntent();
  /**
   * <code>.google.fhir.r4.core.CarePlan.IntentCode intent = 17 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.r4.core.CarePlan.IntentCodeOrBuilder getIntentOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.fhir.r4.core.Reference subject = 21 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR, (.google.fhir.proto.valid_reference_type) = "Patient", (.google.fhir.proto.valid_reference_type) = "Group"];</code>
  ...
  /**
   * <code>repeated .google.fhir.r4.core.CarePlan.Activity activity = 31;</code>
   */
  java.util.List<com.google.fhir.r4.core.CarePlan.Activity> 
      getActivityList();
  /**
   * <code>repeated .google.fhir.r4.core.CarePlan.Activity activity = 31;</code>
   */
  com.google.fhir.r4.core.CarePlan.Activity getActivity(int index);
  /**
   * <code>repeated .google.fhir.r4.core.CarePlan.Activity activity = 31;</code>
   */
   ...
   * <code>repeated .google.fhir.r4.core.CarePlan.Activity activity = 31;</code>
   */
  java.util.List<? extends com.google.fhir.r4.core.CarePlan.ActivityOrBuilder> 
      getActivityOrBuilderList();
  /**
   * <code>repeated .google.fhir.r4.core.CarePlan.Activity activity = 31;</code>
   */
  com.google.fhir.r4.core.CarePlan.ActivityOrBuilder getActivityOrBuilder(
      int index);
