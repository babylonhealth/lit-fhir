...
public interface ConceptMapOrBuilder
  ...
  /**
   * <code>
   * .google.fhir.r4.core.ConceptMap.StatusCode status = 15 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];
   * </code>
   *
  ...
  java.util.List<com.google.fhir.r4.core.ConceptMap.Group> getGroupList();
  /** <code>repeated .google.fhir.r4.core.ConceptMap.Group group = 27;</code> */
  ...
  /** <code>repeated .google.fhir.r4.core.ConceptMap.Group group = 27;</code> */
  com.google.fhir.r4.core.ConceptMap.GroupOrBuilder getGroupOrBuilder(int index);
}
