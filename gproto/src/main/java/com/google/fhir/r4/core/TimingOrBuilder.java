...
public interface TimingOrBuilder
   ...
   */
  java.util.List<com.google.fhir.r4.core.DateTime> getEventList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.fhir.r4.core.DateTime event = 4;</code>
   */
  java.util.List<? extends com.google.fhir.r4.core.DateTimeOrBuilder> getEventOrBuilderList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.fhir.r4.core.DateTime event = 4;</code>
   */
  com.google.fhir.r4.core.DateTimeOrBuilder getEventOrBuilder(int index);
