...
public interface QICoreOrganizationOrBuilder
    extends
   ...
   * </code>
   */
  java.util.List<com.google.fhir.r4.qicore.QICoreOrganization.Contact> getContactList();
  /**
   * <code>
   * repeated .google.fhir.r4.qicore.QICoreOrganization.Contact contact = 18 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];
   * </code>
   ...
   * </code>
   */
  com.google.fhir.r4.qicore.QICoreOrganization.ContactOrBuilder getContactOrBuilder(int index);
