...
public interface PrimitiveTestSuiteOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.r4.testing.PrimitiveTestSuite)
   ...
   */
  java.util.List<com.google.fhir.r4.testing.ValidPair> 
      getValidPairsList();
  /**
   * <pre>
   * Note: The test suite will fail if any of these are empty.
   ...
   * <code>repeated .google.fhir.r4.testing.ValidPair valid_pairs = 1;</code>
   */
  com.google.fhir.r4.testing.ValidPair getValidPairs(int index);
  /**
   * <pre>
   * Note: The test suite will fail if any of these are empty.
   * </pre>
   ...
   * <code>repeated .google.fhir.r4.testing.ValidPair valid_pairs = 1;</code>
   */
  java.util.List<? extends com.google.fhir.r4.testing.ValidPairOrBuilder> 
   ...
   * <code>repeated .google.fhir.r4.testing.ValidPair valid_pairs = 1;</code>
   */
  com.google.fhir.r4.testing.ValidPairOrBuilder getValidPairsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.fhir.r4.testing.PrimitiveProtoUnion> 
      getInvalidProtosList();
  /**
   * <code>repeated .google.fhir.r4.testing.PrimitiveProtoUnion invalid_protos = 3;</code>
   */
  com.google.fhir.r4.testing.PrimitiveProtoUnion getInvalidProtos(int index);
  /**
   * <code>repeated .google.fhir.r4.testing.PrimitiveProtoUnion invalid_protos = 3;</code>
   */
   ...
   * <code>repeated .google.fhir.r4.testing.PrimitiveProtoUnion invalid_protos = 3;</code>
   */
  java.util.List<? extends com.google.fhir.r4.testing.PrimitiveProtoUnionOrBuilder> 
      getInvalidProtosOrBuilderList();
  /**
   * <code>repeated .google.fhir.r4.testing.PrimitiveProtoUnion invalid_protos = 3;</code>
   */
  com.google.fhir.r4.testing.PrimitiveProtoUnionOrBuilder getInvalidProtosOrBuilder(
      int index);
