...
public interface QICoreDiagnosticReportNoteOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.r4.qicore.QICoreDiagnosticReportNote)
   ...
   * @return The status.
   */
  com.google.fhir.r4.qicore.QICoreDiagnosticReportNote.StatusCode getStatus();
  /**
   * <code>.google.fhir.r4.qicore.QICoreDiagnosticReportNote.StatusCode status = 12 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.r4.qicore.QICoreDiagnosticReportNote.StatusCodeOrBuilder getStatusOrBuilder();
   ...
   */
  com.google.fhir.r4.qicore.QICoreDiagnosticReportNote.EffectiveX getEffective();
  /**
   * <code>.google.fhir.r4.qicore.QICoreDiagnosticReportNote.EffectiveX effective = 17 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.r4.qicore.QICoreDiagnosticReportNote.EffectiveXOrBuilder getEffectiveOrBuilder();
   ...
   */
  java.util.List<com.google.fhir.r4.qicore.QICoreDiagnosticReportNote.Media> 
      getMediaList();
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreDiagnosticReportNote.Media media = 24 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
  com.google.fhir.r4.qicore.QICoreDiagnosticReportNote.Media getMedia(int index);
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreDiagnosticReportNote.Media media = 24 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
  int getMediaCount();
   ...
   * <code>repeated .google.fhir.r4.qicore.QICoreDiagnosticReportNote.Media media = 24 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
  java.util.List<? extends com.google.fhir.r4.qicore.QICoreDiagnosticReportNote.MediaOrBuilder> 
      getMediaOrBuilderList();
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreDiagnosticReportNote.Media media = 24 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
  com.google.fhir.r4.qicore.QICoreDiagnosticReportNote.MediaOrBuilder getMediaOrBuilder(
      int index);
