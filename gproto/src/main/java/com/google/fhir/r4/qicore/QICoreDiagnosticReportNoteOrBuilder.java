...
public interface QICoreDiagnosticReportNoteOrBuilder
    extends
   ...
   * </code>
   */
  java.util.List<com.google.fhir.r4.qicore.QICoreDiagnosticReportNote.Media> getMediaList();
  /**
   * <code>
   * repeated .google.fhir.r4.qicore.QICoreDiagnosticReportNote.Media media = 24 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];
   * </code>
   ...
   * </code>
   */
  com.google.fhir.r4.qicore.QICoreDiagnosticReportNote.MediaOrBuilder getMediaOrBuilder(int index);
