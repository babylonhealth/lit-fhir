...
public interface EffectEvidenceSynthesisOrBuilder
    extends
  ...
  /**
   * <code>
   * .google.fhir.r4.core.EffectEvidenceSynthesis.StatusCode status = 15 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];
   * </code>
   *
   ...
   *
   * <code>
   * .google.fhir.r4.core.Reference exposure = 36 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR, (.google.fhir.proto.valid_reference_type) = "EvidenceVariable"];
   * </code>
   *
   ...
   *
   * <code>
   * .google.fhir.r4.core.Reference exposure_alternative = 37 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR, (.google.fhir.proto.valid_reference_type) = "EvidenceVariable"];
   * </code>
   *
   ...
   *
   * <code>
   * .google.fhir.r4.core.Reference outcome = 38 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR, (.google.fhir.proto.valid_reference_type) = "EvidenceVariable"];
   * </code>
   *
  ...
  /**
   * <code>
   * repeated .google.fhir.r4.core.EffectEvidenceSynthesis.ResultsByExposure results_by_exposure = 40;
   * </code>
   */
   ...
   */
  java.util.List<
          ? extends com.google.fhir.r4.core.EffectEvidenceSynthesis.ResultsByExposureOrBuilder>
   ...
   * </code>
   */
  com.google.fhir.r4.core.EffectEvidenceSynthesis.ResultsByExposureOrBuilder
      getResultsByExposureOrBuilder(int index);

  /**
   * <code>
   * repeated .google.fhir.r4.core.EffectEvidenceSynthesis.EffectEstimate effect_estimate = 41;
   * </code>
   */
   ...
   * </code>
   */
  com.google.fhir.r4.core.EffectEvidenceSynthesis.EffectEstimateOrBuilder
      getEffectEstimateOrBuilder(int index);

  /**
   * <code>repeated .google.fhir.r4.core.EffectEvidenceSynthesis.Certainty certainty = 42;</code>
   */
  java.util.List<com.google.fhir.r4.core.EffectEvidenceSynthesis.Certainty> getCertaintyList();
  /**
   * <code>repeated .google.fhir.r4.core.EffectEvidenceSynthesis.Certainty certainty = 42;</code>
   */
