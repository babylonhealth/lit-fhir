...
public interface USCoreCareTeamOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.r4.uscore.USCoreCareTeam)
   ...
   * @return The status.
   */
  com.google.fhir.r4.uscore.USCoreCareTeam.StatusCode getStatus();
  /**
   * <code>.google.fhir.r4.uscore.USCoreCareTeam.StatusCode status = 11;</code>
   */
  com.google.fhir.r4.uscore.USCoreCareTeam.StatusCodeOrBuilder getStatusOrBuilder();
   ...
   */
  java.util.List<com.google.fhir.r4.uscore.USCoreCareTeam.Participant> 
      getParticipantList();
  /**
   * <code>repeated .google.fhir.r4.uscore.USCoreCareTeam.Participant participant = 17 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.r4.uscore.USCoreCareTeam.Participant getParticipant(int index);
  /**
   * <code>repeated .google.fhir.r4.uscore.USCoreCareTeam.Participant participant = 17 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
   ...
   * <code>repeated .google.fhir.r4.uscore.USCoreCareTeam.Participant participant = 17 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  java.util.List<? extends com.google.fhir.r4.uscore.USCoreCareTeam.ParticipantOrBuilder> 
      getParticipantOrBuilderList();
  /**
   * <code>repeated .google.fhir.r4.uscore.USCoreCareTeam.Participant participant = 17 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.r4.uscore.USCoreCareTeam.ParticipantOrBuilder getParticipantOrBuilder(
      int index);
