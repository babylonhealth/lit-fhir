...
public interface ComputablePlanDefinitionOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.r4.core.ComputablePlanDefinition)
  ...
  /**
   * <code>.google.fhir.r4.core.ComputablePlanDefinition.StatusCode status = 17 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   ...
   * @return The status.
   */
  com.google.fhir.r4.core.ComputablePlanDefinition.StatusCode getStatus();
  /**
   * <code>.google.fhir.r4.core.ComputablePlanDefinition.StatusCode status = 17 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.r4.core.ComputablePlanDefinition.StatusCodeOrBuilder getStatusOrBuilder();
  ...
  /**
   * <code>.google.fhir.r4.core.ComputablePlanDefinition.SubjectX subject = 19;</code>
   ...
   * @return The subject.
   */
  com.google.fhir.r4.core.ComputablePlanDefinition.SubjectX getSubject();
  /**
   * <code>.google.fhir.r4.core.ComputablePlanDefinition.SubjectX subject = 19;</code>
   */
  com.google.fhir.r4.core.ComputablePlanDefinition.SubjectXOrBuilder getSubjectOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.fhir.r4.core.Canonical library = 38 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   ...
   * @return The library.
   */
  com.google.fhir.r4.core.Canonical getLibrary();
  /**
   * <pre>
   * Logic used by the plan definition
   * </pre>
  ...
  /**
   * <code>repeated .google.fhir.r4.core.ComputablePlanDefinition.Goal goal = 39;</code>
   */
  java.util.List<com.google.fhir.r4.core.ComputablePlanDefinition.Goal> 
      getGoalList();
  /**
   * <code>repeated .google.fhir.r4.core.ComputablePlanDefinition.Goal goal = 39;</code>
   */
  com.google.fhir.r4.core.ComputablePlanDefinition.Goal getGoal(int index);
  /**
   * <code>repeated .google.fhir.r4.core.ComputablePlanDefinition.Goal goal = 39;</code>
   */
  int getGoalCount();
   ...
   * <code>repeated .google.fhir.r4.core.ComputablePlanDefinition.Goal goal = 39;</code>
   */
  java.util.List<? extends com.google.fhir.r4.core.ComputablePlanDefinition.GoalOrBuilder> 
      getGoalOrBuilderList();
  /**
   * <code>repeated .google.fhir.r4.core.ComputablePlanDefinition.Goal goal = 39;</code>
   */
  com.google.fhir.r4.core.ComputablePlanDefinition.GoalOrBuilder getGoalOrBuilder(
      int index);

  /**
   * <code>repeated .google.fhir.r4.core.ComputablePlanDefinition.Action action = 40;</code>
   */
  java.util.List<com.google.fhir.r4.core.ComputablePlanDefinition.Action> 
      getActionList();
  /**
   * <code>repeated .google.fhir.r4.core.ComputablePlanDefinition.Action action = 40;</code>
   */
  com.google.fhir.r4.core.ComputablePlanDefinition.Action getAction(int index);
  /**
   * <code>repeated .google.fhir.r4.core.ComputablePlanDefinition.Action action = 40;</code>
   */
  int getActionCount();
   ...
   * <code>repeated .google.fhir.r4.core.ComputablePlanDefinition.Action action = 40;</code>
   */
  java.util.List<? extends com.google.fhir.r4.core.ComputablePlanDefinition.ActionOrBuilder> 
      getActionOrBuilderList();
  /**
   * <code>repeated .google.fhir.r4.core.ComputablePlanDefinition.Action action = 40;</code>
   */
  com.google.fhir.r4.core.ComputablePlanDefinition.ActionOrBuilder getActionOrBuilder(
      int index);
}
