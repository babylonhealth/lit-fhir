...
public interface QICoreImmunizationRecommendationOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.r4.qicore.QICoreImmunizationRecommendation)
   ...
   */
  java.util.List<com.google.fhir.r4.qicore.QICoreImmunizationRecommendation.Recommendation> 
      getRecommendationList();
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreImmunizationRecommendation.Recommendation recommendation = 14 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR, (.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())", (.google.fhir.proto.fhir_path_constraint) = "vaccineCode.exists() or targetDisease.exists()"];</code>
   */
  com.google.fhir.r4.qicore.QICoreImmunizationRecommendation.Recommendation getRecommendation(int index);
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreImmunizationRecommendation.Recommendation recommendation = 14 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR, (.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())", (.google.fhir.proto.fhir_path_constraint) = "vaccineCode.exists() or targetDisease.exists()"];</code>
   */
   ...
   * <code>repeated .google.fhir.r4.qicore.QICoreImmunizationRecommendation.Recommendation recommendation = 14 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR, (.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())", (.google.fhir.proto.fhir_path_constraint) = "vaccineCode.exists() or targetDisease.exists()"];</code>
   */
  java.util.List<? extends com.google.fhir.r4.qicore.QICoreImmunizationRecommendation.RecommendationOrBuilder> 
      getRecommendationOrBuilderList();
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreImmunizationRecommendation.Recommendation recommendation = 14 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR, (.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())", (.google.fhir.proto.fhir_path_constraint) = "vaccineCode.exists() or targetDisease.exists()"];</code>
   */
  com.google.fhir.r4.qicore.QICoreImmunizationRecommendation.RecommendationOrBuilder getRecommendationOrBuilder(
      int index);
}
