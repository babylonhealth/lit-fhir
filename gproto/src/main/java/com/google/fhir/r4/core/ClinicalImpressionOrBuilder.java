...
public interface ClinicalImpressionOrBuilder
   ...
   * </code>
   */
  java.util.List<com.google.fhir.r4.core.Reference> getProblemList();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  java.util.List<? extends com.google.fhir.r4.core.ReferenceOrBuilder> getProblemOrBuilderList();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.fhir.r4.core.ReferenceOrBuilder getProblemOrBuilder(int index);

  /**
   * <code>repeated .google.fhir.r4.core.ClinicalImpression.Investigation investigation = 22;</code>
   */
  java.util.List<com.google.fhir.r4.core.ClinicalImpression.Investigation> getInvestigationList();
  /**
   * <code>repeated .google.fhir.r4.core.ClinicalImpression.Investigation investigation = 22;</code>
   */
   ...
   */
  java.util.List<com.google.fhir.r4.core.Uri> getProtocolList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.fhir.r4.core.Uri protocol = 23;</code>
   */
  java.util.List<? extends com.google.fhir.r4.core.UriOrBuilder> getProtocolOrBuilderList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.fhir.r4.core.Uri protocol = 23;</code>
   */
  com.google.fhir.r4.core.UriOrBuilder getProtocolOrBuilder(int index);
  ...
  java.util.List<com.google.fhir.r4.core.ClinicalImpression.Finding> getFindingList();
  /** <code>repeated .google.fhir.r4.core.ClinicalImpression.Finding finding = 25;</code> */
  ...
  /** <code>repeated .google.fhir.r4.core.ClinicalImpression.Finding finding = 25;</code> */
  com.google.fhir.r4.core.ClinicalImpression.FindingOrBuilder getFindingOrBuilder(int index);
   ...
   */
  java.util.List<com.google.fhir.r4.core.CodeableConcept> getPrognosisCodeableConceptList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.fhir.r4.core.CodeableConcept prognosis_codeable_concept = 26;</code>
   */
  com.google.fhir.r4.core.CodeableConceptOrBuilder getPrognosisCodeableConceptOrBuilder(int index);
   ...
   * </code>
   */
  java.util.List<com.google.fhir.r4.core.Reference> getPrognosisReferenceList();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.fhir.r4.core.ReferenceOrBuilder getPrognosisReferenceOrBuilder(int index);
