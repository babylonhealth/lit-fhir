...
public interface QICoreObservationOrBuilder extends
   ...
   */
  java.util.List<com.google.fhir.r4.qicore.QICoreObservation.Component> 
      getComponentList();
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreObservation.Component component = 33 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
   ...
   * <code>repeated .google.fhir.r4.qicore.QICoreObservation.Component component = 33 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
  com.google.fhir.r4.qicore.QICoreObservation.ComponentOrBuilder getComponentOrBuilder(
      int index);
