...
public interface StructureMapOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.r4.core.StructureMap)
  ...
  /**
   * <code>.google.fhir.r4.core.StructureMap.StatusCode status = 15 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   ...
   * @return The status.
   */
  com.google.fhir.r4.core.StructureMap.StatusCode getStatus();
  /**
   * <code>.google.fhir.r4.core.StructureMap.StatusCode status = 15 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.r4.core.StructureMap.StatusCodeOrBuilder getStatusOrBuilder();
  ...
  /**
   * <code>repeated .google.fhir.r4.core.StructureMap.Structure structure = 25;</code>
   */
  java.util.List<com.google.fhir.r4.core.StructureMap.Structure> 
      getStructureList();
  /**
   * <code>repeated .google.fhir.r4.core.StructureMap.Structure structure = 25;</code>
   */
  com.google.fhir.r4.core.StructureMap.Structure getStructure(int index);
  /**
   * <code>repeated .google.fhir.r4.core.StructureMap.Structure structure = 25;</code>
   */
   ...
   * <code>repeated .google.fhir.r4.core.StructureMap.Structure structure = 25;</code>
   */
  java.util.List<? extends com.google.fhir.r4.core.StructureMap.StructureOrBuilder> 
      getStructureOrBuilderList();
  /**
   * <code>repeated .google.fhir.r4.core.StructureMap.Structure structure = 25;</code>
   */
  com.google.fhir.r4.core.StructureMap.StructureOrBuilder getStructureOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>repeated .google.fhir.r4.core.Canonical import = 26;</code>
   */
   ...
   * <code>repeated .google.fhir.r4.core.Canonical import = 26;</code>
   */
  com.google.fhir.r4.core.Canonical getImport(int index);
  /**
   * <pre>
   * Other maps used by this map (canonical URLs)
   * </pre>
   ...
   * <code>repeated .google.fhir.r4.core.Canonical import = 26;</code>
   */
  com.google.fhir.r4.core.CanonicalOrBuilder getImportOrBuilder(
      int index);

  /**
   * <code>repeated .google.fhir.r4.core.StructureMap.Group group = 27 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  java.util.List<com.google.fhir.r4.core.StructureMap.Group> 
      getGroupList();
  /**
   * <code>repeated .google.fhir.r4.core.StructureMap.Group group = 27 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.r4.core.StructureMap.Group getGroup(int index);
  /**
   * <code>repeated .google.fhir.r4.core.StructureMap.Group group = 27 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  int getGroupCount();
   ...
   * <code>repeated .google.fhir.r4.core.StructureMap.Group group = 27 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  java.util.List<? extends com.google.fhir.r4.core.StructureMap.GroupOrBuilder> 
      getGroupOrBuilderList();
  /**
   * <code>repeated .google.fhir.r4.core.StructureMap.Group group = 27 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.r4.core.StructureMap.GroupOrBuilder getGroupOrBuilder(
      int index);
}
