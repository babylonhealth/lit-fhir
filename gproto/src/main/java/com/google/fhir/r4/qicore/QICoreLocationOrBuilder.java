...
public interface QICoreLocationOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.r4.qicore.QICoreLocation)
   ...
   * @return The status.
   */
  com.google.fhir.r4.qicore.QICoreLocation.StatusCode getStatus();
  /**
   * <code>.google.fhir.r4.qicore.QICoreLocation.StatusCode status = 11;</code>
   */
  com.google.fhir.r4.qicore.QICoreLocation.StatusCodeOrBuilder getStatusOrBuilder();
   ...
   * @return The mode.
   */
  com.google.fhir.r4.qicore.QICoreLocation.ModeCode getMode();
  /**
   * <code>.google.fhir.r4.qicore.QICoreLocation.ModeCode mode = 16;</code>
   */
  com.google.fhir.r4.qicore.QICoreLocation.ModeCodeOrBuilder getModeOrBuilder();
   ...
   * @return The position.
   */
  com.google.fhir.r4.qicore.QICoreLocation.Position getPosition();
  /**
   * <code>.google.fhir.r4.qicore.QICoreLocation.Position position = 21 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
  com.google.fhir.r4.qicore.QICoreLocation.PositionOrBuilder getPositionOrBuilder();
   ...
   */
  java.util.List<com.google.fhir.r4.qicore.QICoreLocation.HoursOfOperation> 
      getHoursOfOperationList();
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreLocation.HoursOfOperation hours_of_operation = 24 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
  com.google.fhir.r4.qicore.QICoreLocation.HoursOfOperation getHoursOfOperation(int index);
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreLocation.HoursOfOperation hours_of_operation = 24 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
   ...
   * <code>repeated .google.fhir.r4.qicore.QICoreLocation.HoursOfOperation hours_of_operation = 24 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
  java.util.List<? extends com.google.fhir.r4.qicore.QICoreLocation.HoursOfOperationOrBuilder> 
      getHoursOfOperationOrBuilderList();
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreLocation.HoursOfOperation hours_of_operation = 24 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
  com.google.fhir.r4.qicore.QICoreLocation.HoursOfOperationOrBuilder getHoursOfOperationOrBuilder(
      int index);
