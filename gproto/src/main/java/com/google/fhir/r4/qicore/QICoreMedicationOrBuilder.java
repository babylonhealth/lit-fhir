...
public interface QICoreMedicationOrBuilder extends
   ...
   */
  java.util.List<com.google.fhir.r4.qicore.QICoreMedication.Ingredient> 
      getIngredientList();
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreMedication.Ingredient ingredient = 16 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
   ...
   * <code>repeated .google.fhir.r4.qicore.QICoreMedication.Ingredient ingredient = 16 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
  com.google.fhir.r4.qicore.QICoreMedication.IngredientOrBuilder getIngredientOrBuilder(
      int index);
