...
public interface QICoreCarePlanOrBuilder extends
  ...
  /**
   * <code>.google.fhir.r4.qicore.QICoreCarePlan.StatusCode status = 16 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
  ...
  /**
   * <code>.google.fhir.r4.qicore.QICoreCarePlan.IntentCode intent = 17 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
  ...
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreCarePlan.Activity activity = 31 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())", (.google.fhir.proto.fhir_path_constraint) = "detail.empty() or reference.empty()"];</code>
   */
  java.util.List<com.google.fhir.r4.qicore.QICoreCarePlan.Activity> 
      getActivityList();
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreCarePlan.Activity activity = 31 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())", (.google.fhir.proto.fhir_path_constraint) = "detail.empty() or reference.empty()"];</code>
   */
   ...
   * <code>repeated .google.fhir.r4.qicore.QICoreCarePlan.Activity activity = 31 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())", (.google.fhir.proto.fhir_path_constraint) = "detail.empty() or reference.empty()"];</code>
   */
  com.google.fhir.r4.qicore.QICoreCarePlan.ActivityOrBuilder getActivityOrBuilder(
      int index);
