...
public interface QICoreDeviceRequestOrBuilder
    extends
   ...
   * </code>
   */
  java.util.List<com.google.fhir.r4.qicore.QICoreDeviceRequest.Parameter> getParameterList();
  /**
   * <code>
   * repeated .google.fhir.r4.qicore.QICoreDeviceRequest.Parameter parameter = 20 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];
   * </code>
   ...
   * </code>
   */
  com.google.fhir.r4.qicore.QICoreDeviceRequest.ParameterOrBuilder getParameterOrBuilder(int index);
