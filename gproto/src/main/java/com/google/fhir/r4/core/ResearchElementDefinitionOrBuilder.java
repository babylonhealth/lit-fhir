...
public interface ResearchElementDefinitionOrBuilder
    extends
  ...
  /**
   * <code>
   * .google.fhir.r4.core.ResearchElementDefinition.StatusCode status = 17 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];
   * </code>
   *
   ...
   */
  java.util.List<com.google.fhir.r4.core.String> getCommentList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.fhir.r4.core.String comment = 24;</code>
   */
  java.util.List<? extends com.google.fhir.r4.core.StringOrBuilder> getCommentOrBuilderList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.fhir.r4.core.String comment = 24;</code>
   */
  com.google.fhir.r4.core.StringOrBuilder getCommentOrBuilder(int index);
  ...
  /**
   * <code>
   * .google.fhir.r4.core.ResearchElementDefinition.TypeCode type = 40 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];
   * </code>
   *
  ...
  /**
   * <code>.google.fhir.r4.core.ResearchElementDefinition.VariableTypeCode variable_type = 41;
   * </code>
   *
   ...
   * </code>
   */
  com.google.fhir.r4.core.ResearchElementDefinition.VariableTypeCodeOrBuilder
      getVariableTypeOrBuilder();

  /**
   * <code>
   * repeated .google.fhir.r4.core.ResearchElementDefinition.Characteristic characteristic = 42 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];
   * </code>
   */
   ...
   */
  java.util.List<
          ? extends com.google.fhir.r4.core.ResearchElementDefinition.CharacteristicOrBuilder>
   ...
   * </code>
   */
  com.google.fhir.r4.core.ResearchElementDefinition.CharacteristicOrBuilder
