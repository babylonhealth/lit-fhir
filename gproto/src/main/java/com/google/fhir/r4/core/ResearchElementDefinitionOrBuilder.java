...
public interface ResearchElementDefinitionOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.r4.core.ResearchElementDefinition)
   ...
   */
  com.google.fhir.r4.core.String getShortTitle();
  /**
   * <pre>
   * Title for use in informal contexts
   * </pre>
   ...
   * <code>.google.fhir.r4.core.String short_title = 15;</code>
   */
  com.google.fhir.r4.core.StringOrBuilder getShortTitleOrBuilder();
  ...
  /**
   * <code>.google.fhir.r4.core.ResearchElementDefinition.StatusCode status = 17 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   ...
   * @return The status.
   */
  com.google.fhir.r4.core.ResearchElementDefinition.StatusCode getStatus();
  /**
   * <code>.google.fhir.r4.core.ResearchElementDefinition.StatusCode status = 17 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.r4.core.ResearchElementDefinition.StatusCodeOrBuilder getStatusOrBuilder();
  ...
  /**
   * <code>.google.fhir.r4.core.ResearchElementDefinition.SubjectX subject = 19;</code>
   ...
   * @return The subject.
   */
  com.google.fhir.r4.core.ResearchElementDefinition.SubjectX getSubject();
  /**
   * <code>.google.fhir.r4.core.ResearchElementDefinition.SubjectX subject = 19;</code>
   */
  com.google.fhir.r4.core.ResearchElementDefinition.SubjectXOrBuilder getSubjectOrBuilder();
   ...
   * <code>repeated .google.fhir.r4.core.String comment = 24;</code>
   */
  com.google.fhir.r4.core.String getComment(int index);
  /**
   * <pre>
   * Used for footnotes or explanatory notes
   * </pre>
  ...
  /**
   * <code>.google.fhir.r4.core.ResearchElementDefinition.TypeCode type = 40 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   ...
   * @return The type.
   */
  com.google.fhir.r4.core.ResearchElementDefinition.TypeCode getType();
  /**
   * <code>.google.fhir.r4.core.ResearchElementDefinition.TypeCode type = 40 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.r4.core.ResearchElementDefinition.TypeCodeOrBuilder getTypeOrBuilder();

  /**
   * <code>.google.fhir.r4.core.ResearchElementDefinition.VariableTypeCode variable_type = 41;</code>
   * @return Whether the variableType field is set.
   */
   ...
   */
  com.google.fhir.r4.core.ResearchElementDefinition.VariableTypeCode getVariableType();
  /**
   * <code>.google.fhir.r4.core.ResearchElementDefinition.VariableTypeCode variable_type = 41;</code>
   */
  com.google.fhir.r4.core.ResearchElementDefinition.VariableTypeCodeOrBuilder getVariableTypeOrBuilder();

  /**
   * <code>repeated .google.fhir.r4.core.ResearchElementDefinition.Characteristic characteristic = 42 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  java.util.List<com.google.fhir.r4.core.ResearchElementDefinition.Characteristic> 
      getCharacteristicList();
  /**
   * <code>repeated .google.fhir.r4.core.ResearchElementDefinition.Characteristic characteristic = 42 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.r4.core.ResearchElementDefinition.Characteristic getCharacteristic(int index);
  /**
   * <code>repeated .google.fhir.r4.core.ResearchElementDefinition.Characteristic characteristic = 42 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
   ...
   * <code>repeated .google.fhir.r4.core.ResearchElementDefinition.Characteristic characteristic = 42 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  java.util.List<? extends com.google.fhir.r4.core.ResearchElementDefinition.CharacteristicOrBuilder> 
      getCharacteristicOrBuilderList();
  /**
   * <code>repeated .google.fhir.r4.core.ResearchElementDefinition.Characteristic characteristic = 42 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.r4.core.ResearchElementDefinition.CharacteristicOrBuilder getCharacteristicOrBuilder(
      int index);
}
