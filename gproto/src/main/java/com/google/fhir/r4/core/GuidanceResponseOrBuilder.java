...
public interface GuidanceResponseOrBuilder
   ...
   * </code>
   */
  java.util.List<com.google.fhir.r4.core.Reference> getEvaluationMessageList();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.fhir.r4.core.ReferenceOrBuilder getEvaluationMessageOrBuilder(int index);
   ...
   */
  java.util.List<com.google.fhir.r4.core.DataRequirement> getDataRequirementList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.fhir.r4.core.DataRequirement data_requirement = 24;</code>
   */
  com.google.fhir.r4.core.DataRequirementOrBuilder getDataRequirementOrBuilder(int index);
}
