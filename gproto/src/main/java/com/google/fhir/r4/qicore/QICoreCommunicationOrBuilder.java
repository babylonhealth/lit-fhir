...
public interface QICoreCommunicationOrBuilder extends
   ...
   */
  java.util.List<com.google.fhir.r4.qicore.QICoreCommunication.Payload> 
      getPayloadList();
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreCommunication.Payload payload = 31 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
   ...
   * <code>repeated .google.fhir.r4.qicore.QICoreCommunication.Payload payload = 31 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
  com.google.fhir.r4.qicore.QICoreCommunication.PayloadOrBuilder getPayloadOrBuilder(
      int index);
