...
public interface QICoreDiagnosticReportLabOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.r4.qicore.QICoreDiagnosticReportLab)
   ...
   * @return The status.
   */
  com.google.fhir.r4.qicore.QICoreDiagnosticReportLab.StatusCode getStatus();
  /**
   * <code>.google.fhir.r4.qicore.QICoreDiagnosticReportLab.StatusCode status = 12 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.r4.qicore.QICoreDiagnosticReportLab.StatusCodeOrBuilder getStatusOrBuilder();
   ...
   */
  com.google.fhir.r4.qicore.QICoreDiagnosticReportLab.EffectiveX getEffective();
  /**
   * <code>.google.fhir.r4.qicore.QICoreDiagnosticReportLab.EffectiveX effective = 17 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.r4.qicore.QICoreDiagnosticReportLab.EffectiveXOrBuilder getEffectiveOrBuilder();
   ...
   */
  java.util.List<com.google.fhir.r4.qicore.QICoreDiagnosticReportLab.Media> 
      getMediaList();
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreDiagnosticReportLab.Media media = 24 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
  com.google.fhir.r4.qicore.QICoreDiagnosticReportLab.Media getMedia(int index);
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreDiagnosticReportLab.Media media = 24 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
  int getMediaCount();
   ...
   * <code>repeated .google.fhir.r4.qicore.QICoreDiagnosticReportLab.Media media = 24 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
  java.util.List<? extends com.google.fhir.r4.qicore.QICoreDiagnosticReportLab.MediaOrBuilder> 
      getMediaOrBuilderList();
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreDiagnosticReportLab.Media media = 24 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];</code>
   */
  com.google.fhir.r4.qicore.QICoreDiagnosticReportLab.MediaOrBuilder getMediaOrBuilder(
      int index);
   ...
   */
  com.google.fhir.r4.core.Reference getLocationPerformed();
  /**
   * <pre>
   * Location Performed
   * </pre>
   ...
   * <code>.google.fhir.r4.core.Reference location_performed = 28 [(.google.fhir.proto.fhir_inlined_extension_url) = "http://hl7.org/fhir/StructureDefinition/diagnosticReport-locationPerformed", (.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())", (.google.fhir.proto.fhir_path_constraint) = "extension.exists() != value.exists()"];</code>
   */
  com.google.fhir.r4.core.ReferenceOrBuilder getLocationPerformedOrBuilder();
}
