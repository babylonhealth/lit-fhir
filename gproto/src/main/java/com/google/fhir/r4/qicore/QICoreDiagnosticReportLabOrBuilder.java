...
public interface QICoreDiagnosticReportLabOrBuilder
    extends
   ...
   * </code>
   */
  java.util.List<com.google.fhir.r4.qicore.QICoreDiagnosticReportLab.Media> getMediaList();
  /**
   * <code>
   * repeated .google.fhir.r4.qicore.QICoreDiagnosticReportLab.Media media = 24 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())"];
   * </code>
   ...
   * </code>
   */
  com.google.fhir.r4.qicore.QICoreDiagnosticReportLab.MediaOrBuilder getMediaOrBuilder(int index);
   ...
   */
  java.util.List<com.google.fhir.r4.core.CodeableConcept> getConclusionCodeList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.fhir.r4.core.CodeableConcept conclusion_code = 26;</code>
   */
  com.google.fhir.r4.core.CodeableConceptOrBuilder getConclusionCodeOrBuilder(int index);
