...
public interface QICoreGoalOrBuilder extends
   ...
   */
  java.util.List<com.google.fhir.r4.qicore.QICoreGoal.Target> 
      getTargetList();
  /**
   * <code>repeated .google.fhir.r4.qicore.QICoreGoal.Target target = 18 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())", (.google.fhir.proto.fhir_path_constraint) = "(detail.exists() and measure.exists()) or detail.exists().not()"];</code>
   */
   ...
   * <code>repeated .google.fhir.r4.qicore.QICoreGoal.Target target = 18 [(.google.fhir.proto.fhir_path_constraint) = "hasValue() or (children().count() &gt; id.count())", (.google.fhir.proto.fhir_path_constraint) = "(detail.exists() and measure.exists()) or detail.exists().not()"];</code>
   */
  com.google.fhir.r4.qicore.QICoreGoal.TargetOrBuilder getTargetOrBuilder(
      int index);
