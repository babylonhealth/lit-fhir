...
public interface QICoreFlagOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.r4.qicore.QICoreFlag)
   ...
   * @return The status.
   */
  com.google.fhir.r4.qicore.QICoreFlag.StatusCode getStatus();
  /**
   * <code>.google.fhir.r4.qicore.QICoreFlag.StatusCode status = 11 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.r4.qicore.QICoreFlag.StatusCodeOrBuilder getStatusOrBuilder();
