...
public class PrimitiveWrappers {
   ...
   * are: a) A primitive does not meet the primitive regex - e.g., a decimal with value "1.2.3" b)
   * The primitive has no value, and has no extensions other than PrimitiveHasNoValue c) The
   * primitive has no value, and does NOT have the PrimitiveHasNoValue extension.
   */
