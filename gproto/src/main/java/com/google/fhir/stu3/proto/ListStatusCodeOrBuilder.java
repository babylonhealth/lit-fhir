...
public interface ListStatusCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.ListStatusCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.ListStatusCode.Value getValue();
