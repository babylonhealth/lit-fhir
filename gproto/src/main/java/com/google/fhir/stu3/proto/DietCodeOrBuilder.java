...
public interface DietCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.DietCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.DietCode.Value getValue();
