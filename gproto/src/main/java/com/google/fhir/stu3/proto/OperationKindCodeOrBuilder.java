...
public interface OperationKindCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.OperationKindCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.OperationKindCode.Value getValue();
