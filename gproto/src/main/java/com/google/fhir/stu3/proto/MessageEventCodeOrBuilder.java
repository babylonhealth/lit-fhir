...
public interface MessageEventCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.MessageEventCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.MessageEventCode.Value getValue();
