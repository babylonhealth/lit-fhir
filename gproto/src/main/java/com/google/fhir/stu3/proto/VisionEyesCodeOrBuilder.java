...
public interface VisionEyesCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.VisionEyesCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.VisionEyesCode.Value getValue();
