...
public interface PropertyTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.PropertyTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.PropertyTypeCode.Value getValue();
