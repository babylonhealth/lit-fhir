...
public interface ActionTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.ActionTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.ActionTypeCode.Value getValue();
