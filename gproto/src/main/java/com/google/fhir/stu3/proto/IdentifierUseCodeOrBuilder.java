...
public interface IdentifierUseCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.IdentifierUseCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.IdentifierUseCode.Value getValue();
