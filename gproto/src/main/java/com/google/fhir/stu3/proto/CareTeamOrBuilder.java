...
public interface CareTeamOrBuilder
   ...
   * </code>
   */
  java.util.List<com.google.fhir.stu3.proto.CareTeam.Participant> getParticipantList();
  /**
   * <code>
   * repeated .google.fhir.stu3.proto.CareTeam.Participant participant = 16 [(.google.fhir.proto.fhir_path_constraint) = "onBehalfOf.exists() implies (member.resolve() is Practitioner)"];
   * </code>
   ...
   * </code>
   */
  com.google.fhir.stu3.proto.CareTeam.ParticipantOrBuilder getParticipantOrBuilder(int index);
