...
public interface LocationModeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.LocationModeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.LocationModeCode.Value getValue();
