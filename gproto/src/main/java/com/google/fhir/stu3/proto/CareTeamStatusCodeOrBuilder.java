...
public interface CareTeamStatusCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.CareTeamStatusCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.CareTeamStatusCode.Value getValue();
