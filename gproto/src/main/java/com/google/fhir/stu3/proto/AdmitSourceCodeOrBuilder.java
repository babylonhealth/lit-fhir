...
public interface AdmitSourceCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.AdmitSourceCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.AdmitSourceCode.Value getValue();
