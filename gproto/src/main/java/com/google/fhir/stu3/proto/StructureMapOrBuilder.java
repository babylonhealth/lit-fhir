...
public interface StructureMapOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.StructureMap)
  ...
  /** <code>repeated .google.fhir.stu3.proto.StructureMap.Structure structure = 24;</code> */
  java.util.List<com.google.fhir.stu3.proto.StructureMap.Structure> getStructureList();
  /** <code>repeated .google.fhir.stu3.proto.StructureMap.Structure structure = 24;</code> */
  com.google.fhir.stu3.proto.StructureMap.Structure getStructure(int index);
  /** <code>repeated .google.fhir.stu3.proto.StructureMap.Structure structure = 24;</code> */
  int getStructureCount();
  /** <code>repeated .google.fhir.stu3.proto.StructureMap.Structure structure = 24;</code> */
  java.util.List<? extends com.google.fhir.stu3.proto.StructureMap.StructureOrBuilder>
      getStructureOrBuilderList();
  /** <code>repeated .google.fhir.stu3.proto.StructureMap.Structure structure = 24;</code> */
  com.google.fhir.stu3.proto.StructureMap.StructureOrBuilder getStructureOrBuilder(int index);
   ...
   * </pre>
   *
   * <code>repeated .google.fhir.stu3.proto.Uri import = 25;</code>
   */
  java.util.List<com.google.fhir.stu3.proto.Uri> getImportList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.fhir.stu3.proto.Uri import = 25;</code>
   */
  com.google.fhir.stu3.proto.Uri getImport(int index);
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.fhir.stu3.proto.Uri import = 25;</code>
   */
  java.util.List<? extends com.google.fhir.stu3.proto.UriOrBuilder> getImportOrBuilderList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.fhir.stu3.proto.Uri import = 25;</code>
   */
  com.google.fhir.stu3.proto.UriOrBuilder getImportOrBuilder(int index);

  /**
   * <code>
   * repeated .google.fhir.stu3.proto.StructureMap.Group group = 26 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];
   * </code>
   */
  java.util.List<com.google.fhir.stu3.proto.StructureMap.Group> getGroupList();
  /**
   * <code>
   * repeated .google.fhir.stu3.proto.StructureMap.Group group = 26 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];
   * </code>
   */
  com.google.fhir.stu3.proto.StructureMap.Group getGroup(int index);
  /**
   * <code>
   * repeated .google.fhir.stu3.proto.StructureMap.Group group = 26 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];
   * </code>
   ...
   * </code>
   */
  java.util.List<? extends com.google.fhir.stu3.proto.StructureMap.GroupOrBuilder>
   ...
   * </code>
   */
  com.google.fhir.stu3.proto.StructureMap.GroupOrBuilder getGroupOrBuilder(int index);
}
