...
public interface IssueSeverityCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.IssueSeverityCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.IssueSeverityCode.Value getValue();
