...
public interface UDIEntryTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.UDIEntryTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.UDIEntryTypeCode.Value getValue();
