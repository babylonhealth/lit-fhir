...
public interface MeasureTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.MeasureTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.MeasureTypeCode.Value getValue();
