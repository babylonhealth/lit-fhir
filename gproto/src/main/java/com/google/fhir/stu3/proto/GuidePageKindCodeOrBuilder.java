...
public interface GuidePageKindCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.GuidePageKindCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.GuidePageKindCode.Value getValue();
