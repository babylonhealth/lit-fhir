...
public interface XPathUsageTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.XPathUsageTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.XPathUsageTypeCode.Value getValue();
