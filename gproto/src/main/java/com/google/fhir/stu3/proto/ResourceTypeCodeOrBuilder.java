...
public interface ResourceTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.ResourceTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.ResourceTypeCode.Value getValue();
