...
public interface EventStatusCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.EventStatusCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.EventStatusCode.Value getValue();
