...
public interface QualityTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.QualityTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.QualityTypeCode.Value getValue();
