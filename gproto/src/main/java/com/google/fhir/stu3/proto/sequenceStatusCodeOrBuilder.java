...
public interface sequenceStatusCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.sequenceStatusCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.sequenceStatusCode.Value getValue();
