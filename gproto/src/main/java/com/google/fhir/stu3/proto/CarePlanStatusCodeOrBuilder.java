...
public interface CarePlanStatusCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.CarePlanStatusCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.CarePlanStatusCode.Value getValue();
