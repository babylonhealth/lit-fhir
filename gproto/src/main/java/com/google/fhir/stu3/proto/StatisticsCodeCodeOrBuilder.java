...
public interface StatisticsCodeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.StatisticsCodeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.StatisticsCodeCode.Value getValue();
