...
public interface LocationStatusCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.LocationStatusCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.LocationStatusCode.Value getValue();
