...
public interface VitalspanelOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.Vitalspanel)
   ...
   * @return The code.
   */
  com.google.fhir.stu3.proto.Vitalspanel.CodeableConceptForCode getCode();
  /**
   * <code>.google.fhir.stu3.proto.Vitalspanel.CodeableConceptForCode code = 13 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.stu3.proto.Vitalspanel.CodeableConceptForCodeOrBuilder getCodeOrBuilder();
   ...
   */
  com.google.fhir.stu3.proto.Vitalspanel.Effective getEffective();
  /**
   * <code>.google.fhir.stu3.proto.Vitalspanel.Effective effective = 16 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR, (.google.fhir.proto.fhir_path_constraint) = "($this as dateTime).toString().length() &gt;= 8"];</code>
   */
  com.google.fhir.stu3.proto.Vitalspanel.EffectiveOrBuilder getEffectiveOrBuilder();
   ...
   */
  java.util.List<com.google.fhir.stu3.proto.Vitalspanel.Related> 
      getRelatedList();
  /**
   * <code>repeated .google.fhir.stu3.proto.Vitalspanel.Related related = 28 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.stu3.proto.Vitalspanel.Related getRelated(int index);
  /**
   * <code>repeated .google.fhir.stu3.proto.Vitalspanel.Related related = 28 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  int getRelatedCount();
   ...
   * <code>repeated .google.fhir.stu3.proto.Vitalspanel.Related related = 28 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  java.util.List<? extends com.google.fhir.stu3.proto.Vitalspanel.RelatedOrBuilder> 
      getRelatedOrBuilderList();
  /**
   * <code>repeated .google.fhir.stu3.proto.Vitalspanel.Related related = 28 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.stu3.proto.Vitalspanel.RelatedOrBuilder getRelatedOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.fhir.stu3.proto.Vitalspanel.Component> 
      getComponentList();
  /**
   * <code>repeated .google.fhir.stu3.proto.Vitalspanel.Component component = 29 [(.google.fhir.proto.fhir_path_constraint) = "value.exists() or dataAbsentReason.exists()"];</code>
   */
  com.google.fhir.stu3.proto.Vitalspanel.Component getComponent(int index);
  /**
   * <code>repeated .google.fhir.stu3.proto.Vitalspanel.Component component = 29 [(.google.fhir.proto.fhir_path_constraint) = "value.exists() or dataAbsentReason.exists()"];</code>
   */
   ...
   * <code>repeated .google.fhir.stu3.proto.Vitalspanel.Component component = 29 [(.google.fhir.proto.fhir_path_constraint) = "value.exists() or dataAbsentReason.exists()"];</code>
   */
  java.util.List<? extends com.google.fhir.stu3.proto.Vitalspanel.ComponentOrBuilder> 
      getComponentOrBuilderList();
  /**
   * <code>repeated .google.fhir.stu3.proto.Vitalspanel.Component component = 29 [(.google.fhir.proto.fhir_path_constraint) = "value.exists() or dataAbsentReason.exists()"];</code>
   */
  com.google.fhir.stu3.proto.Vitalspanel.ComponentOrBuilder getComponentOrBuilder(
      int index);
}
