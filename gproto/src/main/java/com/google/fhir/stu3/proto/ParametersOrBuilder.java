...
public interface ParametersOrBuilder
   ...
   * </code>
   */
  java.util.List<com.google.fhir.stu3.proto.Parameters.Parameter> getParameterList();
  /**
   * <code>
   * repeated .google.fhir.stu3.proto.Parameters.Parameter parameter = 5 [(.google.fhir.proto.fhir_path_constraint) = "(part.exists() and value.empty() and resource.empty()) or (part.empty() and (value.exists() xor resource.exists()))"];
   * </code>
   ...
   * </code>
   */
  com.google.fhir.stu3.proto.Parameters.ParameterOrBuilder getParameterOrBuilder(int index);
}
