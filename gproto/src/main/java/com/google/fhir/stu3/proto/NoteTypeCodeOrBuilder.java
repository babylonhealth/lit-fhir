...
public interface NoteTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.NoteTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.NoteTypeCode.Value getValue();
