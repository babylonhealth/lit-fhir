...
public interface RequestIntentCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.RequestIntentCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.RequestIntentCode.Value getValue();
