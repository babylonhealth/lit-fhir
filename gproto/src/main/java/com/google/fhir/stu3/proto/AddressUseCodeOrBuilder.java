...
public interface AddressUseCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.AddressUseCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.AddressUseCode.Value getValue();
