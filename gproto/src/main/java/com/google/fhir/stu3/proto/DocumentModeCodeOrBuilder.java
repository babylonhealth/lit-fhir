...
public interface DocumentModeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.DocumentModeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.DocumentModeCode.Value getValue();
