...
public interface FilterOperatorCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.FilterOperatorCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.FilterOperatorCode.Value getValue();
