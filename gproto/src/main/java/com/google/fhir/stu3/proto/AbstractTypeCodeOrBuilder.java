...
public interface AbstractTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.AbstractTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.AbstractTypeCode.Value getValue();
