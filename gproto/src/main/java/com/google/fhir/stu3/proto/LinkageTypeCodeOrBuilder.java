...
public interface LinkageTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.LinkageTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.LinkageTypeCode.Value getValue();
