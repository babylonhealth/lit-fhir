...
public interface GoalPriorityCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.GoalPriorityCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.GoalPriorityCode.Value getValue();
