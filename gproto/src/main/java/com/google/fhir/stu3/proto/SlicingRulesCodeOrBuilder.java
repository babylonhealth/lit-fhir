...
public interface SlicingRulesCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.SlicingRulesCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.SlicingRulesCode.Value getValue();
