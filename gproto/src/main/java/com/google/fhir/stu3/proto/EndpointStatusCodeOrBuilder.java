...
public interface EndpointStatusCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.EndpointStatusCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.EndpointStatusCode.Value getValue();
