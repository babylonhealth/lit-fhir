...
public interface SequenceTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.SequenceTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.SequenceTypeCode.Value getValue();
