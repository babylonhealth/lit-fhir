...
public interface TaskStatusCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.TaskStatusCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.TaskStatusCode.Value getValue();
