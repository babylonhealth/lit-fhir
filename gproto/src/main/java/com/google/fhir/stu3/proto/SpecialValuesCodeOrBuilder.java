...
public interface SpecialValuesCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.SpecialValuesCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.SpecialValuesCode.Value getValue();
