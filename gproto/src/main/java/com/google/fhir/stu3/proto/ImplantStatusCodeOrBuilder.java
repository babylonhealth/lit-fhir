...
public interface ImplantStatusCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.ImplantStatusCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.ImplantStatusCode.Value getValue();
