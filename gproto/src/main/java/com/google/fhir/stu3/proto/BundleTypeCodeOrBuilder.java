...
public interface BundleTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.BundleTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.BundleTypeCode.Value getValue();
