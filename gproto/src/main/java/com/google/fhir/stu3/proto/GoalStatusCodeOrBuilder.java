...
public interface GoalStatusCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.GoalStatusCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.GoalStatusCode.Value getValue();
