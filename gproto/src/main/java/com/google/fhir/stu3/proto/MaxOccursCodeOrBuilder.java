...
public interface MaxOccursCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.MaxOccursCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.MaxOccursCode.Value getValue();
