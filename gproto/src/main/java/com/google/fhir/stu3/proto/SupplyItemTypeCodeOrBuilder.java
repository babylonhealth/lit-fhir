...
public interface SupplyItemTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.SupplyItemTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.SupplyItemTypeCode.Value getValue();
