...
public interface ListOrderCodesCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.ListOrderCodesCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.ListOrderCodesCode.Value getValue();
