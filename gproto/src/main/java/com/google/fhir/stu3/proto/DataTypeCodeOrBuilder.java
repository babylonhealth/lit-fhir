...
public interface DataTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.DataTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.DataTypeCode.Value getValue();
