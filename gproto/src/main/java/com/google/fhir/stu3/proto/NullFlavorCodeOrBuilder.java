...
public interface NullFlavorCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.NullFlavorCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.NullFlavorCode.Value getValue();
