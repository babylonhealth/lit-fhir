...
public interface HTTPVerbCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.HTTPVerbCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.HTTPVerbCode.Value getValue();
