...
public interface ResponseTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.ResponseTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.ResponseTypeCode.Value getValue();
