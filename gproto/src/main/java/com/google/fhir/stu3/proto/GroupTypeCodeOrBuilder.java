...
public interface GroupTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.GroupTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.GroupTypeCode.Value getValue();
