...
public interface MatchGradeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.MatchGradeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.MatchGradeCode.Value getValue();
