...
public interface ConsentStateCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.ConsentStateCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.ConsentStateCode.Value getValue();
