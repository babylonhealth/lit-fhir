...
public interface SlotStatusCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.SlotStatusCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.SlotStatusCode.Value getValue();
