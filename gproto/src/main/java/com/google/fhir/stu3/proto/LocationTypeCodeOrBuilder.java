...
public interface LocationTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.LocationTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.LocationTypeCode.Value getValue();
