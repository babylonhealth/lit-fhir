...
public interface GoalCategoryCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.GoalCategoryCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.GoalCategoryCode.Value getValue();
