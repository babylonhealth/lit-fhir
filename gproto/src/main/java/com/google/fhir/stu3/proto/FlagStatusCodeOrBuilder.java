...
public interface FlagStatusCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.FlagStatusCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.FlagStatusCode.Value getValue();
