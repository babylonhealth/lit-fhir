...
public interface CommonTagsCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.CommonTagsCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.CommonTagsCode.Value getValue();
