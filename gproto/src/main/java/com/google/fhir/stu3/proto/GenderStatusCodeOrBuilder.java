...
public interface GenderStatusCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.GenderStatusCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.GenderStatusCode.Value getValue();
