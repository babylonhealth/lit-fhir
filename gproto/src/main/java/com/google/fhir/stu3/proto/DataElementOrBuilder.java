...
public interface DataElementOrBuilder extends
   ...
   */
  java.util.List<com.google.fhir.stu3.proto.DataElement.Mapping> 
      getMappingList();
  /**
   * <code>repeated .google.fhir.stu3.proto.DataElement.Mapping mapping = 23 [(.google.fhir.proto.fhir_path_constraint) = "uri.exists() or name.exists()"];</code>
   */
   ...
   * <code>repeated .google.fhir.stu3.proto.DataElement.Mapping mapping = 23 [(.google.fhir.proto.fhir_path_constraint) = "uri.exists() or name.exists()"];</code>
   */
  com.google.fhir.stu3.proto.DataElement.MappingOrBuilder getMappingOrBuilder(
      int index);
