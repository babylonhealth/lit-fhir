...
public interface ReferralMethodCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.ReferralMethodCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.ReferralMethodCode.Value getValue();
