...
public interface UsCoreConditionOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.uscore.UsCoreCondition)
   ...
   * <code>.google.fhir.stu3.proto.ConditionVerificationStatusCode verification_status = 11 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.stu3.proto.ConditionVerificationStatusCodeOrBuilder getVerificationStatusOrBuilder();
   ...
   * @return The onset.
   */
  com.google.fhir.stu3.uscore.UsCoreCondition.Onset getOnset();
  /**
   * <code>.google.fhir.stu3.uscore.UsCoreCondition.Onset onset = 18;</code>
   */
  com.google.fhir.stu3.uscore.UsCoreCondition.OnsetOrBuilder getOnsetOrBuilder();
   ...
   */
  com.google.fhir.stu3.uscore.UsCoreCondition.Abatement getAbatement();
  /**
   * <code>.google.fhir.stu3.uscore.UsCoreCondition.Abatement abatement = 19;</code>
   */
  com.google.fhir.stu3.uscore.UsCoreCondition.AbatementOrBuilder getAbatementOrBuilder();
   ...
   * @return The stage.
   */
  com.google.fhir.stu3.uscore.UsCoreCondition.Stage getStage();
  /**
   * <code>.google.fhir.stu3.uscore.UsCoreCondition.Stage stage = 22 [(.google.fhir.proto.fhir_path_constraint) = "summary.exists() or assessment.exists()"];</code>
   */
  com.google.fhir.stu3.uscore.UsCoreCondition.StageOrBuilder getStageOrBuilder();
   ...
   */
  java.util.List<com.google.fhir.stu3.uscore.UsCoreCondition.Evidence> 
      getEvidenceList();
  /**
   * <code>repeated .google.fhir.stu3.uscore.UsCoreCondition.Evidence evidence = 23 [(.google.fhir.proto.fhir_path_constraint) = "code.exists() or detail.exists()"];</code>
   */
  com.google.fhir.stu3.uscore.UsCoreCondition.Evidence getEvidence(int index);
  /**
   * <code>repeated .google.fhir.stu3.uscore.UsCoreCondition.Evidence evidence = 23 [(.google.fhir.proto.fhir_path_constraint) = "code.exists() or detail.exists()"];</code>
   */
   ...
   * <code>repeated .google.fhir.stu3.uscore.UsCoreCondition.Evidence evidence = 23 [(.google.fhir.proto.fhir_path_constraint) = "code.exists() or detail.exists()"];</code>
   */
  java.util.List<? extends com.google.fhir.stu3.uscore.UsCoreCondition.EvidenceOrBuilder> 
      getEvidenceOrBuilderList();
  /**
   * <code>repeated .google.fhir.stu3.uscore.UsCoreCondition.Evidence evidence = 23 [(.google.fhir.proto.fhir_path_constraint) = "code.exists() or detail.exists()"];</code>
   */
  com.google.fhir.stu3.uscore.UsCoreCondition.EvidenceOrBuilder getEvidenceOrBuilder(
      int index);
