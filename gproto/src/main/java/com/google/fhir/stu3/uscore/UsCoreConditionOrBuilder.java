...
public interface UsCoreConditionOrBuilder
   ...
   * </code>
   */
  java.util.List<com.google.fhir.stu3.uscore.UsCoreCondition.Evidence> getEvidenceList();
  /**
   * <code>
   * repeated .google.fhir.stu3.uscore.UsCoreCondition.Evidence evidence = 23 [(.google.fhir.proto.fhir_path_constraint) = "code.exists() or detail.exists()"];
   * </code>
   ...
   * </code>
   */
  com.google.fhir.stu3.uscore.UsCoreCondition.EvidenceOrBuilder getEvidenceOrBuilder(int index);
