...
public interface RepositoryTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.RepositoryTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.RepositoryTypeCode.Value getValue();
