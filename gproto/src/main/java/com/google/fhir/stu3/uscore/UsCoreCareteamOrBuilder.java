...
public interface UsCoreCareteamOrBuilder
    extends
   ...
   * </code>
   */
  java.util.List<com.google.fhir.stu3.uscore.UsCoreCareteam.Participant> getParticipantList();
  /**
   * <code>
   * repeated .google.fhir.stu3.uscore.UsCoreCareteam.Participant participant = 16 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR, (.google.fhir.proto.fhir_path_constraint) = "onBehalfOf.exists() implies (member.resolve() is Practitioner)"];
   * </code>
   ...
   * </code>
   */
  java.util.List<com.google.fhir.stu3.proto.Reference> getManagingOrganizationList();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.fhir.stu3.proto.ReferenceOrBuilder getManagingOrganizationOrBuilder(int index);
