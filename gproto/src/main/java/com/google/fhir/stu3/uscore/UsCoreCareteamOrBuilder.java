...
public interface UsCoreCareteamOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.uscore.UsCoreCareteam)
   ...
   * @return The status.
   */
  com.google.fhir.stu3.proto.CareTeamStatusCode getStatus();
  /**
   * <pre>
   * proposed | active | suspended | inactive | entered-in-error
   * </pre>
   ...
   * <code>.google.fhir.stu3.proto.CareTeamStatusCode status = 10 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR];</code>
   */
  com.google.fhir.stu3.proto.CareTeamStatusCodeOrBuilder getStatusOrBuilder();
   ...
   */
  java.util.List<com.google.fhir.stu3.uscore.UsCoreCareteam.Participant> 
      getParticipantList();
  /**
   * <code>repeated .google.fhir.stu3.uscore.UsCoreCareteam.Participant participant = 16 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR, (.google.fhir.proto.fhir_path_constraint) = "onBehalfOf.exists() implies (member.resolve() is Practitioner)"];</code>
   */
  com.google.fhir.stu3.uscore.UsCoreCareteam.Participant getParticipant(int index);
  /**
   * <code>repeated .google.fhir.stu3.uscore.UsCoreCareteam.Participant participant = 16 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR, (.google.fhir.proto.fhir_path_constraint) = "onBehalfOf.exists() implies (member.resolve() is Practitioner)"];</code>
   */
   ...
   * <code>repeated .google.fhir.stu3.uscore.UsCoreCareteam.Participant participant = 16 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR, (.google.fhir.proto.fhir_path_constraint) = "onBehalfOf.exists() implies (member.resolve() is Practitioner)"];</code>
   */
  java.util.List<? extends com.google.fhir.stu3.uscore.UsCoreCareteam.ParticipantOrBuilder> 
      getParticipantOrBuilderList();
  /**
   * <code>repeated .google.fhir.stu3.uscore.UsCoreCareteam.Participant participant = 16 [(.google.fhir.proto.validation_requirement) = REQUIRED_BY_FHIR, (.google.fhir.proto.fhir_path_constraint) = "onBehalfOf.exists() implies (member.resolve() is Practitioner)"];</code>
   */
  com.google.fhir.stu3.uscore.UsCoreCareteam.ParticipantOrBuilder getParticipantOrBuilder(
      int index);
   ...
   * <code>repeated .google.fhir.stu3.proto.Reference managing_organization = 19 [(.google.fhir.proto.valid_reference_type) = "Organization"];</code>
   */
  com.google.fhir.stu3.proto.Reference getManagingOrganization(int index);
  /**
   * <pre>
   * Organization responsible for the care team
   * </pre>
