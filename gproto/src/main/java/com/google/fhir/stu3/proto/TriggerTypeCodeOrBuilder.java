...
public interface TriggerTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.TriggerTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.TriggerTypeCode.Value getValue();
