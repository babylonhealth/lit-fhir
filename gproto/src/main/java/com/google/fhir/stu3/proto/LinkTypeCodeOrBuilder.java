...
public interface LinkTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.LinkTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.LinkTypeCode.Value getValue();
