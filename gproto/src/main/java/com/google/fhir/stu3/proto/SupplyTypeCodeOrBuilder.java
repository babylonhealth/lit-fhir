...
public interface SupplyTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.SupplyTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.SupplyTypeCode.Value getValue();
