...
public interface ListModeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.ListModeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.ListModeCode.Value getValue();
