...
public interface SpecimenStatusCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.SpecimenStatusCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.SpecimenStatusCode.Value getValue();
