...
public interface DiagnosisRoleCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.DiagnosisRoleCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.DiagnosisRoleCode.Value getValue();
