...
public interface HL7WorkgroupCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.HL7WorkgroupCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.HL7WorkgroupCode.Value getValue();
