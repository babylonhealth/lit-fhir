...
public interface IssueTypeCodeOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.fhir.stu3.proto.IssueTypeCode)
   ...
   * @return The value.
   */
  com.google.fhir.stu3.proto.IssueTypeCode.Value getValue();
