...
public class TestScript_Setup_ActionBuilder {
  ...
  public TestScript_Setup_ActionBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public TestScript_Setup_ActionBuilder withId(@NonNull String id) {
   ...
   */
  public TestScript_Setup_ActionBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public TestScript_Setup_ActionBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public TestScript_Setup_ActionBuilder withModifierExtension(
  ...
  /** @param _assert */
  public TestScript_Setup_ActionBuilder withAssert(
      @NonNull TestScript$Setup$Action$Assert _assert) {
    this._assert = Optional.of(_assert);
    return this;
  }
  /** @param operation */
  public TestScript_Setup_ActionBuilder withOperation(
