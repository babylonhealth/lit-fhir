...
public interface SubstancePolymer_MonomerSet_StartingMaterialBuilder {
  ...
  public class Impl implements SubstancePolymer_MonomerSet_StartingMaterialBuilder {
     ...
     */
    public SubstancePolymer_MonomerSet_StartingMaterialBuilder.Impl withId(@NonNull String id) {
    ...
    /** @param isDefining */
    public SubstancePolymer_MonomerSet_StartingMaterialBuilder.Impl withIsDefining(
