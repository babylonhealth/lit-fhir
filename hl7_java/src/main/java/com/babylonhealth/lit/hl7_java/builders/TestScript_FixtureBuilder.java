...
public interface TestScript_FixtureBuilder {
  public TestScript.Fixture build();

  public static Impl init(Boolean autocreate, Boolean autodelete) {
  ...
  public class Impl implements TestScript_FixtureBuilder {
     ...
     * @param autodelete
     */
    public Impl(Boolean autocreate, Boolean autodelete) {
     ...
     */
    public TestScript_FixtureBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param resource */
    public TestScript_FixtureBuilder.Impl withResource(@NonNull Reference resource) {
     ...
     */
    public TestScript_FixtureBuilder.Impl withExtension(@NonNull Extension... extension) {
