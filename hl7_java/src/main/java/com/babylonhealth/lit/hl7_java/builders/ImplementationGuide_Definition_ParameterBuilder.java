...
public interface ImplementationGuide_Definition_ParameterBuilder {
  ...
  public class Impl implements ImplementationGuide_Definition_ParameterBuilder {
     ...
     */
    public ImplementationGuide_Definition_ParameterBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public ImplementationGuide_Definition_ParameterBuilder.Impl withExtension(
     ...
     */
    public ImplementationGuide_Definition_ParameterBuilder.Impl withModifierExtension(
