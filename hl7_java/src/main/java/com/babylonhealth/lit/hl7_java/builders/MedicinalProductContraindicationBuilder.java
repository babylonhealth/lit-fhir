...
public class MedicinalProductContraindicationBuilder {
  ...
  public MedicinalProductContraindicationBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public MedicinalProductContraindicationBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public MedicinalProductContraindicationBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public MedicinalProductContraindicationBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param subject - The medication for which this is an indication. */
  public MedicinalProductContraindicationBuilder withSubject(@NonNull Reference... subject) {
    this.subject = Arrays.asList(subject);
    return this;
  }
  /** @param subject - The medication for which this is an indication. */
  public MedicinalProductContraindicationBuilder withSubject(
  ...
  public MedicinalProductContraindicationBuilder withDisease(@NonNull CodeableConcept disease) {
    this.disease = Optional.of(disease);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public MedicinalProductContraindicationBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public MedicinalProductContraindicationBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public MedicinalProductContraindicationBuilder withContained(
   ...
   */
  public MedicinalProductContraindicationBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public MedicinalProductContraindicationBuilder withExtension(
      @NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param population - The population group to which this applies. */
  public MedicinalProductContraindicationBuilder withPopulation(@NonNull Choice... population) {
    this.population = Arrays.asList(population);
    return this;
  }
  /** @param population - The population group to which this applies. */
  public MedicinalProductContraindicationBuilder withPopulation(
  ...
  public MedicinalProductContraindicationBuilder withComorbidity(
   ...
   *     profiles etc.
   */
  public MedicinalProductContraindicationBuilder withImplicitRules(@NonNull String implicitRules) {
    this.implicitRules = Optional.of(implicitRules);
    return this;
  }
  /** @param diseaseStatus - The status of the disease or symptom for the contraindication. */
  public MedicinalProductContraindicationBuilder withDiseaseStatus(
   ...
   */
  public MedicinalProductContraindicationBuilder withModifierExtension(
   ...
   */
  public MedicinalProductContraindicationBuilder withTherapeuticIndication(
   ...
   */
  public MedicinalProductContraindicationBuilder withOtherTherapy(
  ...
  public MedicinalProductContraindication build() {
    return new MedicinalProductContraindication(
        ...
        (Option) OptionConverters.toScala(disease),
