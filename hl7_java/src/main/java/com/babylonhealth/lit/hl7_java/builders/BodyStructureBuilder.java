...
public class BodyStructureBuilder {
   ...
   */
  public BodyStructureBuilder(Reference patient) {
   ...
   */
  public BodyStructureBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public BodyStructureBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public BodyStructureBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param image - Image or images used to identify a location. */
  public BodyStructureBuilder withImage(@NonNull Attachment... image) {
    this.image = Arrays.asList(image);
    return this;
  }
  /** @param image - Image or images used to identify a location. */
  public BodyStructureBuilder withImage(@NonNull Collection<Attachment> image) {
    this.image = Collections.unmodifiableCollection(image);
    return this;
  }
  /** @param active - Whether this body site is in active use. */
  public BodyStructureBuilder withActive(@NonNull Boolean active) {
    this.active = Optional.of(active);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public BodyStructureBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public BodyStructureBuilder withLocation(@NonNull CodeableConcept location) {
   ...
   */
  public BodyStructureBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public BodyStructureBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public BodyStructureBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public BodyStructureBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param identifier - Identifier for this instance of the anatomical structure. */
  public BodyStructureBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - Identifier for this instance of the anatomical structure. */
  public BodyStructureBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public BodyStructureBuilder withMorphology(@NonNull CodeableConcept morphology) {
    this.morphology = Optional.of(morphology);
    return this;
  }
  /** @param description - A summary, characterization or explanation of the body structure. */
  public BodyStructureBuilder withDescription(@NonNull String description) {
   ...
   *     profiles etc.
   */
  public BodyStructureBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public BodyStructureBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public BodyStructureBuilder withModifierExtension(
   ...
   */
  public BodyStructureBuilder withLocationQualifier(@NonNull CodeableConcept... locationQualifier) {
   ...
   *     qualifiers for laterality, relative location, directionality, number, and plane.
   */
  public BodyStructureBuilder withLocationQualifier(
  ...
  public BodyStructure build() {
    return new BodyStructure(
        ...
        (Option) OptionConverters.toScala(morphology),
