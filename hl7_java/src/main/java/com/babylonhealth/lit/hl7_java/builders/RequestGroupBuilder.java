...
public class RequestGroupBuilder {
   ...
   * @param intent - Indicates the level of authority/intentionality associated with the request and
   *     where the request fits into the workflow chain.
   */
  public RequestGroupBuilder(REQUEST_STATUS status, REQUEST_INTENT intent) {
    this.status = status;
    this.intent = intent;
  }
   ...
   */
  public RequestGroupBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public RequestGroupBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public RequestGroupBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param code - A code that identifies what the overall request group is. */
  public RequestGroupBuilder withCode(@NonNull CodeableConcept code) {
   ...
   */
  public RequestGroupBuilder withNote(@NonNull Annotation... note) {
   ...
   * @param note - Provides a mechanism to communicate additional information about the response.
   */
  public RequestGroupBuilder withNote(@NonNull Collection<Annotation> note) {
    this.note = Collections.unmodifiableCollection(note);
    return this;
  }
  /** @param author - Provides a reference to the author of the request group. */
  public RequestGroupBuilder withAuthor(@NonNull Reference author) {
   ...
   *     request.
   */
  public RequestGroupBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     request.
   */
  public RequestGroupBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param subject - The subject for which the request group was created. */
  public RequestGroupBuilder withSubject(@NonNull Reference subject) {
    this.subject = Optional.of(subject);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public RequestGroupBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   *     request.
   */
  public RequestGroupBuilder withReplaces(@NonNull Reference... replaces) {
   ...
   *     request.
   */
  public RequestGroupBuilder withReplaces(@NonNull Collection<Reference> replaces) {
   ...
   *     requests.
   */
  public RequestGroupBuilder withPriority(@NonNull REQUEST_PRIORITY priority) {
   ...
   */
  public RequestGroupBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public RequestGroupBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public RequestGroupBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public RequestGroupBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param encounter - Describes the context of the request group, if any. */
  public RequestGroupBuilder withEncounter(@NonNull Reference encounter) {
   ...
   */
  public RequestGroupBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   * @param identifier - Allows a service to provide a unique, business identifier for the request.
   */
  public RequestGroupBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
    this.identifier = Collections.unmodifiableCollection(identifier);
    return this;
  }
  /** @param authoredOn - Indicates when the request group was created. */
  public RequestGroupBuilder withAuthoredOn(@NonNull FHIRDateTime authoredOn) {
  ...
  public RequestGroupBuilder withReasonCode(@NonNull CodeableConcept... reasonCode) {
    this.reasonCode = Arrays.asList(reasonCode);
    return this;
  }
  /** @param reasonCode - Describes the reason for the request group in coded or textual form. */
  public RequestGroupBuilder withReasonCode(@NonNull Collection<CodeableConcept> reasonCode) {
   ...
   *     profiles etc.
   */
  public RequestGroupBuilder withImplicitRules(@NonNull String implicitRules) {
    this.implicitRules = Optional.of(implicitRules);
    return this;
  }
  /**
   * @param instantiatesUri - A URL referencing an externally defined protocol, guideline, orderset
   *     or other definition that is adhered to in whole or in part by this request.
   */
  public RequestGroupBuilder withInstantiatesUri(@NonNull String... instantiatesUri) {
   ...
   *     or other definition that is adhered to in whole or in part by this request.
   */
  public RequestGroupBuilder withInstantiatesUri(@NonNull Collection<String> instantiatesUri) {
   ...
   */
  public RequestGroupBuilder withGroupIdentifier(@NonNull Identifier groupIdentifier) {
   ...
   *     group.
   */
  public RequestGroupBuilder withReasonReference(@NonNull Reference... reasonReference) {
   ...
   *     group.
   */
  public RequestGroupBuilder withReasonReference(@NonNull Collection<Reference> reasonReference) {
   ...
   */
  public RequestGroupBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public RequestGroupBuilder withModifierExtension(
      @NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /**
   * @param instantiatesCanonical - A canonical URL referencing a FHIR-defined protocol, guideline,
   *     orderset or other definition that is adhered to in whole or in part by this request.
   */
  public RequestGroupBuilder withInstantiatesCanonical(@NonNull String... instantiatesCanonical) {
   ...
   *     orderset or other definition that is adhered to in whole or in part by this request.
   */
  public RequestGroupBuilder withInstantiatesCanonical(
  ...
  public RequestGroupBuilder withAction(@NonNull RequestGroup.Action... action) {
    this.action = Arrays.asList(action);
    return this;
  }
  /** @param action - The actions, if any, produced by the evaluation of the artifact. */
  public RequestGroupBuilder withAction(@NonNull Collection<RequestGroup.Action> action) {
