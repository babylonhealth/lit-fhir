...
public class ResearchDefinitionBuilder {
   ...
   */
  public ResearchDefinitionBuilder withId(@NonNull String id) {
   ...
   *     which an authoritative instance of this research definition is (or will be) published. This
   *     URL can be the target of a canonical reference. It SHALL remain the same when the research
   *     definition is stored on different servers.
   */
  public ResearchDefinitionBuilder withUrl(@NonNull String url) {
   ...
   *     to the resource.
   */
  public ResearchDefinitionBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public ResearchDefinitionBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /**
   * @param name - A natural language name identifying the research definition. This name should be
   *     usable as an identifier for the module by machine processing applications such as code
   *     generation.
   */
  public ResearchDefinitionBuilder withName(@NonNull String name) {
   ...
   *     definition changes.
   */
  public ResearchDefinitionBuilder withDate(@NonNull FHIRDateTime date) {
    this.date = Optional.of(date);
    return this;
  }
  /** @param title - A short, descriptive, user-friendly title for the research definition. */
  public ResearchDefinitionBuilder withTitle(@NonNull String title) {
   ...
   */
  public ResearchDefinitionBuilder withUsage(@NonNull String usage) {
   ...
   */
  public ResearchDefinitionBuilder withTopic(@NonNull CodeableConcept... topic) {
   ...
   *     useful for filtering and searching.
   */
  public ResearchDefinitionBuilder withTopic(@NonNull Collection<CodeableConcept> topic) {
   ...
   */
  public ResearchDefinitionBuilder withAuthor(@NonNull ContactDetail... author) {
   ...
   *     maintenance of the content.
   */
  public ResearchDefinitionBuilder withAuthor(@NonNull Collection<ContactDetail> author) {
   ...
   *     the content.
   */
  public ResearchDefinitionBuilder withEditor(@NonNull ContactDetail... editor) {
   ...
   *     the content.
   */
  public ResearchDefinitionBuilder withEditor(@NonNull Collection<ContactDetail> editor) {
   ...
   *     arbitrary value managed by the research definition author and is not expected to be
   ...
   */
  public ResearchDefinitionBuilder withVersion(@NonNull String version) {
   ...
   *     publisher.
   */
  public ResearchDefinitionBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public ResearchDefinitionBuilder withContact(@NonNull Collection<ContactDetail> contact) {
    this.contact = Collections.unmodifiableCollection(contact);
    return this;
  }
  /** @param comment - A human-readable string to clarify or explain concepts about the resource. */
  public ResearchDefinitionBuilder withComment(@NonNull String... comment) {
    this.comment = Arrays.asList(comment);
    return this;
  }
  /** @param comment - A human-readable string to clarify or explain concepts about the resource. */
  public ResearchDefinitionBuilder withComment(@NonNull Collection<String> comment) {
   ...
   *     designed as it has.
   */
  public ResearchDefinitionBuilder withPurpose(@NonNull String purpose) {
   ...
   *     ResearchDefinition.
   */
  public ResearchDefinitionBuilder withLibrary(@NonNull String... library) {
   ...
   *     ResearchDefinition.
   */
  public ResearchDefinitionBuilder withLibrary(@NonNull Collection<String> library) {
   ...
   *     for the research.
   */
  public ResearchDefinitionBuilder withOutcome(@NonNull Reference outcome) {
    this.outcome = Optional.of(outcome);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public ResearchDefinitionBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public ResearchDefinitionBuilder withSubtitle(@NonNull String subtitle) {
   ...
   *     of the content.
   */
  public ResearchDefinitionBuilder withReviewer(@NonNull ContactDetail... reviewer) {
   ...
   *     of the content.
   */
  public ResearchDefinitionBuilder withReviewer(@NonNull Collection<ContactDetail> reviewer) {
   ...
   */
  public ResearchDefinitionBuilder withEndorser(@NonNull ContactDetail... endorser) {
   ...
   *     content for use in some setting.
   */
  public ResearchDefinitionBuilder withEndorser(@NonNull Collection<ContactDetail> endorser) {
   ...
   *     for the research.
   */
  public ResearchDefinitionBuilder withExposure(@NonNull Reference exposure) {
   ...
   */
  public ResearchDefinitionBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public ResearchDefinitionBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public ResearchDefinitionBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ResearchDefinitionBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     definition.
   */
  public ResearchDefinitionBuilder withPublisher(@NonNull String publisher) {
   ...
   */
  public ResearchDefinitionBuilder withCopyright(@NonNull String copyright) {
    this.copyright = Optional.of(copyright);
    return this;
  }
  /**
   * @param identifier - A formal identifier that is used to identify this research definition when
   *     it is represented in other formats, or referenced in a specification, model, design or an
   *     instance.
   */
  public ResearchDefinitionBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     instance.
   */
  public ResearchDefinitionBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public ResearchDefinitionBuilder withShortTitle(@NonNull String shortTitle) {
   ...
   */
  public <T> ResearchDefinitionBuilder withSubject(@NonNull T subject) {
    var guessedSuffix =
        autoSuffix(subject.getClass().getSimpleName(), ResearchDefinition$.MODULE$.subject());
   ...
   */
  public <T> ResearchDefinitionBuilder withSubject(String suffix, @NonNull T subject) {
    guard(subject.getClass().getSimpleName(), suffix, ResearchDefinition$.MODULE$.subject());
    this.subject =
        Optional.of(
            (Choice)
                Choice$.MODULE$.fromSuffix(suffix, subject, ResearchDefinition$.MODULE$.subject()));
    return this;
  }
  /**
   ...
   */
  public ResearchDefinitionBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate research definition instances.
   */
  public ResearchDefinitionBuilder withUseContext(@NonNull Collection<UsageContext> useContext) {
   ...
   */
  public ResearchDefinitionBuilder withDescription(@NonNull String description) {
   ...
   *     genuine usage.
   */
  public ResearchDefinitionBuilder withExperimental(@NonNull Boolean experimental) {
    this.experimental = Optional.of(experimental);
    return this;
  }
  /**
   * @param jurisdiction - A legal or geographic region in which the research definition is intended
   *     to be used.
   */
  public ResearchDefinitionBuilder withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
   ...
   *     to be used.
   */
  public ResearchDefinitionBuilder withJurisdiction(
   ...
   */
  public ResearchDefinitionBuilder withApprovalDate(@NonNull FHIRDate approvalDate) {
   ...
   *     profiles etc.
   */
  public ResearchDefinitionBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public ResearchDefinitionBuilder withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
   ...
   */
  public ResearchDefinitionBuilder withEffectivePeriod(@NonNull Period effectivePeriod) {
   ...
   */
  public ResearchDefinitionBuilder withRelatedArtifact(
   ...
   */
  public ResearchDefinitionBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public ResearchDefinitionBuilder withModifierExtension(
   ...
   */
  public ResearchDefinitionBuilder withExposureAlternative(@NonNull Reference exposureAlternative) {
    this.exposureAlternative = Optional.of(exposureAlternative);
    return this;
  }

  public ResearchDefinitionBuilder withoutMeta() {
