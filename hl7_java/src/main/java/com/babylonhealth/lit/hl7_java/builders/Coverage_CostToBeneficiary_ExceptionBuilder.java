...
public class Coverage_CostToBeneficiary_ExceptionBuilder {
   ...
   */
  public Coverage_CostToBeneficiary_ExceptionBuilder(CodeableConcept _type) {
    this._type = _type;
  }
   ...
   */
  public Coverage_CostToBeneficiary_ExceptionBuilder withId(@NonNull String id) {
   ...
   *     to be in force.
   */
  public Coverage_CostToBeneficiary_ExceptionBuilder withPeriod(@NonNull Period period) {
   ...
   */
  public Coverage_CostToBeneficiary_ExceptionBuilder withExtension(
   ...
   */
  public Coverage_CostToBeneficiary_ExceptionBuilder withModifierExtension(
