...
public interface Contract_RuleBuilder {
  ...
  public class Impl implements Contract_RuleBuilder {
    ...
    /**
     * Required fields for {@link Contract.Rule}
     *
     * @param content Field is a 'choice' field. Type should be one of Attachment, Reference. To
     *     pass the value in, wrap with one of the Contract_RuleBuilder.content static methods
     */
     ...
     */
    public Contract_RuleBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public Contract_RuleBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public Contract_RuleBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public Contract_RuleBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
     ...
     */
    public Contract_RuleBuilder.Impl withModifierExtension(
