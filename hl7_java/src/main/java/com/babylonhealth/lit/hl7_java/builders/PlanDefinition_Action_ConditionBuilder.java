...
public interface PlanDefinition_Action_ConditionBuilder {
  ...
  public class Impl implements PlanDefinition_Action_ConditionBuilder {
     ...
     */
    public PlanDefinition_Action_ConditionBuilder.Impl withId(@NonNull String id) {
