...
public class AuditEventBuilder {
   ...
   */
  public AuditEventBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public AuditEventBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public AuditEventBuilder withText(@NonNull Narrative text) {
   ...
   *     audit.
   */
  public AuditEventBuilder withAction(@NonNull AUDIT_EVENT_ACTION action) {
    this.action = Optional.of(action);
    return this;
  }
  /** @param period - The period during which the activity occurred. */
  public AuditEventBuilder withPeriod(@NonNull Period period) {
    this.period = Optional.of(period);
    return this;
  }
  /** @param subtype - Identifier for the category of event. */
  public AuditEventBuilder withSubtype(@NonNull Coding... subtype) {
    this.subtype = Arrays.asList(subtype);
    return this;
  }
  /** @param subtype - Identifier for the category of event. */
  public AuditEventBuilder withSubtype(@NonNull Collection<Coding> subtype) {
    this.subtype = Collections.unmodifiableCollection(subtype);
    return this;
  }
  /** @param outcome - Indicates whether the event succeeded or failed. */
  public AuditEventBuilder withOutcome(@NonNull AUDIT_EVENT_OUTCOME outcome) {
    this.outcome = Optional.of(outcome);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public AuditEventBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public AuditEventBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public AuditEventBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public AuditEventBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public AuditEventBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param outcomeDesc - A free text description of the outcome of the event. */
  public AuditEventBuilder withOutcomeDesc(@NonNull String outcomeDesc) {
   ...
   *     profiles etc.
   */
  public AuditEventBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     recorded.
   */
  public AuditEventBuilder withPurposeOfEvent(@NonNull CodeableConcept... purposeOfEvent) {
   ...
   *     recorded.
   */
  public AuditEventBuilder withPurposeOfEvent(@NonNull Collection<CodeableConcept> purposeOfEvent) {
   ...
   */
  public AuditEventBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public AuditEventBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param entity - Specific instances of data or objects that have been accessed. */
  public AuditEventBuilder withEntity(@NonNull AuditEvent.Entity... entity) {
    this.entity = Arrays.asList(entity);
    return this;
  }
  /** @param entity - Specific instances of data or objects that have been accessed. */
  public AuditEventBuilder withEntity(@NonNull Collection<AuditEvent.Entity> entity) {
