...
public class ClaimResponse_Item_Detail_SubDetailBuilder {
   ...
   */
  public ClaimResponse_Item_Detail_SubDetailBuilder(Integer subDetailSequence) {
   ...
   */
  public ClaimResponse_Item_Detail_SubDetailBuilder withId(@NonNull String id) {
   ...
   */
  public ClaimResponse_Item_Detail_SubDetailBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ClaimResponse_Item_Detail_SubDetailBuilder withExtension(
      @NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param noteNumber */
  public ClaimResponse_Item_Detail_SubDetailBuilder withNoteNumber(@NonNull Integer... noteNumber) {
    this.noteNumber = Arrays.asList(noteNumber);
    return this;
  }
  /** @param noteNumber */
  public ClaimResponse_Item_Detail_SubDetailBuilder withNoteNumber(
   ...
   */
  public ClaimResponse_Item_Detail_SubDetailBuilder withAdjudication(
   ...
   */
  public ClaimResponse_Item_Detail_SubDetailBuilder withModifierExtension(
