...
public class PlanDefinitionBuilder {
   ...
   */
  public PlanDefinitionBuilder withId(@NonNull String id) {
   ...
   */
  public PlanDefinitionBuilder withUrl(@NonNull String url) {
   ...
   *     to the resource.
   */
  public PlanDefinitionBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public PlanDefinitionBuilder withText(@NonNull Narrative text) {
   ...
   *     generation.
   */
  public PlanDefinitionBuilder withName(@NonNull String name) {
   ...
   */
  public PlanDefinitionBuilder withType(@NonNull CodeableConcept _type) {
   ...
   *     changes.
   */
  public PlanDefinitionBuilder withDate(@NonNull FHIRDateTime date) {
    this.date = Optional.of(date);
    return this;
  }
  /** @param title - A short, descriptive, user-friendly title for the plan definition. */
  public PlanDefinitionBuilder withTitle(@NonNull String title) {
   ...
   *     perspective.
   */
  public PlanDefinitionBuilder withUsage(@NonNull String usage) {
   ...
   *     searching.
   */
  public PlanDefinitionBuilder withTopic(@NonNull CodeableConcept... topic) {
   ...
   *     searching.
   */
  public PlanDefinitionBuilder withTopic(@NonNull Collection<CodeableConcept> topic) {
   ...
   */
  public PlanDefinitionBuilder withAuthor(@NonNull ContactDetail... author) {
   ...
   *     maintenance of the content.
   */
  public PlanDefinitionBuilder withAuthor(@NonNull Collection<ContactDetail> author) {
   ...
   *     the content.
   */
  public PlanDefinitionBuilder withEditor(@NonNull ContactDetail... editor) {
   ...
   *     the content.
   */
  public PlanDefinitionBuilder withEditor(@NonNull Collection<ContactDetail> editor) {
   ...
   */
  public PlanDefinitionBuilder withVersion(@NonNull String version) {
   ...
   *     publisher.
   */
  public PlanDefinitionBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public PlanDefinitionBuilder withContact(@NonNull Collection<ContactDetail> contact) {
   ...
   *     as it has.
   */
  public PlanDefinitionBuilder withPurpose(@NonNull String purpose) {
   ...
   *     definition.
   */
  public PlanDefinitionBuilder withLibrary(@NonNull String... library) {
   ...
   *     definition.
   */
  public PlanDefinitionBuilder withLibrary(@NonNull Collection<String> library) {
    this.library = Collections.unmodifiableCollection(library);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public PlanDefinitionBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public PlanDefinitionBuilder withSubtitle(@NonNull String subtitle) {
   ...
   *     of the content.
   */
  public PlanDefinitionBuilder withReviewer(@NonNull ContactDetail... reviewer) {
   ...
   *     of the content.
   */
  public PlanDefinitionBuilder withReviewer(@NonNull Collection<ContactDetail> reviewer) {
   ...
   */
  public PlanDefinitionBuilder withEndorser(@NonNull ContactDetail... endorser) {
   ...
   *     content for use in some setting.
   */
  public PlanDefinitionBuilder withEndorser(@NonNull Collection<ContactDetail> endorser) {
   ...
   */
  public PlanDefinitionBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public PlanDefinitionBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public PlanDefinitionBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public PlanDefinitionBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     definition.
   */
  public PlanDefinitionBuilder withPublisher(@NonNull String publisher) {
   ...
   *     definition.
   */
  public PlanDefinitionBuilder withCopyright(@NonNull String copyright) {
   ...
   *     instance.
   */
  public PlanDefinitionBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     instance.
   */
  public PlanDefinitionBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public <T> PlanDefinitionBuilder withSubject(@NonNull T subject) {
    var guessedSuffix =
        autoSuffix(subject.getClass().getSimpleName(), PlanDefinition$.MODULE$.subject());
   ...
   */
  public <T> PlanDefinitionBuilder withSubject(String suffix, @NonNull T subject) {
    guard(subject.getClass().getSimpleName(), suffix, PlanDefinition$.MODULE$.subject());
    this.subject =
        Optional.of(
            (Choice)
                Choice$.MODULE$.fromSuffix(suffix, subject, PlanDefinition$.MODULE$.subject()));
    return this;
  }
  /**
   ...
   */
  public PlanDefinitionBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate plan definition instances.
   */
  public PlanDefinitionBuilder withUseContext(@NonNull Collection<UsageContext> useContext) {
   ...
   */
  public PlanDefinitionBuilder withDescription(@NonNull String description) {
   ...
   *     genuine usage.
   */
  public PlanDefinitionBuilder withExperimental(@NonNull Boolean experimental) {
   ...
   *     be used.
   */
  public PlanDefinitionBuilder withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
   ...
   *     be used.
   */
  public PlanDefinitionBuilder withJurisdiction(@NonNull Collection<CodeableConcept> jurisdiction) {
   ...
   */
  public PlanDefinitionBuilder withApprovalDate(@NonNull FHIRDate approvalDate) {
   ...
   *     profiles etc.
   */
  public PlanDefinitionBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public PlanDefinitionBuilder withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
   ...
   *     to be in active use.
   */
  public PlanDefinitionBuilder withEffectivePeriod(@NonNull Period effectivePeriod) {
   ...
   */
  public PlanDefinitionBuilder withRelatedArtifact(@NonNull RelatedArtifact... relatedArtifact) {
   ...
   *     bibliographic references.
   */
  public PlanDefinitionBuilder withRelatedArtifact(
   ...
   */
  public PlanDefinitionBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public PlanDefinitionBuilder withModifierExtension(
   ...
   */
  public PlanDefinitionBuilder withGoal(@NonNull PlanDefinition.Goal... goal) {
   ...
   *     via immunization, meeting a process improvement objective, etc.
   */
  public PlanDefinitionBuilder withGoal(@NonNull Collection<PlanDefinition.Goal> goal) {
  ...
  public PlanDefinitionBuilder withAction(@NonNull PlanDefinition.Action... action) {
    this.action = Arrays.asList(action);
    return this;
  }
  /** @param action - An action or group of actions to be taken as part of the plan. */
  public PlanDefinitionBuilder withAction(@NonNull Collection<PlanDefinition.Action> action) {
