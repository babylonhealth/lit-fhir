...
public interface Encounter_ParticipantBuilder {
  ...
  public class Impl implements Encounter_ParticipantBuilder {
     ...
     */
    public Encounter_ParticipantBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public Encounter_ParticipantBuilder.Impl withType(@NonNull CodeableConcept... _type) {
     ...
     *     skilled nursing, rehabilitation).
     */
    public Encounter_ParticipantBuilder.Impl withType(@NonNull Collection<CodeableConcept> _type) {
     ...
     */
    public Encounter_ParticipantBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public Encounter_ParticipantBuilder.Impl withExtension(
