...
public interface ExampleScenarioBuilder extends CanonicalResourceBuilder {
  ...
  public class Impl implements ExampleScenarioBuilder {
     ...
     */
    public ExampleScenarioBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public ExampleScenarioBuilder.Impl withUrl(@NonNull String url) {
     ...
     */
    public ExampleScenarioBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     *     generation.
     */
    public ExampleScenarioBuilder.Impl withName(@NonNull String name) {
     ...
     */
    public ExampleScenarioBuilder.Impl withDate(@NonNull FHIRDateTime date) {
     ...
     *     sequence.
     */
    public ExampleScenarioBuilder.Impl withVersion(@NonNull String version) {
     ...
     *     publisher.
     */
    public ExampleScenarioBuilder.Impl withContact(@NonNull ContactDetail... contact) {
     ...
     *     publisher.
     */
    public ExampleScenarioBuilder.Impl withContact(@NonNull Collection<ContactDetail> contact) {
     ...
     *     scenario.
     */
    public ExampleScenarioBuilder.Impl withPurpose(@NonNull String purpose) {
      this.purpose = Optional.of(purpose);
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public ExampleScenarioBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
      this.language = Optional.of(language);
      return this;
    }
    /** @param workflow - Another nested workflow. */
    public ExampleScenarioBuilder.Impl withWorkflow(@NonNull String... workflow) {
      this.workflow = Arrays.asList(workflow);
      return this;
    }
    /** @param workflow - Another nested workflow. */
    public ExampleScenarioBuilder.Impl withWorkflow(@NonNull Collection<String> workflow) {
     ...
     */
    public ExampleScenarioBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     their own independent transaction scope.
     */
    public ExampleScenarioBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
     ...
     */
    public ExampleScenarioBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     scenario.
     */
    public ExampleScenarioBuilder.Impl withPublisher(@NonNull String publisher) {
      this.publisher = Optional.of(publisher);
      return this;
    }
    /**
     * @param copyright - A copyright statement relating to the example scenario and/or its
     *     contents. Copyright statements are generally legal restrictions on the use and publishing
     *     of the example scenario.
     */
    public ExampleScenarioBuilder.Impl withCopyright(@NonNull String copyright) {
      this.copyright = Optional.of(copyright);
      return this;
    }
    /**
     * @param identifier - A formal identifier that is used to identify this example scenario when
     *     it is represented in other formats, or referenced in a specification, model, design or an
     *     instance.
     */
    public ExampleScenarioBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     *     instance.
     */
    public ExampleScenarioBuilder.Impl withIdentifier(@NonNull Collection<Identifier> identifier) {
     ...
     */
    public ExampleScenarioBuilder.Impl withUseContext(@NonNull UsageContext... useContext) {
     ...
     *     genuine usage.
     */
    public ExampleScenarioBuilder.Impl withExperimental(@NonNull Boolean experimental) {
      this.experimental = Optional.of(experimental);
      return this;
    }
    /**
     * @param jurisdiction - A legal or geographic region in which the example scenario is intended
     *     to be used.
     */
    public ExampleScenarioBuilder.Impl withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
     ...
     *     profiles etc.
     */
    public ExampleScenarioBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
    ...
    public ExampleScenarioBuilder.Impl withProcess(@NonNull ExampleScenario.Process... process) {
