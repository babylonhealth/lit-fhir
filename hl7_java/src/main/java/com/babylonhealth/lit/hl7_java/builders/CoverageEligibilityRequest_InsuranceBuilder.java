...
public interface CoverageEligibilityRequest_InsuranceBuilder {
  ...
  public class Impl implements CoverageEligibilityRequest_InsuranceBuilder {
     ...
     */
    public CoverageEligibilityRequest_InsuranceBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param focal */
    public CoverageEligibilityRequest_InsuranceBuilder.Impl withFocal(@NonNull Boolean focal) {
     ...
     */
    public CoverageEligibilityRequest_InsuranceBuilder.Impl withExtension(
     ...
     */
    public CoverageEligibilityRequest_InsuranceBuilder.Impl withModifierExtension(
    ...
    public CoverageEligibilityRequest_InsuranceBuilder.Impl withBusinessArrangement(
