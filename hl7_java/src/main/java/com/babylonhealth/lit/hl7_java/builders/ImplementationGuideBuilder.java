...
public interface ImplementationGuideBuilder extends DomainResourceBuilder {
  ...
  public class Impl implements ImplementationGuideBuilder {
     ...
     */
    public ImplementationGuideBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public ImplementationGuideBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     *     guide changes.
     */
    public ImplementationGuideBuilder.Impl withDate(@NonNull FHIRDateTime date) {
      this.date = Optional.of(date);
      return this;
    }
    /** @param title - A short, descriptive, user-friendly title for the implementation guide. */
    public ImplementationGuideBuilder.Impl withTitle(@NonNull String title) {
     ...
     */
    public ImplementationGuideBuilder.Impl withVersion(@NonNull String version) {
     ...
     *     publisher.
     */
    public ImplementationGuideBuilder.Impl withContact(@NonNull ContactDetail... contact) {
     ...
     *     publisher.
     */
    public ImplementationGuideBuilder.Impl withContact(@NonNull Collection<ContactDetail> contact) {
     ...
     */
    public ImplementationGuideBuilder.Impl withLicense(@NonNull SPDX_LICENSE license) {
      this.license = Optional.of(license);
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public ImplementationGuideBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public ImplementationGuideBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     */
    public ImplementationGuideBuilder.Impl withPublisher(@NonNull String publisher) {
     ...
     */
    public ImplementationGuideBuilder.Impl withCopyright(@NonNull String copyright) {
     ...
     */
    public ImplementationGuideBuilder.Impl withUseContext(@NonNull UsageContext... useContext) {
     ...
     */
    public ImplementationGuideBuilder.Impl withDescription(@NonNull String description) {
     ...
     *     for genuine usage.
     */
    public ImplementationGuideBuilder.Impl withExperimental(@NonNull Boolean experimental) {
     ...
     *     profiles etc.
     */
    public ImplementationGuideBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
    ...
    public ImplementationGuideBuilder.Impl withGlobal(
        @NonNull ImplementationGuide.Global... global) {
    ...
    /**
     * @param dependsOn - Another implementation guide that this implementation depends on.
     *     Typically, an implementation guide uses value sets, profiles etc.defined in other
    ...
    public ImplementationGuideBuilder.Impl withManifest(
        @NonNull ImplementationGuide.Manifest manifest) {
