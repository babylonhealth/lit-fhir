...
public class AccountBuilder {
   ...
   */
  public AccountBuilder(ACCOUNT_STATUS status) {
    this.status = status;
  }
   ...
   */
  public AccountBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public AccountBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public AccountBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param _type - Categorizes the account for reporting and searching purposes. */
  public AccountBuilder withType(@NonNull CodeableConcept _type) {
    this._type = Optional.of(_type);
    return this;
  }
  /** @param name - Name used for the account when displaying it to humans in reports, etc. */
  public AccountBuilder withName(@NonNull String name) {
   ...
   */
  public AccountBuilder withOwner(@NonNull Reference owner) {
    this.owner = Optional.of(owner);
    return this;
  }
  /** @param partOf - Reference to a parent Account. */
  public AccountBuilder withPartOf(@NonNull Reference partOf) {
    this.partOf = Optional.of(partOf);
    return this;
  }
  /**
   * @param subject - Identifies the entity which incurs the expenses. While the immediate
   *     recipients of services or goods might be entities related to the subject, the expenses were
   *     ultimately incurred by the subject of the Account.
   */
  public AccountBuilder withSubject(@NonNull Reference... subject) {
   ...
   *     ultimately incurred by the subject of the Account.
   */
  public AccountBuilder withSubject(@NonNull Collection<Reference> subject) {
    this.subject = Collections.unmodifiableCollection(subject);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public AccountBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public AccountBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public AccountBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public AccountBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public AccountBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public AccountBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     intended for human use (e.g. credit card number).
   */
  public AccountBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   *     is used.
   */
  public AccountBuilder withDescription(@NonNull String description) {
   ...
   *     profiles etc.
   */
  public AccountBuilder withImplicitRules(@NonNull String implicitRules) {
    this.implicitRules = Optional.of(implicitRules);
    return this;
  }
  /** @param servicePeriod - The date range of services associated with this account. */
  public AccountBuilder withServicePeriod(@NonNull Period servicePeriod) {
   ...
   */
  public AccountBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public AccountBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
   ...
   */
  public AccountBuilder withCoverage(@NonNull Account.Coverage... coverage) {
   ...
   *     and what order should they be applied to the account.
   */
  public AccountBuilder withCoverage(@NonNull Collection<Account.Coverage> coverage) {
   ...
   *     fall short.
   */
  public AccountBuilder withGuarantor(@NonNull Account.Guarantor... guarantor) {
   ...
   *     fall short.
   */
  public AccountBuilder withGuarantor(@NonNull Collection<Account.Guarantor> guarantor) {
  ...
  public Account build() {
    return new Account(
        ...
        (Option) OptionConverters.toScala(servicePeriod),
