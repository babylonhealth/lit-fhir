...
public class QuestionnaireBuilder {
  ...
  /**
   * Required fields for {@link Questionnaire}
   *
   * @param status - The status of this questionnaire. Enables tracking the life-cycle of the
   *     content.
   */
  public QuestionnaireBuilder(PUBLICATION_STATUS status) {
    this.status = status;
  }
   ...
   */
  public QuestionnaireBuilder withId(@NonNull String id) {
   ...
   */
  public QuestionnaireBuilder withUrl(@NonNull String url) {
   ...
   *     to the resource.
   */
  public QuestionnaireBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public QuestionnaireBuilder withText(@NonNull Narrative text) {
   ...
   */
  public QuestionnaireBuilder withName(@NonNull String name) {
   ...
   *     changes.
   */
  public QuestionnaireBuilder withDate(@NonNull FHIRDateTime date) {
   ...
   *     such as LOINC.
   */
  public QuestionnaireBuilder withCode(@NonNull Coding... code) {
   ...
   *     such as LOINC.
   */
  public QuestionnaireBuilder withCode(@NonNull Collection<Coding> code) {
  ...
  public QuestionnaireBuilder withTitle(@NonNull String title) {
   ...
   */
  public QuestionnaireBuilder withVersion(@NonNull String version) {
   ...
   *     publisher.
   */
  public QuestionnaireBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public QuestionnaireBuilder withContact(@NonNull Collection<ContactDetail> contact) {
   ...
   *     as it has.
   */
  public QuestionnaireBuilder withPurpose(@NonNull String purpose) {
    this.purpose = Optional.of(purpose);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public QuestionnaireBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public QuestionnaireBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public QuestionnaireBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public QuestionnaireBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public QuestionnaireBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public QuestionnaireBuilder withPublisher(@NonNull String publisher) {
   ...
   *     questionnaire.
   */
  public QuestionnaireBuilder withCopyright(@NonNull String copyright) {
   ...
   *     instance.
   */
  public QuestionnaireBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     instance.
   */
  public QuestionnaireBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public QuestionnaireBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate questionnaire instances.
   */
  public QuestionnaireBuilder withUseContext(@NonNull Collection<UsageContext> useContext) {
    this.useContext = Collections.unmodifiableCollection(useContext);
    return this;
  }
  /** @param derivedFrom - The URL of a Questionnaire that this Questionnaire is based on. */
  public QuestionnaireBuilder withDerivedFrom(@NonNull String... derivedFrom) {
    this.derivedFrom = Arrays.asList(derivedFrom);
    return this;
  }
  /** @param derivedFrom - The URL of a Questionnaire that this Questionnaire is based on. */
  public QuestionnaireBuilder withDerivedFrom(@NonNull Collection<String> derivedFrom) {
   ...
   *     questionnaire.
   */
  public QuestionnaireBuilder withSubjectType(@NonNull RESOURCE_TYPES... subjectType) {
   ...
   *     questionnaire.
   */
  public QuestionnaireBuilder withSubjectType(@NonNull Collection<RESOURCE_TYPES> subjectType) {
   ...
   */
  public QuestionnaireBuilder withDescription(@NonNull String description) {
   ...
   *     genuine usage.
   */
  public QuestionnaireBuilder withExperimental(@NonNull Boolean experimental) {
   ...
   *     used.
   */
  public QuestionnaireBuilder withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
   ...
   *     used.
   */
  public QuestionnaireBuilder withJurisdiction(@NonNull Collection<CodeableConcept> jurisdiction) {
   ...
   */
  public QuestionnaireBuilder withApprovalDate(@NonNull FHIRDate approvalDate) {
   ...
   *     profiles etc.
   */
  public QuestionnaireBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public QuestionnaireBuilder withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
   ...
   *     be in active use.
   */
  public QuestionnaireBuilder withEffectivePeriod(@NonNull Period effectivePeriod) {
   ...
   */
  public QuestionnaireBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public QuestionnaireBuilder withModifierExtension(
   ...
   *     questionnaire.
   */
  public QuestionnaireBuilder withItem(@NonNull Questionnaire.Item... item) {
   ...
   *     questionnaire.
   */
  public QuestionnaireBuilder withItem(@NonNull Collection<Questionnaire.Item> item) {
