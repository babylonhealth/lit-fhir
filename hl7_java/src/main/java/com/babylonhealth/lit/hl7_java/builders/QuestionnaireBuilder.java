...
public interface QuestionnaireBuilder extends DomainResourceBuilder {
  ...
  public class Impl implements QuestionnaireBuilder {
     ...
     */
    public QuestionnaireBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public QuestionnaireBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     *     generation.
     */
    public QuestionnaireBuilder.Impl withName(@NonNull String name) {
     ...
     *     changes.
     */
    public QuestionnaireBuilder.Impl withDate(@NonNull FHIRDateTime date) {
     ...
     */
    public QuestionnaireBuilder.Impl withCode(@NonNull Coding... code) {
     ...
     *     terminology such as LOINC.
     */
    public QuestionnaireBuilder.Impl withCode(@NonNull Collection<Coding> code) {
     ...
     */
    public QuestionnaireBuilder.Impl withVersion(@NonNull String version) {
     ...
     *     publisher.
     */
    public QuestionnaireBuilder.Impl withContact(@NonNull ContactDetail... contact) {
     ...
     *     as it has.
     */
    public QuestionnaireBuilder.Impl withPurpose(@NonNull String purpose) {
      this.purpose = Optional.of(purpose);
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public QuestionnaireBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public QuestionnaireBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     questionnaire.
     */
    public QuestionnaireBuilder.Impl withPublisher(@NonNull String publisher) {
     ...
     *     questionnaire.
     */
    public QuestionnaireBuilder.Impl withCopyright(@NonNull String copyright) {
     ...
     *     instance.
     */
    public QuestionnaireBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     *     instance.
     */
    public QuestionnaireBuilder.Impl withIdentifier(@NonNull Collection<Identifier> identifier) {
     ...
     */
    public QuestionnaireBuilder.Impl withUseContext(@NonNull UsageContext... useContext) {
    ...
    public QuestionnaireBuilder.Impl withDerivedFrom(@NonNull String... derivedFrom) {
      this.derivedFrom = Arrays.asList(derivedFrom);
      return this;
    }
    /** @param derivedFrom - The URL of a Questionnaire that this Questionnaire is based on. */
    public QuestionnaireBuilder.Impl withDerivedFrom(@NonNull Collection<String> derivedFrom) {
     ...
     *     the questionnaire.
     */
    public QuestionnaireBuilder.Impl withSubjectType(@NonNull RESOURCE_TYPES... subjectType) {
     ...
     *     the questionnaire.
     */
    public QuestionnaireBuilder.Impl withSubjectType(
     ...
     */
    public QuestionnaireBuilder.Impl withDescription(@NonNull String description) {
     ...
     *     genuine usage.
     */
    public QuestionnaireBuilder.Impl withExperimental(@NonNull Boolean experimental) {
     ...
     *     be used.
     */
    public QuestionnaireBuilder.Impl withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
     ...
     */
    public QuestionnaireBuilder.Impl withApprovalDate(@NonNull FHIRDate approvalDate) {
     ...
     *     profiles etc.
     */
    public QuestionnaireBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public QuestionnaireBuilder.Impl withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
     ...
     *     questionnaire.
     */
    public QuestionnaireBuilder.Impl withItem(@NonNull Questionnaire.Item... item) {
