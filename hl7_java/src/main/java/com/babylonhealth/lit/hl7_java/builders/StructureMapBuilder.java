...
public interface StructureMapBuilder extends CanonicalResourceBuilder {
  ...
  public class Impl implements StructureMapBuilder {
     ...
     */
    public StructureMapBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public StructureMapBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     *     changes.
     */
    public StructureMapBuilder.Impl withDate(@NonNull FHIRDateTime date) {
      this.date = Optional.of(date);
      return this;
    }
    /** @param title - A short, descriptive, user-friendly title for the structure map. */
    public StructureMapBuilder.Impl withTitle(@NonNull String title) {
      this.title = Optional.of(title);
      return this;
    }
    /** @param _import - Other maps used by this map (canonical URLs). */
    public StructureMapBuilder.Impl withImport(@NonNull String... _import) {
      this._import = Arrays.asList(_import);
      return this;
    }
    /** @param _import - Other maps used by this map (canonical URLs). */
    public StructureMapBuilder.Impl withImport(@NonNull Collection<String> _import) {
      this._import = Collections.unmodifiableCollection(_import);
      return this;
    }
    /**
     * @param version - The identifier that is used to identify this version of the structure map
     *     when it is referenced in a specification, model, design or instance. This is an arbitrary
     *     value managed by the structure map author and is not expected to be globally unique. For
     ...
     */
    public StructureMapBuilder.Impl withVersion(@NonNull String version) {
     ...
     *     publisher.
     */
    public StructureMapBuilder.Impl withContact(@NonNull ContactDetail... contact) {
     ...
     *     publisher.
     */
    public StructureMapBuilder.Impl withContact(@NonNull Collection<ContactDetail> contact) {
     ...
     *     as it has.
     */
    public StructureMapBuilder.Impl withPurpose(@NonNull String purpose) {
      this.purpose = Optional.of(purpose);
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public StructureMapBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public StructureMapBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     their own independent transaction scope.
     */
    public StructureMapBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
     ...
     */
    public StructureMapBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     map.
     */
    public StructureMapBuilder.Impl withPublisher(@NonNull String publisher) {
     ...
     *     structure map.
     */
    public StructureMapBuilder.Impl withCopyright(@NonNull String copyright) {
      this.copyright = Optional.of(copyright);
      return this;
    }
    /**
     * @param identifier - A formal identifier that is used to identify this structure map when it
     *     is represented in other formats, or referenced in a specification, model, design or an
     *     instance.
     */
    public StructureMapBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     *     instance.
     */
    public StructureMapBuilder.Impl withIdentifier(@NonNull Collection<Identifier> identifier) {
     ...
     */
    public StructureMapBuilder.Impl withUseContext(@NonNull UsageContext... useContext) {
     ...
     */
    public StructureMapBuilder.Impl withDescription(@NonNull String description) {
     ...
     *     genuine usage.
     */
    public StructureMapBuilder.Impl withExperimental(@NonNull Boolean experimental) {
      this.experimental = Optional.of(experimental);
      return this;
    }
    /**
     * @param jurisdiction - A legal or geographic region in which the structure map is intended to
     *     be used.
     */
    public StructureMapBuilder.Impl withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
     ...
     *     profiles etc.
     */
    public StructureMapBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public StructureMapBuilder.Impl withModifierExtension(@NonNull Extension... modifierExtension) {
     ...
     */
    public StructureMapBuilder.Impl withStructure(@NonNull StructureMap.Structure... structure) {
