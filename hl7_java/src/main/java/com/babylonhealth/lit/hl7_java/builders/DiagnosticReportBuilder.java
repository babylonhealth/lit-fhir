...
public class DiagnosticReportBuilder {
   ...
   */
  public DiagnosticReportBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public DiagnosticReportBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public DiagnosticReportBuilder withText(@NonNull Narrative text) {
   ...
   */
  public DiagnosticReportBuilder withIssued(@NonNull ZonedDateTime issued) {
    this.issued = Optional.of(issued);
    return this;
  }
  /** @param result - [Observations](observation.html) that are part of this diagnostic report. */
  public DiagnosticReportBuilder withResult(@NonNull Reference... result) {
    this.result = Arrays.asList(result);
    return this;
  }
  /** @param result - [Observations](observation.html) that are part of this diagnostic report. */
  public DiagnosticReportBuilder withResult(@NonNull Collection<Reference> result) {
    this.result = Collections.unmodifiableCollection(result);
    return this;
  }
  /** @param basedOn - Details concerning a service requested. */
  public DiagnosticReportBuilder withBasedOn(@NonNull Reference... basedOn) {
    this.basedOn = Arrays.asList(basedOn);
    return this;
  }
  /** @param basedOn - Details concerning a service requested. */
  public DiagnosticReportBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
   ...
   *     other sources.
   */
  public DiagnosticReportBuilder withSubject(@NonNull Reference subject) {
    this.subject = Optional.of(subject);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public DiagnosticReportBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public DiagnosticReportBuilder withCategory(@NonNull CodeableConcept... category) {
   ...
   *     used for searching, sorting and display purposes.
   */
  public DiagnosticReportBuilder withCategory(@NonNull Collection<CodeableConcept> category) {
    this.category = Collections.unmodifiableCollection(category);
    return this;
  }
  /** @param specimen - Details about the specimens on which this diagnostic report is based. */
  public DiagnosticReportBuilder withSpecimen(@NonNull Reference... specimen) {
    this.specimen = Arrays.asList(specimen);
    return this;
  }
  /** @param specimen - Details about the specimens on which this diagnostic report is based. */
  public DiagnosticReportBuilder withSpecimen(@NonNull Collection<Reference> specimen) {
   ...
   */
  public DiagnosticReportBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public DiagnosticReportBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public DiagnosticReportBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public DiagnosticReportBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public DiagnosticReportBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - The diagnostic service that is responsible for issuing the report. */
  public DiagnosticReportBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - The diagnostic service that is responsible for issuing the report. */
  public DiagnosticReportBuilder withPerformer(@NonNull Collection<Reference> performer) {
    this.performer = Collections.unmodifiableCollection(performer);
    return this;
  }
  /** @param identifier - Identifiers assigned to this report by the performer or other systems. */
  public DiagnosticReportBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - Identifiers assigned to this report by the performer or other systems. */
  public DiagnosticReportBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public DiagnosticReportBuilder withConclusion(@NonNull String conclusion) {
   ...
   */
  public DiagnosticReportBuilder withImagingStudy(@NonNull Reference... imagingStudy) {
   ...
   *     views of the source images.
   */
  public DiagnosticReportBuilder withImagingStudy(@NonNull Collection<Reference> imagingStudy) {
   ...
   *     profiles etc.
   */
  public DiagnosticReportBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public DiagnosticReportBuilder withPresentedForm(@NonNull Attachment... presentedForm) {
   ...
   *     diagnostic service. Multiple formats are allowed but they SHALL be semantically equivalent.
   */
  public DiagnosticReportBuilder withPresentedForm(@NonNull Collection<Attachment> presentedForm) {
   ...
   *     (interpretation/impression) of the diagnostic report.
   */
  public DiagnosticReportBuilder withConclusionCode(@NonNull CodeableConcept... conclusionCode) {
   ...
   *     (interpretation/impression) of the diagnostic report.
   */
  public DiagnosticReportBuilder withConclusionCode(
   ...
   */
  public DiagnosticReportBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public DiagnosticReportBuilder withModifierExtension(
   ...
   */
  public DiagnosticReportBuilder withResultsInterpreter(@NonNull Reference... resultsInterpreter) {
   ...
   *     report's conclusions and interpretations.
   */
  public DiagnosticReportBuilder withResultsInterpreter(
   ...
   */
  public DiagnosticReportBuilder withMedia(@NonNull DiagnosticReport.Media... media) {
   ...
   *     specimens (i.e. slides of interest).
   */
  public DiagnosticReportBuilder withMedia(@NonNull Collection<DiagnosticReport.Media> media) {
