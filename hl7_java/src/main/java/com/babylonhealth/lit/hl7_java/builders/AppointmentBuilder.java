...
public class AppointmentBuilder {
   ...
   *     participation status which indicates their involvement in the process, however this status
   ...
   */
  public AppointmentBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param end - Date/Time that the appointment is to conclude. */
  public AppointmentBuilder withEnd(@NonNull ZonedDateTime end) {
   ...
   *     to the resource.
   */
  public AppointmentBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public AppointmentBuilder withText(@NonNull Narrative text) {
   ...
   *     appointment.
   */
  public AppointmentBuilder withSlot(@NonNull Reference... slot) {
   ...
   *     appointment.
   */
  public AppointmentBuilder withSlot(@NonNull Collection<Reference> slot) {
    this.slot = Collections.unmodifiableCollection(slot);
    return this;
  }
  /** @param start - Date/Time that the appointment is to take place. */
  public AppointmentBuilder withStart(@NonNull ZonedDateTime start) {
    this.start = Optional.of(start);
    return this;
  }
  /**
   * @param created - The date that this appointment was initially created. This could be different
   *     to the meta.lastModified value on the initial entry, as this could have been before the
   *     resource was created on the FHIR server, and should remain unchanged over the lifespan of
   *     the appointment.
   */
  public AppointmentBuilder withCreated(@NonNull FHIRDateTime created) {
    this.created = Optional.of(created);
    return this;
  }
  /** @param comment - Additional comments about the appointment. */
  public AppointmentBuilder withComment(@NonNull String comment) {
   ...
   */
  public AppointmentBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     referral or procedure request).
   */
  public AppointmentBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public AppointmentBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public AppointmentBuilder withPriority(@NonNull Integer priority) {
   ...
   */
  public AppointmentBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public AppointmentBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public AppointmentBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public AppointmentBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public AppointmentBuilder withSpecialty(@NonNull CodeableConcept... specialty) {
   ...
   *     service requested in this appointment.
   */
  public AppointmentBuilder withSpecialty(@NonNull Collection<CodeableConcept> specialty) {
   ...
   *     documentation).
   */
  public AppointmentBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     documentation).
   */
  public AppointmentBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public AppointmentBuilder withReasonCode(@NonNull CodeableConcept... reasonCode) {
   ...
   *     clinical than administrative.
   */
  public AppointmentBuilder withReasonCode(@NonNull Collection<CodeableConcept> reasonCode) {
    this.reasonCode = Collections.unmodifiableCollection(reasonCode);
    return this;
  }
  /** @param serviceType - The specific service that is to be performed during this appointment. */
  public AppointmentBuilder withServiceType(@NonNull CodeableConcept... serviceType) {
    this.serviceType = Arrays.asList(serviceType);
    return this;
  }
  /** @param serviceType - The specific service that is to be performed during this appointment. */
  public AppointmentBuilder withServiceType(@NonNull Collection<CodeableConcept> serviceType) {
   ...
   *     line in a meeting request, or appointment list. Detailed or expanded information should be
   *     put in the comment field.
   */
  public AppointmentBuilder withDescription(@NonNull String description) {
   ...
   *     profiles etc.
   */
  public AppointmentBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     this appointment.
   */
  public AppointmentBuilder withServiceCategory(@NonNull CodeableConcept... serviceCategory) {
   ...
   *     this appointment.
   */
  public AppointmentBuilder withServiceCategory(
   ...
   *     (not service type).
   */
  public AppointmentBuilder withAppointmentType(@NonNull CodeableConcept appointmentType) {
    this.appointmentType = Optional.of(appointmentType);
    return this;
  }
  /**
   * @param reasonReference - Reason the appointment has been scheduled to take place, as specified
   *     using information from another resource. When the patient arrives and the encounter begins
   *     it may be used as the admission diagnosis. The indication will typically be a Condition
   *     (with other resources referenced in the evidence.detail), or a Procedure.
   */
  public AppointmentBuilder withReasonReference(@NonNull Reference... reasonReference) {
   ...
   *     (with other resources referenced in the evidence.detail), or a Procedure.
   */
  public AppointmentBuilder withReasonReference(@NonNull Collection<Reference> reasonReference) {
   ...
   *     time would work. Also, if there is, for example, a planned 15 minute break in the middle of
   *     a long appointment, the duration may be 15 minutes less than the difference between the
   *     start and end.
   */
  public AppointmentBuilder withMinutesDuration(@NonNull Integer minutesDuration) {
   ...
   */
  public AppointmentBuilder withRequestedPeriod(@NonNull Period... requestedPeriod) {
   ...
   *     However, in other situations the duration may be calculated by the scheduling system.
   */
  public AppointmentBuilder withRequestedPeriod(@NonNull Collection<Period> requestedPeriod) {
   ...
   */
  public AppointmentBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public AppointmentBuilder withModifierExtension(
      @NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /**
   * @param cancelationReason - The coded reason for the appointment being cancelled. This is often
   *     used in reporting/billing/futher processing to determine if further actions are required,
   *     or specific fees apply.
   */
  public AppointmentBuilder withCancelationReason(@NonNull CodeableConcept cancelationReason) {
   ...
   */
  public AppointmentBuilder withPatientInstruction(@NonNull String patientInstruction) {
    this.patientInstruction = Optional.of(patientInstruction);
    return this;
  }
  /**
   * @param supportingInformation - Additional information to support the appointment provided when
   *     making the appointment.
   */
  public AppointmentBuilder withSupportingInformation(@NonNull Reference... supportingInformation) {
   ...
   *     making the appointment.
   */
  public AppointmentBuilder withSupportingInformation(
