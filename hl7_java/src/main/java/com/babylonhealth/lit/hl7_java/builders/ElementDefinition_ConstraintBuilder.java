...
public class ElementDefinition_ConstraintBuilder {
   ...
   * @param severity
   */
  public ElementDefinition_ConstraintBuilder(
      String key, String human, CONSTRAINT_SEVERITY severity) {
    this.key = key;
    this.human = human;
   ...
   */
  public ElementDefinition_ConstraintBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param xpath */
  public ElementDefinition_ConstraintBuilder withXpath(@NonNull String xpath) {
    this.xpath = Optional.of(xpath);
    return this;
  }
  /** @param source */
  public ElementDefinition_ConstraintBuilder withSource(@NonNull String source) {
   ...
   */
  public ElementDefinition_ConstraintBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ElementDefinition_ConstraintBuilder withExtension(
      @NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param expression */
  public ElementDefinition_ConstraintBuilder withExpression(@NonNull String expression) {
   ...
   */
  public ElementDefinition_ConstraintBuilder withRequirements(@NonNull String requirements) {
