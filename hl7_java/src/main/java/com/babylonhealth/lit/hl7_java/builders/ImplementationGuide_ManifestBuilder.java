...
public class ImplementationGuide_ManifestBuilder {
   ...
   * @param resource
   */
  public ImplementationGuide_ManifestBuilder(
      Collection<ImplementationGuide$Manifest$Resource> resource) {
   ...
   */
  public ImplementationGuide_ManifestBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param image */
  public ImplementationGuide_ManifestBuilder withImage(@NonNull String... image) {
    this.image = Arrays.asList(image);
    return this;
  }
  /** @param image */
  public ImplementationGuide_ManifestBuilder withImage(@NonNull Collection<String> image) {
    this.image = Collections.unmodifiableCollection(image);
    return this;
  }
  /** @param other */
  public ImplementationGuide_ManifestBuilder withOther(@NonNull String... other) {
    this.other = Arrays.asList(other);
    return this;
  }
  /** @param other */
  public ImplementationGuide_ManifestBuilder withOther(@NonNull Collection<String> other) {
   ...
   */
  public ImplementationGuide_ManifestBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ImplementationGuide_ManifestBuilder withExtension(
      @NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param rendering */
  public ImplementationGuide_ManifestBuilder withRendering(@NonNull String rendering) {
   ...
   */
  public ImplementationGuide_ManifestBuilder withModifierExtension(
  ...
  /** @param page */
  public ImplementationGuide_ManifestBuilder withPage(
