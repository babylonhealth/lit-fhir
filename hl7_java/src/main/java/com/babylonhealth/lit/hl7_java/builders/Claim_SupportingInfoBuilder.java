...
public class Claim_SupportingInfoBuilder {
   ...
   */
  public Claim_SupportingInfoBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param code */
  public Claim_SupportingInfoBuilder withCode(@NonNull CodeableConcept code) {
    this.code = Optional.of(code);
    return this;
  }
  /** @param reason */
  public Claim_SupportingInfoBuilder withReason(@NonNull CodeableConcept reason) {
   ...
   */
  public Claim_SupportingInfoBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Claim_SupportingInfoBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public Claim_SupportingInfoBuilder withModifierExtension(
