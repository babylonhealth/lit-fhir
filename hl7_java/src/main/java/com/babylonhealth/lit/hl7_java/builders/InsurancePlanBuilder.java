...
public class InsurancePlanBuilder {
   ...
   */
  public InsurancePlanBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public InsurancePlanBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public InsurancePlanBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param _type - The kind of health insurance product. */
  public InsurancePlanBuilder withType(@NonNull CodeableConcept... _type) {
    this._type = Arrays.asList(_type);
    return this;
  }
  /** @param _type - The kind of health insurance product. */
  public InsurancePlanBuilder withType(@NonNull Collection<CodeableConcept> _type) {
  ...
  public InsurancePlanBuilder withName(@NonNull String name) {
   ...
   *     past.
   */
  public InsurancePlanBuilder withAlias(@NonNull String... alias) {
   ...
   *     past.
   */
  public InsurancePlanBuilder withAlias(@NonNull Collection<String> alias) {
    this.alias = Collections.unmodifiableCollection(alias);
    return this;
  }
  /** @param status - The current state of the health insurance product. */
  public InsurancePlanBuilder withStatus(@NonNull PUBLICATION_STATUS status) {
    this.status = Optional.of(status);
    return this;
  }
  /** @param period - The period of time that the health insurance product is available. */
  public InsurancePlanBuilder withPeriod(@NonNull Period period) {
    this.period = Optional.of(period);
    return this;
  }
  /**
   * @param ownedBy - The entity that is providing the health insurance product and underwriting the
   *     risk. This is typically an insurance carriers, other third-party payers, or health plan
   *     sponsors comonly referred to as 'payers'.
   */
  public InsurancePlanBuilder withOwnedBy(@NonNull Reference ownedBy) {
    this.ownedBy = Optional.of(ownedBy);
    return this;
  }
  /** @param network - Reference to the network included in the health insurance product. */
  public InsurancePlanBuilder withNetwork(@NonNull Reference... network) {
    this.network = Arrays.asList(network);
    return this;
  }
  /** @param network - Reference to the network included in the health insurance product. */
  public InsurancePlanBuilder withNetwork(@NonNull Collection<Reference> network) {
    this.network = Collections.unmodifiableCollection(network);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public InsurancePlanBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   *     insurance product.
   */
  public InsurancePlanBuilder withEndpoint(@NonNull Reference... endpoint) {
   ...
   *     insurance product.
   */
  public InsurancePlanBuilder withEndpoint(@NonNull Collection<Reference> endpoint) {
   ...
   */
  public InsurancePlanBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public InsurancePlanBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public InsurancePlanBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public InsurancePlanBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public InsurancePlanBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     constant as the resource is updated and propagates from server to server.
   */
  public InsurancePlanBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   *     apply.
   */
  public InsurancePlanBuilder withCoverageArea(@NonNull Reference... coverageArea) {
   ...
   *     apply.
   */
  public InsurancePlanBuilder withCoverageArea(@NonNull Collection<Reference> coverageArea) {
   ...
   *     profiles etc.
   */
  public InsurancePlanBuilder withImplicitRules(@NonNull String implicitRules) {
    this.implicitRules = Optional.of(implicitRules);
    return this;
  }
  /**
   * @param administeredBy - An organization which administer other services such as underwriting,
   *     customer service and/or claims processing on behalf of the health insurance product owner.
   */
  public InsurancePlanBuilder withAdministeredBy(@NonNull Reference administeredBy) {
   ...
   */
  public InsurancePlanBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public InsurancePlanBuilder withModifierExtension(
      @NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param contact - The contact for the health insurance product for a certain purpose. */
  public InsurancePlanBuilder withContact(@NonNull InsurancePlan.Contact... contact) {
    this.contact = Arrays.asList(contact);
    return this;
  }
  /** @param contact - The contact for the health insurance product for a certain purpose. */
  public InsurancePlanBuilder withContact(@NonNull Collection<InsurancePlan.Contact> contact) {
    this.contact = Collections.unmodifiableCollection(contact);
    return this;
  }
  /** @param coverage - Details about the coverage offered by the insurance product. */
  public InsurancePlanBuilder withCoverage(@NonNull InsurancePlan.Coverage... coverage) {
    this.coverage = Arrays.asList(coverage);
    return this;
  }
  /** @param coverage - Details about the coverage offered by the insurance product. */
  public InsurancePlanBuilder withCoverage(@NonNull Collection<InsurancePlan.Coverage> coverage) {
    this.coverage = Collections.unmodifiableCollection(coverage);
    return this;
  }
  /** @param plan - Details about an insurance plan. */
  public InsurancePlanBuilder withPlan(@NonNull InsurancePlan.Plan... plan) {
    this.plan = Arrays.asList(plan);
    return this;
  }
  /** @param plan - Details about an insurance plan. */
  public InsurancePlanBuilder withPlan(@NonNull Collection<InsurancePlan.Plan> plan) {
