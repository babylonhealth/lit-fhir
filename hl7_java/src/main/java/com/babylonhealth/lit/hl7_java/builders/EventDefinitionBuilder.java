...
public class EventDefinitionBuilder {
   ...
   *     condition is specified, the event fires whenever any one of the trigger conditions is met.
   */
  public EventDefinitionBuilder(PUBLICATION_STATUS status, Collection<TriggerDefinition> trigger) {
    this.status = status;
   ...
   */
  public EventDefinitionBuilder withId(@NonNull String id) {
   ...
   */
  public EventDefinitionBuilder withUrl(@NonNull String url) {
   ...
   *     to the resource.
   */
  public EventDefinitionBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public EventDefinitionBuilder withText(@NonNull Narrative text) {
   ...
   *     generation.
   */
  public EventDefinitionBuilder withName(@NonNull String name) {
    this.name = Optional.of(name);
    return this;
  }
  /**
   * @param date - The date (and optionally time) when the event definition was published. The date
   ...
   *     changes.
   */
  public EventDefinitionBuilder withDate(@NonNull FHIRDateTime date) {
    this.date = Optional.of(date);
    return this;
  }
  /** @param title - A short, descriptive, user-friendly title for the event definition. */
  public EventDefinitionBuilder withTitle(@NonNull String title) {
   ...
   *     perspective.
   */
  public EventDefinitionBuilder withUsage(@NonNull String usage) {
   ...
   */
  public EventDefinitionBuilder withTopic(@NonNull CodeableConcept... topic) {
   ...
   *     categorization of the module that can be useful for filtering and searching.
   */
  public EventDefinitionBuilder withTopic(@NonNull Collection<CodeableConcept> topic) {
   ...
   */
  public EventDefinitionBuilder withAuthor(@NonNull ContactDetail... author) {
   ...
   *     maintenance of the content.
   */
  public EventDefinitionBuilder withAuthor(@NonNull Collection<ContactDetail> author) {
   ...
   *     the content.
   */
  public EventDefinitionBuilder withEditor(@NonNull ContactDetail... editor) {
   ...
   *     the content.
   */
  public EventDefinitionBuilder withEditor(@NonNull Collection<ContactDetail> editor) {
   ...
   *     value managed by the event definition author and is not expected to be globally unique. For
   ...
   */
  public EventDefinitionBuilder withVersion(@NonNull String version) {
   ...
   *     publisher.
   */
  public EventDefinitionBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public EventDefinitionBuilder withContact(@NonNull Collection<ContactDetail> contact) {
   ...
   *     designed as it has.
   */
  public EventDefinitionBuilder withPurpose(@NonNull String purpose) {
    this.purpose = Optional.of(purpose);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public EventDefinitionBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public EventDefinitionBuilder withSubtitle(@NonNull String subtitle) {
   ...
   *     of the content.
   */
  public EventDefinitionBuilder withReviewer(@NonNull ContactDetail... reviewer) {
   ...
   *     of the content.
   */
  public EventDefinitionBuilder withReviewer(@NonNull Collection<ContactDetail> reviewer) {
   ...
   */
  public EventDefinitionBuilder withEndorser(@NonNull ContactDetail... endorser) {
   ...
   *     content for use in some setting.
   */
  public EventDefinitionBuilder withEndorser(@NonNull Collection<ContactDetail> endorser) {
   ...
   */
  public EventDefinitionBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public EventDefinitionBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public EventDefinitionBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public EventDefinitionBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     definition.
   */
  public EventDefinitionBuilder withPublisher(@NonNull String publisher) {
   ...
   *     event definition.
   */
  public EventDefinitionBuilder withCopyright(@NonNull String copyright) {
    this.copyright = Optional.of(copyright);
    return this;
  }
  /**
   * @param identifier - A formal identifier that is used to identify this event definition when it
   *     is represented in other formats, or referenced in a specification, model, design or an
   *     instance.
   */
  public EventDefinitionBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     instance.
   */
  public EventDefinitionBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public <T> EventDefinitionBuilder withSubject(@NonNull T subject) {
    var guessedSuffix =
        autoSuffix(subject.getClass().getSimpleName(), EventDefinition$.MODULE$.subject());
   ...
   */
  public <T> EventDefinitionBuilder withSubject(String suffix, @NonNull T subject) {
    guard(subject.getClass().getSimpleName(), suffix, EventDefinition$.MODULE$.subject());
    this.subject =
        Optional.of(
            (Choice)
                Choice$.MODULE$.fromSuffix(suffix, subject, EventDefinition$.MODULE$.subject()));
    return this;
  }
  /**
   ...
   */
  public EventDefinitionBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate event definition instances.
   */
  public EventDefinitionBuilder withUseContext(@NonNull Collection<UsageContext> useContext) {
   ...
   */
  public EventDefinitionBuilder withDescription(@NonNull String description) {
   ...
   *     genuine usage.
   */
  public EventDefinitionBuilder withExperimental(@NonNull Boolean experimental) {
    this.experimental = Optional.of(experimental);
    return this;
  }
  /**
   * @param jurisdiction - A legal or geographic region in which the event definition is intended to
   *     be used.
   */
  public EventDefinitionBuilder withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
   ...
   *     be used.
   */
  public EventDefinitionBuilder withJurisdiction(
   ...
   */
  public EventDefinitionBuilder withApprovalDate(@NonNull FHIRDate approvalDate) {
   ...
   *     profiles etc.
   */
  public EventDefinitionBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public EventDefinitionBuilder withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
    this.lastReviewDate = Optional.of(lastReviewDate);
    return this;
  }
  /**
   * @param effectivePeriod - The period during which the event definition content was or is planned
   *     to be in active use.
   */
  public EventDefinitionBuilder withEffectivePeriod(@NonNull Period effectivePeriod) {
   ...
   */
  public EventDefinitionBuilder withRelatedArtifact(@NonNull RelatedArtifact... relatedArtifact) {
   ...
   *     bibliographic references.
   */
  public EventDefinitionBuilder withRelatedArtifact(
   ...
   */
  public EventDefinitionBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public EventDefinitionBuilder withModifierExtension(
