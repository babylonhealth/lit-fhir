...
public class AdverseEvent_SuspectEntity_CausalityBuilder {
  ...
  public AdverseEvent_SuspectEntity_CausalityBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public AdverseEvent_SuspectEntity_CausalityBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param author */
  public AdverseEvent_SuspectEntity_CausalityBuilder withAuthor(@NonNull Reference author) {
    this.author = Optional.of(author);
    return this;
  }
  /** @param method */
  public AdverseEvent_SuspectEntity_CausalityBuilder withMethod(@NonNull CodeableConcept method) {
   ...
   */
  public AdverseEvent_SuspectEntity_CausalityBuilder withExtension(
  ...
  /** @param assessment */
  public AdverseEvent_SuspectEntity_CausalityBuilder withAssessment(
   ...
   */
  public AdverseEvent_SuspectEntity_CausalityBuilder withModifierExtension(
  ...
  public AdverseEvent_SuspectEntity_CausalityBuilder withProductRelatedness(
