...
public interface Contract_LegalBuilder {
  ...
  public class Impl implements Contract_LegalBuilder {
     ...
     */
    public Contract_LegalBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public Contract_LegalBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public Contract_LegalBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public Contract_LegalBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
     ...
     */
    public Contract_LegalBuilder.Impl withModifierExtension(
