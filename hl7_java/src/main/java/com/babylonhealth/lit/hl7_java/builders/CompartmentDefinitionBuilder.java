...
public class CompartmentDefinitionBuilder {
   ...
   * @param name - A natural language name identifying the compartment definition. This name should
   ...
   */
  public CompartmentDefinitionBuilder(
   ...
   */
  public CompartmentDefinitionBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public CompartmentDefinitionBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public CompartmentDefinitionBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /**
   * @param date - The date (and optionally time) when the compartment definition was published. The
   ...
   *     definition changes.
   */
  public CompartmentDefinitionBuilder withDate(@NonNull FHIRDateTime date) {
   ...
   *     arbitrary value managed by the compartment definition author and is not expected to be
   ...
   */
  public CompartmentDefinitionBuilder withVersion(@NonNull String version) {
   ...
   *     publisher.
   */
  public CompartmentDefinitionBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public CompartmentDefinitionBuilder withContact(@NonNull Collection<ContactDetail> contact) {
   ...
   *     designed as it has.
   */
  public CompartmentDefinitionBuilder withPurpose(@NonNull String purpose) {
    this.purpose = Optional.of(purpose);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public CompartmentDefinitionBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public CompartmentDefinitionBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public CompartmentDefinitionBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public CompartmentDefinitionBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public CompartmentDefinitionBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     definition.
   */
  public CompartmentDefinitionBuilder withPublisher(@NonNull String publisher) {
   ...
   */
  public CompartmentDefinitionBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate compartment definition instances.
   */
  public CompartmentDefinitionBuilder withUseContext(@NonNull Collection<UsageContext> useContext) {
   ...
   */
  public CompartmentDefinitionBuilder withDescription(@NonNull String description) {
    this.description = Optional.of(description);
    return this;
  }
  /**
   * @param experimental - A Boolean value to indicate that this compartment definition is authored
   *     for testing purposes (or education/evaluation/marketing) and is not intended to be used for
   *     genuine usage.
   */
  public CompartmentDefinitionBuilder withExperimental(@NonNull Boolean experimental) {
   ...
   *     profiles etc.
   */
  public CompartmentDefinitionBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public CompartmentDefinitionBuilder withModifierExtension(
  ...
  public CompartmentDefinitionBuilder withResource(
