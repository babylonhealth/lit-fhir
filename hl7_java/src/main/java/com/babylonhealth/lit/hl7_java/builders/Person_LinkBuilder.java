...
public interface Person_LinkBuilder {
  public Person.Link build();

  public static Impl init(Reference target) {
  ...
  public class Impl implements Person_LinkBuilder {
     ...
     */
    public Person_LinkBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public Person_LinkBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public Person_LinkBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
     ...
     */
    public Person_LinkBuilder.Impl withModifierExtension(@NonNull Extension... modifierExtension) {
