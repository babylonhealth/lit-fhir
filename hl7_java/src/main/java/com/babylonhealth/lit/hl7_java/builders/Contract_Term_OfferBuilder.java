...
public class Contract_Term_OfferBuilder {
  ...
  public Contract_Term_OfferBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public Contract_Term_OfferBuilder withId(@NonNull String id) {
   ...
   */
  public Contract_Term_OfferBuilder withType(@NonNull CodeableConcept _type) {
   ...
   */
  public Contract_Term_OfferBuilder withText(@NonNull String text) {
   ...
   */
  public Contract_Term_OfferBuilder withTopic(@NonNull Reference topic) {
    this.topic = Optional.of(topic);
    return this;
  }
  /** @param linkId */
  public Contract_Term_OfferBuilder withLinkId(@NonNull String... linkId) {
    this.linkId = Arrays.asList(linkId);
    return this;
  }
  /** @param linkId */
  public Contract_Term_OfferBuilder withLinkId(@NonNull Collection<String> linkId) {
    this.linkId = Collections.unmodifiableCollection(linkId);
    return this;
  }
  /** @param decision */
  public Contract_Term_OfferBuilder withDecision(@NonNull CodeableConcept decision) {
   ...
   */
  public Contract_Term_OfferBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Contract_Term_OfferBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     Source Contract.
   */
  public Contract_Term_OfferBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     Source Contract.
   */
  public Contract_Term_OfferBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
    this.identifier = Collections.unmodifiableCollection(identifier);
    return this;
  }
  /** @param decisionMode */
  public Contract_Term_OfferBuilder withDecisionMode(@NonNull CodeableConcept... decisionMode) {
    this.decisionMode = Arrays.asList(decisionMode);
    return this;
  }
  /** @param decisionMode */
  public Contract_Term_OfferBuilder withDecisionMode(
   ...
   */
  public Contract_Term_OfferBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public Contract_Term_OfferBuilder withModifierExtension(
      @NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param securityLabelNumber */
  public Contract_Term_OfferBuilder withSecurityLabelNumber(
  ...
  /** @param party */
  public Contract_Term_OfferBuilder withParty(@NonNull Contract$Term$Offer$Party... party) {
    this.party = Arrays.asList(party);
    return this;
  }
  /** @param party */
  public Contract_Term_OfferBuilder withParty(
      @NonNull Collection<Contract$Term$Offer$Party> party) {
    this.party = Collections.unmodifiableCollection(party);
    return this;
  }
  /** @param answer */
  public Contract_Term_OfferBuilder withAnswer(@NonNull Contract$Term$Offer$Answer... answer) {
    this.answer = Arrays.asList(answer);
    return this;
  }
  /** @param answer */
  public Contract_Term_OfferBuilder withAnswer(
