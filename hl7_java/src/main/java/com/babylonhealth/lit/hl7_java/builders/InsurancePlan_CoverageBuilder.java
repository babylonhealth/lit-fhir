...
public class InsurancePlan_CoverageBuilder {
   ...
   * @param benefit
   */
  public InsurancePlan_CoverageBuilder(
   ...
   */
  public InsurancePlan_CoverageBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param network - Reference to the network included in the health insurance product. */
  public InsurancePlan_CoverageBuilder withNetwork(@NonNull Reference... network) {
    this.network = Arrays.asList(network);
    return this;
  }
  /** @param network - Reference to the network included in the health insurance product. */
  public InsurancePlan_CoverageBuilder withNetwork(@NonNull Collection<Reference> network) {
   ...
   */
  public InsurancePlan_CoverageBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public InsurancePlan_CoverageBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public InsurancePlan_CoverageBuilder withModifierExtension(
