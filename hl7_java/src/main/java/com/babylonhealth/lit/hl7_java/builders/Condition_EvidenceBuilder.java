...
public interface Condition_EvidenceBuilder {
  ...
  public class Impl implements Condition_EvidenceBuilder {
     ...
     */
    public Condition_EvidenceBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param code - Identification of the condition, problem or diagnosis. */
    public Condition_EvidenceBuilder.Impl withCode(@NonNull CodeableConcept... code) {
      this.code = Arrays.asList(code);
      return this;
    }
    /** @param code - Identification of the condition, problem or diagnosis. */
    public Condition_EvidenceBuilder.Impl withCode(@NonNull Collection<CodeableConcept> code) {
     ...
     */
    public Condition_EvidenceBuilder.Impl withExtension(@NonNull Extension... extension) {
