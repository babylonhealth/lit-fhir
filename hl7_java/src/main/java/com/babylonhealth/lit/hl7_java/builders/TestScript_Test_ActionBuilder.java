...
public interface TestScript_Test_ActionBuilder {
  ...
  public class Impl implements TestScript_Test_ActionBuilder {
     ...
     */
    public TestScript_Test_ActionBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param _assert */
    public TestScript_Test_ActionBuilder.Impl withAssert(
     ...
     */
    public TestScript_Test_ActionBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public TestScript_Test_ActionBuilder.Impl withExtension(
    ...
    /** @param operation */
    public TestScript_Test_ActionBuilder.Impl withOperation(
     ...
     */
    public TestScript_Test_ActionBuilder.Impl withModifierExtension(
