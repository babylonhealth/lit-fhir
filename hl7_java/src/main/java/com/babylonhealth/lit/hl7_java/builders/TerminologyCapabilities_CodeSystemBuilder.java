...
public class TerminologyCapabilities_CodeSystemBuilder {
  private Optional<String> id = Optional.empty();
  private Optional<String> uri = Optional.empty();
  private Collection<Extension> extension = Collections.emptyList();
  private Optional<Boolean> subsumption = Optional.empty();
  private Collection<Extension> modifierExtension = Collections.emptyList();
  private Collection<TerminologyCapabilities$CodeSystem$Version> version = Collections.emptyList();

  /** Required fields for {@link TerminologyCapabilities.CodeSystem} */
  public TerminologyCapabilities_CodeSystemBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public TerminologyCapabilities_CodeSystemBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param uri */
  public TerminologyCapabilities_CodeSystemBuilder withUri(@NonNull String uri) {
   ...
   */
  public TerminologyCapabilities_CodeSystemBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public TerminologyCapabilities_CodeSystemBuilder withExtension(
      @NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param subsumption */
  public TerminologyCapabilities_CodeSystemBuilder withSubsumption(@NonNull Boolean subsumption) {
   ...
   */
  public TerminologyCapabilities_CodeSystemBuilder withModifierExtension(
   ...
   */
  public TerminologyCapabilities_CodeSystemBuilder withVersion(
