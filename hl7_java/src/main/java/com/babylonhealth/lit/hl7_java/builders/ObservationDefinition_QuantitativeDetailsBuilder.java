...
public class ObservationDefinition_QuantitativeDetailsBuilder {
  ...
  public ObservationDefinition_QuantitativeDetailsBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public ObservationDefinition_QuantitativeDetailsBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param unit */
  public ObservationDefinition_QuantitativeDetailsBuilder withUnit(@NonNull CodeableConcept unit) {
   ...
   */
  public ObservationDefinition_QuantitativeDetailsBuilder withExtension(
  ...
  /** @param customaryUnit */
  public ObservationDefinition_QuantitativeDetailsBuilder withCustomaryUnit(
      @NonNull CodeableConcept customaryUnit) {
    this.customaryUnit = Optional.of(customaryUnit);
    return this;
  }
  /** @param conversionFactor */
  public ObservationDefinition_QuantitativeDetailsBuilder withConversionFactor(
      @NonNull BigDecimal conversionFactor) {
    this.conversionFactor = Optional.of(conversionFactor);
    return this;
  }
  /** @param decimalPrecision */
  public ObservationDefinition_QuantitativeDetailsBuilder withDecimalPrecision(
   ...
   */
  public ObservationDefinition_QuantitativeDetailsBuilder withModifierExtension(
