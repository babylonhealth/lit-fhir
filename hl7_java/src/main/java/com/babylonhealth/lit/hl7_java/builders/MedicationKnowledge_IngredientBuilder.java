...
public class MedicationKnowledge_IngredientBuilder {
   ...
   */
  public MedicationKnowledge_IngredientBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param isActive */
  public MedicationKnowledge_IngredientBuilder withIsActive(@NonNull Boolean isActive) {
    this.isActive = Optional.of(isActive);
    return this;
  }
  /** @param strength */
  public MedicationKnowledge_IngredientBuilder withStrength(@NonNull Ratio strength) {
   ...
   */
  public MedicationKnowledge_IngredientBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public MedicationKnowledge_IngredientBuilder withExtension(
   ...
   */
  public MedicationKnowledge_IngredientBuilder withModifierExtension(
