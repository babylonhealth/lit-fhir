...
public interface ExplanationOfBenefit_PayeeBuilder {
  ...
  public class Impl implements ExplanationOfBenefit_PayeeBuilder {
     ...
     */
    public ExplanationOfBenefit_PayeeBuilder.Impl withId(@NonNull String id) {
     ...
     *     professional.
     */
    public ExplanationOfBenefit_PayeeBuilder.Impl withType(@NonNull CodeableConcept _type) {
     ...
     */
    public ExplanationOfBenefit_PayeeBuilder.Impl withExtension(@NonNull Extension... extension) {
