...
public class MedicationKnowledge_RegulatoryBuilder {
   ...
   */
  public MedicationKnowledge_RegulatoryBuilder(Reference regulatoryAuthority) {
   ...
   */
  public MedicationKnowledge_RegulatoryBuilder withId(@NonNull String id) {
   ...
   */
  public MedicationKnowledge_RegulatoryBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public MedicationKnowledge_RegulatoryBuilder withExtension(
   ...
   */
  public MedicationKnowledge_RegulatoryBuilder withModifierExtension(
  ...
  /** @param schedule */
  public MedicationKnowledge_RegulatoryBuilder withSchedule(
  ...
  /** @param maxDispense */
  public MedicationKnowledge_RegulatoryBuilder withMaxDispense(
      @NonNull MedicationKnowledge$Regulatory$MaxDispense maxDispense) {
    this.maxDispense = Optional.of(maxDispense);
    return this;
  }
  /** @param substitution */
  public MedicationKnowledge_RegulatoryBuilder withSubstitution(
