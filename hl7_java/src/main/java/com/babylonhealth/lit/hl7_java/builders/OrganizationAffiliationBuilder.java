...
public class OrganizationAffiliationBuilder {
  ...
  public OrganizationAffiliationBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public OrganizationAffiliationBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public OrganizationAffiliationBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public OrganizationAffiliationBuilder withText(@NonNull Narrative text) {
   ...
   */
  public OrganizationAffiliationBuilder withCode(@NonNull CodeableConcept... code) {
   ...
   * @param code - Definition of the role the participatingOrganization plays in the association.
   */
  public OrganizationAffiliationBuilder withCode(@NonNull Collection<CodeableConcept> code) {
  ...
  public OrganizationAffiliationBuilder withActive(@NonNull Boolean active) {
   ...
   */
  public OrganizationAffiliationBuilder withPeriod(@NonNull Period period) {
   ...
   */
  public OrganizationAffiliationBuilder withNetwork(@NonNull Reference... network) {
   ...
   *     provides the role's services (if defined) at the indicated locations (if defined).
   */
  public OrganizationAffiliationBuilder withNetwork(@NonNull Collection<Reference> network) {
   ...
   */
  public OrganizationAffiliationBuilder withTelecom(@NonNull ContactPoint... telecom) {
   ...
   * @param telecom - Contact details at the participatingOrganization relevant to this Affiliation.
   */
  public OrganizationAffiliationBuilder withTelecom(@NonNull Collection<ContactPoint> telecom) {
    this.telecom = Collections.unmodifiableCollection(telecom);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public OrganizationAffiliationBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param location - The location(s) at which the role occurs. */
  public OrganizationAffiliationBuilder withLocation(@NonNull Reference... location) {
    this.location = Arrays.asList(location);
    return this;
  }
  /** @param location - The location(s) at which the role occurs. */
  public OrganizationAffiliationBuilder withLocation(@NonNull Collection<Reference> location) {
  ...
  public OrganizationAffiliationBuilder withEndpoint(@NonNull Reference... endpoint) {
    this.endpoint = Arrays.asList(endpoint);
    return this;
  }
  /** @param endpoint - Technical endpoints providing access to services operated for this role. */
  public OrganizationAffiliationBuilder withEndpoint(@NonNull Collection<Reference> endpoint) {
   ...
   */
  public OrganizationAffiliationBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public OrganizationAffiliationBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public OrganizationAffiliationBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public OrganizationAffiliationBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     role.
   */
  public OrganizationAffiliationBuilder withSpecialty(@NonNull CodeableConcept... specialty) {
   ...
   *     role.
   */
  public OrganizationAffiliationBuilder withSpecialty(
  ...
  public OrganizationAffiliationBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - Business identifiers that are specific to this role. */
  public OrganizationAffiliationBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   *     members).
   */
  public OrganizationAffiliationBuilder withOrganization(@NonNull Reference organization) {
   ...
   *     profiles etc.
   */
  public OrganizationAffiliationBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public OrganizationAffiliationBuilder withModifierExtension(
  ...
  public OrganizationAffiliationBuilder withHealthcareService(
  ...
  /**
   * @param participatingOrganization - The Participating Organization provides/performs the role(s)
   *     defined by the code to the Primary Organization (e.g. providing services or is a member
   *     of).
   */
  public OrganizationAffiliationBuilder withParticipatingOrganization(
