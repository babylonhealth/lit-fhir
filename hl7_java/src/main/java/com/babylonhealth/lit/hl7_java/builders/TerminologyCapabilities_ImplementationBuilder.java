...
public interface TerminologyCapabilities_ImplementationBuilder {
  ...
  public class Impl implements TerminologyCapabilities_ImplementationBuilder {
     ...
     */
    public TerminologyCapabilities_ImplementationBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public TerminologyCapabilities_ImplementationBuilder.Impl withUrl(@NonNull String url) {
     ...
     */
    public TerminologyCapabilities_ImplementationBuilder.Impl withExtension(
     ...
     */
    public TerminologyCapabilities_ImplementationBuilder.Impl withModifierExtension(
