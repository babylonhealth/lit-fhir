...
public class EpisodeOfCareBuilder {
   ...
   */
  public EpisodeOfCareBuilder(EPISODE_OF_CARE_STATUS status, Reference patient) {
    this.status = status;
   ...
   */
  public EpisodeOfCareBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public EpisodeOfCareBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public EpisodeOfCareBuilder withText(@NonNull Narrative text) {
   ...
   */
  public EpisodeOfCareBuilder withType(@NonNull CodeableConcept... _type) {
   ...
   *     disease management, type of funded care.
   */
  public EpisodeOfCareBuilder withType(@NonNull Collection<CodeableConcept> _type) {
   ...
   *     specific purposes.
   */
  public EpisodeOfCareBuilder withTeam(@NonNull Reference... team) {
   ...
   *     specific purposes.
   */
  public EpisodeOfCareBuilder withTeam(@NonNull Collection<Reference> team) {
   ...
   *     responsibility.
   */
  public EpisodeOfCareBuilder withPeriod(@NonNull Period period) {
    this.period = Optional.of(period);
    return this;
  }
  /** @param account - The set of accounts that may be used for billing for this EpisodeOfCare. */
  public EpisodeOfCareBuilder withAccount(@NonNull Reference... account) {
    this.account = Arrays.asList(account);
    return this;
  }
  /** @param account - The set of accounts that may be used for billing for this EpisodeOfCare. */
  public EpisodeOfCareBuilder withAccount(@NonNull Collection<Reference> account) {
    this.account = Collections.unmodifiableCollection(account);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public EpisodeOfCareBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public EpisodeOfCareBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public EpisodeOfCareBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public EpisodeOfCareBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public EpisodeOfCareBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     purposes.
   */
  public EpisodeOfCareBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     purposes.
   */
  public EpisodeOfCareBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   *     patient.
   */
  public EpisodeOfCareBuilder withCareManager(@NonNull Reference careManager) {
   ...
   *     profiles etc.
   */
  public EpisodeOfCareBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     referrals.
   */
  public EpisodeOfCareBuilder withReferralRequest(@NonNull Reference... referralRequest) {
   ...
   *     referrals.
   */
  public EpisodeOfCareBuilder withReferralRequest(@NonNull Collection<Reference> referralRequest) {
   ...
   */
  public EpisodeOfCareBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public EpisodeOfCareBuilder withModifierExtension(
   ...
   */
  public EpisodeOfCareBuilder withManagingOrganization(@NonNull Reference managingOrganization) {
  ...
  public EpisodeOfCareBuilder withDiagnosis(@NonNull EpisodeOfCare.Diagnosis... diagnosis) {
    this.diagnosis = Arrays.asList(diagnosis);
    return this;
  }
  /** @param diagnosis - The list of diagnosis relevant to this episode of care. */
  public EpisodeOfCareBuilder withDiagnosis(
   ...
   */
  public EpisodeOfCareBuilder withStatusHistory(
