...
public interface ValueSet_ComposeBuilder {
  public ValueSet.Compose build();

  public static Impl init(Collection<ValueSet$Compose$Include> include) {
  ...
  public class Impl implements ValueSet_ComposeBuilder {
     ...
     * @param include
     */
    public Impl(Collection<ValueSet$Compose$Include> include) {
     ...
     */
    public ValueSet_ComposeBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param exclude */
    public ValueSet_ComposeBuilder.Impl withExclude(@NonNull ValueSet$Compose$Include... exclude) {
     ...
     */
    public ValueSet_ComposeBuilder.Impl withExtension(@NonNull Extension... extension) {
    ...
    /** @param lockedDate */
    public ValueSet_ComposeBuilder.Impl withLockedDate(@NonNull FHIRDate lockedDate) {
