...
public class ActivityDefinitionBuilder {
   ...
   */
  public ActivityDefinitionBuilder withId(@NonNull String id) {
   ...
   */
  public ActivityDefinitionBuilder withUrl(@NonNull String url) {
   ...
   *     to the resource.
   */
  public ActivityDefinitionBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public ActivityDefinitionBuilder withText(@NonNull Narrative text) {
   ...
   *     generation.
   */
  public ActivityDefinitionBuilder withName(@NonNull String name) {
   ...
   *     definition changes.
   */
  public ActivityDefinitionBuilder withDate(@NonNull FHIRDateTime date) {
   ...
   */
  public ActivityDefinitionBuilder withKind(@NonNull REQUEST_RESOURCE_TYPES kind) {
   ...
   */
  public ActivityDefinitionBuilder withCode(@NonNull CodeableConcept code) {
    this.code = Optional.of(code);
    return this;
  }
  /** @param title - A short, descriptive, user-friendly title for the activity definition. */
  public ActivityDefinitionBuilder withTitle(@NonNull String title) {
   ...
   *     perspective.
   */
  public ActivityDefinitionBuilder withUsage(@NonNull String usage) {
   ...
   */
  public ActivityDefinitionBuilder withTopic(@NonNull CodeableConcept... topic) {
   ...
   *     high-level categorization of the activity that can be useful for filtering and searching.
   */
  public ActivityDefinitionBuilder withTopic(@NonNull Collection<CodeableConcept> topic) {
   ...
   */
  public ActivityDefinitionBuilder withAuthor(@NonNull ContactDetail... author) {
   ...
   *     maintenance of the content.
   */
  public ActivityDefinitionBuilder withAuthor(@NonNull Collection<ContactDetail> author) {
   ...
   *     the content.
   */
  public ActivityDefinitionBuilder withEditor(@NonNull ContactDetail... editor) {
   ...
   *     the content.
   */
  public ActivityDefinitionBuilder withEditor(@NonNull Collection<ContactDetail> editor) {
   ...
   */
  public ActivityDefinitionBuilder withIntent(@NonNull REQUEST_INTENT intent) {
   ...
   */
  public ActivityDefinitionBuilder withDosage(@NonNull Dosage... dosage) {
   ...
   *     for MedicationRequest resources.
   */
  public ActivityDefinitionBuilder withDosage(@NonNull Collection<Dosage> dosage) {
   ...
   */
  public ActivityDefinitionBuilder withVersion(@NonNull String version) {
   ...
   *     publisher.
   */
  public ActivityDefinitionBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public ActivityDefinitionBuilder withContact(@NonNull Collection<ContactDetail> contact) {
   ...
   *     designed as it has.
   */
  public ActivityDefinitionBuilder withPurpose(@NonNull String purpose) {
   ...
   *     activity definition.
   */
  public ActivityDefinitionBuilder withLibrary(@NonNull String... library) {
   ...
   *     activity definition.
   */
  public ActivityDefinitionBuilder withLibrary(@NonNull Collection<String> library) {
   ...
   *     conform.
   */
  public ActivityDefinitionBuilder withProfile(@NonNull String profile) {
    this.profile = Optional.of(profile);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public ActivityDefinitionBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public ActivityDefinitionBuilder withSubtitle(@NonNull String subtitle) {
   ...
   *     of the content.
   */
  public ActivityDefinitionBuilder withReviewer(@NonNull ContactDetail... reviewer) {
   ...
   *     of the content.
   */
  public ActivityDefinitionBuilder withReviewer(@NonNull Collection<ContactDetail> reviewer) {
   ...
   */
  public ActivityDefinitionBuilder withEndorser(@NonNull ContactDetail... endorser) {
   ...
   *     content for use in some setting.
   */
  public ActivityDefinitionBuilder withEndorser(@NonNull Collection<ContactDetail> endorser) {
   ...
   *     requests.
   */
  public ActivityDefinitionBuilder withPriority(@NonNull REQUEST_PRIORITY priority) {
   ...
   *     specific clinic, etc.
   */
  public ActivityDefinitionBuilder withLocation(@NonNull Reference location) {
   ...
   *     etc.).
   */
  public ActivityDefinitionBuilder withQuantity(@NonNull Quantity quantity) {
   ...
   */
  public ActivityDefinitionBuilder withBodySite(@NonNull CodeableConcept... bodySite) {
   ...
   *     performed (I.e. the target sites).
   */
  public ActivityDefinitionBuilder withBodySite(@NonNull Collection<CodeableConcept> bodySite) {
   ...
   */
  public ActivityDefinitionBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public ActivityDefinitionBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public ActivityDefinitionBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ActivityDefinitionBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     definition.
   */
  public ActivityDefinitionBuilder withPublisher(@NonNull String publisher) {
   ...
   */
  public ActivityDefinitionBuilder withCopyright(@NonNull String copyright) {
   ...
   *     Range, Timing.
   */
  public <T> ActivityDefinitionBuilder withTiming(@NonNull T timing) {
    var guessedSuffix =
        autoSuffix(timing.getClass().getSimpleName(), ActivityDefinition$.MODULE$.timing());
   ...
   */
  public <T> ActivityDefinitionBuilder withTiming(String suffix, @NonNull T timing) {
    guard(timing.getClass().getSimpleName(), suffix, ActivityDefinition$.MODULE$.timing());
    this.timing =
        Optional.of(
            (Choice)
                Choice$.MODULE$.fromSuffix(suffix, timing, ActivityDefinition$.MODULE$.timing()));
    return this;
  }
  /**
   ...
   */
  public ActivityDefinitionBuilder withTransform(@NonNull String transform) {
   ...
   *     instance.
   */
  public ActivityDefinitionBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     instance.
   */
  public ActivityDefinitionBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public <T> ActivityDefinitionBuilder withSubject(@NonNull T subject) {
    var guessedSuffix =
        autoSuffix(subject.getClass().getSimpleName(), ActivityDefinition$.MODULE$.subject());
   ...
   */
  public <T> ActivityDefinitionBuilder withSubject(String suffix, @NonNull T subject) {
    guard(subject.getClass().getSimpleName(), suffix, ActivityDefinition$.MODULE$.subject());
    this.subject =
        Optional.of(
            (Choice)
                Choice$.MODULE$.fromSuffix(suffix, subject, ActivityDefinition$.MODULE$.subject()));
    return this;
  }
  /**
   ...
   */
  public ActivityDefinitionBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate activity definition instances.
   */
  public ActivityDefinitionBuilder withUseContext(@NonNull Collection<UsageContext> useContext) {
   ...
   */
  public <T> ActivityDefinitionBuilder withProduct(@NonNull T product) {
    var guessedSuffix =
        autoSuffix(product.getClass().getSimpleName(), ActivityDefinition$.MODULE$.product());
   ...
   */
  public <T> ActivityDefinitionBuilder withProduct(String suffix, @NonNull T product) {
    guard(product.getClass().getSimpleName(), suffix, ActivityDefinition$.MODULE$.product());
    this.product =
        Optional.of(
            (Choice)
                Choice$.MODULE$.fromSuffix(suffix, product, ActivityDefinition$.MODULE$.product()));
    return this;
  }
  /**
   ...
   */
  public ActivityDefinitionBuilder withDescription(@NonNull String description) {
   ...
   *     genuine usage.
   */
  public ActivityDefinitionBuilder withExperimental(@NonNull Boolean experimental) {
   ...
   *     to be used.
   */
  public ActivityDefinitionBuilder withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
   ...
   *     to be used.
   */
  public ActivityDefinitionBuilder withJurisdiction(
   ...
   */
  public ActivityDefinitionBuilder withApprovalDate(@NonNull FHIRDate approvalDate) {
   ...
   */
  public ActivityDefinitionBuilder withDoNotPerform(@NonNull Boolean doNotPerform) {
   ...
   *     profiles etc.
   */
  public ActivityDefinitionBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public ActivityDefinitionBuilder withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
   ...
   */
  public ActivityDefinitionBuilder withEffectivePeriod(@NonNull Period effectivePeriod) {
   ...
   */
  public ActivityDefinitionBuilder withRelatedArtifact(
   ...
   */
  public ActivityDefinitionBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public ActivityDefinitionBuilder withModifierExtension(
   ...
   */
  public ActivityDefinitionBuilder withSpecimenRequirement(
   ...
   */
  public ActivityDefinitionBuilder withObservationRequirement(
   ...
   *     by the action.
   */
  public ActivityDefinitionBuilder withObservationResultRequirement(
  ...
  public ActivityDefinitionBuilder withParticipant(
   ...
   */
  public ActivityDefinitionBuilder withDynamicValue(
