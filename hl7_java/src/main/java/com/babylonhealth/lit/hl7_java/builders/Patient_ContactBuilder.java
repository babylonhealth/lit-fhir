...
public class Patient_ContactBuilder {
  ...
  public Patient_ContactBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public Patient_ContactBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param name - A name associated with the individual. */
  public Patient_ContactBuilder withName(@NonNull HumanName name) {
   ...
   */
  public Patient_ContactBuilder withGender(@NonNull ADMINISTRATIVE_GENDER gender) {
    this.gender = Optional.of(gender);
    return this;
  }
  /** @param period */
  public Patient_ContactBuilder withPeriod(@NonNull Period period) {
   ...
   */
  public Patient_ContactBuilder withTelecom(@NonNull ContactPoint... telecom) {
   ...
   *     individual may be contacted.
   */
  public Patient_ContactBuilder withTelecom(@NonNull Collection<ContactPoint> telecom) {
    this.telecom = Collections.unmodifiableCollection(telecom);
    return this;
  }
  /** @param address - An address for the individual. */
  public Patient_ContactBuilder withAddress(@NonNull Address address) {
   ...
   */
  public Patient_ContactBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Patient_ContactBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param relationship */
  public Patient_ContactBuilder withRelationship(@NonNull CodeableConcept... relationship) {
    this.relationship = Arrays.asList(relationship);
    return this;
  }
  /** @param relationship */
  public Patient_ContactBuilder withRelationship(
      @NonNull Collection<CodeableConcept> relationship) {
    this.relationship = Collections.unmodifiableCollection(relationship);
    return this;
  }
  /** @param organization */
  public Patient_ContactBuilder withOrganization(@NonNull Reference organization) {
   ...
   */
  public Patient_ContactBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public Patient_ContactBuilder withModifierExtension(
