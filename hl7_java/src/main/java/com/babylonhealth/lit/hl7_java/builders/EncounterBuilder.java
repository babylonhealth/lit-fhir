...
public class EncounterBuilder {
   ...
   */
  public EncounterBuilder(Coding _class, ENCOUNTER_STATUS status) {
    this._class = _class;
    this.status = status;
  }
   ...
   */
  public EncounterBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public EncounterBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public EncounterBuilder withText(@NonNull Narrative text) {
   ...
   */
  public EncounterBuilder withType(@NonNull CodeableConcept... _type) {
   ...
   *     nursing, rehabilitation).
   */
  public EncounterBuilder withType(@NonNull Collection<CodeableConcept> _type) {
    this._type = Collections.unmodifiableCollection(_type);
    return this;
  }
  /** @param period - The start and end time of the encounter. */
  public EncounterBuilder withPeriod(@NonNull Period period) {
   ...
   *     absence.
   */
  public EncounterBuilder withLength(@NonNull Duration length) {
   ...
   *     time).
   */
  public EncounterBuilder withPartOf(@NonNull Reference partOf) {
    this.partOf = Optional.of(partOf);
    return this;
  }
  /** @param subject - The patient or group present at the encounter. */
  public EncounterBuilder withSubject(@NonNull Reference subject) {
   ...
   *     request).
   */
  public EncounterBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     request).
   */
  public EncounterBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param account - The set of accounts that may be used for billing for this Encounter. */
  public EncounterBuilder withAccount(@NonNull Reference... account) {
    this.account = Arrays.asList(account);
    return this;
  }
  /** @param account - The set of accounts that may be used for billing for this Encounter. */
  public EncounterBuilder withAccount(@NonNull Collection<Reference> account) {
    this.account = Collections.unmodifiableCollection(account);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public EncounterBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param priority - Indicates the urgency of the encounter. */
  public EncounterBuilder withPriority(@NonNull CodeableConcept priority) {
   ...
   */
  public EncounterBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public EncounterBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public EncounterBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public EncounterBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param identifier - Identifier(s) by which this encounter is known. */
  public EncounterBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - Identifier(s) by which this encounter is known. */
  public EncounterBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public EncounterBuilder withReasonCode(@NonNull CodeableConcept... reasonCode) {
   ...
   *     can be used for a coded admission diagnosis.
   */
  public EncounterBuilder withReasonCode(@NonNull Collection<CodeableConcept> reasonCode) {
   ...
   *     cardiology).
   */
  public EncounterBuilder withServiceType(@NonNull CodeableConcept serviceType) {
    this.serviceType = Optional.of(serviceType);
    return this;
  }
  /** @param appointment - The appointment that scheduled this encounter. */
  public EncounterBuilder withAppointment(@NonNull Reference... appointment) {
    this.appointment = Arrays.asList(appointment);
    return this;
  }
  /** @param appointment - The appointment that scheduled this encounter. */
  public EncounterBuilder withAppointment(@NonNull Collection<Reference> appointment) {
   ...
   *     profiles etc.
   */
  public EncounterBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     span years).
   */
  public EncounterBuilder withEpisodeOfCare(@NonNull Reference... episodeOfCare) {
   ...
   *     span years).
   */
  public EncounterBuilder withEpisodeOfCare(@NonNull Collection<Reference> episodeOfCare) {
   ...
   */
  public EncounterBuilder withReasonReference(@NonNull Reference... reasonReference) {
   ...
   *     this can be used for a coded admission diagnosis.
   */
  public EncounterBuilder withReasonReference(@NonNull Collection<Reference> reasonReference) {
   ...
   */
  public EncounterBuilder withServiceProvider(@NonNull Reference serviceProvider) {
   ...
   */
  public EncounterBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public EncounterBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param location - List of locations where the patient has been during this encounter. */
  public EncounterBuilder withLocation(@NonNull Encounter.Location... location) {
    this.location = Arrays.asList(location);
    return this;
  }
  /** @param location - List of locations where the patient has been during this encounter. */
  public EncounterBuilder withLocation(@NonNull Collection<Encounter.Location> location) {
  ...
  public EncounterBuilder withDiagnosis(@NonNull Encounter.Diagnosis... diagnosis) {
    this.diagnosis = Arrays.asList(diagnosis);
    return this;
  }
  /** @param diagnosis - The list of diagnosis relevant to this encounter. */
  public EncounterBuilder withDiagnosis(@NonNull Collection<Encounter.Diagnosis> diagnosis) {
  ...
  public EncounterBuilder withParticipant(@NonNull Encounter.Participant... participant) {
    this.participant = Arrays.asList(participant);
    return this;
  }
  /** @param participant - The list of people responsible for providing the service. */
  public EncounterBuilder withParticipant(@NonNull Collection<Encounter.Participant> participant) {
   ...
   */
  public EncounterBuilder withClassHistory(@NonNull Encounter.ClassHistory... classHistory) {
   ...
   *     during a kind of discharge from emergency to inpatient.
   */
  public EncounterBuilder withClassHistory(
   ...
   */
  public EncounterBuilder withStatusHistory(@NonNull Encounter.StatusHistory... statusHistory) {
   ...
   *     have the server store them.
   */
  public EncounterBuilder withStatusHistory(
  ...
  public EncounterBuilder withHospitalization(@NonNull Encounter.Hospitalization hospitalization) {
