...
public interface MedicationKnowledge_MonitoringProgramBuilder {
  ...
  public class Impl implements MedicationKnowledge_MonitoringProgramBuilder {
     ...
     */
    public MedicationKnowledge_MonitoringProgramBuilder.Impl withId(@NonNull String id) {
