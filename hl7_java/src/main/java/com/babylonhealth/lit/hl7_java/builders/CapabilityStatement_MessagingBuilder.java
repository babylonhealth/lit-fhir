...
public class CapabilityStatement_MessagingBuilder {
  ...
  public CapabilityStatement_MessagingBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public CapabilityStatement_MessagingBuilder withId(@NonNull String id) {
   ...
   */
  public CapabilityStatement_MessagingBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public CapabilityStatement_MessagingBuilder withExtension(
      @NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param reliableCache */
  public CapabilityStatement_MessagingBuilder withReliableCache(@NonNull Integer reliableCache) {
    this.reliableCache = Optional.of(reliableCache);
    return this;
  }
  /** @param documentation */
  public CapabilityStatement_MessagingBuilder withDocumentation(@NonNull String documentation) {
   ...
   */
  public CapabilityStatement_MessagingBuilder withModifierExtension(
  ...
  /** @param endpoint */
  public CapabilityStatement_MessagingBuilder withEndpoint(
  ...
  public CapabilityStatement_MessagingBuilder withSupportedMessage(
