...
public interface Device_PropertyBuilder {
  ...
  public class Impl implements Device_PropertyBuilder {
     ...
     */
    public Device_PropertyBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public Device_PropertyBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
