...
public class Contract_FriendlyBuilder {
   ...
   */
  public Contract_FriendlyBuilder withId(@NonNull String id) {
   ...
   */
  public Contract_FriendlyBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Contract_FriendlyBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public Contract_FriendlyBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public Contract_FriendlyBuilder withModifierExtension(
