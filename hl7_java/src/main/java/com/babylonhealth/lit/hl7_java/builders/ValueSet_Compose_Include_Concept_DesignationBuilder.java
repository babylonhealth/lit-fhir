...
public interface ValueSet_Compose_Include_Concept_DesignationBuilder {
  ...
  public class Impl implements ValueSet_Compose_Include_Concept_DesignationBuilder {
     ...
     */
    public ValueSet_Compose_Include_Concept_DesignationBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param use */
    public ValueSet_Compose_Include_Concept_DesignationBuilder.Impl withUse(@NonNull Coding use) {
