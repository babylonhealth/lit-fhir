...
public interface MedicationKnowledge_MedicineClassificationBuilder {
  ...
  public class Impl implements MedicationKnowledge_MedicineClassificationBuilder {
     ...
     */
    public MedicationKnowledge_MedicineClassificationBuilder.Impl withId(@NonNull String id) {
