...
public interface OperationDefinitionBuilder extends CanonicalResourceBuilder {
  ...
  public class Impl implements OperationDefinitionBuilder {
     ...
     */
    public OperationDefinitionBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public OperationDefinitionBuilder.Impl withUrl(@NonNull String url) {
     ...
     */
    public OperationDefinitionBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     *     definition changes.
     */
    public OperationDefinitionBuilder.Impl withDate(@NonNull FHIRDateTime date) {
     ...
     */
    public OperationDefinitionBuilder.Impl withBase(@NonNull String base) {
      this.base = Optional.of(base);
      return this;
    }
    /** @param title - A short, descriptive, user-friendly title for the operation definition. */
    public OperationDefinitionBuilder.Impl withTitle(@NonNull String title) {
     ...
     *     an arbitrary value managed by the operation definition author and is not expected to be
     ...
     */
    public OperationDefinitionBuilder.Impl withVersion(@NonNull String version) {
     ...
     *     publisher.
     */
    public OperationDefinitionBuilder.Impl withContact(@NonNull ContactDetail... contact) {
     ...
     *     publisher.
     */
    public OperationDefinitionBuilder.Impl withContact(@NonNull Collection<ContactDetail> contact) {
     ...
     *     designed as it has.
     */
    public OperationDefinitionBuilder.Impl withPurpose(@NonNull String purpose) {
      this.purpose = Optional.of(purpose);
      return this;
    }
    /** @param comment - Additional information about how to use this operation or named query. */
    public OperationDefinitionBuilder.Impl withComment(@NonNull String comment) {
      this.comment = Optional.of(comment);
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public OperationDefinitionBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
      this.language = Optional.of(language);
      return this;
    }
    /** @param resource - The types on which this operation can be executed. */
    public OperationDefinitionBuilder.Impl withResource(@NonNull RESOURCE_TYPES... resource) {
      this.resource = Arrays.asList(resource);
      return this;
    }
    /** @param resource - The types on which this operation can be executed. */
    public OperationDefinitionBuilder.Impl withResource(
        @NonNull Collection<RESOURCE_TYPES> resource) {
     ...
     */
    public OperationDefinitionBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     their own independent transaction scope.
     */
    public OperationDefinitionBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
     ...
     */
    public OperationDefinitionBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     definition.
     */
    public OperationDefinitionBuilder.Impl withPublisher(@NonNull String publisher) {
     ...
     */
    public OperationDefinitionBuilder.Impl withUseContext(@NonNull UsageContext... useContext) {
    ...
    /**
     * @param description - A free text natural language description of the operation definition
     *     from a consumer's perspective.
     */
    public OperationDefinitionBuilder.Impl withDescription(@NonNull String description) {
     ...
     *     for genuine usage.
     */
    public OperationDefinitionBuilder.Impl withExperimental(@NonNull Boolean experimental) {
    ...
    /**
     * @param affectsState - Whether the operation affects state. Side effects such as producing
     *     audit trail entries do not count as 'affecting state'.
     */
    public OperationDefinitionBuilder.Impl withAffectsState(@NonNull Boolean affectsState) {
     ...
     *     resource as a whole.
     */
    public OperationDefinitionBuilder.Impl withInputProfile(@NonNull String inputProfile) {
     ...
     *     profiles etc.
     */
    public OperationDefinitionBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     *     resource.
     */
    public OperationDefinitionBuilder.Impl withOutputProfile(@NonNull String outputProfile) {
