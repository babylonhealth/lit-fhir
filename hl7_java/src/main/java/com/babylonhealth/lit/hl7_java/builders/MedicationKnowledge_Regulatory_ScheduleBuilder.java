...
public interface MedicationKnowledge_Regulatory_ScheduleBuilder {
  public MedicationKnowledge$Regulatory$Schedule build();

  public static Impl init(CodeableConcept schedule) {
  ...
  public class Impl implements MedicationKnowledge_Regulatory_ScheduleBuilder {
     ...
     * @param schedule
     */
    public Impl(CodeableConcept schedule) {
     ...
     */
    public MedicationKnowledge_Regulatory_ScheduleBuilder.Impl withId(@NonNull String id) {
