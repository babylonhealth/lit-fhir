...
public class SubstancePolymer_MonomerSetBuilder {
  ...
  public SubstancePolymer_MonomerSetBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public SubstancePolymer_MonomerSetBuilder withId(@NonNull String id) {
   ...
   */
  public SubstancePolymer_MonomerSetBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public SubstancePolymer_MonomerSetBuilder withExtension(
      @NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param ratioType */
  public SubstancePolymer_MonomerSetBuilder withRatioType(@NonNull CodeableConcept ratioType) {
   ...
   */
  public SubstancePolymer_MonomerSetBuilder withModifierExtension(
  ...
  public SubstancePolymer_MonomerSetBuilder withStartingMaterial(
