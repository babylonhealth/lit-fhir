...
public class InsurancePlan_Plan_SpecificCostBuilder {
   ...
   * @param category
   */
  public InsurancePlan_Plan_SpecificCostBuilder(CodeableConcept category) {
   ...
   */
  public InsurancePlan_Plan_SpecificCostBuilder withId(@NonNull String id) {
   ...
   */
  public InsurancePlan_Plan_SpecificCostBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public InsurancePlan_Plan_SpecificCostBuilder withExtension(
   ...
   */
  public InsurancePlan_Plan_SpecificCostBuilder withModifierExtension(
  ...
  /** @param benefit */
  public InsurancePlan_Plan_SpecificCostBuilder withBenefit(
