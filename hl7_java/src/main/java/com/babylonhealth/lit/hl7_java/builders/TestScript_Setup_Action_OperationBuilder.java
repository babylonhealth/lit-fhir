...
public class TestScript_Setup_Action_OperationBuilder {
   ...
   */
  public TestScript_Setup_Action_OperationBuilder(Boolean encodeRequestUrl) {
   ...
   */
  public TestScript_Setup_Action_OperationBuilder withId(@NonNull String id) {
   ...
   *     different servers.
   */
  public TestScript_Setup_Action_OperationBuilder withUrl(@NonNull String url) {
    this.url = Optional.of(url);
    return this;
  }
  /** @param _type */
  public TestScript_Setup_Action_OperationBuilder withType(@NonNull Coding _type) {
    this._type = Optional.of(_type);
    return this;
  }
  /** @param label */
  public TestScript_Setup_Action_OperationBuilder withLabel(@NonNull String label) {
    this.label = Optional.of(label);
    return this;
  }
  /** @param accept */
  public TestScript_Setup_Action_OperationBuilder withAccept(@NonNull String accept) {
    this.accept = Optional.of(accept);
    return this;
  }
  /** @param method */
  public TestScript_Setup_Action_OperationBuilder withMethod(@NonNull HTTP_OPERATIONS method) {
   ...
   *     element.
   */
  public TestScript_Setup_Action_OperationBuilder withOrigin(@NonNull Integer origin) {
    this.origin = Optional.of(origin);
    return this;
  }
  /** @param params */
  public TestScript_Setup_Action_OperationBuilder withParams(@NonNull String params) {
    this.params = Optional.of(params);
    return this;
  }
  /** @param resource */
  public TestScript_Setup_Action_OperationBuilder withResource(@NonNull DEFINED_TYPES resource) {
    this.resource = Optional.of(resource);
    return this;
  }
  /** @param sourceId */
  public TestScript_Setup_Action_OperationBuilder withSourceId(@NonNull String sourceId) {
    this.sourceId = Optional.of(sourceId);
    return this;
  }
  /** @param targetId */
  public TestScript_Setup_Action_OperationBuilder withTargetId(@NonNull String targetId) {
   ...
   */
  public TestScript_Setup_Action_OperationBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public TestScript_Setup_Action_OperationBuilder withExtension(
      @NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param requestId */
  public TestScript_Setup_Action_OperationBuilder withRequestId(@NonNull String requestId) {
    this.requestId = Optional.of(requestId);
    return this;
  }
  /** @param responseId */
  public TestScript_Setup_Action_OperationBuilder withResponseId(@NonNull String responseId) {
   ...
   */
  public TestScript_Setup_Action_OperationBuilder withDescription(@NonNull String description) {
    this.description = Optional.of(description);
    return this;
  }
  /** @param contentType */
  public TestScript_Setup_Action_OperationBuilder withContentType(@NonNull String contentType) {
   ...
   *     destination element.
   */
  public TestScript_Setup_Action_OperationBuilder withDestination(@NonNull Integer destination) {
   ...
   */
  public TestScript_Setup_Action_OperationBuilder withModifierExtension(
  ...
  /** @param requestHeader */
  public TestScript_Setup_Action_OperationBuilder withRequestHeader(
