...
public class StructureMap_GroupBuilder {
   ...
   * @param rule
   */
  public StructureMap_GroupBuilder(
      String name,
   ...
   */
  public StructureMap_GroupBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param _extends */
  public StructureMap_GroupBuilder withExtends(@NonNull String _extends) {
   ...
   */
  public StructureMap_GroupBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public StructureMap_GroupBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param documentation */
  public StructureMap_GroupBuilder withDocumentation(@NonNull String documentation) {
   ...
   */
  public StructureMap_GroupBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public StructureMap_GroupBuilder withModifierExtension(
