...
public class Composition_RelatesToBuilder {
   ...
   */
  public Composition_RelatesToBuilder withId(@NonNull String id) {
   ...
   */
  public Composition_RelatesToBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Composition_RelatesToBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public Composition_RelatesToBuilder withModifierExtension(
