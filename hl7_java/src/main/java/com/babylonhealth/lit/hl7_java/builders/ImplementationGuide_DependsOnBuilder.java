...
public class ImplementationGuide_DependsOnBuilder {
   ...
   * @param uri
   */
  public ImplementationGuide_DependsOnBuilder(String uri) {
    this.uri = uri;
  }
   ...
   */
  public ImplementationGuide_DependsOnBuilder withId(@NonNull String id) {
   ...
   */
  public ImplementationGuide_DependsOnBuilder withVersion(@NonNull String version) {
   ...
   */
  public ImplementationGuide_DependsOnBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ImplementationGuide_DependsOnBuilder withExtension(
   ...
   */
  public ImplementationGuide_DependsOnBuilder withPackageId(@NonNull String packageId) {
   ...
   */
  public ImplementationGuide_DependsOnBuilder withModifierExtension(
