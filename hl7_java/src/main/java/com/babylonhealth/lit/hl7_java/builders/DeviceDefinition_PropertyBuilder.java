...
public class DeviceDefinition_PropertyBuilder {
   ...
   */
  public DeviceDefinition_PropertyBuilder(CodeableConcept _type) {
    this._type = _type;
  }
   ...
   */
  public DeviceDefinition_PropertyBuilder withId(@NonNull String id) {
   ...
   */
  public DeviceDefinition_PropertyBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public DeviceDefinition_PropertyBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param valueCode */
  public DeviceDefinition_PropertyBuilder withValueCode(@NonNull CodeableConcept... valueCode) {
    this.valueCode = Arrays.asList(valueCode);
    return this;
  }
  /** @param valueCode */
  public DeviceDefinition_PropertyBuilder withValueCode(
      @NonNull Collection<CodeableConcept> valueCode) {
    this.valueCode = Collections.unmodifiableCollection(valueCode);
    return this;
  }
  /** @param valueQuantity */
  public DeviceDefinition_PropertyBuilder withValueQuantity(@NonNull Quantity... valueQuantity) {
    this.valueQuantity = Arrays.asList(valueQuantity);
    return this;
  }
  /** @param valueQuantity */
  public DeviceDefinition_PropertyBuilder withValueQuantity(
   ...
   */
  public DeviceDefinition_PropertyBuilder withModifierExtension(
