...
public class Questionnaire_Item_InitialBuilder {
   ...
   */
  public Questionnaire_Item_InitialBuilder withId(@NonNull String id) {
   ...
   */
  public Questionnaire_Item_InitialBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Questionnaire_Item_InitialBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public Questionnaire_Item_InitialBuilder withModifierExtension(
