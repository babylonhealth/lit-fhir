...
public interface DeviceDefinition_DeviceNameBuilder {
  ...
  public class Impl implements DeviceDefinition_DeviceNameBuilder {
     ...
     */
    public DeviceDefinition_DeviceNameBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public DeviceDefinition_DeviceNameBuilder.Impl withExtension(@NonNull Extension... extension) {
