...
public class MedicationKnowledge_AdministrationGuidelinesBuilder {
   ...
   */
  public MedicationKnowledge_AdministrationGuidelinesBuilder withId(@NonNull String id) {
   ...
   */
  public MedicationKnowledge_AdministrationGuidelinesBuilder withExtension(
   ...
   */
  public MedicationKnowledge_AdministrationGuidelinesBuilder withModifierExtension(
  ...
  /** @param dosage */
  public MedicationKnowledge_AdministrationGuidelinesBuilder withDosage(
  ...
  public MedicationKnowledge_AdministrationGuidelinesBuilder withPatientCharacteristics(
      @NonNull
