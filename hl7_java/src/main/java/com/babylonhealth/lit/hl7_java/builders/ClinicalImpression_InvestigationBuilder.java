...
public interface ClinicalImpression_InvestigationBuilder {
  ...
  public class Impl implements ClinicalImpression_InvestigationBuilder {
     ...
     */
    public ClinicalImpression_InvestigationBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param item */
    public ClinicalImpression_InvestigationBuilder.Impl withItem(@NonNull Reference... item) {
      this.item = Arrays.asList(item);
      return this;
    }
    /** @param item */
    public ClinicalImpression_InvestigationBuilder.Impl withItem(
        @NonNull Collection<Reference> item) {
