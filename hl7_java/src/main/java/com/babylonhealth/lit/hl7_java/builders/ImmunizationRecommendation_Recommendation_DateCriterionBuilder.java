...
public interface ImmunizationRecommendation_Recommendation_DateCriterionBuilder {
  public ImmunizationRecommendation$Recommendation$DateCriterion build();

  public static Impl init(CodeableConcept code, FHIRDateTime value) {
  ...
  public class Impl implements ImmunizationRecommendation_Recommendation_DateCriterionBuilder {
     ...
     * @param value
     */
    public Impl(CodeableConcept code, FHIRDateTime value) {
      this.code = code;
      this.value = value;
    }
     ...
     */
    public ImmunizationRecommendation_Recommendation_DateCriterionBuilder.Impl withId(
        @NonNull String id) {
