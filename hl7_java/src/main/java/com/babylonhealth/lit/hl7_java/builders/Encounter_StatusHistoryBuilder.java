...
public interface Encounter_StatusHistoryBuilder {
  public Encounter.StatusHistory build();

  public static Impl init(ENCOUNTER_STATUS status, Period period) {
  ...
  public class Impl implements Encounter_StatusHistoryBuilder {
     ...
     */
    public Encounter_StatusHistoryBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public Encounter_StatusHistoryBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public Encounter_StatusHistoryBuilder.Impl withExtension(
     ...
     */
    public Encounter_StatusHistoryBuilder.Impl withModifierExtension(
