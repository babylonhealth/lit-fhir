...
public interface CodeSystemBuilder extends CanonicalResourceBuilder {
  public CodeSystem build();

  public static Impl init(PUBLICATION_STATUS status, CODESYSTEM_CONTENT_MODE content) {
  ...
  public class Impl implements CodeSystemBuilder {
     ...
     */
    public Impl(PUBLICATION_STATUS status, CODESYSTEM_CONTENT_MODE content) {
      this.status = status;
     ...
     */
    public CodeSystemBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public CodeSystemBuilder.Impl withUrl(@NonNull String url) {
     ...
     */
    public CodeSystemBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     *     generation.
     */
    public CodeSystemBuilder.Impl withName(@NonNull String name) {
     ...
     *     changes.
     */
    public CodeSystemBuilder.Impl withDate(@NonNull FHIRDateTime date) {
      this.date = Optional.of(date);
      return this;
    }
    /** @param title - A short, descriptive, user-friendly title for the code system. */
    public CodeSystemBuilder.Impl withTitle(@NonNull String title) {
     ...
     */
    public CodeSystemBuilder.Impl withCount(@NonNull Integer count) {
     ...
     */
    public CodeSystemBuilder.Impl withVersion(@NonNull String version) {
     ...
     *     publisher.
     */
    public CodeSystemBuilder.Impl withContact(@NonNull ContactDetail... contact) {
     ...
     *     publisher.
     */
    public CodeSystemBuilder.Impl withContact(@NonNull Collection<ContactDetail> contact) {
     ...
     *     as it has.
     */
    public CodeSystemBuilder.Impl withPurpose(@NonNull String purpose) {
      this.purpose = Optional.of(purpose);
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public CodeSystemBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public CodeSystemBuilder.Impl withValueSet(@NonNull String valueSet) {
     ...
     */
    public CodeSystemBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     their own independent transaction scope.
     */
    public CodeSystemBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
     ...
     */
    public CodeSystemBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     */
    public CodeSystemBuilder.Impl withPublisher(@NonNull String publisher) {
     ...
     *     code system.
     */
    public CodeSystemBuilder.Impl withCopyright(@NonNull String copyright) {
     ...
     *     instance.
     */
    public CodeSystemBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     *     instance.
     */
    public CodeSystemBuilder.Impl withIdentifier(@NonNull Collection<Identifier> identifier) {
     ...
     */
    public CodeSystemBuilder.Impl withUseContext(@NonNull UsageContext... useContext) {
     ...
     */
    public CodeSystemBuilder.Impl withDescription(@NonNull String description) {
     ...
     */
    public CodeSystemBuilder.Impl withSupplements(@NonNull String supplements) {
     ...
     *     genuine usage.
     */
    public CodeSystemBuilder.Impl withExperimental(@NonNull Boolean experimental) {
     ...
     *     used.
     */
    public CodeSystemBuilder.Impl withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
     ...
     *     profiles etc.
     */
    public CodeSystemBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public CodeSystemBuilder.Impl withCaseSensitive(@NonNull Boolean caseSensitive) {
     ...
     */
    public CodeSystemBuilder.Impl withCompositional(@NonNull Boolean compositional) {
     ...
     *     this code system.
     */
    public CodeSystemBuilder.Impl withVersionNeeded(@NonNull Boolean versionNeeded) {
     ...
     *     resource.
     */
    public CodeSystemBuilder.Impl withHierarchyMeaning(
     ...
     */
    public CodeSystemBuilder.Impl withModifierExtension(@NonNull Extension... modifierExtension) {
     ...
     */
    public CodeSystemBuilder.Impl withFilter(@NonNull CodeSystem.Filter... filter) {
     ...
     */
    public CodeSystemBuilder.Impl withProperty(@NonNull CodeSystem.Property... property) {
     ...
     *     can be provided about a concept.
     */
    public CodeSystemBuilder.Impl withProperty(@NonNull Collection<CodeSystem.Property> property) {
     ...
     */
    public CodeSystemBuilder.Impl withConcept(@NonNull CodeSystem.Concept... concept) {
