...
public class MeasureBuilder {
   ...
   */
  public MeasureBuilder withId(@NonNull String id) {
   ...
   *     different servers.
   */
  public MeasureBuilder withUrl(@NonNull String url) {
   ...
   *     to the resource.
   */
  public MeasureBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public MeasureBuilder withText(@NonNull Narrative text) {
   ...
   */
  public MeasureBuilder withName(@NonNull String name) {
   ...
   */
  public MeasureBuilder withDate(@NonNull FHIRDateTime date) {
   ...
   */
  public MeasureBuilder withType(@NonNull CodeableConcept... _type) {
   ...
   *     time, a patient-reported outcome, or a structure measure such as utilization.
   */
  public MeasureBuilder withType(@NonNull Collection<CodeableConcept> _type) {
    this._type = Collections.unmodifiableCollection(_type);
    return this;
  }
  /** @param title - A short, descriptive, user-friendly title for the measure. */
  public MeasureBuilder withTitle(@NonNull String title) {
   ...
   */
  public MeasureBuilder withUsage(@NonNull String usage) {
   ...
   *     searching.
   */
  public MeasureBuilder withTopic(@NonNull CodeableConcept... topic) {
   ...
   *     searching.
   */
  public MeasureBuilder withTopic(@NonNull Collection<CodeableConcept> topic) {
   ...
   */
  public MeasureBuilder withAuthor(@NonNull ContactDetail... author) {
   ...
   *     maintenance of the content.
   */
  public MeasureBuilder withAuthor(@NonNull Collection<ContactDetail> author) {
   ...
   *     the content.
   */
  public MeasureBuilder withEditor(@NonNull ContactDetail... editor) {
   ...
   *     the content.
   */
  public MeasureBuilder withEditor(@NonNull Collection<ContactDetail> editor) {
   ...
   */
  public MeasureBuilder withVersion(@NonNull String version) {
   ...
   *     publisher.
   */
  public MeasureBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public MeasureBuilder withContact(@NonNull Collection<ContactDetail> contact) {
   ...
   *     has.
   */
  public MeasureBuilder withPurpose(@NonNull String purpose) {
   ...
   *     measure.
   */
  public MeasureBuilder withLibrary(@NonNull String... library) {
   ...
   *     measure.
   */
  public MeasureBuilder withLibrary(@NonNull Collection<String> library) {
   ...
   */
  public MeasureBuilder withScoring(@NonNull CodeableConcept scoring) {
    this.scoring = Optional.of(scoring);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public MeasureBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public MeasureBuilder withSubtitle(@NonNull String subtitle) {
   ...
   *     of the content.
   */
  public MeasureBuilder withReviewer(@NonNull ContactDetail... reviewer) {
   ...
   *     of the content.
   */
  public MeasureBuilder withReviewer(@NonNull Collection<ContactDetail> reviewer) {
   ...
   */
  public MeasureBuilder withEndorser(@NonNull ContactDetail... endorser) {
   ...
   *     content for use in some setting.
   */
  public MeasureBuilder withEndorser(@NonNull Collection<ContactDetail> endorser) {
   ...
   */
  public MeasureBuilder withGuidance(@NonNull String guidance) {
   ...
   */
  public MeasureBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public MeasureBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public MeasureBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public MeasureBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param publisher - The name of the organization or individual that published the measure. */
  public MeasureBuilder withPublisher(@NonNull String publisher) {
   ...
   */
  public MeasureBuilder withCopyright(@NonNull String copyright) {
   ...
   */
  public MeasureBuilder withRationale(@NonNull String rationale) {
   ...
   *     instance.
   */
  public MeasureBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     instance.
   */
  public MeasureBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public MeasureBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate measure instances.
   */
  public MeasureBuilder withUseContext(@NonNull Collection<UsageContext> useContext) {
   ...
   */
  public MeasureBuilder withDisclaimer(@NonNull String disclaimer) {
  ...
  public MeasureBuilder withDefinition(@NonNull String... definition) {
    this.definition = Arrays.asList(definition);
    return this;
  }
  /** @param definition - Provides a description of an individual term used within the measure. */
  public MeasureBuilder withDefinition(@NonNull Collection<String> definition) {
   ...
   *     perspective.
   */
  public MeasureBuilder withDescription(@NonNull String description) {
   ...
   *     usage.
   */
  public MeasureBuilder withExperimental(@NonNull Boolean experimental) {
   ...
   */
  public MeasureBuilder withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
   ...
   * @param jurisdiction - A legal or geographic region in which the measure is intended to be used.
   */
  public MeasureBuilder withJurisdiction(@NonNull Collection<CodeableConcept> jurisdiction) {
   ...
   */
  public MeasureBuilder withApprovalDate(@NonNull FHIRDate approvalDate) {
   ...
   *     profiles etc.
   */
  public MeasureBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public MeasureBuilder withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
   ...
   */
  public MeasureBuilder withRiskAdjustment(@NonNull String riskAdjustment) {
   ...
   *     active use.
   */
  public MeasureBuilder withEffectivePeriod(@NonNull Period effectivePeriod) {
   ...
   */
  public MeasureBuilder withRelatedArtifact(@NonNull RelatedArtifact... relatedArtifact) {
   ...
   *     bibliographic references.
   */
  public MeasureBuilder withRelatedArtifact(@NonNull Collection<RelatedArtifact> relatedArtifact) {
   ...
   */
  public MeasureBuilder withRateAggregation(@NonNull String rateAggregation) {
   ...
   */
  public MeasureBuilder withCompositeScoring(@NonNull CodeableConcept compositeScoring) {
   ...
   */
  public MeasureBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public MeasureBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
   ...
   */
  public MeasureBuilder withImprovementNotation(@NonNull CodeableConcept improvementNotation) {
   ...
   */
  public MeasureBuilder withClinicalRecommendationStatement(
   ...
   *     Resource Path.
   */
  public MeasureBuilder withSupplementalData(
  ...
  public MeasureBuilder withGroup(@NonNull Measure.Group... group) {
    this.group = Arrays.asList(group);
    return this;
  }
  /** @param group - A group of population criteria for the measure. */
  public MeasureBuilder withGroup(@NonNull Collection<Measure.Group> group) {
