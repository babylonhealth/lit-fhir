...
public interface Procedure_PerformerBuilder {
  ...
  public class Impl implements Procedure_PerformerBuilder {
     ...
     */
    public Procedure_PerformerBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param function */
    public Procedure_PerformerBuilder.Impl withFunction(@NonNull CodeableConcept function) {
     ...
     */
    public Procedure_PerformerBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public Procedure_PerformerBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
