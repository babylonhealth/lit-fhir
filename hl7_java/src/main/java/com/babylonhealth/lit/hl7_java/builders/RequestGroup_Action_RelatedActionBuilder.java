...
public class RequestGroup_Action_RelatedActionBuilder {
   ...
   * @param relationship
   */
  public RequestGroup_Action_RelatedActionBuilder(
   ...
   */
  public RequestGroup_Action_RelatedActionBuilder withId(@NonNull String id) {
   ...
   */
  public RequestGroup_Action_RelatedActionBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public RequestGroup_Action_RelatedActionBuilder withExtension(
   ...
   */
  public RequestGroup_Action_RelatedActionBuilder withModifierExtension(
