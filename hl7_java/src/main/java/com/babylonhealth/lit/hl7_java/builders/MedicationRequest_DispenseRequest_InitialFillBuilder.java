...
public interface MedicationRequest_DispenseRequest_InitialFillBuilder {
  ...
  public class Impl implements MedicationRequest_DispenseRequest_InitialFillBuilder {
     ...
     */
    public MedicationRequest_DispenseRequest_InitialFillBuilder.Impl withId(@NonNull String id) {
