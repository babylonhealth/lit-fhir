...
public interface CatalogEntry_RelatedEntryBuilder {
  ...
  public class Impl implements CatalogEntry_RelatedEntryBuilder {
     ...
     */
    public CatalogEntry_RelatedEntryBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public CatalogEntry_RelatedEntryBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public CatalogEntry_RelatedEntryBuilder.Impl withExtension(
     ...
     */
    public CatalogEntry_RelatedEntryBuilder.Impl withModifierExtension(
