...
public
interface MedicationKnowledge_IndicationGuideline_DosingGuideline_PatientCharacteristicBuilder {
  public MedicationKnowledge$IndicationGuideline$DosingGuideline$PatientCharacteristic build();
  ...
  public class Impl
      implements MedicationKnowledge_IndicationGuideline_DosingGuideline_PatientCharacteristicBuilder {
     ...
     */
    public MedicationKnowledge_IndicationGuideline_DosingGuideline_PatientCharacteristicBuilder.Impl
     ...
     *     MedicationKnowledge_IndicationGuideline_DosingGuideline_PatientCharacteristicBuilder.value
     *     static methods
     */
    public MedicationKnowledge_IndicationGuideline_DosingGuideline_PatientCharacteristicBuilder.Impl
        withValue(@NonNull ChoiceCodeableConceptOrQuantityOrRange value) {
    ...
    public MedicationKnowledge$IndicationGuideline$DosingGuideline$PatientCharacteristic build() {
      return new MedicationKnowledge$IndicationGuideline$DosingGuideline$PatientCharacteristic(
