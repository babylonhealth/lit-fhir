...
public class ValueSet_ExpansionBuilder {
   ...
   * @param timestamp
   */
  public ValueSet_ExpansionBuilder(FHIRDateTime timestamp) {
   ...
   */
  public ValueSet_ExpansionBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param total */
  public ValueSet_ExpansionBuilder withTotal(@NonNull Integer total) {
    this.total = Optional.of(total);
    return this;
  }
  /** @param offset */
  public ValueSet_ExpansionBuilder withOffset(@NonNull Integer offset) {
   ...
   */
  public ValueSet_ExpansionBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ValueSet_ExpansionBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     instance.
   */
  public ValueSet_ExpansionBuilder withIdentifier(@NonNull String identifier) {
   ...
   */
  public ValueSet_ExpansionBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public ValueSet_ExpansionBuilder withModifierExtension(
      @NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param contains */
  public ValueSet_ExpansionBuilder withContains(@NonNull ValueSet$Expansion$Contains... contains) {
    this.contains = Arrays.asList(contains);
    return this;
  }
  /** @param contains */
  public ValueSet_ExpansionBuilder withContains(
      @NonNull Collection<ValueSet$Expansion$Contains> contains) {
    this.contains = Collections.unmodifiableCollection(contains);
    return this;
  }
  /** @param parameter */
  public ValueSet_ExpansionBuilder withParameter(
