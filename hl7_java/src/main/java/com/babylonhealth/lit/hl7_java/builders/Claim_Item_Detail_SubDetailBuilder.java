...
public class Claim_Item_Detail_SubDetailBuilder {
   ...
   */
  public Claim_Item_Detail_SubDetailBuilder(Integer sequence, CodeableConcept productOrService) {
   ...
   */
  public Claim_Item_Detail_SubDetailBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param net */
  public Claim_Item_Detail_SubDetailBuilder withNet(@NonNull Money net) {
    this.net = Optional.of(net);
    return this;
  }
  /** @param udi */
  public Claim_Item_Detail_SubDetailBuilder withUdi(@NonNull Reference... udi) {
    this.udi = Arrays.asList(udi);
    return this;
  }
  /** @param udi */
  public Claim_Item_Detail_SubDetailBuilder withUdi(@NonNull Collection<Reference> udi) {
    this.udi = Collections.unmodifiableCollection(udi);
    return this;
  }
  /** @param factor */
  public Claim_Item_Detail_SubDetailBuilder withFactor(@NonNull BigDecimal factor) {
    this.factor = Optional.of(factor);
    return this;
  }
  /** @param revenue */
  public Claim_Item_Detail_SubDetailBuilder withRevenue(@NonNull CodeableConcept revenue) {
    this.revenue = Optional.of(revenue);
    return this;
  }
  /** @param category */
  public Claim_Item_Detail_SubDetailBuilder withCategory(@NonNull CodeableConcept category) {
    this.category = Optional.of(category);
    return this;
  }
  /** @param modifier */
  public Claim_Item_Detail_SubDetailBuilder withModifier(@NonNull CodeableConcept... modifier) {
    this.modifier = Arrays.asList(modifier);
    return this;
  }
  /** @param modifier */
  public Claim_Item_Detail_SubDetailBuilder withModifier(
      @NonNull Collection<CodeableConcept> modifier) {
    this.modifier = Collections.unmodifiableCollection(modifier);
    return this;
  }
  /** @param quantity */
  public Claim_Item_Detail_SubDetailBuilder withQuantity(@NonNull Quantity quantity) {
   ...
   */
  public Claim_Item_Detail_SubDetailBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Claim_Item_Detail_SubDetailBuilder withExtension(
      @NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param unitPrice */
  public Claim_Item_Detail_SubDetailBuilder withUnitPrice(@NonNull Money unitPrice) {
    this.unitPrice = Optional.of(unitPrice);
    return this;
  }
  /** @param programCode */
  public Claim_Item_Detail_SubDetailBuilder withProgramCode(
   ...
   */
  public Claim_Item_Detail_SubDetailBuilder withModifierExtension(
