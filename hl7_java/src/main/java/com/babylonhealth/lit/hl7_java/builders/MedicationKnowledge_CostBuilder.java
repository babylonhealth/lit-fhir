...
public interface MedicationKnowledge_CostBuilder {
  ...
  public class Impl implements MedicationKnowledge_CostBuilder {
     ...
     */
    public MedicationKnowledge_CostBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param source */
    public MedicationKnowledge_CostBuilder.Impl withSource(@NonNull String source) {
     ...
     */
    public MedicationKnowledge_CostBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     */
    public MedicationKnowledge_CostBuilder.Impl withModifierExtension(
