...
public class Group_CharacteristicBuilder {
   ...
   */
  public Group_CharacteristicBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param period */
  public Group_CharacteristicBuilder withPeriod(@NonNull Period period) {
   ...
   */
  public Group_CharacteristicBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Group_CharacteristicBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public Group_CharacteristicBuilder withModifierExtension(
