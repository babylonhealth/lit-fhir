...
public interface Medication_BatchBuilder {
  ...
  public class Impl implements Medication_BatchBuilder {
     ...
     */
    public Medication_BatchBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public Medication_BatchBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public Medication_BatchBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
    ...
    public Medication_BatchBuilder.Impl withExpirationDate(@NonNull FHIRDateTime expirationDate) {
