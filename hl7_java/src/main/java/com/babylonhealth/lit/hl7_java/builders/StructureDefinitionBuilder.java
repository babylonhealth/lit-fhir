...
public class StructureDefinitionBuilder {
   ...
   * @param name - A natural language name identifying the structure definition. This name should be
   ...
   *     models.
   * @param status - The status of this structure definition. Enables tracking the life-cycle of the
   *     content.
   ...
   */
  public StructureDefinitionBuilder(
      String url,
      String name,
   ...
   */
  public StructureDefinitionBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public StructureDefinitionBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public StructureDefinitionBuilder withText(@NonNull Narrative text) {
   ...
   *     definition changes.
   */
  public StructureDefinitionBuilder withDate(@NonNull FHIRDateTime date) {
    this.date = Optional.of(date);
    return this;
  }
  /** @param title - A short, descriptive, user-friendly title for the structure definition. */
  public StructureDefinitionBuilder withTitle(@NonNull String title) {
   ...
   */
  public StructureDefinitionBuilder withVersion(@NonNull String version) {
   ...
   *     publisher.
   */
  public StructureDefinitionBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public StructureDefinitionBuilder withContact(@NonNull Collection<ContactDetail> contact) {
   ...
   *     designed as it has.
   */
  public StructureDefinitionBuilder withPurpose(@NonNull String purpose) {
   ...
   */
  public StructureDefinitionBuilder withKeyword(@NonNull Coding... keyword) {
   ...
   *     definition, or the content it describes.
   */
  public StructureDefinitionBuilder withKeyword(@NonNull Collection<Coding> keyword) {
    this.keyword = Collections.unmodifiableCollection(keyword);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public StructureDefinitionBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public StructureDefinitionBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public StructureDefinitionBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public StructureDefinitionBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public StructureDefinitionBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     definition.
   */
  public StructureDefinitionBuilder withPublisher(@NonNull String publisher) {
   ...
   */
  public StructureDefinitionBuilder withCopyright(@NonNull String copyright) {
    this.copyright = Optional.of(copyright);
    return this;
  }
  /**
   * @param identifier - A formal identifier that is used to identify this structure definition when
   *     it is represented in other formats, or referenced in a specification, model, design or an
   *     instance.
   */
  public StructureDefinitionBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     instance.
   */
  public StructureDefinitionBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public StructureDefinitionBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate structure definition instances.
   */
  public StructureDefinitionBuilder withUseContext(@NonNull Collection<UsageContext> useContext) {
    this.useContext = Collections.unmodifiableCollection(useContext);
    return this;
  }
  /** @param derivation - How the type relates to the baseDefinition. */
  public StructureDefinitionBuilder withDerivation(@NonNull TYPE_DERIVATION_RULE derivation) {
    this.derivation = Optional.of(derivation);
    return this;
  }
  /**
   * @param description - A free text natural language description of the structure definition from
   *     a consumer's perspective.
   */
  public StructureDefinitionBuilder withDescription(@NonNull String description) {
    this.description = Optional.of(description);
    return this;
  }
  /**
   * @param fhirVersion - The version of the FHIR specification on which this StructureDefinition is
   *     based - this is the formal version of the specification, without the revision number, e.g.
   *     [publication].[major].[minor], which is 4.0.1. for this version.
   */
  public StructureDefinitionBuilder withFhirVersion(@NonNull FHIR_VERSION fhirVersion) {
   ...
   *     genuine usage.
   */
  public StructureDefinitionBuilder withExperimental(@NonNull Boolean experimental) {
   ...
   *     intended to be used.
   */
  public StructureDefinitionBuilder withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
   ...
   *     intended to be used.
   */
  public StructureDefinitionBuilder withJurisdiction(
   ...
   *     profiles etc.
   */
  public StructureDefinitionBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public StructureDefinitionBuilder withBaseDefinition(@NonNull String baseDefinition) {
    this.baseDefinition = Optional.of(baseDefinition);
    return this;
  }
  /**
   * @param contextInvariant - A set of rules as FHIRPath Invariants about when the extension can be
   *     used (e.g. co-occurrence variants for the extension). All the rules must be true.
   */
  public StructureDefinitionBuilder withContextInvariant(@NonNull String... contextInvariant) {
   ...
   *     used (e.g. co-occurrence variants for the extension). All the rules must be true.
   */
  public StructureDefinitionBuilder withContextInvariant(
   ...
   */
  public StructureDefinitionBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public StructureDefinitionBuilder withModifierExtension(
      @NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param mapping - An external specification that the content is mapped to. */
  public StructureDefinitionBuilder withMapping(@NonNull StructureDefinition.Mapping... mapping) {
    this.mapping = Arrays.asList(mapping);
    return this;
  }
  /** @param mapping - An external specification that the content is mapped to. */
  public StructureDefinitionBuilder withMapping(
   ...
   *     can be applied.
   */
  public StructureDefinitionBuilder withContext(@NonNull StructureDefinition.Context... context) {
   ...
   *     can be applied.
   */
  public StructureDefinitionBuilder withContext(
   ...
   */
  public StructureDefinitionBuilder withSnapshot(@NonNull StructureDefinition.Snapshot snapshot) {
    this.snapshot = Optional.of(snapshot);
    return this;
  }
  /**
   * @param differential - A differential view is expressed relative to the base StructureDefinition
   *     - a statement of differences that it applies.
   */
  public StructureDefinitionBuilder withDifferential(
