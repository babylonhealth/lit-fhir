...
public interface ExplanationOfBenefit_CareTeamBuilder {
  ...
  public class Impl implements ExplanationOfBenefit_CareTeamBuilder {
     ...
     */
    public ExplanationOfBenefit_CareTeamBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param role */
    public ExplanationOfBenefit_CareTeamBuilder.Impl withRole(@NonNull CodeableConcept role) {
