...
public class ConceptMap_Group_ElementBuilder {
  ...
  public ConceptMap_Group_ElementBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public ConceptMap_Group_ElementBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param code */
  public ConceptMap_Group_ElementBuilder withCode(@NonNull String code) {
    this.code = Optional.of(code);
    return this;
  }
  /** @param display */
  public ConceptMap_Group_ElementBuilder withDisplay(@NonNull String display) {
   ...
   */
  public ConceptMap_Group_ElementBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ConceptMap_Group_ElementBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public ConceptMap_Group_ElementBuilder withModifierExtension(
   ...
   */
  public ConceptMap_Group_ElementBuilder withTarget(
