...
public class MedicinalProductIngredient_SubstanceBuilder {
   ...
   * @param code
   */
  public MedicinalProductIngredient_SubstanceBuilder(CodeableConcept code) {
    this.code = code;
  }
   ...
   */
  public MedicinalProductIngredient_SubstanceBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param strength */
  public MedicinalProductIngredient_SubstanceBuilder withStrength(
   ...
   */
  public MedicinalProductIngredient_SubstanceBuilder withExtension(
   ...
   */
  public MedicinalProductIngredient_SubstanceBuilder withModifierExtension(
