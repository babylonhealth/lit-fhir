...
public class ExplanationOfBenefit_AddItem_Detail_SubDetailBuilder {
   ...
   */
  public ExplanationOfBenefit_AddItem_Detail_SubDetailBuilder(CodeableConcept productOrService) {
   ...
   */
  public ExplanationOfBenefit_AddItem_Detail_SubDetailBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param net */
  public ExplanationOfBenefit_AddItem_Detail_SubDetailBuilder withNet(@NonNull Money net) {
    this.net = Optional.of(net);
    return this;
  }
  /** @param factor */
  public ExplanationOfBenefit_AddItem_Detail_SubDetailBuilder withFactor(
      @NonNull BigDecimal factor) {
    this.factor = Optional.of(factor);
    return this;
  }
  /** @param modifier */
  public ExplanationOfBenefit_AddItem_Detail_SubDetailBuilder withModifier(
  ...
  /** @param quantity */
  public ExplanationOfBenefit_AddItem_Detail_SubDetailBuilder withQuantity(
   ...
   */
  public ExplanationOfBenefit_AddItem_Detail_SubDetailBuilder withExtension(
  ...
  /** @param unitPrice */
  public ExplanationOfBenefit_AddItem_Detail_SubDetailBuilder withUnitPrice(
      @NonNull Money unitPrice) {
    this.unitPrice = Optional.of(unitPrice);
    return this;
  }
  /** @param noteNumber */
  public ExplanationOfBenefit_AddItem_Detail_SubDetailBuilder withNoteNumber(
   ...
   */
  public ExplanationOfBenefit_AddItem_Detail_SubDetailBuilder withAdjudication(
   ...
   */
  public ExplanationOfBenefit_AddItem_Detail_SubDetailBuilder withModifierExtension(
