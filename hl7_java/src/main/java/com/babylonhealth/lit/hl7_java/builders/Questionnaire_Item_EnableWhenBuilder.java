...
public class Questionnaire_Item_EnableWhenBuilder {
   ...
   */
  public Questionnaire_Item_EnableWhenBuilder withId(@NonNull String id) {
   ...
   */
  public Questionnaire_Item_EnableWhenBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Questionnaire_Item_EnableWhenBuilder withExtension(
   ...
   */
  public Questionnaire_Item_EnableWhenBuilder withModifierExtension(
