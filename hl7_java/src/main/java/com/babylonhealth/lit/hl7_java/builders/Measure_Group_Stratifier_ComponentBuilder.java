...
public interface Measure_Group_Stratifier_ComponentBuilder {
  ...
  public class Impl implements Measure_Group_Stratifier_ComponentBuilder {
     ...
     */
    public Measure_Group_Stratifier_ComponentBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param code */
    public Measure_Group_Stratifier_ComponentBuilder.Impl withCode(@NonNull CodeableConcept code) {
     ...
     */
    public Measure_Group_Stratifier_ComponentBuilder.Impl withDescription(
