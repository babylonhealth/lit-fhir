...
public interface BiologicallyDerivedProduct_ManipulationBuilder {
  ...
  public class Impl implements BiologicallyDerivedProduct_ManipulationBuilder {
     ...
     */
    public BiologicallyDerivedProduct_ManipulationBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /**
     * @param time Field is a 'choice' field. Type should be one of FHIRDateTime, Period. To pass
     *     the value in, wrap with one of the BiologicallyDerivedProduct_ManipulationBuilder.time
     *     static methods
     */
