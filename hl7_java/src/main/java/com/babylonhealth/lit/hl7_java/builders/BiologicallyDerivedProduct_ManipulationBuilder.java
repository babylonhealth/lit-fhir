...
public class BiologicallyDerivedProduct_ManipulationBuilder {
   ...
   */
  public BiologicallyDerivedProduct_ManipulationBuilder withId(@NonNull String id) {
   ...
   */
  public BiologicallyDerivedProduct_ManipulationBuilder withExtension(
  ...
  /** @param description */
  public BiologicallyDerivedProduct_ManipulationBuilder withDescription(
   ...
   */
  public BiologicallyDerivedProduct_ManipulationBuilder withModifierExtension(
