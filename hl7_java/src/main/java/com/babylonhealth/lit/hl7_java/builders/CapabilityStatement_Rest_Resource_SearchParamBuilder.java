...
public class CapabilityStatement_Rest_Resource_SearchParamBuilder {
   ...
   * @param _type
   */
  public CapabilityStatement_Rest_Resource_SearchParamBuilder(
      String name, SEARCH_PARAM_TYPE _type) {
    this.name = name;
    this._type = _type;
  }
   ...
   */
  public CapabilityStatement_Rest_Resource_SearchParamBuilder withId(@NonNull String id) {
   ...
   */
  public CapabilityStatement_Rest_Resource_SearchParamBuilder withExtension(
  ...
  /** @param definition */
  public CapabilityStatement_Rest_Resource_SearchParamBuilder withDefinition(
      @NonNull String definition) {
    this.definition = Optional.of(definition);
    return this;
  }
  /** @param documentation */
  public CapabilityStatement_Rest_Resource_SearchParamBuilder withDocumentation(
   ...
   */
  public CapabilityStatement_Rest_Resource_SearchParamBuilder withModifierExtension(
