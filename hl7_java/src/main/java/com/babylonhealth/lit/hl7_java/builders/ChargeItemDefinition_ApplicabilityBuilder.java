...
public interface ChargeItemDefinition_ApplicabilityBuilder {
  ...
  public class Impl implements ChargeItemDefinition_ApplicabilityBuilder {
     ...
     */
    public ChargeItemDefinition_ApplicabilityBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public ChargeItemDefinition_ApplicabilityBuilder.Impl withLanguage(@NonNull String language) {
     ...
     */
    public ChargeItemDefinition_ApplicabilityBuilder.Impl withDescription(
