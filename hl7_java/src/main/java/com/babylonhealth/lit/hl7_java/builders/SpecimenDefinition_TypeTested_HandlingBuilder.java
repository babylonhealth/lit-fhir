...
public class SpecimenDefinition_TypeTested_HandlingBuilder {
  ...
  public SpecimenDefinition_TypeTested_HandlingBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public SpecimenDefinition_TypeTested_HandlingBuilder withId(@NonNull String id) {
   ...
   */
  public SpecimenDefinition_TypeTested_HandlingBuilder withExtension(
  ...
  /** @param maxDuration */
  public SpecimenDefinition_TypeTested_HandlingBuilder withMaxDuration(
      @NonNull Duration maxDuration) {
    this.maxDuration = Optional.of(maxDuration);
    return this;
  }
  /** @param instruction */
  public SpecimenDefinition_TypeTested_HandlingBuilder withInstruction(
      @NonNull String instruction) {
    this.instruction = Optional.of(instruction);
    return this;
  }
  /** @param temperatureRange */
  public SpecimenDefinition_TypeTested_HandlingBuilder withTemperatureRange(
   ...
   */
  public SpecimenDefinition_TypeTested_HandlingBuilder withModifierExtension(
  ...
  public SpecimenDefinition_TypeTested_HandlingBuilder withTemperatureQualifier(
