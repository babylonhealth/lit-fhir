...
public class EvidenceBuilder {
   ...
   */
  public EvidenceBuilder(PUBLICATION_STATUS status, Reference exposureBackground) {
    this.status = status;
   ...
   */
  public EvidenceBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /**
   * @param url - An absolute URI that is used to identify this evidence when it is referenced in a
   ...
   *     different servers.
   */
  public EvidenceBuilder withUrl(@NonNull String url) {
   ...
   *     to the resource.
   */
  public EvidenceBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public EvidenceBuilder withText(@NonNull Narrative text) {
   ...
   */
  public EvidenceBuilder withName(@NonNull String name) {
   ...
   */
  public EvidenceBuilder withDate(@NonNull FHIRDateTime date) {
    this.date = Optional.of(date);
    return this;
  }
  /** @param note - A human-readable string to clarify or explain concepts about the resource. */
  public EvidenceBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - A human-readable string to clarify or explain concepts about the resource. */
  public EvidenceBuilder withNote(@NonNull Collection<Annotation> note) {
    this.note = Collections.unmodifiableCollection(note);
    return this;
  }
  /** @param title - A short, descriptive, user-friendly title for the evidence. */
  public EvidenceBuilder withTitle(@NonNull String title) {
    this.title = Optional.of(title);
    return this;
  }
  /**
   * @param topic - Descriptive topics related to the content of the Evidence. Topics provide a
   *     high-level categorization grouping types of Evidences that can be useful for filtering and
   *     searching.
   */
  public EvidenceBuilder withTopic(@NonNull CodeableConcept... topic) {
   ...
   *     searching.
   */
  public EvidenceBuilder withTopic(@NonNull Collection<CodeableConcept> topic) {
   ...
   */
  public EvidenceBuilder withAuthor(@NonNull ContactDetail... author) {
   ...
   *     maintenance of the content.
   */
  public EvidenceBuilder withAuthor(@NonNull Collection<ContactDetail> author) {
   ...
   *     the content.
   */
  public EvidenceBuilder withEditor(@NonNull ContactDetail... editor) {
   ...
   *     the content.
   */
  public EvidenceBuilder withEditor(@NonNull Collection<ContactDetail> editor) {
   ...
   */
  public EvidenceBuilder withVersion(@NonNull String version) {
   ...
   *     publisher.
   */
  public EvidenceBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public EvidenceBuilder withContact(@NonNull Collection<ContactDetail> contact) {
   ...
   *     research.
   */
  public EvidenceBuilder withOutcome(@NonNull Reference... outcome) {
   ...
   *     research.
   */
  public EvidenceBuilder withOutcome(@NonNull Collection<Reference> outcome) {
    this.outcome = Collections.unmodifiableCollection(outcome);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public EvidenceBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public EvidenceBuilder withSubtitle(@NonNull String subtitle) {
   ...
   *     of the content.
   */
  public EvidenceBuilder withReviewer(@NonNull ContactDetail... reviewer) {
   ...
   *     of the content.
   */
  public EvidenceBuilder withReviewer(@NonNull Collection<ContactDetail> reviewer) {
   ...
   */
  public EvidenceBuilder withEndorser(@NonNull ContactDetail... endorser) {
   ...
   *     content for use in some setting.
   */
  public EvidenceBuilder withEndorser(@NonNull Collection<ContactDetail> endorser) {
   ...
   */
  public EvidenceBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public EvidenceBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public EvidenceBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public EvidenceBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param publisher - The name of the organization or individual that published the evidence. */
  public EvidenceBuilder withPublisher(@NonNull String publisher) {
   ...
   *     evidence.
   */
  public EvidenceBuilder withCopyright(@NonNull String copyright) {
   ...
   *     instance.
   */
  public EvidenceBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     instance.
   */
  public EvidenceBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public EvidenceBuilder withShortTitle(@NonNull String shortTitle) {
   ...
   */
  public EvidenceBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate evidence instances.
   */
  public EvidenceBuilder withUseContext(@NonNull Collection<UsageContext> useContext) {
   ...
   *     perspective.
   */
  public EvidenceBuilder withDescription(@NonNull String description) {
   ...
   *     used.
   */
  public EvidenceBuilder withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
   ...
   *     used.
   */
  public EvidenceBuilder withJurisdiction(@NonNull Collection<CodeableConcept> jurisdiction) {
   ...
   */
  public EvidenceBuilder withApprovalDate(@NonNull FHIRDate approvalDate) {
   ...
   *     profiles etc.
   */
  public EvidenceBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public EvidenceBuilder withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
   ...
   *     in active use.
   */
  public EvidenceBuilder withEffectivePeriod(@NonNull Period effectivePeriod) {
   ...
   */
  public EvidenceBuilder withRelatedArtifact(@NonNull RelatedArtifact... relatedArtifact) {
   ...
   *     bibliographic references.
   */
  public EvidenceBuilder withRelatedArtifact(@NonNull Collection<RelatedArtifact> relatedArtifact) {
   ...
   *     for the research.
   */
  public EvidenceBuilder withExposureVariant(@NonNull Reference... exposureVariant) {
   ...
   *     for the research.
   */
  public EvidenceBuilder withExposureVariant(@NonNull Collection<Reference> exposureVariant) {
   ...
   */
  public EvidenceBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public EvidenceBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
