...
public class Contract_SignerBuilder {
   ...
   * @param signature
   */
  public Contract_SignerBuilder(Coding _type, Reference party, Collection<Signature> signature) {
    this._type = _type;
    this.party = party;
   ...
   */
  public Contract_SignerBuilder withId(@NonNull String id) {
   ...
   */
  public Contract_SignerBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Contract_SignerBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public Contract_SignerBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public Contract_SignerBuilder withModifierExtension(
