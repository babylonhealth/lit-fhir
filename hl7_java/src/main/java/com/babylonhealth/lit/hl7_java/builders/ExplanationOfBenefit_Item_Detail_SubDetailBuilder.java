...
public class ExplanationOfBenefit_Item_Detail_SubDetailBuilder {
   ...
   */
  public ExplanationOfBenefit_Item_Detail_SubDetailBuilder(
   ...
   */
  public ExplanationOfBenefit_Item_Detail_SubDetailBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param net */
  public ExplanationOfBenefit_Item_Detail_SubDetailBuilder withNet(@NonNull Money net) {
    this.net = Optional.of(net);
    return this;
  }
  /** @param udi */
  public ExplanationOfBenefit_Item_Detail_SubDetailBuilder withUdi(@NonNull Reference... udi) {
    this.udi = Arrays.asList(udi);
    return this;
  }
  /** @param udi */
  public ExplanationOfBenefit_Item_Detail_SubDetailBuilder withUdi(
      @NonNull Collection<Reference> udi) {
    this.udi = Collections.unmodifiableCollection(udi);
    return this;
  }
  /** @param factor */
  public ExplanationOfBenefit_Item_Detail_SubDetailBuilder withFactor(@NonNull BigDecimal factor) {
    this.factor = Optional.of(factor);
    return this;
  }
  /** @param revenue */
  public ExplanationOfBenefit_Item_Detail_SubDetailBuilder withRevenue(
      @NonNull CodeableConcept revenue) {
    this.revenue = Optional.of(revenue);
    return this;
  }
  /** @param category */
  public ExplanationOfBenefit_Item_Detail_SubDetailBuilder withCategory(
      @NonNull CodeableConcept category) {
    this.category = Optional.of(category);
    return this;
  }
  /** @param modifier */
  public ExplanationOfBenefit_Item_Detail_SubDetailBuilder withModifier(
  ...
  /** @param quantity */
  public ExplanationOfBenefit_Item_Detail_SubDetailBuilder withQuantity(
   ...
   */
  public ExplanationOfBenefit_Item_Detail_SubDetailBuilder withExtension(
  ...
  /** @param unitPrice */
  public ExplanationOfBenefit_Item_Detail_SubDetailBuilder withUnitPrice(@NonNull Money unitPrice) {
    this.unitPrice = Optional.of(unitPrice);
    return this;
  }
  /** @param noteNumber */
  public ExplanationOfBenefit_Item_Detail_SubDetailBuilder withNoteNumber(
  ...
  /** @param programCode */
  public ExplanationOfBenefit_Item_Detail_SubDetailBuilder withProgramCode(
   ...
   */
  public ExplanationOfBenefit_Item_Detail_SubDetailBuilder withAdjudication(
   ...
   */
  public ExplanationOfBenefit_Item_Detail_SubDetailBuilder withModifierExtension(
