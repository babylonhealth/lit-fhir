...
public class ShareablevaluesetBuilder {
   ...
   *     usage.
   */
  public ShareablevaluesetBuilder(
      String url,
      String name,
   ...
   */
  public ShareablevaluesetBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public ShareablevaluesetBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public ShareablevaluesetBuilder withText(@NonNull Narrative text) {
   ...
   */
  public ShareablevaluesetBuilder withDate(@NonNull FHIRDateTime date) {
    this.date = Optional.of(date);
    return this;
  }
  /** @param title - A short, descriptive, user-friendly title for the value set. */
  public ShareablevaluesetBuilder withTitle(@NonNull String title) {
   ...
   *     publisher.
   */
  public ShareablevaluesetBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public ShareablevaluesetBuilder withContact(@NonNull Collection<ContactDetail> contact) {
   ...
   *     has.
   */
  public ShareablevaluesetBuilder withPurpose(@NonNull String purpose) {
    this.purpose = Optional.of(purpose);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public ShareablevaluesetBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public ShareablevaluesetBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public ShareablevaluesetBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public ShareablevaluesetBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ShareablevaluesetBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public ShareablevaluesetBuilder withImmutable(@NonNull Boolean immutable) {
   ...
   *     value set.
   */
  public ShareablevaluesetBuilder withCopyright(@NonNull String copyright) {
   ...
   *     instance.
   */
  public ShareablevaluesetBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     instance.
   */
  public ShareablevaluesetBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public ShareablevaluesetBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate value set instances.
   */
  public ShareablevaluesetBuilder withUseContext(@NonNull Collection<UsageContext> useContext) {
   ...
   *     used.
   */
  public ShareablevaluesetBuilder withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
   ...
   *     used.
   */
  public ShareablevaluesetBuilder withJurisdiction(
   ...
   *     profiles etc.
   */
  public ShareablevaluesetBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public ShareablevaluesetBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public ShareablevaluesetBuilder withModifierExtension(
   ...
   *     performed.
   */
  public ShareablevaluesetBuilder withExpansion(@NonNull ValueSet.Expansion expansion) {
   ...
   */
  public ShareablevaluesetBuilder withCompose(@NonNull ValueSet.Compose compose) {
  ...
  public Shareablevalueset build() {
    return new Shareablevalueset(
        ...
        publisher,
        (Option) OptionConverters.toScala(immutable.map(x -> (Object) x)),
        ...
        (Option) OptionConverters.toScala(compose),
