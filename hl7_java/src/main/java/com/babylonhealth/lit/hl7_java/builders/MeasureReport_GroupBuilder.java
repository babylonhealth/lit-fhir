...
public class MeasureReport_GroupBuilder {
  ...
  public MeasureReport_GroupBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public MeasureReport_GroupBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param code */
  public MeasureReport_GroupBuilder withCode(@NonNull CodeableConcept code) {
   ...
   */
  public MeasureReport_GroupBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public MeasureReport_GroupBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param measureScore */
  public MeasureReport_GroupBuilder withMeasureScore(@NonNull Quantity measureScore) {
   ...
   */
  public MeasureReport_GroupBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public MeasureReport_GroupBuilder withModifierExtension(
      @NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param population */
  public MeasureReport_GroupBuilder withPopulation(
  ...
  /** @param stratifier */
  public MeasureReport_GroupBuilder withStratifier(
