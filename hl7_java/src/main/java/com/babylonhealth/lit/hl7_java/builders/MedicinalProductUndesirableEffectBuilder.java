...
public class MedicinalProductUndesirableEffectBuilder {
  ...
  public MedicinalProductUndesirableEffectBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public MedicinalProductUndesirableEffectBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public MedicinalProductUndesirableEffectBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public MedicinalProductUndesirableEffectBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param subject - The medication for which this is an indication. */
  public MedicinalProductUndesirableEffectBuilder withSubject(@NonNull Reference... subject) {
    this.subject = Arrays.asList(subject);
    return this;
  }
  /** @param subject - The medication for which this is an indication. */
  public MedicinalProductUndesirableEffectBuilder withSubject(
      @NonNull Collection<Reference> subject) {
    this.subject = Collections.unmodifiableCollection(subject);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public MedicinalProductUndesirableEffectBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public MedicinalProductUndesirableEffectBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public MedicinalProductUndesirableEffectBuilder withContained(
   ...
   */
  public MedicinalProductUndesirableEffectBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public MedicinalProductUndesirableEffectBuilder withExtension(
      @NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param population - The population group to which this applies. */
  public MedicinalProductUndesirableEffectBuilder withPopulation(@NonNull Choice... population) {
    this.population = Arrays.asList(population);
    return this;
  }
  /** @param population - The population group to which this applies. */
  public MedicinalProductUndesirableEffectBuilder withPopulation(
   ...
   *     profiles etc.
   */
  public MedicinalProductUndesirableEffectBuilder withImplicitRules(@NonNull String implicitRules) {
    this.implicitRules = Optional.of(implicitRules);
    return this;
  }
  /** @param classification - Classification of the effect. */
  public MedicinalProductUndesirableEffectBuilder withClassification(
   ...
   */
  public MedicinalProductUndesirableEffectBuilder withModifierExtension(
  ...
  public MedicinalProductUndesirableEffectBuilder withFrequencyOfOccurrence(
  ...
  public MedicinalProductUndesirableEffectBuilder withSymptomConditionEffect(
