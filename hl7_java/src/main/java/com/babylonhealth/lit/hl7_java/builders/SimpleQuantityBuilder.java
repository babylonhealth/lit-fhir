...
public class SimpleQuantityBuilder {
   ...
   */
  public SimpleQuantityBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param unit - A human-readable form of the unit. */
  public SimpleQuantityBuilder withUnit(@NonNull String unit) {
    this.unit = Optional.of(unit);
    return this;
  }
  /** @param code - A computer processable form of the unit in some unit representation system. */
  public SimpleQuantityBuilder withCode(@NonNull String code) {
   ...
   */
  public SimpleQuantityBuilder withValue(@NonNull BigDecimal value) {
    this.value = Optional.of(value);
    return this;
  }
  /** @param system - The identification of the system that provides the coded form of the unit. */
  public SimpleQuantityBuilder withSystem(@NonNull String system) {
   ...
   */
  public SimpleQuantityBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public SimpleQuantityBuilder withExtension(@NonNull Collection<Extension> extension) {
