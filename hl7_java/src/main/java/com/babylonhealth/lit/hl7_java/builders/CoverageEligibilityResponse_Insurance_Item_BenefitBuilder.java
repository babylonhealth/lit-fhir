...
public class CoverageEligibilityResponse_Insurance_Item_BenefitBuilder {
   ...
   * @param _type
   */
  public CoverageEligibilityResponse_Insurance_Item_BenefitBuilder(CodeableConcept _type) {
    this._type = _type;
  }
   ...
   */
  public CoverageEligibilityResponse_Insurance_Item_BenefitBuilder withId(@NonNull String id) {
   ...
   */
  public CoverageEligibilityResponse_Insurance_Item_BenefitBuilder withExtension(
   ...
   */
  public CoverageEligibilityResponse_Insurance_Item_BenefitBuilder withModifierExtension(
