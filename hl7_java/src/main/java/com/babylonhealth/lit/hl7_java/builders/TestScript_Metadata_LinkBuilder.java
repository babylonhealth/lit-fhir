...
public class TestScript_Metadata_LinkBuilder {
   ...
   *     different servers.
   */
  public TestScript_Metadata_LinkBuilder(String url) {
    this.url = url;
  }
   ...
   */
  public TestScript_Metadata_LinkBuilder withId(@NonNull String id) {
   ...
   */
  public TestScript_Metadata_LinkBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public TestScript_Metadata_LinkBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public TestScript_Metadata_LinkBuilder withDescription(@NonNull String description) {
   ...
   */
  public TestScript_Metadata_LinkBuilder withModifierExtension(
