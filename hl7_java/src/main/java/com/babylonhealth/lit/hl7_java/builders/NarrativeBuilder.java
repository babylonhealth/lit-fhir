...
public interface NarrativeBuilder extends ElementBuilder {
  public Narrative build();

  public static Impl init(String div, NARRATIVE_STATUS status) {
  ...
  public class Impl implements NarrativeBuilder {
     ...
     *     additional data.
     */
    public Impl(String div, NARRATIVE_STATUS status) {
      this.div = div;
      this.status = status;
    }
     ...
     */
    public NarrativeBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public NarrativeBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     part of the definition of the extension.
     */
    public NarrativeBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
