...
public class MedicinalProduct_NameBuilder {
   ...
   * @param productName
   */
  public MedicinalProduct_NameBuilder(String productName) {
   ...
   */
  public MedicinalProduct_NameBuilder withId(@NonNull String id) {
   ...
   */
  public MedicinalProduct_NameBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public MedicinalProduct_NameBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public MedicinalProduct_NameBuilder withModifierExtension(
  ...
  /** @param namePart */
  public MedicinalProduct_NameBuilder withNamePart(
  ...
  public MedicinalProduct_NameBuilder withCountryLanguage(
