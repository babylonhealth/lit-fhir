...
public class CapabilityStatement_ImplementationBuilder {
   ...
   *     as part of an RFP.
   */
  public CapabilityStatement_ImplementationBuilder(String description) {
   ...
   */
  public CapabilityStatement_ImplementationBuilder withId(@NonNull String id) {
   ...
   */
  public CapabilityStatement_ImplementationBuilder withUrl(@NonNull String url) {
   ...
   */
  public CapabilityStatement_ImplementationBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public CapabilityStatement_ImplementationBuilder withExtension(
      @NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param custodian */
  public CapabilityStatement_ImplementationBuilder withCustodian(@NonNull Reference custodian) {
   ...
   */
  public CapabilityStatement_ImplementationBuilder withModifierExtension(
