...
public class StructureDefinition_ContextBuilder {
   ...
   * @param expression
   */
  public StructureDefinition_ContextBuilder(EXTENSION_CONTEXT_TYPE _type, String expression) {
    this._type = _type;
   ...
   */
  public StructureDefinition_ContextBuilder withId(@NonNull String id) {
   ...
   */
  public StructureDefinition_ContextBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public StructureDefinition_ContextBuilder withExtension(
   ...
   */
  public StructureDefinition_ContextBuilder withModifierExtension(
