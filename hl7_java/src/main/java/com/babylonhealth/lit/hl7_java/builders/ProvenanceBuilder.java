...
public interface ProvenanceBuilder extends DomainResourceBuilder {
  ...
  public class Impl implements ProvenanceBuilder {
     ...
     */
    public ProvenanceBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public ProvenanceBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     *     etc.
     */
    public ProvenanceBuilder.Impl withPolicy(@NonNull String... policy) {
     ...
     *     etc.
     */
    public ProvenanceBuilder.Impl withPolicy(@NonNull Collection<String> policy) {
      this.policy = Collections.unmodifiableCollection(policy);
      return this;
    }
    /** @param reason - The reason that the activity was taking place. */
    public ProvenanceBuilder.Impl withReason(@NonNull CodeableConcept... reason) {
      this.reason = Arrays.asList(reason);
      return this;
    }
    /** @param reason - The reason that the activity was taking place. */
    public ProvenanceBuilder.Impl withReason(@NonNull Collection<CodeableConcept> reason) {
    ...
    public ProvenanceBuilder.Impl withLocation(@NonNull Reference location) {
     ...
     */
    public ProvenanceBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public ProvenanceBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
     ...
     */
    public ProvenanceBuilder.Impl withSignature(@NonNull Signature... signature) {
     ...
     */
    public ProvenanceBuilder.Impl withOccurred(@NonNull Choice_0934386166 occurred) {
     ...
     *     profiles etc.
     */
    public ProvenanceBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public ProvenanceBuilder.Impl withModifierExtension(@NonNull Extension... modifierExtension) {
