...
public class ProvenanceBuilder {
  ...
  /**
   * Required fields for {@link Provenance}
   *
   ...
   */
  public ProvenanceBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public ProvenanceBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public ProvenanceBuilder withText(@NonNull Narrative text) {
   ...
   */
  public ProvenanceBuilder withPolicy(@NonNull String... policy) {
   ...
   *     have multiple applicable policy documents, such as patient consent, guarantor funding, etc.
   */
  public ProvenanceBuilder withPolicy(@NonNull Collection<String> policy) {
    this.policy = Collections.unmodifiableCollection(policy);
    return this;
  }
  /** @param reason - The reason that the activity was taking place. */
  public ProvenanceBuilder withReason(@NonNull CodeableConcept... reason) {
    this.reason = Arrays.asList(reason);
    return this;
  }
  /** @param reason - The reason that the activity was taking place. */
  public ProvenanceBuilder withReason(@NonNull Collection<CodeableConcept> reason) {
    this.reason = Collections.unmodifiableCollection(reason);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public ProvenanceBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param location - Where the activity occurred, if relevant. */
  public ProvenanceBuilder withLocation(@NonNull Reference location) {
   ...
   */
  public ProvenanceBuilder withActivity(@NonNull CodeableConcept activity) {
   ...
   */
  public ProvenanceBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public ProvenanceBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public ProvenanceBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ProvenanceBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public ProvenanceBuilder withSignature(@NonNull Signature... signature) {
   ...
   *     Provenance.agent. The purpose of the signature is indicated.
   */
  public ProvenanceBuilder withSignature(@NonNull Collection<Signature> signature) {
   ...
   */
  public <T> ProvenanceBuilder withOccurred(@NonNull T occurred) {
    var guessedSuffix =
        autoSuffix(occurred.getClass().getSimpleName(), Provenance$.MODULE$.occurred());
   ...
   */
  public <T> ProvenanceBuilder withOccurred(String suffix, @NonNull T occurred) {
    guard(occurred.getClass().getSimpleName(), suffix, Provenance$.MODULE$.occurred());
    this.occurred =
        Optional.of(
            (Choice) Choice$.MODULE$.fromSuffix(suffix, occurred, Provenance$.MODULE$.occurred()));
    return this;
  }
  /**
   ...
   *     profiles etc.
   */
  public ProvenanceBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public ProvenanceBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public ProvenanceBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param entity - An entity used in this activity. */
  public ProvenanceBuilder withEntity(@NonNull Provenance.Entity... entity) {
    this.entity = Arrays.asList(entity);
    return this;
  }
  /** @param entity - An entity used in this activity. */
  public ProvenanceBuilder withEntity(@NonNull Collection<Provenance.Entity> entity) {
