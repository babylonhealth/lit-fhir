...
public interface HealthcareService_AvailableTimeBuilder {
  ...
  public class Impl implements HealthcareService_AvailableTimeBuilder {
     ...
     */
    public HealthcareService_AvailableTimeBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param allDay */
    public HealthcareService_AvailableTimeBuilder.Impl withAllDay(@NonNull Boolean allDay) {
    ...
    public HealthcareService_AvailableTimeBuilder.Impl withAvailableEndTime(
    ...
    public HealthcareService_AvailableTimeBuilder.Impl withAvailableStartTime(
