...
public class HealthcareService_AvailableTimeBuilder {
  ...
  /** Required fields for {@link HealthcareService.AvailableTime} */
  public HealthcareService_AvailableTimeBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public HealthcareService_AvailableTimeBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param allDay */
  public HealthcareService_AvailableTimeBuilder withAllDay(@NonNull Boolean allDay) {
   ...
   */
  public HealthcareService_AvailableTimeBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public HealthcareService_AvailableTimeBuilder withExtension(
      @NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param daysOfWeek */
  public HealthcareService_AvailableTimeBuilder withDaysOfWeek(
  ...
  public HealthcareService_AvailableTimeBuilder withAvailableEndTime(
   ...
   */
  public HealthcareService_AvailableTimeBuilder withModifierExtension(
  ...
  public HealthcareService_AvailableTimeBuilder withAvailableStartTime(
