...
public class SubstancePolymer_Repeat_RepeatUnitBuilder {
  ...
  public SubstancePolymer_Repeat_RepeatUnitBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public SubstancePolymer_Repeat_RepeatUnitBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param amount */
  public SubstancePolymer_Repeat_RepeatUnitBuilder withAmount(@NonNull Choice amount) {
   ...
   */
  public SubstancePolymer_Repeat_RepeatUnitBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public SubstancePolymer_Repeat_RepeatUnitBuilder withExtension(
      @NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param repeatUnit */
  public SubstancePolymer_Repeat_RepeatUnitBuilder withRepeatUnit(@NonNull String repeatUnit) {
   ...
   */
  public SubstancePolymer_Repeat_RepeatUnitBuilder withModifierExtension(
  ...
  public SubstancePolymer_Repeat_RepeatUnitBuilder withOrientationOfPolymerisation(
  ...
  public SubstancePolymer_Repeat_RepeatUnitBuilder withDegreeOfPolymerisation(
      @NonNull
  ...
  public SubstancePolymer_Repeat_RepeatUnitBuilder withStructuralRepresentation(
      @NonNull
          SubstancePolymer$Repeat$RepeatUnit$StructuralRepresentation... structuralRepresentation) {
