...
public interface DocumentManifest_RelatedBuilder {
  ...
  public class Impl implements DocumentManifest_RelatedBuilder {
     ...
     */
    public DocumentManifest_RelatedBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param ref */
    public DocumentManifest_RelatedBuilder.Impl withRef(@NonNull Reference ref) {
     ...
     */
    public DocumentManifest_RelatedBuilder.Impl withExtension(@NonNull Extension... extension) {
