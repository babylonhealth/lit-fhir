...
public class CommunicationRequest_PayloadBuilder {
   ...
   *     To pass the value in, wrap with one of the CommunicationRequest_PayloadBuilder.content
   *     static methods
   */
   ...
   */
  public CommunicationRequest_PayloadBuilder withId(@NonNull String id) {
   ...
   */
  public CommunicationRequest_PayloadBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public CommunicationRequest_PayloadBuilder withExtension(
   ...
   */
  public CommunicationRequest_PayloadBuilder withModifierExtension(
