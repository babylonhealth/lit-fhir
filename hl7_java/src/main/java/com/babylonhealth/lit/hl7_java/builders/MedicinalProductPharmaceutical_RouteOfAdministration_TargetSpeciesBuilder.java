...
public class MedicinalProductPharmaceutical_RouteOfAdministration_TargetSpeciesBuilder {
  ...
  /**
   * Required fields for {@link MedicinalProductPharmaceutical$RouteOfAdministration$TargetSpecies}
   *
   * @param code
   */
  public MedicinalProductPharmaceutical_RouteOfAdministration_TargetSpeciesBuilder(
   ...
   */
  public MedicinalProductPharmaceutical_RouteOfAdministration_TargetSpeciesBuilder withId(
      @NonNull String id) {
   ...
   */
  public MedicinalProductPharmaceutical_RouteOfAdministration_TargetSpeciesBuilder withExtension(
