...
public class ExplanationOfBenefit_ProcedureBuilder {
   ...
   */
  public ExplanationOfBenefit_ProcedureBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param udi */
  public ExplanationOfBenefit_ProcedureBuilder withUdi(@NonNull Reference... udi) {
    this.udi = Arrays.asList(udi);
    return this;
  }
  /** @param udi */
  public ExplanationOfBenefit_ProcedureBuilder withUdi(@NonNull Collection<Reference> udi) {
   ...
   */
  public ExplanationOfBenefit_ProcedureBuilder withType(@NonNull CodeableConcept... _type) {
   ...
   * @param _type - The category of claim, e.g. oral, pharmacy, vision, institutional, professional.
   */
  public ExplanationOfBenefit_ProcedureBuilder withType(
      @NonNull Collection<CodeableConcept> _type) {
    this._type = Collections.unmodifiableCollection(_type);
    return this;
  }
  /** @param date */
  public ExplanationOfBenefit_ProcedureBuilder withDate(@NonNull FHIRDateTime date) {
   ...
   */
  public ExplanationOfBenefit_ProcedureBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ExplanationOfBenefit_ProcedureBuilder withExtension(
   ...
   */
  public ExplanationOfBenefit_ProcedureBuilder withModifierExtension(
