...
public class VerificationResult_ValidatorBuilder {
   ...
   * @param organization
   */
  public VerificationResult_ValidatorBuilder(Reference organization) {
   ...
   */
  public VerificationResult_ValidatorBuilder withId(@NonNull String id) {
   ...
   */
  public VerificationResult_ValidatorBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public VerificationResult_ValidatorBuilder withExtension(
   ...
   */
  public VerificationResult_ValidatorBuilder withModifierExtension(
  ...
  public VerificationResult_ValidatorBuilder withIdentityCertificate(
      @NonNull String identityCertificate) {
    this.identityCertificate = Optional.of(identityCertificate);
    return this;
  }
  /** @param attestationSignature */
  public VerificationResult_ValidatorBuilder withAttestationSignature(
