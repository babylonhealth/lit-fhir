...
public interface Claim_ItemBuilder {
  ...
  public class Impl implements Claim_ItemBuilder {
     ...
     */
    public Claim_ItemBuilder.Impl withServiced(@NonNull Choice_0503196159 serviced) {
     ...
     *     methods
     */
    public Claim_ItemBuilder.Impl withLocation(@NonNull Choice_0316522316 location) {
