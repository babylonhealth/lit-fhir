...
public interface DetectedIssue_EvidenceBuilder {
  ...
  public class Impl implements DetectedIssue_EvidenceBuilder {
     ...
     */
    public DetectedIssue_EvidenceBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param code - Identifies the general type of issue identified. */
    public DetectedIssue_EvidenceBuilder.Impl withCode(@NonNull CodeableConcept... code) {
      this.code = Arrays.asList(code);
      return this;
    }
    /** @param code - Identifies the general type of issue identified. */
    public DetectedIssue_EvidenceBuilder.Impl withCode(@NonNull Collection<CodeableConcept> code) {
     ...
     */
    public DetectedIssue_EvidenceBuilder.Impl withExtension(@NonNull Extension... extension) {
