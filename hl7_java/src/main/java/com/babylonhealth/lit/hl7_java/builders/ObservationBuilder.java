...
public interface ObservationBuilder extends DomainResourceBuilder {
  ...
  public class Impl implements ObservationBuilder {
    ...
    /**
     * Required fields for {@link Observation}
     *
     ...
     */
    public ObservationBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public ObservationBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public ObservationBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public ObservationBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public ObservationBuilder.Impl withText(@NonNull NarrativeBuilder text) {
      this.text = Optional.of(text.build());
      return this;
    }
    /** @param note - Comments about the observation or the results. */
    public ObservationBuilder.Impl withNote(@NonNull Annotation... note) {
      this.note = Arrays.asList(note);
      return this;
    }
    /** @param note - Comments about the observation or the results. */
    public ObservationBuilder.Impl withNote(@NonNull Collection<Annotation> note) {
      this.note = Collections.unmodifiableCollection(note);
      return this;
    }

    public ObservationBuilder.Impl withNote(@NonNull AnnotationBuilder... note) {
     ...
     */
    public ObservationBuilder.Impl withFocus(@NonNull Reference... focus) {
     ...
     *     is the patient of record and the mother is the focus.
     */
    public ObservationBuilder.Impl withFocus(@NonNull Collection<Reference> focus) {
      this.focus = Collections.unmodifiableCollection(focus);
      return this;
    }

    public ObservationBuilder.Impl withFocus(@NonNull ReferenceBuilder... focus) {
     ...
     */
    public ObservationBuilder.Impl withPartOf(@NonNull Reference... partOf) {
     ...
     *     For example, an observation as part of a procedure.
     */
    public ObservationBuilder.Impl withPartOf(@NonNull Collection<Reference> partOf) {
      this.partOf = Collections.unmodifiableCollection(partOf);
      return this;
    }

    public ObservationBuilder.Impl withPartOf(@NonNull ReferenceBuilder... partOf) {
     ...
     */
    public ObservationBuilder.Impl withIssued(@NonNull ZonedDateTime issued) {
      this.issued = Optional.of(issued);
      return this;
    }
    /** @param method - Indicates the mechanism used to perform the observation. */
    public ObservationBuilder.Impl withMethod(@NonNull CodeableConcept method) {
      this.method = Optional.of(method);
      return this;
    }

    public ObservationBuilder.Impl withMethod(@NonNull CodeableConceptBuilder method) {
      this.method = Optional.of(method.build());
      return this;
    }
    /** @param device - The device used to generate the observation data. */
    public ObservationBuilder.Impl withDevice(@NonNull Reference device) {
      this.device = Optional.of(device);
      return this;
    }

    public ObservationBuilder.Impl withDevice(@NonNull ReferenceBuilder device) {
     ...
     */
    public ObservationBuilder.Impl withBasedOn(@NonNull Reference... basedOn) {
     ...
     *     performed before it is dispensed.
     */
    public ObservationBuilder.Impl withBasedOn(@NonNull Collection<Reference> basedOn) {
      this.basedOn = Collections.unmodifiableCollection(basedOn);
      return this;
    }

    public ObservationBuilder.Impl withBasedOn(@NonNull ReferenceBuilder... basedOn) {
    ...
    public ObservationBuilder.Impl withSubject(@NonNull ReferenceBuilder subject) {
      this.subject = Optional.of(subject.build());
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public ObservationBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
      this.language = Optional.of(language);
      return this;
    }
    /** @param category - A code that classifies the general type of observation being made. */
    public ObservationBuilder.Impl withCategory(@NonNull CodeableConcept... category) {
      this.category = Arrays.asList(category);
      return this;
    }
    /** @param category - A code that classifies the general type of observation being made. */
    public ObservationBuilder.Impl withCategory(@NonNull Collection<CodeableConcept> category) {
      this.category = Collections.unmodifiableCollection(category);
      return this;
    }

    public ObservationBuilder.Impl withCategory(@NonNull CodeableConceptBuilder... category) {
     ...
     *     static methods
     */
    public ObservationBuilder.Impl withValue(@NonNull Choice01239641171 value) {
     ...
     *     (i.e. the target site).
     */
    public ObservationBuilder.Impl withBodySite(@NonNull CodeableConcept bodySite) {
      this.bodySite = Optional.of(bodySite);
      return this;
    }

    public ObservationBuilder.Impl withBodySite(@NonNull CodeableConceptBuilder bodySite) {
      this.bodySite = Optional.of(bodySite.build());
      return this;
    }
    /** @param specimen - The specimen that was used when this observation was made. */
    public ObservationBuilder.Impl withSpecimen(@NonNull Reference specimen) {
      this.specimen = Optional.of(specimen);
      return this;
    }

    public ObservationBuilder.Impl withSpecimen(@NonNull ReferenceBuilder specimen) {
    ...
    public ObservationBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public ObservationBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public ObservationBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public ObservationBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
     ...
     */
    public ObservationBuilder.Impl withEncounter(@NonNull Reference encounter) {
      this.encounter = Optional.of(encounter);
      return this;
    }

    public ObservationBuilder.Impl withEncounter(@NonNull ReferenceBuilder encounter) {
      this.encounter = Optional.of(encounter.build());
      return this;
    }
    /** @param performer - Who was responsible for asserting the observed value as "true". */
    public ObservationBuilder.Impl withPerformer(@NonNull Reference... performer) {
      this.performer = Arrays.asList(performer);
      return this;
    }
    /** @param performer - Who was responsible for asserting the observed value as "true". */
    public ObservationBuilder.Impl withPerformer(@NonNull Collection<Reference> performer) {
      this.performer = Collections.unmodifiableCollection(performer);
      return this;
    }

    public ObservationBuilder.Impl withPerformer(@NonNull ReferenceBuilder... performer) {
     ...
     */
    public ObservationBuilder.Impl withHasMember(@NonNull Reference... hasMember) {
     ...
     *     a set of vital sign measurements) that includes the target as a member of the group.
     */
    public ObservationBuilder.Impl withHasMember(@NonNull Collection<Reference> hasMember) {
      this.hasMember = Collections.unmodifiableCollection(hasMember);
      return this;
    }

    public ObservationBuilder.Impl withHasMember(@NonNull ReferenceBuilder... hasMember) {
    ...
    public ObservationBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
      this.identifier = Arrays.asList(identifier);
      return this;
    }
    /** @param identifier - A unique identifier assigned to this observation. */
    public ObservationBuilder.Impl withIdentifier(@NonNull Collection<Identifier> identifier) {
      this.identifier = Collections.unmodifiableCollection(identifier);
      return this;
    }

    public ObservationBuilder.Impl withIdentifier(@NonNull IdentifierBuilder... identifier) {
     ...
     */
    public ObservationBuilder.Impl withDerivedFrom(@NonNull Reference... derivedFrom) {
     ...
     *     based on an ultrasound image.
     */
    public ObservationBuilder.Impl withDerivedFrom(@NonNull Collection<Reference> derivedFrom) {
      this.derivedFrom = Collections.unmodifiableCollection(derivedFrom);
      return this;
    }

    public ObservationBuilder.Impl withDerivedFrom(@NonNull ReferenceBuilder... derivedFrom) {
     ...
     *     static methods
     */
    public ObservationBuilder.Impl withEffective(@NonNull Choice_1926447453 effective) {
     ...
     *     profiles etc.
     */
    public ObservationBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     *     low, normal.
     */
    public ObservationBuilder.Impl withInterpretation(@NonNull CodeableConcept... interpretation) {
     ...
     *     low, normal.
     */
    public ObservationBuilder.Impl withInterpretation(
     ...
     */
    public ObservationBuilder.Impl withDataAbsentReason(@NonNull CodeableConcept dataAbsentReason) {
      this.dataAbsentReason = Optional.of(dataAbsentReason);
      return this;
    }

    public ObservationBuilder.Impl withDataAbsentReason(
     ...
     */
    public ObservationBuilder.Impl withModifierExtension(@NonNull Extension... modifierExtension) {
     ...
     *     DomainResource (including cannot change the meaning of modifierExtension itself).
     */
    public ObservationBuilder.Impl withModifierExtension(
     ...
     */
    public ObservationBuilder.Impl withComponent(@NonNull Observation.Component... component) {
     ...
     *     measurement and multiple component observations for genetics observations.
     */
    public ObservationBuilder.Impl withComponent(
     ...
     *     used.
     */
    public ObservationBuilder.Impl withReferenceRange(
    ...
    public ObservationBuilder withoutMeta() {
