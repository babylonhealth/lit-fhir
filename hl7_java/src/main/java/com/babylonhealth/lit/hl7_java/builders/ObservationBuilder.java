...
public class ObservationBuilder {
   ...
   *     static methods
   */
  public ObservationBuilder withValue(@NonNull Choice_0802685816 value) {
   ...
   *     pass the value in, wrap with one of the ObservationBuilder.effective static methods
   */
  public ObservationBuilder withEffective(@NonNull Choice01473702374 effective) {
