...
public class ObservationBuilder {
   ...
   */
  public ObservationBuilder(CodeableConcept code, OBSERVATION_STATUS status) {
    this.code = code;
    this.status = status;
  }
   ...
   */
  public ObservationBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public ObservationBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public ObservationBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public ObservationBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public ObservationBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   */
  public ObservationBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     patient of record and the mother is the focus.
   */
  public ObservationBuilder withFocus(@NonNull Collection<Reference> focus) {
   ...
   */
  public ObservationBuilder withPartOf(@NonNull Reference... partOf) {
   ...
   *     example, an observation as part of a procedure.
   */
  public ObservationBuilder withPartOf(@NonNull Collection<Reference> partOf) {
   ...
   */
  public ObservationBuilder withIssued(@NonNull ZonedDateTime issued) {
    this.issued = Optional.of(issued);
    return this;
  }
  /** @param method - Indicates the mechanism used to perform the observation. */
  public ObservationBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param device - The device used to generate the observation data. */
  public ObservationBuilder withDevice(@NonNull Reference device) {
   ...
   */
  public ObservationBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     before it is dispensed.
   */
  public ObservationBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
   ...
   */
  public ObservationBuilder withSubject(@NonNull Reference subject) {
    this.subject = Optional.of(subject);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public ObservationBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param category - A code that classifies the general type of observation being made. */
  public ObservationBuilder withCategory(@NonNull CodeableConcept... category) {
    this.category = Arrays.asList(category);
    return this;
  }
  /** @param category - A code that classifies the general type of observation being made. */
  public ObservationBuilder withCategory(@NonNull Collection<CodeableConcept> category) {
   ...
   *     SampledData, String.
   */
  public <T> ObservationBuilder withValue(@NonNull T value) {
    var guessedSuffix = autoSuffix(value.getClass().getSimpleName(), Observation$.MODULE$.value());
   ...
   */
  public <T> ObservationBuilder withValue(String suffix, @NonNull T value) {
    guard(value.getClass().getSimpleName(), suffix, Observation$.MODULE$.value());
    this.value =
        Optional.of(
            (Choice) Choice$.MODULE$.fromSuffix(suffix, value, Observation$.MODULE$.value()));
    return this;
  }
  /**
   ...
   *     the target site).
   */
  public ObservationBuilder withBodySite(@NonNull CodeableConcept bodySite) {
    this.bodySite = Optional.of(bodySite);
    return this;
  }
  /** @param specimen - The specimen that was used when this observation was made. */
  public ObservationBuilder withSpecimen(@NonNull Reference specimen) {
   ...
   */
  public ObservationBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public ObservationBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public ObservationBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ObservationBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public ObservationBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public ObservationBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public ObservationBuilder withPerformer(@NonNull Collection<Reference> performer) {
   ...
   */
  public ObservationBuilder withHasMember(@NonNull Reference... hasMember) {
   ...
   *     set of vital sign measurements) that includes the target as a member of the group.
   */
  public ObservationBuilder withHasMember(@NonNull Collection<Reference> hasMember) {
  ...
  public ObservationBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public ObservationBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public ObservationBuilder withDerivedFrom(@NonNull Reference... derivedFrom) {
   ...
   *     based on an ultrasound image.
   */
  public ObservationBuilder withDerivedFrom(@NonNull Collection<Reference> derivedFrom) {
   ...
   */
  public <T> ObservationBuilder withEffective(@NonNull T effective) {
    var guessedSuffix =
        autoSuffix(effective.getClass().getSimpleName(), Observation$.MODULE$.effective());
   ...
   */
  public <T> ObservationBuilder withEffective(String suffix, @NonNull T effective) {
    guard(effective.getClass().getSimpleName(), suffix, Observation$.MODULE$.effective());
    this.effective =
        Optional.of(
            (Choice)
                Choice$.MODULE$.fromSuffix(suffix, effective, Observation$.MODULE$.effective()));
    return this;
  }
  /**
   ...
   *     profiles etc.
   */
  public ObservationBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     low, normal.
   */
  public ObservationBuilder withInterpretation(@NonNull CodeableConcept... interpretation) {
   ...
   *     low, normal.
   */
  public ObservationBuilder withInterpretation(
   ...
   */
  public ObservationBuilder withDataAbsentReason(@NonNull CodeableConcept dataAbsentReason) {
   ...
   */
  public ObservationBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public ObservationBuilder withModifierExtension(
   ...
   */
  public ObservationBuilder withComponent(@NonNull Observation.Component... component) {
   ...
   *     measurement and multiple component observations for genetics observations.
   */
  public ObservationBuilder withComponent(@NonNull Collection<Observation.Component> component) {
   ...
   */
  public ObservationBuilder withReferenceRange(
