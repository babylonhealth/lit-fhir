...
public class MeasureReportBuilder {
   ...
   *
   * @param _type - The type of measure report. This may be an individual report, which provides the
   *     score for the measure for an individual member of the population; a subject-listing, which
   ...
   */
  public MeasureReportBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public MeasureReportBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public MeasureReportBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param date - The date this measure report was generated. */
  public MeasureReportBuilder withDate(@NonNull FHIRDateTime date) {
   ...
   */
  public MeasureReportBuilder withSubject(@NonNull Reference subject) {
    this.subject = Optional.of(subject);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public MeasureReportBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param reporter - The individual, location, or organization that is reporting the data. */
  public MeasureReportBuilder withReporter(@NonNull Reference reporter) {
   ...
   */
  public MeasureReportBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public MeasureReportBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public MeasureReportBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public MeasureReportBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     instance.
   */
  public MeasureReportBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     instance.
   */
  public MeasureReportBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   *     profiles etc.
   */
  public MeasureReportBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public MeasureReportBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public MeasureReportBuilder withModifierExtension(
   ...
   */
  public MeasureReportBuilder withEvaluatedResource(@NonNull Reference... evaluatedResource) {
   ...
   *     the calculation of this measure.
   */
  public MeasureReportBuilder withEvaluatedResource(
   ...
   */
  public MeasureReportBuilder withImprovementNotation(
   ...
   */
  public MeasureReportBuilder withGroup(@NonNull MeasureReport.Group... group) {
   ...
   * @param group - The results of the calculation, one for each population group in the measure.
   */
  public MeasureReportBuilder withGroup(@NonNull Collection<MeasureReport.Group> group) {
