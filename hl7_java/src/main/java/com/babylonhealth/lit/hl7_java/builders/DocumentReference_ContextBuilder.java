...
public interface DocumentReference_ContextBuilder {
  ...
  public class Impl implements DocumentReference_ContextBuilder {
     ...
     */
    public DocumentReference_ContextBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param event */
    public DocumentReference_ContextBuilder.Impl withEvent(@NonNull CodeableConcept... event) {
    ...
    /** @param related */
    public DocumentReference_ContextBuilder.Impl withRelated(@NonNull Reference... related) {
     ...
     */
    public DocumentReference_ContextBuilder.Impl withExtension(@NonNull Extension... extension) {
