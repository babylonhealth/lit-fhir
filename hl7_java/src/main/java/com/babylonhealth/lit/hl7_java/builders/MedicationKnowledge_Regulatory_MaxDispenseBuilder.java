...
public interface MedicationKnowledge_Regulatory_MaxDispenseBuilder {
  public MedicationKnowledge$Regulatory$MaxDispense build();

  public static Impl init(Quantity quantity) {
  ...
  public class Impl implements MedicationKnowledge_Regulatory_MaxDispenseBuilder {
     ...
     */
    public MedicationKnowledge_Regulatory_MaxDispenseBuilder.Impl withId(@NonNull String id) {
