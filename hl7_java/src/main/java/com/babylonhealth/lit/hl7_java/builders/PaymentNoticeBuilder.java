...
public class PaymentNoticeBuilder {
   ...
   */
  public PaymentNoticeBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public PaymentNoticeBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public PaymentNoticeBuilder withText(@NonNull Narrative text) {
   ...
   *     notification.
   */
  public PaymentNoticeBuilder withPayee(@NonNull Reference payee) {
    this.payee = Optional.of(payee);
    return this;
  }
  /** @param request - Reference of resource for which payment is being made. */
  public PaymentNoticeBuilder withRequest(@NonNull Reference request) {
    this.request = Optional.of(request);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public PaymentNoticeBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param response - Reference of response to resource for which payment is being made. */
  public PaymentNoticeBuilder withResponse(@NonNull Reference response) {
   ...
   */
  public PaymentNoticeBuilder withProvider(@NonNull Reference provider) {
   ...
   */
  public PaymentNoticeBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public PaymentNoticeBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public PaymentNoticeBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public PaymentNoticeBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this payment notice. */
  public PaymentNoticeBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this payment notice. */
  public PaymentNoticeBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
    this.identifier = Collections.unmodifiableCollection(identifier);
    return this;
  }
  /** @param paymentDate - The date when the above payment action occurred. */
  public PaymentNoticeBuilder withPaymentDate(@NonNull FHIRDate paymentDate) {
   ...
   *     profiles etc.
   */
  public PaymentNoticeBuilder withImplicitRules(@NonNull String implicitRules) {
    this.implicitRules = Optional.of(implicitRules);
    return this;
  }
  /** @param paymentStatus - A code indicating whether payment has been sent or cleared. */
  public PaymentNoticeBuilder withPaymentStatus(@NonNull CodeableConcept paymentStatus) {
   ...
   */
  public PaymentNoticeBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public PaymentNoticeBuilder withModifierExtension(
  ...
  public PaymentNotice build() {
    return new PaymentNotice(
        ...
        (Option) OptionConverters.toScala(paymentStatus),
