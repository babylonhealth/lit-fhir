...
public class ClaimResponse_AddItem_DetailBuilder {
   ...
   */
  public ClaimResponse_AddItem_DetailBuilder(
   ...
   */
  public ClaimResponse_AddItem_DetailBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param net */
  public ClaimResponse_AddItem_DetailBuilder withNet(@NonNull Money net) {
    this.net = Optional.of(net);
    return this;
  }
  /** @param factor */
  public ClaimResponse_AddItem_DetailBuilder withFactor(@NonNull BigDecimal factor) {
    this.factor = Optional.of(factor);
    return this;
  }
  /** @param modifier */
  public ClaimResponse_AddItem_DetailBuilder withModifier(@NonNull CodeableConcept... modifier) {
    this.modifier = Arrays.asList(modifier);
    return this;
  }
  /** @param modifier */
  public ClaimResponse_AddItem_DetailBuilder withModifier(
      @NonNull Collection<CodeableConcept> modifier) {
    this.modifier = Collections.unmodifiableCollection(modifier);
    return this;
  }
  /** @param quantity */
  public ClaimResponse_AddItem_DetailBuilder withQuantity(@NonNull Quantity quantity) {
   ...
   */
  public ClaimResponse_AddItem_DetailBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ClaimResponse_AddItem_DetailBuilder withExtension(
      @NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param unitPrice */
  public ClaimResponse_AddItem_DetailBuilder withUnitPrice(@NonNull Money unitPrice) {
    this.unitPrice = Optional.of(unitPrice);
    return this;
  }
  /** @param noteNumber */
  public ClaimResponse_AddItem_DetailBuilder withNoteNumber(@NonNull Integer... noteNumber) {
    this.noteNumber = Arrays.asList(noteNumber);
    return this;
  }
  /** @param noteNumber */
  public ClaimResponse_AddItem_DetailBuilder withNoteNumber(
   ...
   */
  public ClaimResponse_AddItem_DetailBuilder withModifierExtension(
  ...
  /** @param subDetail */
  public ClaimResponse_AddItem_DetailBuilder withSubDetail(
