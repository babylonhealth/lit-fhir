...
public class TerminologyCapabilitiesBuilder {
   ...
   *     code changes. In addition, it should change when the substantive content of the terminology
   ...
   * @param status - The status of this terminology capabilities. Enables tracking the life-cycle of
   *     the content.
   */
  public TerminologyCapabilitiesBuilder(
   ...
   */
  public TerminologyCapabilitiesBuilder withId(@NonNull String id) {
   ...
   */
  public TerminologyCapabilitiesBuilder withUrl(@NonNull String url) {
   ...
   *     to the resource.
   */
  public TerminologyCapabilitiesBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public TerminologyCapabilitiesBuilder withText(@NonNull Narrative text) {
   ...
   *     code generation.
   */
  public TerminologyCapabilitiesBuilder withName(@NonNull String name) {
    this.name = Optional.of(name);
    return this;
  }
  /** @param title - A short, descriptive, user-friendly title for the terminology capabilities. */
  public TerminologyCapabilitiesBuilder withTitle(@NonNull String title) {
   ...
   *     an arbitrary value managed by the terminology capabilities author and is not expected to be
   ...
   */
  public TerminologyCapabilitiesBuilder withVersion(@NonNull String version) {
   ...
   *     publisher.
   */
  public TerminologyCapabilitiesBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public TerminologyCapabilitiesBuilder withContact(@NonNull Collection<ContactDetail> contact) {
   ...
   *     designed as it has.
   */
  public TerminologyCapabilitiesBuilder withPurpose(@NonNull String purpose) {
    this.purpose = Optional.of(purpose);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public TerminologyCapabilitiesBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public TerminologyCapabilitiesBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public TerminologyCapabilitiesBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public TerminologyCapabilitiesBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public TerminologyCapabilitiesBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     capabilities.
   */
  public TerminologyCapabilitiesBuilder withPublisher(@NonNull String publisher) {
   ...
   */
  public TerminologyCapabilitiesBuilder withCopyright(@NonNull String copyright) {
   ...
   */
  public TerminologyCapabilitiesBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate terminology capabilities instances.
   */
  public TerminologyCapabilitiesBuilder withUseContext(
      @NonNull Collection<UsageContext> useContext) {
    this.useContext = Collections.unmodifiableCollection(useContext);
    return this;
  }
  /** @param lockedDate - Whether the server supports lockedDate. */
  public TerminologyCapabilitiesBuilder withLockedDate(@NonNull Boolean lockedDate) {
   ...
   */
  public TerminologyCapabilitiesBuilder withCodeSearch(@NonNull CODE_SEARCH_SUPPORT codeSearch) {
   ...
   */
  public TerminologyCapabilitiesBuilder withDescription(@NonNull String description) {
   ...
   */
  public TerminologyCapabilitiesBuilder withExperimental(@NonNull Boolean experimental) {
   ...
   *     intended to be used.
   */
  public TerminologyCapabilitiesBuilder withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
   ...
   *     intended to be used.
   */
  public TerminologyCapabilitiesBuilder withJurisdiction(
   ...
   *     profiles etc.
   */
  public TerminologyCapabilitiesBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public TerminologyCapabilitiesBuilder withModifierExtension(
  ...
  public TerminologyCapabilitiesBuilder withClosure(
   ...
   *     when the statement describes the capabilities of a particular software version, independent
   *     of an installation.
   */
  public TerminologyCapabilitiesBuilder withSoftware(
   ...
   */
  public TerminologyCapabilitiesBuilder withTranslation(
   ...
   */
  public TerminologyCapabilitiesBuilder withValidateCode(
   ...
   *     terminology capability statement - i.e. a particular installation, rather than the
   *     capabilities of a software program.
   */
  public TerminologyCapabilitiesBuilder withImplementation(
   ...
   *     operation.
   */
  public TerminologyCapabilitiesBuilder withExpansion(
   ...
   *     code system URL, then this declares the general assumptions a client can make about support
   *     for any CodeSystem resource.
   */
  public TerminologyCapabilitiesBuilder withCodeSystem(
  ...
  public TerminologyCapabilities build() {
    return new TerminologyCapabilities(
        ...
        (Option) OptionConverters.toScala(lockedDate.map(x -> (Object) x)),
        (Option) OptionConverters.toScala(codeSearch),
        (Option) OptionConverters.toScala(description),
        (Option) OptionConverters.toScala(experimental.map(x -> (Object) x)),
        jurisdiction.stream().collect(new LitSeqJCollector<>()),
        (Option) OptionConverters.toScala(implicitRules),
        modifierExtension.stream().collect(new LitSeqJCollector<>()),
        (Option) OptionConverters.toScala(closure),
        (Option) OptionConverters.toScala(software),
        (Option) OptionConverters.toScala(translation),
        (Option) OptionConverters.toScala(validateCode),
        (Option) OptionConverters.toScala(implementation),
        (Option) OptionConverters.toScala(expansion),
