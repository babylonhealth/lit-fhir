...
public interface CapabilityStatementBuilder extends CanonicalResourceBuilder {
  ...
  public class Impl implements CapabilityStatementBuilder {
     ...
     */
    public CapabilityStatementBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public CapabilityStatementBuilder.Impl withUrl(@NonNull String url) {
     ...
     */
    public CapabilityStatementBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     *     generation.
     */
    public CapabilityStatementBuilder.Impl withName(@NonNull String name) {
      this.name = Optional.of(name);
      return this;
    }
    /** @param title - A short, descriptive, user-friendly title for the capability statement. */
    public CapabilityStatementBuilder.Impl withTitle(@NonNull String title) {
     ...
     */
    public CapabilityStatementBuilder.Impl withVersion(@NonNull String version) {
     ...
     *     publisher.
     */
    public CapabilityStatementBuilder.Impl withContact(@NonNull ContactDetail... contact) {
     ...
     *     designed as it has.
     */
    public CapabilityStatementBuilder.Impl withPurpose(@NonNull String purpose) {
      this.purpose = Optional.of(purpose);
      return this;
    }
    /**
     * @param imports - Reference to a canonical URL of another CapabilityStatement that this
     *     software adds to. The capability statement automatically includes everything in the other
     ...
     */
    public CapabilityStatementBuilder.Impl withImports(@NonNull String... imports) {
     ...
     *     interactions and operations to add additional details to them.
     */
    public CapabilityStatementBuilder.Impl withImports(@NonNull Collection<String> imports) {
      this.imports = Collections.unmodifiableCollection(imports);
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public CapabilityStatementBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public CapabilityStatementBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     their own independent transaction scope.
     */
    public CapabilityStatementBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
     ...
     */
    public CapabilityStatementBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     statement.
     */
    public CapabilityStatementBuilder.Impl withPublisher(@NonNull String publisher) {
     ...
     */
    public CapabilityStatementBuilder.Impl withCopyright(@NonNull String copyright) {
     ...
     */
    public CapabilityStatementBuilder.Impl withUseContext(@NonNull UsageContext... useContext) {
     ...
     */
    public CapabilityStatementBuilder.Impl withDescription(@NonNull String description) {
     ...
     *     content types.
     */
    public CapabilityStatementBuilder.Impl withPatchFormat(@NonNull String... patchFormat) {
     ...
     *     content types.
     */
    public CapabilityStatementBuilder.Impl withPatchFormat(
        @NonNull Collection<String> patchFormat) {
     ...
     *     for genuine usage.
     */
    public CapabilityStatementBuilder.Impl withExperimental(@NonNull Boolean experimental) {
     ...
     */
    public CapabilityStatementBuilder.Impl withInstantiates(@NonNull String... instantiates) {
     ...
     *     full capability details.
     */
    public CapabilityStatementBuilder.Impl withInstantiates(
     ...
     *     profiles etc.
     */
    public CapabilityStatementBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public CapabilityStatementBuilder.Impl withImplementationGuide(
    ...
    public CapabilityStatementBuilder.Impl withSoftware(
        @NonNull CapabilityStatement.Software software) {
    ...
    public CapabilityStatementBuilder.Impl withRest(@NonNull CapabilityStatement.Rest... rest) {
      this.rest = Arrays.asList(rest);
      return this;
    }
    /** @param rest - A definition of the restful capabilities of the solution, if any. */
    public CapabilityStatementBuilder.Impl withRest(
        @NonNull Collection<CapabilityStatement.Rest> rest) {
