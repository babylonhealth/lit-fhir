...
public class Task_InputBuilder {
   ...
   */
  public Task_InputBuilder(CodeableConcept _type, @NonNull ParamDistinguisher value) {
    this._type = _type;
    this.value =
        (Choice)
            Choice$.MODULE$.fromSuffix(
                value.suffix, value.wrappedChoice, Task.Input$.MODULE$.value());
  }
   ...
   */
  public Task_InputBuilder withId(@NonNull String id) {
   ...
   */
  public Task_InputBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Task_InputBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public Task_InputBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public Task_InputBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
