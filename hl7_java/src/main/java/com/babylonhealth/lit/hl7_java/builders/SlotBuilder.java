...
public class SlotBuilder {
   ...
   */
  public SlotBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public SlotBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public SlotBuilder withText(@NonNull Narrative text) {
   ...
   */
  public SlotBuilder withComment(@NonNull String comment) {
    this.comment = Optional.of(comment);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public SlotBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public SlotBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public SlotBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public SlotBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public SlotBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public SlotBuilder withSpecialty(@NonNull CodeableConcept... specialty) {
   ...
   *     service requested in this appointment.
   */
  public SlotBuilder withSpecialty(@NonNull Collection<CodeableConcept> specialty) {
    this.specialty = Collections.unmodifiableCollection(specialty);
    return this;
  }
  /** @param identifier - External Ids for this item. */
  public SlotBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - External Ids for this item. */
  public SlotBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public SlotBuilder withOverbooked(@NonNull Boolean overbooked) {
   ...
   */
  public SlotBuilder withServiceType(@NonNull CodeableConcept... serviceType) {
   ...
   *     itself). If provided then this overrides the value provided on the availability resource.
   */
  public SlotBuilder withServiceType(@NonNull Collection<CodeableConcept> serviceType) {
   ...
   *     profiles etc.
   */
  public SlotBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     this appointment.
   */
  public SlotBuilder withServiceCategory(@NonNull CodeableConcept... serviceCategory) {
   ...
   *     this appointment.
   */
  public SlotBuilder withServiceCategory(@NonNull Collection<CodeableConcept> serviceCategory) {
   ...
   *     (not service type).
   */
  public SlotBuilder withAppointmentType(@NonNull CodeableConcept appointmentType) {
   ...
   */
  public SlotBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public SlotBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
