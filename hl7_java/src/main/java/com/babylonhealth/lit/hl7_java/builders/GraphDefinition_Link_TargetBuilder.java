...
public class GraphDefinition_Link_TargetBuilder {
  ...
  private Collection<GraphDefinition$Link$Target$Compartment> compartment = Collections.emptyList();
   ...
   * @param _type
   */
  public GraphDefinition_Link_TargetBuilder(RESOURCE_TYPES _type) {
    this._type = _type;
  }
   ...
   */
  public GraphDefinition_Link_TargetBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param link - Links this graph makes rules about. */
  public GraphDefinition_Link_TargetBuilder withLink(@NonNull GraphDefinition.Link... link) {
    this.link = Arrays.asList(link);
    return this;
  }
  /** @param link - Links this graph makes rules about. */
  public GraphDefinition_Link_TargetBuilder withLink(
      @NonNull Collection<GraphDefinition.Link> link) {
    this.link = Collections.unmodifiableCollection(link);
    return this;
  }
  /** @param params */
  public GraphDefinition_Link_TargetBuilder withParams(@NonNull String params) {
    this.params = Optional.of(params);
    return this;
  }
  /** @param profile - The profile that describes the use of the base resource. */
  public GraphDefinition_Link_TargetBuilder withProfile(@NonNull String profile) {
   ...
   */
  public GraphDefinition_Link_TargetBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public GraphDefinition_Link_TargetBuilder withExtension(
   ...
   */
  public GraphDefinition_Link_TargetBuilder withModifierExtension(
  ...
  /** @param compartment */
  public GraphDefinition_Link_TargetBuilder withCompartment(
