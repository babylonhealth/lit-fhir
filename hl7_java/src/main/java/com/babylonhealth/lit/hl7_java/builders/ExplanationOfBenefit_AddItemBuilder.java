...
public class ExplanationOfBenefit_AddItemBuilder {
   ...
   */
  public ExplanationOfBenefit_AddItemBuilder(CodeableConcept productOrService) {
   ...
   */
  public ExplanationOfBenefit_AddItemBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param net */
  public ExplanationOfBenefit_AddItemBuilder withNet(@NonNull Money net) {
    this.net = Optional.of(net);
    return this;
  }
  /** @param factor */
  public ExplanationOfBenefit_AddItemBuilder withFactor(@NonNull BigDecimal factor) {
    this.factor = Optional.of(factor);
    return this;
  }
  /** @param subSite */
  public ExplanationOfBenefit_AddItemBuilder withSubSite(@NonNull CodeableConcept... subSite) {
    this.subSite = Arrays.asList(subSite);
    return this;
  }
  /** @param subSite */
  public ExplanationOfBenefit_AddItemBuilder withSubSite(
   ...
   *     preauthorization.
   */
  public ExplanationOfBenefit_AddItemBuilder withProvider(@NonNull Reference... provider) {
   ...
   *     preauthorization.
   */
  public ExplanationOfBenefit_AddItemBuilder withProvider(@NonNull Collection<Reference> provider) {
    this.provider = Collections.unmodifiableCollection(provider);
    return this;
  }
  /** @param modifier */
  public ExplanationOfBenefit_AddItemBuilder withModifier(@NonNull CodeableConcept... modifier) {
    this.modifier = Arrays.asList(modifier);
    return this;
  }
  /** @param modifier */
  public ExplanationOfBenefit_AddItemBuilder withModifier(
      @NonNull Collection<CodeableConcept> modifier) {
    this.modifier = Collections.unmodifiableCollection(modifier);
    return this;
  }
  /** @param quantity */
  public ExplanationOfBenefit_AddItemBuilder withQuantity(@NonNull Quantity quantity) {
    this.quantity = Optional.of(quantity);
    return this;
  }
  /** @param bodySite */
  public ExplanationOfBenefit_AddItemBuilder withBodySite(@NonNull CodeableConcept bodySite) {
   ...
   */
  public ExplanationOfBenefit_AddItemBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ExplanationOfBenefit_AddItemBuilder withExtension(
      @NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param unitPrice */
  public ExplanationOfBenefit_AddItemBuilder withUnitPrice(@NonNull Money unitPrice) {
    this.unitPrice = Optional.of(unitPrice);
    return this;
  }
  /** @param noteNumber */
  public ExplanationOfBenefit_AddItemBuilder withNoteNumber(@NonNull Integer... noteNumber) {
    this.noteNumber = Arrays.asList(noteNumber);
    return this;
  }
  /** @param noteNumber */
  public ExplanationOfBenefit_AddItemBuilder withNoteNumber(
      @NonNull Collection<Integer> noteNumber) {
    this.noteNumber = Collections.unmodifiableCollection(noteNumber);
    return this;
  }
  /** @param programCode */
  public ExplanationOfBenefit_AddItemBuilder withProgramCode(
   ...
   *     value in, wrap with one of the ExplanationOfBenefit_AddItemBuilder.serviced static methods
   */
  ...
  /** @param itemSequence */
  public ExplanationOfBenefit_AddItemBuilder withItemSequence(@NonNull Integer... itemSequence) {
    this.itemSequence = Arrays.asList(itemSequence);
    return this;
  }
  /** @param itemSequence */
  public ExplanationOfBenefit_AddItemBuilder withItemSequence(
   ...
   */
  public ExplanationOfBenefit_AddItemBuilder withAdjudication(
  ...
  public ExplanationOfBenefit_AddItemBuilder withDetailSequence(
   ...
   */
  public ExplanationOfBenefit_AddItemBuilder withModifierExtension(
  ...
  public ExplanationOfBenefit_AddItemBuilder withSubDetailSequence(
  ...
  /** @param detail */
  public ExplanationOfBenefit_AddItemBuilder withDetail(
