...
public class DeviceBuilder {
   ...
   */
  public DeviceBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param url - A network address on which the device may be contacted directly. */
  public DeviceBuilder withUrl(@NonNull String url) {
   ...
   *     to the resource.
   */
  public DeviceBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public DeviceBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param _type - The kind or type of device. */
  public DeviceBuilder withType(@NonNull CodeableConcept _type) {
   ...
   */
  public DeviceBuilder withNote(@NonNull Annotation... note) {
   ...
   *     not captured in an existing element.
   */
  public DeviceBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   *     the device.
   */
  public DeviceBuilder withOwner(@NonNull Reference owner) {
    this.owner = Optional.of(owner);
    return this;
  }
  /** @param status - Status of the Device availability. */
  public DeviceBuilder withStatus(@NonNull DEVICE_STATUS status) {
   ...
   */
  public DeviceBuilder withSafety(@NonNull CodeableConcept... safety) {
   ...
   *     devices containing latex.
   */
  public DeviceBuilder withSafety(@NonNull Collection<CodeableConcept> safety) {
    this.safety = Collections.unmodifiableCollection(safety);
    return this;
  }
  /** @param parent - The parent device. */
  public DeviceBuilder withParent(@NonNull Reference parent) {
    this.parent = Optional.of(parent);
    return this;
  }
  /** @param patient - Patient information, If the device is affixed to a person. */
  public DeviceBuilder withPatient(@NonNull Reference patient) {
   ...
   *     for the device.
   */
  public DeviceBuilder withContact(@NonNull ContactPoint... contact) {
   ...
   *     for the device.
   */
  public DeviceBuilder withContact(@NonNull Collection<ContactPoint> contact) {
    this.contact = Collections.unmodifiableCollection(contact);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public DeviceBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param location - The place where the device can be found. */
  public DeviceBuilder withLocation(@NonNull Reference location) {
   ...
   */
  public DeviceBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public DeviceBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public DeviceBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public DeviceBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param lotNumber - Lot number assigned by the manufacturer. */
  public DeviceBuilder withLotNumber(@NonNull String lotNumber) {
   ...
   */
  public DeviceBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     organizations or owners.
   */
  public DeviceBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
    this.identifier = Collections.unmodifiableCollection(identifier);
    return this;
  }
  /** @param definition - The reference to the definition for the device. */
  public DeviceBuilder withDefinition(@NonNull Reference definition) {
    this.definition = Optional.of(definition);
    return this;
  }
  /** @param partNumber - The part number of the device. */
  public DeviceBuilder withPartNumber(@NonNull String partNumber) {
    this.partNumber = Optional.of(partNumber);
    return this;
  }
  /** @param modelNumber - The model number for the device. */
  public DeviceBuilder withModelNumber(@NonNull String modelNumber) {
    this.modelNumber = Optional.of(modelNumber);
    return this;
  }
  /** @param statusReason - Reason for the dtatus of the Device availability. */
  public DeviceBuilder withStatusReason(@NonNull CodeableConcept... statusReason) {
    this.statusReason = Arrays.asList(statusReason);
    return this;
  }
  /** @param statusReason - Reason for the dtatus of the Device availability. */
  public DeviceBuilder withStatusReason(@NonNull Collection<CodeableConcept> statusReason) {
    this.statusReason = Collections.unmodifiableCollection(statusReason);
    return this;
  }
  /** @param manufacturer - A name of the manufacturer. */
  public DeviceBuilder withManufacturer(@NonNull String manufacturer) {
   ...
   *     manufactured.
   */
  public DeviceBuilder withSerialNumber(@NonNull String serialNumber) {
   ...
   *     profiles etc.
   */
  public DeviceBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public DeviceBuilder withExpirationDate(@NonNull FHIRDateTime expirationDate) {
    this.expirationDate = Optional.of(expirationDate);
    return this;
  }
  /** @param manufactureDate - The date and time when the device was manufactured. */
  public DeviceBuilder withManufactureDate(@NonNull FHIRDateTime manufactureDate) {
   ...
   */
  public DeviceBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public DeviceBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
   ...
   */
  public DeviceBuilder withDistinctIdentifier(@NonNull String distinctIdentifier) {
  ...
  public DeviceBuilder withVersion(@NonNull Device.Version... version) {
    this.version = Arrays.asList(version);
    return this;
  }
  /** @param version - The actual design of the device or software version running on the device. */
  public DeviceBuilder withVersion(@NonNull Collection<Device.Version> version) {
   ...
   */
  public DeviceBuilder withProperty(@NonNull Device.Property... property) {
   ...
   *     regulation status, time properties.
   */
  public DeviceBuilder withProperty(@NonNull Collection<Device.Property> property) {
   ...
   *     been sold.
   */
  public DeviceBuilder withUdiCarrier(@NonNull Device.UdiCarrier... udiCarrier) {
   ...
   *     been sold.
   */
  public DeviceBuilder withUdiCarrier(@NonNull Collection<Device.UdiCarrier> udiCarrier) {
   ...
   */
  public DeviceBuilder withDeviceName(@NonNull Device.DeviceName... deviceName) {
   ...
   *     available from DeviceDefinition.
   */
  public DeviceBuilder withDeviceName(@NonNull Collection<Device.DeviceName> deviceName) {
   ...
   */
  public DeviceBuilder withSpecialization(@NonNull Device.Specialization... specialization) {
   ...
   *     device conforms for a particular purpose, and used for the communication.
   */
  public DeviceBuilder withSpecialization(
