...
public class DeviceRequestBuilder {
   ...
   */
  public DeviceRequestBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public DeviceRequestBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public DeviceRequestBuilder withText(@NonNull Narrative text) {
   ...
   */
  public DeviceRequestBuilder withNote(@NonNull Annotation... note) {
   ...
   *     instruction, or a note associated with the statement.
   */
  public DeviceRequestBuilder withNote(@NonNull Collection<Annotation> note) {
    this.note = Collections.unmodifiableCollection(note);
    return this;
  }
  /** @param status - The status of the request. */
  public DeviceRequestBuilder withStatus(@NonNull REQUEST_STATUS status) {
    this.status = Optional.of(status);
    return this;
  }
  /** @param basedOn - Plan/proposal/order fulfilled by this request. */
  public DeviceRequestBuilder withBasedOn(@NonNull Reference... basedOn) {
    this.basedOn = Arrays.asList(basedOn);
    return this;
  }
  /** @param basedOn - Plan/proposal/order fulfilled by this request. */
  public DeviceRequestBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public DeviceRequestBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   *     requests.
   */
  public DeviceRequestBuilder withPriority(@NonNull REQUEST_PRIORITY priority) {
   ...
   */
  public DeviceRequestBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public DeviceRequestBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public DeviceRequestBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public DeviceRequestBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public DeviceRequestBuilder withEncounter(@NonNull Reference encounter) {
   ...
   *     activation.
   */
  public DeviceRequestBuilder withRequester(@NonNull Reference requester) {
    this.requester = Optional.of(requester);
    return this;
  }
  /** @param performer - The desired performer for doing the diagnostic testing. */
  public DeviceRequestBuilder withPerformer(@NonNull Reference performer) {
   ...
   */
  public DeviceRequestBuilder withInsurance(@NonNull Reference... insurance) {
   ...
   *     pre-determinations that may be required for delivering the requested service.
   */
  public DeviceRequestBuilder withInsurance(@NonNull Collection<Reference> insurance) {
  ...
  public DeviceRequestBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - Identifiers assigned to this order by the orderer or by the receiver. */
  public DeviceRequestBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
    this.identifier = Collections.unmodifiableCollection(identifier);
    return this;
  }
  /** @param authoredOn - When the request transitioned to being actionable. */
  public DeviceRequestBuilder withAuthoredOn(@NonNull FHIRDateTime authoredOn) {
    this.authoredOn = Optional.of(authoredOn);
    return this;
  }
  /** @param reasonCode - Reason or justification for the use of this device. */
  public DeviceRequestBuilder withReasonCode(@NonNull CodeableConcept... reasonCode) {
    this.reasonCode = Arrays.asList(reasonCode);
    return this;
  }
  /** @param reasonCode - Reason or justification for the use of this device. */
  public DeviceRequestBuilder withReasonCode(@NonNull Collection<CodeableConcept> reasonCode) {
   ...
   *     request(s).
   */
  public DeviceRequestBuilder withPriorRequest(@NonNull Reference... priorRequest) {
   ...
   *     request(s).
   */
  public DeviceRequestBuilder withPriorRequest(@NonNull Collection<Reference> priorRequest) {
   ...
   *     profiles etc.
   */
  public DeviceRequestBuilder withImplicitRules(@NonNull String implicitRules) {
  ...
  public DeviceRequestBuilder withPerformerType(@NonNull CodeableConcept performerType) {
   ...
   */
  public DeviceRequestBuilder withSupportingInfo(@NonNull Reference... supportingInfo) {
   ...
   *     device will be used (i.e. the target site).
   */
  public DeviceRequestBuilder withSupportingInfo(@NonNull Collection<Reference> supportingInfo) {
   ...
   *     orderset or other definition that is adhered to in whole or in part by this DeviceRequest.
   */
  public DeviceRequestBuilder withInstantiatesUri(@NonNull String... instantiatesUri) {
   ...
   *     orderset or other definition that is adhered to in whole or in part by this DeviceRequest.
   */
  public DeviceRequestBuilder withInstantiatesUri(@NonNull Collection<String> instantiatesUri) {
  ...
  public DeviceRequestBuilder withGroupIdentifier(@NonNull Identifier groupIdentifier) {
    this.groupIdentifier = Optional.of(groupIdentifier);
    return this;
  }
  /** @param reasonReference - Reason or justification for the use of this device. */
  public DeviceRequestBuilder withReasonReference(@NonNull Reference... reasonReference) {
    this.reasonReference = Arrays.asList(reasonReference);
    return this;
  }
  /** @param reasonReference - Reason or justification for the use of this device. */
  public DeviceRequestBuilder withReasonReference(@NonNull Collection<Reference> reasonReference) {
    this.reasonReference = Collections.unmodifiableCollection(reasonReference);
    return this;
  }
  /** @param relevantHistory - Key events in the history of the request. */
  public DeviceRequestBuilder withRelevantHistory(@NonNull Reference... relevantHistory) {
    this.relevantHistory = Arrays.asList(relevantHistory);
    return this;
  }
  /** @param relevantHistory - Key events in the history of the request. */
  public DeviceRequestBuilder withRelevantHistory(@NonNull Collection<Reference> relevantHistory) {
   ...
   */
  public DeviceRequestBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public DeviceRequestBuilder withModifierExtension(
   ...
   *     or other definition that is adhered to in whole or in part by this DeviceRequest.
   */
  public DeviceRequestBuilder withInstantiatesCanonical(@NonNull String... instantiatesCanonical) {
   ...
   *     or other definition that is adhered to in whole or in part by this DeviceRequest.
   */
  public DeviceRequestBuilder withInstantiatesCanonical(
   ...
   *     lenses.
   */
  public DeviceRequestBuilder withParameter(@NonNull DeviceRequest.Parameter... parameter) {
   ...
   *     lenses.
   */
  public DeviceRequestBuilder withParameter(
