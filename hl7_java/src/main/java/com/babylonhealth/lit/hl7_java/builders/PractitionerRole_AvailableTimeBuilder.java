...
public interface PractitionerRole_AvailableTimeBuilder {
  ...
  public class Impl implements PractitionerRole_AvailableTimeBuilder {
     ...
     */
    public PractitionerRole_AvailableTimeBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param allDay */
    public PractitionerRole_AvailableTimeBuilder.Impl withAllDay(@NonNull Boolean allDay) {
    ...
    public PractitionerRole_AvailableTimeBuilder.Impl withAvailableEndTime(
    ...
    public PractitionerRole_AvailableTimeBuilder.Impl withAvailableStartTime(
