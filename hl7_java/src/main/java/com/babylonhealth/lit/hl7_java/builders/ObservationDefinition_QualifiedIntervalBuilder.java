...
public class ObservationDefinition_QualifiedIntervalBuilder {
  ...
  public ObservationDefinition_QualifiedIntervalBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public ObservationDefinition_QualifiedIntervalBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param age */
  public ObservationDefinition_QualifiedIntervalBuilder withAge(@NonNull Range age) {
    this.age = Optional.of(age);
    return this;
  }
  /** @param range */
  public ObservationDefinition_QualifiedIntervalBuilder withRange(@NonNull Range range) {
    this.range = Optional.of(range);
    return this;
  }
  /** @param gender */
  public ObservationDefinition_QualifiedIntervalBuilder withGender(
      @NonNull ADMINISTRATIVE_GENDER gender) {
    this.gender = Optional.of(gender);
    return this;
  }
  /** @param context */
  public ObservationDefinition_QualifiedIntervalBuilder withContext(
      @NonNull CodeableConcept context) {
    this.context = Optional.of(context);
    return this;
  }
  /** @param category - A code that classifies the general type of observation. */
  public ObservationDefinition_QualifiedIntervalBuilder withCategory(
   ...
   */
  public ObservationDefinition_QualifiedIntervalBuilder withExtension(
  ...
  /** @param appliesTo */
  public ObservationDefinition_QualifiedIntervalBuilder withAppliesTo(
  ...
  /** @param condition */
  public ObservationDefinition_QualifiedIntervalBuilder withCondition(@NonNull String condition) {
    this.condition = Optional.of(condition);
    return this;
  }
  /** @param gestationalAge */
  public ObservationDefinition_QualifiedIntervalBuilder withGestationalAge(
   ...
   */
  public ObservationDefinition_QualifiedIntervalBuilder withModifierExtension(
