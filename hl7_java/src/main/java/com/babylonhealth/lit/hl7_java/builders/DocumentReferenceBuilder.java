...
public class DocumentReferenceBuilder {
   ...
   */
  public DocumentReferenceBuilder(
   ...
   */
  public DocumentReferenceBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public DocumentReferenceBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public DocumentReferenceBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /**
   * @param _type - Specifies the particular kind of document referenced (e.g. History and Physical,
   *     Discharge Summary, Progress Note). This usually equates to the purpose of making the
   *     document referenced.
   */
  public DocumentReferenceBuilder withType(@NonNull CodeableConcept _type) {
    this._type = Optional.of(_type);
    return this;
  }
  /** @param date - When the document reference was created. */
  public DocumentReferenceBuilder withDate(@NonNull ZonedDateTime date) {
    this.date = Optional.of(date);
    return this;
  }
  /** @param author - Identifies who is responsible for adding the information to the document. */
  public DocumentReferenceBuilder withAuthor(@NonNull Reference... author) {
    this.author = Arrays.asList(author);
    return this;
  }
  /** @param author - Identifies who is responsible for adding the information to the document. */
  public DocumentReferenceBuilder withAuthor(@NonNull Collection<Reference> author) {
   ...
   *     (such as a document about a herd of farm animals, or a set of patients that share a common
   *     exposure).
   */
  public DocumentReferenceBuilder withSubject(@NonNull Reference subject) {
    this.subject = Optional.of(subject);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public DocumentReferenceBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public DocumentReferenceBuilder withCategory(@NonNull CodeableConcept... category) {
   ...
   *     DocumentReference.type.
   */
  public DocumentReferenceBuilder withCategory(@NonNull Collection<CodeableConcept> category) {
   ...
   */
  public DocumentReferenceBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public DocumentReferenceBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public DocumentReferenceBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public DocumentReferenceBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param docStatus - The status of the underlying document. */
  public DocumentReferenceBuilder withDocStatus(@NonNull COMPOSITION_STATUS docStatus) {
   ...
   */
  public DocumentReferenceBuilder withCustodian(@NonNull Reference custodian) {
   ...
   */
  public DocumentReferenceBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     independent identifiers.
   */
  public DocumentReferenceBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
    this.identifier = Collections.unmodifiableCollection(identifier);
    return this;
  }
  /** @param description - Human-readable description of the source document. */
  public DocumentReferenceBuilder withDescription(@NonNull String description) {
   ...
   *     profiles etc.
   */
  public DocumentReferenceBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public DocumentReferenceBuilder withAuthenticator(@NonNull Reference authenticator) {
    this.authenticator = Optional.of(authenticator);
    return this;
  }
  /**
   * @param securityLabel - A set of Security-Tag codes specifying the level of privacy/security of
   *     the Document. Note that DocumentReference.meta.security contains the security labels of the
   *     "reference" to the document, while DocumentReference.securityLabel contains a snapshot of
   *     the security labels on the document the reference refers to.
   */
  public DocumentReferenceBuilder withSecurityLabel(@NonNull CodeableConcept... securityLabel) {
   ...
   *     the security labels on the document the reference refers to.
   */
  public DocumentReferenceBuilder withSecurityLabel(
   ...
   *     identifier is specific to this version of the document. This unique identifier may be used
   *     elsewhere to identify this version of the document.
   */
  public DocumentReferenceBuilder withMasterIdentifier(@NonNull Identifier masterIdentifier) {
   ...
   */
  public DocumentReferenceBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public DocumentReferenceBuilder withModifierExtension(
      @NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param context - The clinical context in which the document was prepared. */
  public DocumentReferenceBuilder withContext(@NonNull DocumentReference.Context context) {
   ...
   *     already exist.
   */
  public DocumentReferenceBuilder withRelatesTo(@NonNull DocumentReference.RelatesTo... relatesTo) {
   ...
   *     already exist.
   */
  public DocumentReferenceBuilder withRelatesTo(
