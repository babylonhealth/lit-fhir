...
public class Immunization_EducationBuilder {
  ...
  public Immunization_EducationBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public Immunization_EducationBuilder withId(@NonNull String id) {
   ...
   */
  public Immunization_EducationBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Immunization_EducationBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param reference */
  public Immunization_EducationBuilder withReference(@NonNull String reference) {
    this.reference = Optional.of(reference);
    return this;
  }
  /** @param documentType */
  public Immunization_EducationBuilder withDocumentType(@NonNull String documentType) {
    this.documentType = Optional.of(documentType);
    return this;
  }
  /** @param publicationDate */
  public Immunization_EducationBuilder withPublicationDate(@NonNull FHIRDateTime publicationDate) {
    this.publicationDate = Optional.of(publicationDate);
    return this;
  }
  /** @param presentationDate */
  public Immunization_EducationBuilder withPresentationDate(
   ...
   */
  public Immunization_EducationBuilder withModifierExtension(
