...
public class DeviceDefinitionBuilder {
   ...
   */
  public DeviceDefinitionBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param url - A network address on which the device may be contacted directly. */
  public DeviceDefinitionBuilder withUrl(@NonNull String url) {
   ...
   *     to the resource.
   */
  public DeviceDefinitionBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public DeviceDefinitionBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param _type - What kind of device or device system this is. */
  public DeviceDefinitionBuilder withType(@NonNull CodeableConcept _type) {
   ...
   */
  public DeviceDefinitionBuilder withNote(@NonNull Annotation... note) {
   ...
   *     not captured in an existing element.
   */
  public DeviceDefinitionBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   *     the device.
   */
  public DeviceDefinitionBuilder withOwner(@NonNull Reference owner) {
    this.owner = Optional.of(owner);
    return this;
  }
  /** @param safety - Safety characteristics of the device. */
  public DeviceDefinitionBuilder withSafety(@NonNull CodeableConcept... safety) {
    this.safety = Arrays.asList(safety);
    return this;
  }
  /** @param safety - Safety characteristics of the device. */
  public DeviceDefinitionBuilder withSafety(@NonNull Collection<CodeableConcept> safety) {
  ...
  public DeviceDefinitionBuilder withVersion(@NonNull String... version) {
    this.version = Arrays.asList(version);
    return this;
  }
  /** @param version - The available versions of the device, e.g., software versions. */
  public DeviceDefinitionBuilder withVersion(@NonNull Collection<String> version) {
   ...
   *     for the device.
   */
  public DeviceDefinitionBuilder withContact(@NonNull ContactPoint... contact) {
   ...
   *     for the device.
   */
  public DeviceDefinitionBuilder withContact(@NonNull Collection<ContactPoint> contact) {
    this.contact = Collections.unmodifiableCollection(contact);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public DeviceDefinitionBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   *     product).
   */
  public DeviceDefinitionBuilder withQuantity(@NonNull Quantity quantity) {
   ...
   */
  public DeviceDefinitionBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public DeviceDefinitionBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public DeviceDefinitionBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public DeviceDefinitionBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public DeviceDefinitionBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     manufacturers, other organizations or owners. For example: handle ID.
   */
  public DeviceDefinitionBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
    this.identifier = Collections.unmodifiableCollection(identifier);
    return this;
  }
  /** @param modelNumber - The model number for the device. */
  public DeviceDefinitionBuilder withModelNumber(@NonNull String modelNumber) {
    this.modelNumber = Optional.of(modelNumber);
    return this;
  }
  /**
   * @param languageCode - Language code for the human-readable text strings produced by the device
   *     (all supported).
   */
  public DeviceDefinitionBuilder withLanguageCode(@NonNull CodeableConcept... languageCode) {
   ...
   *     (all supported).
   */
  public DeviceDefinitionBuilder withLanguageCode(
  ...
  public DeviceDefinitionBuilder withParentDevice(@NonNull Reference parentDevice) {
   ...
   *     profiles etc.
   */
  public DeviceDefinitionBuilder withImplicitRules(@NonNull String implicitRules) {
  ...
  public DeviceDefinitionBuilder withShelfLifeStorage(@NonNull Choice... shelfLifeStorage) {
    this.shelfLifeStorage = Arrays.asList(shelfLifeStorage);
    return this;
  }
  /** @param shelfLifeStorage - Shelf Life and storage information. */
  public DeviceDefinitionBuilder withShelfLifeStorage(
   ...
   */
  public DeviceDefinitionBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   */
  public DeviceDefinitionBuilder withProperty(@NonNull DeviceDefinition.Property... property) {
   ...
   *     regulation status, time properties.
   */
  public DeviceDefinitionBuilder withProperty(
  ...
  public DeviceDefinitionBuilder withDeviceName(
  ...
  public DeviceDefinitionBuilder withCapability(
  ...
  public DeviceDefinitionBuilder withMaterial(@NonNull DeviceDefinition.Material... material) {
    this.material = Arrays.asList(material);
    return this;
  }
  /** @param material - A substance used to create the material(s) of which the device is made. */
  public DeviceDefinitionBuilder withMaterial(
   ...
   */
  public DeviceDefinitionBuilder withSpecialization(
   ...
   *     just the udiCarrier for the jurisdiction it is sold, or for multiple jurisdictions it could
   *     have been sold.
   */
  public DeviceDefinitionBuilder withUdiDeviceIdentifier(
