...
public class MedicationKnowledge_DrugCharacteristicBuilder {
   ...
   */
  public MedicationKnowledge_DrugCharacteristicBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param _type */
  public MedicationKnowledge_DrugCharacteristicBuilder withType(@NonNull CodeableConcept _type) {
   ...
   */
  public MedicationKnowledge_DrugCharacteristicBuilder withExtension(
   ...
   */
  public MedicationKnowledge_DrugCharacteristicBuilder withModifierExtension(
