...
public class SubstancePolymerBuilder {
  ...
  public SubstancePolymerBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public SubstancePolymerBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public SubstancePolymerBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public SubstancePolymerBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param _class - Todo. */
  public SubstancePolymerBuilder withClass(@NonNull CodeableConcept _class) {
    this._class = Optional.of(_class);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public SubstancePolymerBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param geometry - Todo. */
  public SubstancePolymerBuilder withGeometry(@NonNull CodeableConcept geometry) {
   ...
   */
  public SubstancePolymerBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public SubstancePolymerBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public SubstancePolymerBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public SubstancePolymerBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param modification - Todo. */
  public SubstancePolymerBuilder withModification(@NonNull String... modification) {
    this.modification = Arrays.asList(modification);
    return this;
  }
  /** @param modification - Todo. */
  public SubstancePolymerBuilder withModification(@NonNull Collection<String> modification) {
   ...
   *     profiles etc.
   */
  public SubstancePolymerBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public SubstancePolymerBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public SubstancePolymerBuilder withModifierExtension(
      @NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param copolymerConnectivity - Todo. */
  public SubstancePolymerBuilder withCopolymerConnectivity(
  ...
  public SubstancePolymerBuilder withMonomerSet(
  ...
  /** @param repeat - Todo. */
  public SubstancePolymerBuilder withRepeat(@NonNull SubstancePolymer.Repeat... repeat) {
    this.repeat = Arrays.asList(repeat);
    return this;
  }
  /** @param repeat - Todo. */
  public SubstancePolymerBuilder withRepeat(@NonNull Collection<SubstancePolymer.Repeat> repeat) {
