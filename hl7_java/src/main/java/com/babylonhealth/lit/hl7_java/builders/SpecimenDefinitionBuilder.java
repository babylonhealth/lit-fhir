...
public class SpecimenDefinitionBuilder {
  ...
  public SpecimenDefinitionBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public SpecimenDefinitionBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public SpecimenDefinitionBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public SpecimenDefinitionBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public SpecimenDefinitionBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public SpecimenDefinitionBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public SpecimenDefinitionBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public SpecimenDefinitionBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public SpecimenDefinitionBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param identifier - A business identifier associated with the kind of specimen. */
  public SpecimenDefinitionBuilder withIdentifier(@NonNull Identifier identifier) {
    this.identifier = Optional.of(identifier);
    return this;
  }
  /** @param timeAspect - Time aspect of specimen collection (duration or offset). */
  public SpecimenDefinitionBuilder withTimeAspect(@NonNull String timeAspect) {
    this.timeAspect = Optional.of(timeAspect);
    return this;
  }
  /** @param collection - The action to be performed for collecting the specimen. */
  public SpecimenDefinitionBuilder withCollection(@NonNull CodeableConcept... collection) {
    this.collection = Arrays.asList(collection);
    return this;
  }
  /** @param collection - The action to be performed for collecting the specimen. */
  public SpecimenDefinitionBuilder withCollection(@NonNull Collection<CodeableConcept> collection) {
   ...
   *     profiles etc.
   */
  public SpecimenDefinitionBuilder withImplicitRules(@NonNull String implicitRules) {
    this.implicitRules = Optional.of(implicitRules);
    return this;
  }
  /** @param typeCollected - The kind of material to be collected. */
  public SpecimenDefinitionBuilder withTypeCollected(@NonNull CodeableConcept typeCollected) {
   ...
   */
  public SpecimenDefinitionBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public SpecimenDefinitionBuilder withModifierExtension(
      @NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param patientPreparation - Preparation of the patient for specimen collection. */
  public SpecimenDefinitionBuilder withPatientPreparation(
   ...
   */
  public SpecimenDefinitionBuilder withTypeTested(
