...
public class NamingSystemBuilder {
   ...
   *
   * @param name - A natural language name identifying the naming system. This name should be usable
   ...
   */
  public NamingSystemBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public NamingSystemBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public NamingSystemBuilder withText(@NonNull Narrative text) {
   ...
   *     systems.
   */
  public NamingSystemBuilder withType(@NonNull CodeableConcept _type) {
   ...
   */
  public NamingSystemBuilder withUsage(@NonNull String usage) {
   ...
   *     publisher.
   */
  public NamingSystemBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public NamingSystemBuilder withContact(@NonNull Collection<ContactDetail> contact) {
    this.contact = Collections.unmodifiableCollection(contact);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public NamingSystemBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public NamingSystemBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public NamingSystemBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public NamingSystemBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public NamingSystemBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public NamingSystemBuilder withPublisher(@NonNull String publisher) {
   ...
   */
  public NamingSystemBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate naming system instances.
   */
  public NamingSystemBuilder withUseContext(@NonNull Collection<UsageContext> useContext) {
   ...
   */
  public NamingSystemBuilder withResponsible(@NonNull String responsible) {
   ...
   */
  public NamingSystemBuilder withDescription(@NonNull String description) {
   ...
   *     used.
   */
  public NamingSystemBuilder withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
   ...
   *     used.
   */
  public NamingSystemBuilder withJurisdiction(@NonNull Collection<CodeableConcept> jurisdiction) {
   ...
   *     profiles etc.
   */
  public NamingSystemBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public NamingSystemBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public NamingSystemBuilder withModifierExtension(
