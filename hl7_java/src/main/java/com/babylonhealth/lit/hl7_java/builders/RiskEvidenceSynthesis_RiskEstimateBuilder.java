...
public class RiskEvidenceSynthesis_RiskEstimateBuilder {
  ...
  public RiskEvidenceSynthesis_RiskEstimateBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public RiskEvidenceSynthesis_RiskEstimateBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param _type */
  public RiskEvidenceSynthesis_RiskEstimateBuilder withType(@NonNull CodeableConcept _type) {
    this._type = Optional.of(_type);
    return this;
  }
  /** @param value */
  public RiskEvidenceSynthesis_RiskEstimateBuilder withValue(@NonNull BigDecimal value) {
   ...
   */
  public RiskEvidenceSynthesis_RiskEstimateBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public RiskEvidenceSynthesis_RiskEstimateBuilder withExtension(
   ...
   */
  public RiskEvidenceSynthesis_RiskEstimateBuilder withDescription(@NonNull String description) {
    this.description = Optional.of(description);
    return this;
  }
  /** @param unitOfMeasure */
  public RiskEvidenceSynthesis_RiskEstimateBuilder withUnitOfMeasure(
      @NonNull CodeableConcept unitOfMeasure) {
    this.unitOfMeasure = Optional.of(unitOfMeasure);
    return this;
  }
  /** @param numeratorCount */
  public RiskEvidenceSynthesis_RiskEstimateBuilder withNumeratorCount(
      @NonNull Integer numeratorCount) {
    this.numeratorCount = Optional.of(numeratorCount);
    return this;
  }
  /** @param denominatorCount */
  public RiskEvidenceSynthesis_RiskEstimateBuilder withDenominatorCount(
   ...
   */
  public RiskEvidenceSynthesis_RiskEstimateBuilder withModifierExtension(
  ...
  public RiskEvidenceSynthesis_RiskEstimateBuilder withPrecisionEstimate(
  ...
  /** @param precisionEstimate */
  public RiskEvidenceSynthesis_RiskEstimateBuilder withPrecisionEstimate(
      @NonNull Collection<RiskEvidenceSynthesis$RiskEstimate$PrecisionEstimate> precisionEstimate) {
