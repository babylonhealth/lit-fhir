...
public class ExplanationOfBenefit_DiagnosisBuilder {
   ...
   */
  public ExplanationOfBenefit_DiagnosisBuilder(Integer sequence, @NonNull Object diagnosis) {
        ...
        (Choice)
            Choice$.MODULE$.fromSuffix(
                autoSuffix(
                    ...
                    ExplanationOfBenefit.Diagnosis$.MODULE$.diagnosis()),
                diagnosis,
                ExplanationOfBenefit.Diagnosis$.MODULE$.diagnosis());
  }
   ...
   */
  public ExplanationOfBenefit_DiagnosisBuilder withId(@NonNull String id) {
   ...
   */
  public ExplanationOfBenefit_DiagnosisBuilder withType(@NonNull CodeableConcept... _type) {
   ...
   * @param _type - The category of claim, e.g. oral, pharmacy, vision, institutional, professional.
   */
  public ExplanationOfBenefit_DiagnosisBuilder withType(
   ...
   */
  public ExplanationOfBenefit_DiagnosisBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ExplanationOfBenefit_DiagnosisBuilder withExtension(
      @NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param onAdmission */
  public ExplanationOfBenefit_DiagnosisBuilder withOnAdmission(
      @NonNull CodeableConcept onAdmission) {
    this.onAdmission = Optional.of(onAdmission);
    return this;
  }
  /** @param packageCode */
  public ExplanationOfBenefit_DiagnosisBuilder withPackageCode(
   ...
   */
  public ExplanationOfBenefit_DiagnosisBuilder withModifierExtension(
