...
public interface PractitionerRole_NotAvailableBuilder {
  ...
  public class Impl implements PractitionerRole_NotAvailableBuilder {
     ...
     */
    public PractitionerRole_NotAvailableBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param during */
    public PractitionerRole_NotAvailableBuilder.Impl withDuring(@NonNull Period during) {
