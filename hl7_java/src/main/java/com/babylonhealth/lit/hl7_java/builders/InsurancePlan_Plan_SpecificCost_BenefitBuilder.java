...
public interface InsurancePlan_Plan_SpecificCost_BenefitBuilder {
  ...
  public class Impl implements InsurancePlan_Plan_SpecificCost_BenefitBuilder {
     ...
     */
    public InsurancePlan_Plan_SpecificCost_BenefitBuilder.Impl withId(@NonNull String id) {
