...
public interface SubstancePolymer_Repeat_RepeatUnit_DegreeOfPolymerisationBuilder {
  ...
  public class Impl implements SubstancePolymer_Repeat_RepeatUnit_DegreeOfPolymerisationBuilder {
     ...
     */
    public SubstancePolymer_Repeat_RepeatUnit_DegreeOfPolymerisationBuilder.Impl withId(
        @NonNull String id) {
