...
public interface ExampleScenario_Instance_VersionBuilder {
  public ExampleScenario$Instance$Version build();

  public static Impl init(String versionId, String description) {
  ...
  public class Impl implements ExampleScenario_Instance_VersionBuilder {
     ...
     */
    public ExampleScenario_Instance_VersionBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public ExampleScenario_Instance_VersionBuilder.Impl withExtension(
     ...
     */
    public ExampleScenario_Instance_VersionBuilder.Impl withModifierExtension(
