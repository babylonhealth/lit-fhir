...
public interface TerminologyCapabilities_Expansion_ParameterBuilder {
  ...
  public class Impl implements TerminologyCapabilities_Expansion_ParameterBuilder {
     ...
     */
    public TerminologyCapabilities_Expansion_ParameterBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public TerminologyCapabilities_Expansion_ParameterBuilder.Impl withExtension(
    ...
    /** @param documentation */
    public TerminologyCapabilities_Expansion_ParameterBuilder.Impl withDocumentation(
     ...
     */
    public TerminologyCapabilities_Expansion_ParameterBuilder.Impl withModifierExtension(
