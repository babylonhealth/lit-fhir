...
public class ElementDefinition_BaseBuilder {
   ...
   */
  public ElementDefinition_BaseBuilder(Integer min, String max, String path) {
    this.min = min;
    this.max = max;
    this.path = path;
  }
   ...
   */
  public ElementDefinition_BaseBuilder withId(@NonNull String id) {
   ...
   */
  public ElementDefinition_BaseBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ElementDefinition_BaseBuilder withExtension(@NonNull Collection<Extension> extension) {
