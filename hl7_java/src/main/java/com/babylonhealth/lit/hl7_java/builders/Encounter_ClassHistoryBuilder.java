...
public interface Encounter_ClassHistoryBuilder {
  public Encounter.ClassHistory build();

  public static Impl init(Coding _class, Period period) {
  ...
  public class Impl implements Encounter_ClassHistoryBuilder {
    ...
    /**
     * Required fields for {@link Encounter.ClassHistory}
     *
     ...
     */
    public Impl(Coding _class, Period period) {
      this._class = _class;
      this.period = period;
    }
     ...
     */
    public Encounter_ClassHistoryBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public Encounter_ClassHistoryBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public Encounter_ClassHistoryBuilder.Impl withExtension(
     ...
     */
    public Encounter_ClassHistoryBuilder.Impl withModifierExtension(
