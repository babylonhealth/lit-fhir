...
public class StructureMap_Group_Rule_TargetBuilder {
  ...
  private Collection<StructureMap$Group$Rule$Target$Parameter> parameter = Collections.emptyList();

  /** Required fields for {@link StructureMap$Group$Rule$Target} */
  public StructureMap_Group_Rule_TargetBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public StructureMap_Group_Rule_TargetBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param context */
  public StructureMap_Group_Rule_TargetBuilder withContext(@NonNull String context) {
    this.context = Optional.of(context);
    return this;
  }
  /** @param element */
  public StructureMap_Group_Rule_TargetBuilder withElement(@NonNull String element) {
    this.element = Optional.of(element);
    return this;
  }
  /** @param variable */
  public StructureMap_Group_Rule_TargetBuilder withVariable(@NonNull String variable) {
    this.variable = Optional.of(variable);
    return this;
  }
  /** @param listMode */
  public StructureMap_Group_Rule_TargetBuilder withListMode(
   ...
   */
  public StructureMap_Group_Rule_TargetBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public StructureMap_Group_Rule_TargetBuilder withExtension(
      @NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param transform */
  public StructureMap_Group_Rule_TargetBuilder withTransform(@NonNull MAP_TRANSFORM transform) {
    this.transform = Optional.of(transform);
    return this;
  }
  /** @param listRuleId */
  public StructureMap_Group_Rule_TargetBuilder withListRuleId(@NonNull String listRuleId) {
    this.listRuleId = Optional.of(listRuleId);
    return this;
  }
  /** @param contextType */
  public StructureMap_Group_Rule_TargetBuilder withContextType(
   ...
   */
  public StructureMap_Group_Rule_TargetBuilder withModifierExtension(
  ...
  /** @param parameter */
  public StructureMap_Group_Rule_TargetBuilder withParameter(
