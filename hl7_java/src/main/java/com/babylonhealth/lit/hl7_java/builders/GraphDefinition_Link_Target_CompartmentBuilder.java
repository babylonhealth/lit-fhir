...
public interface GraphDefinition_Link_Target_CompartmentBuilder {
  ...
  public class Impl implements GraphDefinition_Link_Target_CompartmentBuilder {
     ...
     * @param rule
     */
    public Impl(GRAPH_COMPARTMENT_USE use, COMPARTMENT_TYPE code, GRAPH_COMPARTMENT_RULE rule) {
      this.use = use;
      this.code = code;
      this.rule = rule;
    }
     ...
     */
    public GraphDefinition_Link_Target_CompartmentBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public GraphDefinition_Link_Target_CompartmentBuilder.Impl withDescription(
