...
public interface CoverageEligibilityResponse_ErrorBuilder {
  ...
  public class Impl implements CoverageEligibilityResponse_ErrorBuilder {
     ...
     */
    public CoverageEligibilityResponse_ErrorBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public CoverageEligibilityResponse_ErrorBuilder.Impl withExtension(
     ...
     */
    public CoverageEligibilityResponse_ErrorBuilder.Impl withModifierExtension(
