...
public class Communication_PayloadBuilder {
   ...
   */
  public Communication_PayloadBuilder withId(@NonNull String id) {
   ...
   */
  public Communication_PayloadBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Communication_PayloadBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public Communication_PayloadBuilder withModifierExtension(
