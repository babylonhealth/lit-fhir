...
public class MessageHeaderBuilder {
   ...
   */
  public MessageHeaderBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public MessageHeaderBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public MessageHeaderBuilder withText(@NonNull Narrative text) {
   ...
   *     event.
   */
  public MessageHeaderBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     event.
   */
  public MessageHeaderBuilder withFocus(@NonNull Collection<Reference> focus) {
  ...
  public MessageHeaderBuilder withSender(@NonNull Reference sender) {
   ...
   */
  public MessageHeaderBuilder withAuthor(@NonNull Reference author) {
   ...
   */
  public MessageHeaderBuilder withReason(@NonNull CodeableConcept reason) {
   ...
   */
  public MessageHeaderBuilder withEnterer(@NonNull Reference enterer) {
    this.enterer = Optional.of(enterer);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public MessageHeaderBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public MessageHeaderBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public MessageHeaderBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public MessageHeaderBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public MessageHeaderBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param definition - Permanent link to the MessageDefinition for this message. */
  public MessageHeaderBuilder withDefinition(@NonNull String definition) {
   ...
   */
  public MessageHeaderBuilder withResponsible(@NonNull Reference responsible) {
   ...
   *     profiles etc.
   */
  public MessageHeaderBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public MessageHeaderBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public MessageHeaderBuilder withModifierExtension(
   ...
   */
  public MessageHeaderBuilder withResponse(@NonNull MessageHeader.Response response) {
    this.response = Optional.of(response);
    return this;
  }
  /** @param destination - The destination application which the message is intended for. */
  public MessageHeaderBuilder withDestination(@NonNull MessageHeader.Destination... destination) {
    this.destination = Arrays.asList(destination);
    return this;
  }
  /** @param destination - The destination application which the message is intended for. */
  public MessageHeaderBuilder withDestination(
