...
public interface SearchParameterBuilder extends CanonicalResourceBuilder {
  ...
  public class Impl implements SearchParameterBuilder {
     ...
     */
    public SearchParameterBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public SearchParameterBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public SearchParameterBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public SearchParameterBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public SearchParameterBuilder.Impl withText(@NonNull NarrativeBuilder text) {
     ...
     *     parameter changes.
     */
    public SearchParameterBuilder.Impl withDate(@NonNull FHIRDateTime date) {
     ...
     */
    public SearchParameterBuilder.Impl withXpath(@NonNull String xpath) {
     ...
     *     reference and specify that resources will only be returned if they contain a reference to
     *     a resource which matches the chained parameter value. Values for this field should be
     *     drawn from SearchParameter.code for a parameter on the target resource type.
     */
    public SearchParameterBuilder.Impl withChain(@NonNull String... chain) {
     ...
     *     drawn from SearchParameter.code for a parameter on the target resource type.
     */
    public SearchParameterBuilder.Impl withChain(@NonNull Collection<String> chain) {
      this.chain = Collections.unmodifiableCollection(chain);
      return this;
    }
    /** @param target - Types of resource (if a resource is referenced). */
    public SearchParameterBuilder.Impl withTarget(@NonNull RESOURCE_TYPES... target) {
      this.target = Arrays.asList(target);
      return this;
    }
    /** @param target - Types of resource (if a resource is referenced). */
    public SearchParameterBuilder.Impl withTarget(@NonNull Collection<RESOURCE_TYPES> target) {
     ...
     *     value managed by the search parameter author and is not expected to be globally unique.
     ...
     *     sequence.
     */
    public SearchParameterBuilder.Impl withVersion(@NonNull String version) {
     ...
     *     publisher.
     */
    public SearchParameterBuilder.Impl withContact(@NonNull ContactDetail... contact) {
     ...
     *     publisher.
     */
    public SearchParameterBuilder.Impl withContact(@NonNull Collection<ContactDetail> contact) {
      this.contact = Collections.unmodifiableCollection(contact);
      return this;
    }

    public SearchParameterBuilder.Impl withContact(@NonNull ContactDetailBuilder... contact) {
     ...
     *     designed as it has.
     */
    public SearchParameterBuilder.Impl withPurpose(@NonNull String purpose) {
      this.purpose = Optional.of(purpose);
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public SearchParameterBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
      this.language = Optional.of(language);
      return this;
    }
    /** @param modifier - A modifier supported for the search parameter. */
    public SearchParameterBuilder.Impl withModifier(@NonNull SEARCH_MODIFIER_CODE... modifier) {
      this.modifier = Arrays.asList(modifier);
      return this;
    }
    /** @param modifier - A modifier supported for the search parameter. */
    public SearchParameterBuilder.Impl withModifier(
        @NonNull Collection<SEARCH_MODIFIER_CODE> modifier) {
     ...
     */
    public SearchParameterBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     their own independent transaction scope.
     */
    public SearchParameterBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
      this.contained = Collections.unmodifiableCollection(contained);
      return this;
    }

    public SearchParameterBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public SearchParameterBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public SearchParameterBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public SearchParameterBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
     ...
     *     parameter.
     */
    public SearchParameterBuilder.Impl withPublisher(@NonNull String publisher) {
     ...
     */
    public SearchParameterBuilder.Impl withUseContext(@NonNull UsageContext... useContext) {
     ...
     *     assist with indexing and searching for appropriate search parameter instances.
     */
    public SearchParameterBuilder.Impl withUseContext(
        @NonNull Collection<UsageContext> useContext) {
      this.useContext = Collections.unmodifiableCollection(useContext);
      return this;
    }

    public SearchParameterBuilder.Impl withUseContext(@NonNull UsageContextBuilder... useContext) {
     ...
     *     parameter.
     */
    public SearchParameterBuilder.Impl withExpression(@NonNull String expression) {
     ...
     */
    public SearchParameterBuilder.Impl withXpathUsage(@NonNull SEARCH_XPATH_USAGE xpathUsage) {
     ...
     */
    public SearchParameterBuilder.Impl withMultipleOr(@NonNull Boolean multipleOr) {
      this.multipleOr = Optional.of(multipleOr);
      return this;
    }
    /** @param comparator - Comparators supported for the search parameter. */
    public SearchParameterBuilder.Impl withComparator(@NonNull SEARCH_COMPARATOR... comparator) {
      this.comparator = Arrays.asList(comparator);
      return this;
    }
    /** @param comparator - Comparators supported for the search parameter. */
    public SearchParameterBuilder.Impl withComparator(
        @NonNull Collection<SEARCH_COMPARATOR> comparator) {
     ...
     */
    public SearchParameterBuilder.Impl withDerivedFrom(@NonNull String derivedFrom) {
     ...
     */
    public SearchParameterBuilder.Impl withMultipleAnd(@NonNull Boolean multipleAnd) {
     ...
     *     genuine usage.
     */
    public SearchParameterBuilder.Impl withExperimental(@NonNull Boolean experimental) {
      this.experimental = Optional.of(experimental);
      return this;
    }
    /**
     * @param jurisdiction - A legal or geographic region in which the search parameter is intended
     *     to be used.
     */
    public SearchParameterBuilder.Impl withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
     ...
     *     to be used.
     */
    public SearchParameterBuilder.Impl withJurisdiction(
     ...
     *     profiles etc.
     */
    public SearchParameterBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public SearchParameterBuilder.Impl withModifierExtension(
    ...
    public SearchParameterBuilder.Impl withComponent(
        @NonNull SearchParameter.Component... component) {
    ...
    public SearchParameterBuilder.Impl withComponent(
        @NonNull SearchParameter_ComponentBuilder... component) {
