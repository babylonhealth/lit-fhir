...
public class GroupBuilder {
   ...
   */
  public GroupBuilder(GROUP_TYPE _type, Boolean actual) {
    this._type = _type;
    this.actual = actual;
  }
   ...
   */
  public GroupBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public GroupBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public GroupBuilder withText(@NonNull Narrative text) {
   ...
   *     etc.
   */
  public GroupBuilder withCode(@NonNull CodeableConcept code) {
    this.code = Optional.of(code);
    return this;
  }
  /** @param name - A label assigned to the group for human identification and communication. */
  public GroupBuilder withName(@NonNull String name) {
   ...
   */
  public GroupBuilder withActive(@NonNull Boolean active) {
    this.active = Optional.of(active);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public GroupBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param quantity - A count of the number of resource instances that are part of the group. */
  public GroupBuilder withQuantity(@NonNull Integer quantity) {
   ...
   */
  public GroupBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public GroupBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public GroupBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public GroupBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param identifier - A unique business identifier for this group. */
  public GroupBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique business identifier for this group. */
  public GroupBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   *     profiles etc.
   */
  public GroupBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public GroupBuilder withManagingEntity(@NonNull Reference managingEntity) {
   ...
   */
  public GroupBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public GroupBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param member - Identifies the resource instances that are members of the group. */
  public GroupBuilder withMember(@NonNull Group.Member... member) {
    this.member = Arrays.asList(member);
    return this;
  }
  /** @param member - Identifies the resource instances that are members of the group. */
  public GroupBuilder withMember(@NonNull Collection<Group.Member> member) {
   ...
   *     group.
   */
  public GroupBuilder withCharacteristic(@NonNull Group.Characteristic... characteristic) {
   ...
   *     group.
   */
  public GroupBuilder withCharacteristic(@NonNull Collection<Group.Characteristic> characteristic) {
