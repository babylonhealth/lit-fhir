...
public interface DocumentReference_ContentBuilder {
  public DocumentReference.Content build();

  public static Impl init(Attachment attachment) {
  ...
  public class Impl implements DocumentReference_ContentBuilder {
     ...
     * @param attachment
     */
    public Impl(Attachment attachment) {
     ...
     */
    public DocumentReference_ContentBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param format */
    public DocumentReference_ContentBuilder.Impl withFormat(@NonNull Coding format) {
     ...
     */
    public DocumentReference_ContentBuilder.Impl withExtension(@NonNull Extension... extension) {
