...
public class CompositionBuilder {
  ...
  /**
   * Required fields for {@link Composition}
   *
   ...
   */
  public CompositionBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public CompositionBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public CompositionBuilder withText(@NonNull Narrative text) {
   ...
   *     exposure).
   */
  public CompositionBuilder withSubject(@NonNull Reference subject) {
    this.subject = Optional.of(subject);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public CompositionBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   *     Type.
   */
  public CompositionBuilder withCategory(@NonNull CodeableConcept... category) {
   ...
   *     Type.
   */
  public CompositionBuilder withCategory(@NonNull Collection<CodeableConcept> category) {
   ...
   */
  public CompositionBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public CompositionBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public CompositionBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public CompositionBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     associated with.
   */
  public CompositionBuilder withEncounter(@NonNull Reference encounter) {
   ...
   */
  public CompositionBuilder withCustodian(@NonNull Reference custodian) {
   ...
   */
  public CompositionBuilder withIdentifier(@NonNull Identifier identifier) {
   ...
   *     profiles etc.
   */
  public CompositionBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public CompositionBuilder withConfidentiality(
   ...
   */
  public CompositionBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public CompositionBuilder withModifierExtension(
   ...
   *     documented.
   */
  public CompositionBuilder withEvent(@NonNull Composition.Event... event) {
   ...
   *     documented.
   */
  public CompositionBuilder withEvent(@NonNull Collection<Composition.Event> event) {
    this.event = Collections.unmodifiableCollection(event);
    return this;
  }
  /** @param section - The root of the sections that make up the composition. */
  public CompositionBuilder withSection(@NonNull Composition.Section... section) {
    this.section = Arrays.asList(section);
    return this;
  }
  /** @param section - The root of the sections that make up the composition. */
  public CompositionBuilder withSection(@NonNull Collection<Composition.Section> section) {
   ...
   */
  public CompositionBuilder withAttester(@NonNull Composition.Attester... attester) {
   ...
   * @param attester - A participant who has attested to the accuracy of the composition/document.
   */
  public CompositionBuilder withAttester(@NonNull Collection<Composition.Attester> attester) {
   ...
   *     that already exist.
   */
  public CompositionBuilder withRelatesTo(@NonNull Composition.RelatesTo... relatesTo) {
   ...
   *     that already exist.
   */
  public CompositionBuilder withRelatesTo(@NonNull Collection<Composition.RelatesTo> relatesTo) {
