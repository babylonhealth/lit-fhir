...
public interface CompositionBuilder extends DomainResourceBuilder {
  ...
  public class Impl implements CompositionBuilder {
     ...
     */
    public CompositionBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public CompositionBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     */
    public CompositionBuilder.Impl withText(@NonNull Narrative text) {
    ...
    public CompositionBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     *     Type.
     */
    public CompositionBuilder.Impl withCategory(@NonNull CodeableConcept... category) {
     ...
     *     Type.
     */
    public CompositionBuilder.Impl withCategory(@NonNull Collection<CodeableConcept> category) {
     ...
     */
    public CompositionBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public CompositionBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
     ...
     */
    public CompositionBuilder.Impl withCustodian(@NonNull Reference custodian) {
     ...
     *     profiles etc.
     */
    public CompositionBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public CompositionBuilder.Impl withModifierExtension(@NonNull Extension... modifierExtension) {
     ...
     *     documented.
     */
    public CompositionBuilder.Impl withEvent(@NonNull Composition.Event... event) {
     ...
     *     documented.
     */
    public CompositionBuilder.Impl withEvent(@NonNull Collection<Composition.Event> event) {
     ...
     */
    public CompositionBuilder.Impl withAttester(@NonNull Composition.Attester... attester) {
     ...
     * @param attester - A participant who has attested to the accuracy of the composition/document.
     */
    public CompositionBuilder.Impl withAttester(
     ...
     */
    public CompositionBuilder.Impl withRelatesTo(@NonNull Composition.RelatesTo... relatesTo) {
