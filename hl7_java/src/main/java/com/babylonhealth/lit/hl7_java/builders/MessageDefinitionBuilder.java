...
public interface MessageDefinitionBuilder extends DomainResourceBuilder {
  ...
  public static Impl init(
      FHIRDateTime date, PUBLICATION_STATUS status, @NonNull ChoiceCodingOrUriStr event) {
  ...
  public class Impl implements MessageDefinitionBuilder {
     ...
     */
    public Impl(FHIRDateTime date, PUBLICATION_STATUS status, @NonNull ChoiceCodingOrUriStr event) {
      this.date = date;
      this.status = status;
      this.event = event;
    }
