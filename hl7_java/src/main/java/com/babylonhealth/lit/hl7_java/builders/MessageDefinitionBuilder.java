...
public class MessageDefinitionBuilder {
   ...
   */
  public MessageDefinitionBuilder withId(@NonNull String id) {
   ...
   */
  public MessageDefinitionBuilder withUrl(@NonNull String url) {
   ...
   *     to the resource.
   */
  public MessageDefinitionBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public MessageDefinitionBuilder withText(@NonNull Narrative text) {
   ...
   *     resources are to be added to the bundle when building the document. The GraphDefinition can
   *     also specify profiles that apply to the various resources.
   */
  public MessageDefinitionBuilder withGraph(@NonNull String... graph) {
   ...
   *     also specify profiles that apply to the various resources.
   */
  public MessageDefinitionBuilder withGraph(@NonNull Collection<String> graph) {
    this.graph = Collections.unmodifiableCollection(graph);
    return this;
  }
  /**
   * @param parent - Identifies a protocol or workflow that this MessageDefinition represents a step
   *     in.
   */
  public MessageDefinitionBuilder withParent(@NonNull String... parent) {
   ...
   *     in.
   */
  public MessageDefinitionBuilder withParent(@NonNull Collection<String> parent) {
   ...
   *     value managed by the message definition author and is not expected to be globally unique.
   ...
   */
  public MessageDefinitionBuilder withVersion(@NonNull String version) {
   ...
   *     publisher.
   */
  public MessageDefinitionBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public MessageDefinitionBuilder withContact(@NonNull Collection<ContactDetail> contact) {
   ...
   *     designed as it has.
   */
  public MessageDefinitionBuilder withPurpose(@NonNull String purpose) {
    this.purpose = Optional.of(purpose);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public MessageDefinitionBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param replaces - A MessageDefinition that is superseded by this definition. */
  public MessageDefinitionBuilder withReplaces(@NonNull String... replaces) {
    this.replaces = Arrays.asList(replaces);
    return this;
  }
  /** @param replaces - A MessageDefinition that is superseded by this definition. */
  public MessageDefinitionBuilder withReplaces(@NonNull Collection<String> replaces) {
    this.replaces = Collections.unmodifiableCollection(replaces);
    return this;
  }
  /** @param category - The impact of the content of the message. */
  public MessageDefinitionBuilder withCategory(@NonNull MESSAGE_SIGNIFICANCE_CATEGORY category) {
   ...
   */
  public MessageDefinitionBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public MessageDefinitionBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public MessageDefinitionBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public MessageDefinitionBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     definition.
   */
  public MessageDefinitionBuilder withPublisher(@NonNull String publisher) {
   ...
   */
  public MessageDefinitionBuilder withCopyright(@NonNull String copyright) {
   ...
   *     instance.
   */
  public MessageDefinitionBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     instance.
   */
  public MessageDefinitionBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public MessageDefinitionBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate message definition instances.
   */
  public MessageDefinitionBuilder withUseContext(@NonNull Collection<UsageContext> useContext) {
   ...
   */
  public MessageDefinitionBuilder withDescription(@NonNull String description) {
   ...
   *     genuine usage.
   */
  public MessageDefinitionBuilder withExperimental(@NonNull Boolean experimental) {
    this.experimental = Optional.of(experimental);
    return this;
  }
  /**
   * @param jurisdiction - A legal or geographic region in which the message definition is intended
   *     to be used.
   */
  public MessageDefinitionBuilder withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
   ...
   *     to be used.
   */
  public MessageDefinitionBuilder withJurisdiction(
   ...
   *     profiles etc.
   */
  public MessageDefinitionBuilder withImplicitRules(@NonNull String implicitRules) {
    this.implicitRules = Optional.of(implicitRules);
    return this;
  }
  /**
   * @param responseRequired - Declare at a message definition level whether a response is required
   *     or only upon error or success, or never.
   */
  public MessageDefinitionBuilder withResponseRequired(
   ...
   */
  public MessageDefinitionBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public MessageDefinitionBuilder withModifierExtension(
   ...
   */
  public MessageDefinitionBuilder withFocus(@NonNull MessageDefinition.Focus... focus) {
   ...
   *     For example, the Encounter for an admit message or two Account records for a merge.
   */
  public MessageDefinitionBuilder withFocus(@NonNull Collection<MessageDefinition.Focus> focus) {
   ...
   */
  public MessageDefinitionBuilder withAllowedResponse(
