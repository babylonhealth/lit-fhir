...
public class OperationOutcome_IssueBuilder {
   ...
   * @param severity
   */
  public OperationOutcome_IssueBuilder(ISSUE_TYPE code, ISSUE_SEVERITY severity) {
    this.code = code;
   ...
   */
  public OperationOutcome_IssueBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param details */
  public OperationOutcome_IssueBuilder withDetails(@NonNull CodeableConcept details) {
    this.details = Optional.of(details);
    return this;
  }
  /** @param location */
  public OperationOutcome_IssueBuilder withLocation(@NonNull String... location) {
    this.location = Arrays.asList(location);
    return this;
  }
  /** @param location */
  public OperationOutcome_IssueBuilder withLocation(@NonNull Collection<String> location) {
   ...
   */
  public OperationOutcome_IssueBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public OperationOutcome_IssueBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param expression */
  public OperationOutcome_IssueBuilder withExpression(@NonNull String... expression) {
    this.expression = Arrays.asList(expression);
    return this;
  }
  /** @param expression */
  public OperationOutcome_IssueBuilder withExpression(@NonNull Collection<String> expression) {
    this.expression = Collections.unmodifiableCollection(expression);
    return this;
  }
  /** @param diagnostics */
  public OperationOutcome_IssueBuilder withDiagnostics(@NonNull String diagnostics) {
   ...
   */
  public OperationOutcome_IssueBuilder withModifierExtension(
