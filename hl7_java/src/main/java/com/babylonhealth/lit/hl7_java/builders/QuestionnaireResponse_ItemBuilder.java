...
public class QuestionnaireResponse_ItemBuilder {
   ...
   * @param linkId
   */
  public QuestionnaireResponse_ItemBuilder(String linkId) {
    this.linkId = linkId;
  }
   ...
   */
  public QuestionnaireResponse_ItemBuilder withId(@NonNull String id) {
   ...
   */
  public QuestionnaireResponse_ItemBuilder withText(@NonNull String text) {
   ...
   *     provided.
   */
  public QuestionnaireResponse_ItemBuilder withItem(@NonNull QuestionnaireResponse.Item... item) {
   ...
   *     provided.
   */
  public QuestionnaireResponse_ItemBuilder withItem(
   ...
   */
  public QuestionnaireResponse_ItemBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public QuestionnaireResponse_ItemBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param definition */
  public QuestionnaireResponse_ItemBuilder withDefinition(@NonNull String definition) {
   ...
   */
  public QuestionnaireResponse_ItemBuilder withModifierExtension(
  ...
  /** @param answer */
  public QuestionnaireResponse_ItemBuilder withAnswer(
