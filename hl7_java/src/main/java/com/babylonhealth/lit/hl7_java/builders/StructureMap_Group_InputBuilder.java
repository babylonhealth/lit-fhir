...
public interface StructureMap_Group_InputBuilder {
  public StructureMap$Group$Input build();

  public static Impl init(String name, MAP_INPUT_MODE mode) {
  ...
  public class Impl implements StructureMap_Group_InputBuilder {
     ...
     * @param mode
     */
    public Impl(String name, MAP_INPUT_MODE mode) {
      this.name = name;
      this.mode = mode;
    }
     ...
     */
    public StructureMap_Group_InputBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param _type */
    public StructureMap_Group_InputBuilder.Impl withType(@NonNull String _type) {
     ...
     */
    public StructureMap_Group_InputBuilder.Impl withExtension(@NonNull Extension... extension) {
