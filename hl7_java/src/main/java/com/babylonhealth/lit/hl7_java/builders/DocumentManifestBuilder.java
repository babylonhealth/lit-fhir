...
public class DocumentManifestBuilder {
   ...
   */
  public DocumentManifestBuilder(DOCUMENT_REFERENCE_STATUS status, Collection<Reference> content) {
    this.status = status;
   ...
   */
  public DocumentManifestBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public DocumentManifestBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public DocumentManifestBuilder withText(@NonNull Narrative text) {
   ...
   */
  public DocumentManifestBuilder withType(@NonNull CodeableConcept _type) {
    this._type = Optional.of(_type);
    return this;
  }
  /**
   * @param author - Identifies who is the author of the manifest. Manifest author is not necessarly
   *     the author of the references included.
   */
  public DocumentManifestBuilder withAuthor(@NonNull Reference... author) {
   ...
   *     the author of the references included.
   */
  public DocumentManifestBuilder withAuthor(@NonNull Collection<Reference> author) {
   ...
   *     document manifest.
   */
  public DocumentManifestBuilder withSource(@NonNull String source) {
   ...
   *     subjects (such as a document about a herd of farm animals, or a set of patients that share
   *     a common exposure). If the documents cross more than one subject, then more than one
   *     subject is allowed here (unusual use case).
   */
  public DocumentManifestBuilder withSubject(@NonNull Reference subject) {
   ...
   */
  public DocumentManifestBuilder withCreated(@NonNull FHIRDateTime created) {
    this.created = Optional.of(created);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public DocumentManifestBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public DocumentManifestBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public DocumentManifestBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public DocumentManifestBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public DocumentManifestBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     intended.
   */
  public DocumentManifestBuilder withRecipient(@NonNull Reference... recipient) {
   ...
   *     intended.
   */
  public DocumentManifestBuilder withRecipient(@NonNull Collection<Reference> recipient) {
   ...
   */
  public DocumentManifestBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     independent identifiers.
   */
  public DocumentManifestBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
    this.identifier = Collections.unmodifiableCollection(identifier);
    return this;
  }
  /**
   * @param description - Human-readable description of the source document. This is sometimes known
   *     as the "title".
   */
  public DocumentManifestBuilder withDescription(@NonNull String description) {
   ...
   *     profiles etc.
   */
  public DocumentManifestBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public DocumentManifestBuilder withMasterIdentifier(@NonNull Identifier masterIdentifier) {
   ...
   */
  public DocumentManifestBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public DocumentManifestBuilder withModifierExtension(
      @NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param related - Related identifiers or resources associated with the DocumentManifest. */
  public DocumentManifestBuilder withRelated(@NonNull DocumentManifest.Related... related) {
    this.related = Arrays.asList(related);
    return this;
  }
  /** @param related - Related identifiers or resources associated with the DocumentManifest. */
  public DocumentManifestBuilder withRelated(
