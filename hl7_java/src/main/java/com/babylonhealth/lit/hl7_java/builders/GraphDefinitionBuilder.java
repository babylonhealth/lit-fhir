...
public class GraphDefinitionBuilder {
   ...
   *     content.
   */
  public GraphDefinitionBuilder(String name, RESOURCE_TYPES start, PUBLICATION_STATUS status) {
    this.name = name;
    this.start = start;
    this.status = status;
  }
   ...
   */
  public GraphDefinitionBuilder withId(@NonNull String id) {
   ...
   */
  public GraphDefinitionBuilder withUrl(@NonNull String url) {
   ...
   *     to the resource.
   */
  public GraphDefinitionBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public GraphDefinitionBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /**
   * @param date - The date (and optionally time) when the graph definition was published. The date
   ...
   *     changes.
   */
  public GraphDefinitionBuilder withDate(@NonNull FHIRDateTime date) {
   ...
   *     value managed by the graph definition author and is not expected to be globally unique. For
   ...
   */
  public GraphDefinitionBuilder withVersion(@NonNull String version) {
   ...
   *     publisher.
   */
  public GraphDefinitionBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public GraphDefinitionBuilder withContact(@NonNull Collection<ContactDetail> contact) {
   ...
   *     designed as it has.
   */
  public GraphDefinitionBuilder withPurpose(@NonNull String purpose) {
    this.purpose = Optional.of(purpose);
    return this;
  }
  /** @param profile - The profile that describes the use of the base resource. */
  public GraphDefinitionBuilder withProfile(@NonNull String profile) {
    this.profile = Optional.of(profile);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public GraphDefinitionBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public GraphDefinitionBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public GraphDefinitionBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public GraphDefinitionBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public GraphDefinitionBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     definition.
   */
  public GraphDefinitionBuilder withPublisher(@NonNull String publisher) {
   ...
   */
  public GraphDefinitionBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate graph definition instances.
   */
  public GraphDefinitionBuilder withUseContext(@NonNull Collection<UsageContext> useContext) {
   ...
   */
  public GraphDefinitionBuilder withDescription(@NonNull String description) {
   ...
   *     genuine usage.
   */
  public GraphDefinitionBuilder withExperimental(@NonNull Boolean experimental) {
    this.experimental = Optional.of(experimental);
    return this;
  }
  /**
   * @param jurisdiction - A legal or geographic region in which the graph definition is intended to
   *     be used.
   */
  public GraphDefinitionBuilder withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
   ...
   *     be used.
   */
  public GraphDefinitionBuilder withJurisdiction(
   ...
   *     profiles etc.
   */
  public GraphDefinitionBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public GraphDefinitionBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public GraphDefinitionBuilder withModifierExtension(
      @NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param link - Links this graph makes rules about. */
  public GraphDefinitionBuilder withLink(@NonNull GraphDefinition.Link... link) {
    this.link = Arrays.asList(link);
    return this;
  }
  /** @param link - Links this graph makes rules about. */
  public GraphDefinitionBuilder withLink(@NonNull Collection<GraphDefinition.Link> link) {
