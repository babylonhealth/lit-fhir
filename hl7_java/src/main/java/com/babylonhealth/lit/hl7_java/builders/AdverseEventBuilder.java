...
public class AdverseEventBuilder {
   ...
   */
  public AdverseEventBuilder(Reference subject, ADVERSE_EVENT_ACTUALITY actuality) {
   ...
   */
  public AdverseEventBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public AdverseEventBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public AdverseEventBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param date - The date (and perhaps time) when the adverse event occurred. */
  public AdverseEventBuilder withDate(@NonNull FHIRDateTime date) {
   ...
   */
  public AdverseEventBuilder withEvent(@NonNull CodeableConcept event) {
    this.event = Optional.of(event);
    return this;
  }
  /** @param study - AdverseEvent.study. */
  public AdverseEventBuilder withStudy(@NonNull Reference... study) {
    this.study = Arrays.asList(study);
    return this;
  }
  /** @param study - AdverseEvent.study. */
  public AdverseEventBuilder withStudy(@NonNull Collection<Reference> study) {
    this.study = Collections.unmodifiableCollection(study);
    return this;
  }
  /** @param outcome - Describes the type of outcome from the adverse event. */
  public AdverseEventBuilder withOutcome(@NonNull CodeableConcept outcome) {
    this.outcome = Optional.of(outcome);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public AdverseEventBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param category - The overall type of event, intended for search and filtering purposes. */
  public AdverseEventBuilder withCategory(@NonNull CodeableConcept... category) {
    this.category = Arrays.asList(category);
    return this;
  }
  /** @param category - The overall type of event, intended for search and filtering purposes. */
  public AdverseEventBuilder withCategory(@NonNull Collection<CodeableConcept> category) {
   ...
   *     reporter.
   */
  public AdverseEventBuilder withDetected(@NonNull FHIRDateTime detected) {
    this.detected = Optional.of(detected);
    return this;
  }
  /** @param location - The information about where the adverse event occurred. */
  public AdverseEventBuilder withLocation(@NonNull Reference location) {
    this.location = Optional.of(location);
    return this;
  }
  /**
   * @param severity - Describes the severity of the adverse event, in relation to the subject.
   *     Contrast to AdverseEvent.seriousness - a severe rash might not be serious, but a mild heart
   *     problem is.
   */
  public AdverseEventBuilder withSeverity(@NonNull CodeableConcept severity) {
   ...
   *     practitioner.
   */
  public AdverseEventBuilder withRecorder(@NonNull Reference recorder) {
   ...
   */
  public AdverseEventBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public AdverseEventBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public AdverseEventBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public AdverseEventBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public AdverseEventBuilder withEncounter(@NonNull Reference encounter) {
   ...
   *     to server.
   */
  public AdverseEventBuilder withIdentifier(@NonNull Identifier identifier) {
    this.identifier = Optional.of(identifier);
    return this;
  }
  /** @param seriousness - Assessment whether this event was of real importance. */
  public AdverseEventBuilder withSeriousness(@NonNull CodeableConcept seriousness) {
   ...
   *     information leading to the decision to perform the activity and how to perform the activity
   *     (e.g. consultant), information that the activity itself seeks to reveal (e.g. informant of
   *     clinical history), or information about what activity was performed (e.g. informant
   *     witness).
   */
  public AdverseEventBuilder withContributor(@NonNull Reference... contributor) {
   ...
   *     witness).
   */
  public AdverseEventBuilder withContributor(@NonNull Collection<Reference> contributor) {
   ...
   */
  public AdverseEventBuilder withRecordedDate(@NonNull FHIRDateTime recordedDate) {
   ...
   *     profiles etc.
   */
  public AdverseEventBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public AdverseEventBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public AdverseEventBuilder withModifierExtension(
      @NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param referenceDocument - AdverseEvent.referenceDocument. */
  public AdverseEventBuilder withReferenceDocument(@NonNull Reference... referenceDocument) {
    this.referenceDocument = Arrays.asList(referenceDocument);
    return this;
  }
  /** @param referenceDocument - AdverseEvent.referenceDocument. */
  public AdverseEventBuilder withReferenceDocument(
   ...
   */
  public AdverseEventBuilder withResultingCondition(@NonNull Reference... resultingCondition) {
   ...
   *     of exposure to a substance (for example, a drug or a chemical).
   */
  public AdverseEventBuilder withResultingCondition(
  ...
  public AdverseEventBuilder withSubjectMedicalHistory(
   ...
   */
  public AdverseEventBuilder withSuspectEntity(
