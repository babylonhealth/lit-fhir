...
public class AdverseEvent_SuspectEntityBuilder {
   ...
   * @param instance
   */
  public AdverseEvent_SuspectEntityBuilder(Reference instance) {
   ...
   */
  public AdverseEvent_SuspectEntityBuilder withId(@NonNull String id) {
   ...
   */
  public AdverseEvent_SuspectEntityBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public AdverseEvent_SuspectEntityBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public AdverseEvent_SuspectEntityBuilder withModifierExtension(
  ...
  /** @param causality */
  public AdverseEvent_SuspectEntityBuilder withCausality(
