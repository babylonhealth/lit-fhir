...
public interface PractitionerBuilder extends DomainResourceBuilder {
  ...
  public class Impl implements PractitionerBuilder {
     ...
     */
    public PractitionerBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public PractitionerBuilder.Impl withMeta(@NonNull Meta meta) {
    ...
    public PractitionerBuilder.Impl withName(@NonNull HumanName... name) {
      this.name = Arrays.asList(name);
      return this;
    }
    /** @param name - The name(s) associated with the practitioner. */
    public PractitionerBuilder.Impl withName(@NonNull Collection<HumanName> name) {
    ...
    public PractitionerBuilder.Impl withActive(@NonNull Boolean active) {
     ...
     */
    public PractitionerBuilder.Impl withGender(@NonNull ADMINISTRATIVE_GENDER gender) {
     ...
     *     address.
     */
    public PractitionerBuilder.Impl withTelecom(@NonNull ContactPoint... telecom) {
     ...
     *     address.
     */
    public PractitionerBuilder.Impl withTelecom(@NonNull Collection<ContactPoint> telecom) {
     ...
     *     role dependent.
     */
    public PractitionerBuilder.Impl withAddress(@NonNull Address... address) {
    ...
    public PractitionerBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public PractitionerBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public PractitionerBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
     ...
     */
    public PractitionerBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public PractitionerBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
    ...
    public PractitionerBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     *     profiles etc.
     */
    public PractitionerBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
      this.implicitRules = Optional.of(implicitRules);
      return this;
    }
    /** @param communication - A language the practitioner can use in patient communication. */
    public PractitionerBuilder.Impl withCommunication(@NonNull CodeableConcept... communication) {
     ...
     */
    public PractitionerBuilder.Impl withModifierExtension(@NonNull Extension... modifierExtension) {
