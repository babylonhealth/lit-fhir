...
public class PractitionerBuilder {
  ...
  /** Required fields for {@link Practitioner} */
   ...
   */
  public PractitionerBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public PractitionerBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public PractitionerBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param name - The name(s) associated with the practitioner. */
  public PractitionerBuilder withName(@NonNull HumanName... name) {
    this.name = Arrays.asList(name);
    return this;
  }
  /** @param name - The name(s) associated with the practitioner. */
  public PractitionerBuilder withName(@NonNull Collection<HumanName> name) {
    this.name = Collections.unmodifiableCollection(name);
    return this;
  }
  /** @param photo - Image of the person. */
  public PractitionerBuilder withPhoto(@NonNull Attachment... photo) {
    this.photo = Arrays.asList(photo);
    return this;
  }
  /** @param photo - Image of the person. */
  public PractitionerBuilder withPhoto(@NonNull Collection<Attachment> photo) {
    this.photo = Collections.unmodifiableCollection(photo);
    return this;
  }
  /** @param active - Whether this practitioner's record is in active use. */
  public PractitionerBuilder withActive(@NonNull Boolean active) {
   ...
   */
  public PractitionerBuilder withGender(@NonNull ADMINISTRATIVE_GENDER gender) {
   ...
   *     address.
   */
  public PractitionerBuilder withTelecom(@NonNull ContactPoint... telecom) {
   ...
   *     address.
   */
  public PractitionerBuilder withTelecom(@NonNull Collection<ContactPoint> telecom) {
   ...
   *     role dependent.
   */
  public PractitionerBuilder withAddress(@NonNull Address... address) {
   ...
   *     role dependent.
   */
  public PractitionerBuilder withAddress(@NonNull Collection<Address> address) {
    this.address = Collections.unmodifiableCollection(address);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public PractitionerBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public PractitionerBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public PractitionerBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public PractitionerBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public PractitionerBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param birthDate - The date of birth for the practitioner. */
  public PractitionerBuilder withBirthDate(@NonNull FHIRDate birthDate) {
    this.birthDate = Optional.of(birthDate);
    return this;
  }
  /** @param identifier - An identifier that applies to this person in this role. */
  public PractitionerBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - An identifier that applies to this person in this role. */
  public PractitionerBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   *     profiles etc.
   */
  public PractitionerBuilder withImplicitRules(@NonNull String implicitRules) {
    this.implicitRules = Optional.of(implicitRules);
    return this;
  }
  /** @param communication - A language the practitioner can use in patient communication. */
  public PractitionerBuilder withCommunication(@NonNull CodeableConcept... communication) {
    this.communication = Arrays.asList(communication);
    return this;
  }
  /** @param communication - A language the practitioner can use in patient communication. */
  public PractitionerBuilder withCommunication(@NonNull Collection<CodeableConcept> communication) {
   ...
   */
  public PractitionerBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public PractitionerBuilder withModifierExtension(
   ...
   *     license issued by a medical board authorizing the practitioner to practice medicine within
   *     a certian locality.
   */
  public PractitionerBuilder withQualification(
