...
public class AuditEvent_Entity_DetailBuilder {
   ...
   */
  public AuditEvent_Entity_DetailBuilder withId(@NonNull String id) {
   ...
   */
  public AuditEvent_Entity_DetailBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public AuditEvent_Entity_DetailBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public AuditEvent_Entity_DetailBuilder withModifierExtension(
