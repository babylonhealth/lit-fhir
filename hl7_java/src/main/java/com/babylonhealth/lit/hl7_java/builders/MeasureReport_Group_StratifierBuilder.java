...
public class MeasureReport_Group_StratifierBuilder {
  ...
  public MeasureReport_Group_StratifierBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public MeasureReport_Group_StratifierBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param code */
  public MeasureReport_Group_StratifierBuilder withCode(@NonNull CodeableConcept... code) {
    this.code = Arrays.asList(code);
    return this;
  }
  /** @param code */
  public MeasureReport_Group_StratifierBuilder withCode(@NonNull Collection<CodeableConcept> code) {
   ...
   */
  public MeasureReport_Group_StratifierBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public MeasureReport_Group_StratifierBuilder withExtension(
   ...
   */
  public MeasureReport_Group_StratifierBuilder withModifierExtension(
  ...
  /** @param stratum */
  public MeasureReport_Group_StratifierBuilder withStratum(
