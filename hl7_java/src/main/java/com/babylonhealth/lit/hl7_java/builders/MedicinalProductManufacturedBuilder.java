...
public class MedicinalProductManufacturedBuilder {
   ...
   */
  public MedicinalProductManufacturedBuilder(
      Quantity quantity, CodeableConcept manufacturedDoseForm) {
   ...
   */
  public MedicinalProductManufacturedBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public MedicinalProductManufacturedBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public MedicinalProductManufacturedBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public MedicinalProductManufacturedBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public MedicinalProductManufacturedBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public MedicinalProductManufacturedBuilder withContained(
   ...
   */
  public MedicinalProductManufacturedBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public MedicinalProductManufacturedBuilder withExtension(
      @NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param ingredient - Ingredient. */
  public MedicinalProductManufacturedBuilder withIngredient(@NonNull Reference... ingredient) {
    this.ingredient = Arrays.asList(ingredient);
    return this;
  }
  /** @param ingredient - Ingredient. */
  public MedicinalProductManufacturedBuilder withIngredient(
   ...
   */
  public MedicinalProductManufacturedBuilder withManufacturer(@NonNull Reference... manufacturer) {
   ...
   *     but it currently causes technical issues).
   */
  public MedicinalProductManufacturedBuilder withManufacturer(
   ...
   *     profiles etc.
   */
  public MedicinalProductManufacturedBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public MedicinalProductManufacturedBuilder withModifierExtension(
   ...
   *     item is described.
   */
  public MedicinalProductManufacturedBuilder withUnitOfPresentation(
  ...
  public MedicinalProductManufacturedBuilder withOtherCharacteristics(
  ...
  public MedicinalProductManufacturedBuilder withPhysicalCharacteristics(
  ...
  public MedicinalProductManufactured build() {
    return new MedicinalProductManufactured(
        ...
        (Option) OptionConverters.toScala(unitOfPresentation),
