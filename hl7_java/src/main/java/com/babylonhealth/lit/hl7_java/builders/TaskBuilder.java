...
public class TaskBuilder {
   ...
   */
  public TaskBuilder(TASK_STATUS status, TASK_INTENT intent) {
    this.status = status;
    this.intent = intent;
  }
   ...
   */
  public TaskBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /**
   * @param _for - The entity who benefits from the performance of the service specified in the task
   *     (e.g., the patient).
   */
  public TaskBuilder withFor(@NonNull Reference _for) {
   ...
   *     to the resource.
   */
  public TaskBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public TaskBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param code - A name or code (or both) briefly describing what the task involves. */
  public TaskBuilder withCode(@NonNull CodeableConcept code) {
    this.code = Optional.of(code);
    return this;
  }
  /** @param note - Free-text information captured about the task as it progresses. */
  public TaskBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Free-text information captured about the task as it progresses. */
  public TaskBuilder withNote(@NonNull Collection<Annotation> note) {
    this.note = Collections.unmodifiableCollection(note);
    return this;
  }
  /** @param focus - The request being actioned or the resource being manipulated by this task. */
  public TaskBuilder withFocus(@NonNull Reference focus) {
    this.focus = Optional.of(focus);
    return this;
  }
  /** @param owner - Individual organization or Device currently responsible for task execution. */
  public TaskBuilder withOwner(@NonNull Reference owner) {
    this.owner = Optional.of(owner);
    return this;
  }
  /** @param partOf - Task that this particular task is part of. */
  public TaskBuilder withPartOf(@NonNull Reference... partOf) {
    this.partOf = Arrays.asList(partOf);
    return this;
  }
  /** @param partOf - Task that this particular task is part of. */
  public TaskBuilder withPartOf(@NonNull Collection<Reference> partOf) {
    this.partOf = Collections.unmodifiableCollection(partOf);
    return this;
  }
  /**
   * @param basedOn - BasedOn refers to a higher-level authorization that triggered the creation of
   *     the task. It references a "request" resource such as a ServiceRequest, MedicationRequest,
   *     ServiceRequest, CarePlan, etc. which is distinct from the "request" resource the task is
   *     seeking to fulfill. This latter resource is referenced by FocusOn. For example, based on a
   *     ServiceRequest (= BasedOn), a task is created to fulfill a procedureRequest ( = FocusOn )
   *     to collect a specimen from a patient.
   */
  public TaskBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     to collect a specimen from a patient.
   */
  public TaskBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public TaskBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   *     requests.
   */
  public TaskBuilder withPriority(@NonNull REQUEST_PRIORITY priority) {
    this.priority = Optional.of(priority);
    return this;
  }
  /** @param location - Principal physical location where the this task is performed. */
  public TaskBuilder withLocation(@NonNull Reference location) {
   ...
   */
  public TaskBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public TaskBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public TaskBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public TaskBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public TaskBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param requester - The creator of the task. */
  public TaskBuilder withRequester(@NonNull Reference requester) {
   ...
   */
  public TaskBuilder withInsurance(@NonNull Reference... insurance) {
   ...
   *     pre-determinations that may be relevant to the Task.
   */
  public TaskBuilder withInsurance(@NonNull Collection<Reference> insurance) {
    this.insurance = Collections.unmodifiableCollection(insurance);
    return this;
  }
  /** @param identifier - The business identifier for this task. */
  public TaskBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - The business identifier for this task. */
  public TaskBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
    this.identifier = Collections.unmodifiableCollection(identifier);
    return this;
  }
  /** @param authoredOn - The date and time this task was created. */
  public TaskBuilder withAuthoredOn(@NonNull FHIRDateTime authoredOn) {
   ...
   *     profiles etc.
   */
  public TaskBuilder withImplicitRules(@NonNull String implicitRules) {
    this.implicitRules = Optional.of(implicitRules);
    return this;
  }
  /** @param performerType - The kind of participant that should perform the task. */
  public TaskBuilder withPerformerType(@NonNull CodeableConcept... performerType) {
    this.performerType = Arrays.asList(performerType);
    return this;
  }
  /** @param performerType - The kind of participant that should perform the task. */
  public TaskBuilder withPerformerType(@NonNull Collection<CodeableConcept> performerType) {
  ...
  public TaskBuilder withBusinessStatus(@NonNull CodeableConcept businessStatus) {
   ...
   */
  public TaskBuilder withInstantiatesUri(@NonNull String instantiatesUri) {
   ...
   */
  public TaskBuilder withGroupIdentifier(@NonNull Identifier groupIdentifier) {
   ...
   *     (end).
   */
  public TaskBuilder withExecutionPeriod(@NonNull Period executionPeriod) {
   ...
   */
  public TaskBuilder withReasonReference(@NonNull Reference reasonReference) {
   ...
   *     identify key state transitions or updates that are likely to be relevant to a user looking
   *     at the current version of the task.
   */
  public TaskBuilder withRelevantHistory(@NonNull Reference... relevantHistory) {
   ...
   *     at the current version of the task.
   */
  public TaskBuilder withRelevantHistory(@NonNull Collection<Reference> relevantHistory) {
   ...
   */
  public TaskBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public TaskBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
   ...
   *     orderset or other definition that is adhered to in whole or in part by this Task.
   */
  public TaskBuilder withInstantiatesCanonical(@NonNull String instantiatesCanonical) {
  ...
  public TaskBuilder withInput(@NonNull Task.Input... input) {
    this.input = Arrays.asList(input);
    return this;
  }
  /** @param input - Additional information that may be needed in the execution of the task. */
  public TaskBuilder withInput(@NonNull Collection<Task.Input> input) {
    this.input = Collections.unmodifiableCollection(input);
    return this;
  }
  /** @param output - Outputs produced by the Task. */
  public TaskBuilder withOutput(@NonNull Task.Output... output) {
    this.output = Arrays.asList(output);
    return this;
  }
  /** @param output - Outputs produced by the Task. */
  public TaskBuilder withOutput(@NonNull Collection<Task.Output> output) {
   ...
   */
  public TaskBuilder withRestriction(@NonNull Task.Restriction restriction) {
