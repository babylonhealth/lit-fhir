...
public class LibraryBuilder {
   ...
   */
  public LibraryBuilder withId(@NonNull String id) {
   ...
   *     different servers.
   */
  public LibraryBuilder withUrl(@NonNull String url) {
   ...
   *     to the resource.
   */
  public LibraryBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public LibraryBuilder withText(@NonNull Narrative text) {
   ...
   */
  public LibraryBuilder withName(@NonNull String name) {
   ...
   */
  public LibraryBuilder withDate(@NonNull FHIRDateTime date) {
    this.date = Optional.of(date);
    return this;
  }
  /** @param title - A short, descriptive, user-friendly title for the library. */
  public LibraryBuilder withTitle(@NonNull String title) {
   ...
   */
  public LibraryBuilder withUsage(@NonNull String usage) {
   ...
   */
  public LibraryBuilder withTopic(@NonNull CodeableConcept... topic) {
   ...
   *     high-level categorization of the library that can be useful for filtering and searching.
   */
  public LibraryBuilder withTopic(@NonNull Collection<CodeableConcept> topic) {
   ...
   */
  public LibraryBuilder withAuthor(@NonNull ContactDetail... author) {
   ...
   *     maintenance of the content.
   */
  public LibraryBuilder withAuthor(@NonNull Collection<ContactDetail> author) {
   ...
   *     the content.
   */
  public LibraryBuilder withEditor(@NonNull ContactDetail... editor) {
   ...
   *     the content.
   */
  public LibraryBuilder withEditor(@NonNull Collection<ContactDetail> editor) {
   ...
   */
  public LibraryBuilder withVersion(@NonNull String version) {
   ...
   *     publisher.
   */
  public LibraryBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public LibraryBuilder withContact(@NonNull Collection<ContactDetail> contact) {
   ...
   *     has.
   */
  public LibraryBuilder withPurpose(@NonNull String purpose) {
   ...
   */
  public LibraryBuilder withContent(@NonNull Attachment... content) {
   ...
   *     attachment determines how to interpret the content.
   */
  public LibraryBuilder withContent(@NonNull Collection<Attachment> content) {
    this.content = Collections.unmodifiableCollection(content);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public LibraryBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public LibraryBuilder withSubtitle(@NonNull String subtitle) {
   ...
   *     of the content.
   */
  public LibraryBuilder withReviewer(@NonNull ContactDetail... reviewer) {
   ...
   *     of the content.
   */
  public LibraryBuilder withReviewer(@NonNull Collection<ContactDetail> reviewer) {
   ...
   */
  public LibraryBuilder withEndorser(@NonNull ContactDetail... endorser) {
   ...
   *     content for use in some setting.
   */
  public LibraryBuilder withEndorser(@NonNull Collection<ContactDetail> endorser) {
   ...
   */
  public LibraryBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public LibraryBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public LibraryBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public LibraryBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param publisher - The name of the organization or individual that published the library. */
  public LibraryBuilder withPublisher(@NonNull String publisher) {
   ...
   */
  public LibraryBuilder withCopyright(@NonNull String copyright) {
    this.copyright = Optional.of(copyright);
    return this;
  }
  /** @param parameter - The parameter element defines parameters used by the library. */
  public LibraryBuilder withParameter(@NonNull ParameterDefinition... parameter) {
    this.parameter = Arrays.asList(parameter);
    return this;
  }
  /** @param parameter - The parameter element defines parameters used by the library. */
  public LibraryBuilder withParameter(@NonNull Collection<ParameterDefinition> parameter) {
   ...
   */
  public LibraryBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     identifier is required for non-experimental active artifacts.
   */
  public LibraryBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public LibraryBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate library instances.
   */
  public LibraryBuilder withUseContext(@NonNull Collection<UsageContext> useContext) {
   ...
   *     perspective.
   */
  public LibraryBuilder withDescription(@NonNull String description) {
   ...
   *     usage.
   */
  public LibraryBuilder withExperimental(@NonNull Boolean experimental) {
   ...
   */
  public LibraryBuilder withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
   ...
   * @param jurisdiction - A legal or geographic region in which the library is intended to be used.
   */
  public LibraryBuilder withJurisdiction(@NonNull Collection<CodeableConcept> jurisdiction) {
   ...
   */
  public LibraryBuilder withApprovalDate(@NonNull FHIRDate approvalDate) {
   ...
   *     profiles etc.
   */
  public LibraryBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public LibraryBuilder withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
   ...
   *     active use.
   */
  public LibraryBuilder withEffectivePeriod(@NonNull Period effectivePeriod) {
   ...
   */
  public LibraryBuilder withRelatedArtifact(@NonNull RelatedArtifact... relatedArtifact) {
   ...
   *     bibliographic references.
   */
  public LibraryBuilder withRelatedArtifact(@NonNull Collection<RelatedArtifact> relatedArtifact) {
   ...
   */
  public LibraryBuilder withDataRequirement(@NonNull DataRequirement... dataRequirement) {
   ...
   *     successfully perform the computations defined by the library.
   */
  public LibraryBuilder withDataRequirement(@NonNull Collection<DataRequirement> dataRequirement) {
   ...
   */
  public LibraryBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public LibraryBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
