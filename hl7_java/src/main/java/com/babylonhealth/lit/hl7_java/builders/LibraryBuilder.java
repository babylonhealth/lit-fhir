...
public interface LibraryBuilder extends MetadataResourceBuilder {
  ...
  public class Impl implements LibraryBuilder {
    ...
    /**
     * Required fields for {@link Library}
     *
     ...
     */
    public LibraryBuilder.Impl withId(@NonNull String id) {
     ...
     *     different servers.
     */
    public LibraryBuilder.Impl withUrl(@NonNull String url) {
     ...
     */
    public LibraryBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public LibraryBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public LibraryBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public LibraryBuilder.Impl withText(@NonNull NarrativeBuilder text) {
     ...
     */
    public LibraryBuilder.Impl withName(@NonNull String name) {
     ...
     */
    public LibraryBuilder.Impl withDate(@NonNull FHIRDateTime date) {
      this.date = Optional.of(date);
      return this;
    }
    /** @param title - A short, descriptive, user-friendly title for the library. */
    public LibraryBuilder.Impl withTitle(@NonNull String title) {
     ...
     */
    public LibraryBuilder.Impl withUsage(@NonNull String usage) {
     ...
     */
    public LibraryBuilder.Impl withTopic(@NonNull CodeableConcept... topic) {
     ...
     *     high-level categorization of the library that can be useful for filtering and searching.
     */
    public LibraryBuilder.Impl withTopic(@NonNull Collection<CodeableConcept> topic) {
      this.topic = Collections.unmodifiableCollection(topic);
      return this;
    }

    public LibraryBuilder.Impl withTopic(@NonNull CodeableConceptBuilder... topic) {
     ...
     */
    public LibraryBuilder.Impl withAuthor(@NonNull ContactDetail... author) {
     ...
     *     maintenance of the content.
     */
    public LibraryBuilder.Impl withAuthor(@NonNull Collection<ContactDetail> author) {
      this.author = Collections.unmodifiableCollection(author);
      return this;
    }

    public LibraryBuilder.Impl withAuthor(@NonNull ContactDetailBuilder... author) {
     ...
     *     the content.
     */
    public LibraryBuilder.Impl withEditor(@NonNull ContactDetail... editor) {
     ...
     *     the content.
     */
    public LibraryBuilder.Impl withEditor(@NonNull Collection<ContactDetail> editor) {
      this.editor = Collections.unmodifiableCollection(editor);
      return this;
    }

    public LibraryBuilder.Impl withEditor(@NonNull ContactDetailBuilder... editor) {
     ...
     */
    public LibraryBuilder.Impl withVersion(@NonNull String version) {
     ...
     *     publisher.
     */
    public LibraryBuilder.Impl withContact(@NonNull ContactDetail... contact) {
     ...
     *     publisher.
     */
    public LibraryBuilder.Impl withContact(@NonNull Collection<ContactDetail> contact) {
      this.contact = Collections.unmodifiableCollection(contact);
      return this;
    }

    public LibraryBuilder.Impl withContact(@NonNull ContactDetailBuilder... contact) {
     ...
     *     has.
     */
    public LibraryBuilder.Impl withPurpose(@NonNull String purpose) {
     ...
     */
    public LibraryBuilder.Impl withContent(@NonNull Attachment... content) {
     ...
     *     the attachment determines how to interpret the content.
     */
    public LibraryBuilder.Impl withContent(@NonNull Collection<Attachment> content) {
      this.content = Collections.unmodifiableCollection(content);
      return this;
    }

    public LibraryBuilder.Impl withContent(@NonNull AttachmentBuilder... content) {
      this.content = Arrays.stream(content).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public LibraryBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public LibraryBuilder.Impl withSubtitle(@NonNull String subtitle) {
     ...
     */
    public LibraryBuilder.Impl withReviewer(@NonNull ContactDetail... reviewer) {
     ...
     *     aspect of the content.
     */
    public LibraryBuilder.Impl withReviewer(@NonNull Collection<ContactDetail> reviewer) {
      this.reviewer = Collections.unmodifiableCollection(reviewer);
      return this;
    }

    public LibraryBuilder.Impl withReviewer(@NonNull ContactDetailBuilder... reviewer) {
     ...
     */
    public LibraryBuilder.Impl withEndorser(@NonNull ContactDetail... endorser) {
     ...
     *     content for use in some setting.
     */
    public LibraryBuilder.Impl withEndorser(@NonNull Collection<ContactDetail> endorser) {
      this.endorser = Collections.unmodifiableCollection(endorser);
      return this;
    }

    public LibraryBuilder.Impl withEndorser(@NonNull ContactDetailBuilder... endorser) {
     ...
     */
    public LibraryBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     their own independent transaction scope.
     */
    public LibraryBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
      this.contained = Collections.unmodifiableCollection(contained);
      return this;
    }

    public LibraryBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public LibraryBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public LibraryBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public LibraryBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
      this.extension = Arrays.stream(extension).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param publisher - The name of the organization or individual that published the library. */
    public LibraryBuilder.Impl withPublisher(@NonNull String publisher) {
     ...
     *     library.
     */
    public LibraryBuilder.Impl withCopyright(@NonNull String copyright) {
      this.copyright = Optional.of(copyright);
      return this;
    }
    /** @param parameter - The parameter element defines parameters used by the library. */
    public LibraryBuilder.Impl withParameter(@NonNull ParameterDefinition... parameter) {
      this.parameter = Arrays.asList(parameter);
      return this;
    }
    /** @param parameter - The parameter element defines parameters used by the library. */
    public LibraryBuilder.Impl withParameter(@NonNull Collection<ParameterDefinition> parameter) {
      this.parameter = Collections.unmodifiableCollection(parameter);
      return this;
    }

    public LibraryBuilder.Impl withParameter(@NonNull ParameterDefinitionBuilder... parameter) {
     ...
     */
    public LibraryBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     *     identifier is required for non-experimental active artifacts.
     */
    public LibraryBuilder.Impl withIdentifier(@NonNull Collection<Identifier> identifier) {
      this.identifier = Collections.unmodifiableCollection(identifier);
      return this;
    }

    public LibraryBuilder.Impl withIdentifier(@NonNull IdentifierBuilder... identifier) {
     ...
     */
    public LibraryBuilder.Impl withUseContext(@NonNull UsageContext... useContext) {
     ...
     *     assist with indexing and searching for appropriate library instances.
     */
    public LibraryBuilder.Impl withUseContext(@NonNull Collection<UsageContext> useContext) {
      this.useContext = Collections.unmodifiableCollection(useContext);
      return this;
    }

    public LibraryBuilder.Impl withUseContext(@NonNull UsageContextBuilder... useContext) {
     ...
     */
    public LibraryBuilder.Impl withDescription(@NonNull String description) {
     ...
     *     usage.
     */
    public LibraryBuilder.Impl withExperimental(@NonNull Boolean experimental) {
     ...
     *     used.
     */
    public LibraryBuilder.Impl withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
     ...
     *     used.
     */
    public LibraryBuilder.Impl withJurisdiction(@NonNull Collection<CodeableConcept> jurisdiction) {
      this.jurisdiction = Collections.unmodifiableCollection(jurisdiction);
      return this;
    }

    public LibraryBuilder.Impl withJurisdiction(@NonNull CodeableConceptBuilder... jurisdiction) {
     ...
     */
    public LibraryBuilder.Impl withApprovalDate(@NonNull FHIRDate approvalDate) {
     ...
     *     profiles etc.
     */
    public LibraryBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public LibraryBuilder.Impl withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
     ...
     *     in active use.
     */
    public LibraryBuilder.Impl withEffectivePeriod(@NonNull Period effectivePeriod) {
      this.effectivePeriod = Optional.of(effectivePeriod);
      return this;
    }

    public LibraryBuilder.Impl withEffectivePeriod(@NonNull PeriodBuilder effectivePeriod) {
     ...
     */
    public LibraryBuilder.Impl withRelatedArtifact(@NonNull RelatedArtifact... relatedArtifact) {
     ...
     *     or bibliographic references.
     */
    public LibraryBuilder.Impl withRelatedArtifact(
     ...
     */
    public LibraryBuilder.Impl withDataRequirement(@NonNull DataRequirement... dataRequirement) {
     ...
     *     successfully perform the computations defined by the library.
     */
    public LibraryBuilder.Impl withDataRequirement(
     ...
     */
    public LibraryBuilder.Impl withModifierExtension(@NonNull Extension... modifierExtension) {
     ...
     *     DomainResource (including cannot change the meaning of modifierExtension itself).
     */
    public LibraryBuilder.Impl withModifierExtension(
