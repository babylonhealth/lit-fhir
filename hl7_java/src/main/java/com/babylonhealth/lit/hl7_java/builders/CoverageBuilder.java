...
public class CoverageBuilder {
   ...
   */
  public CoverageBuilder(Collection<Reference> payor, FM_STATUS status, Reference beneficiary) {
    this.payor = payor;
    this.status = status;
   ...
   */
  public CoverageBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public CoverageBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public CoverageBuilder withText(@NonNull Narrative text) {
   ...
   */
  public CoverageBuilder withType(@NonNull CodeableConcept _type) {
   ...
   *     of care.
   */
  public CoverageBuilder withOrder(@NonNull Integer order) {
   ...
   *     to be in force.
   */
  public CoverageBuilder withPeriod(@NonNull Period period) {
    this.period = Optional.of(period);
    return this;
  }
  /**
   * @param network - The insurer-specific identifier for the insurer-defined network of providers
   *     to which the beneficiary may seek treatment which will be covered at the 'in-network' rate,
   *     otherwise 'out of network' terms and conditions apply.
   */
  public CoverageBuilder withNetwork(@NonNull String network) {
    this.network = Optional.of(network);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public CoverageBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param contract - The policy(s) which constitute this insurance coverage. */
  public CoverageBuilder withContract(@NonNull Reference... contract) {
    this.contract = Arrays.asList(contract);
    return this;
  }
  /** @param contract - The policy(s) which constitute this insurance coverage. */
  public CoverageBuilder withContract(@NonNull Collection<Reference> contract) {
   ...
   */
  public CoverageBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public CoverageBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public CoverageBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public CoverageBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param dependent - A unique identifier for a dependent under the coverage. */
  public CoverageBuilder withDependent(@NonNull String dependent) {
    this.dependent = Optional.of(dependent);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this coverage. */
  public CoverageBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this coverage. */
  public CoverageBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   *     family is due.
   */
  public CoverageBuilder withSubscriber(@NonNull Reference subscriber) {
   ...
   *     profiles etc.
   */
  public CoverageBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public CoverageBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public CoverageBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param _class - A suite of underwriter specific classifiers. */
  public CoverageBuilder withClass(@NonNull Coverage.Class... _class) {
    this._class = Arrays.asList(_class);
    return this;
  }
  /** @param _class - A suite of underwriter specific classifiers. */
  public CoverageBuilder withClass(@NonNull Collection<Coverage.Class> _class) {
    this._class = Collections.unmodifiableCollection(_class);
    return this;
  }
  /**
   * @param costToBeneficiary - A suite of codes indicating the cost category and associated amount
   *     which have been detailed in the policy and may have been included on the health card.
   */
  public CoverageBuilder withCostToBeneficiary(
