...
public interface CarePlanBuilder extends DomainResourceBuilder {
  ...
  public class Impl implements CarePlanBuilder {
     ...
     */
    public CarePlanBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public CarePlanBuilder.Impl withMeta(@NonNull Meta meta) {
    ...
    public CarePlanBuilder.Impl withGoal(@NonNull Reference... goal) {
      this.goal = Arrays.asList(goal);
      return this;
    }
    /** @param goal - Describes the intended objective(s) of carrying out the care plan. */
    public CarePlanBuilder.Impl withGoal(@NonNull Collection<Reference> goal) {
    ...
    public CarePlanBuilder.Impl withTitle(@NonNull String title) {
     ...
     */
    public CarePlanBuilder.Impl withPartOf(@NonNull Reference... partOf) {
     ...
     * @param partOf - A larger care plan of which this particular care plan is a component or step.
     */
    public CarePlanBuilder.Impl withPartOf(@NonNull Collection<Reference> partOf) {
     ...
     */
    public CarePlanBuilder.Impl withAuthor(@NonNull Reference author) {
     ...
     */
    public CarePlanBuilder.Impl withCreated(@NonNull FHIRDateTime created) {
      this.created = Optional.of(created);
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public CarePlanBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     *     plan.
     */
    public CarePlanBuilder.Impl withReplaces(@NonNull Reference... replaces) {
     ...
     *     plan.
     */
    public CarePlanBuilder.Impl withReplaces(@NonNull Collection<Reference> replaces) {
     ...
     */
    public CarePlanBuilder.Impl withCategory(@NonNull CodeableConcept... category) {
     ...
     *     management", "wellness plan", etc.
     */
    public CarePlanBuilder.Impl withCategory(@NonNull Collection<CodeableConcept> category) {
     ...
     */
    public CarePlanBuilder.Impl withCareTeam(@NonNull Reference... careTeam) {
     ...
     */
    public CarePlanBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public CarePlanBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
     ...
     *     server.
     */
    public CarePlanBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
    ...
    public CarePlanBuilder.Impl withDescription(@NonNull String description) {
     ...
     *     of the care plan.
     */
    public CarePlanBuilder.Impl withContributor(@NonNull Reference... contributor) {
     ...
     *     profiles etc.
     */
    public CarePlanBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public CarePlanBuilder.Impl withSupportingInfo(@NonNull Reference... supportingInfo) {
     ...
     *     CarePlan.
     */
    public CarePlanBuilder.Impl withInstantiatesUri(@NonNull String... instantiatesUri) {
     ...
     *     CarePlan.
     */
    public CarePlanBuilder.Impl withInstantiatesUri(@NonNull Collection<String> instantiatesUri) {
     ...
     */
    public CarePlanBuilder.Impl withModifierExtension(@NonNull Extension... modifierExtension) {
     ...
     *     CarePlan.
     */
    public CarePlanBuilder.Impl withInstantiatesCanonical(
