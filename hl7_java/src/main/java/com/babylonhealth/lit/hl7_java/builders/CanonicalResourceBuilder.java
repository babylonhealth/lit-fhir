...
public interface CanonicalResourceBuilder extends DomainResourceBuilder {
  public CanonicalResource build();
  ...
  public class Impl implements CanonicalResourceBuilder {
    ...
    /**
     * Required fields for {@link CanonicalResource}
     *
     ...
     */
    public CanonicalResourceBuilder.Impl withId(@NonNull String id) {
     ...
     *     different servers.
     */
    public CanonicalResourceBuilder.Impl withUrl(@NonNull String url) {
     ...
     */
    public CanonicalResourceBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public CanonicalResourceBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public CanonicalResourceBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public CanonicalResourceBuilder.Impl withText(@NonNull NarrativeBuilder text) {
     ...
     *     generation.
     */
    public CanonicalResourceBuilder.Impl withName(@NonNull String name) {
     ...
     */
    public CanonicalResourceBuilder.Impl withDate(@NonNull FHIRDateTime date) {
      this.date = Optional.of(date);
      return this;
    }
    /** @param title - A short, descriptive, user-friendly title for the {{title}}. */
    public CanonicalResourceBuilder.Impl withTitle(@NonNull String title) {
     ...
     */
    public CanonicalResourceBuilder.Impl withVersion(@NonNull String version) {
     ...
     *     publisher.
     */
    public CanonicalResourceBuilder.Impl withContact(@NonNull ContactDetail... contact) {
     ...
     *     publisher.
     */
    public CanonicalResourceBuilder.Impl withContact(@NonNull Collection<ContactDetail> contact) {
      this.contact = Collections.unmodifiableCollection(contact);
      return this;
    }

    public CanonicalResourceBuilder.Impl withContact(@NonNull ContactDetailBuilder... contact) {
     ...
     *     it has.
     */
    public CanonicalResourceBuilder.Impl withPurpose(@NonNull String purpose) {
      this.purpose = Optional.of(purpose);
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public CanonicalResourceBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public CanonicalResourceBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     their own independent transaction scope.
     */
    public CanonicalResourceBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
      this.contained = Collections.unmodifiableCollection(contained);
      return this;
    }

    public CanonicalResourceBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public CanonicalResourceBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public CanonicalResourceBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public CanonicalResourceBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
     ...
     */
    public CanonicalResourceBuilder.Impl withPublisher(@NonNull String publisher) {
     ...
     *     {{title}}.
     */
    public CanonicalResourceBuilder.Impl withCopyright(@NonNull String copyright) {
     ...
     *     instance.
     */
    public CanonicalResourceBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     *     instance.
     */
    public CanonicalResourceBuilder.Impl withIdentifier(
        @NonNull Collection<Identifier> identifier) {
      this.identifier = Collections.unmodifiableCollection(identifier);
      return this;
    }

    public CanonicalResourceBuilder.Impl withIdentifier(@NonNull IdentifierBuilder... identifier) {
     ...
     */
    public CanonicalResourceBuilder.Impl withUseContext(@NonNull UsageContext... useContext) {
     ...
     *     assist with indexing and searching for appropriate {{title}} instances.
     */
    public CanonicalResourceBuilder.Impl withUseContext(
     ...
     */
    public CanonicalResourceBuilder.Impl withDescription(@NonNull String description) {
     ...
     *     usage.
     */
    public CanonicalResourceBuilder.Impl withExperimental(@NonNull Boolean experimental) {
     ...
     *     used.
     */
    public CanonicalResourceBuilder.Impl withJurisdiction(
     ...
     *     profiles etc.
     */
    public CanonicalResourceBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public CanonicalResourceBuilder.Impl withModifierExtension(
