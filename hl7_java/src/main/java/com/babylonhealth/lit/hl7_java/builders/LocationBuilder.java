...
public class LocationBuilder {
  ...
  /** Required fields for {@link Location} */
   ...
   */
  public LocationBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public LocationBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public LocationBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param name - Name of the location as used by humans. Does not need to be unique. */
  public LocationBuilder withName(@NonNull String name) {
   ...
   *     of locations.
   */
  public LocationBuilder withMode(@NonNull LOCATION_MODE mode) {
    this.mode = Optional.of(mode);
    return this;
  }
  /** @param _type - Indicates the type of function performed at the location. */
  public LocationBuilder withType(@NonNull CodeableConcept... _type) {
    this._type = Arrays.asList(_type);
    return this;
  }
  /** @param _type - Indicates the type of function performed at the location. */
  public LocationBuilder withType(@NonNull Collection<CodeableConcept> _type) {
   ...
   *     past.
   */
  public LocationBuilder withAlias(@NonNull String... alias) {
   ...
   *     past.
   */
  public LocationBuilder withAlias(@NonNull Collection<String> alias) {
   ...
   */
  public LocationBuilder withStatus(@NonNull LOCATION_STATUS status) {
    this.status = Optional.of(status);
    return this;
  }
  /** @param partOf - Another Location of which this Location is physically a part of. */
  public LocationBuilder withPartOf(@NonNull Reference partOf) {
   ...
   */
  public LocationBuilder withTelecom(@NonNull ContactPoint... telecom) {
   ...
   *     can include phone numbers, fax numbers, mobile numbers, email addresses and web sites.
   */
  public LocationBuilder withTelecom(@NonNull Collection<ContactPoint> telecom) {
    this.telecom = Collections.unmodifiableCollection(telecom);
    return this;
  }
  /** @param address - Physical location. */
  public LocationBuilder withAddress(@NonNull Address address) {
    this.address = Optional.of(address);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public LocationBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public LocationBuilder withEndpoint(@NonNull Reference... endpoint) {
   ...
   * @param endpoint - Technical endpoints providing access to services operated for the location.
   */
  public LocationBuilder withEndpoint(@NonNull Collection<Reference> endpoint) {
   ...
   */
  public LocationBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public LocationBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public LocationBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public LocationBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param identifier - Unique code or number identifying the location to its users. */
  public LocationBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - Unique code or number identifying the location to its users. */
  public LocationBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   *     place.
   */
  public LocationBuilder withDescription(@NonNull String description) {
    this.description = Optional.of(description);
    return this;
  }
  /** @param physicalType - Physical form of the location, e.g. building, room, vehicle, road. */
  public LocationBuilder withPhysicalType(@NonNull CodeableConcept physicalType) {
   ...
   *     profiles etc.
   */
  public LocationBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public LocationBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public LocationBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
   ...
   *     like maintenance.
   */
  public LocationBuilder withOperationalStatus(@NonNull Coding operationalStatus) {
   ...
   *     the location.
   */
  public LocationBuilder withManagingOrganization(@NonNull Reference managingOrganization) {
   ...
   */
  public LocationBuilder withAvailabilityExceptions(@NonNull String availabilityExceptions) {
   ...
   */
  public LocationBuilder withPosition(@NonNull Location.Position position) {
    this.position = Optional.of(position);
    return this;
  }
  /** @param hoursOfOperation - What days/times during a week is this location usually open. */
  public LocationBuilder withHoursOfOperation(
