...
public interface LocationBuilder extends DomainResourceBuilder {
  ...
  public class Impl implements LocationBuilder {
     ...
     */
    public LocationBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public LocationBuilder.Impl withMeta(@NonNull Meta meta) {
    ...
    public LocationBuilder.Impl withName(@NonNull String name) {
     ...
     *     of locations.
     */
    public LocationBuilder.Impl withMode(@NonNull LOCATION_MODE mode) {
      this.mode = Optional.of(mode);
      return this;
    }
    /** @param _type - Indicates the type of function performed at the location. */
    public LocationBuilder.Impl withType(@NonNull CodeableConcept... _type) {
     ...
     *     the past.
     */
    public LocationBuilder.Impl withAlias(@NonNull String... alias) {
     ...
     *     the past.
     */
    public LocationBuilder.Impl withAlias(@NonNull Collection<String> alias) {
     ...
     */
    public LocationBuilder.Impl withStatus(@NonNull LOCATION_STATUS status) {
      this.status = Optional.of(status);
      return this;
    }
    /** @param partOf - Another Location of which this Location is physically a part of. */
    public LocationBuilder.Impl withPartOf(@NonNull Reference partOf) {
     ...
     */
    public LocationBuilder.Impl withTelecom(@NonNull ContactPoint... telecom) {
     ...
     *     can include phone numbers, fax numbers, mobile numbers, email addresses and web sites.
     */
    public LocationBuilder.Impl withTelecom(@NonNull Collection<ContactPoint> telecom) {
    ...
    public LocationBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public LocationBuilder.Impl withEndpoint(@NonNull Reference... endpoint) {
     ...
     * @param endpoint - Technical endpoints providing access to services operated for the location.
     */
    public LocationBuilder.Impl withEndpoint(@NonNull Collection<Reference> endpoint) {
     ...
     */
    public LocationBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     */
    public LocationBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public LocationBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
     ...
     *     place.
     */
    public LocationBuilder.Impl withDescription(@NonNull String description) {
     ...
     *     profiles etc.
     */
    public LocationBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public LocationBuilder.Impl withModifierExtension(@NonNull Extension... modifierExtension) {
     ...
     */
    public LocationBuilder.Impl withOperationalStatus(@NonNull Coding operationalStatus) {
     ...
     */
    public LocationBuilder.Impl withAvailabilityExceptions(@NonNull String availabilityExceptions) {
     ...
     */
    public LocationBuilder.Impl withPosition(@NonNull Location.Position position) {
