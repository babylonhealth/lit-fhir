...
public class CodeSystem_ConceptBuilder {
   ...
   * @param code
   */
  public CodeSystem_ConceptBuilder(String code) {
    this.code = code;
  }
   ...
   */
  public CodeSystem_ConceptBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param display */
  public CodeSystem_ConceptBuilder withDisplay(@NonNull String display) {
   ...
   */
  public CodeSystem_ConceptBuilder withConcept(@NonNull CodeSystem.Concept... concept) {
   ...
   *     hierarchical relationships are.
   */
  public CodeSystem_ConceptBuilder withConcept(@NonNull Collection<CodeSystem.Concept> concept) {
   ...
   */
  public CodeSystem_ConceptBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public CodeSystem_ConceptBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param definition */
  public CodeSystem_ConceptBuilder withDefinition(@NonNull String definition) {
   ...
   */
  public CodeSystem_ConceptBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public CodeSystem_ConceptBuilder withModifierExtension(
   ...
   */
  public CodeSystem_ConceptBuilder withProperty(@NonNull CodeSystem$Concept$Property... property) {
