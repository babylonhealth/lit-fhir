...
public class ConceptMapBuilder {
   ...
   */
  public ConceptMapBuilder withId(@NonNull String id) {
   ...
   *     different servers.
   */
  public ConceptMapBuilder withUrl(@NonNull String url) {
   ...
   *     to the resource.
   */
  public ConceptMapBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public ConceptMapBuilder withText(@NonNull Narrative text) {
   ...
   */
  public ConceptMapBuilder withName(@NonNull String name) {
    this.name = Optional.of(name);
    return this;
  }
  /**
   * @param date - The date (and optionally time) when the concept map was published. The date must
   ...
   */
  public ConceptMapBuilder withDate(@NonNull FHIRDateTime date) {
    this.date = Optional.of(date);
    return this;
  }
  /** @param title - A short, descriptive, user-friendly title for the concept map. */
  public ConceptMapBuilder withTitle(@NonNull String title) {
   ...
   */
  public ConceptMapBuilder withVersion(@NonNull String version) {
   ...
   *     publisher.
   */
  public ConceptMapBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public ConceptMapBuilder withContact(@NonNull Collection<ContactDetail> contact) {
   ...
   *     it has.
   */
  public ConceptMapBuilder withPurpose(@NonNull String purpose) {
    this.purpose = Optional.of(purpose);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public ConceptMapBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public ConceptMapBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public ConceptMapBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public ConceptMapBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ConceptMapBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public ConceptMapBuilder withPublisher(@NonNull String publisher) {
   ...
   *     concept map.
   */
  public ConceptMapBuilder withCopyright(@NonNull String copyright) {
   ...
   *     instance.
   */
  public ConceptMapBuilder withIdentifier(@NonNull Identifier identifier) {
   ...
   */
  public ConceptMapBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate concept map instances.
   */
  public ConceptMapBuilder withUseContext(@NonNull Collection<UsageContext> useContext) {
   ...
   */
  public ConceptMapBuilder withDescription(@NonNull String description) {
   ...
   *     usage.
   */
  public ConceptMapBuilder withExperimental(@NonNull Boolean experimental) {
   ...
   *     used.
   */
  public ConceptMapBuilder withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
   ...
   *     used.
   */
  public ConceptMapBuilder withJurisdiction(@NonNull Collection<CodeableConcept> jurisdiction) {
   ...
   *     profiles etc.
   */
  public ConceptMapBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public ConceptMapBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public ConceptMapBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param group - A group of mappings that all have the same source and target system. */
  public ConceptMapBuilder withGroup(@NonNull ConceptMap.Group... group) {
    this.group = Arrays.asList(group);
    return this;
  }
  /** @param group - A group of mappings that all have the same source and target system. */
  public ConceptMapBuilder withGroup(@NonNull Collection<ConceptMap.Group> group) {
