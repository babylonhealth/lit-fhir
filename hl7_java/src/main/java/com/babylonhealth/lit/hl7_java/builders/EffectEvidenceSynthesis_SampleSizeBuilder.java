...
public class EffectEvidenceSynthesis_SampleSizeBuilder {
  ...
  public EffectEvidenceSynthesis_SampleSizeBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public EffectEvidenceSynthesis_SampleSizeBuilder withId(@NonNull String id) {
   ...
   */
  public EffectEvidenceSynthesis_SampleSizeBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public EffectEvidenceSynthesis_SampleSizeBuilder withExtension(
   ...
   */
  public EffectEvidenceSynthesis_SampleSizeBuilder withDescription(@NonNull String description) {
    this.description = Optional.of(description);
    return this;
  }
  /** @param numberOfStudies */
  public EffectEvidenceSynthesis_SampleSizeBuilder withNumberOfStudies(
   ...
   */
  public EffectEvidenceSynthesis_SampleSizeBuilder withModifierExtension(
  ...
  public EffectEvidenceSynthesis_SampleSizeBuilder withNumberOfParticipants(
