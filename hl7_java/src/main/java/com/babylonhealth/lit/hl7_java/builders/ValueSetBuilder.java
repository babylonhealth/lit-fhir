...
public interface ValueSetBuilder extends DomainResourceBuilder {
  ...
  public class Impl implements ValueSetBuilder {
     ...
     */
    public ValueSetBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public ValueSetBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     *     generation.
     */
    public ValueSetBuilder.Impl withName(@NonNull String name) {
     ...
     */
    public ValueSetBuilder.Impl withDate(@NonNull FHIRDateTime date) {
      this.date = Optional.of(date);
      return this;
    }
    /** @param title - A short, descriptive, user-friendly title for the value set. */
    public ValueSetBuilder.Impl withTitle(@NonNull String title) {
     ...
     */
    public ValueSetBuilder.Impl withVersion(@NonNull String version) {
     ...
     *     publisher.
     */
    public ValueSetBuilder.Impl withContact(@NonNull ContactDetail... contact) {
     ...
     *     publisher.
     */
    public ValueSetBuilder.Impl withContact(@NonNull Collection<ContactDetail> contact) {
     ...
     *     it has.
     */
    public ValueSetBuilder.Impl withPurpose(@NonNull String purpose) {
      this.purpose = Optional.of(purpose);
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public ValueSetBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public ValueSetBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     */
    public ValueSetBuilder.Impl withPublisher(@NonNull String publisher) {
     ...
     */
    public ValueSetBuilder.Impl withImmutable(@NonNull Boolean immutable) {
     ...
     *     value set.
     */
    public ValueSetBuilder.Impl withCopyright(@NonNull String copyright) {
     ...
     *     instance.
     */
    public ValueSetBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     *     instance.
     */
    public ValueSetBuilder.Impl withIdentifier(@NonNull Collection<Identifier> identifier) {
     ...
     */
    public ValueSetBuilder.Impl withUseContext(@NonNull UsageContext... useContext) {
     ...
     */
    public ValueSetBuilder.Impl withDescription(@NonNull String description) {
     ...
     *     usage.
     */
    public ValueSetBuilder.Impl withExperimental(@NonNull Boolean experimental) {
     ...
     *     used.
     */
    public ValueSetBuilder.Impl withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
     ...
     *     profiles etc.
     */
    public ValueSetBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public ValueSetBuilder.Impl withModifierExtension(@NonNull Extension... modifierExtension) {
     ...
     *     performed.
     */
    public ValueSetBuilder.Impl withExpansion(@NonNull ValueSet.Expansion expansion) {
