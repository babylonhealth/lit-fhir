...
public class MolecularSequenceBuilder {
  ...
  private Collection<MolecularSequence.StructureVariant> structureVariant = Collections.emptyList();
   ...
   *     coordinates, inclusive start, exclusive end) or starting at 1 (1-based numbering, inclusive
   *     start and inclusive end).
   */
  public MolecularSequenceBuilder(Integer coordinateSystem) {
   ...
   */
  public MolecularSequenceBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public MolecularSequenceBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public MolecularSequenceBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param _type - Amino Acid Sequence/ DNA Sequence / RNA Sequence. */
  public MolecularSequenceBuilder withType(@NonNull SEQUENCE_TYPE _type) {
    this._type = Optional.of(_type);
    return this;
  }
  /** @param device - The method for sequencing, for example, chip information. */
  public MolecularSequenceBuilder withDevice(@NonNull Reference device) {
    this.device = Optional.of(device);
    return this;
  }
  /** @param patient - The patient whose sequencing results are described by this resource. */
  public MolecularSequenceBuilder withPatient(@NonNull Reference patient) {
    this.patient = Optional.of(patient);
    return this;
  }
  /** @param pointer - Pointer to next atomic sequence which at most contains one variant. */
  public MolecularSequenceBuilder withPointer(@NonNull Reference... pointer) {
    this.pointer = Arrays.asList(pointer);
    return this;
  }
  /** @param pointer - Pointer to next atomic sequence which at most contains one variant. */
  public MolecularSequenceBuilder withPointer(@NonNull Collection<Reference> pointer) {
    this.pointer = Collections.unmodifiableCollection(pointer);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public MolecularSequenceBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param specimen - Specimen used for sequencing. */
  public MolecularSequenceBuilder withSpecimen(@NonNull Reference specimen) {
    this.specimen = Optional.of(specimen);
    return this;
  }
  /** @param quantity - The number of copies of the sequence of interest. (RNASeq). */
  public MolecularSequenceBuilder withQuantity(@NonNull Quantity quantity) {
   ...
   */
  public MolecularSequenceBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public MolecularSequenceBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public MolecularSequenceBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public MolecularSequenceBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param performer - The organization or lab that should be responsible for this result. */
  public MolecularSequenceBuilder withPerformer(@NonNull Reference performer) {
   ...
   *     FHIR-defined id.
   */
  public MolecularSequenceBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     FHIR-defined id.
   */
  public MolecularSequenceBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
    this.identifier = Collections.unmodifiableCollection(identifier);
    return this;
  }
  /**
   * @param observedSeq - Sequence that was observed. It is the result marked by referenceSeq along
   *     with variant records on referenceSeq. This shall start from referenceSeq.windowStart and
   *     end by referenceSeq.windowEnd.
   */
  public MolecularSequenceBuilder withObservedSeq(@NonNull String observedSeq) {
   ...
   */
  public MolecularSequenceBuilder withReadCoverage(@NonNull Integer readCoverage) {
   ...
   *     profiles etc.
   */
  public MolecularSequenceBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public MolecularSequenceBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public MolecularSequenceBuilder withModifierExtension(
   ...
   */
  public MolecularSequenceBuilder withVariant(@NonNull MolecularSequence.Variant... variant) {
   ...
   *     with the assist of CIGAR string.
   */
  public MolecularSequenceBuilder withVariant(
   ...
   */
  public MolecularSequenceBuilder withRepository(
   ...
   */
  public MolecularSequenceBuilder withQuality(@NonNull MolecularSequence.Quality... quality) {
   ...
   *     ([SO:0001686](http://www.sequenceontology.org/browser/current_svn/term/SO:0001686)).
   */
  public MolecularSequenceBuilder withQuality(
   ...
   */
  public MolecularSequenceBuilder withReferenceSeq(
  ...
  public MolecularSequenceBuilder withStructureVariant(
