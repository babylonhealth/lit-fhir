...
public class MedicationRequest_DispenseRequestBuilder {
  ...
  public MedicationRequest_DispenseRequestBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public MedicationRequest_DispenseRequestBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param quantity */
  public MedicationRequest_DispenseRequestBuilder withQuantity(@NonNull Quantity quantity) {
   ...
   */
  public MedicationRequest_DispenseRequestBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public MedicationRequest_DispenseRequestBuilder withExtension(
   ...
   */
  public MedicationRequest_DispenseRequestBuilder withPerformer(@NonNull Reference performer) {
    this.performer = Optional.of(performer);
    return this;
  }
  /** @param validityPeriod */
  public MedicationRequest_DispenseRequestBuilder withValidityPeriod(
      @NonNull Period validityPeriod) {
    this.validityPeriod = Optional.of(validityPeriod);
    return this;
  }
  /** @param dispenseInterval */
  public MedicationRequest_DispenseRequestBuilder withDispenseInterval(
   ...
   */
  public MedicationRequest_DispenseRequestBuilder withModifierExtension(
  ...
  public MedicationRequest_DispenseRequestBuilder withNumberOfRepeatsAllowed(
  ...
  public MedicationRequest_DispenseRequestBuilder withExpectedSupplyDuration(
      @NonNull Duration expectedSupplyDuration) {
    this.expectedSupplyDuration = Optional.of(expectedSupplyDuration);
    return this;
  }
  /** @param initialFill */
  public MedicationRequest_DispenseRequestBuilder withInitialFill(
