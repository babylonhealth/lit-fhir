...
public interface Substance_InstanceBuilder {
  ...
  public class Impl implements Substance_InstanceBuilder {
     ...
     */
    public Substance_InstanceBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param expiry */
    public Substance_InstanceBuilder.Impl withExpiry(@NonNull FHIRDateTime expiry) {
      this.expiry = Optional.of(expiry);
      return this;
    }
    /** @param quantity */
    public Substance_InstanceBuilder.Impl withQuantity(@NonNull Quantity quantity) {
     ...
     */
    public Substance_InstanceBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public Substance_InstanceBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
