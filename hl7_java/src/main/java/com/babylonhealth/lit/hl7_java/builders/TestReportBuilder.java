...
public class TestReportBuilder {
   ...
   */
  public TestReportBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public TestReportBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public TestReportBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param name - A free text natural language name identifying the executed TestScript. */
  public TestReportBuilder withName(@NonNull String name) {
   ...
   */
  public TestReportBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public TestReportBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public TestReportBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public TestReportBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     context of FHIR.
   */
  public TestReportBuilder withIdentifier(@NonNull Identifier identifier) {
   ...
   *     profiles etc.
   */
  public TestReportBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public TestReportBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public TestReportBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
   ...
   *     client, or a server.
   */
  public TestReportBuilder withParticipant(@NonNull TestReport.Participant... participant) {
   ...
   *     client, or a server.
   */
  public TestReportBuilder withParticipant(
  ...
  public TestReportBuilder withTest(@NonNull TestReport.Test... test) {
    this.test = Arrays.asList(test);
    return this;
  }
  /** @param test - A test executed from the test script. */
  public TestReportBuilder withTest(@NonNull Collection<TestReport.Test> test) {
   ...
   */
  public TestReportBuilder withTeardown(@NonNull TestReport.Teardown teardown) {
   ...
   *     executed.
   */
  public TestReportBuilder withSetup(@NonNull TestReport.Setup setup) {
