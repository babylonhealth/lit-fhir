...
public class Specimen_ProcessingBuilder {
   ...
   */
  public Specimen_ProcessingBuilder withId(@NonNull String id) {
  ...
  /** @param additive */
  public Specimen_ProcessingBuilder withAdditive(@NonNull Reference... additive) {
    this.additive = Arrays.asList(additive);
    return this;
  }
  /** @param additive */
  public Specimen_ProcessingBuilder withAdditive(@NonNull Collection<Reference> additive) {
   ...
   */
  public Specimen_ProcessingBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Specimen_ProcessingBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param procedure */
  public Specimen_ProcessingBuilder withProcedure(@NonNull CodeableConcept procedure) {
    this.procedure = Optional.of(procedure);
    return this;
  }
  /** @param description */
  public Specimen_ProcessingBuilder withDescription(@NonNull String description) {
   ...
   */
  public Specimen_ProcessingBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public Specimen_ProcessingBuilder withModifierExtension(
