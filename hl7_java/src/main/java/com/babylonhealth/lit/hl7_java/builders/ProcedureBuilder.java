...
public interface ProcedureBuilder extends DomainResourceBuilder {
  ...
  public static ChoiceAllergyIntolerance_Onset performed(Age a) {
    return new ChoiceAllergyIntolerance_Onset(a);
  }

  public static ChoiceAllergyIntolerance_Onset performed(FHIRDateTime f) {
    return new ChoiceAllergyIntolerance_Onset(f);
  }

  public static ChoiceAllergyIntolerance_Onset performed(Period p) {
    return new ChoiceAllergyIntolerance_Onset(p);
  }

  public static ChoiceAllergyIntolerance_Onset performed(Range r) {
    return new ChoiceAllergyIntolerance_Onset(r);
  }

  public static ChoiceAllergyIntolerance_Onset performed(String s) {
  ...
  public class Impl implements ProcedureBuilder {
    ...
    private Optional<ChoiceAllergyIntolerance_Onset> performed = Optional.empty();
     ...
     */
    public ProcedureBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public ProcedureBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     */
    public ProcedureBuilder.Impl withText(@NonNull Narrative text) {
    ...
    public ProcedureBuilder.Impl withNote(@NonNull Annotation... note) {
      this.note = Arrays.asList(note);
      return this;
    }
    /** @param note - Any other notes and comments about the procedure. */
    public ProcedureBuilder.Impl withNote(@NonNull Collection<Annotation> note) {
    ...
    /** @param partOf - A larger event of which this particular procedure is a component or step. */
    public ProcedureBuilder.Impl withPartOf(@NonNull Collection<Reference> partOf) {
     ...
     *     procedure.
     */
    public ProcedureBuilder.Impl withBasedOn(@NonNull Reference... basedOn) {
     ...
     *     procedure.
     */
    public ProcedureBuilder.Impl withBasedOn(@NonNull Collection<Reference> basedOn) {
    ...
    public ProcedureBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     *     content.
     */
    public ProcedureBuilder.Impl withRecorder(@NonNull Reference recorder) {
     ...
     */
    public ProcedureBuilder.Impl withBodySite(@NonNull CodeableConcept... bodySite) {
     ...
     */
    public ProcedureBuilder.Impl withFollowUp(@NonNull CodeableConcept... followUp) {
     ...
     *     which case the CarePlan resource can be used.
     */
    public ProcedureBuilder.Impl withFollowUp(@NonNull Collection<CodeableConcept> followUp) {
     ...
     */
    public ProcedureBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public ProcedureBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
     ...
     *     server.
     */
    public ProcedureBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     *     server.
     */
    public ProcedureBuilder.Impl withIdentifier(@NonNull Collection<Identifier> identifier) {
     ...
     */
    public ProcedureBuilder.Impl withPerformed(@NonNull ChoiceAllergyIntolerance_Onset performed) {
     ...
     *     issues.
     */
    public ProcedureBuilder.Impl withComplication(@NonNull CodeableConcept... complication) {
     ...
     *     issues.
     */
    public ProcedureBuilder.Impl withComplication(
     ...
     *     profiles etc.
     */
    public ProcedureBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public ProcedureBuilder.Impl withInstantiatesUri(@NonNull String... instantiatesUri) {
     ...
     */
    public ProcedureBuilder.Impl withModifierExtension(@NonNull Extension... modifierExtension) {
     ...
     */
    public ProcedureBuilder.Impl withComplicationDetail(@NonNull Reference... complicationDetail) {
     ...
     */
    public ProcedureBuilder.Impl withInstantiatesCanonical(
    ...
    public ProcedureBuilder.Impl withPerformer(@NonNull Procedure.Performer... performer) {
      this.performer = Arrays.asList(performer);
      return this;
    }
    /** @param performer - Limited to "real" people rather than equipment. */
    public ProcedureBuilder.Impl withPerformer(@NonNull Collection<Procedure.Performer> performer) {
     ...
     */
    public ProcedureBuilder.Impl withFocalDevice(@NonNull Procedure.FocalDevice... focalDevice) {
