...
public class ExplanationOfBenefit_Item_DetailBuilder {
   ...
   */
  public ExplanationOfBenefit_Item_DetailBuilder(
      Integer sequence, CodeableConcept productOrService) {
   ...
   */
  public ExplanationOfBenefit_Item_DetailBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param net */
  public ExplanationOfBenefit_Item_DetailBuilder withNet(@NonNull Money net) {
    this.net = Optional.of(net);
    return this;
  }
  /** @param udi */
  public ExplanationOfBenefit_Item_DetailBuilder withUdi(@NonNull Reference... udi) {
    this.udi = Arrays.asList(udi);
    return this;
  }
  /** @param udi */
  public ExplanationOfBenefit_Item_DetailBuilder withUdi(@NonNull Collection<Reference> udi) {
    this.udi = Collections.unmodifiableCollection(udi);
    return this;
  }
  /** @param factor */
  public ExplanationOfBenefit_Item_DetailBuilder withFactor(@NonNull BigDecimal factor) {
    this.factor = Optional.of(factor);
    return this;
  }
  /** @param revenue */
  public ExplanationOfBenefit_Item_DetailBuilder withRevenue(@NonNull CodeableConcept revenue) {
    this.revenue = Optional.of(revenue);
    return this;
  }
  /** @param category */
  public ExplanationOfBenefit_Item_DetailBuilder withCategory(@NonNull CodeableConcept category) {
    this.category = Optional.of(category);
    return this;
  }
  /** @param modifier */
  public ExplanationOfBenefit_Item_DetailBuilder withModifier(
  ...
  /** @param quantity */
  public ExplanationOfBenefit_Item_DetailBuilder withQuantity(@NonNull Quantity quantity) {
   ...
   */
  public ExplanationOfBenefit_Item_DetailBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ExplanationOfBenefit_Item_DetailBuilder withExtension(
      @NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param unitPrice */
  public ExplanationOfBenefit_Item_DetailBuilder withUnitPrice(@NonNull Money unitPrice) {
    this.unitPrice = Optional.of(unitPrice);
    return this;
  }
  /** @param noteNumber */
  public ExplanationOfBenefit_Item_DetailBuilder withNoteNumber(@NonNull Integer... noteNumber) {
    this.noteNumber = Arrays.asList(noteNumber);
    return this;
  }
  /** @param noteNumber */
  public ExplanationOfBenefit_Item_DetailBuilder withNoteNumber(
      @NonNull Collection<Integer> noteNumber) {
    this.noteNumber = Collections.unmodifiableCollection(noteNumber);
    return this;
  }
  /** @param programCode */
  public ExplanationOfBenefit_Item_DetailBuilder withProgramCode(
   ...
   */
  public ExplanationOfBenefit_Item_DetailBuilder withAdjudication(
   ...
   */
  public ExplanationOfBenefit_Item_DetailBuilder withModifierExtension(
  ...
  /** @param subDetail */
  public ExplanationOfBenefit_Item_DetailBuilder withSubDetail(
