...
public interface TerminologyCapabilities_SoftwareBuilder {
  ...
  public class Impl implements TerminologyCapabilities_SoftwareBuilder {
     ...
     */
    public TerminologyCapabilities_SoftwareBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public TerminologyCapabilities_SoftwareBuilder.Impl withVersion(@NonNull String version) {
     ...
     */
    public TerminologyCapabilities_SoftwareBuilder.Impl withExtension(
     ...
     */
    public TerminologyCapabilities_SoftwareBuilder.Impl withModifierExtension(
