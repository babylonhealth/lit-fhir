...
public interface MedicinalProductInteraction_InteractantBuilder {
  ...
  public class Impl implements MedicinalProductInteraction_InteractantBuilder {
     ...
     */
    public MedicinalProductInteraction_InteractantBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public MedicinalProductInteraction_InteractantBuilder.Impl withExtension(
     ...
     */
    public MedicinalProductInteraction_InteractantBuilder.Impl withModifierExtension(
