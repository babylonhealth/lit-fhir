...
public interface RiskEvidenceSynthesisBuilder extends DomainResourceBuilder {
  public RiskEvidenceSynthesis build();

  public static Impl init(PUBLICATION_STATUS status, Reference outcome, Reference population) {
  ...
  public class Impl implements RiskEvidenceSynthesisBuilder {
    ...
    private Optional<RiskEvidenceSynthesis.SampleSize> sampleSize = Optional.empty();
    private Optional<RiskEvidenceSynthesis.RiskEstimate> riskEstimate = Optional.empty();
    private Collection<RiskEvidenceSynthesis.Certainty> certainty = Collections.emptyList();

    /**
     * Required fields for {@link RiskEvidenceSynthesis}
     *
     * @param status - The status of this risk evidence synthesis. Enables tracking the life-cycle
     *     of the content.
     ...
     *     for the research.
     */
    public Impl(PUBLICATION_STATUS status, Reference outcome, Reference population) {
      this.status = status;
     ...
     */
    public RiskEvidenceSynthesisBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /**
     * @param url - An absolute URI that is used to identify this risk evidence synthesis when it is
     ...
     */
    public RiskEvidenceSynthesisBuilder.Impl withUrl(@NonNull String url) {
     ...
     */
    public RiskEvidenceSynthesisBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public RiskEvidenceSynthesisBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public RiskEvidenceSynthesisBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public RiskEvidenceSynthesisBuilder.Impl withText(@NonNull NarrativeBuilder text) {
     ...
     *     as code generation.
     */
    public RiskEvidenceSynthesisBuilder.Impl withName(@NonNull String name) {
      this.name = Optional.of(name);
      return this;
    }
    /**
     * @param date - The date (and optionally time) when the risk evidence synthesis was published.
     ...
     */
    public RiskEvidenceSynthesisBuilder.Impl withDate(@NonNull FHIRDateTime date) {
      this.date = Optional.of(date);
      return this;
    }
    /** @param note - A human-readable string to clarify or explain concepts about the resource. */
    public RiskEvidenceSynthesisBuilder.Impl withNote(@NonNull Annotation... note) {
      this.note = Arrays.asList(note);
      return this;
    }
    /** @param note - A human-readable string to clarify or explain concepts about the resource. */
    public RiskEvidenceSynthesisBuilder.Impl withNote(@NonNull Collection<Annotation> note) {
      this.note = Collections.unmodifiableCollection(note);
      return this;
    }

    public RiskEvidenceSynthesisBuilder.Impl withNote(@NonNull AnnotationBuilder... note) {
      this.note = Arrays.stream(note).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param title - A short, descriptive, user-friendly title for the risk evidence synthesis. */
    public RiskEvidenceSynthesisBuilder.Impl withTitle(@NonNull String title) {
      this.title = Optional.of(title);
      return this;
    }
    /**
     * @param topic - Descriptive topics related to the content of the RiskEvidenceSynthesis. Topics
     *     provide a high-level categorization grouping types of EffectEvidenceSynthesiss that can
     *     be useful for filtering and searching.
     */
    public RiskEvidenceSynthesisBuilder.Impl withTopic(@NonNull CodeableConcept... topic) {
     ...
     *     be useful for filtering and searching.
     */
    public RiskEvidenceSynthesisBuilder.Impl withTopic(@NonNull Collection<CodeableConcept> topic) {
      this.topic = Collections.unmodifiableCollection(topic);
      return this;
    }

    public RiskEvidenceSynthesisBuilder.Impl withTopic(@NonNull CodeableConceptBuilder... topic) {
     ...
     */
    public RiskEvidenceSynthesisBuilder.Impl withAuthor(@NonNull ContactDetail... author) {
     ...
     *     maintenance of the content.
     */
    public RiskEvidenceSynthesisBuilder.Impl withAuthor(@NonNull Collection<ContactDetail> author) {
      this.author = Collections.unmodifiableCollection(author);
      return this;
    }

    public RiskEvidenceSynthesisBuilder.Impl withAuthor(@NonNull ContactDetailBuilder... author) {
     ...
     *     the content.
     */
    public RiskEvidenceSynthesisBuilder.Impl withEditor(@NonNull ContactDetail... editor) {
     ...
     *     the content.
     */
    public RiskEvidenceSynthesisBuilder.Impl withEditor(@NonNull Collection<ContactDetail> editor) {
      this.editor = Collections.unmodifiableCollection(editor);
      return this;
    }

    public RiskEvidenceSynthesisBuilder.Impl withEditor(@NonNull ContactDetailBuilder... editor) {
     ...
     *     arbitrary value managed by the risk evidence synthesis author and is not expected to be
     ...
     */
    public RiskEvidenceSynthesisBuilder.Impl withVersion(@NonNull String version) {
     ...
     *     publisher.
     */
    public RiskEvidenceSynthesisBuilder.Impl withContact(@NonNull ContactDetail... contact) {
     ...
     *     publisher.
     */
    public RiskEvidenceSynthesisBuilder.Impl withContact(
        @NonNull Collection<ContactDetail> contact) {
      this.contact = Collections.unmodifiableCollection(contact);
      return this;
    }

    public RiskEvidenceSynthesisBuilder.Impl withContact(@NonNull ContactDetailBuilder... contact) {
      this.contact = Arrays.stream(contact).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public RiskEvidenceSynthesisBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public RiskEvidenceSynthesisBuilder.Impl withReviewer(@NonNull ContactDetail... reviewer) {
     ...
     *     aspect of the content.
     */
    public RiskEvidenceSynthesisBuilder.Impl withReviewer(
     ...
     */
    public RiskEvidenceSynthesisBuilder.Impl withEndorser(@NonNull ContactDetail... endorser) {
     ...
     *     content for use in some setting.
     */
    public RiskEvidenceSynthesisBuilder.Impl withEndorser(
     ...
     *     the research.
     */
    public RiskEvidenceSynthesisBuilder.Impl withExposure(@NonNull Reference exposure) {
      this.exposure = Optional.of(exposure);
      return this;
    }

    public RiskEvidenceSynthesisBuilder.Impl withExposure(@NonNull ReferenceBuilder exposure) {
     ...
     */
    public RiskEvidenceSynthesisBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public RiskEvidenceSynthesisBuilder.Impl withContained(
        @NonNull Collection<Resource> contained) {
      this.contained = Collections.unmodifiableCollection(contained);
      return this;
    }

    public RiskEvidenceSynthesisBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public RiskEvidenceSynthesisBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public RiskEvidenceSynthesisBuilder.Impl withExtension(
        @NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public RiskEvidenceSynthesisBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
      this.extension = Arrays.stream(extension).map(e -> e.build()).collect(toList());
      return this;
    }
    /**
     * @param publisher - The name of the organization or individual that published the risk
     *     evidence synthesis.
     */
    public RiskEvidenceSynthesisBuilder.Impl withPublisher(@NonNull String publisher) {
     ...
     *     of the risk evidence synthesis.
     */
    public RiskEvidenceSynthesisBuilder.Impl withCopyright(@NonNull String copyright) {
      this.copyright = Optional.of(copyright);
      return this;
    }
    /** @param studyType - Type of study eg randomized trial. */
    public RiskEvidenceSynthesisBuilder.Impl withStudyType(@NonNull CodeableConcept studyType) {
      this.studyType = Optional.of(studyType);
      return this;
    }

    public RiskEvidenceSynthesisBuilder.Impl withStudyType(
        @NonNull CodeableConceptBuilder studyType) {
      this.studyType = Optional.of(studyType.build());
      return this;
    }
    /**
     * @param identifier - A formal identifier that is used to identify this risk evidence synthesis
     *     when it is represented in other formats, or referenced in a specification, model, design
     *     or an instance.
     */
    public RiskEvidenceSynthesisBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     *     or an instance.
     */
    public RiskEvidenceSynthesisBuilder.Impl withIdentifier(
     ...
     */
    public RiskEvidenceSynthesisBuilder.Impl withUseContext(@NonNull UsageContext... useContext) {
     ...
     *     assist with indexing and searching for appropriate risk evidence synthesis instances.
     */
    public RiskEvidenceSynthesisBuilder.Impl withUseContext(
     ...
     */
    public RiskEvidenceSynthesisBuilder.Impl withDescription(@NonNull String description) {
      this.description = Optional.of(description);
      return this;
    }
    /**
     * @param jurisdiction - A legal or geographic region in which the risk evidence synthesis is
     *     intended to be used.
     */
    public RiskEvidenceSynthesisBuilder.Impl withJurisdiction(
     ...
     */
    public RiskEvidenceSynthesisBuilder.Impl withApprovalDate(@NonNull FHIRDate approvalDate) {
     ...
     *     profiles etc.
     */
    public RiskEvidenceSynthesisBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
      this.implicitRules = Optional.of(implicitRules);
      return this;
    }
    /** @param synthesisType - Type of synthesis eg meta-analysis. */
    public RiskEvidenceSynthesisBuilder.Impl withSynthesisType(
     ...
     */
    public RiskEvidenceSynthesisBuilder.Impl withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
      this.lastReviewDate = Optional.of(lastReviewDate);
      return this;
    }
    /**
     * @param effectivePeriod - The period during which the risk evidence synthesis content was or
     *     is planned to be in active use.
     */
    public RiskEvidenceSynthesisBuilder.Impl withEffectivePeriod(@NonNull Period effectivePeriod) {
      this.effectivePeriod = Optional.of(effectivePeriod);
      return this;
    }

    public RiskEvidenceSynthesisBuilder.Impl withEffectivePeriod(
     ...
     */
    public RiskEvidenceSynthesisBuilder.Impl withRelatedArtifact(
     ...
     */
    public RiskEvidenceSynthesisBuilder.Impl withModifierExtension(
    ...
    public RiskEvidenceSynthesisBuilder.Impl withSampleSize(
        @NonNull RiskEvidenceSynthesis.SampleSize sampleSize) {
      this.sampleSize = Optional.of(sampleSize);
      return this;
    }

    public RiskEvidenceSynthesisBuilder.Impl withSampleSize(
        @NonNull RiskEvidenceSynthesis_SampleSizeBuilder sampleSize) {
      this.sampleSize = Optional.of(sampleSize.build());
      return this;
    }
    /** @param riskEstimate - The estimated risk of the outcome. */
    public RiskEvidenceSynthesisBuilder.Impl withRiskEstimate(
        @NonNull RiskEvidenceSynthesis.RiskEstimate riskEstimate) {
      this.riskEstimate = Optional.of(riskEstimate);
      return this;
    }

    public RiskEvidenceSynthesisBuilder.Impl withRiskEstimate(
        @NonNull RiskEvidenceSynthesis_RiskEstimateBuilder riskEstimate) {
      this.riskEstimate = Optional.of(riskEstimate.build());
      return this;
    }
    /** @param certainty - A description of the certainty of the risk estimate. */
    public RiskEvidenceSynthesisBuilder.Impl withCertainty(
        @NonNull RiskEvidenceSynthesis.Certainty... certainty) {
      this.certainty = Arrays.asList(certainty);
      return this;
    }
    /** @param certainty - A description of the certainty of the risk estimate. */
    public RiskEvidenceSynthesisBuilder.Impl withCertainty(
        @NonNull Collection<RiskEvidenceSynthesis.Certainty> certainty) {
      this.certainty = Collections.unmodifiableCollection(certainty);
      return this;
    }

    public RiskEvidenceSynthesisBuilder.Impl withCertainty(
        @NonNull RiskEvidenceSynthesis_CertaintyBuilder... certainty) {
    ...
    public RiskEvidenceSynthesis build() {
      return new RiskEvidenceSynthesis(
          ...
          OptionConverters.toScala(riskEstimate),
