...
public class RiskEvidenceSynthesisBuilder {
   ...
   *     the research.
   */
  public RiskEvidenceSynthesisBuilder(
      PUBLICATION_STATUS status, Reference outcome, Reference population) {
    this.status = status;
   ...
   */
  public RiskEvidenceSynthesisBuilder withId(@NonNull String id) {
   ...
   *     which an authoritative instance of this risk evidence synthesis is (or will be) published.
   *     This URL can be the target of a canonical reference. It SHALL remain the same when the risk
   *     evidence synthesis is stored on different servers.
   */
  public RiskEvidenceSynthesisBuilder withUrl(@NonNull String url) {
   ...
   *     to the resource.
   */
  public RiskEvidenceSynthesisBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public RiskEvidenceSynthesisBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /**
   * @param name - A natural language name identifying the risk evidence synthesis. This name should
   *     be usable as an identifier for the module by machine processing applications such as code
   *     generation.
   */
  public RiskEvidenceSynthesisBuilder withName(@NonNull String name) {
   ...
   */
  public RiskEvidenceSynthesisBuilder withDate(@NonNull FHIRDateTime date) {
    this.date = Optional.of(date);
    return this;
  }
  /** @param note - A human-readable string to clarify or explain concepts about the resource. */
  public RiskEvidenceSynthesisBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - A human-readable string to clarify or explain concepts about the resource. */
  public RiskEvidenceSynthesisBuilder withNote(@NonNull Collection<Annotation> note) {
    this.note = Collections.unmodifiableCollection(note);
    return this;
  }
  /** @param title - A short, descriptive, user-friendly title for the risk evidence synthesis. */
  public RiskEvidenceSynthesisBuilder withTitle(@NonNull String title) {
   ...
   */
  public RiskEvidenceSynthesisBuilder withTopic(@NonNull CodeableConcept... topic) {
   ...
   *     useful for filtering and searching.
   */
  public RiskEvidenceSynthesisBuilder withTopic(@NonNull Collection<CodeableConcept> topic) {
   ...
   */
  public RiskEvidenceSynthesisBuilder withAuthor(@NonNull ContactDetail... author) {
   ...
   *     maintenance of the content.
   */
  public RiskEvidenceSynthesisBuilder withAuthor(@NonNull Collection<ContactDetail> author) {
   ...
   *     the content.
   */
  public RiskEvidenceSynthesisBuilder withEditor(@NonNull ContactDetail... editor) {
   ...
   *     the content.
   */
  public RiskEvidenceSynthesisBuilder withEditor(@NonNull Collection<ContactDetail> editor) {
   ...
   */
  public RiskEvidenceSynthesisBuilder withVersion(@NonNull String version) {
   ...
   *     publisher.
   */
  public RiskEvidenceSynthesisBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public RiskEvidenceSynthesisBuilder withContact(@NonNull Collection<ContactDetail> contact) {
    this.contact = Collections.unmodifiableCollection(contact);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public RiskEvidenceSynthesisBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   *     of the content.
   */
  public RiskEvidenceSynthesisBuilder withReviewer(@NonNull ContactDetail... reviewer) {
   ...
   *     of the content.
   */
  public RiskEvidenceSynthesisBuilder withReviewer(@NonNull Collection<ContactDetail> reviewer) {
   ...
   */
  public RiskEvidenceSynthesisBuilder withEndorser(@NonNull ContactDetail... endorser) {
   ...
   *     content for use in some setting.
   */
  public RiskEvidenceSynthesisBuilder withEndorser(@NonNull Collection<ContactDetail> endorser) {
   ...
   *     research.
   */
  public RiskEvidenceSynthesisBuilder withExposure(@NonNull Reference exposure) {
   ...
   */
  public RiskEvidenceSynthesisBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public RiskEvidenceSynthesisBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public RiskEvidenceSynthesisBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public RiskEvidenceSynthesisBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     synthesis.
   */
  public RiskEvidenceSynthesisBuilder withPublisher(@NonNull String publisher) {
   ...
   */
  public RiskEvidenceSynthesisBuilder withCopyright(@NonNull String copyright) {
    this.copyright = Optional.of(copyright);
    return this;
  }
  /** @param studyType - Type of study eg randomized trial. */
  public RiskEvidenceSynthesisBuilder withStudyType(@NonNull CodeableConcept studyType) {
   ...
   *     an instance.
   */
  public RiskEvidenceSynthesisBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     an instance.
   */
  public RiskEvidenceSynthesisBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public RiskEvidenceSynthesisBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate risk evidence synthesis instances.
   */
  public RiskEvidenceSynthesisBuilder withUseContext(@NonNull Collection<UsageContext> useContext) {
   ...
   */
  public RiskEvidenceSynthesisBuilder withDescription(@NonNull String description) {
   ...
   *     intended to be used.
   */
  public RiskEvidenceSynthesisBuilder withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
   ...
   *     intended to be used.
   */
  public RiskEvidenceSynthesisBuilder withJurisdiction(
   ...
   */
  public RiskEvidenceSynthesisBuilder withApprovalDate(@NonNull FHIRDate approvalDate) {
   ...
   *     profiles etc.
   */
  public RiskEvidenceSynthesisBuilder withImplicitRules(@NonNull String implicitRules) {
    this.implicitRules = Optional.of(implicitRules);
    return this;
  }
  /** @param synthesisType - Type of synthesis eg meta-analysis. */
  public RiskEvidenceSynthesisBuilder withSynthesisType(@NonNull CodeableConcept synthesisType) {
   ...
   */
  public RiskEvidenceSynthesisBuilder withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
    this.lastReviewDate = Optional.of(lastReviewDate);
    return this;
  }
  /**
   * @param effectivePeriod - The period during which the risk evidence synthesis content was or is
   *     planned to be in active use.
   */
  public RiskEvidenceSynthesisBuilder withEffectivePeriod(@NonNull Period effectivePeriod) {
   ...
   */
  public RiskEvidenceSynthesisBuilder withRelatedArtifact(
   ...
   */
  public RiskEvidenceSynthesisBuilder withModifierExtension(
  ...
  public RiskEvidenceSynthesisBuilder withSampleSize(
  ...
  public RiskEvidenceSynthesisBuilder withRiskEstimate(
  ...
  public RiskEvidenceSynthesisBuilder withCertainty(
  ...
  public RiskEvidenceSynthesis build() {
    return new RiskEvidenceSynthesis(
        ...
        (Option) OptionConverters.toScala(exposure),
        ...
        (Option) OptionConverters.toScala(riskEstimate),
