...
public interface Claim_PayeeBuilder {
  ...
  public class Impl implements Claim_PayeeBuilder {
     ...
     */
    public Claim_PayeeBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param party */
    public Claim_PayeeBuilder.Impl withParty(@NonNull Reference party) {
     ...
     */
    public Claim_PayeeBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     */
    public Claim_PayeeBuilder.Impl withModifierExtension(@NonNull Extension... modifierExtension) {
