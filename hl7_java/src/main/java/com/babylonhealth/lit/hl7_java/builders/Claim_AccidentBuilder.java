...
public interface Claim_AccidentBuilder {
  public Claim.Accident build();

  public static Impl init(FHIRDate date) {
  ...
  public class Impl implements Claim_AccidentBuilder {
    ...
    /**
     * Required fields for {@link Claim.Accident}
     *
     * @param date
     */
    public Impl(FHIRDate date) {
      this.date = date;
    }
     ...
     */
    public Claim_AccidentBuilder.Impl withId(@NonNull String id) {
     ...
     *     professional.
     */
    public Claim_AccidentBuilder.Impl withType(@NonNull CodeableConcept _type) {
      this._type = Optional.of(_type);
      return this;
    }

    public Claim_AccidentBuilder.Impl withType(@NonNull CodeableConceptBuilder _type) {
     ...
     */
    public Claim_AccidentBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public Claim_AccidentBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public Claim_AccidentBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
     ...
     */
    public Claim_AccidentBuilder.Impl withModifierExtension(
