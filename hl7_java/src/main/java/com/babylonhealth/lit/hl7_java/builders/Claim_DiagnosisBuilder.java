...
public interface Claim_DiagnosisBuilder {
  ...
  public class Impl implements Claim_DiagnosisBuilder {
     ...
     *     wrap with one of the Claim_DiagnosisBuilder.diagnosis static methods
     */
     ...
     */
    public Claim_DiagnosisBuilder.Impl withId(@NonNull String id) {
     ...
     *     professional.
     */
    public Claim_DiagnosisBuilder.Impl withType(@NonNull CodeableConcept... _type) {
     ...
     *     professional.
     */
    public Claim_DiagnosisBuilder.Impl withType(@NonNull Collection<CodeableConcept> _type) {
     ...
     */
    public Claim_DiagnosisBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public Claim_DiagnosisBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
