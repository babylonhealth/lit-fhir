...
public class Claim_DiagnosisBuilder {
  ...
  /**
   * Required fields for {@link Claim.Diagnosis}
   *
   * @param sequence
   ...
   */
  public Claim_DiagnosisBuilder withId(@NonNull String id) {
   ...
   */
  public Claim_DiagnosisBuilder withType(@NonNull CodeableConcept... _type) {
   ...
   * @param _type - The category of claim, e.g. oral, pharmacy, vision, institutional, professional.
   */
  public Claim_DiagnosisBuilder withType(@NonNull Collection<CodeableConcept> _type) {
   ...
   */
  public Claim_DiagnosisBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Claim_DiagnosisBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param onAdmission */
  public Claim_DiagnosisBuilder withOnAdmission(@NonNull CodeableConcept onAdmission) {
    this.onAdmission = Optional.of(onAdmission);
    return this;
  }
  /** @param packageCode */
  public Claim_DiagnosisBuilder withPackageCode(@NonNull CodeableConcept packageCode) {
   ...
   */
  public Claim_DiagnosisBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public Claim_DiagnosisBuilder withModifierExtension(
