...
public interface Consent_VerificationBuilder {
  ...
  public static Impl init(Boolean verified) {
  ...
  public class Impl implements Consent_VerificationBuilder {
     ...
     */
    public Consent_VerificationBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public Consent_VerificationBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public Consent_VerificationBuilder.Impl withExtension(
