...
public interface ServiceRequestBuilder extends DomainResourceBuilder {
  ...
  public class Impl implements ServiceRequestBuilder {
     ...
     */
    public ServiceRequestBuilder.Impl withQuantity(@NonNull Choice_0575082635 quantity) {
     ...
     */
    public ServiceRequestBuilder.Impl withAsNeeded(@NonNull Choice_1768247138 asNeeded) {
     ...
     */
    public ServiceRequestBuilder.Impl withOccurrence(@NonNull Choice00609373412 occurrence) {
