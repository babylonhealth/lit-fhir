...
public class ServiceRequestBuilder {
   ...
   *     patient, but can also be requested on animals, groups of humans or animals, devices such as
   *     dialysis machines, or even locations (typically for environmental scans).
   */
  public ServiceRequestBuilder(REQUEST_STATUS status, REQUEST_INTENT intent, Reference subject) {
    this.status = status;
    this.intent = intent;
   ...
   */
  public ServiceRequestBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public ServiceRequestBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public ServiceRequestBuilder withText(@NonNull Narrative text) {
   ...
   */
  public ServiceRequestBuilder withCode(@NonNull CodeableConcept code) {
   ...
   */
  public ServiceRequestBuilder withNote(@NonNull Annotation... note) {
   ...
   *     internal billing notes.
   */
  public ServiceRequestBuilder withNote(@NonNull Collection<Annotation> note) {
    this.note = Collections.unmodifiableCollection(note);
    return this;
  }
  /** @param basedOn - Plan/proposal/order fulfilled by this request. */
  public ServiceRequestBuilder withBasedOn(@NonNull Reference... basedOn) {
    this.basedOn = Arrays.asList(basedOn);
    return this;
  }
  /** @param basedOn - Plan/proposal/order fulfilled by this request. */
  public ServiceRequestBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public ServiceRequestBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   *     request(s).
   */
  public ServiceRequestBuilder withReplaces(@NonNull Reference... replaces) {
   ...
   *     request(s).
   */
  public ServiceRequestBuilder withReplaces(@NonNull Collection<Reference> replaces) {
   ...
   */
  public ServiceRequestBuilder withCategory(@NonNull CodeableConcept... category) {
   ...
   *     purposes (e.g. "Surgical Procedure").
   */
  public ServiceRequestBuilder withCategory(@NonNull Collection<CodeableConcept> category) {
   ...
   *     other requests.
   */
  public ServiceRequestBuilder withPriority(@NonNull REQUEST_PRIORITY priority) {
    this.priority = Optional.of(priority);
    return this;
  }
  /** @param specimen - One or more specimens that the laboratory procedure will use. */
  public ServiceRequestBuilder withSpecimen(@NonNull Reference... specimen) {
    this.specimen = Arrays.asList(specimen);
    return this;
  }
  /** @param specimen - One or more specimens that the laboratory procedure will use. */
  public ServiceRequestBuilder withSpecimen(@NonNull Collection<Reference> specimen) {
   ...
   *     site.
   */
  public ServiceRequestBuilder withBodySite(@NonNull CodeableConcept... bodySite) {
   ...
   *     site.
   */
  public ServiceRequestBuilder withBodySite(@NonNull Collection<CodeableConcept> bodySite) {
   ...
   */
  public ServiceRequestBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public ServiceRequestBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public ServiceRequestBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ServiceRequestBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public ServiceRequestBuilder withEncounter(@NonNull Reference encounter) {
   ...
   *     activation.
   */
  public ServiceRequestBuilder withRequester(@NonNull Reference requester) {
   ...
   */
  public ServiceRequestBuilder withPerformer(@NonNull Reference... performer) {
   ...
   *     surgeon, dermatopathologist, endoscopist, etc.
   */
  public ServiceRequestBuilder withPerformer(@NonNull Collection<Reference> performer) {
   ...
   */
  public ServiceRequestBuilder withInsurance(@NonNull Reference... insurance) {
   ...
   *     pre-determinations that may be needed for delivering the requested service.
   */
  public ServiceRequestBuilder withInsurance(@NonNull Collection<Reference> insurance) {
   ...
   */
  public ServiceRequestBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     receiver and/or order fulfiller.
   */
  public ServiceRequestBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
    this.identifier = Collections.unmodifiableCollection(identifier);
    return this;
  }
  /** @param authoredOn - When the request transitioned to being actionable. */
  public ServiceRequestBuilder withAuthoredOn(@NonNull FHIRDateTime authoredOn) {
   ...
   */
  public ServiceRequestBuilder withReasonCode(@NonNull CodeableConcept... reasonCode) {
   ...
   *     referred to in `supportingInfo`.
   */
  public ServiceRequestBuilder withReasonCode(@NonNull Collection<CodeableConcept> reasonCode) {
   ...
   *     identifier.
   */
  public ServiceRequestBuilder withRequisition(@NonNull Identifier requisition) {
   ...
   */
  public ServiceRequestBuilder withOrderDetail(@NonNull CodeableConcept... orderDetail) {
   ...
   *     instructions specifying how the bandage should be applied.
   */
  public ServiceRequestBuilder withOrderDetail(@NonNull Collection<CodeableConcept> orderDetail) {
   ...
   */
  public ServiceRequestBuilder withDoNotPerform(@NonNull Boolean doNotPerform) {
   ...
   */
  public ServiceRequestBuilder withLocationCode(@NonNull CodeableConcept... locationCode) {
   ...
   *     coded or free text form. E.g. at home or nursing day care center.
   */
  public ServiceRequestBuilder withLocationCode(@NonNull Collection<CodeableConcept> locationCode) {
   ...
   *     profiles etc.
   */
  public ServiceRequestBuilder withImplicitRules(@NonNull String implicitRules) {
  ...
  public ServiceRequestBuilder withPerformerType(@NonNull CodeableConcept performerType) {
   ...
   *     influence the services or their interpretations. This information includes diagnosis,
   *     clinical findings and other observations. In laboratory ordering these are typically
   *     referred to as "ask at order entry questions (AOEs)". This includes observations explicitly
   ...
   *     measurements.
   */
  public ServiceRequestBuilder withSupportingInfo(@NonNull Reference... supportingInfo) {
   ...
   *     measurements.
   */
  public ServiceRequestBuilder withSupportingInfo(@NonNull Collection<Reference> supportingInfo) {
   ...
   *     orderset or other definition that is adhered to in whole or in part by this ServiceRequest.
   */
  public ServiceRequestBuilder withInstantiatesUri(@NonNull String... instantiatesUri) {
   ...
   *     orderset or other definition that is adhered to in whole or in part by this ServiceRequest.
   */
  public ServiceRequestBuilder withInstantiatesUri(@NonNull Collection<String> instantiatesUri) {
    this.instantiatesUri = Collections.unmodifiableCollection(instantiatesUri);
    return this;
  }
  /**
   * @param reasonReference - Indicates another resource that provides a justification for why this
   *     service is being requested. May relate to the resources referred to in `supportingInfo`.
   */
  public ServiceRequestBuilder withReasonReference(@NonNull Reference... reasonReference) {
   ...
   *     service is being requested. May relate to the resources referred to in `supportingInfo`.
   */
  public ServiceRequestBuilder withReasonReference(@NonNull Collection<Reference> reasonReference) {
    this.reasonReference = Collections.unmodifiableCollection(reasonReference);
    return this;
  }
  /** @param relevantHistory - Key events in the history of the request. */
  public ServiceRequestBuilder withRelevantHistory(@NonNull Reference... relevantHistory) {
    this.relevantHistory = Arrays.asList(relevantHistory);
    return this;
  }
  /** @param relevantHistory - Key events in the history of the request. */
  public ServiceRequestBuilder withRelevantHistory(@NonNull Collection<Reference> relevantHistory) {
   ...
   */
  public ServiceRequestBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public ServiceRequestBuilder withModifierExtension(
   ...
   */
  public ServiceRequestBuilder withLocationReference(@NonNull Reference... locationReference) {
   ...
   *     should actually happen. E.g. at home or nursing day care center.
   */
  public ServiceRequestBuilder withLocationReference(
   ...
   *     consumer.
   */
  public ServiceRequestBuilder withPatientInstruction(@NonNull String patientInstruction) {
   ...
   *     or other definition that is adhered to in whole or in part by this ServiceRequest.
   */
  public ServiceRequestBuilder withInstantiatesCanonical(@NonNull String... instantiatesCanonical) {
   ...
   *     or other definition that is adhered to in whole or in part by this ServiceRequest.
   */
  public ServiceRequestBuilder withInstantiatesCanonical(
