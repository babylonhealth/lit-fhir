...
public class Questionnaire_Item_AnswerOptionBuilder {
   ...
   */
  public Questionnaire_Item_AnswerOptionBuilder withId(@NonNull String id) {
   ...
   */
  public Questionnaire_Item_AnswerOptionBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Questionnaire_Item_AnswerOptionBuilder withExtension(
      @NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param initialSelected */
  public Questionnaire_Item_AnswerOptionBuilder withInitialSelected(
   ...
   */
  public Questionnaire_Item_AnswerOptionBuilder withModifierExtension(
