...
public class InvoiceBuilder {
  ...
  private Collection<Invoice$LineItem$PriceComponent> totalPriceComponent = Collections.emptyList();
   ...
   */
  public InvoiceBuilder(INVOICE_STATUS status) {
    this.status = status;
  }
   ...
   */
  public InvoiceBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public InvoiceBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public InvoiceBuilder withText(@NonNull Narrative text) {
   ...
   *     dental, preliminary).
   */
  public InvoiceBuilder withType(@NonNull CodeableConcept _type) {
    this._type = Optional.of(_type);
    return this;
  }
  /** @param date - Date/time(s) of when this Invoice was posted. */
  public InvoiceBuilder withDate(@NonNull FHIRDateTime date) {
   ...
   */
  public InvoiceBuilder withNote(@NonNull Annotation... note) {
   ...
   * @param note - Comments made about the invoice by the issuer, subject, or other participants.
   */
  public InvoiceBuilder withNote(@NonNull Collection<Annotation> note) {
    this.note = Collections.unmodifiableCollection(note);
    return this;
  }
  /** @param issuer - The organizationissuing the Invoice. */
  public InvoiceBuilder withIssuer(@NonNull Reference issuer) {
   ...
   *     in this invoice.
   */
  public InvoiceBuilder withSubject(@NonNull Reference subject) {
    this.subject = Optional.of(subject);
    return this;
  }
  /** @param account - Account which is supposed to be balanced with this Invoice. */
  public InvoiceBuilder withAccount(@NonNull Reference account) {
    this.account = Optional.of(account);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public InvoiceBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param totalNet - Invoice total , taxes excluded. */
  public InvoiceBuilder withTotalNet(@NonNull Money totalNet) {
   ...
   */
  public InvoiceBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public InvoiceBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public InvoiceBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public InvoiceBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public InvoiceBuilder withRecipient(@NonNull Reference recipient) {
   ...
   */
  public InvoiceBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     about this invoice or for tracking of payments.
   */
  public InvoiceBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
    this.identifier = Collections.unmodifiableCollection(identifier);
    return this;
  }
  /** @param totalGross - Invoice total, tax included. */
  public InvoiceBuilder withTotalGross(@NonNull Money totalGross) {
   ...
   *     methods of payment.
   */
  public InvoiceBuilder withPaymentTerms(@NonNull String paymentTerms) {
   ...
   *     profiles etc.
   */
  public InvoiceBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public InvoiceBuilder withCancelledReason(@NonNull String cancelledReason) {
   ...
   */
  public InvoiceBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public InvoiceBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
   ...
   */
  public InvoiceBuilder withTotalPriceComponent(
   ...
   */
  public InvoiceBuilder withParticipant(@NonNull Invoice.Participant... participant) {
   ...
   * @param participant - Indicates who or what performed or participated in the charged service.
   */
  public InvoiceBuilder withParticipant(@NonNull Collection<Invoice.Participant> participant) {
   ...
   */
  public InvoiceBuilder withLineItem(@NonNull Invoice.LineItem... lineItem) {
   ...
   *     such as date, code and amount are found in the referenced ChargeItem resource.
   */
  public InvoiceBuilder withLineItem(@NonNull Collection<Invoice.LineItem> lineItem) {
