...
public class Coverage_CostToBeneficiaryBuilder {
   ...
   */
  public Coverage_CostToBeneficiaryBuilder withId(@NonNull String id) {
   ...
   */
  public Coverage_CostToBeneficiaryBuilder withType(@NonNull CodeableConcept _type) {
   ...
   */
  public Coverage_CostToBeneficiaryBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Coverage_CostToBeneficiaryBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public Coverage_CostToBeneficiaryBuilder withModifierExtension(
  ...
  /** @param exception */
  public Coverage_CostToBeneficiaryBuilder withException(
