...
public interface ImplementationGuide_Definition_GroupingBuilder {
  ...
  public class Impl implements ImplementationGuide_Definition_GroupingBuilder {
     ...
     */
    public ImplementationGuide_Definition_GroupingBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public ImplementationGuide_Definition_GroupingBuilder.Impl withExtension(
     ...
     */
    public ImplementationGuide_Definition_GroupingBuilder.Impl withDescription(
     ...
     */
    public ImplementationGuide_Definition_GroupingBuilder.Impl withModifierExtension(
