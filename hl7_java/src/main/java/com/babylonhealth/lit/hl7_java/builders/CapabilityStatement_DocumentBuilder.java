...
public interface CapabilityStatement_DocumentBuilder {
  public CapabilityStatement.Document build();

  public static Impl init(DOCUMENT_MODE mode, String profile) {
  ...
  public class Impl implements CapabilityStatement_DocumentBuilder {
     ...
     * @param profile
     */
    public Impl(DOCUMENT_MODE mode, String profile) {
      this.mode = mode;
     ...
     */
    public CapabilityStatement_DocumentBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public CapabilityStatement_DocumentBuilder.Impl withExtension(@NonNull Extension... extension) {
