...
public class ObservationDefinitionBuilder {
   ...
   *
   * @param code - Describes what will be observed. Sometimes this is called the observation "name".
   */
  public ObservationDefinitionBuilder(CodeableConcept code) {
    this.code = code;
  }
   ...
   */
  public ObservationDefinitionBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public ObservationDefinitionBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public ObservationDefinitionBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param method - The method or technique used to perform the observation. */
  public ObservationDefinitionBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public ObservationDefinitionBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param category - A code that classifies the general type of observation. */
  public ObservationDefinitionBuilder withCategory(@NonNull CodeableConcept... category) {
    this.category = Arrays.asList(category);
    return this;
  }
  /** @param category - A code that classifies the general type of observation. */
  public ObservationDefinitionBuilder withCategory(@NonNull Collection<CodeableConcept> category) {
   ...
   */
  public ObservationDefinitionBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public ObservationDefinitionBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public ObservationDefinitionBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ObservationDefinitionBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this ObservationDefinition artifact. */
  public ObservationDefinitionBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this ObservationDefinition artifact. */
  public ObservationDefinitionBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   *     profiles etc.
   */
  public ObservationDefinitionBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public ObservationDefinitionBuilder withModifierExtension(
   ...
   */
  public ObservationDefinitionBuilder withPermittedDataType(
   ...
   */
  public ObservationDefinitionBuilder withValidCodedValueSet(
   ...
   *     observations conforming to this ObservationDefinition.
   */
  public ObservationDefinitionBuilder withPreferredReportName(@NonNull String preferredReportName) {
    this.preferredReportName = Optional.of(preferredReportName);
    return this;
  }
  /**
   * @param normalCodedValueSet - The set of normal coded results for the observations conforming to
   *     this ObservationDefinition.
   */
  public ObservationDefinitionBuilder withNormalCodedValueSet(
      @NonNull Reference normalCodedValueSet) {
    this.normalCodedValueSet = Optional.of(normalCodedValueSet);
    return this;
  }
  /**
   * @param abnormalCodedValueSet - The set of abnormal coded results for the observation conforming
   *     to this ObservationDefinition.
   */
  public ObservationDefinitionBuilder withAbnormalCodedValueSet(
      @NonNull Reference abnormalCodedValueSet) {
    this.abnormalCodedValueSet = Optional.of(abnormalCodedValueSet);
    return this;
  }
  /**
   * @param criticalCodedValueSet - The set of critical coded results for the observation conforming
   *     to this ObservationDefinition.
   */
  public ObservationDefinitionBuilder withCriticalCodedValueSet(
   ...
   */
  public ObservationDefinitionBuilder withMultipleResultsAllowed(
   ...
   */
  public ObservationDefinitionBuilder withQualifiedInterval(
  ...
  public ObservationDefinitionBuilder withQuantitativeDetails(
