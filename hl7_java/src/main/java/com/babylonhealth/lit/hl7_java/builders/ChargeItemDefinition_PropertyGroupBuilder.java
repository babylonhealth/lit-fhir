...
public class ChargeItemDefinition_PropertyGroupBuilder {
  ...
  public ChargeItemDefinition_PropertyGroupBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public ChargeItemDefinition_PropertyGroupBuilder withId(@NonNull String id) {
   ...
   */
  public ChargeItemDefinition_PropertyGroupBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ChargeItemDefinition_PropertyGroupBuilder withExtension(
   ...
   */
  public ChargeItemDefinition_PropertyGroupBuilder withApplicability(
   ...
   */
  public ChargeItemDefinition_PropertyGroupBuilder withModifierExtension(
  ...
  public ChargeItemDefinition_PropertyGroupBuilder withPriceComponent(
