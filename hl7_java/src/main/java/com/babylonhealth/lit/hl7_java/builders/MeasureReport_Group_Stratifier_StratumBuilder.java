...
public class MeasureReport_Group_Stratifier_StratumBuilder {
  ...
  public MeasureReport_Group_Stratifier_StratumBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public MeasureReport_Group_Stratifier_StratumBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param value */
  public MeasureReport_Group_Stratifier_StratumBuilder withValue(@NonNull CodeableConcept value) {
   ...
   */
  public MeasureReport_Group_Stratifier_StratumBuilder withExtension(
  ...
  /** @param measureScore */
  public MeasureReport_Group_Stratifier_StratumBuilder withMeasureScore(
   ...
   */
  public MeasureReport_Group_Stratifier_StratumBuilder withModifierExtension(
  ...
  /** @param component */
  public MeasureReport_Group_Stratifier_StratumBuilder withComponent(
  ...
  /** @param population */
  public MeasureReport_Group_Stratifier_StratumBuilder withPopulation(
