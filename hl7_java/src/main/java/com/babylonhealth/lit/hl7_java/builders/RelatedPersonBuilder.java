...
public interface RelatedPersonBuilder extends DomainResourceBuilder {
  ...
  public class Impl implements RelatedPersonBuilder {
     ...
     */
    public RelatedPersonBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public RelatedPersonBuilder.Impl withMeta(@NonNull Meta meta) {
    ...
    public RelatedPersonBuilder.Impl withName(@NonNull HumanName... name) {
      this.name = Arrays.asList(name);
      return this;
    }
    /** @param name - A name associated with the person. */
    public RelatedPersonBuilder.Impl withName(@NonNull Collection<HumanName> name) {
    ...
    public RelatedPersonBuilder.Impl withActive(@NonNull Boolean active) {
     ...
     */
    public RelatedPersonBuilder.Impl withGender(@NonNull ADMINISTRATIVE_GENDER gender) {
     ...
     */
    public RelatedPersonBuilder.Impl withPeriod(@NonNull Period period) {
     ...
     *     address.
     */
    public RelatedPersonBuilder.Impl withTelecom(@NonNull ContactPoint... telecom) {
     ...
     *     address.
     */
    public RelatedPersonBuilder.Impl withTelecom(@NonNull Collection<ContactPoint> telecom) {
    ...
    public RelatedPersonBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public RelatedPersonBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public RelatedPersonBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
     ...
     */
    public RelatedPersonBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public RelatedPersonBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
    ...
    public RelatedPersonBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     *     person.
     */
    public RelatedPersonBuilder.Impl withRelationship(@NonNull CodeableConcept... relationship) {
     ...
     *     profiles etc.
     */
    public RelatedPersonBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
