...
public class RelatedPersonBuilder {
  ...
  /**
   * Required fields for {@link RelatedPerson}
   *
   * @param patient - The patient this person is related to.
   */
  public RelatedPersonBuilder(Reference patient) {
   ...
   */
  public RelatedPersonBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public RelatedPersonBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public RelatedPersonBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param name - A name associated with the person. */
  public RelatedPersonBuilder withName(@NonNull HumanName... name) {
    this.name = Arrays.asList(name);
    return this;
  }
  /** @param name - A name associated with the person. */
  public RelatedPersonBuilder withName(@NonNull Collection<HumanName> name) {
    this.name = Collections.unmodifiableCollection(name);
    return this;
  }
  /** @param photo - Image of the person. */
  public RelatedPersonBuilder withPhoto(@NonNull Attachment... photo) {
    this.photo = Arrays.asList(photo);
    return this;
  }
  /** @param photo - Image of the person. */
  public RelatedPersonBuilder withPhoto(@NonNull Collection<Attachment> photo) {
    this.photo = Collections.unmodifiableCollection(photo);
    return this;
  }
  /** @param active - Whether this related person record is in active use. */
  public RelatedPersonBuilder withActive(@NonNull Boolean active) {
   ...
   */
  public RelatedPersonBuilder withGender(@NonNull ADMINISTRATIVE_GENDER gender) {
   ...
   */
  public RelatedPersonBuilder withPeriod(@NonNull Period period) {
   ...
   */
  public RelatedPersonBuilder withTelecom(@NonNull ContactPoint... telecom) {
   ...
   * @param telecom - A contact detail for the person, e.g. a telephone number or an email address.
   */
  public RelatedPersonBuilder withTelecom(@NonNull Collection<ContactPoint> telecom) {
  ...
  public RelatedPersonBuilder withAddress(@NonNull Address... address) {
    this.address = Arrays.asList(address);
    return this;
  }
  /** @param address - Address where the related person can be contacted or visited. */
  public RelatedPersonBuilder withAddress(@NonNull Collection<Address> address) {
    this.address = Collections.unmodifiableCollection(address);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public RelatedPersonBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public RelatedPersonBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public RelatedPersonBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public RelatedPersonBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public RelatedPersonBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param birthDate - The date on which the related person was born. */
  public RelatedPersonBuilder withBirthDate(@NonNull FHIRDate birthDate) {
    this.birthDate = Optional.of(birthDate);
    return this;
  }
  /** @param identifier - Identifier for a person within a particular scope. */
  public RelatedPersonBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - Identifier for a person within a particular scope. */
  public RelatedPersonBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public RelatedPersonBuilder withRelationship(@NonNull CodeableConcept... relationship) {
   ...
   * @param relationship - The nature of the relationship between a patient and the related person.
   */
  public RelatedPersonBuilder withRelationship(@NonNull Collection<CodeableConcept> relationship) {
   ...
   *     profiles etc.
   */
  public RelatedPersonBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public RelatedPersonBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public RelatedPersonBuilder withModifierExtension(
   ...
   *     health.
   */
  public RelatedPersonBuilder withCommunication(
