...
public interface DeviceDefinition_CapabilityBuilder {
  ...
  public class Impl implements DeviceDefinition_CapabilityBuilder {
     ...
     */
    public DeviceDefinition_CapabilityBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public DeviceDefinition_CapabilityBuilder.Impl withExtension(@NonNull Extension... extension) {
