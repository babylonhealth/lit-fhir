...
public class MedicinalProductIngredientBuilder {
   ...
   */
  public MedicinalProductIngredientBuilder(CodeableConcept role) {
    this.role = role;
  }
   ...
   */
  public MedicinalProductIngredientBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public MedicinalProductIngredientBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public MedicinalProductIngredientBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public MedicinalProductIngredientBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public MedicinalProductIngredientBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public MedicinalProductIngredientBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public MedicinalProductIngredientBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public MedicinalProductIngredientBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     not appropriate.
   */
  public MedicinalProductIngredientBuilder withIdentifier(@NonNull Identifier identifier) {
    this.identifier = Optional.of(identifier);
    return this;
  }
  /** @param manufacturer - Manufacturer of this Ingredient. */
  public MedicinalProductIngredientBuilder withManufacturer(@NonNull Reference... manufacturer) {
    this.manufacturer = Arrays.asList(manufacturer);
    return this;
  }
  /** @param manufacturer - Manufacturer of this Ingredient. */
  public MedicinalProductIngredientBuilder withManufacturer(
   ...
   *     profiles etc.
   */
  public MedicinalProductIngredientBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public MedicinalProductIngredientBuilder withModifierExtension(
  ...
  public MedicinalProductIngredientBuilder withAllergenicIndicator(
  ...
  public MedicinalProductIngredientBuilder withSubstance(
  ...
  public MedicinalProductIngredientBuilder withSpecifiedSubstance(
