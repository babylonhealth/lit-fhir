...
public class PeriodBuilder {
   ...
   */
  public PeriodBuilder withId(@NonNull String id) {
   ...
   *     time.
   */
  public PeriodBuilder withEnd(@NonNull FHIRDateTime end) {
    this.end = Optional.of(end);
    return this;
  }
  /** @param start - The start of the period. The boundary is inclusive. */
  public PeriodBuilder withStart(@NonNull FHIRDateTime start) {
   ...
   */
  public PeriodBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public PeriodBuilder withExtension(@NonNull Collection<Extension> extension) {
