...
public class DurationBuilder {
   ...
   */
  public DurationBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param unit - A human-readable form of the unit. */
  public DurationBuilder withUnit(@NonNull String unit) {
    this.unit = Optional.of(unit);
    return this;
  }
  /** @param code - A computer processable form of the unit in some unit representation system. */
  public DurationBuilder withCode(@NonNull String code) {
   ...
   */
  public DurationBuilder withValue(@NonNull BigDecimal value) {
    this.value = Optional.of(value);
    return this;
  }
  /** @param system - The identification of the system that provides the coded form of the unit. */
  public DurationBuilder withSystem(@NonNull String system) {
   ...
   */
  public DurationBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public DurationBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public DurationBuilder withComparator(@NonNull QUANTITY_COMPARATOR comparator) {
