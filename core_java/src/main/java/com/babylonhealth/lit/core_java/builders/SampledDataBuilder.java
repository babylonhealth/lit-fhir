...
public class SampledDataBuilder {
   ...
   */
  public SampledDataBuilder(Quantity origin, BigDecimal period, Integer dimensions) {
    this.origin = origin;
    this.period = period;
   ...
   */
  public SampledDataBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /**
   * @param data - A series of data points which are decimal values separated by a single space
   *     (character u20). The special values "E" (error), "L" (below detection limit) and "U" (above
   *     detection limit) can also be used in place of a decimal value.
   */
  public SampledDataBuilder withData(@NonNull String data) {
   ...
   *     added to the origin.
   */
  public SampledDataBuilder withFactor(@NonNull BigDecimal factor) {
   ...
   */
  public SampledDataBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public SampledDataBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /**
   * @param lowerLimit - The lower limit of detection of the measured points. This is needed if any
   *     of the data points have the value "L" (lower than detection limit).
   */
  public SampledDataBuilder withLowerLimit(@NonNull BigDecimal lowerLimit) {
    this.lowerLimit = Optional.of(lowerLimit);
    return this;
  }
  /**
   * @param upperLimit - The upper limit of detection of the measured points. This is needed if any
   *     of the data points have the value "U" (higher than detection limit).
   */
  public SampledDataBuilder withUpperLimit(@NonNull BigDecimal upperLimit) {
