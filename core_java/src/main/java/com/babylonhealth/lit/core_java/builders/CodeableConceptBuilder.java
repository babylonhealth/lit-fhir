...
public class CodeableConceptBuilder {
   ...
   */
  public CodeableConceptBuilder withId(@NonNull String id) {
   ...
   */
  public CodeableConceptBuilder withText(@NonNull String text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param coding - A reference to a code defined by a terminology system. */
  public CodeableConceptBuilder withCoding(@NonNull Coding... coding) {
    this.coding = Arrays.asList(coding);
    return this;
  }
  /** @param coding - A reference to a code defined by a terminology system. */
  public CodeableConceptBuilder withCoding(@NonNull Collection<Coding> coding) {
   ...
   */
  public CodeableConceptBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public CodeableConceptBuilder withExtension(@NonNull Collection<Extension> extension) {
