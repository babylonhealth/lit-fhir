...
public interface AgeBuilder extends QuantityBuilder {
  public Age build();
  ...
  public class Impl implements AgeBuilder {
     ...
     */
    public AgeBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param unit - A human-readable form of the unit. */
    public AgeBuilder.Impl withUnit(@NonNull String unit) {
      this.unit = Optional.of(unit);
      return this;
    }
    /** @param code - A computer processable form of the unit in some unit representation system. */
    public AgeBuilder.Impl withCode(@NonNull String code) {
     ...
     */
    public AgeBuilder.Impl withValue(@NonNull BigDecimal value) {
     ...
     */
    public AgeBuilder.Impl withSystem(@NonNull String system) {
     ...
     */
    public AgeBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     part of the definition of the extension.
     */
    public AgeBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public AgeBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
     ...
     */
    public AgeBuilder.Impl withComparator(@NonNull QUANTITY_COMPARATOR comparator) {
