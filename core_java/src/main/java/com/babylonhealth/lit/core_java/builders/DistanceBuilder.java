...
public interface DistanceBuilder extends QuantityBuilder {
  ...
  public class Impl implements DistanceBuilder {
    ...
    /** Required fields for {@link Distance} */
    public Impl() {}
     ...
     */
    public DistanceBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param unit - A human-readable form of the unit. */
    public DistanceBuilder.Impl withUnit(@NonNull String unit) {
      this.unit = Optional.of(unit);
      return this;
    }
    /** @param code - A computer processable form of the unit in some unit representation system. */
    public DistanceBuilder.Impl withCode(@NonNull String code) {
     ...
     */
    public DistanceBuilder.Impl withValue(@NonNull BigDecimal value) {
     ...
     */
    public DistanceBuilder.Impl withSystem(@NonNull String system) {
     ...
     */
    public DistanceBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     part of the definition of the extension.
     */
    public DistanceBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public DistanceBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
     ...
     */
    public DistanceBuilder.Impl withComparator(@NonNull QUANTITY_COMPARATOR comparator) {
