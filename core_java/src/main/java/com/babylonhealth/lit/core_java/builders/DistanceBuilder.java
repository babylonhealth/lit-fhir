...
public class DistanceBuilder {
   ...
   */
  public DistanceBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param unit - A human-readable form of the unit. */
  public DistanceBuilder withUnit(@NonNull String unit) {
    this.unit = Optional.of(unit);
    return this;
  }
  /** @param code - A computer processable form of the unit in some unit representation system. */
  public DistanceBuilder withCode(@NonNull String code) {
   ...
   */
  public DistanceBuilder withValue(@NonNull BigDecimal value) {
    this.value = Optional.of(value);
    return this;
  }
  /** @param system - The identification of the system that provides the coded form of the unit. */
  public DistanceBuilder withSystem(@NonNull String system) {
   ...
   */
  public DistanceBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public DistanceBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public DistanceBuilder withComparator(@NonNull QUANTITY_COMPARATOR comparator) {
