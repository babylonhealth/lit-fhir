...
public class ParameterDefinitionBuilder {
   ...
   */
  public ParameterDefinitionBuilder(OPERATION_PARAMETER_USE use, ALL_TYPES _type) {
    this.use = use;
    this._type = _type;
  }
   ...
   */
  public ParameterDefinitionBuilder withId(@NonNull String id) {
   ...
   *     response.
   */
  public ParameterDefinitionBuilder withMin(@NonNull Integer min) {
    this.min = Optional.of(min);
    return this;
  }
  /**
   * @param max - The maximum number of times this element is permitted to appear in the request or
   *     response.
   */
  public ParameterDefinitionBuilder withMax(@NonNull String max) {
   ...
   *     evaluation contexts.
   */
  public ParameterDefinitionBuilder withName(@NonNull String name) {
   ...
   */
  public ParameterDefinitionBuilder withProfile(@NonNull String profile) {
   ...
   */
  public ParameterDefinitionBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ParameterDefinitionBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     the module.
   */
  public ParameterDefinitionBuilder withDocumentation(@NonNull String documentation) {
