...
public class HumanNameBuilder {
   ...
   */
  public HumanNameBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param use - Identifies the purpose for this name. */
  public HumanNameBuilder withUse(@NonNull NAME_USE use) {
   ...
   */
  public HumanNameBuilder withText(@NonNull String text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param given - Given name. */
  public HumanNameBuilder withGiven(@NonNull String... given) {
    this.given = Arrays.asList(given);
    return this;
  }
  /** @param given - Given name. */
  public HumanNameBuilder withGiven(@NonNull Collection<String> given) {
    this.given = Collections.unmodifiableCollection(given);
    return this;
  }
  /**
   * @param family - The part of a name that links to the genealogy. In some cultures (e.g. Eritrea)
   *     the family name of a son is the first name of his father.
   */
  public HumanNameBuilder withFamily(@NonNull String family) {
    this.family = Optional.of(family);
    return this;
  }
  /**
   * @param prefix - Part of the name that is acquired as a title due to academic, legal, employment
   *     or nobility status, etc. and that appears at the start of the name.
   */
  public HumanNameBuilder withPrefix(@NonNull String... prefix) {
   ...
   *     or nobility status, etc. and that appears at the start of the name.
   */
  public HumanNameBuilder withPrefix(@NonNull Collection<String> prefix) {
    this.prefix = Collections.unmodifiableCollection(prefix);
    return this;
  }
  /**
   * @param suffix - Part of the name that is acquired as a title due to academic, legal, employment
   *     or nobility status, etc. and that appears at the end of the name.
   */
  public HumanNameBuilder withSuffix(@NonNull String... suffix) {
   ...
   *     or nobility status, etc. and that appears at the end of the name.
   */
  public HumanNameBuilder withSuffix(@NonNull Collection<String> suffix) {
  ...
  public HumanNameBuilder withPeriod(@NonNull Period period) {
   ...
   */
  public HumanNameBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public HumanNameBuilder withExtension(@NonNull Collection<Extension> extension) {
