...
public class Us_core_observation_labBuilder {
   ...
   *
   * @param code - The test that was performed. A LOINC **SHALL** be used if the concept is present
   *     in LOINC.
   ...
   */
  public Us_core_observation_labBuilder(
   ...
   */
  public Us_core_observation_labBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public Us_core_observation_labBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public Us_core_observation_labBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public Us_core_observation_labBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public Us_core_observation_labBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   */
  public Us_core_observation_labBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     patient of record and the mother is the focus.
   */
  public Us_core_observation_labBuilder withFocus(@NonNull Collection<Reference> focus) {
   ...
   */
  public Us_core_observation_labBuilder withPartOf(@NonNull Reference... partOf) {
   ...
   *     example, an observation as part of a procedure.
   */
  public Us_core_observation_labBuilder withPartOf(@NonNull Collection<Reference> partOf) {
   ...
   */
  public Us_core_observation_labBuilder withIssued(@NonNull ZonedDateTime issued) {
    this.issued = Optional.of(issued);
    return this;
  }
  /** @param method - Indicates the mechanism used to perform the observation. */
  public Us_core_observation_labBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param device - The device used to generate the observation data. */
  public Us_core_observation_labBuilder withDevice(@NonNull Reference device) {
   ...
   */
  public Us_core_observation_labBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     before it is dispensed.
   */
  public Us_core_observation_labBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public Us_core_observation_labBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   *     the target site).
   */
  public Us_core_observation_labBuilder withBodySite(@NonNull CodeableConcept bodySite) {
    this.bodySite = Optional.of(bodySite);
    return this;
  }
  /** @param specimen - The specimen that was used when this observation was made. */
  public Us_core_observation_labBuilder withSpecimen(@NonNull Reference specimen) {
   ...
   */
  public Us_core_observation_labBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public Us_core_observation_labBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public Us_core_observation_labBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Us_core_observation_labBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public Us_core_observation_labBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public Us_core_observation_labBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public Us_core_observation_labBuilder withPerformer(@NonNull Collection<Reference> performer) {
   ...
   */
  public Us_core_observation_labBuilder withHasMember(@NonNull Reference... hasMember) {
   ...
   *     set of vital sign measurements) that includes the target as a member of the group.
   */
  public Us_core_observation_labBuilder withHasMember(@NonNull Collection<Reference> hasMember) {
  ...
  public Us_core_observation_labBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public Us_core_observation_labBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public Us_core_observation_labBuilder withDerivedFrom(@NonNull Reference... derivedFrom) {
   ...
   *     based on an ultrasound image.
   */
  public Us_core_observation_labBuilder withDerivedFrom(
   ...
   *     profiles etc.
   */
  public Us_core_observation_labBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     low, normal.
   */
  public Us_core_observation_labBuilder withInterpretation(
   ...
   */
  public Us_core_observation_labBuilder withDataAbsentReason(
   ...
   */
  public Us_core_observation_labBuilder withModifierExtension(
   ...
   */
  public Us_core_observation_labBuilder withComponent(@NonNull Observation.Component... component) {
   ...
   *     measurement and multiple component observations for genetics observations.
   */
  public Us_core_observation_labBuilder withComponent(
   ...
   */
  public Us_core_observation_labBuilder withReferenceRange(
  ...
  public Us_core_observation_labBuilder withoutMeta() {
