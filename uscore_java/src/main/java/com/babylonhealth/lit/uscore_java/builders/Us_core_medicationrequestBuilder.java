...
public class Us_core_medicationrequestBuilder {
   ...
   */
  public Us_core_medicationrequestBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public Us_core_medicationrequestBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public Us_core_medicationrequestBuilder withText(@NonNull Narrative text) {
   ...
   *     attributes.
   */
  public Us_core_medicationrequestBuilder withNote(@NonNull Annotation... note) {
   ...
   *     attributes.
   */
  public Us_core_medicationrequestBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   *     request.
   */
  public Us_core_medicationrequestBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     request.
   */
  public Us_core_medicationrequestBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public Us_core_medicationrequestBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public Us_core_medicationrequestBuilder withCategory(@NonNull CodeableConcept... category) {
   ...
   *     is expected to be consumed or administered (i.e. inpatient or outpatient)).
   */
  public Us_core_medicationrequestBuilder withCategory(
   ...
   *     to other requests.
   */
  public Us_core_medicationrequestBuilder withPriority(@NonNull REQUEST_PRIORITY priority) {
   ...
   */
  public Us_core_medicationrequestBuilder withRecorder(@NonNull Reference recorder) {
   ...
   */
  public Us_core_medicationrequestBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public Us_core_medicationrequestBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public Us_core_medicationrequestBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Us_core_medicationrequestBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public Us_core_medicationrequestBuilder withEncounter(@NonNull Reference encounter) {
   ...
   */
  public Us_core_medicationrequestBuilder withPerformer(@NonNull Reference performer) {
   ...
   */
  public Us_core_medicationrequestBuilder withInsurance(@NonNull Reference... insurance) {
   ...
   *     pre-determinations that may be required for delivering the requested service.
   */
  public Us_core_medicationrequestBuilder withInsurance(@NonNull Collection<Reference> insurance) {
   ...
   */
  public Us_core_medicationrequestBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     from server to server.
   */
  public Us_core_medicationrequestBuilder withIdentifier(
   ...
   */
  public Us_core_medicationrequestBuilder withReasonCode(@NonNull CodeableConcept... reasonCode) {
   ...
   * @param reasonCode - The reason or the indication for ordering or not ordering the medication.
   */
  public Us_core_medicationrequestBuilder withReasonCode(
  ...
  public Us_core_medicationrequestBuilder withStatusReason(@NonNull CodeableConcept statusReason) {
   ...
   *     not to occur.
   */
  public Us_core_medicationrequestBuilder withDoNotPerform(@NonNull Boolean doNotPerform) {
   ...
   */
  public Us_core_medicationrequestBuilder withEventHistory(@NonNull Reference... eventHistory) {
   ...
   *     are likely to be relevant to a user looking at the current version of the resource.
   */
  public Us_core_medicationrequestBuilder withEventHistory(
   ...
   *     profiles etc.
   */
  public Us_core_medicationrequestBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public Us_core_medicationrequestBuilder withPerformerType(
   ...
   */
  public Us_core_medicationrequestBuilder withDetectedIssue(@NonNull Reference... detectedIssue) {
   ...
   *     duplicate therapy, dosage alert etc.
   */
  public Us_core_medicationrequestBuilder withDetectedIssue(
   ...
   */
  public Us_core_medicationrequestBuilder withReasonReference(
   ...
   *     MedicationRequest.
   */
  public Us_core_medicationrequestBuilder withInstantiatesUri(@NonNull String... instantiatesUri) {
   ...
   *     MedicationRequest.
   */
  public Us_core_medicationrequestBuilder withInstantiatesUri(
   ...
   *     or prescription.
   */
  public Us_core_medicationrequestBuilder withGroupIdentifier(@NonNull Identifier groupIdentifier) {
   ...
   */
  public Us_core_medicationrequestBuilder withModifierExtension(
   ...
   *     prescription.
   */
  public Us_core_medicationrequestBuilder withPriorPrescription(
   ...
   */
  public Us_core_medicationrequestBuilder withCourseOfTherapyType(
   ...
   */
  public Us_core_medicationrequestBuilder withSupportingInformation(
   ...
   */
  public Us_core_medicationrequestBuilder withInstantiatesCanonical(
   ...
   *     may be done.
   */
  public Us_core_medicationrequestBuilder withSubstitution(
  ...
  public Us_core_medicationrequestBuilder withDosageInstruction(
   ...
   *     pharmacy department.
   */
  public Us_core_medicationrequestBuilder withDispenseRequest(
