...
public class Us_core_allergyintoleranceBuilder {
  ...
  /**
   * Required fields for {@link Us_core_allergyintolerance}
   *
   ...
   */
  public Us_core_allergyintoleranceBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public Us_core_allergyintoleranceBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public Us_core_allergyintoleranceBuilder withText(@NonNull Narrative text) {
   ...
   */
  public Us_core_allergyintoleranceBuilder withType(@NonNull ALLERGY_INTOLERANCE_TYPE _type) {
   ...
   *     in other fields.
   */
  public Us_core_allergyintoleranceBuilder withNote(@NonNull Annotation... note) {
   ...
   *     in other fields.
   */
  public Us_core_allergyintoleranceBuilder withNote(@NonNull Collection<Annotation> note) {
    this.note = Collections.unmodifiableCollection(note);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public Us_core_allergyintoleranceBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param category - Category of the identified substance. */
  public Us_core_allergyintoleranceBuilder withCategory(
   ...
   */
  public Us_core_allergyintoleranceBuilder withRecorder(@NonNull Reference recorder) {
    this.recorder = Optional.of(recorder);
    return this;
  }
  /** @param asserter - The source of the information about the allergy that is recorded. */
  public Us_core_allergyintoleranceBuilder withAsserter(@NonNull Reference asserter) {
   ...
   */
  public Us_core_allergyintoleranceBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public Us_core_allergyintoleranceBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public Us_core_allergyintoleranceBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Us_core_allergyintoleranceBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param encounter - The encounter when the allergy or intolerance was asserted. */
  public Us_core_allergyintoleranceBuilder withEncounter(@NonNull Reference encounter) {
   ...
   *     server to server.
   */
  public Us_core_allergyintoleranceBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     server to server.
   */
  public Us_core_allergyintoleranceBuilder withIdentifier(
   ...
   */
  public Us_core_allergyintoleranceBuilder withCriticality(
   ...
   */
  public Us_core_allergyintoleranceBuilder withRecordedDate(@NonNull FHIRDateTime recordedDate) {
   ...
   *     profiles etc.
   */
  public Us_core_allergyintoleranceBuilder withImplicitRules(@NonNull String implicitRules) {
    this.implicitRules = Optional.of(implicitRules);
    return this;
  }
  /** @param clinicalStatus - The clinical status of the allergy or intolerance. */
  public Us_core_allergyintoleranceBuilder withClinicalStatus(
   ...
   *     reaction event.
   */
  public Us_core_allergyintoleranceBuilder withLastOccurrence(
   ...
   */
  public Us_core_allergyintoleranceBuilder withModifierExtension(
   ...
   *     product).
   */
  public Us_core_allergyintoleranceBuilder withVerificationStatus(
   ...
   */
  public Us_core_allergyintoleranceBuilder withReaction(
  ...
  public Us_core_allergyintolerance build() {
    return new Us_core_allergyintolerance(
