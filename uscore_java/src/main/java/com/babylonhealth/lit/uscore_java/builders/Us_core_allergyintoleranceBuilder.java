...
public interface Us_core_allergyintoleranceBuilder extends AllergyIntoleranceBuilder {
  ...
  public class Impl implements Us_core_allergyintoleranceBuilder {
     ...
     */
    public Us_core_allergyintoleranceBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public Us_core_allergyintoleranceBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     *     risk.
     */
    public Us_core_allergyintoleranceBuilder.Impl withType(
        @NonNull ALLERGY_INTOLERANCE_TYPE _type) {
     ...
     */
    public Us_core_allergyintoleranceBuilder.Impl withNote(@NonNull Annotation... note) {
    ...
    public Us_core_allergyintoleranceBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
      this.language = Optional.of(language);
      return this;
    }
    /** @param category - Category of the identified substance. */
    public Us_core_allergyintoleranceBuilder.Impl withCategory(
     ...
     */
    public Us_core_allergyintoleranceBuilder.Impl withOnset(
        @NonNull ChoiceAllergyIntolerance_Onset onset) {
     ...
     *     content.
     */
    public Us_core_allergyintoleranceBuilder.Impl withRecorder(@NonNull Reference recorder) {
     ...
     */
    public Us_core_allergyintoleranceBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     */
    public Us_core_allergyintoleranceBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     */
    public Us_core_allergyintoleranceBuilder.Impl withCriticality(
     ...
     */
    public Us_core_allergyintoleranceBuilder.Impl withRecordedDate(
     ...
     *     profiles etc.
     */
    public Us_core_allergyintoleranceBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     *     reaction event.
     */
    public Us_core_allergyintoleranceBuilder.Impl withLastOccurrence(
