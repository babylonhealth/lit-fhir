...
public class Us_core_directBuilder {
   ...
   */
  public Us_core_directBuilder(String url) {
    this.url = url;
  }
   ...
   */
  public Us_core_directBuilder withId(@NonNull String id) {
   ...
   */
  public Us_core_directBuilder withValue(@NonNull Boolean value) {
   ...
   */
  public Us_core_directBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Us_core_directBuilder withExtension(@NonNull Collection<Extension> extension) {
