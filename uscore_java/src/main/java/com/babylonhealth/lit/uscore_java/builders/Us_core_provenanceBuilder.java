...
public class Us_core_provenanceBuilder {
   ...
   */
  public Us_core_provenanceBuilder(
   ...
   */
  public Us_core_provenanceBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public Us_core_provenanceBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public Us_core_provenanceBuilder withText(@NonNull Narrative text) {
   ...
   */
  public Us_core_provenanceBuilder withPolicy(@NonNull String... policy) {
   ...
   *     have multiple applicable policy documents, such as patient consent, guarantor funding, etc.
   */
  public Us_core_provenanceBuilder withPolicy(@NonNull Collection<String> policy) {
    this.policy = Collections.unmodifiableCollection(policy);
    return this;
  }
  /** @param reason - The reason that the activity was taking place. */
  public Us_core_provenanceBuilder withReason(@NonNull CodeableConcept... reason) {
    this.reason = Arrays.asList(reason);
    return this;
  }
  /** @param reason - The reason that the activity was taking place. */
  public Us_core_provenanceBuilder withReason(@NonNull Collection<CodeableConcept> reason) {
    this.reason = Collections.unmodifiableCollection(reason);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public Us_core_provenanceBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param location - Where the activity occurred, if relevant. */
  public Us_core_provenanceBuilder withLocation(@NonNull Reference location) {
   ...
   */
  public Us_core_provenanceBuilder withActivity(@NonNull CodeableConcept activity) {
   ...
   */
  public Us_core_provenanceBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public Us_core_provenanceBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public Us_core_provenanceBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Us_core_provenanceBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public Us_core_provenanceBuilder withSignature(@NonNull Signature... signature) {
   ...
   *     Provenance.agent. The purpose of the signature is indicated.
   */
  public Us_core_provenanceBuilder withSignature(@NonNull Collection<Signature> signature) {
   ...
   *     profiles etc.
   */
  public Us_core_provenanceBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public Us_core_provenanceBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public Us_core_provenanceBuilder withModifierExtension(
      @NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param entity - An entity used in this activity. */
  public Us_core_provenanceBuilder withEntity(@NonNull Provenance.Entity... entity) {
    this.entity = Arrays.asList(entity);
    return this;
  }
  /** @param entity - An entity used in this activity. */
  public Us_core_provenanceBuilder withEntity(@NonNull Collection<Provenance.Entity> entity) {
