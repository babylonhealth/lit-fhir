...
public class Us_core_practitionerBuilder {
   ...
   */
  public Us_core_practitionerBuilder(
      Collection<HumanName> name, Collection<Identifier> identifier) {
    this.name = name;
   ...
   */
  public Us_core_practitionerBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public Us_core_practitionerBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public Us_core_practitionerBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param photo - Image of the person. */
  public Us_core_practitionerBuilder withPhoto(@NonNull Attachment... photo) {
    this.photo = Arrays.asList(photo);
    return this;
  }
  /** @param photo - Image of the person. */
  public Us_core_practitionerBuilder withPhoto(@NonNull Collection<Attachment> photo) {
    this.photo = Collections.unmodifiableCollection(photo);
    return this;
  }
  /** @param active - Whether this practitioner's record is in active use. */
  public Us_core_practitionerBuilder withActive(@NonNull Boolean active) {
   ...
   */
  public Us_core_practitionerBuilder withGender(@NonNull ADMINISTRATIVE_GENDER gender) {
   ...
   *     address.
   */
  public Us_core_practitionerBuilder withTelecom(@NonNull ContactPoint... telecom) {
   ...
   *     address.
   */
  public Us_core_practitionerBuilder withTelecom(@NonNull Collection<ContactPoint> telecom) {
   ...
   *     role dependent.
   */
  public Us_core_practitionerBuilder withAddress(@NonNull Address... address) {
   ...
   *     role dependent.
   */
  public Us_core_practitionerBuilder withAddress(@NonNull Collection<Address> address) {
    this.address = Collections.unmodifiableCollection(address);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public Us_core_practitionerBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public Us_core_practitionerBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public Us_core_practitionerBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public Us_core_practitionerBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Us_core_practitionerBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param birthDate - The date of birth for the practitioner. */
  public Us_core_practitionerBuilder withBirthDate(@NonNull FHIRDate birthDate) {
   ...
   *     profiles etc.
   */
  public Us_core_practitionerBuilder withImplicitRules(@NonNull String implicitRules) {
    this.implicitRules = Optional.of(implicitRules);
    return this;
  }
  /** @param communication - A language the practitioner can use in patient communication. */
  public Us_core_practitionerBuilder withCommunication(@NonNull CodeableConcept... communication) {
    this.communication = Arrays.asList(communication);
    return this;
  }
  /** @param communication - A language the practitioner can use in patient communication. */
  public Us_core_practitionerBuilder withCommunication(
   ...
   */
  public Us_core_practitionerBuilder withModifierExtension(
   ...
   *     a certian locality.
   */
  public Us_core_practitionerBuilder withQualification(
