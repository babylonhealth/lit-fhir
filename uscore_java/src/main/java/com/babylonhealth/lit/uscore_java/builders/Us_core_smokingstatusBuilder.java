...
public class Us_core_smokingstatusBuilder {
  private Optional<String> id = Optional.empty();
  private Optional<Meta> meta =
      Optional.of(
          new MetaBuilder()
              .withProfile("http://hl7.org/fhir/us/core/StructureDefinition/us-core-smokingstatus")
              .build());
  ...
  /**
   * Required fields for {@link Us_core_smokingstatus}
   *
   ...
   */
  public Us_core_smokingstatusBuilder(
   ...
   */
  public Us_core_smokingstatusBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public Us_core_smokingstatusBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public Us_core_smokingstatusBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public Us_core_smokingstatusBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public Us_core_smokingstatusBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   */
  public Us_core_smokingstatusBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     patient of record and the mother is the focus.
   */
  public Us_core_smokingstatusBuilder withFocus(@NonNull Collection<Reference> focus) {
   ...
   */
  public Us_core_smokingstatusBuilder withPartOf(@NonNull Reference... partOf) {
   ...
   *     example, an observation as part of a procedure.
   */
  public Us_core_smokingstatusBuilder withPartOf(@NonNull Collection<Reference> partOf) {
    this.partOf = Collections.unmodifiableCollection(partOf);
    return this;
  }
  /** @param method - Indicates the mechanism used to perform the observation. */
  public Us_core_smokingstatusBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param device - The device used to generate the observation data. */
  public Us_core_smokingstatusBuilder withDevice(@NonNull Reference device) {
   ...
   */
  public Us_core_smokingstatusBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     before it is dispensed.
   */
  public Us_core_smokingstatusBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public Us_core_smokingstatusBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param category - A code that classifies the general type of observation being made. */
  public Us_core_smokingstatusBuilder withCategory(@NonNull CodeableConcept... category) {
    this.category = Arrays.asList(category);
    return this;
  }
  /** @param category - A code that classifies the general type of observation being made. */
  public Us_core_smokingstatusBuilder withCategory(@NonNull Collection<CodeableConcept> category) {
   ...
   *     the target site).
   */
  public Us_core_smokingstatusBuilder withBodySite(@NonNull CodeableConcept bodySite) {
    this.bodySite = Optional.of(bodySite);
    return this;
  }
  /** @param specimen - The specimen that was used when this observation was made. */
  public Us_core_smokingstatusBuilder withSpecimen(@NonNull Reference specimen) {
   ...
   */
  public Us_core_smokingstatusBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public Us_core_smokingstatusBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public Us_core_smokingstatusBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Us_core_smokingstatusBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public Us_core_smokingstatusBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public Us_core_smokingstatusBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public Us_core_smokingstatusBuilder withPerformer(@NonNull Collection<Reference> performer) {
   ...
   */
  public Us_core_smokingstatusBuilder withHasMember(@NonNull Reference... hasMember) {
   ...
   *     set of vital sign measurements) that includes the target as a member of the group.
   */
  public Us_core_smokingstatusBuilder withHasMember(@NonNull Collection<Reference> hasMember) {
  ...
  public Us_core_smokingstatusBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public Us_core_smokingstatusBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public Us_core_smokingstatusBuilder withDerivedFrom(@NonNull Reference... derivedFrom) {
   ...
   *     based on an ultrasound image.
   */
  public Us_core_smokingstatusBuilder withDerivedFrom(@NonNull Collection<Reference> derivedFrom) {
   ...
   *     profiles etc.
   */
  public Us_core_smokingstatusBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     low, normal.
   */
  public Us_core_smokingstatusBuilder withInterpretation(
   ...
   */
  public Us_core_smokingstatusBuilder withDataAbsentReason(
   ...
   */
  public Us_core_smokingstatusBuilder withModifierExtension(
   ...
   */
  public Us_core_smokingstatusBuilder withComponent(@NonNull Observation.Component... component) {
   ...
   *     measurement and multiple component observations for genetics observations.
   */
  public Us_core_smokingstatusBuilder withComponent(
   ...
   */
  public Us_core_smokingstatusBuilder withReferenceRange(
  ...
  public Us_core_smokingstatusBuilder withoutMeta() {
    this.meta = Optional.empty();
    return this;
  }

  public Us_core_smokingstatus build() {
    return new Us_core_smokingstatus(
