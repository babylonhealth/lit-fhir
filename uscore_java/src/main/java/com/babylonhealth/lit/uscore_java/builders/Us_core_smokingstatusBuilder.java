...
public interface Us_core_smokingstatusBuilder extends ObservationBuilder {
  ...
  public class Impl implements Us_core_smokingstatusBuilder {
     ...
     */
    public Us_core_smokingstatusBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public Us_core_smokingstatusBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     */
    public Us_core_smokingstatusBuilder.Impl withText(@NonNull Narrative text) {
     ...
     */
    public Us_core_smokingstatusBuilder.Impl withFocus(@NonNull Reference... focus) {
     ...
     *     is the patient of record and the mother is the focus.
     */
    public Us_core_smokingstatusBuilder.Impl withFocus(@NonNull Collection<Reference> focus) {
     ...
     */
    public Us_core_smokingstatusBuilder.Impl withPartOf(@NonNull Reference... partOf) {
     ...
     *     For example, an observation as part of a procedure.
     */
    public Us_core_smokingstatusBuilder.Impl withPartOf(@NonNull Collection<Reference> partOf) {
     ...
     */
    public Us_core_smokingstatusBuilder.Impl withBasedOn(@NonNull Reference... basedOn) {
     ...
     *     performed before it is dispensed.
     */
    public Us_core_smokingstatusBuilder.Impl withBasedOn(@NonNull Collection<Reference> basedOn) {
    ...
    public Us_core_smokingstatusBuilder.Impl withCategory(@NonNull CodeableConcept... category) {
     ...
     *     (i.e. the target site).
     */
    public Us_core_smokingstatusBuilder.Impl withBodySite(@NonNull CodeableConcept bodySite) {
     ...
     */
    public Us_core_smokingstatusBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     */
    public Us_core_smokingstatusBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public Us_core_smokingstatusBuilder.Impl withExtension(
    ...
    public Us_core_smokingstatusBuilder.Impl withPerformer(@NonNull Reference... performer) {
     ...
     */
    public Us_core_smokingstatusBuilder.Impl withHasMember(@NonNull Reference... hasMember) {
     ...
     *     a set of vital sign measurements) that includes the target as a member of the group.
     */
    public Us_core_smokingstatusBuilder.Impl withHasMember(
     ...
     */
    public Us_core_smokingstatusBuilder.Impl withDerivedFrom(@NonNull Reference... derivedFrom) {
     ...
     */
    public Us_core_smokingstatusBuilder.Impl withEffective(@NonNull Choice00107722725 effective) {
     ...
     *     profiles etc.
     */
    public Us_core_smokingstatusBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
    ...
    public Us_core_smokingstatusBuilder.Impl withoutMeta() {
