...
public class Us_core_pulse_oximetryBuilder {
  private Optional<String> id = Optional.empty();
  private Optional<Meta> meta =
      Optional.of(
          new MetaBuilder()
              .withProfile("http://hl7.org/fhir/us/core/StructureDefinition/us-core-pulse-oximetry")
              .build());
   ...
   */
  public Us_core_pulse_oximetryBuilder(
   ...
   */
  public Us_core_pulse_oximetryBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public Us_core_pulse_oximetryBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public Us_core_pulse_oximetryBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public Us_core_pulse_oximetryBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public Us_core_pulse_oximetryBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   */
  public Us_core_pulse_oximetryBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     patient of record and the mother is the focus.
   */
  public Us_core_pulse_oximetryBuilder withFocus(@NonNull Collection<Reference> focus) {
   ...
   */
  public Us_core_pulse_oximetryBuilder withPartOf(@NonNull Reference... partOf) {
   ...
   *     example, an observation as part of a procedure.
   */
  public Us_core_pulse_oximetryBuilder withPartOf(@NonNull Collection<Reference> partOf) {
   ...
   */
  public Us_core_pulse_oximetryBuilder withIssued(@NonNull ZonedDateTime issued) {
    this.issued = Optional.of(issued);
    return this;
  }
  /** @param method - Indicates the mechanism used to perform the observation. */
  public Us_core_pulse_oximetryBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param device - The device used to generate the observation data. */
  public Us_core_pulse_oximetryBuilder withDevice(@NonNull Reference device) {
   ...
   */
  public Us_core_pulse_oximetryBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     before it is dispensed.
   */
  public Us_core_pulse_oximetryBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public Us_core_pulse_oximetryBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public Us_core_pulse_oximetryBuilder withValue(@NonNull Quantity value) {
   ...
   *     the target site).
   */
  public Us_core_pulse_oximetryBuilder withBodySite(@NonNull CodeableConcept bodySite) {
    this.bodySite = Optional.of(bodySite);
    return this;
  }
  /** @param specimen - The specimen that was used when this observation was made. */
  public Us_core_pulse_oximetryBuilder withSpecimen(@NonNull Reference specimen) {
   ...
   */
  public Us_core_pulse_oximetryBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public Us_core_pulse_oximetryBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public Us_core_pulse_oximetryBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Us_core_pulse_oximetryBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public Us_core_pulse_oximetryBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public Us_core_pulse_oximetryBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public Us_core_pulse_oximetryBuilder withPerformer(@NonNull Collection<Reference> performer) {
    this.performer = Collections.unmodifiableCollection(performer);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public Us_core_pulse_oximetryBuilder withHasMember(@NonNull Reference... hasMember) {
    this.hasMember = Arrays.asList(hasMember);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public Us_core_pulse_oximetryBuilder withHasMember(@NonNull Collection<Reference> hasMember) {
  ...
  public Us_core_pulse_oximetryBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public Us_core_pulse_oximetryBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public Us_core_pulse_oximetryBuilder withDerivedFrom(@NonNull Reference... derivedFrom) {
   ...
   *     based on an ultrasound image.
   */
  public Us_core_pulse_oximetryBuilder withDerivedFrom(@NonNull Collection<Reference> derivedFrom) {
   ...
   *     profiles etc.
   */
  public Us_core_pulse_oximetryBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     low, normal.
   */
  public Us_core_pulse_oximetryBuilder withInterpretation(
   ...
   */
  public Us_core_pulse_oximetryBuilder withDataAbsentReason(
   ...
   */
  public Us_core_pulse_oximetryBuilder withModifierExtension(
  ...
  public Us_core_pulse_oximetryBuilder withComponent(@NonNull Observation.Component... component) {
    this.component = Arrays.asList(component);
    return this;
  }
  /** @param component - Used when reporting systolic and diastolic blood pressure. */
  public Us_core_pulse_oximetryBuilder withComponent(
   ...
   */
  public Us_core_pulse_oximetryBuilder withReferenceRange(
