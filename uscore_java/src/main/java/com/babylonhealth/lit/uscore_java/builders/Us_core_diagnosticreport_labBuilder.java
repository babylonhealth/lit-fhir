...
public interface Us_core_diagnosticreport_labBuilder extends DiagnosticReportBuilder {
  ...
  public class Impl implements Us_core_diagnosticreport_labBuilder {
     ...
     */
    public Us_core_diagnosticreport_labBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public Us_core_diagnosticreport_labBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     *     diagnostic report.
     */
    public Us_core_diagnosticreport_labBuilder.Impl withResult(@NonNull Reference... result) {
    ...
    public Us_core_diagnosticreport_labBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
      this.language = Optional.of(language);
      return this;
    }
    /** @param specimen - Details about the specimens on which this diagnostic report is based. */
    public Us_core_diagnosticreport_labBuilder.Impl withSpecimen(@NonNull Reference... specimen) {
     ...
     */
    public Us_core_diagnosticreport_labBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     */
    public Us_core_diagnosticreport_labBuilder.Impl withExtension(@NonNull Extension... extension) {
    ...
    public Us_core_diagnosticreport_labBuilder.Impl withPerformer(@NonNull Reference... performer) {
     ...
     */
    public Us_core_diagnosticreport_labBuilder.Impl withConclusion(@NonNull String conclusion) {
     ...
     *     profiles etc.
     */
    public Us_core_diagnosticreport_labBuilder.Impl withImplicitRules(
