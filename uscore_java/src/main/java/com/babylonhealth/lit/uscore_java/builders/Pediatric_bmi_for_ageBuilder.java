...
public class Pediatric_bmi_for_ageBuilder {
  private Optional<String> id = Optional.empty();
  private Optional<Meta> meta =
      Optional.of(
          new MetaBuilder()
              .withProfile("http://hl7.org/fhir/us/core/StructureDefinition/pediatric-bmi-for-age")
              .build());
  ...
  /**
   * Required fields for {@link Pediatric_bmi_for_age}
   *
   ...
   */
  public Pediatric_bmi_for_ageBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public Pediatric_bmi_for_ageBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public Pediatric_bmi_for_ageBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public Pediatric_bmi_for_ageBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public Pediatric_bmi_for_ageBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   */
  public Pediatric_bmi_for_ageBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     patient of record and the mother is the focus.
   */
  public Pediatric_bmi_for_ageBuilder withFocus(@NonNull Collection<Reference> focus) {
   ...
   */
  public Pediatric_bmi_for_ageBuilder withPartOf(@NonNull Reference... partOf) {
   ...
   *     example, an observation as part of a procedure.
   */
  public Pediatric_bmi_for_ageBuilder withPartOf(@NonNull Collection<Reference> partOf) {
   ...
   */
  public Pediatric_bmi_for_ageBuilder withIssued(@NonNull ZonedDateTime issued) {
    this.issued = Optional.of(issued);
    return this;
  }
  /** @param method - Indicates the mechanism used to perform the observation. */
  public Pediatric_bmi_for_ageBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param device - The device used to generate the observation data. */
  public Pediatric_bmi_for_ageBuilder withDevice(@NonNull Reference device) {
   ...
   */
  public Pediatric_bmi_for_ageBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     before it is dispensed.
   */
  public Pediatric_bmi_for_ageBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public Pediatric_bmi_for_ageBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   *     the target site).
   */
  public Pediatric_bmi_for_ageBuilder withBodySite(@NonNull CodeableConcept bodySite) {
    this.bodySite = Optional.of(bodySite);
    return this;
  }
  /** @param specimen - The specimen that was used when this observation was made. */
  public Pediatric_bmi_for_ageBuilder withSpecimen(@NonNull Reference specimen) {
   ...
   */
  public Pediatric_bmi_for_ageBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public Pediatric_bmi_for_ageBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public Pediatric_bmi_for_ageBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Pediatric_bmi_for_ageBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public Pediatric_bmi_for_ageBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public Pediatric_bmi_for_ageBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public Pediatric_bmi_for_ageBuilder withPerformer(@NonNull Collection<Reference> performer) {
    this.performer = Collections.unmodifiableCollection(performer);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public Pediatric_bmi_for_ageBuilder withHasMember(@NonNull Reference... hasMember) {
    this.hasMember = Arrays.asList(hasMember);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public Pediatric_bmi_for_ageBuilder withHasMember(@NonNull Collection<Reference> hasMember) {
  ...
  public Pediatric_bmi_for_ageBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public Pediatric_bmi_for_ageBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public Pediatric_bmi_for_ageBuilder withDerivedFrom(@NonNull Reference... derivedFrom) {
   ...
   *     based on an ultrasound image.
   */
  public Pediatric_bmi_for_ageBuilder withDerivedFrom(@NonNull Collection<Reference> derivedFrom) {
   ...
   *     profiles etc.
   */
  public Pediatric_bmi_for_ageBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     low, normal.
   */
  public Pediatric_bmi_for_ageBuilder withInterpretation(
   ...
   */
  public Pediatric_bmi_for_ageBuilder withDataAbsentReason(
   ...
   */
  public Pediatric_bmi_for_ageBuilder withModifierExtension(
  ...
  public Pediatric_bmi_for_ageBuilder withComponent(@NonNull Observation.Component... component) {
    this.component = Arrays.asList(component);
    return this;
  }
  /** @param component - Used when reporting systolic and diastolic blood pressure. */
  public Pediatric_bmi_for_ageBuilder withComponent(
   ...
   */
  public Pediatric_bmi_for_ageBuilder withReferenceRange(
  ...
  public Pediatric_bmi_for_age build() {
    return new Pediatric_bmi_for_age(
