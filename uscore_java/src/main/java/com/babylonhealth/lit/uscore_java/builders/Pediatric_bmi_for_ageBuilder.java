...
public interface Pediatric_bmi_for_ageBuilder extends VitalsignsBuilder {
  ...
  public class Impl implements Pediatric_bmi_for_ageBuilder {
     ...
     */
    public Pediatric_bmi_for_ageBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public Pediatric_bmi_for_ageBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     */
    public Pediatric_bmi_for_ageBuilder.Impl withText(@NonNull Narrative text) {
     ...
     */
    public Pediatric_bmi_for_ageBuilder.Impl withFocus(@NonNull Reference... focus) {
     ...
     *     is the patient of record and the mother is the focus.
     */
    public Pediatric_bmi_for_ageBuilder.Impl withFocus(@NonNull Collection<Reference> focus) {
     ...
     */
    public Pediatric_bmi_for_ageBuilder.Impl withPartOf(@NonNull Reference... partOf) {
     ...
     *     For example, an observation as part of a procedure.
     */
    public Pediatric_bmi_for_ageBuilder.Impl withPartOf(@NonNull Collection<Reference> partOf) {
     ...
     */
    public Pediatric_bmi_for_ageBuilder.Impl withIssued(@NonNull ZonedDateTime issued) {
      this.issued = Optional.of(issued);
      return this;
    }
    /** @param method - Indicates the mechanism used to perform the observation. */
    public Pediatric_bmi_for_ageBuilder.Impl withMethod(@NonNull CodeableConcept method) {
     ...
     */
    public Pediatric_bmi_for_ageBuilder.Impl withBasedOn(@NonNull Reference... basedOn) {
     ...
     *     performed before it is dispensed.
     */
    public Pediatric_bmi_for_ageBuilder.Impl withBasedOn(@NonNull Collection<Reference> basedOn) {
     ...
     *     (i.e. the target site).
     */
    public Pediatric_bmi_for_ageBuilder.Impl withBodySite(@NonNull CodeableConcept bodySite) {
     ...
     */
    public Pediatric_bmi_for_ageBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     */
    public Pediatric_bmi_for_ageBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public Pediatric_bmi_for_ageBuilder.Impl withExtension(
    ...
    public Pediatric_bmi_for_ageBuilder.Impl withPerformer(@NonNull Reference... performer) {
      this.performer = Arrays.asList(performer);
      return this;
    }
    /** @param performer - Who was responsible for asserting the observed value as "true". */
    public Pediatric_bmi_for_ageBuilder.Impl withPerformer(
    ...
    /** @param hasMember - Used when reporting vital signs panel components. */
    public Pediatric_bmi_for_ageBuilder.Impl withHasMember(
     ...
     */
    public Pediatric_bmi_for_ageBuilder.Impl withDerivedFrom(@NonNull Reference... derivedFrom) {
     ...
     *     profiles etc.
     */
    public Pediatric_bmi_for_ageBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
