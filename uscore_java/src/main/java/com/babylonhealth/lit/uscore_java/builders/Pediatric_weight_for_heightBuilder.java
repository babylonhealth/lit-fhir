...
public interface Pediatric_weight_for_heightBuilder extends VitalsignsBuilder {
  ...
  public class Impl implements Pediatric_weight_for_heightBuilder {
    ...
    /**
     * Required fields for {@link Pediatric_weight_for_height}
     *
     ...
     */
    public Pediatric_weight_for_heightBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public Pediatric_weight_for_heightBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public Pediatric_weight_for_heightBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public Pediatric_weight_for_heightBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public Pediatric_weight_for_heightBuilder.Impl withText(@NonNull NarrativeBuilder text) {
      this.text = Optional.of(text.build());
      return this;
    }
    /** @param note - Comments about the observation or the results. */
    public Pediatric_weight_for_heightBuilder.Impl withNote(@NonNull Annotation... note) {
      this.note = Arrays.asList(note);
      return this;
    }
    /** @param note - Comments about the observation or the results. */
    public Pediatric_weight_for_heightBuilder.Impl withNote(@NonNull Collection<Annotation> note) {
      this.note = Collections.unmodifiableCollection(note);
      return this;
    }

    public Pediatric_weight_for_heightBuilder.Impl withNote(@NonNull AnnotationBuilder... note) {
     ...
     */
    public Pediatric_weight_for_heightBuilder.Impl withFocus(@NonNull Reference... focus) {
     ...
     *     is the patient of record and the mother is the focus.
     */
    public Pediatric_weight_for_heightBuilder.Impl withFocus(@NonNull Collection<Reference> focus) {
      this.focus = Collections.unmodifiableCollection(focus);
      return this;
    }

    public Pediatric_weight_for_heightBuilder.Impl withFocus(@NonNull ReferenceBuilder... focus) {
     ...
     */
    public Pediatric_weight_for_heightBuilder.Impl withPartOf(@NonNull Reference... partOf) {
     ...
     *     For example, an observation as part of a procedure.
     */
    public Pediatric_weight_for_heightBuilder.Impl withPartOf(
        @NonNull Collection<Reference> partOf) {
      this.partOf = Collections.unmodifiableCollection(partOf);
      return this;
    }

    public Pediatric_weight_for_heightBuilder.Impl withPartOf(@NonNull ReferenceBuilder... partOf) {
     ...
     */
    public Pediatric_weight_for_heightBuilder.Impl withIssued(@NonNull ZonedDateTime issued) {
      this.issued = Optional.of(issued);
      return this;
    }
    /** @param method - Indicates the mechanism used to perform the observation. */
    public Pediatric_weight_for_heightBuilder.Impl withMethod(@NonNull CodeableConcept method) {
      this.method = Optional.of(method);
      return this;
    }

    public Pediatric_weight_for_heightBuilder.Impl withMethod(
    ...
    public Pediatric_weight_for_heightBuilder.Impl withDevice(@NonNull Reference device) {
      this.device = Optional.of(device);
      return this;
    }

    public Pediatric_weight_for_heightBuilder.Impl withDevice(@NonNull ReferenceBuilder device) {
     ...
     */
    public Pediatric_weight_for_heightBuilder.Impl withBasedOn(@NonNull Reference... basedOn) {
     ...
     *     performed before it is dispensed.
     */
    public Pediatric_weight_for_heightBuilder.Impl withBasedOn(
    ...
    public Pediatric_weight_for_heightBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     *     (i.e. the target site).
     */
    public Pediatric_weight_for_heightBuilder.Impl withBodySite(@NonNull CodeableConcept bodySite) {
      this.bodySite = Optional.of(bodySite);
      return this;
    }

    public Pediatric_weight_for_heightBuilder.Impl withBodySite(
    ...
    public Pediatric_weight_for_heightBuilder.Impl withSpecimen(@NonNull Reference specimen) {
      this.specimen = Optional.of(specimen);
      return this;
    }

    public Pediatric_weight_for_heightBuilder.Impl withSpecimen(
     ...
     */
    public Pediatric_weight_for_heightBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public Pediatric_weight_for_heightBuilder.Impl withContained(
     ...
     */
    public Pediatric_weight_for_heightBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public Pediatric_weight_for_heightBuilder.Impl withExtension(
     ...
     */
    public Pediatric_weight_for_heightBuilder.Impl withEncounter(@NonNull Reference encounter) {
      this.encounter = Optional.of(encounter);
      return this;
    }

    public Pediatric_weight_for_heightBuilder.Impl withEncounter(
        @NonNull ReferenceBuilder encounter) {
      this.encounter = Optional.of(encounter.build());
      return this;
    }
    /** @param performer - Who was responsible for asserting the observed value as "true". */
    public Pediatric_weight_for_heightBuilder.Impl withPerformer(@NonNull Reference... performer) {
      this.performer = Arrays.asList(performer);
      return this;
    }
    /** @param performer - Who was responsible for asserting the observed value as "true". */
    public Pediatric_weight_for_heightBuilder.Impl withPerformer(
    ...
    public Pediatric_weight_for_heightBuilder.Impl withHasMember(@NonNull Reference... hasMember) {
      this.hasMember = Arrays.asList(hasMember);
      return this;
    }
    /** @param hasMember - Used when reporting vital signs panel components. */
    public Pediatric_weight_for_heightBuilder.Impl withHasMember(
    ...
    public Pediatric_weight_for_heightBuilder.Impl withIdentifier(
     ...
     */
    public Pediatric_weight_for_heightBuilder.Impl withDerivedFrom(
     ...
     *     profiles etc.
     */
    public Pediatric_weight_for_heightBuilder.Impl withImplicitRules(
     ...
     *     low, normal.
     */
    public Pediatric_weight_for_heightBuilder.Impl withInterpretation(
     ...
     */
    public Pediatric_weight_for_heightBuilder.Impl withDataAbsentReason(
     ...
     */
    public Pediatric_weight_for_heightBuilder.Impl withModifierExtension(
    ...
    public Pediatric_weight_for_heightBuilder.Impl withComponent(
     ...
     *     used.
     */
    public Pediatric_weight_for_heightBuilder.Impl withReferenceRange(
