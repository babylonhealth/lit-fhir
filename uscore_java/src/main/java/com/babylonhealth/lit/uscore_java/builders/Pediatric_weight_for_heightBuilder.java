...
public class Pediatric_weight_for_heightBuilder {
   ...
   */
  public Pediatric_weight_for_heightBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public Pediatric_weight_for_heightBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public Pediatric_weight_for_heightBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public Pediatric_weight_for_heightBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public Pediatric_weight_for_heightBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   */
  public Pediatric_weight_for_heightBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     patient of record and the mother is the focus.
   */
  public Pediatric_weight_for_heightBuilder withFocus(@NonNull Collection<Reference> focus) {
   ...
   */
  public Pediatric_weight_for_heightBuilder withPartOf(@NonNull Reference... partOf) {
   ...
   *     example, an observation as part of a procedure.
   */
  public Pediatric_weight_for_heightBuilder withPartOf(@NonNull Collection<Reference> partOf) {
   ...
   */
  public Pediatric_weight_for_heightBuilder withIssued(@NonNull ZonedDateTime issued) {
    this.issued = Optional.of(issued);
    return this;
  }
  /** @param method - Indicates the mechanism used to perform the observation. */
  public Pediatric_weight_for_heightBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param device - The device used to generate the observation data. */
  public Pediatric_weight_for_heightBuilder withDevice(@NonNull Reference device) {
   ...
   */
  public Pediatric_weight_for_heightBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     before it is dispensed.
   */
  public Pediatric_weight_for_heightBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public Pediatric_weight_for_heightBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   *     the target site).
   */
  public Pediatric_weight_for_heightBuilder withBodySite(@NonNull CodeableConcept bodySite) {
    this.bodySite = Optional.of(bodySite);
    return this;
  }
  /** @param specimen - The specimen that was used when this observation was made. */
  public Pediatric_weight_for_heightBuilder withSpecimen(@NonNull Reference specimen) {
   ...
   */
  public Pediatric_weight_for_heightBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public Pediatric_weight_for_heightBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public Pediatric_weight_for_heightBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Pediatric_weight_for_heightBuilder withExtension(
   ...
   */
  public Pediatric_weight_for_heightBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public Pediatric_weight_for_heightBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public Pediatric_weight_for_heightBuilder withPerformer(
      @NonNull Collection<Reference> performer) {
    this.performer = Collections.unmodifiableCollection(performer);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public Pediatric_weight_for_heightBuilder withHasMember(@NonNull Reference... hasMember) {
    this.hasMember = Arrays.asList(hasMember);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public Pediatric_weight_for_heightBuilder withHasMember(
  ...
  public Pediatric_weight_for_heightBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public Pediatric_weight_for_heightBuilder withIdentifier(
   ...
   */
  public Pediatric_weight_for_heightBuilder withDerivedFrom(@NonNull Reference... derivedFrom) {
   ...
   *     based on an ultrasound image.
   */
  public Pediatric_weight_for_heightBuilder withDerivedFrom(
   ...
   *     profiles etc.
   */
  public Pediatric_weight_for_heightBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     low, normal.
   */
  public Pediatric_weight_for_heightBuilder withInterpretation(
   ...
   */
  public Pediatric_weight_for_heightBuilder withDataAbsentReason(
   ...
   */
  public Pediatric_weight_for_heightBuilder withModifierExtension(
  ...
  public Pediatric_weight_for_heightBuilder withComponent(
   ...
   */
  public Pediatric_weight_for_heightBuilder withReferenceRange(
