...
public class Us_core_diagnosticreport_noteBuilder {
   ...
   * @param subject - The subject of the report. Usually, but not always, this is a patient. However
   ...
   */
  public Us_core_diagnosticreport_noteBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public Us_core_diagnosticreport_noteBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public Us_core_diagnosticreport_noteBuilder withText(@NonNull Narrative text) {
   ...
   */
  public Us_core_diagnosticreport_noteBuilder withIssued(@NonNull ZonedDateTime issued) {
   ...
   *     diagnostic report.
   */
  public Us_core_diagnosticreport_noteBuilder withResult(@NonNull Reference... result) {
   ...
   *     diagnostic report.
   */
  public Us_core_diagnosticreport_noteBuilder withResult(@NonNull Collection<Reference> result) {
    this.result = Collections.unmodifiableCollection(result);
    return this;
  }
  /** @param basedOn - Details concerning a service requested. */
  public Us_core_diagnosticreport_noteBuilder withBasedOn(@NonNull Reference... basedOn) {
    this.basedOn = Arrays.asList(basedOn);
    return this;
  }
  /** @param basedOn - Details concerning a service requested. */
  public Us_core_diagnosticreport_noteBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public Us_core_diagnosticreport_noteBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param specimen - Details about the specimens on which this diagnostic report is based. */
  public Us_core_diagnosticreport_noteBuilder withSpecimen(@NonNull Reference... specimen) {
    this.specimen = Arrays.asList(specimen);
    return this;
  }
  /** @param specimen - Details about the specimens on which this diagnostic report is based. */
  public Us_core_diagnosticreport_noteBuilder withSpecimen(
   ...
   */
  public Us_core_diagnosticreport_noteBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public Us_core_diagnosticreport_noteBuilder withContained(
   ...
   */
  public Us_core_diagnosticreport_noteBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Us_core_diagnosticreport_noteBuilder withExtension(
   ...
   */
  public Us_core_diagnosticreport_noteBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - The diagnostic service that is responsible for issuing the report. */
  public Us_core_diagnosticreport_noteBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - The diagnostic service that is responsible for issuing the report. */
  public Us_core_diagnosticreport_noteBuilder withPerformer(
  ...
  public Us_core_diagnosticreport_noteBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - Identifiers assigned to this report by the performer or other systems. */
  public Us_core_diagnosticreport_noteBuilder withIdentifier(
   ...
   */
  public Us_core_diagnosticreport_noteBuilder withConclusion(@NonNull String conclusion) {
   ...
   */
  public Us_core_diagnosticreport_noteBuilder withImagingStudy(@NonNull Reference... imagingStudy) {
   ...
   *     views of the source images.
   */
  public Us_core_diagnosticreport_noteBuilder withImagingStudy(
   ...
   *     profiles etc.
   */
  public Us_core_diagnosticreport_noteBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public Us_core_diagnosticreport_noteBuilder withPresentedForm(
   ...
   *     (interpretation/impression) of the diagnostic report.
   */
  public Us_core_diagnosticreport_noteBuilder withConclusionCode(
   ...
   */
  public Us_core_diagnosticreport_noteBuilder withModifierExtension(
   ...
   */
  public Us_core_diagnosticreport_noteBuilder withResultsInterpreter(
   ...
   */
  public Us_core_diagnosticreport_noteBuilder withMedia(@NonNull DiagnosticReport.Media... media) {
   ...
   *     specimens (i.e. slides of interest).
   */
  public Us_core_diagnosticreport_noteBuilder withMedia(
