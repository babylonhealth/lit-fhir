...
public class Us_core_goalBuilder {
   ...
   */
  public Us_core_goalBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public Us_core_goalBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public Us_core_goalBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param note - Any comments related to the goal. */
  public Us_core_goalBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Any comments related to the goal. */
  public Us_core_goalBuilder withNote(@NonNull Collection<Annotation> note) {
    this.note = Collections.unmodifiableCollection(note);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public Us_core_goalBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param category - Indicates a category the goal falls within. */
  public Us_core_goalBuilder withCategory(@NonNull CodeableConcept... category) {
    this.category = Arrays.asList(category);
    return this;
  }
  /** @param category - Indicates a category the goal falls within. */
  public Us_core_goalBuilder withCategory(@NonNull Collection<CodeableConcept> category) {
   ...
   */
  public Us_core_goalBuilder withPriority(@NonNull CodeableConcept priority) {
   ...
   */
  public Us_core_goalBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public Us_core_goalBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public Us_core_goalBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Us_core_goalBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public Us_core_goalBuilder withAddresses(@NonNull Reference... addresses) {
   ...
   *     to be addressed by the goal.
   */
  public Us_core_goalBuilder withAddresses(@NonNull Collection<Reference> addresses) {
   ...
   *     server.
   */
  public Us_core_goalBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     server.
   */
  public Us_core_goalBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public Us_core_goalBuilder withStatusDate(@NonNull FHIRDate statusDate) {
    this.statusDate = Optional.of(statusDate);
    return this;
  }
  /** @param expressedBy - Indicates whose goal this is - patient goal, practitioner goal, etc. */
  public Us_core_goalBuilder withExpressedBy(@NonNull Reference expressedBy) {
   ...
   */
  public Us_core_goalBuilder withOutcomeCode(@NonNull CodeableConcept... outcomeCode) {
   ...
   *     the goal is assessed.
   */
  public Us_core_goalBuilder withOutcomeCode(@NonNull Collection<CodeableConcept> outcomeCode) {
  ...
  public Us_core_goalBuilder withStatusReason(@NonNull String statusReason) {
   ...
   *     profiles etc.
   */
  public Us_core_goalBuilder withImplicitRules(@NonNull String implicitRules) {
    this.implicitRules = Optional.of(implicitRules);
    return this;
  }
  /** @param outcomeReference - Details of what's changed (or not changed). */
  public Us_core_goalBuilder withOutcomeReference(@NonNull Reference... outcomeReference) {
    this.outcomeReference = Arrays.asList(outcomeReference);
    return this;
  }
  /** @param outcomeReference - Details of what's changed (or not changed). */
  public Us_core_goalBuilder withOutcomeReference(@NonNull Collection<Reference> outcomeReference) {
   ...
   */
  public Us_core_goalBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public Us_core_goalBuilder withModifierExtension(
   ...
   *     the target.
   */
  public Us_core_goalBuilder withAchievementStatus(@NonNull CodeableConcept achievementStatus) {
    this.achievementStatus = Optional.of(achievementStatus);
    return this;
  }
  /** @param target - Indicates what should be done by when. */
  public Us_core_goalBuilder withTarget(@NonNull Goal.Target... target) {
    this.target = Arrays.asList(target);
    return this;
  }
  /** @param target - Indicates what should be done by when. */
  public Us_core_goalBuilder withTarget(@NonNull Collection<Goal.Target> target) {
