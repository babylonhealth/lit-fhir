...
object UKCore_Questionnaire extends CompanionFor[UKCore_Questionnaire] {
  implicit def summonObjectAndCompanionUKCore_Questionnaire_66183084(
      o: UKCore_Questionnaire): ObjectAndCompanion[UKCore_Questionnaire, UKCore_Questionnaire.type] = ObjectAndCompanion(o, this)
  ...
  override val profileUrl: Option[String]           = Some("https://fhir.hl7.org.uk/StructureDefinition/UKCore-Questionnaire")
  def apply(
      id: Option[String] = None,
      url: Option[UriStr] = None,
      meta: Option[Meta] = Some(new Meta(profile = LitSeq("https://fhir.hl7.org.uk/StructureDefinition/UKCore-Questionnaire"))),
  ...
  ): UKCore_Questionnaire = new UKCore_Questionnaire(
    id,
    url,
    meta,
    text,
  ...
  override def fields(t: UKCore_Questionnaire): Seq[FHIRComponentField[_]]  = fieldsFromParent(t).get
  def extractId(t: UKCore_Questionnaire): Option[String]                    = t.id
  def extractUrl(t: UKCore_Questionnaire): Option[UriStr]                   = t.url
  def extractMeta(t: UKCore_Questionnaire): Option[Meta]                    = t.meta
  def extractText(t: UKCore_Questionnaire): Option[Narrative]               = t.text
  def extractName(t: UKCore_Questionnaire): Option[String]                  = t.name
  def extractDate(t: UKCore_Questionnaire): Option[FHIRDateTime]            = t.date
  def extractCode(t: UKCore_Questionnaire): LitSeq[Coding]                  = t.code
  def extractTitle(t: UKCore_Questionnaire): Option[String]                 = t.title
  def extractStatus(t: UKCore_Questionnaire): PUBLICATION_STATUS            = t.status
  def extractVersion(t: UKCore_Questionnaire): Option[String]               = t.version
  def extractContact(t: UKCore_Questionnaire): LitSeq[ContactDetail]        = t.contact
  def extractPurpose(t: UKCore_Questionnaire): Option[Markdown]             = t.purpose
  def extractLanguage(t: UKCore_Questionnaire): Option[LANGUAGES]           = t.language
  def extractContained(t: UKCore_Questionnaire): LitSeq[Resource]           = t.contained
  def extractExtension(t: UKCore_Questionnaire): LitSeq[Extension]          = t.extension
  def extractPublisher(t: UKCore_Questionnaire): Option[String]             = t.publisher
  def extractCopyright(t: UKCore_Questionnaire): Option[Markdown]           = t.copyright
  def extractUseContext(t: UKCore_Questionnaire): LitSeq[UsageContext]      = t.useContext
  def extractDerivedFrom(t: UKCore_Questionnaire): LitSeq[Canonical]        = t.derivedFrom
  def extractSubjectType(t: UKCore_Questionnaire): LitSeq[RESOURCE_TYPES]   = t.subjectType
  def extractDescription(t: UKCore_Questionnaire): Option[Markdown]         = t.description
  def extractExperimental(t: UKCore_Questionnaire): Option[Boolean]         = t.experimental
  def extractJurisdiction(t: UKCore_Questionnaire): LitSeq[CodeableConcept] = t.jurisdiction
  def extractApprovalDate(t: UKCore_Questionnaire): Option[FHIRDate]        = t.approvalDate
  def extractImplicitRules(t: UKCore_Questionnaire): Option[UriStr]         = t.implicitRules
  def extractLastReviewDate(t: UKCore_Questionnaire): Option[FHIRDate]      = t.lastReviewDate
  def extractEffectivePeriod(t: UKCore_Questionnaire): Option[Period]       = t.effectivePeriod
  def extractModifierExtension(t: UKCore_Questionnaire): LitSeq[Extension]  = t.modifierExtension
  def extractIdentifier(t: UKCore_Questionnaire): LitSeq[Identifier]        = t.identifier
  def extractItem(t: UKCore_Questionnaire): LitSeq[Questionnaire.Item]      = t.item
  override val thisName: String                                             = "UKCore_Questionnaire"
  override val searchParams: Map[String, UKCore_Questionnaire => Seq[Any]]  = Questionnaire.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[UKCore_Questionnaire] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new UKCore_Questionnaire(
...
/** Defines the UK Core constraints and extensions on the Questionnaire resource for the minimal set of data to query and retrieve
  * the questionnaire information.
  *
  * Subclass of [[hl7.model.Questionnaire]] (A structured set of questions intended to guide the collection of answers from
  * end-users. Questionnaires provide detailed control over order, presentation, phraseology and grouping to allow coherent,
  ...
  *     design or instance. This is an arbitrary value managed by the questionnaire author and is not expected to be globally
  ...
  */
@POJOBoilerplate
class UKCore_Questionnaire(
    override val id: Option[String] = None,
    override val url: Option[UriStr] = None,
    override val meta: Option[Meta] = Some(
      new Meta(profile = LitSeq("https://fhir.hl7.org.uk/StructureDefinition/UKCore-Questionnaire"))),
