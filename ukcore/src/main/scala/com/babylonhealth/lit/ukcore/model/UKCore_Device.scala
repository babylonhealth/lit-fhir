...
object UKCore_Device extends CompanionFor[UKCore_Device] {
  implicit def summonObjectAndCompanionUKCore_Device_403291963(
      o: UKCore_Device): ObjectAndCompanion[UKCore_Device, UKCore_Device.type] = ObjectAndCompanion(o, this)
  ...
  override val profileUrl: Option[String]           = Some("https://fhir.hl7.org.uk/StructureDefinition/UKCore-Device")
  def apply(
      id: Option[String] = None,
      url: Option[UriStr] = None,
      meta: Option[Meta] = Some(new Meta(profile = LitSeq("https://fhir.hl7.org.uk/StructureDefinition/UKCore-Device"))),
  ...
  ): UKCore_Device = new UKCore_Device(
    id,
    url,
    meta,
    text,
  ...
  override def fields(t: UKCore_Device): Seq[FHIRComponentField[_]]          = fieldsFromParent(t).get
  def extractId(t: UKCore_Device): Option[String]                            = t.id
  def extractUrl(t: UKCore_Device): Option[UriStr]                           = t.url
  def extractMeta(t: UKCore_Device): Option[Meta]                            = t.meta
  def extractText(t: UKCore_Device): Option[Narrative]                       = t.text
  def extractType(t: UKCore_Device): Option[CodeableConcept]                 = t.`type`
  def extractStatus(t: UKCore_Device): Option[DEVICE_STATUS]                 = t.status
  def extractSafety(t: UKCore_Device): LitSeq[CodeableConcept]               = t.safety
  def extractContact(t: UKCore_Device): LitSeq[ContactPoint]                 = t.contact
  def extractLanguage(t: UKCore_Device): Option[LANGUAGES]                   = t.language
  def extractContained(t: UKCore_Device): LitSeq[Resource]                   = t.contained
  def extractExtension(t: UKCore_Device): LitSeq[Extension]                  = t.extension
  def extractLotNumber(t: UKCore_Device): Option[String]                     = t.lotNumber
  def extractPartNumber(t: UKCore_Device): Option[String]                    = t.partNumber
  def extractModelNumber(t: UKCore_Device): Option[String]                   = t.modelNumber
  def extractStatusReason(t: UKCore_Device): LitSeq[CodeableConcept]         = t.statusReason
  def extractManufacturer(t: UKCore_Device): Option[String]                  = t.manufacturer
  def extractSerialNumber(t: UKCore_Device): Option[String]                  = t.serialNumber
  def extractImplicitRules(t: UKCore_Device): Option[UriStr]                 = t.implicitRules
  def extractExpirationDate(t: UKCore_Device): Option[FHIRDateTime]          = t.expirationDate
  def extractNote(t: UKCore_Device): LitSeq[Annotation]                      = t.note
  def extractManufactureDate(t: UKCore_Device): Option[FHIRDateTime]         = t.manufactureDate
  def extractModifierExtension(t: UKCore_Device): LitSeq[Extension]          = t.modifierExtension
  def extractDistinctIdentifier(t: UKCore_Device): Option[String]            = t.distinctIdentifier
  def extractIdentifier(t: UKCore_Device): LitSeq[Identifier]                = t.identifier
  def extractProperty(t: UKCore_Device): LitSeq[Device.Property]             = t.property
  def extractOwner(t: UKCore_Device): Option[Reference]                      = t.owner
  def extractVersion(t: UKCore_Device): LitSeq[Device.Version]               = t.version
  def extractParent(t: UKCore_Device): Option[Reference]                     = t.parent
  def extractUdiCarrier(t: UKCore_Device): LitSeq[Device.UdiCarrier]         = t.udiCarrier
  def extractDeviceName(t: UKCore_Device): LitSeq[Device.DeviceName]         = t.deviceName
  def extractPatient(t: UKCore_Device): Option[Reference]                    = t.patient
  def extractLocation(t: UKCore_Device): Option[Reference]                   = t.location
  def extractDefinition(t: UKCore_Device): Option[Reference]                 = t.definition
  def extractSpecialization(t: UKCore_Device): LitSeq[Device.Specialization] = t.specialization
  override val thisName: String                                              = "UKCore_Device"
  override val searchParams: Map[String, UKCore_Device => Seq[Any]]          = Device.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[UKCore_Device] =
...
/** Defines the UK Core constraints and extensions on the Device resource for the minimal set of data to query and retrieve
  * information relating to a type of a manufactured item that is used in the provision of healthcare without being substantially
  * changed through that activity. The device may be a medical or non-medical device.
  *
  ...
  *     describing the Device. This typically would be used when a person provides the name(s) or when the device represents one
  *     of the names available from DeviceDefinition.
  * @param patient
...
class UKCore_Device(
    ...
    override val meta: Option[Meta] = Some(
      new Meta(profile = LitSeq("https://fhir.hl7.org.uk/StructureDefinition/UKCore-Device"))),
    ...
    override val udiCarrier: LitSeq[Device.UdiCarrier] = LitSeq.empty,
