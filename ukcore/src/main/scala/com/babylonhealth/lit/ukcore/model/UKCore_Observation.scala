...
object UKCore_Observation extends CompanionFor[UKCore_Observation] {
  implicit def summonObjectAndCompanionUKCore_Observation_1865489635(
      o: UKCore_Observation): ObjectAndCompanion[UKCore_Observation, UKCore_Observation.type] = ObjectAndCompanion(o, this)
  ...
  override val profileUrl: Option[String]           = Some("https://fhir.hl7.org.uk/StructureDefinition/UKCore-Observation")
  type ValueChoice     = Choice[Union02118820890]
  type EffectiveChoice = Choice[Union00107722725]
  def apply(
      id: Option[String] = None,
      meta: Option[Meta] = Some(new Meta(profile = LitSeq("https://fhir.hl7.org.uk/StructureDefinition/UKCore-Observation"))),
      ...
      value: Option[UKCore_Observation.ValueChoice] = None,
      contained: LitSeq[Resource] = LitSeq.empty,
      extension: LitSeq[Extension] = LitSeq.empty,
      effective: Option[UKCore_Observation.EffectiveChoice] = None,
  ...
  ): UKCore_Observation = new UKCore_Observation(
    id,
    meta,
    text,
    status,
  ...
  val value: FHIRComponentFieldMeta[Option[UKCore_Observation.ValueChoice]] =
    FHIRComponentFieldMeta("value", lTagOf[Option[UKCore_Observation.ValueChoice]], true, lTagOf[Union02118820890])
  val contained: FHIRComponentFieldMeta[LitSeq[Resource]] =
    FHIRComponentFieldMeta("contained", lTagOf[LitSeq[Resource]], false, lTagOf[Resource])
  val extension: FHIRComponentFieldMeta[LitSeq[Extension]] =
    FHIRComponentFieldMeta("extension", lTagOf[LitSeq[Extension]], false, lTagOf[Extension])
  val effective: FHIRComponentFieldMeta[Option[UKCore_Observation.EffectiveChoice]] =
    FHIRComponentFieldMeta("effective", lTagOf[Option[UKCore_Observation.EffectiveChoice]], true, lTagOf[Union00107722725])
  ...
  override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Try(
    Seq(
      ...
      FHIRComponentField[Option[UKCore_Observation.ValueChoice]](value, t.value),
      FHIRComponentField[LitSeq[Resource]](contained, t.contained),
      FHIRComponentField[LitSeq[Extension]](extension, t.extension),
      FHIRComponentField[Option[UKCore_Observation.EffectiveChoice]](effective, t.effective),
  ...
  override def fields(t: UKCore_Observation): Seq[FHIRComponentField[_]]                  = fieldsFromParent(t).get
  def extractId(t: UKCore_Observation): Option[String]                                    = t.id
  def extractMeta(t: UKCore_Observation): Option[Meta]                                    = t.meta
  def extractText(t: UKCore_Observation): Option[Narrative]                               = t.text
  def extractStatus(t: UKCore_Observation): OBSERVATION_STATUS                            = t.status
  def extractIssued(t: UKCore_Observation): Option[ZonedDateTime]                         = t.issued
  def extractMethod(t: UKCore_Observation): Option[CodeableConcept]                       = t.method
  def extractLanguage(t: UKCore_Observation): Option[LANGUAGES]                           = t.language
  def extractCategory(t: UKCore_Observation): LitSeq[CodeableConcept]                     = t.category
  def extractValue(t: UKCore_Observation): Option[UKCore_Observation.ValueChoice]         = t.value
  def extractContained(t: UKCore_Observation): LitSeq[Resource]                           = t.contained
  def extractExtension(t: UKCore_Observation): LitSeq[Extension]                          = t.extension
  def extractEffective(t: UKCore_Observation): Option[UKCore_Observation.EffectiveChoice] = t.effective
  def extractImplicitRules(t: UKCore_Observation): Option[UriStr]                         = t.implicitRules
  def extractCode(t: UKCore_Observation): CodeableConcept                                 = t.code
  def extractInterpretation(t: UKCore_Observation): LitSeq[CodeableConcept]               = t.interpretation
  def extractNote(t: UKCore_Observation): LitSeq[Annotation]                              = t.note
  def extractDataAbsentReason(t: UKCore_Observation): Option[CodeableConcept]             = t.dataAbsentReason
  def extractModifierExtension(t: UKCore_Observation): LitSeq[Extension]                  = t.modifierExtension
  def extractBodySite(t: UKCore_Observation): Option[CodeableConcept]                     = t.bodySite
  def extractIdentifier(t: UKCore_Observation): LitSeq[Identifier]                        = t.identifier
  def extractFocus(t: UKCore_Observation): LitSeq[Reference]                              = t.focus
  def extractPartOf(t: UKCore_Observation): LitSeq[Reference]                             = t.partOf
  def extractDevice(t: UKCore_Observation): Option[Reference]                             = t.device
  def extractComponent(t: UKCore_Observation): LitSeq[Observation.Component]              = t.component
  def extractBasedOn(t: UKCore_Observation): LitSeq[Reference]                            = t.basedOn
  def extractSubject(t: UKCore_Observation): Option[Reference]                            = t.subject
  def extractSpecimen(t: UKCore_Observation): Option[Reference]                           = t.specimen
  def extractEncounter(t: UKCore_Observation): Option[Reference]                          = t.encounter
  def extractPerformer(t: UKCore_Observation): LitSeq[Reference]                          = t.performer
  def extractHasMember(t: UKCore_Observation): LitSeq[Reference]                          = t.hasMember
  def extractReferenceRange(t: UKCore_Observation): LitSeq[Observation.ReferenceRange]    = t.referenceRange
  def extractDerivedFrom(t: UKCore_Observation): LitSeq[Reference]                        = t.derivedFrom
  override val thisName: String                                                           = "UKCore_Observation"
  override val searchParams: Map[String, UKCore_Observation => Seq[Any]]                  = Observation.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[UKCore_Observation] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new UKCore_Observation(
...
/** Defines the UK Core constraints and extensions on the observation resource for the minimal set of data to query and retrieve
  * generic observation information.
  *
  ...
  */
@POJOBoilerplate
class UKCore_Observation(
    override val id: Option[String] = None,
    override val meta: Option[Meta] = Some(
      new Meta(profile = LitSeq("https://fhir.hl7.org.uk/StructureDefinition/UKCore-Observation"))),
    ...
    override val value: Option[UKCore_Observation.ValueChoice] = None,
    override val contained: LitSeq[Resource] = LitSeq.empty,
    override val extension: LitSeq[Extension] = LitSeq.empty,
    override val effective: Option[UKCore_Observation.EffectiveChoice] = None,
