...
public class BpBuilder {
  private Optional<String> id = Optional.empty();
  private Optional<Meta> meta =
      Optional.of(
          new MetaBuilder().withProfile("http://hl7.org/fhir/StructureDefinition/bp").build());
    ...
    this.effective =
        (Choice)
            Choice$.MODULE$.fromSuffix(
                autoSuffix(effective.getClass().getSimpleName(), Bp$.MODULE$.effective()),
                effective,
                Bp$.MODULE$.effective());
    this.code = code;
   ...
   */
  public BpBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public BpBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public BpBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public BpBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public BpBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   */
  public BpBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     patient of record and the mother is the focus.
   */
  public BpBuilder withFocus(@NonNull Collection<Reference> focus) {
   ...
   */
  public BpBuilder withPartOf(@NonNull Reference... partOf) {
   ...
   *     example, an observation as part of a procedure.
   */
  public BpBuilder withPartOf(@NonNull Collection<Reference> partOf) {
   ...
   */
  public BpBuilder withIssued(@NonNull ZonedDateTime issued) {
    this.issued = Optional.of(issued);
    return this;
  }
  /** @param method - Indicates the mechanism used to perform the observation. */
  public BpBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param device - The device used to generate the observation data. */
  public BpBuilder withDevice(@NonNull Reference device) {
   ...
   */
  public BpBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     before it is dispensed.
   */
  public BpBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public BpBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public BpBuilder withValue(@NonNull Quantity value) {
   ...
   *     the target site).
   */
  public BpBuilder withBodySite(@NonNull CodeableConcept bodySite) {
    this.bodySite = Optional.of(bodySite);
    return this;
  }
  /** @param specimen - The specimen that was used when this observation was made. */
  public BpBuilder withSpecimen(@NonNull Reference specimen) {
   ...
   */
  public BpBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public BpBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public BpBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public BpBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public BpBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public BpBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public BpBuilder withPerformer(@NonNull Collection<Reference> performer) {
    this.performer = Collections.unmodifiableCollection(performer);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public BpBuilder withHasMember(@NonNull Reference... hasMember) {
    this.hasMember = Arrays.asList(hasMember);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public BpBuilder withHasMember(@NonNull Collection<Reference> hasMember) {
  ...
  public BpBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public BpBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public BpBuilder withDerivedFrom(@NonNull Reference... derivedFrom) {
   ...
   *     based on an ultrasound image.
   */
  public BpBuilder withDerivedFrom(@NonNull Collection<Reference> derivedFrom) {
   ...
   *     profiles etc.
   */
  public BpBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     low, normal.
   */
  public BpBuilder withInterpretation(@NonNull CodeableConcept... interpretation) {
   ...
   *     low, normal.
   */
  public BpBuilder withInterpretation(@NonNull Collection<CodeableConcept> interpretation) {
   ...
   */
  public BpBuilder withDataAbsentReason(@NonNull CodeableConcept dataAbsentReason) {
   ...
   */
  public BpBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public BpBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
   ...
   */
  public BpBuilder withReferenceRange(@NonNull Observation.ReferenceRange... referenceRange) {
   ...
   *     represent two distinct target populations, two `referenceRange` elements would be used.
   */
  public BpBuilder withReferenceRange(
