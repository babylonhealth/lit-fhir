...
public class SynthesisBuilder {
   ...
   */
  public SynthesisBuilder withId(@NonNull String id) {
   ...
   *     different servers.
   */
  public SynthesisBuilder withUrl(@NonNull String url) {
   ...
   *     to the resource.
   */
  public SynthesisBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public SynthesisBuilder withText(@NonNull Narrative text) {
   ...
   */
  public SynthesisBuilder withName(@NonNull String name) {
   ...
   */
  public SynthesisBuilder withDate(@NonNull FHIRDateTime date) {
    this.date = Optional.of(date);
    return this;
  }
  /** @param note - A human-readable string to clarify or explain concepts about the resource. */
  public SynthesisBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - A human-readable string to clarify or explain concepts about the resource. */
  public SynthesisBuilder withNote(@NonNull Collection<Annotation> note) {
    this.note = Collections.unmodifiableCollection(note);
    return this;
  }
  /** @param title - A short, descriptive, user-friendly title for the evidence. */
  public SynthesisBuilder withTitle(@NonNull String title) {
   ...
   *     searching.
   */
  public SynthesisBuilder withTopic(@NonNull CodeableConcept... topic) {
   ...
   *     searching.
   */
  public SynthesisBuilder withTopic(@NonNull Collection<CodeableConcept> topic) {
   ...
   */
  public SynthesisBuilder withAuthor(@NonNull ContactDetail... author) {
   ...
   *     maintenance of the content.
   */
  public SynthesisBuilder withAuthor(@NonNull Collection<ContactDetail> author) {
   ...
   *     the content.
   */
  public SynthesisBuilder withEditor(@NonNull ContactDetail... editor) {
   ...
   *     the content.
   */
  public SynthesisBuilder withEditor(@NonNull Collection<ContactDetail> editor) {
   ...
   */
  public SynthesisBuilder withVersion(@NonNull String version) {
   ...
   *     publisher.
   */
  public SynthesisBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public SynthesisBuilder withContact(@NonNull Collection<ContactDetail> contact) {
    this.contact = Collections.unmodifiableCollection(contact);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public SynthesisBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public SynthesisBuilder withSubtitle(@NonNull String subtitle) {
   ...
   *     of the content.
   */
  public SynthesisBuilder withReviewer(@NonNull ContactDetail... reviewer) {
   ...
   *     of the content.
   */
  public SynthesisBuilder withReviewer(@NonNull Collection<ContactDetail> reviewer) {
   ...
   */
  public SynthesisBuilder withEndorser(@NonNull ContactDetail... endorser) {
   ...
   *     content for use in some setting.
   */
  public SynthesisBuilder withEndorser(@NonNull Collection<ContactDetail> endorser) {
   ...
   */
  public SynthesisBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public SynthesisBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public SynthesisBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public SynthesisBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param publisher - The name of the organization or individual that published the evidence. */
  public SynthesisBuilder withPublisher(@NonNull String publisher) {
   ...
   *     evidence.
   */
  public SynthesisBuilder withCopyright(@NonNull String copyright) {
   ...
   *     instance.
   */
  public SynthesisBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     instance.
   */
  public SynthesisBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public SynthesisBuilder withShortTitle(@NonNull String shortTitle) {
   ...
   */
  public SynthesisBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate evidence instances.
   */
  public SynthesisBuilder withUseContext(@NonNull Collection<UsageContext> useContext) {
   ...
   *     perspective.
   */
  public SynthesisBuilder withDescription(@NonNull String description) {
   ...
   *     used.
   */
  public SynthesisBuilder withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
   ...
   *     used.
   */
  public SynthesisBuilder withJurisdiction(@NonNull Collection<CodeableConcept> jurisdiction) {
   ...
   */
  public SynthesisBuilder withApprovalDate(@NonNull FHIRDate approvalDate) {
   ...
   *     profiles etc.
   */
  public SynthesisBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public SynthesisBuilder withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
   ...
   *     in active use.
   */
  public SynthesisBuilder withEffectivePeriod(@NonNull Period effectivePeriod) {
   ...
   */
  public SynthesisBuilder withRelatedArtifact(@NonNull RelatedArtifact... relatedArtifact) {
   ...
   *     bibliographic references.
   */
  public SynthesisBuilder withRelatedArtifact(
   ...
   */
  public SynthesisBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public SynthesisBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
