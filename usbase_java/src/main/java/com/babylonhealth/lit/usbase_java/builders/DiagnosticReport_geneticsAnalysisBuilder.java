...
public interface DiagnosticReport_geneticsAnalysisBuilder extends ExtensionBuilder {
  ...
  public class Impl implements DiagnosticReport_geneticsAnalysisBuilder {
    private Optional<String> id = Optional.empty();
    private Collection<Extension> extension;

    /**
     * Required fields for {@link DiagnosticReport_geneticsAnalysis}
     *
     ...
     */
    public DiagnosticReport_geneticsAnalysisBuilder.Impl withId(@NonNull String id) {
