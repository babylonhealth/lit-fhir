...
public interface Codesystem_alternateBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Codesystem_alternateBuilder {
    private Optional<String> id = Optional.empty();
    private Collection<Extension> extension;

    /**
     * Required fields for {@link Codesystem_alternate}
     *
     ...
     */
    public Codesystem_alternateBuilder.Impl withId(@NonNull String id) {
