...
public class Patient_birthTimeBuilder {
   ...
   */
  public Patient_birthTimeBuilder(String url, FHIRDateTime value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Patient_birthTimeBuilder withId(@NonNull String id) {
