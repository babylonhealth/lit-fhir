...
public interface TranslationBuilder extends ExtensionBuilder {
  ...
  public class Impl implements TranslationBuilder {
    private Optional<String> id = Optional.empty();
    private Collection<Extension> extension;

    /**
     * Required fields for {@link Translation}
     *
     ...
     */
    public TranslationBuilder.Impl withId(@NonNull String id) {
