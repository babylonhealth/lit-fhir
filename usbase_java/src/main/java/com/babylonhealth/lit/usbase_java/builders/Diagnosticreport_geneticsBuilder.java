...
public class Diagnosticreport_geneticsBuilder {
   ...
   */
  public Diagnosticreport_geneticsBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public Diagnosticreport_geneticsBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public Diagnosticreport_geneticsBuilder withText(@NonNull Narrative text) {
   ...
   */
  public Diagnosticreport_geneticsBuilder withIssued(@NonNull ZonedDateTime issued) {
   ...
   *     diagnostic report.
   */
  public Diagnosticreport_geneticsBuilder withResult(@NonNull Reference... result) {
   ...
   *     diagnostic report.
   */
  public Diagnosticreport_geneticsBuilder withResult(@NonNull Collection<Reference> result) {
    this.result = Collections.unmodifiableCollection(result);
    return this;
  }
  /** @param basedOn - Details concerning a service requested. */
  public Diagnosticreport_geneticsBuilder withBasedOn(@NonNull Reference... basedOn) {
    this.basedOn = Arrays.asList(basedOn);
    return this;
  }
  /** @param basedOn - Details concerning a service requested. */
  public Diagnosticreport_geneticsBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
   ...
   *     other sources.
   */
  public Diagnosticreport_geneticsBuilder withSubject(@NonNull Reference subject) {
    this.subject = Optional.of(subject);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public Diagnosticreport_geneticsBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public Diagnosticreport_geneticsBuilder withCategory(@NonNull CodeableConcept... category) {
   ...
   *     used for searching, sorting and display purposes.
   */
  public Diagnosticreport_geneticsBuilder withCategory(
  ...
  public Diagnosticreport_geneticsBuilder withSpecimen(@NonNull Reference... specimen) {
    this.specimen = Arrays.asList(specimen);
    return this;
  }
  /** @param specimen - Details about the specimens on which this diagnostic report is based. */
  public Diagnosticreport_geneticsBuilder withSpecimen(@NonNull Collection<Reference> specimen) {
   ...
   */
  public Diagnosticreport_geneticsBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public Diagnosticreport_geneticsBuilder withContained(@NonNull Collection<Resource> contained) {
    this.contained = Collections.unmodifiableCollection(contained);
    return this;
  }
  /** @param extension - An Extension */
  public Diagnosticreport_geneticsBuilder withExtension(@NonNull Extension... extension) {
    this.extension = Arrays.asList(extension);
    return this;
  }
  /** @param extension - An Extension */
  public Diagnosticreport_geneticsBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public Diagnosticreport_geneticsBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - The diagnostic service that is responsible for issuing the report. */
  public Diagnosticreport_geneticsBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - The diagnostic service that is responsible for issuing the report. */
  public Diagnosticreport_geneticsBuilder withPerformer(@NonNull Collection<Reference> performer) {
    this.performer = Collections.unmodifiableCollection(performer);
    return this;
  }
  /** @param identifier - Identifiers assigned to this report by the performer or other systems. */
  public Diagnosticreport_geneticsBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - Identifiers assigned to this report by the performer or other systems. */
  public Diagnosticreport_geneticsBuilder withIdentifier(
   ...
   */
  public Diagnosticreport_geneticsBuilder withConclusion(@NonNull String conclusion) {
   ...
   */
  public <T> Diagnosticreport_geneticsBuilder withEffective(@NonNull T effective) {
    var guessedSuffix =
        autoSuffix(
            effective.getClass().getSimpleName(), Diagnosticreport_genetics$.MODULE$.effective());
   ...
   */
  public <T> Diagnosticreport_geneticsBuilder withEffective(String suffix, @NonNull T effective) {
    guard(
        effective.getClass().getSimpleName(),
        suffix,
        Diagnosticreport_genetics$.MODULE$.effective());
    this.effective =
        Optional.of(
            (Choice)
                Choice$.MODULE$.fromSuffix(
                    suffix, effective, Diagnosticreport_genetics$.MODULE$.effective()));
    return this;
  }
  /**
   ...
   */
  public Diagnosticreport_geneticsBuilder withImagingStudy(@NonNull Reference... imagingStudy) {
   ...
   *     views of the source images.
   */
  public Diagnosticreport_geneticsBuilder withImagingStudy(
   ...
   *     profiles etc.
   */
  public Diagnosticreport_geneticsBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public Diagnosticreport_geneticsBuilder withPresentedForm(@NonNull Attachment... presentedForm) {
   ...
   *     diagnostic service. Multiple formats are allowed but they SHALL be semantically equivalent.
   */
  public Diagnosticreport_geneticsBuilder withPresentedForm(
   ...
   */
  public Diagnosticreport_geneticsBuilder withModifierExtension(
   ...
   */
  public Diagnosticreport_geneticsBuilder withResultsInterpreter(
   ...
   */
  public Diagnosticreport_geneticsBuilder withMedia(@NonNull DiagnosticReport.Media... media) {
   ...
   *     specimens (i.e. slides of interest).
   */
  public Diagnosticreport_geneticsBuilder withMedia(
