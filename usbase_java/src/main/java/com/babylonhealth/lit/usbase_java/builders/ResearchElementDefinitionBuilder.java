...
import com.babylonhealth.lit.usbase.RESEARCH_ELEMENT_TYPE;
import com.babylonhealth.lit.hl7.PUBLICATION_STATUS;
import com.babylonhealth.lit.core.LANGUAGES;
import com.babylonhealth.lit.usbase.VARIABLE_TYPE;
...
public interface ResearchElementDefinitionBuilder extends DomainResourceBuilder {
  ...
  public class Impl implements ResearchElementDefinitionBuilder {
     ...
     * @param status - The status of this research element definition. Enables tracking the
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /**
     * @param url - An absolute URI that is used to identify this research element definition when
     *     it is referenced in a specification, model, design or an instance; also called its
     *     canonical identifier. This SHOULD be globally unique and SHOULD be a literal address at
     *     which at which an authoritative instance of this research element definition is (or will
     *     be) published. This URL can be the target of a canonical reference. It SHALL remain the
     *     same when the research element definition is stored on different servers.
     */
    public ResearchElementDefinitionBuilder.Impl withUrl(@NonNull String url) {
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public ResearchElementDefinitionBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public ResearchElementDefinitionBuilder.Impl withText(@NonNull NarrativeBuilder text) {
     ...
     *     as code generation.
     */
    public ResearchElementDefinitionBuilder.Impl withName(@NonNull String name) {
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withDate(@NonNull FHIRDateTime date) {
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withTitle(@NonNull String title) {
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withUsage(@NonNull String usage) {
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withTopic(@NonNull CodeableConcept... topic) {
     ...
     *     that can be useful for filtering and searching.
     */
    public ResearchElementDefinitionBuilder.Impl withTopic(
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withAuthor(@NonNull ContactDetail... author) {
     ...
     *     maintenance of the content.
     */
    public ResearchElementDefinitionBuilder.Impl withAuthor(
     ...
     *     the content.
     */
    public ResearchElementDefinitionBuilder.Impl withEditor(@NonNull ContactDetail... editor) {
     ...
     *     the content.
     */
    public ResearchElementDefinitionBuilder.Impl withEditor(
     ...
     *     an arbitrary value managed by the research element definition author and is not expected
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withVersion(@NonNull String version) {
     ...
     *     publisher.
     */
    public ResearchElementDefinitionBuilder.Impl withContact(@NonNull ContactDetail... contact) {
     ...
     *     publisher.
     */
    public ResearchElementDefinitionBuilder.Impl withContact(
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withComment(@NonNull String... comment) {
     ...
     * @param comment - A human-readable string to clarify or explain concepts about the resource.
     */
    public ResearchElementDefinitionBuilder.Impl withComment(@NonNull Collection<String> comment) {
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withPurpose(@NonNull String purpose) {
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withLibrary(@NonNull String... library) {
     ...
     *     ResearchElementDefinition.
     */
    public ResearchElementDefinitionBuilder.Impl withLibrary(@NonNull Collection<String> library) {
      this.library = Collections.unmodifiableCollection(library);
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public ResearchElementDefinitionBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withSubtitle(@NonNull String subtitle) {
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withReviewer(@NonNull ContactDetail... reviewer) {
     ...
     *     aspect of the content.
     */
    public ResearchElementDefinitionBuilder.Impl withReviewer(
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withEndorser(@NonNull ContactDetail... endorser) {
     ...
     *     content for use in some setting.
     */
    public ResearchElementDefinitionBuilder.Impl withEndorser(
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public ResearchElementDefinitionBuilder.Impl withContained(
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public ResearchElementDefinitionBuilder.Impl withExtension(
     ...
     *     element definition.
     */
    public ResearchElementDefinitionBuilder.Impl withPublisher(@NonNull String publisher) {
      this.publisher = Optional.of(publisher);
      return this;
    }
    /**
     * @param copyright - A copyright statement relating to the research element definition and/or
     *     its contents. Copyright statements are generally legal restrictions on the use and
     *     publishing of the research element definition.
     */
    public ResearchElementDefinitionBuilder.Impl withCopyright(@NonNull String copyright) {
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     *     model, design or an instance.
     */
    public ResearchElementDefinitionBuilder.Impl withIdentifier(
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withShortTitle(@NonNull String shortTitle) {
     ...
     *     ResearchElementDefinition can be anything. Field is a 'choice' field. Type should be one
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withUseContext(
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withDescription(@NonNull String description) {
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withExperimental(@NonNull Boolean experimental) {
      this.experimental = Optional.of(experimental);
      return this;
    }
    /**
     * @param jurisdiction - A legal or geographic region in which the research element definition
     *     is intended to be used.
     */
    public ResearchElementDefinitionBuilder.Impl withJurisdiction(
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withApprovalDate(@NonNull FHIRDate approvalDate) {
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withVariableType(
        @NonNull VARIABLE_TYPE variableType) {
     ...
     *     profiles etc.
     */
    public ResearchElementDefinitionBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withLastReviewDate(
        @NonNull FHIRDate lastReviewDate) {
      this.lastReviewDate = Optional.of(lastReviewDate);
      return this;
    }
    /**
     * @param effectivePeriod - The period during which the research element definition content was
     *     or is planned to be in active use.
     */
    public ResearchElementDefinitionBuilder.Impl withEffectivePeriod(
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withRelatedArtifact(
     ...
     */
    public ResearchElementDefinitionBuilder.Impl withModifierExtension(
    ...
    public ResearchElementDefinition build() {
      return new ResearchElementDefinition(
          ...
          OptionConverters.toScala(variableType),
