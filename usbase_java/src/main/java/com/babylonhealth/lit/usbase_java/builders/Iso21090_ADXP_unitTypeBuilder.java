...
public class Iso21090_ADXP_unitTypeBuilder {
   ...
   */
  public Iso21090_ADXP_unitTypeBuilder(String url, String value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Iso21090_ADXP_unitTypeBuilder withId(@NonNull String id) {
