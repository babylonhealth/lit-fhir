...
public class DiagnosticReport_riskBuilder {
   ...
   */
  public DiagnosticReport_riskBuilder(String url, Reference value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public DiagnosticReport_riskBuilder withId(@NonNull String id) {
