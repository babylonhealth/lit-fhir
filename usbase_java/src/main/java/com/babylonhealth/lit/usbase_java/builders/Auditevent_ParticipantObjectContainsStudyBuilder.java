...
public interface Auditevent_ParticipantObjectContainsStudyBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Auditevent_ParticipantObjectContainsStudyBuilder {
     ...
     */
    public Auditevent_ParticipantObjectContainsStudyBuilder.Impl withId(@NonNull String id) {
