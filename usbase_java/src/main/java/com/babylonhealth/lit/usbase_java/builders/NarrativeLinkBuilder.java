...
public interface NarrativeLinkBuilder extends ExtensionBuilder {
  ...
  public class Impl implements NarrativeLinkBuilder {
     ...
     */
    public NarrativeLinkBuilder.Impl withId(@NonNull String id) {
