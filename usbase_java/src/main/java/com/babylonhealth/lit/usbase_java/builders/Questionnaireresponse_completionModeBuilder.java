...
public interface Questionnaireresponse_completionModeBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Questionnaireresponse_completionModeBuilder {
     ...
     */
    public Questionnaireresponse_completionModeBuilder.Impl withId(@NonNull String id) {
