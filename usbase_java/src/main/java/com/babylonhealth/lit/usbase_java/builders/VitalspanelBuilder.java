...
public class VitalspanelBuilder {
   ...
   */
  public VitalspanelBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public VitalspanelBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public VitalspanelBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public VitalspanelBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public VitalspanelBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   */
  public VitalspanelBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     patient of record and the mother is the focus.
   */
  public VitalspanelBuilder withFocus(@NonNull Collection<Reference> focus) {
   ...
   */
  public VitalspanelBuilder withPartOf(@NonNull Reference... partOf) {
   ...
   *     example, an observation as part of a procedure.
   */
  public VitalspanelBuilder withPartOf(@NonNull Collection<Reference> partOf) {
   ...
   */
  public VitalspanelBuilder withIssued(@NonNull ZonedDateTime issued) {
    this.issued = Optional.of(issued);
    return this;
  }
  /** @param method - Indicates the mechanism used to perform the observation. */
  public VitalspanelBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param device - The device used to generate the observation data. */
  public VitalspanelBuilder withDevice(@NonNull Reference device) {
   ...
   */
  public VitalspanelBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     before it is dispensed.
   */
  public VitalspanelBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public VitalspanelBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   *     the target site).
   */
  public VitalspanelBuilder withBodySite(@NonNull CodeableConcept bodySite) {
    this.bodySite = Optional.of(bodySite);
    return this;
  }
  /** @param specimen - The specimen that was used when this observation was made. */
  public VitalspanelBuilder withSpecimen(@NonNull Reference specimen) {
   ...
   */
  public VitalspanelBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public VitalspanelBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public VitalspanelBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public VitalspanelBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public VitalspanelBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public VitalspanelBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public VitalspanelBuilder withPerformer(@NonNull Collection<Reference> performer) {
    this.performer = Collections.unmodifiableCollection(performer);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public VitalspanelBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public VitalspanelBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public VitalspanelBuilder withDerivedFrom(@NonNull Reference... derivedFrom) {
   ...
   *     based on an ultrasound image.
   */
  public VitalspanelBuilder withDerivedFrom(@NonNull Collection<Reference> derivedFrom) {
   ...
   *     profiles etc.
   */
  public VitalspanelBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     low, normal.
   */
  public VitalspanelBuilder withInterpretation(@NonNull CodeableConcept... interpretation) {
   ...
   *     low, normal.
   */
  public VitalspanelBuilder withInterpretation(
   ...
   */
  public VitalspanelBuilder withDataAbsentReason(@NonNull CodeableConcept dataAbsentReason) {
   ...
   */
  public VitalspanelBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public VitalspanelBuilder withModifierExtension(
      @NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param component - Used when reporting systolic and diastolic blood pressure. */
  public VitalspanelBuilder withComponent(@NonNull Observation.Component... component) {
    this.component = Arrays.asList(component);
    return this;
  }
  /** @param component - Used when reporting systolic and diastolic blood pressure. */
  public VitalspanelBuilder withComponent(@NonNull Collection<Observation.Component> component) {
   ...
   */
  public VitalspanelBuilder withReferenceRange(
