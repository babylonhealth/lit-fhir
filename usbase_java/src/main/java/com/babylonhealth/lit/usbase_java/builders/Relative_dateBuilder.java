...
public interface Relative_dateBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Relative_dateBuilder {
    private Optional<String> id = Optional.empty();
    private Collection<Extension> extension;

    /**
     * Required fields for {@link Relative_date}
     *
     ...
     */
    public Relative_dateBuilder.Impl withId(@NonNull String id) {
