...
public class SubstanceSourceMaterial_Organism_HybridBuilder {
  ...
  public SubstanceSourceMaterial_Organism_HybridBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public SubstanceSourceMaterial_Organism_HybridBuilder withId(@NonNull String id) {
   ...
   */
  public SubstanceSourceMaterial_Organism_HybridBuilder withExtension(
  ...
  /** @param hybridType */
  public SubstanceSourceMaterial_Organism_HybridBuilder withHybridType(
   ...
   */
  public SubstanceSourceMaterial_Organism_HybridBuilder withModifierExtension(
