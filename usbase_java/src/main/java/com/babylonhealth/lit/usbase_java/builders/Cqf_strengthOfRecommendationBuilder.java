...
public class Cqf_strengthOfRecommendationBuilder {
   ...
   */
  public Cqf_strengthOfRecommendationBuilder(String url, CodeableConcept value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Cqf_strengthOfRecommendationBuilder withId(@NonNull String id) {
