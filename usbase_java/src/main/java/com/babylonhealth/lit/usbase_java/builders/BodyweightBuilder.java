...
public interface BodyweightBuilder extends VitalsignsBuilder {
  ...
  public class Impl implements BodyweightBuilder {
     ...
     *     BodyweightBuilder.effective static methods
     ...
     */
    public BodyweightBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public BodyweightBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     */
    public BodyweightBuilder.Impl withText(@NonNull Narrative text) {
     ...
     */
    public BodyweightBuilder.Impl withFocus(@NonNull Reference... focus) {
     ...
     *     is the patient of record and the mother is the focus.
     */
    public BodyweightBuilder.Impl withFocus(@NonNull Collection<Reference> focus) {
     ...
     */
    public BodyweightBuilder.Impl withPartOf(@NonNull Reference... partOf) {
     ...
     *     For example, an observation as part of a procedure.
     */
    public BodyweightBuilder.Impl withPartOf(@NonNull Collection<Reference> partOf) {
     ...
     */
    public BodyweightBuilder.Impl withIssued(@NonNull ZonedDateTime issued) {
      this.issued = Optional.of(issued);
      return this;
    }
    /** @param method - Indicates the mechanism used to perform the observation. */
    public BodyweightBuilder.Impl withMethod(@NonNull CodeableConcept method) {
     ...
     */
    public BodyweightBuilder.Impl withBasedOn(@NonNull Reference... basedOn) {
     ...
     *     performed before it is dispensed.
     */
    public BodyweightBuilder.Impl withBasedOn(@NonNull Collection<Reference> basedOn) {
     ...
     */
    public BodyweightBuilder.Impl withValue(@NonNull Quantity value) {
     ...
     *     (i.e. the target site).
     */
    public BodyweightBuilder.Impl withBodySite(@NonNull CodeableConcept bodySite) {
     ...
     */
    public BodyweightBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     */
    public BodyweightBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public BodyweightBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
    ...
    public BodyweightBuilder.Impl withPerformer(@NonNull Reference... performer) {
      this.performer = Arrays.asList(performer);
      return this;
    }
    /** @param performer - Who was responsible for asserting the observed value as "true". */
    public BodyweightBuilder.Impl withPerformer(@NonNull Collection<Reference> performer) {
    ...
    /** @param hasMember - Used when reporting vital signs panel components. */
    public BodyweightBuilder.Impl withHasMember(@NonNull Collection<Reference> hasMember) {
     ...
     */
    public BodyweightBuilder.Impl withDerivedFrom(@NonNull Reference... derivedFrom) {
     ...
     *     profiles etc.
     */
    public BodyweightBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     *     low, normal.
     */
    public BodyweightBuilder.Impl withInterpretation(@NonNull CodeableConcept... interpretation) {
     ...
     */
    public BodyweightBuilder.Impl withModifierExtension(@NonNull Extension... modifierExtension) {
