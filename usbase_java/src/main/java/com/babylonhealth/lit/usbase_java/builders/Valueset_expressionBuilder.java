...
public class Valueset_expressionBuilder {
   ...
   */
  public Valueset_expressionBuilder(String url, Expression value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Valueset_expressionBuilder withId(@NonNull String id) {
