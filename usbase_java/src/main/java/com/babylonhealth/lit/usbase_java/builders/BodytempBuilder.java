...
public class BodytempBuilder {
    ...
    this.effective =
        (Choice)
            Choice$.MODULE$.fromSuffix(
                autoSuffix(effective.getClass().getSimpleName(), Bodytemp$.MODULE$.effective()),
                effective,
                Bodytemp$.MODULE$.effective());
    this.code = code;
  }
   ...
   */
  public BodytempBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public BodytempBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public BodytempBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public BodytempBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public BodytempBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   */
  public BodytempBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     patient of record and the mother is the focus.
   */
  public BodytempBuilder withFocus(@NonNull Collection<Reference> focus) {
   ...
   */
  public BodytempBuilder withPartOf(@NonNull Reference... partOf) {
   ...
   *     example, an observation as part of a procedure.
   */
  public BodytempBuilder withPartOf(@NonNull Collection<Reference> partOf) {
   ...
   */
  public BodytempBuilder withIssued(@NonNull ZonedDateTime issued) {
    this.issued = Optional.of(issued);
    return this;
  }
  /** @param method - Indicates the mechanism used to perform the observation. */
  public BodytempBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param device - The device used to generate the observation data. */
  public BodytempBuilder withDevice(@NonNull Reference device) {
   ...
   */
  public BodytempBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     before it is dispensed.
   */
  public BodytempBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public BodytempBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public BodytempBuilder withValue(@NonNull Quantity value) {
   ...
   *     the target site).
   */
  public BodytempBuilder withBodySite(@NonNull CodeableConcept bodySite) {
    this.bodySite = Optional.of(bodySite);
    return this;
  }
  /** @param specimen - The specimen that was used when this observation was made. */
  public BodytempBuilder withSpecimen(@NonNull Reference specimen) {
   ...
   */
  public BodytempBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public BodytempBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public BodytempBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public BodytempBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public BodytempBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public BodytempBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public BodytempBuilder withPerformer(@NonNull Collection<Reference> performer) {
    this.performer = Collections.unmodifiableCollection(performer);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public BodytempBuilder withHasMember(@NonNull Reference... hasMember) {
    this.hasMember = Arrays.asList(hasMember);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public BodytempBuilder withHasMember(@NonNull Collection<Reference> hasMember) {
  ...
  public BodytempBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public BodytempBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public BodytempBuilder withDerivedFrom(@NonNull Reference... derivedFrom) {
   ...
   *     based on an ultrasound image.
   */
  public BodytempBuilder withDerivedFrom(@NonNull Collection<Reference> derivedFrom) {
   ...
   *     profiles etc.
   */
  public BodytempBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     low, normal.
   */
  public BodytempBuilder withInterpretation(@NonNull CodeableConcept... interpretation) {
   ...
   *     low, normal.
   */
  public BodytempBuilder withInterpretation(@NonNull Collection<CodeableConcept> interpretation) {
   ...
   */
  public BodytempBuilder withDataAbsentReason(@NonNull CodeableConcept dataAbsentReason) {
   ...
   */
  public BodytempBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public BodytempBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param component - Used when reporting systolic and diastolic blood pressure. */
  public BodytempBuilder withComponent(@NonNull Observation.Component... component) {
    this.component = Arrays.asList(component);
    return this;
  }
  /** @param component - Used when reporting systolic and diastolic blood pressure. */
  public BodytempBuilder withComponent(@NonNull Collection<Observation.Component> component) {
   ...
   */
  public BodytempBuilder withReferenceRange(@NonNull Observation.ReferenceRange... referenceRange) {
   ...
   *     represent two distinct target populations, two `referenceRange` elements would be used.
   */
  public BodytempBuilder withReferenceRange(
