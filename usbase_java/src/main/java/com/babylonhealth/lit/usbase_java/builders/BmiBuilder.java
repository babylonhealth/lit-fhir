...
public class BmiBuilder {
  ...
  private Optional<Meta> meta =
      Optional.of(
          new MetaBuilder().withProfile("http://hl7.org/fhir/StructureDefinition/bmi").build());
   ...
   */
  public BmiBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public BmiBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public BmiBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public BmiBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public BmiBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   */
  public BmiBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     patient of record and the mother is the focus.
   */
  public BmiBuilder withFocus(@NonNull Collection<Reference> focus) {
   ...
   */
  public BmiBuilder withPartOf(@NonNull Reference... partOf) {
   ...
   *     example, an observation as part of a procedure.
   */
  public BmiBuilder withPartOf(@NonNull Collection<Reference> partOf) {
   ...
   */
  public BmiBuilder withIssued(@NonNull ZonedDateTime issued) {
    this.issued = Optional.of(issued);
    return this;
  }
  /** @param method - Indicates the mechanism used to perform the observation. */
  public BmiBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param device - The device used to generate the observation data. */
  public BmiBuilder withDevice(@NonNull Reference device) {
   ...
   */
  public BmiBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     before it is dispensed.
   */
  public BmiBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public BmiBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   *     the target site).
   */
  public BmiBuilder withBodySite(@NonNull CodeableConcept bodySite) {
    this.bodySite = Optional.of(bodySite);
    return this;
  }
  /** @param specimen - The specimen that was used when this observation was made. */
  public BmiBuilder withSpecimen(@NonNull Reference specimen) {
   ...
   */
  public BmiBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public BmiBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public BmiBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public BmiBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public BmiBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public BmiBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public BmiBuilder withPerformer(@NonNull Collection<Reference> performer) {
    this.performer = Collections.unmodifiableCollection(performer);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public BmiBuilder withHasMember(@NonNull Reference... hasMember) {
    this.hasMember = Arrays.asList(hasMember);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public BmiBuilder withHasMember(@NonNull Collection<Reference> hasMember) {
  ...
  public BmiBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public BmiBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public BmiBuilder withDerivedFrom(@NonNull Reference... derivedFrom) {
   ...
   *     based on an ultrasound image.
   */
  public BmiBuilder withDerivedFrom(@NonNull Collection<Reference> derivedFrom) {
   ...
   *     profiles etc.
   */
  public BmiBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     low, normal.
   */
  public BmiBuilder withInterpretation(@NonNull CodeableConcept... interpretation) {
   ...
   *     low, normal.
   */
  public BmiBuilder withInterpretation(@NonNull Collection<CodeableConcept> interpretation) {
   ...
   */
  public BmiBuilder withDataAbsentReason(@NonNull CodeableConcept dataAbsentReason) {
   ...
   */
  public BmiBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public BmiBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param component - Used when reporting systolic and diastolic blood pressure. */
  public BmiBuilder withComponent(@NonNull Observation.Component... component) {
    this.component = Arrays.asList(component);
    return this;
  }
  /** @param component - Used when reporting systolic and diastolic blood pressure. */
  public BmiBuilder withComponent(@NonNull Collection<Observation.Component> component) {
   ...
   */
  public BmiBuilder withReferenceRange(@NonNull Observation.ReferenceRange... referenceRange) {
   ...
   *     represent two distinct target populations, two `referenceRange` elements would be used.
   */
  public BmiBuilder withReferenceRange(
