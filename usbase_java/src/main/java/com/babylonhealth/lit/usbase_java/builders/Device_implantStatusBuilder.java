...
public class Device_implantStatusBuilder {
   ...
   */
  public Device_implantStatusBuilder(String url, IMPLANTSTATUS value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Device_implantStatusBuilder withId(@NonNull String id) {
