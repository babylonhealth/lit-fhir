...
public class Organization_periodBuilder {
   ...
   */
  public Organization_periodBuilder(String url, Period value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Organization_periodBuilder withId(@NonNull String id) {
