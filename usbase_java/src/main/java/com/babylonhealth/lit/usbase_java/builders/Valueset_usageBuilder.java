...
public interface Valueset_usageBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Valueset_usageBuilder {
     ...
     */
    public Valueset_usageBuilder.Impl withId(@NonNull String id) {
