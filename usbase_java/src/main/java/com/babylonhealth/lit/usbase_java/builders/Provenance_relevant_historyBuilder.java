...
public class Provenance_relevant_historyBuilder {
   ...
   *
   * @param target - This points to the version of the resource that was created as a result of this
   *     historical record action. Typically only a single resource will be referenced, but if the
   *     same action is performed to multiple resources in the context of a transaction, some
   *     systems may link multiple resource instances.
   ...
   */
  public Provenance_relevant_historyBuilder(
   ...
   */
  public Provenance_relevant_historyBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public Provenance_relevant_historyBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public Provenance_relevant_historyBuilder withText(@NonNull Narrative text) {
   ...
   */
  public Provenance_relevant_historyBuilder withPolicy(@NonNull String... policy) {
   ...
   *     have multiple applicable policy documents, such as patient consent, guarantor funding, etc.
   */
  public Provenance_relevant_historyBuilder withPolicy(@NonNull Collection<String> policy) {
    this.policy = Collections.unmodifiableCollection(policy);
    return this;
  }
  /** @param reason - The reason that the activity was taking place. */
  public Provenance_relevant_historyBuilder withReason(@NonNull CodeableConcept... reason) {
    this.reason = Arrays.asList(reason);
    return this;
  }
  /** @param reason - The reason that the activity was taking place. */
  public Provenance_relevant_historyBuilder withReason(
      @NonNull Collection<CodeableConcept> reason) {
    this.reason = Collections.unmodifiableCollection(reason);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public Provenance_relevant_historyBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param location - Where the activity occurred, if relevant. */
  public Provenance_relevant_historyBuilder withLocation(@NonNull Reference location) {
   ...
   */
  public Provenance_relevant_historyBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public Provenance_relevant_historyBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public Provenance_relevant_historyBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public Provenance_relevant_historyBuilder withExtension(
   ...
   */
  public Provenance_relevant_historyBuilder withSignature(@NonNull Signature... signature) {
   ...
   *     Provenance.agent. The purpose of the signature is indicated.
   */
  public Provenance_relevant_historyBuilder withSignature(
   ...
   *     profiles etc.
   */
  public Provenance_relevant_historyBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public Provenance_relevant_historyBuilder withModifierExtension(
  ...
  public Provenance_relevant_historyBuilder withEntity(@NonNull Provenance.Entity... entity) {
    this.entity = Arrays.asList(entity);
    return this;
  }
  /** @param entity - An entity used in this activity. */
  public Provenance_relevant_historyBuilder withEntity(
