...
public class Observation_geneticsCopyNumberEventBuilder {
   ...
   */
  public Observation_geneticsCopyNumberEventBuilder(String url, CodeableConcept value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Observation_geneticsCopyNumberEventBuilder withId(@NonNull String id) {
