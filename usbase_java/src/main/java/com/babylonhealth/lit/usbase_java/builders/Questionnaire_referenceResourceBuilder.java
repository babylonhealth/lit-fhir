...
public class Questionnaire_referenceResourceBuilder {
   ...
   */
  public Questionnaire_referenceResourceBuilder(String url, RESOURCE_TYPES value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Questionnaire_referenceResourceBuilder withId(@NonNull String id) {
