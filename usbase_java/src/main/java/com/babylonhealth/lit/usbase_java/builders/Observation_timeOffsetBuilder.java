...
public class Observation_timeOffsetBuilder {
   ...
   */
  public Observation_timeOffsetBuilder(String url, Integer value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Observation_timeOffsetBuilder withId(@NonNull String id) {
