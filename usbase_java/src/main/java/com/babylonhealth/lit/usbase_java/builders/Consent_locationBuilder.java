...
public interface Consent_locationBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Consent_locationBuilder {
    private Optional<String> id = Optional.empty();
    private Reference value;

    /**
     * Required fields for {@link Consent_location}
     *
     ...
     */
    public Consent_locationBuilder.Impl withId(@NonNull String id) {
