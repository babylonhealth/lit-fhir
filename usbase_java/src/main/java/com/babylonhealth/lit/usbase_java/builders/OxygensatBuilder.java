...
public class OxygensatBuilder {
    ...
    this.effective =
        (Choice)
            Choice$.MODULE$.fromSuffix(
                autoSuffix(effective.getClass().getSimpleName(), Oxygensat$.MODULE$.effective()),
                effective,
                Oxygensat$.MODULE$.effective());
    this.code = code;
  }
   ...
   */
  public OxygensatBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public OxygensatBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public OxygensatBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public OxygensatBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public OxygensatBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   */
  public OxygensatBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     patient of record and the mother is the focus.
   */
  public OxygensatBuilder withFocus(@NonNull Collection<Reference> focus) {
   ...
   */
  public OxygensatBuilder withPartOf(@NonNull Reference... partOf) {
   ...
   *     example, an observation as part of a procedure.
   */
  public OxygensatBuilder withPartOf(@NonNull Collection<Reference> partOf) {
   ...
   */
  public OxygensatBuilder withIssued(@NonNull ZonedDateTime issued) {
    this.issued = Optional.of(issued);
    return this;
  }
  /** @param method - Indicates the mechanism used to perform the observation. */
  public OxygensatBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param device - The device used to generate the observation data. */
  public OxygensatBuilder withDevice(@NonNull Reference device) {
   ...
   */
  public OxygensatBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     before it is dispensed.
   */
  public OxygensatBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public OxygensatBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public OxygensatBuilder withValue(@NonNull Quantity value) {
   ...
   *     the target site).
   */
  public OxygensatBuilder withBodySite(@NonNull CodeableConcept bodySite) {
    this.bodySite = Optional.of(bodySite);
    return this;
  }
  /** @param specimen - The specimen that was used when this observation was made. */
  public OxygensatBuilder withSpecimen(@NonNull Reference specimen) {
   ...
   */
  public OxygensatBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public OxygensatBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public OxygensatBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public OxygensatBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public OxygensatBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public OxygensatBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public OxygensatBuilder withPerformer(@NonNull Collection<Reference> performer) {
    this.performer = Collections.unmodifiableCollection(performer);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public OxygensatBuilder withHasMember(@NonNull Reference... hasMember) {
    this.hasMember = Arrays.asList(hasMember);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public OxygensatBuilder withHasMember(@NonNull Collection<Reference> hasMember) {
  ...
  public OxygensatBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public OxygensatBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public OxygensatBuilder withDerivedFrom(@NonNull Reference... derivedFrom) {
   ...
   *     based on an ultrasound image.
   */
  public OxygensatBuilder withDerivedFrom(@NonNull Collection<Reference> derivedFrom) {
   ...
   *     profiles etc.
   */
  public OxygensatBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     low, normal.
   */
  public OxygensatBuilder withInterpretation(@NonNull CodeableConcept... interpretation) {
   ...
   *     low, normal.
   */
  public OxygensatBuilder withInterpretation(@NonNull Collection<CodeableConcept> interpretation) {
   ...
   */
  public OxygensatBuilder withDataAbsentReason(@NonNull CodeableConcept dataAbsentReason) {
   ...
   */
  public OxygensatBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public OxygensatBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param component - Used when reporting systolic and diastolic blood pressure. */
  public OxygensatBuilder withComponent(@NonNull Observation.Component... component) {
    this.component = Arrays.asList(component);
    return this;
  }
  /** @param component - Used when reporting systolic and diastolic blood pressure. */
  public OxygensatBuilder withComponent(@NonNull Collection<Observation.Component> component) {
   ...
   */
  public OxygensatBuilder withReferenceRange(
