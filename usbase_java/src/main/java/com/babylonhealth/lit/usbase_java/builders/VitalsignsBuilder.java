...
public class VitalsignsBuilder {
   ...
   */
  public VitalsignsBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public VitalsignsBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public VitalsignsBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public VitalsignsBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public VitalsignsBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   */
  public VitalsignsBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     patient of record and the mother is the focus.
   */
  public VitalsignsBuilder withFocus(@NonNull Collection<Reference> focus) {
   ...
   */
  public VitalsignsBuilder withPartOf(@NonNull Reference... partOf) {
   ...
   *     example, an observation as part of a procedure.
   */
  public VitalsignsBuilder withPartOf(@NonNull Collection<Reference> partOf) {
   ...
   */
  public VitalsignsBuilder withIssued(@NonNull ZonedDateTime issued) {
    this.issued = Optional.of(issued);
    return this;
  }
  /** @param method - Indicates the mechanism used to perform the observation. */
  public VitalsignsBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param device - The device used to generate the observation data. */
  public VitalsignsBuilder withDevice(@NonNull Reference device) {
   ...
   */
  public VitalsignsBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     before it is dispensed.
   */
  public VitalsignsBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public VitalsignsBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   *     the target site).
   */
  public VitalsignsBuilder withBodySite(@NonNull CodeableConcept bodySite) {
    this.bodySite = Optional.of(bodySite);
    return this;
  }
  /** @param specimen - The specimen that was used when this observation was made. */
  public VitalsignsBuilder withSpecimen(@NonNull Reference specimen) {
   ...
   */
  public VitalsignsBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public VitalsignsBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public VitalsignsBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public VitalsignsBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public VitalsignsBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public VitalsignsBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public VitalsignsBuilder withPerformer(@NonNull Collection<Reference> performer) {
    this.performer = Collections.unmodifiableCollection(performer);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public VitalsignsBuilder withHasMember(@NonNull Reference... hasMember) {
    this.hasMember = Arrays.asList(hasMember);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public VitalsignsBuilder withHasMember(@NonNull Collection<Reference> hasMember) {
  ...
  public VitalsignsBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public VitalsignsBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public VitalsignsBuilder withDerivedFrom(@NonNull Reference... derivedFrom) {
   ...
   *     based on an ultrasound image.
   */
  public VitalsignsBuilder withDerivedFrom(@NonNull Collection<Reference> derivedFrom) {
   ...
   *     profiles etc.
   */
  public VitalsignsBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     low, normal.
   */
  public VitalsignsBuilder withInterpretation(@NonNull CodeableConcept... interpretation) {
   ...
   *     low, normal.
   */
  public VitalsignsBuilder withInterpretation(@NonNull Collection<CodeableConcept> interpretation) {
   ...
   */
  public VitalsignsBuilder withDataAbsentReason(@NonNull CodeableConcept dataAbsentReason) {
   ...
   */
  public VitalsignsBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public VitalsignsBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param component - Used when reporting systolic and diastolic blood pressure. */
  public VitalsignsBuilder withComponent(@NonNull Observation.Component... component) {
    this.component = Arrays.asList(component);
    return this;
  }
  /** @param component - Used when reporting systolic and diastolic blood pressure. */
  public VitalsignsBuilder withComponent(@NonNull Collection<Observation.Component> component) {
   ...
   */
  public VitalsignsBuilder withReferenceRange(
