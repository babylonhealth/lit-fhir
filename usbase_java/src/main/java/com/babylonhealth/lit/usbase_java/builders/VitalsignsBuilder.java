...
public interface VitalsignsBuilder extends ObservationBuilder {
  ...
  public class Impl implements VitalsignsBuilder {
    ...
    private Optional<Meta> meta =
        Optional.of(
            MetaBuilder.init()
                .withProfile("http://hl7.org/fhir/StructureDefinition/vitalsigns")
                .build());
    ...
    /**
     * Required fields for {@link Vitalsigns}
     *
     ...
     */
    public VitalsignsBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public VitalsignsBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public VitalsignsBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public VitalsignsBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public VitalsignsBuilder.Impl withText(@NonNull NarrativeBuilder text) {
      this.text = Optional.of(text.build());
      return this;
    }
    /** @param note - Comments about the observation or the results. */
    public VitalsignsBuilder.Impl withNote(@NonNull Annotation... note) {
      this.note = Arrays.asList(note);
      return this;
    }
    /** @param note - Comments about the observation or the results. */
    public VitalsignsBuilder.Impl withNote(@NonNull Collection<Annotation> note) {
      this.note = Collections.unmodifiableCollection(note);
      return this;
    }

    public VitalsignsBuilder.Impl withNote(@NonNull AnnotationBuilder... note) {
     ...
     */
    public VitalsignsBuilder.Impl withFocus(@NonNull Reference... focus) {
     ...
     *     is the patient of record and the mother is the focus.
     */
    public VitalsignsBuilder.Impl withFocus(@NonNull Collection<Reference> focus) {
      this.focus = Collections.unmodifiableCollection(focus);
      return this;
    }

    public VitalsignsBuilder.Impl withFocus(@NonNull ReferenceBuilder... focus) {
     ...
     */
    public VitalsignsBuilder.Impl withPartOf(@NonNull Reference... partOf) {
     ...
     *     For example, an observation as part of a procedure.
     */
    public VitalsignsBuilder.Impl withPartOf(@NonNull Collection<Reference> partOf) {
      this.partOf = Collections.unmodifiableCollection(partOf);
      return this;
    }

    public VitalsignsBuilder.Impl withPartOf(@NonNull ReferenceBuilder... partOf) {
     ...
     */
    public VitalsignsBuilder.Impl withIssued(@NonNull ZonedDateTime issued) {
      this.issued = Optional.of(issued);
      return this;
    }
    /** @param method - Indicates the mechanism used to perform the observation. */
    public VitalsignsBuilder.Impl withMethod(@NonNull CodeableConcept method) {
      this.method = Optional.of(method);
      return this;
    }

    public VitalsignsBuilder.Impl withMethod(@NonNull CodeableConceptBuilder method) {
      this.method = Optional.of(method.build());
      return this;
    }
    /** @param device - The device used to generate the observation data. */
    public VitalsignsBuilder.Impl withDevice(@NonNull Reference device) {
      this.device = Optional.of(device);
      return this;
    }

    public VitalsignsBuilder.Impl withDevice(@NonNull ReferenceBuilder device) {
     ...
     */
    public VitalsignsBuilder.Impl withBasedOn(@NonNull Reference... basedOn) {
     ...
     *     performed before it is dispensed.
     */
    public VitalsignsBuilder.Impl withBasedOn(@NonNull Collection<Reference> basedOn) {
      this.basedOn = Collections.unmodifiableCollection(basedOn);
      return this;
    }

    public VitalsignsBuilder.Impl withBasedOn(@NonNull ReferenceBuilder... basedOn) {
      this.basedOn = Arrays.stream(basedOn).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public VitalsignsBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public VitalsignsBuilder.Impl withValue(@NonNull ChoiceObservation_Value value) {
     ...
     *     (i.e. the target site).
     */
    public VitalsignsBuilder.Impl withBodySite(@NonNull CodeableConcept bodySite) {
      this.bodySite = Optional.of(bodySite);
      return this;
    }

    public VitalsignsBuilder.Impl withBodySite(@NonNull CodeableConceptBuilder bodySite) {
      this.bodySite = Optional.of(bodySite.build());
      return this;
    }
    /** @param specimen - The specimen that was used when this observation was made. */
    public VitalsignsBuilder.Impl withSpecimen(@NonNull Reference specimen) {
      this.specimen = Optional.of(specimen);
      return this;
    }

    public VitalsignsBuilder.Impl withSpecimen(@NonNull ReferenceBuilder specimen) {
     ...
     */
    public VitalsignsBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public VitalsignsBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
      this.contained = Collections.unmodifiableCollection(contained);
      return this;
    }

    public VitalsignsBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public VitalsignsBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public VitalsignsBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public VitalsignsBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
     ...
     */
    public VitalsignsBuilder.Impl withEncounter(@NonNull Reference encounter) {
      this.encounter = Optional.of(encounter);
      return this;
    }

    public VitalsignsBuilder.Impl withEncounter(@NonNull ReferenceBuilder encounter) {
      this.encounter = Optional.of(encounter.build());
      return this;
    }
    /** @param performer - Who was responsible for asserting the observed value as "true". */
    public VitalsignsBuilder.Impl withPerformer(@NonNull Reference... performer) {
      this.performer = Arrays.asList(performer);
      return this;
    }
    /** @param performer - Who was responsible for asserting the observed value as "true". */
    public VitalsignsBuilder.Impl withPerformer(@NonNull Collection<Reference> performer) {
      this.performer = Collections.unmodifiableCollection(performer);
      return this;
    }

    public VitalsignsBuilder.Impl withPerformer(@NonNull ReferenceBuilder... performer) {
    ...
    public VitalsignsBuilder.Impl withHasMember(@NonNull Reference... hasMember) {
      this.hasMember = Arrays.asList(hasMember);
      return this;
    }
    /** @param hasMember - Used when reporting vital signs panel components. */
    public VitalsignsBuilder.Impl withHasMember(@NonNull Collection<Reference> hasMember) {
      this.hasMember = Collections.unmodifiableCollection(hasMember);
      return this;
    }

    public VitalsignsBuilder.Impl withHasMember(@NonNull ReferenceBuilder... hasMember) {
    ...
    public VitalsignsBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
      this.identifier = Arrays.asList(identifier);
      return this;
    }
    /** @param identifier - A unique identifier assigned to this observation. */
    public VitalsignsBuilder.Impl withIdentifier(@NonNull Collection<Identifier> identifier) {
      this.identifier = Collections.unmodifiableCollection(identifier);
      return this;
    }

    public VitalsignsBuilder.Impl withIdentifier(@NonNull IdentifierBuilder... identifier) {
     ...
     */
    public VitalsignsBuilder.Impl withDerivedFrom(@NonNull Reference... derivedFrom) {
     ...
     *     based on an ultrasound image.
     */
    public VitalsignsBuilder.Impl withDerivedFrom(@NonNull Collection<Reference> derivedFrom) {
      this.derivedFrom = Collections.unmodifiableCollection(derivedFrom);
      return this;
    }

    public VitalsignsBuilder.Impl withDerivedFrom(@NonNull ReferenceBuilder... derivedFrom) {
     ...
     *     profiles etc.
     */
    public VitalsignsBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     *     low, normal.
     */
    public VitalsignsBuilder.Impl withInterpretation(@NonNull CodeableConcept... interpretation) {
     ...
     *     low, normal.
     */
    public VitalsignsBuilder.Impl withInterpretation(
     ...
     */
    public VitalsignsBuilder.Impl withDataAbsentReason(@NonNull CodeableConcept dataAbsentReason) {
      this.dataAbsentReason = Optional.of(dataAbsentReason);
      return this;
    }

    public VitalsignsBuilder.Impl withDataAbsentReason(
     ...
     */
    public VitalsignsBuilder.Impl withModifierExtension(@NonNull Extension... modifierExtension) {
     ...
     *     DomainResource (including cannot change the meaning of modifierExtension itself).
     */
    public VitalsignsBuilder.Impl withModifierExtension(
    ...
    public VitalsignsBuilder.Impl withComponent(@NonNull Observation.Component... component) {
      this.component = Arrays.asList(component);
      return this;
    }
    /** @param component - Used when reporting systolic and diastolic blood pressure. */
    public VitalsignsBuilder.Impl withComponent(
     ...
     *     used.
     */
    public VitalsignsBuilder.Impl withReferenceRange(
    ...
    public VitalsignsBuilder withoutMeta() {
