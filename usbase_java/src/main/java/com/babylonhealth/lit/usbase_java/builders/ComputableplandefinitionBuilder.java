...
public class ComputableplandefinitionBuilder {
   ...
   *     definition.
   */
  public ComputableplandefinitionBuilder(PUBLICATION_STATUS status, String library) {
    this.status = status;
   ...
   */
  public ComputableplandefinitionBuilder withId(@NonNull String id) {
   ...
   */
  public ComputableplandefinitionBuilder withUrl(@NonNull String url) {
   ...
   *     to the resource.
   */
  public ComputableplandefinitionBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public ComputableplandefinitionBuilder withText(@NonNull Narrative text) {
   ...
   *     generation.
   */
  public ComputableplandefinitionBuilder withName(@NonNull String name) {
   ...
   */
  public ComputableplandefinitionBuilder withType(@NonNull CodeableConcept _type) {
   ...
   *     changes.
   */
  public ComputableplandefinitionBuilder withDate(@NonNull FHIRDateTime date) {
    this.date = Optional.of(date);
    return this;
  }
  /** @param title - A short, descriptive, user-friendly title for the plan definition. */
  public ComputableplandefinitionBuilder withTitle(@NonNull String title) {
   ...
   *     perspective.
   */
  public ComputableplandefinitionBuilder withUsage(@NonNull String usage) {
   ...
   *     searching.
   */
  public ComputableplandefinitionBuilder withTopic(@NonNull CodeableConcept... topic) {
   ...
   *     searching.
   */
  public ComputableplandefinitionBuilder withTopic(@NonNull Collection<CodeableConcept> topic) {
   ...
   */
  public ComputableplandefinitionBuilder withAuthor(@NonNull ContactDetail... author) {
   ...
   *     maintenance of the content.
   */
  public ComputableplandefinitionBuilder withAuthor(@NonNull Collection<ContactDetail> author) {
   ...
   *     the content.
   */
  public ComputableplandefinitionBuilder withEditor(@NonNull ContactDetail... editor) {
   ...
   *     the content.
   */
  public ComputableplandefinitionBuilder withEditor(@NonNull Collection<ContactDetail> editor) {
   ...
   */
  public ComputableplandefinitionBuilder withVersion(@NonNull String version) {
   ...
   *     publisher.
   */
  public ComputableplandefinitionBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public ComputableplandefinitionBuilder withContact(@NonNull Collection<ContactDetail> contact) {
   ...
   *     as it has.
   */
  public ComputableplandefinitionBuilder withPurpose(@NonNull String purpose) {
    this.purpose = Optional.of(purpose);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public ComputableplandefinitionBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public ComputableplandefinitionBuilder withSubtitle(@NonNull String subtitle) {
   ...
   *     of the content.
   */
  public ComputableplandefinitionBuilder withReviewer(@NonNull ContactDetail... reviewer) {
   ...
   *     of the content.
   */
  public ComputableplandefinitionBuilder withReviewer(@NonNull Collection<ContactDetail> reviewer) {
   ...
   */
  public ComputableplandefinitionBuilder withEndorser(@NonNull ContactDetail... endorser) {
   ...
   *     content for use in some setting.
   */
  public ComputableplandefinitionBuilder withEndorser(@NonNull Collection<ContactDetail> endorser) {
   ...
   */
  public ComputableplandefinitionBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public ComputableplandefinitionBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public ComputableplandefinitionBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ComputableplandefinitionBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     definition.
   */
  public ComputableplandefinitionBuilder withPublisher(@NonNull String publisher) {
   ...
   *     definition.
   */
  public ComputableplandefinitionBuilder withCopyright(@NonNull String copyright) {
   ...
   *     instance.
   */
  public ComputableplandefinitionBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     instance.
   */
  public ComputableplandefinitionBuilder withIdentifier(
   ...
   *     pass the value in, wrap with one of the ComputableplandefinitionBuilder.subject static
   *     methods
   */
   ...
   */
  public ComputableplandefinitionBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate plan definition instances.
   */
  public ComputableplandefinitionBuilder withUseContext(
   ...
   */
  public ComputableplandefinitionBuilder withDescription(@NonNull String description) {
   ...
   *     genuine usage.
   */
  public ComputableplandefinitionBuilder withExperimental(@NonNull Boolean experimental) {
   ...
   *     be used.
   */
  public ComputableplandefinitionBuilder withJurisdiction(
   ...
   */
  public ComputableplandefinitionBuilder withApprovalDate(@NonNull FHIRDate approvalDate) {
   ...
   *     profiles etc.
   */
  public ComputableplandefinitionBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public ComputableplandefinitionBuilder withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
   ...
   *     to be in active use.
   */
  public ComputableplandefinitionBuilder withEffectivePeriod(@NonNull Period effectivePeriod) {
   ...
   */
  public ComputableplandefinitionBuilder withRelatedArtifact(
   ...
   */
  public ComputableplandefinitionBuilder withModifierExtension(
   ...
   */
  public ComputableplandefinitionBuilder withGoal(@NonNull PlanDefinition.Goal... goal) {
   ...
   *     via immunization, meeting a process improvement objective, etc.
   */
  public ComputableplandefinitionBuilder withGoal(@NonNull Collection<PlanDefinition.Goal> goal) {
  ...
  public ComputableplandefinitionBuilder withAction(@NonNull PlanDefinition.Action... action) {
    this.action = Arrays.asList(action);
    return this;
  }
  /** @param action - An action or group of actions to be taken as part of the plan. */
  public ComputableplandefinitionBuilder withAction(
