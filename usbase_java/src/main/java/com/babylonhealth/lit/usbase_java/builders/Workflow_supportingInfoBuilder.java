...
public class Workflow_supportingInfoBuilder {
   ...
   */
  public Workflow_supportingInfoBuilder(String url, Reference value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Workflow_supportingInfoBuilder withId(@NonNull String id) {
