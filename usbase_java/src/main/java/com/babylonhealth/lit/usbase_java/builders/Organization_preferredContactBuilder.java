...
public class Organization_preferredContactBuilder {
   ...
   */
  public Organization_preferredContactBuilder(String url, Boolean value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Organization_preferredContactBuilder withId(@NonNull String id) {
