...
public class Codesystem_replacedbyBuilder {
   ...
   */
  public Codesystem_replacedbyBuilder(String url, Coding value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Codesystem_replacedbyBuilder withId(@NonNull String id) {
