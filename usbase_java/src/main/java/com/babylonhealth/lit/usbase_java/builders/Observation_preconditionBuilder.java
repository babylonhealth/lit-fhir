...
public interface Observation_preconditionBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Observation_preconditionBuilder {
     ...
     */
    public Observation_preconditionBuilder.Impl withId(@NonNull String id) {
