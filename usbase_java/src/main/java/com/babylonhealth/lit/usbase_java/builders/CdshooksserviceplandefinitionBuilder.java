...
public interface CdshooksserviceplandefinitionBuilder extends PlanDefinitionBuilder {
  public Cdshooksserviceplandefinition build();

  public static Impl init(PUBLICATION_STATUS status, Collection<Extension> extension) {
  ...
  public class Impl implements CdshooksserviceplandefinitionBuilder {
     ...
     */
    public Impl(PUBLICATION_STATUS status, Collection<Extension> extension) {
      this.status = status;
     ...
     */
    public CdshooksserviceplandefinitionBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public CdshooksserviceplandefinitionBuilder.Impl withUrl(@NonNull String url) {
     ...
     */
    public CdshooksserviceplandefinitionBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public CdshooksserviceplandefinitionBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public CdshooksserviceplandefinitionBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public CdshooksserviceplandefinitionBuilder.Impl withText(@NonNull NarrativeBuilder text) {
     ...
     *     generation.
     */
    public CdshooksserviceplandefinitionBuilder.Impl withName(@NonNull String name) {
     ...
     */
    public CdshooksserviceplandefinitionBuilder.Impl withType(@NonNull CodeableConcept _type) {
      this._type = Optional.of(_type);
      return this;
    }

    public CdshooksserviceplandefinitionBuilder.Impl withType(
     ...
     *     definition changes.
     */
    public CdshooksserviceplandefinitionBuilder.Impl withDate(@NonNull FHIRDateTime date) {
      this.date = Optional.of(date);
      return this;
    }
    /** @param title - A short, descriptive, user-friendly title for the plan definition. */
    public CdshooksserviceplandefinitionBuilder.Impl withTitle(@NonNull String title) {
     ...
     *     perspective.
     */
    public CdshooksserviceplandefinitionBuilder.Impl withUsage(@NonNull String usage) {
     ...
     *     and searching.
     */
    public CdshooksserviceplandefinitionBuilder.Impl withTopic(@NonNull CodeableConcept... topic) {
     ...
     *     and searching.
     */
    public CdshooksserviceplandefinitionBuilder.Impl withTopic(
     ...
     */
    public CdshooksserviceplandefinitionBuilder.Impl withAuthor(@NonNull ContactDetail... author) {
     ...
     *     maintenance of the content.
     */
    public CdshooksserviceplandefinitionBuilder.Impl withAuthor(
     ...
     *     the content.
     */
    public CdshooksserviceplandefinitionBuilder.Impl withEditor(@NonNull ContactDetail... editor) {
     ...
     *     the content.
     */
    public CdshooksserviceplandefinitionBuilder.Impl withEditor(
     ...
     */
    public CdshooksserviceplandefinitionBuilder.Impl withVersion(@NonNull String version) {
     ...
     *     publisher.
     */
    public CdshooksserviceplandefinitionBuilder.Impl withContact(
        @NonNull ContactDetail... contact) {
     ...
     *     designed as it has.
     */
    public CdshooksserviceplandefinitionBuilder.Impl withPurpose(@NonNull String purpose) {
     ...
     *     plan definition.
     */
    public CdshooksserviceplandefinitionBuilder.Impl withLibrary(@NonNull String... library) {
     ...
     *     plan definition.
     */
    public CdshooksserviceplandefinitionBuilder.Impl withLibrary(
        @NonNull Collection<String> library) {
      this.library = Collections.unmodifiableCollection(library);
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public CdshooksserviceplandefinitionBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public CdshooksserviceplandefinitionBuilder.Impl withSubtitle(@NonNull String subtitle) {
     ...
     */
    public CdshooksserviceplandefinitionBuilder.Impl withReviewer(
     ...
     */
    public CdshooksserviceplandefinitionBuilder.Impl withEndorser(
     ...
     */
    public CdshooksserviceplandefinitionBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public CdshooksserviceplandefinitionBuilder.Impl withContained(
     ...
     *     definition.
     */
    public CdshooksserviceplandefinitionBuilder.Impl withPublisher(@NonNull String publisher) {
     ...
     *     plan definition.
     */
    public CdshooksserviceplandefinitionBuilder.Impl withCopyright(@NonNull String copyright) {
     ...
     *     instance.
     */
    public CdshooksserviceplandefinitionBuilder.Impl withIdentifier(
     ...
     *     To pass the value in, wrap with one of the CdshooksserviceplandefinitionBuilder.subject
     *     static methods
     */
     ...
     */
    public CdshooksserviceplandefinitionBuilder.Impl withUseContext(
     ...
     */
    public CdshooksserviceplandefinitionBuilder.Impl withDescription(@NonNull String description) {
     ...
     *     genuine usage.
     */
    public CdshooksserviceplandefinitionBuilder.Impl withExperimental(
        @NonNull Boolean experimental) {
     ...
     *     to be used.
     */
    public CdshooksserviceplandefinitionBuilder.Impl withJurisdiction(
     ...
     */
    public CdshooksserviceplandefinitionBuilder.Impl withApprovalDate(
     ...
     *     profiles etc.
     */
    public CdshooksserviceplandefinitionBuilder.Impl withImplicitRules(
     ...
     */
    public CdshooksserviceplandefinitionBuilder.Impl withLastReviewDate(
     ...
     */
    public CdshooksserviceplandefinitionBuilder.Impl withEffectivePeriod(
     ...
     */
    public CdshooksserviceplandefinitionBuilder.Impl withRelatedArtifact(
     ...
     */
    public CdshooksserviceplandefinitionBuilder.Impl withModifierExtension(
     ...
     */
    public CdshooksserviceplandefinitionBuilder.Impl withGoal(
        @NonNull PlanDefinition.Goal... goal) {
    ...
    public CdshooksserviceplandefinitionBuilder.Impl withAction(
