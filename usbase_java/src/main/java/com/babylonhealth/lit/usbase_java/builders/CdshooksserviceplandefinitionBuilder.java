...
public class CdshooksserviceplandefinitionBuilder {
  private Optional<String> id = Optional.empty();
  private Optional<String> url = Optional.empty();
  private Optional<Meta> meta =
      Optional.of(
          new MetaBuilder()
              .withProfile("http://hl7.org/fhir/StructureDefinition/cdshooksserviceplandefinition")
              .build());
  ...
  /**
   * Required fields for {@link Cdshooksserviceplandefinition}
   *
   * @param status - The status of this plan definition. Enables tracking the life-cycle of the
   *     content.
   * @param extension - An Extension
   */
  public CdshooksserviceplandefinitionBuilder(
   ...
   */
  public CdshooksserviceplandefinitionBuilder withId(@NonNull String id) {
   ...
   */
  public CdshooksserviceplandefinitionBuilder withUrl(@NonNull String url) {
   ...
   *     to the resource.
   */
  public CdshooksserviceplandefinitionBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public CdshooksserviceplandefinitionBuilder withText(@NonNull Narrative text) {
   ...
   *     generation.
   */
  public CdshooksserviceplandefinitionBuilder withName(@NonNull String name) {
   ...
   */
  public CdshooksserviceplandefinitionBuilder withType(@NonNull CodeableConcept _type) {
   ...
   *     changes.
   */
  public CdshooksserviceplandefinitionBuilder withDate(@NonNull FHIRDateTime date) {
    this.date = Optional.of(date);
    return this;
  }
  /** @param title - A short, descriptive, user-friendly title for the plan definition. */
  public CdshooksserviceplandefinitionBuilder withTitle(@NonNull String title) {
   ...
   *     perspective.
   */
  public CdshooksserviceplandefinitionBuilder withUsage(@NonNull String usage) {
   ...
   *     searching.
   */
  public CdshooksserviceplandefinitionBuilder withTopic(@NonNull CodeableConcept... topic) {
   ...
   *     searching.
   */
  public CdshooksserviceplandefinitionBuilder withTopic(
   ...
   */
  public CdshooksserviceplandefinitionBuilder withAuthor(@NonNull ContactDetail... author) {
   ...
   *     maintenance of the content.
   */
  public CdshooksserviceplandefinitionBuilder withAuthor(
   ...
   *     the content.
   */
  public CdshooksserviceplandefinitionBuilder withEditor(@NonNull ContactDetail... editor) {
   ...
   *     the content.
   */
  public CdshooksserviceplandefinitionBuilder withEditor(
   ...
   */
  public CdshooksserviceplandefinitionBuilder withVersion(@NonNull String version) {
   ...
   *     publisher.
   */
  public CdshooksserviceplandefinitionBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public CdshooksserviceplandefinitionBuilder withContact(
   ...
   *     as it has.
   */
  public CdshooksserviceplandefinitionBuilder withPurpose(@NonNull String purpose) {
   ...
   *     definition.
   */
  public CdshooksserviceplandefinitionBuilder withLibrary(@NonNull String... library) {
   ...
   *     definition.
   */
  public CdshooksserviceplandefinitionBuilder withLibrary(@NonNull Collection<String> library) {
    this.library = Collections.unmodifiableCollection(library);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public CdshooksserviceplandefinitionBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public CdshooksserviceplandefinitionBuilder withSubtitle(@NonNull String subtitle) {
   ...
   *     of the content.
   */
  public CdshooksserviceplandefinitionBuilder withReviewer(@NonNull ContactDetail... reviewer) {
   ...
   *     of the content.
   */
  public CdshooksserviceplandefinitionBuilder withReviewer(
   ...
   */
  public CdshooksserviceplandefinitionBuilder withEndorser(@NonNull ContactDetail... endorser) {
   ...
   *     content for use in some setting.
   */
  public CdshooksserviceplandefinitionBuilder withEndorser(
   ...
   */
  public CdshooksserviceplandefinitionBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public CdshooksserviceplandefinitionBuilder withContained(
   ...
   *     definition.
   */
  public CdshooksserviceplandefinitionBuilder withPublisher(@NonNull String publisher) {
   ...
   *     definition.
   */
  public CdshooksserviceplandefinitionBuilder withCopyright(@NonNull String copyright) {
   ...
   *     instance.
   */
  public CdshooksserviceplandefinitionBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     instance.
   */
  public CdshooksserviceplandefinitionBuilder withIdentifier(
   ...
   */
  public <T> CdshooksserviceplandefinitionBuilder withSubject(@NonNull T subject) {
    var guessedSuffix =
        autoSuffix(
            subject.getClass().getSimpleName(), Cdshooksserviceplandefinition$.MODULE$.subject());
   ...
   */
  public <T> CdshooksserviceplandefinitionBuilder withSubject(String suffix, @NonNull T subject) {
    guard(
        subject.getClass().getSimpleName(),
        suffix,
        Cdshooksserviceplandefinition$.MODULE$.subject());
    this.subject =
        Optional.of(
            (Choice)
                Choice$.MODULE$.fromSuffix(
                    suffix, subject, Cdshooksserviceplandefinition$.MODULE$.subject()));
    return this;
  }
  /**
   ...
   */
  public CdshooksserviceplandefinitionBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate plan definition instances.
   */
  public CdshooksserviceplandefinitionBuilder withUseContext(
   ...
   */
  public CdshooksserviceplandefinitionBuilder withDescription(@NonNull String description) {
   ...
   *     genuine usage.
   */
  public CdshooksserviceplandefinitionBuilder withExperimental(@NonNull Boolean experimental) {
   ...
   *     be used.
   */
  public CdshooksserviceplandefinitionBuilder withJurisdiction(
   ...
   */
  public CdshooksserviceplandefinitionBuilder withApprovalDate(@NonNull FHIRDate approvalDate) {
   ...
   *     profiles etc.
   */
  public CdshooksserviceplandefinitionBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public CdshooksserviceplandefinitionBuilder withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
   ...
   *     to be in active use.
   */
  public CdshooksserviceplandefinitionBuilder withEffectivePeriod(@NonNull Period effectivePeriod) {
   ...
   */
  public CdshooksserviceplandefinitionBuilder withRelatedArtifact(
   ...
   */
  public CdshooksserviceplandefinitionBuilder withModifierExtension(
   ...
   */
  public CdshooksserviceplandefinitionBuilder withGoal(@NonNull PlanDefinition.Goal... goal) {
   ...
   *     via immunization, meeting a process improvement objective, etc.
   */
  public CdshooksserviceplandefinitionBuilder withGoal(
  ...
  public CdshooksserviceplandefinitionBuilder withAction(@NonNull PlanDefinition.Action... action) {
    this.action = Arrays.asList(action);
    return this;
  }
  /** @param action - An action or group of actions to be taken as part of the plan. */
  public CdshooksserviceplandefinitionBuilder withAction(
  ...
  public Cdshooksserviceplandefinition build() {
    return new Cdshooksserviceplandefinition(
