...
public interface SubstanceSourceMaterial_Organism_AuthorBuilder {
  ...
  public class Impl implements SubstanceSourceMaterial_Organism_AuthorBuilder {
     ...
     */
    public SubstanceSourceMaterial_Organism_AuthorBuilder.Impl withId(@NonNull String id) {
    ...
    public SubstanceSourceMaterial_Organism_AuthorBuilder.Impl withAuthorDescription(
