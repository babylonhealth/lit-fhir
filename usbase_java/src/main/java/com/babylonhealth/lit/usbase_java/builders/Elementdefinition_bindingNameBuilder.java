...
public interface Elementdefinition_bindingNameBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Elementdefinition_bindingNameBuilder {
     ...
     */
    public Elementdefinition_bindingNameBuilder.Impl withId(@NonNull String id) {
