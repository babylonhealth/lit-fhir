...
public class Codesystem_sourceReferenceBuilder {
   ...
   */
  public Codesystem_sourceReferenceBuilder(String url, String value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Codesystem_sourceReferenceBuilder withId(@NonNull String id) {
