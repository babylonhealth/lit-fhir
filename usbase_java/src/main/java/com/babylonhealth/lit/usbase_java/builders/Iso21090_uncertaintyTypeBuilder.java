...
public class Iso21090_uncertaintyTypeBuilder {
   ...
   */
  public Iso21090_uncertaintyTypeBuilder(String url, PROBABILITY_DISTRIBUTION_TYPE value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Iso21090_uncertaintyTypeBuilder withId(@NonNull String id) {
