...
public interface Resource_pertainsToGoalBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Resource_pertainsToGoalBuilder {
     ...
     */
    public Resource_pertainsToGoalBuilder.Impl withId(@NonNull String id) {
