...
public class Servicerequest_geneticsBuilder {
   ...
   */
  public Servicerequest_geneticsBuilder(
      REQUEST_STATUS status, REQUEST_INTENT intent, Reference subject) {
    this.status = status;
    this.intent = intent;
   ...
   */
  public Servicerequest_geneticsBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public Servicerequest_geneticsBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public Servicerequest_geneticsBuilder withText(@NonNull Narrative text) {
   ...
   */
  public Servicerequest_geneticsBuilder withCode(@NonNull CodeableConcept code) {
   ...
   */
  public Servicerequest_geneticsBuilder withNote(@NonNull Annotation... note) {
   ...
   *     internal billing notes.
   */
  public Servicerequest_geneticsBuilder withNote(@NonNull Collection<Annotation> note) {
    this.note = Collections.unmodifiableCollection(note);
    return this;
  }
  /** @param basedOn - Plan/proposal/order fulfilled by this request. */
  public Servicerequest_geneticsBuilder withBasedOn(@NonNull Reference... basedOn) {
    this.basedOn = Arrays.asList(basedOn);
    return this;
  }
  /** @param basedOn - Plan/proposal/order fulfilled by this request. */
  public Servicerequest_geneticsBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public Servicerequest_geneticsBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   *     request(s).
   */
  public Servicerequest_geneticsBuilder withReplaces(@NonNull Reference... replaces) {
   ...
   *     request(s).
   */
  public Servicerequest_geneticsBuilder withReplaces(@NonNull Collection<Reference> replaces) {
   ...
   */
  public Servicerequest_geneticsBuilder withCategory(@NonNull CodeableConcept... category) {
   ...
   *     purposes (e.g. "Surgical Procedure").
   */
  public Servicerequest_geneticsBuilder withCategory(
   ...
   *     other requests.
   */
  public Servicerequest_geneticsBuilder withPriority(@NonNull REQUEST_PRIORITY priority) {
    this.priority = Optional.of(priority);
    return this;
  }
  /** @param specimen - One or more specimens that the laboratory procedure will use. */
  public Servicerequest_geneticsBuilder withSpecimen(@NonNull Reference... specimen) {
    this.specimen = Arrays.asList(specimen);
    return this;
  }
  /** @param specimen - One or more specimens that the laboratory procedure will use. */
  public Servicerequest_geneticsBuilder withSpecimen(@NonNull Collection<Reference> specimen) {
   ...
   *     site.
   */
  public Servicerequest_geneticsBuilder withBodySite(@NonNull CodeableConcept... bodySite) {
   ...
   *     site.
   */
  public Servicerequest_geneticsBuilder withBodySite(
   ...
   */
  public Servicerequest_geneticsBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public Servicerequest_geneticsBuilder withContained(@NonNull Collection<Resource> contained) {
    this.contained = Collections.unmodifiableCollection(contained);
    return this;
  }
  /** @param extension - An Extension */
  public Servicerequest_geneticsBuilder withExtension(@NonNull Extension... extension) {
    this.extension = Arrays.asList(extension);
    return this;
  }
  /** @param extension - An Extension */
  public Servicerequest_geneticsBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public Servicerequest_geneticsBuilder withEncounter(@NonNull Reference encounter) {
   ...
   *     activation.
   */
  public Servicerequest_geneticsBuilder withRequester(@NonNull Reference requester) {
   ...
   */
  public Servicerequest_geneticsBuilder withPerformer(@NonNull Reference... performer) {
   ...
   *     surgeon, dermatopathologist, endoscopist, etc.
   */
  public Servicerequest_geneticsBuilder withPerformer(@NonNull Collection<Reference> performer) {
   ...
   */
  public Servicerequest_geneticsBuilder withInsurance(@NonNull Reference... insurance) {
   ...
   *     pre-determinations that may be needed for delivering the requested service.
   */
  public Servicerequest_geneticsBuilder withInsurance(@NonNull Collection<Reference> insurance) {
   ...
   */
  public Servicerequest_geneticsBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     receiver and/or order fulfiller.
   */
  public Servicerequest_geneticsBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
    this.identifier = Collections.unmodifiableCollection(identifier);
    return this;
  }
  /** @param authoredOn - When the request transitioned to being actionable. */
  public Servicerequest_geneticsBuilder withAuthoredOn(@NonNull FHIRDateTime authoredOn) {
   ...
   */
  public Servicerequest_geneticsBuilder withReasonCode(@NonNull CodeableConcept... reasonCode) {
   ...
   *     referred to in `supportingInfo`.
   */
  public Servicerequest_geneticsBuilder withReasonCode(
   ...
   *     identifier.
   */
  public Servicerequest_geneticsBuilder withRequisition(@NonNull Identifier requisition) {
   ...
   */
  public Servicerequest_geneticsBuilder withOrderDetail(@NonNull CodeableConcept... orderDetail) {
   ...
   *     instructions specifying how the bandage should be applied.
   */
  public Servicerequest_geneticsBuilder withOrderDetail(
   ...
   */
  public Servicerequest_geneticsBuilder withDoNotPerform(@NonNull Boolean doNotPerform) {
   ...
   */
  public Servicerequest_geneticsBuilder withLocationCode(@NonNull CodeableConcept... locationCode) {
   ...
   *     coded or free text form. E.g. at home or nursing day care center.
   */
  public Servicerequest_geneticsBuilder withLocationCode(
   ...
   *     profiles etc.
   */
  public Servicerequest_geneticsBuilder withImplicitRules(@NonNull String implicitRules) {
  ...
  public Servicerequest_geneticsBuilder withPerformerType(@NonNull CodeableConcept performerType) {
   ...
   *     measurements.
   */
  public Servicerequest_geneticsBuilder withSupportingInfo(@NonNull Reference... supportingInfo) {
   ...
   *     measurements.
   */
  public Servicerequest_geneticsBuilder withSupportingInfo(
   ...
   */
  public Servicerequest_geneticsBuilder withInstantiatesUri(@NonNull String... instantiatesUri) {
   ...
   *     orderset or other definition that is adhered to in whole or in part by this ServiceRequest.
   */
  public Servicerequest_geneticsBuilder withInstantiatesUri(
   ...
   */
  public Servicerequest_geneticsBuilder withReasonReference(@NonNull Reference... reasonReference) {
   ...
   *     service is being requested. May relate to the resources referred to in `supportingInfo`.
   */
  public Servicerequest_geneticsBuilder withReasonReference(
      @NonNull Collection<Reference> reasonReference) {
    this.reasonReference = Collections.unmodifiableCollection(reasonReference);
    return this;
  }
  /** @param relevantHistory - Key events in the history of the request. */
  public Servicerequest_geneticsBuilder withRelevantHistory(@NonNull Reference... relevantHistory) {
    this.relevantHistory = Arrays.asList(relevantHistory);
    return this;
  }
  /** @param relevantHistory - Key events in the history of the request. */
  public Servicerequest_geneticsBuilder withRelevantHistory(
   ...
   */
  public Servicerequest_geneticsBuilder withModifierExtension(
   ...
   */
  public Servicerequest_geneticsBuilder withLocationReference(
   ...
   *     consumer.
   */
  public Servicerequest_geneticsBuilder withPatientInstruction(@NonNull String patientInstruction) {
   ...
   */
  public Servicerequest_geneticsBuilder withInstantiatesCanonical(
