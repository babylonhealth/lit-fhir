...
public interface Servicerequest_geneticsItemBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Servicerequest_geneticsItemBuilder {
    private Optional<String> id = Optional.empty();
    private Collection<Extension> extension;

    /**
     * Required fields for {@link Servicerequest_geneticsItem}
     *
     ...
     */
    public Servicerequest_geneticsItemBuilder.Impl withId(@NonNull String id) {
