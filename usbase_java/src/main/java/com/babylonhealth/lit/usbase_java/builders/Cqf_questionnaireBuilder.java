...
public interface Cqf_questionnaireBuilder extends QuestionnaireBuilder {
  ...
  public class Impl implements Cqf_questionnaireBuilder {
     ...
     */
    public Cqf_questionnaireBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public Cqf_questionnaireBuilder.Impl withUrl(@NonNull String url) {
     ...
     */
    public Cqf_questionnaireBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     *     generation.
     */
    public Cqf_questionnaireBuilder.Impl withName(@NonNull String name) {
     ...
     *     changes.
     */
    public Cqf_questionnaireBuilder.Impl withDate(@NonNull FHIRDateTime date) {
     ...
     */
    public Cqf_questionnaireBuilder.Impl withCode(@NonNull Coding... code) {
     ...
     *     terminology such as LOINC.
     */
    public Cqf_questionnaireBuilder.Impl withCode(@NonNull Collection<Coding> code) {
     ...
     */
    public Cqf_questionnaireBuilder.Impl withVersion(@NonNull String version) {
     ...
     *     publisher.
     */
    public Cqf_questionnaireBuilder.Impl withContact(@NonNull ContactDetail... contact) {
     ...
     *     as it has.
     */
    public Cqf_questionnaireBuilder.Impl withPurpose(@NonNull String purpose) {
      this.purpose = Optional.of(purpose);
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public Cqf_questionnaireBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public Cqf_questionnaireBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public Cqf_questionnaireBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
     ...
     *     questionnaire.
     */
    public Cqf_questionnaireBuilder.Impl withPublisher(@NonNull String publisher) {
     ...
     *     questionnaire.
     */
    public Cqf_questionnaireBuilder.Impl withCopyright(@NonNull String copyright) {
     ...
     *     instance.
     */
    public Cqf_questionnaireBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     *     instance.
     */
    public Cqf_questionnaireBuilder.Impl withIdentifier(
     ...
     */
    public Cqf_questionnaireBuilder.Impl withUseContext(@NonNull UsageContext... useContext) {
    ...
    public Cqf_questionnaireBuilder.Impl withDerivedFrom(@NonNull String... derivedFrom) {
      this.derivedFrom = Arrays.asList(derivedFrom);
      return this;
    }
    /** @param derivedFrom - The URL of a Questionnaire that this Questionnaire is based on. */
    public Cqf_questionnaireBuilder.Impl withDerivedFrom(@NonNull Collection<String> derivedFrom) {
     ...
     *     the questionnaire.
     */
    public Cqf_questionnaireBuilder.Impl withSubjectType(@NonNull RESOURCE_TYPES... subjectType) {
     ...
     *     the questionnaire.
     */
    public Cqf_questionnaireBuilder.Impl withSubjectType(
     ...
     */
    public Cqf_questionnaireBuilder.Impl withDescription(@NonNull String description) {
     ...
     *     genuine usage.
     */
    public Cqf_questionnaireBuilder.Impl withExperimental(@NonNull Boolean experimental) {
     ...
     */
    public Cqf_questionnaireBuilder.Impl withApprovalDate(@NonNull FHIRDate approvalDate) {
     ...
     *     profiles etc.
     */
    public Cqf_questionnaireBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public Cqf_questionnaireBuilder.Impl withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
     ...
     *     questionnaire.
     */
    public Cqf_questionnaireBuilder.Impl withItem(@NonNull Questionnaire.Item... item) {
