...
public interface Capabilitystatement_websocketBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Capabilitystatement_websocketBuilder {
     ...
     */
    public Capabilitystatement_websocketBuilder.Impl withId(@NonNull String id) {
