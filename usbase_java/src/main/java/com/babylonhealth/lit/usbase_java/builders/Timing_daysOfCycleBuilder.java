...
public interface Timing_daysOfCycleBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Timing_daysOfCycleBuilder {
    private Optional<String> id = Optional.empty();
    private Collection<Extension> extension;

    /**
     * Required fields for {@link Timing_daysOfCycle}
     *
     ...
     */
    public Timing_daysOfCycleBuilder.Impl withId(@NonNull String id) {
