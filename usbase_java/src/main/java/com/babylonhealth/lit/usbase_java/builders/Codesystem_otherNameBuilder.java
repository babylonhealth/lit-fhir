...
public interface Codesystem_otherNameBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Codesystem_otherNameBuilder {
     ...
     */
    public Codesystem_otherNameBuilder.Impl withId(@NonNull String id) {
