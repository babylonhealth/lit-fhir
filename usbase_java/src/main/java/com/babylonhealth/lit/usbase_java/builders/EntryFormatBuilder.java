...
public interface EntryFormatBuilder extends ExtensionBuilder {
  ...
  public class Impl implements EntryFormatBuilder {
     ...
     */
    public EntryFormatBuilder.Impl withId(@NonNull String id) {
