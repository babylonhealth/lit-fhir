...
public interface HlaresultBuilder extends DiagnosticReportBuilder {
  ...
  public class Impl implements HlaresultBuilder {
     ...
     */
    public HlaresultBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public HlaresultBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     */
    public HlaresultBuilder.Impl withIssued(@NonNull ZonedDateTime issued) {
     ...
     *     diagnostic report.
     */
    public HlaresultBuilder.Impl withResult(@NonNull Reference... result) {
     ...
     *     diagnostic report.
     */
    public HlaresultBuilder.Impl withResult(@NonNull Collection<Reference> result) {
    ...
    /** @param basedOn - Details concerning a service requested. */
    public HlaresultBuilder.Impl withBasedOn(@NonNull Collection<Reference> basedOn) {
    ...
    public HlaresultBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public HlaresultBuilder.Impl withCategory(@NonNull CodeableConcept... category) {
     ...
     *     used for searching, sorting and display purposes.
     */
    public HlaresultBuilder.Impl withCategory(@NonNull Collection<CodeableConcept> category) {
     ...
     */
    public HlaresultBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public HlaresultBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
    ...
    /** @param extension - An Extension */
    public HlaresultBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
    ...
    public HlaresultBuilder.Impl withPerformer(@NonNull Reference... performer) {
     ...
     */
    public HlaresultBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     */
    public HlaresultBuilder.Impl withConclusion(@NonNull String conclusion) {
     ...
     *     methods
     */
    public HlaresultBuilder.Impl withEffective(@NonNull ChoiceDateTimeOrPeriod effective) {
     ...
     */
    public HlaresultBuilder.Impl withImagingStudy(@NonNull Reference... imagingStudy) {
     ...
     *     information to provide views of the source images.
     */
    public HlaresultBuilder.Impl withImagingStudy(@NonNull Collection<Reference> imagingStudy) {
     ...
     *     profiles etc.
     */
    public HlaresultBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     *     equivalent.
     */
    public HlaresultBuilder.Impl withPresentedForm(@NonNull Attachment... presentedForm) {
     ...
     *     equivalent.
     */
    public HlaresultBuilder.Impl withPresentedForm(@NonNull Collection<Attachment> presentedForm) {
     ...
     *     (interpretation/impression) of the diagnostic report.
     */
    public HlaresultBuilder.Impl withConclusionCode(@NonNull CodeableConcept... conclusionCode) {
     ...
     */
    public HlaresultBuilder.Impl withModifierExtension(@NonNull Extension... modifierExtension) {
     ...
     */
    public HlaresultBuilder.Impl withResultsInterpreter(@NonNull Reference... resultsInterpreter) {
     ...
     */
    public HlaresultBuilder.Impl withMedia(@NonNull DiagnosticReport.Media... media) {
