...
public interface Codesystem_authorBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Codesystem_authorBuilder {
     ...
     */
    public Codesystem_authorBuilder.Impl withId(@NonNull String id) {
