...
public class Valueset_stewardBuilder {
   ...
   */
  public Valueset_stewardBuilder(String url, ContactDetail value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Valueset_stewardBuilder withId(@NonNull String id) {
