...
public interface Cqf_systemUserTypeBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Cqf_systemUserTypeBuilder {
     ...
     */
    public Cqf_systemUserTypeBuilder.Impl withId(@NonNull String id) {
