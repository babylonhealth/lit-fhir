...
public class ProductShelfLifeBuilder {
   ...
   *     shelf life of the packaged Medicinal Product itself, shelf life after transformation where
   *     necessary and shelf life after the first opening of a bottle, etc. The shelf life type
   *     shall be specified using an appropriate controlled vocabulary The controlled term and the
   *     controlled term identifier shall be specified.
   * @param period - The shelf life time period can be specified using a numerical value for the
   *     period of time and its unit of time measurement The unit of measurement shall be specified
   *     in accordance with ISO 11240 and the resulting terminology The symbol and the symbol
   *     identifier shall be used.
   */
  public ProductShelfLifeBuilder(CodeableConcept _type, Quantity period) {
    this._type = _type;
    this.period = period;
  }
   ...
   */
  public ProductShelfLifeBuilder withId(@NonNull String id) {
   ...
   */
  public ProductShelfLifeBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ProductShelfLifeBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param identifier - Unique identifier for the packaged Medicinal Product. */
  public ProductShelfLifeBuilder withIdentifier(@NonNull Identifier identifier) {
   ...
   */
  public ProductShelfLifeBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public ProductShelfLifeBuilder withModifierExtension(
      @NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /**
   * @param specialPrecautionsForStorage - Special precautions for storage, if any, can be specified
   *     using an appropriate controlled vocabulary The controlled term and the controlled term
   *     identifier shall be specified.
   */
  public ProductShelfLifeBuilder withSpecialPrecautionsForStorage(
