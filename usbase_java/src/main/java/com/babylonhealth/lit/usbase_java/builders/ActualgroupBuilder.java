...
public class ActualgroupBuilder {
   ...
   */
  public ActualgroupBuilder(GROUP_TYPE _type, Boolean actual) {
    this._type = _type;
    this.actual = actual;
  }
   ...
   */
  public ActualgroupBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public ActualgroupBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public ActualgroupBuilder withText(@NonNull Narrative text) {
   ...
   *     etc.
   */
  public ActualgroupBuilder withCode(@NonNull CodeableConcept code) {
    this.code = Optional.of(code);
    return this;
  }
  /** @param name - A label assigned to the group for human identification and communication. */
  public ActualgroupBuilder withName(@NonNull String name) {
   ...
   */
  public ActualgroupBuilder withActive(@NonNull Boolean active) {
    this.active = Optional.of(active);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public ActualgroupBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param quantity - A count of the number of resource instances that are part of the group. */
  public ActualgroupBuilder withQuantity(@NonNull Integer quantity) {
   ...
   */
  public ActualgroupBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public ActualgroupBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public ActualgroupBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ActualgroupBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param identifier - A unique business identifier for this group. */
  public ActualgroupBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique business identifier for this group. */
  public ActualgroupBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   *     profiles etc.
   */
  public ActualgroupBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public ActualgroupBuilder withManagingEntity(@NonNull Reference managingEntity) {
   ...
   */
  public ActualgroupBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public ActualgroupBuilder withModifierExtension(
      @NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param member - Identifies the resource instances that are members of the group. */
  public ActualgroupBuilder withMember(@NonNull Group.Member... member) {
    this.member = Arrays.asList(member);
    return this;
  }
  /** @param member - Identifies the resource instances that are members of the group. */
  public ActualgroupBuilder withMember(@NonNull Collection<Group.Member> member) {
