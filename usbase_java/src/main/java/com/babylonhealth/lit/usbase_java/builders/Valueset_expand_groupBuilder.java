...
public interface Valueset_expand_groupBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Valueset_expand_groupBuilder {
    private Optional<String> id = Optional.empty();
    private Collection<Extension> extension;

    /**
     * Required fields for {@link Valueset_expand_group}
     *
     ...
     */
    public Valueset_expand_groupBuilder.Impl withId(@NonNull String id) {
