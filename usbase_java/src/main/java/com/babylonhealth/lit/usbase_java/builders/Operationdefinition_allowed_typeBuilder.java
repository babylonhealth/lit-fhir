...
public interface Operationdefinition_allowed_typeBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Operationdefinition_allowed_typeBuilder {
     ...
     */
    public Operationdefinition_allowed_typeBuilder.Impl withId(@NonNull String id) {
