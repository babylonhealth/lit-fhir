...
public interface GeolocationBuilder extends ExtensionBuilder {
  ...
  public class Impl implements GeolocationBuilder {
    private Optional<String> id = Optional.empty();
    private Collection<Extension> extension;

    /**
     * Required fields for {@link Geolocation}
     *
     ...
     */
    public GeolocationBuilder.Impl withId(@NonNull String id) {
