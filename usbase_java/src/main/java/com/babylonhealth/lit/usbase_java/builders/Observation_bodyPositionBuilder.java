...
public interface Observation_bodyPositionBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Observation_bodyPositionBuilder {
     ...
     */
    public Observation_bodyPositionBuilder.Impl withId(@NonNull String id) {
