...
public interface Observation_geneticsGenomicSourceClassBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Observation_geneticsGenomicSourceClassBuilder {
     ...
     */
    public Observation_geneticsGenomicSourceClassBuilder.Impl withId(@NonNull String id) {
