...
public interface Patient_disabilityBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Patient_disabilityBuilder {
    private Optional<String> id = Optional.empty();
    private CodeableConcept value;

    /**
     * Required fields for {@link Patient_disability}
     *
     ...
     */
    public Patient_disabilityBuilder.Impl withId(@NonNull String id) {
