...
public interface Observation_geneticsAncestryBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Observation_geneticsAncestryBuilder {
    private Optional<String> id = Optional.empty();
    private Collection<Extension> extension;

    /**
     * Required fields for {@link Observation_geneticsAncestry}
     *
     ...
     */
    public Observation_geneticsAncestryBuilder.Impl withId(@NonNull String id) {
