...
public interface SubstanceSourceMaterial_PartDescriptionBuilder {
  ...
  public class Impl implements SubstanceSourceMaterial_PartDescriptionBuilder {
     ...
     */
    public SubstanceSourceMaterial_PartDescriptionBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param part */
    public SubstanceSourceMaterial_PartDescriptionBuilder.Impl withPart(
        @NonNull CodeableConcept part) {
