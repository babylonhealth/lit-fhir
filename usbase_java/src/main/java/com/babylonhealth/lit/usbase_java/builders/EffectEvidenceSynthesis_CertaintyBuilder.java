...
public interface EffectEvidenceSynthesis_CertaintyBuilder {
  ...
  public class Impl implements EffectEvidenceSynthesis_CertaintyBuilder {
     ...
     */
    public EffectEvidenceSynthesis_CertaintyBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }
    /** @param note - A human-readable string to clarify or explain concepts about the resource. */
    public EffectEvidenceSynthesis_CertaintyBuilder.Impl withNote(@NonNull Annotation... note) {
