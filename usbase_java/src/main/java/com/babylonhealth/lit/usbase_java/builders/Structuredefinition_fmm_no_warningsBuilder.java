...
public class Structuredefinition_fmm_no_warningsBuilder {
   ...
   */
  public Structuredefinition_fmm_no_warningsBuilder(String url, Integer value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Structuredefinition_fmm_no_warningsBuilder withId(@NonNull String id) {
