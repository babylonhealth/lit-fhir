...
public interface Goal_acceptanceBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Goal_acceptanceBuilder {
    private Optional<String> id = Optional.empty();
    private Collection<Extension> extension;

    /**
     * Required fields for {@link Goal_acceptance}
     *
     ...
     */
    public Goal_acceptanceBuilder.Impl withId(@NonNull String id) {
