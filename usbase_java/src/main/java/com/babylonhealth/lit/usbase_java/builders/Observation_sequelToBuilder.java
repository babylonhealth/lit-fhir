...
public class Observation_sequelToBuilder {
   ...
   */
  public Observation_sequelToBuilder(String url, Reference value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Observation_sequelToBuilder withId(@NonNull String id) {
