...
public interface Patient_proficiencyBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Patient_proficiencyBuilder {
    private Optional<String> id = Optional.empty();
    private Collection<Extension> extension = Collections.emptyList();

    /** Required fields for {@link Patient_proficiency} */
    public Impl() {}
     ...
     */
    public Patient_proficiencyBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public Patient_proficiencyBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     part of the definition of the extension.
     */
    public Patient_proficiencyBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
