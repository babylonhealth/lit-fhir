...
public class LdlcholesterolBuilder {
  private Optional<String> id = Optional.empty();
  private Optional<Meta> meta =
      Optional.of(
          new MetaBuilder()
              .withProfile("http://hl7.org/fhir/StructureDefinition/ldlcholesterol")
              .build());
  ...
  /**
   * Required fields for {@link Ldlcholesterol}
   *
   * @param code - LDL Cholesterol -measured or calculated per code.
   ...
   */
  public LdlcholesterolBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public LdlcholesterolBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public LdlcholesterolBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param note - Comments about result. */
  public LdlcholesterolBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Comments about result. */
  public LdlcholesterolBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   */
  public LdlcholesterolBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     patient of record and the mother is the focus.
   */
  public LdlcholesterolBuilder withFocus(@NonNull Collection<Reference> focus) {
   ...
   */
  public LdlcholesterolBuilder withPartOf(@NonNull Reference... partOf) {
   ...
   *     example, an observation as part of a procedure.
   */
  public LdlcholesterolBuilder withPartOf(@NonNull Collection<Reference> partOf) {
   ...
   */
  public LdlcholesterolBuilder withIssued(@NonNull ZonedDateTime issued) {
    this.issued = Optional.of(issued);
    return this;
  }
  /** @param method - Indicates the mechanism used to perform the observation. */
  public LdlcholesterolBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param device - The device used to generate the observation data. */
  public LdlcholesterolBuilder withDevice(@NonNull Reference device) {
   ...
   */
  public LdlcholesterolBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     before it is dispensed.
   */
  public LdlcholesterolBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
   ...
   */
  public LdlcholesterolBuilder withSubject(@NonNull Reference subject) {
    this.subject = Optional.of(subject);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public LdlcholesterolBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param category - A code that classifies the general type of observation being made. */
  public LdlcholesterolBuilder withCategory(@NonNull CodeableConcept... category) {
    this.category = Arrays.asList(category);
    return this;
  }
  /** @param category - A code that classifies the general type of observation being made. */
  public LdlcholesterolBuilder withCategory(@NonNull Collection<CodeableConcept> category) {
   ...
   */
  public LdlcholesterolBuilder withValue(@NonNull Quantity value) {
   ...
   *     the target site).
   */
  public LdlcholesterolBuilder withBodySite(@NonNull CodeableConcept bodySite) {
    this.bodySite = Optional.of(bodySite);
    return this;
  }
  /** @param specimen - The specimen that was used when this observation was made. */
  public LdlcholesterolBuilder withSpecimen(@NonNull Reference specimen) {
   ...
   */
  public LdlcholesterolBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public LdlcholesterolBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public LdlcholesterolBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public LdlcholesterolBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public LdlcholesterolBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public LdlcholesterolBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public LdlcholesterolBuilder withPerformer(@NonNull Collection<Reference> performer) {
    this.performer = Collections.unmodifiableCollection(performer);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public LdlcholesterolBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public LdlcholesterolBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   *     pass the value in, wrap with one of the LdlcholesterolBuilder.effective static methods
   */
   ...
   *     profiles etc.
   */
  public LdlcholesterolBuilder withImplicitRules(@NonNull String implicitRules) {
    this.implicitRules = Optional.of(implicitRules);
    return this;
  }
  /** @param interpretation - + | ++ | +++ | - | -- | ---. */
  public LdlcholesterolBuilder withInterpretation(@NonNull CodeableConcept interpretation) {
   ...
   */
  public LdlcholesterolBuilder withDataAbsentReason(@NonNull CodeableConcept dataAbsentReason) {
   ...
   */
  public LdlcholesterolBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public LdlcholesterolBuilder withModifierExtension(
   ...
   */
  public LdlcholesterolBuilder withComponent(@NonNull Observation.Component... component) {
   ...
   *     measurement and multiple component observations for genetics observations.
   */
  public LdlcholesterolBuilder withComponent(@NonNull Collection<Observation.Component> component) {
