...
public interface LdlcholesterolBuilder extends ObservationBuilder {
  ...
  public class Impl implements LdlcholesterolBuilder {
     ...
     */
    public LdlcholesterolBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public LdlcholesterolBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     */
    public LdlcholesterolBuilder.Impl withText(@NonNull Narrative text) {
     ...
     */
    public LdlcholesterolBuilder.Impl withFocus(@NonNull Reference... focus) {
     ...
     *     is the patient of record and the mother is the focus.
     */
    public LdlcholesterolBuilder.Impl withFocus(@NonNull Collection<Reference> focus) {
     ...
     */
    public LdlcholesterolBuilder.Impl withPartOf(@NonNull Reference... partOf) {
     ...
     *     For example, an observation as part of a procedure.
     */
    public LdlcholesterolBuilder.Impl withPartOf(@NonNull Collection<Reference> partOf) {
     ...
     */
    public LdlcholesterolBuilder.Impl withIssued(@NonNull ZonedDateTime issued) {
      this.issued = Optional.of(issued);
      return this;
    }
    /** @param method - Indicates the mechanism used to perform the observation. */
    public LdlcholesterolBuilder.Impl withMethod(@NonNull CodeableConcept method) {
     ...
     */
    public LdlcholesterolBuilder.Impl withBasedOn(@NonNull Reference... basedOn) {
     ...
     *     performed before it is dispensed.
     */
    public LdlcholesterolBuilder.Impl withBasedOn(@NonNull Collection<Reference> basedOn) {
    ...
    public LdlcholesterolBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
      this.language = Optional.of(language);
      return this;
    }
    /** @param category - A code that classifies the general type of observation being made. */
    public LdlcholesterolBuilder.Impl withCategory(@NonNull CodeableConcept... category) {
      this.category = Arrays.asList(category);
      return this;
    }
    /** @param category - A code that classifies the general type of observation being made. */
    public LdlcholesterolBuilder.Impl withCategory(@NonNull Collection<CodeableConcept> category) {
     ...
     *     (i.e. the target site).
     */
    public LdlcholesterolBuilder.Impl withBodySite(@NonNull CodeableConcept bodySite) {
     ...
     */
    public LdlcholesterolBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     */
    public LdlcholesterolBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public LdlcholesterolBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
    ...
    public LdlcholesterolBuilder.Impl withPerformer(@NonNull Reference... performer) {
      this.performer = Arrays.asList(performer);
      return this;
    }
    /** @param performer - Who was responsible for asserting the observed value as "true". */
    public LdlcholesterolBuilder.Impl withPerformer(@NonNull Collection<Reference> performer) {
     ...
     *     static methods
     */
    public LdlcholesterolBuilder.Impl withEffective(
     ...
     *     profiles etc.
     */
    public LdlcholesterolBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
      this.implicitRules = Optional.of(implicitRules);
      return this;
    }
    /** @param interpretation - + | ++ | +++ | - | -- | ---. */
    public LdlcholesterolBuilder.Impl withInterpretation(@NonNull CodeableConcept interpretation) {
     ...
     */
    public LdlcholesterolBuilder.Impl withComponent(@NonNull Observation.Component... component) {
