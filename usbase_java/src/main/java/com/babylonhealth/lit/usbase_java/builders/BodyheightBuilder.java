...
public interface BodyheightBuilder extends VitalsignsBuilder {
  ...
  public class Impl implements BodyheightBuilder {
    ...
    private Optional<Meta> meta =
        Optional.of(
            MetaBuilder.init()
                .withProfile("http://hl7.org/fhir/StructureDefinition/bodyheight")
                .build());
    ...
    /**
     * Required fields for {@link Bodyheight}
     *
     ...
     *     BodyheightBuilder.effective static methods
     * @param code - Body Height.
     */
    public Impl(
        OBSERVATION_STATUS status,
        Reference subject,
     ...
     */
    public BodyheightBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public BodyheightBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public BodyheightBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public BodyheightBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public BodyheightBuilder.Impl withText(@NonNull NarrativeBuilder text) {
      this.text = Optional.of(text.build());
      return this;
    }
    /** @param note - Comments about the observation or the results. */
    public BodyheightBuilder.Impl withNote(@NonNull Annotation... note) {
      this.note = Arrays.asList(note);
      return this;
    }
    /** @param note - Comments about the observation or the results. */
    public BodyheightBuilder.Impl withNote(@NonNull Collection<Annotation> note) {
      this.note = Collections.unmodifiableCollection(note);
      return this;
    }

    public BodyheightBuilder.Impl withNote(@NonNull AnnotationBuilder... note) {
     ...
     */
    public BodyheightBuilder.Impl withFocus(@NonNull Reference... focus) {
     ...
     *     is the patient of record and the mother is the focus.
     */
    public BodyheightBuilder.Impl withFocus(@NonNull Collection<Reference> focus) {
      this.focus = Collections.unmodifiableCollection(focus);
      return this;
    }

    public BodyheightBuilder.Impl withFocus(@NonNull ReferenceBuilder... focus) {
     ...
     */
    public BodyheightBuilder.Impl withPartOf(@NonNull Reference... partOf) {
     ...
     *     For example, an observation as part of a procedure.
     */
    public BodyheightBuilder.Impl withPartOf(@NonNull Collection<Reference> partOf) {
      this.partOf = Collections.unmodifiableCollection(partOf);
      return this;
    }

    public BodyheightBuilder.Impl withPartOf(@NonNull ReferenceBuilder... partOf) {
     ...
     */
    public BodyheightBuilder.Impl withIssued(@NonNull ZonedDateTime issued) {
      this.issued = Optional.of(issued);
      return this;
    }
    /** @param method - Indicates the mechanism used to perform the observation. */
    public BodyheightBuilder.Impl withMethod(@NonNull CodeableConcept method) {
      this.method = Optional.of(method);
      return this;
    }

    public BodyheightBuilder.Impl withMethod(@NonNull CodeableConceptBuilder method) {
      this.method = Optional.of(method.build());
      return this;
    }
    /** @param device - The device used to generate the observation data. */
    public BodyheightBuilder.Impl withDevice(@NonNull Reference device) {
      this.device = Optional.of(device);
      return this;
    }

    public BodyheightBuilder.Impl withDevice(@NonNull ReferenceBuilder device) {
     ...
     */
    public BodyheightBuilder.Impl withBasedOn(@NonNull Reference... basedOn) {
     ...
     *     performed before it is dispensed.
     */
    public BodyheightBuilder.Impl withBasedOn(@NonNull Collection<Reference> basedOn) {
      this.basedOn = Collections.unmodifiableCollection(basedOn);
      return this;
    }

    public BodyheightBuilder.Impl withBasedOn(@NonNull ReferenceBuilder... basedOn) {
      this.basedOn = Arrays.stream(basedOn).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public BodyheightBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public BodyheightBuilder.Impl withValue(@NonNull Quantity value) {
      this.value = Optional.of(value);
      return this;
    }

    public BodyheightBuilder.Impl withValue(@NonNull QuantityBuilder value) {
     ...
     *     (i.e. the target site).
     */
    public BodyheightBuilder.Impl withBodySite(@NonNull CodeableConcept bodySite) {
      this.bodySite = Optional.of(bodySite);
      return this;
    }

    public BodyheightBuilder.Impl withBodySite(@NonNull CodeableConceptBuilder bodySite) {
      this.bodySite = Optional.of(bodySite.build());
      return this;
    }
    /** @param specimen - The specimen that was used when this observation was made. */
    public BodyheightBuilder.Impl withSpecimen(@NonNull Reference specimen) {
      this.specimen = Optional.of(specimen);
      return this;
    }

    public BodyheightBuilder.Impl withSpecimen(@NonNull ReferenceBuilder specimen) {
     ...
     */
    public BodyheightBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public BodyheightBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
      this.contained = Collections.unmodifiableCollection(contained);
      return this;
    }

    public BodyheightBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public BodyheightBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public BodyheightBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public BodyheightBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
     ...
     */
    public BodyheightBuilder.Impl withEncounter(@NonNull Reference encounter) {
      this.encounter = Optional.of(encounter);
      return this;
    }

    public BodyheightBuilder.Impl withEncounter(@NonNull ReferenceBuilder encounter) {
      this.encounter = Optional.of(encounter.build());
      return this;
    }
    /** @param performer - Who was responsible for asserting the observed value as "true". */
    public BodyheightBuilder.Impl withPerformer(@NonNull Reference... performer) {
      this.performer = Arrays.asList(performer);
      return this;
    }
    /** @param performer - Who was responsible for asserting the observed value as "true". */
    public BodyheightBuilder.Impl withPerformer(@NonNull Collection<Reference> performer) {
      this.performer = Collections.unmodifiableCollection(performer);
      return this;
    }

    public BodyheightBuilder.Impl withPerformer(@NonNull ReferenceBuilder... performer) {
    ...
    public BodyheightBuilder.Impl withHasMember(@NonNull Reference... hasMember) {
      this.hasMember = Arrays.asList(hasMember);
      return this;
    }
    /** @param hasMember - Used when reporting vital signs panel components. */
    public BodyheightBuilder.Impl withHasMember(@NonNull Collection<Reference> hasMember) {
      this.hasMember = Collections.unmodifiableCollection(hasMember);
      return this;
    }

    public BodyheightBuilder.Impl withHasMember(@NonNull ReferenceBuilder... hasMember) {
    ...
    public BodyheightBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
      this.identifier = Arrays.asList(identifier);
      return this;
    }
    /** @param identifier - A unique identifier assigned to this observation. */
    public BodyheightBuilder.Impl withIdentifier(@NonNull Collection<Identifier> identifier) {
      this.identifier = Collections.unmodifiableCollection(identifier);
      return this;
    }

    public BodyheightBuilder.Impl withIdentifier(@NonNull IdentifierBuilder... identifier) {
     ...
     */
    public BodyheightBuilder.Impl withDerivedFrom(@NonNull Reference... derivedFrom) {
     ...
     *     based on an ultrasound image.
     */
    public BodyheightBuilder.Impl withDerivedFrom(@NonNull Collection<Reference> derivedFrom) {
      this.derivedFrom = Collections.unmodifiableCollection(derivedFrom);
      return this;
    }

    public BodyheightBuilder.Impl withDerivedFrom(@NonNull ReferenceBuilder... derivedFrom) {
     ...
     *     profiles etc.
     */
    public BodyheightBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     *     low, normal.
     */
    public BodyheightBuilder.Impl withInterpretation(@NonNull CodeableConcept... interpretation) {
     ...
     *     low, normal.
     */
    public BodyheightBuilder.Impl withInterpretation(
     ...
     */
    public BodyheightBuilder.Impl withDataAbsentReason(@NonNull CodeableConcept dataAbsentReason) {
      this.dataAbsentReason = Optional.of(dataAbsentReason);
      return this;
    }

    public BodyheightBuilder.Impl withDataAbsentReason(
     ...
     */
    public BodyheightBuilder.Impl withModifierExtension(@NonNull Extension... modifierExtension) {
     ...
     *     DomainResource (including cannot change the meaning of modifierExtension itself).
     */
    public BodyheightBuilder.Impl withModifierExtension(
    ...
    public BodyheightBuilder.Impl withComponent(@NonNull Observation.Component... component) {
      this.component = Arrays.asList(component);
      return this;
    }
    /** @param component - Used when reporting systolic and diastolic blood pressure. */
    public BodyheightBuilder.Impl withComponent(
     ...
     *     used.
     */
    public BodyheightBuilder.Impl withReferenceRange(
    ...
    public BodyheightBuilder.Impl withoutMeta() {
