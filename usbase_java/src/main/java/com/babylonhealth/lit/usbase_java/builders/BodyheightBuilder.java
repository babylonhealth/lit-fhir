...
public class BodyheightBuilder {
    ...
    this.effective =
        (Choice)
            Choice$.MODULE$.fromSuffix(
                autoSuffix(effective.getClass().getSimpleName(), Bodyheight$.MODULE$.effective()),
                effective,
                Bodyheight$.MODULE$.effective());
    this.code = code;
  }
   ...
   */
  public BodyheightBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public BodyheightBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public BodyheightBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public BodyheightBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public BodyheightBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   */
  public BodyheightBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     patient of record and the mother is the focus.
   */
  public BodyheightBuilder withFocus(@NonNull Collection<Reference> focus) {
   ...
   */
  public BodyheightBuilder withPartOf(@NonNull Reference... partOf) {
   ...
   *     example, an observation as part of a procedure.
   */
  public BodyheightBuilder withPartOf(@NonNull Collection<Reference> partOf) {
   ...
   */
  public BodyheightBuilder withIssued(@NonNull ZonedDateTime issued) {
    this.issued = Optional.of(issued);
    return this;
  }
  /** @param method - Indicates the mechanism used to perform the observation. */
  public BodyheightBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param device - The device used to generate the observation data. */
  public BodyheightBuilder withDevice(@NonNull Reference device) {
   ...
   */
  public BodyheightBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     before it is dispensed.
   */
  public BodyheightBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public BodyheightBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public BodyheightBuilder withValue(@NonNull Quantity value) {
   ...
   *     the target site).
   */
  public BodyheightBuilder withBodySite(@NonNull CodeableConcept bodySite) {
    this.bodySite = Optional.of(bodySite);
    return this;
  }
  /** @param specimen - The specimen that was used when this observation was made. */
  public BodyheightBuilder withSpecimen(@NonNull Reference specimen) {
   ...
   */
  public BodyheightBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public BodyheightBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public BodyheightBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public BodyheightBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public BodyheightBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public BodyheightBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public BodyheightBuilder withPerformer(@NonNull Collection<Reference> performer) {
    this.performer = Collections.unmodifiableCollection(performer);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public BodyheightBuilder withHasMember(@NonNull Reference... hasMember) {
    this.hasMember = Arrays.asList(hasMember);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public BodyheightBuilder withHasMember(@NonNull Collection<Reference> hasMember) {
  ...
  public BodyheightBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public BodyheightBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public BodyheightBuilder withDerivedFrom(@NonNull Reference... derivedFrom) {
   ...
   *     based on an ultrasound image.
   */
  public BodyheightBuilder withDerivedFrom(@NonNull Collection<Reference> derivedFrom) {
   ...
   *     profiles etc.
   */
  public BodyheightBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     low, normal.
   */
  public BodyheightBuilder withInterpretation(@NonNull CodeableConcept... interpretation) {
   ...
   *     low, normal.
   */
  public BodyheightBuilder withInterpretation(@NonNull Collection<CodeableConcept> interpretation) {
   ...
   */
  public BodyheightBuilder withDataAbsentReason(@NonNull CodeableConcept dataAbsentReason) {
   ...
   */
  public BodyheightBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public BodyheightBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param component - Used when reporting systolic and diastolic blood pressure. */
  public BodyheightBuilder withComponent(@NonNull Observation.Component... component) {
    this.component = Arrays.asList(component);
    return this;
  }
  /** @param component - Used when reporting systolic and diastolic blood pressure. */
  public BodyheightBuilder withComponent(@NonNull Collection<Observation.Component> component) {
   ...
   */
  public BodyheightBuilder withReferenceRange(
