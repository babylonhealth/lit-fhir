...
public interface MimeTypeBuilder extends ExtensionBuilder {
  ...
  public class Impl implements MimeTypeBuilder {
     ...
     */
    public MimeTypeBuilder.Impl withId(@NonNull String id) {
