...
public class Questionnaire_signatureRequiredBuilder {
   ...
   */
  public Questionnaire_signatureRequiredBuilder(String url, CodeableConcept value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Questionnaire_signatureRequiredBuilder withId(@NonNull String id) {
