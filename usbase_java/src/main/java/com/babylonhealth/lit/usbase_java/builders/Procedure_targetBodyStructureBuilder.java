...
public class Procedure_targetBodyStructureBuilder {
   ...
   */
  public Procedure_targetBodyStructureBuilder(String url, Reference value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Procedure_targetBodyStructureBuilder withId(@NonNull String id) {
