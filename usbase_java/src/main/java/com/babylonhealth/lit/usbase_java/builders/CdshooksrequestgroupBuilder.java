...
public class CdshooksrequestgroupBuilder {
   ...
   */
  public CdshooksrequestgroupBuilder(
   ...
   */
  public CdshooksrequestgroupBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public CdshooksrequestgroupBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public CdshooksrequestgroupBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param code - A code that identifies what the overall request group is. */
  public CdshooksrequestgroupBuilder withCode(@NonNull CodeableConcept code) {
   ...
   */
  public CdshooksrequestgroupBuilder withNote(@NonNull Annotation... note) {
   ...
   * @param note - Provides a mechanism to communicate additional information about the response.
   */
  public CdshooksrequestgroupBuilder withNote(@NonNull Collection<Annotation> note) {
    this.note = Collections.unmodifiableCollection(note);
    return this;
  }
  /** @param author - Provides a reference to the author of the request group. */
  public CdshooksrequestgroupBuilder withAuthor(@NonNull Reference author) {
   ...
   *     request.
   */
  public CdshooksrequestgroupBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     request.
   */
  public CdshooksrequestgroupBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param subject - The subject for which the request group was created. */
  public CdshooksrequestgroupBuilder withSubject(@NonNull Reference subject) {
    this.subject = Optional.of(subject);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public CdshooksrequestgroupBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   *     request.
   */
  public CdshooksrequestgroupBuilder withReplaces(@NonNull Reference... replaces) {
   ...
   *     request.
   */
  public CdshooksrequestgroupBuilder withReplaces(@NonNull Collection<Reference> replaces) {
   ...
   *     requests.
   */
  public CdshooksrequestgroupBuilder withPriority(@NonNull REQUEST_PRIORITY priority) {
   ...
   */
  public CdshooksrequestgroupBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public CdshooksrequestgroupBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public CdshooksrequestgroupBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public CdshooksrequestgroupBuilder withExtension(@NonNull Collection<Extension> extension) {
    this.extension = Collections.unmodifiableCollection(extension);
    return this;
  }
  /** @param encounter - Describes the context of the request group, if any. */
  public CdshooksrequestgroupBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param authoredOn - Indicates when the request group was created. */
  public CdshooksrequestgroupBuilder withAuthoredOn(@NonNull FHIRDateTime authoredOn) {
  ...
  public CdshooksrequestgroupBuilder withReasonCode(@NonNull CodeableConcept... reasonCode) {
    this.reasonCode = Arrays.asList(reasonCode);
    return this;
  }
  /** @param reasonCode - Describes the reason for the request group in coded or textual form. */
  public CdshooksrequestgroupBuilder withReasonCode(
   ...
   *     profiles etc.
   */
  public CdshooksrequestgroupBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public CdshooksrequestgroupBuilder withGroupIdentifier(@NonNull Identifier groupIdentifier) {
   ...
   *     group.
   */
  public CdshooksrequestgroupBuilder withReasonReference(@NonNull Reference... reasonReference) {
   ...
   *     group.
   */
  public CdshooksrequestgroupBuilder withReasonReference(
   ...
   */
  public CdshooksrequestgroupBuilder withModifierExtension(
   ...
   */
  public CdshooksrequestgroupBuilder withInstantiatesCanonical(
  ...
  public CdshooksrequestgroupBuilder withAction(@NonNull RequestGroup.Action... action) {
    this.action = Arrays.asList(action);
    return this;
  }
  /** @param action - The actions, if any, produced by the evaluation of the artifact. */
  public CdshooksrequestgroupBuilder withAction(@NonNull Collection<RequestGroup.Action> action) {
