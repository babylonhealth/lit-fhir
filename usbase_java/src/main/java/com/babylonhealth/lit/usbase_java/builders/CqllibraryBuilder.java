...
public class CqllibraryBuilder {
   ...
   *     Reference.
   */
  public <T> CqllibraryBuilder withSubject(@NonNull T subject) {
    var guessedSuffix =
        autoSuffix(subject.getClass().getSimpleName(), Cqllibrary$.MODULE$.subject());
   ...
   */
  public <T> CqllibraryBuilder withSubject(String suffix, @NonNull T subject) {
    guard(subject.getClass().getSimpleName(), suffix, Cqllibrary$.MODULE$.subject());
    this.subject =
        Optional.of(
            (Choice) Choice$.MODULE$.fromSuffix(suffix, subject, Cqllibrary$.MODULE$.subject()));
    return this;
  }
  /**
