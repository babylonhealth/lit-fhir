...
public class Questionnaire_baseTypeBuilder {
   ...
   */
  public Questionnaire_baseTypeBuilder(String url, DATA_TYPES value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Questionnaire_baseTypeBuilder withId(@NonNull String id) {
