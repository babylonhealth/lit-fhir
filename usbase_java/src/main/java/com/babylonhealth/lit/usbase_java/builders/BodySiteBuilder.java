...
public interface BodySiteBuilder extends ExtensionBuilder {
  ...
  public class Impl implements BodySiteBuilder {
     ...
     */
    public BodySiteBuilder.Impl withId(@NonNull String id) {
