...
public class Observation_geneticsBuilder {
   ...
   */
  public Observation_geneticsBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public Observation_geneticsBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public Observation_geneticsBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public Observation_geneticsBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public Observation_geneticsBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   */
  public Observation_geneticsBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     patient of record and the mother is the focus.
   */
  public Observation_geneticsBuilder withFocus(@NonNull Collection<Reference> focus) {
   ...
   */
  public Observation_geneticsBuilder withPartOf(@NonNull Reference... partOf) {
   ...
   *     example, an observation as part of a procedure.
   */
  public Observation_geneticsBuilder withPartOf(@NonNull Collection<Reference> partOf) {
   ...
   */
  public Observation_geneticsBuilder withIssued(@NonNull ZonedDateTime issued) {
    this.issued = Optional.of(issued);
    return this;
  }
  /** @param method - Indicates the mechanism used to perform the observation. */
  public Observation_geneticsBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param device - The device used to generate the observation data. */
  public Observation_geneticsBuilder withDevice(@NonNull Reference device) {
   ...
   */
  public Observation_geneticsBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     before it is dispensed.
   */
  public Observation_geneticsBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
   ...
   */
  public Observation_geneticsBuilder withSubject(@NonNull Reference subject) {
    this.subject = Optional.of(subject);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public Observation_geneticsBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param category - A code that classifies the general type of observation being made. */
  public Observation_geneticsBuilder withCategory(@NonNull CodeableConcept... category) {
    this.category = Arrays.asList(category);
    return this;
  }
  /** @param category - A code that classifies the general type of observation being made. */
  public Observation_geneticsBuilder withCategory(@NonNull Collection<CodeableConcept> category) {
   ...
   *     the target site).
   */
  public Observation_geneticsBuilder withBodySite(@NonNull CodeableConcept bodySite) {
    this.bodySite = Optional.of(bodySite);
    return this;
  }
  /** @param specimen - The specimen that was used when this observation was made. */
  public Observation_geneticsBuilder withSpecimen(@NonNull Reference specimen) {
   ...
   */
  public Observation_geneticsBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public Observation_geneticsBuilder withContained(@NonNull Collection<Resource> contained) {
    this.contained = Collections.unmodifiableCollection(contained);
    return this;
  }
  /** @param extension - An Extension */
  public Observation_geneticsBuilder withExtension(@NonNull Extension... extension) {
    this.extension = Arrays.asList(extension);
    return this;
  }
  /** @param extension - An Extension */
  public Observation_geneticsBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public Observation_geneticsBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public Observation_geneticsBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public Observation_geneticsBuilder withPerformer(@NonNull Collection<Reference> performer) {
   ...
   */
  public Observation_geneticsBuilder withHasMember(@NonNull Reference... hasMember) {
   ...
   *     set of vital sign measurements) that includes the target as a member of the group.
   */
  public Observation_geneticsBuilder withHasMember(@NonNull Collection<Reference> hasMember) {
  ...
  public Observation_geneticsBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public Observation_geneticsBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public Observation_geneticsBuilder withDerivedFrom(@NonNull Reference... derivedFrom) {
   ...
   *     based on an ultrasound image.
   */
  public Observation_geneticsBuilder withDerivedFrom(@NonNull Collection<Reference> derivedFrom) {
   ...
   *     profiles etc.
   */
  public Observation_geneticsBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     low, normal.
   */
  public Observation_geneticsBuilder withInterpretation(
   ...
   */
  public Observation_geneticsBuilder withDataAbsentReason(
   ...
   */
  public Observation_geneticsBuilder withModifierExtension(
   ...
   */
  public Observation_geneticsBuilder withComponent(@NonNull Observation.Component... component) {
   ...
   *     measurement and multiple component observations for genetics observations.
   */
  public Observation_geneticsBuilder withComponent(
   ...
   */
  public Observation_geneticsBuilder withReferenceRange(
  ...
  public Observation_geneticsBuilder withoutMeta() {
