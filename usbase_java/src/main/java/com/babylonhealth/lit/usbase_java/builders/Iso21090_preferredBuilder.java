...
public class Iso21090_preferredBuilder {
   ...
   */
  public Iso21090_preferredBuilder(String url, Boolean value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Iso21090_preferredBuilder withId(@NonNull String id) {
