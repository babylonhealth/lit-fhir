...
public class SubstanceSourceMaterial_OrganismBuilder {
  ...
  public SubstanceSourceMaterial_OrganismBuilder() {}

  /**
   * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned,
   *     this value never changes.
   */
  public SubstanceSourceMaterial_OrganismBuilder withId(@NonNull String id) {
    this.id = Optional.of(id);
    return this;
  }
  /** @param genus */
  public SubstanceSourceMaterial_OrganismBuilder withGenus(@NonNull CodeableConcept genus) {
    this.genus = Optional.of(genus);
    return this;
  }
  /** @param family */
  public SubstanceSourceMaterial_OrganismBuilder withFamily(@NonNull CodeableConcept family) {
    this.family = Optional.of(family);
    return this;
  }
  /** @param species */
  public SubstanceSourceMaterial_OrganismBuilder withSpecies(@NonNull CodeableConcept species) {
   ...
   */
  public SubstanceSourceMaterial_OrganismBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public SubstanceSourceMaterial_OrganismBuilder withExtension(
   ...
   */
  public SubstanceSourceMaterial_OrganismBuilder withModifierExtension(
  ...
  public SubstanceSourceMaterial_OrganismBuilder withIntraspecificType(
  ...
  public SubstanceSourceMaterial_OrganismBuilder withIntraspecificDescription(
      @NonNull String intraspecificDescription) {
    this.intraspecificDescription = Optional.of(intraspecificDescription);
    return this;
  }
  /** @param author */
  public SubstanceSourceMaterial_OrganismBuilder withAuthor(
  ...
  /** @param hybrid */
  public SubstanceSourceMaterial_OrganismBuilder withHybrid(
      @NonNull SubstanceSourceMaterial$Organism$Hybrid hybrid) {
    this.hybrid = Optional.of(hybrid);
    return this;
  }
  /** @param organismGeneral */
  public SubstanceSourceMaterial_OrganismBuilder withOrganismGeneral(
