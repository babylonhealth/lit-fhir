...
public interface Http_response_headerBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Http_response_headerBuilder {
     ...
     */
    public Http_response_headerBuilder.Impl withId(@NonNull String id) {
