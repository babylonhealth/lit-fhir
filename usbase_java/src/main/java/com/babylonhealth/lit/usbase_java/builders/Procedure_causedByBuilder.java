...
public interface Procedure_causedByBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Procedure_causedByBuilder {
     ...
     */
    public Procedure_causedByBuilder.Impl withId(@NonNull String id) {
