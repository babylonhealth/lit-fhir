...
public interface HdlcholesterolBuilder extends ObservationBuilder {
  public Hdlcholesterol build();
  ...
  public class Impl implements HdlcholesterolBuilder {
    private Optional<String> id = Optional.empty();
    private Optional<Meta> meta =
        Optional.of(
            MetaBuilder.init()
                .withProfile("http://hl7.org/fhir/StructureDefinition/hdlcholesterol")
                .build());
    ...
    /**
     * Required fields for {@link Hdlcholesterol}
     *
     * @param code - HDL Cholesterol.
     ...
     */
    public HdlcholesterolBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public HdlcholesterolBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public HdlcholesterolBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public HdlcholesterolBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public HdlcholesterolBuilder.Impl withText(@NonNull NarrativeBuilder text) {
      this.text = Optional.of(text.build());
      return this;
    }
    /** @param note - Comments about result. */
    public HdlcholesterolBuilder.Impl withNote(@NonNull Annotation... note) {
      this.note = Arrays.asList(note);
      return this;
    }
    /** @param note - Comments about result. */
    public HdlcholesterolBuilder.Impl withNote(@NonNull Collection<Annotation> note) {
      this.note = Collections.unmodifiableCollection(note);
      return this;
    }

    public HdlcholesterolBuilder.Impl withNote(@NonNull AnnotationBuilder... note) {
     ...
     */
    public HdlcholesterolBuilder.Impl withFocus(@NonNull Reference... focus) {
     ...
     *     is the patient of record and the mother is the focus.
     */
    public HdlcholesterolBuilder.Impl withFocus(@NonNull Collection<Reference> focus) {
      this.focus = Collections.unmodifiableCollection(focus);
      return this;
    }

    public HdlcholesterolBuilder.Impl withFocus(@NonNull ReferenceBuilder... focus) {
     ...
     */
    public HdlcholesterolBuilder.Impl withPartOf(@NonNull Reference... partOf) {
     ...
     *     For example, an observation as part of a procedure.
     */
    public HdlcholesterolBuilder.Impl withPartOf(@NonNull Collection<Reference> partOf) {
      this.partOf = Collections.unmodifiableCollection(partOf);
      return this;
    }

    public HdlcholesterolBuilder.Impl withPartOf(@NonNull ReferenceBuilder... partOf) {
     ...
     */
    public HdlcholesterolBuilder.Impl withIssued(@NonNull ZonedDateTime issued) {
      this.issued = Optional.of(issued);
      return this;
    }
    /** @param method - Indicates the mechanism used to perform the observation. */
    public HdlcholesterolBuilder.Impl withMethod(@NonNull CodeableConcept method) {
      this.method = Optional.of(method);
      return this;
    }

    public HdlcholesterolBuilder.Impl withMethod(@NonNull CodeableConceptBuilder method) {
      this.method = Optional.of(method.build());
      return this;
    }
    /** @param device - The device used to generate the observation data. */
    public HdlcholesterolBuilder.Impl withDevice(@NonNull Reference device) {
      this.device = Optional.of(device);
      return this;
    }

    public HdlcholesterolBuilder.Impl withDevice(@NonNull ReferenceBuilder device) {
     ...
     */
    public HdlcholesterolBuilder.Impl withBasedOn(@NonNull Reference... basedOn) {
     ...
     *     performed before it is dispensed.
     */
    public HdlcholesterolBuilder.Impl withBasedOn(@NonNull Collection<Reference> basedOn) {
      this.basedOn = Collections.unmodifiableCollection(basedOn);
      return this;
    }

    public HdlcholesterolBuilder.Impl withBasedOn(@NonNull ReferenceBuilder... basedOn) {
     ...
     *     observation.
     */
    public HdlcholesterolBuilder.Impl withSubject(@NonNull Reference subject) {
      this.subject = Optional.of(subject);
      return this;
    }

    public HdlcholesterolBuilder.Impl withSubject(@NonNull ReferenceBuilder subject) {
      this.subject = Optional.of(subject.build());
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public HdlcholesterolBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
      this.language = Optional.of(language);
      return this;
    }
    /** @param category - A code that classifies the general type of observation being made. */
    public HdlcholesterolBuilder.Impl withCategory(@NonNull CodeableConcept... category) {
      this.category = Arrays.asList(category);
      return this;
    }
    /** @param category - A code that classifies the general type of observation being made. */
    public HdlcholesterolBuilder.Impl withCategory(@NonNull Collection<CodeableConcept> category) {
      this.category = Collections.unmodifiableCollection(category);
      return this;
    }

    public HdlcholesterolBuilder.Impl withCategory(@NonNull CodeableConceptBuilder... category) {
     ...
     */
    public HdlcholesterolBuilder.Impl withValue(@NonNull Quantity value) {
      this.value = Optional.of(value);
      return this;
    }

    public HdlcholesterolBuilder.Impl withValue(@NonNull QuantityBuilder value) {
     ...
     *     (i.e. the target site).
     */
    public HdlcholesterolBuilder.Impl withBodySite(@NonNull CodeableConcept bodySite) {
      this.bodySite = Optional.of(bodySite);
      return this;
    }

    public HdlcholesterolBuilder.Impl withBodySite(@NonNull CodeableConceptBuilder bodySite) {
      this.bodySite = Optional.of(bodySite.build());
      return this;
    }
    /** @param specimen - The specimen that was used when this observation was made. */
    public HdlcholesterolBuilder.Impl withSpecimen(@NonNull Reference specimen) {
      this.specimen = Optional.of(specimen);
      return this;
    }

    public HdlcholesterolBuilder.Impl withSpecimen(@NonNull ReferenceBuilder specimen) {
     ...
     */
    public HdlcholesterolBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public HdlcholesterolBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
      this.contained = Collections.unmodifiableCollection(contained);
      return this;
    }

    public HdlcholesterolBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public HdlcholesterolBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public HdlcholesterolBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public HdlcholesterolBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
     ...
     */
    public HdlcholesterolBuilder.Impl withEncounter(@NonNull Reference encounter) {
      this.encounter = Optional.of(encounter);
      return this;
    }

    public HdlcholesterolBuilder.Impl withEncounter(@NonNull ReferenceBuilder encounter) {
      this.encounter = Optional.of(encounter.build());
      return this;
    }
    /** @param performer - Who was responsible for asserting the observed value as "true". */
    public HdlcholesterolBuilder.Impl withPerformer(@NonNull Reference... performer) {
      this.performer = Arrays.asList(performer);
      return this;
    }
    /** @param performer - Who was responsible for asserting the observed value as "true". */
    public HdlcholesterolBuilder.Impl withPerformer(@NonNull Collection<Reference> performer) {
      this.performer = Collections.unmodifiableCollection(performer);
      return this;
    }

    public HdlcholesterolBuilder.Impl withPerformer(@NonNull ReferenceBuilder... performer) {
    ...
    public HdlcholesterolBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
      this.identifier = Arrays.asList(identifier);
      return this;
    }
    /** @param identifier - A unique identifier assigned to this observation. */
    public HdlcholesterolBuilder.Impl withIdentifier(@NonNull Collection<Identifier> identifier) {
      this.identifier = Collections.unmodifiableCollection(identifier);
      return this;
    }

    public HdlcholesterolBuilder.Impl withIdentifier(@NonNull IdentifierBuilder... identifier) {
     ...
     *     ZonedDateTime. To pass the value in, wrap with one of the HdlcholesterolBuilder.effective
     *     static methods
     */
    public HdlcholesterolBuilder.Impl withEffective(@NonNull Choice00107722725 effective) {
     ...
     *     profiles etc.
     */
    public HdlcholesterolBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
      this.implicitRules = Optional.of(implicitRules);
      return this;
    }
    /** @param interpretation - + | ++ | +++ | - | -- | ---. */
    public HdlcholesterolBuilder.Impl withInterpretation(@NonNull CodeableConcept interpretation) {
      this.interpretation = Optional.of(interpretation);
      return this;
    }

    public HdlcholesterolBuilder.Impl withInterpretation(
     ...
     */
    public HdlcholesterolBuilder.Impl withDataAbsentReason(
     ...
     */
    public HdlcholesterolBuilder.Impl withModifierExtension(
     ...
     */
    public HdlcholesterolBuilder.Impl withComponent(@NonNull Observation.Component... component) {
     ...
     *     measurement and multiple component observations for genetics observations.
     */
    public HdlcholesterolBuilder.Impl withComponent(
    ...
    public HdlcholesterolBuilder.Impl withoutMeta() {
