...
public class HdlcholesterolBuilder {
   ...
   */
  public HdlcholesterolBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public HdlcholesterolBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public HdlcholesterolBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param note - Comments about result. */
  public HdlcholesterolBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Comments about result. */
  public HdlcholesterolBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   */
  public HdlcholesterolBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     patient of record and the mother is the focus.
   */
  public HdlcholesterolBuilder withFocus(@NonNull Collection<Reference> focus) {
   ...
   */
  public HdlcholesterolBuilder withPartOf(@NonNull Reference... partOf) {
   ...
   *     example, an observation as part of a procedure.
   */
  public HdlcholesterolBuilder withPartOf(@NonNull Collection<Reference> partOf) {
   ...
   */
  public HdlcholesterolBuilder withIssued(@NonNull ZonedDateTime issued) {
    this.issued = Optional.of(issued);
    return this;
  }
  /** @param method - Indicates the mechanism used to perform the observation. */
  public HdlcholesterolBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param device - The device used to generate the observation data. */
  public HdlcholesterolBuilder withDevice(@NonNull Reference device) {
   ...
   */
  public HdlcholesterolBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     before it is dispensed.
   */
  public HdlcholesterolBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
   ...
   */
  public HdlcholesterolBuilder withSubject(@NonNull Reference subject) {
    this.subject = Optional.of(subject);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public HdlcholesterolBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param category - A code that classifies the general type of observation being made. */
  public HdlcholesterolBuilder withCategory(@NonNull CodeableConcept... category) {
    this.category = Arrays.asList(category);
    return this;
  }
  /** @param category - A code that classifies the general type of observation being made. */
  public HdlcholesterolBuilder withCategory(@NonNull Collection<CodeableConcept> category) {
   ...
   */
  public HdlcholesterolBuilder withValue(@NonNull Quantity value) {
   ...
   *     the target site).
   */
  public HdlcholesterolBuilder withBodySite(@NonNull CodeableConcept bodySite) {
    this.bodySite = Optional.of(bodySite);
    return this;
  }
  /** @param specimen - The specimen that was used when this observation was made. */
  public HdlcholesterolBuilder withSpecimen(@NonNull Reference specimen) {
   ...
   */
  public HdlcholesterolBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public HdlcholesterolBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public HdlcholesterolBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public HdlcholesterolBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public HdlcholesterolBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public HdlcholesterolBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public HdlcholesterolBuilder withPerformer(@NonNull Collection<Reference> performer) {
    this.performer = Collections.unmodifiableCollection(performer);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public HdlcholesterolBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public HdlcholesterolBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public <T> HdlcholesterolBuilder withEffective(@NonNull T effective) {
    var guessedSuffix =
        autoSuffix(effective.getClass().getSimpleName(), Hdlcholesterol$.MODULE$.effective());
   ...
   */
  public <T> HdlcholesterolBuilder withEffective(String suffix, @NonNull T effective) {
    guard(effective.getClass().getSimpleName(), suffix, Hdlcholesterol$.MODULE$.effective());
    this.effective =
        Optional.of(
            (Choice)
                Choice$.MODULE$.fromSuffix(suffix, effective, Hdlcholesterol$.MODULE$.effective()));
    return this;
  }
  /**
   ...
   *     profiles etc.
   */
  public HdlcholesterolBuilder withImplicitRules(@NonNull String implicitRules) {
    this.implicitRules = Optional.of(implicitRules);
    return this;
  }
  /** @param interpretation - + | ++ | +++ | - | -- | ---. */
  public HdlcholesterolBuilder withInterpretation(@NonNull CodeableConcept interpretation) {
   ...
   */
  public HdlcholesterolBuilder withDataAbsentReason(@NonNull CodeableConcept dataAbsentReason) {
   ...
   */
  public HdlcholesterolBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public HdlcholesterolBuilder withModifierExtension(
   ...
   */
  public HdlcholesterolBuilder withComponent(@NonNull Observation.Component... component) {
   ...
   *     measurement and multiple component observations for genetics observations.
   */
  public HdlcholesterolBuilder withComponent(@NonNull Collection<Observation.Component> component) {
