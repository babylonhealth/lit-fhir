...
public class _11179_objectClassPropertyBuilder {
   ...
   */
  public _11179_objectClassPropertyBuilder(String url, Coding value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public _11179_objectClassPropertyBuilder withId(@NonNull String id) {
