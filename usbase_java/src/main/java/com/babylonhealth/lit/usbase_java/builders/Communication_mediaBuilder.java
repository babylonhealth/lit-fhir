...
public class Communication_mediaBuilder {
   ...
   */
  public Communication_mediaBuilder(String url, Attachment value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Communication_mediaBuilder withId(@NonNull String id) {
