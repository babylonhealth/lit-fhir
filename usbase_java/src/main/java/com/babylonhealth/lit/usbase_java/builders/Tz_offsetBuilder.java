...
public interface Tz_offsetBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Tz_offsetBuilder {
     ...
     */
    public Tz_offsetBuilder.Impl withId(@NonNull String id) {
