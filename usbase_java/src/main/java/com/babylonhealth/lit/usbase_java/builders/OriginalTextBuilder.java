...
public interface OriginalTextBuilder extends ExtensionBuilder {
  ...
  public class Impl implements OriginalTextBuilder {
     ...
     */
    public OriginalTextBuilder.Impl withId(@NonNull String id) {
