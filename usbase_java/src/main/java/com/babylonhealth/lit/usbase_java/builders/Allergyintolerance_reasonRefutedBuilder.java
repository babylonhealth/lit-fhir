...
public class Allergyintolerance_reasonRefutedBuilder {
   ...
   */
  public Allergyintolerance_reasonRefutedBuilder(String url, CodeableConcept value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Allergyintolerance_reasonRefutedBuilder withId(@NonNull String id) {
