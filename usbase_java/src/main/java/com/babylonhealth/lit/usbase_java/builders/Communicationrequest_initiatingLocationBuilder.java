...
public interface Communicationrequest_initiatingLocationBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Communicationrequest_initiatingLocationBuilder {
     ...
     */
    public Communicationrequest_initiatingLocationBuilder.Impl withId(@NonNull String id) {
