...
public class MarketingStatusBuilder {
   ...
   *     shall be specified using the ISO 8601 date format NOTE “Placed on the market” refers to the
   *     release of the Medicinal Product into the distribution chain.
   */
  public MarketingStatusBuilder(CodeableConcept status, CodeableConcept country, Period dateRange) {
    this.status = status;
   ...
   */
  public MarketingStatusBuilder withId(@NonNull String id) {
   ...
   */
  public MarketingStatusBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public MarketingStatusBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     country and/or jurisdiction shall be provided A complete date consisting of day, month and
   *     year shall be specified using the ISO 8601 date format NOTE “Placed on the market” refers
   *     to the release of the Medicinal Product into the distribution chain.
   */
  public MarketingStatusBuilder withRestoreDate(@NonNull FHIRDateTime restoreDate) {
    this.restoreDate = Optional.of(restoreDate);
    return this;
  }
  /**
   * @param jurisdiction - Where a Medicines Regulatory Agency has granted a marketing authorisation
   *     for which specific provisions within a jurisdiction apply, the jurisdiction can be
   *     specified using an appropriate controlled terminology The controlled term and the
   *     controlled term identifier shall be specified.
   */
  public MarketingStatusBuilder withJurisdiction(@NonNull CodeableConcept jurisdiction) {
   ...
   */
  public MarketingStatusBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public MarketingStatusBuilder withModifierExtension(
