...
public interface Hla_genotyping_results_glstringBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Hla_genotyping_results_glstringBuilder {
     ...
     */
    public Hla_genotyping_results_glstringBuilder.Impl withId(@NonNull String id) {
