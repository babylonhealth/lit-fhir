...
public class Elementdefinition_translatableBuilder {
   ...
   */
  public Elementdefinition_translatableBuilder(String url, Boolean value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Elementdefinition_translatableBuilder withId(@NonNull String id) {
