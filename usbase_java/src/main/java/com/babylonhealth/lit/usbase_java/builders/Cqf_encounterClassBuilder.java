...
public interface Cqf_encounterClassBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Cqf_encounterClassBuilder {
     ...
     */
    public Cqf_encounterClassBuilder.Impl withId(@NonNull String id) {
