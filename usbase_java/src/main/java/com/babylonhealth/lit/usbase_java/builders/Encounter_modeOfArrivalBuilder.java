...
public class Encounter_modeOfArrivalBuilder {
   ...
   */
  public Encounter_modeOfArrivalBuilder(String url, Coding value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Encounter_modeOfArrivalBuilder withId(@NonNull String id) {
