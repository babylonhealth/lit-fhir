...
public interface Codesystem_warningBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Codesystem_warningBuilder {
     ...
     */
    public Codesystem_warningBuilder.Impl withId(@NonNull String id) {
