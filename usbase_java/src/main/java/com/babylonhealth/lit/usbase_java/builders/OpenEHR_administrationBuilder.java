...
public interface OpenEHR_administrationBuilder extends ExtensionBuilder {
  ...
  public class Impl implements OpenEHR_administrationBuilder {
     ...
     */
    public OpenEHR_administrationBuilder.Impl withId(@NonNull String id) {
