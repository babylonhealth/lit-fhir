...
public interface Oauth_urisBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Oauth_urisBuilder {
    private Optional<String> id = Optional.empty();
    private Collection<Extension> extension;

    /**
     * Required fields for {@link Oauth_uris}
     *
     ...
     */
    public Oauth_urisBuilder.Impl withId(@NonNull String id) {
