...
public interface GroupdefinitionBuilder extends GroupBuilder {
  ...
  public class Impl implements GroupdefinitionBuilder {
     ...
     */
    public GroupdefinitionBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public GroupdefinitionBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     */
    public GroupdefinitionBuilder.Impl withText(@NonNull Narrative text) {
    ...
    public GroupdefinitionBuilder.Impl withName(@NonNull String name) {
     ...
     */
    public GroupdefinitionBuilder.Impl withActive(@NonNull Boolean active) {
      this.active = Optional.of(active);
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public GroupdefinitionBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
      this.language = Optional.of(language);
      return this;
    }
    /** @param quantity - A count of the number of resource instances that are part of the group. */
    public GroupdefinitionBuilder.Impl withQuantity(@NonNull Integer quantity) {
     ...
     */
    public GroupdefinitionBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public GroupdefinitionBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
     ...
     */
    public GroupdefinitionBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public GroupdefinitionBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
     ...
     *     profiles etc.
     */
    public GroupdefinitionBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
