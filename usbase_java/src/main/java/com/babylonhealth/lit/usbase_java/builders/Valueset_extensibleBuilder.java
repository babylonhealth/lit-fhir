...
public class Valueset_extensibleBuilder {
   ...
   */
  public Valueset_extensibleBuilder(String url, Boolean value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Valueset_extensibleBuilder withId(@NonNull String id) {
