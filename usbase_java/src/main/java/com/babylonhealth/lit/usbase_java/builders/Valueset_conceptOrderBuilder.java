...
public class Valueset_conceptOrderBuilder {
   ...
   */
  public Valueset_conceptOrderBuilder(String url, Integer value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Valueset_conceptOrderBuilder withId(@NonNull String id) {
