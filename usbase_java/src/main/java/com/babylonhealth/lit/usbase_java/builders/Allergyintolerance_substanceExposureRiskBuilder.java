...
public interface Allergyintolerance_substanceExposureRiskBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Allergyintolerance_substanceExposureRiskBuilder {
     ...
     */
    public Allergyintolerance_substanceExposureRiskBuilder.Impl withId(@NonNull String id) {
