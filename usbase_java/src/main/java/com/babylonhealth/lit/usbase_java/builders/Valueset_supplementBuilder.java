...
public interface Valueset_supplementBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Valueset_supplementBuilder {
     ...
     */
    public Valueset_supplementBuilder.Impl withId(@NonNull String id) {
