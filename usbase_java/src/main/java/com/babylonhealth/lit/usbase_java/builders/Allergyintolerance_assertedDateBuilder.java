...
public class Allergyintolerance_assertedDateBuilder {
   ...
   */
  public Allergyintolerance_assertedDateBuilder(String url, FHIRDateTime value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Allergyintolerance_assertedDateBuilder withId(@NonNull String id) {
