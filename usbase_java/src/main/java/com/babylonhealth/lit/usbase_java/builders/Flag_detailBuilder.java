...
public interface Flag_detailBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Flag_detailBuilder {
     ...
     */
    public Flag_detailBuilder.Impl withId(@NonNull String id) {
