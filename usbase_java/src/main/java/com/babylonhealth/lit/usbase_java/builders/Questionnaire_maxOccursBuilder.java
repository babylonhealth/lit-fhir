...
public interface Questionnaire_maxOccursBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Questionnaire_maxOccursBuilder {
     ...
     */
    public Questionnaire_maxOccursBuilder.Impl withId(@NonNull String id) {
