...
public class Questionnaireresponse_signatureBuilder {
   ...
   */
  public Questionnaireresponse_signatureBuilder(String url, Signature value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Questionnaireresponse_signatureBuilder withId(@NonNull String id) {
