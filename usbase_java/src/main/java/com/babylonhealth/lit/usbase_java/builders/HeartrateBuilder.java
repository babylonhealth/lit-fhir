...
public class HeartrateBuilder {
    ...
    this.effective =
        (Choice)
            Choice$.MODULE$.fromSuffix(
                autoSuffix(effective.getClass().getSimpleName(), Heartrate$.MODULE$.effective()),
                effective,
                Heartrate$.MODULE$.effective());
    this.code = code;
  }
   ...
   */
  public HeartrateBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public HeartrateBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public HeartrateBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public HeartrateBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public HeartrateBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   */
  public HeartrateBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     patient of record and the mother is the focus.
   */
  public HeartrateBuilder withFocus(@NonNull Collection<Reference> focus) {
   ...
   */
  public HeartrateBuilder withPartOf(@NonNull Reference... partOf) {
   ...
   *     example, an observation as part of a procedure.
   */
  public HeartrateBuilder withPartOf(@NonNull Collection<Reference> partOf) {
   ...
   */
  public HeartrateBuilder withIssued(@NonNull ZonedDateTime issued) {
    this.issued = Optional.of(issued);
    return this;
  }
  /** @param method - Indicates the mechanism used to perform the observation. */
  public HeartrateBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param device - The device used to generate the observation data. */
  public HeartrateBuilder withDevice(@NonNull Reference device) {
   ...
   */
  public HeartrateBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     before it is dispensed.
   */
  public HeartrateBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public HeartrateBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public HeartrateBuilder withValue(@NonNull Quantity value) {
   ...
   *     the target site).
   */
  public HeartrateBuilder withBodySite(@NonNull CodeableConcept bodySite) {
    this.bodySite = Optional.of(bodySite);
    return this;
  }
  /** @param specimen - The specimen that was used when this observation was made. */
  public HeartrateBuilder withSpecimen(@NonNull Reference specimen) {
   ...
   */
  public HeartrateBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public HeartrateBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public HeartrateBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public HeartrateBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public HeartrateBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public HeartrateBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public HeartrateBuilder withPerformer(@NonNull Collection<Reference> performer) {
    this.performer = Collections.unmodifiableCollection(performer);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public HeartrateBuilder withHasMember(@NonNull Reference... hasMember) {
    this.hasMember = Arrays.asList(hasMember);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public HeartrateBuilder withHasMember(@NonNull Collection<Reference> hasMember) {
  ...
  public HeartrateBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public HeartrateBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public HeartrateBuilder withDerivedFrom(@NonNull Reference... derivedFrom) {
   ...
   *     based on an ultrasound image.
   */
  public HeartrateBuilder withDerivedFrom(@NonNull Collection<Reference> derivedFrom) {
   ...
   *     profiles etc.
   */
  public HeartrateBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     low, normal.
   */
  public HeartrateBuilder withInterpretation(@NonNull CodeableConcept... interpretation) {
   ...
   *     low, normal.
   */
  public HeartrateBuilder withInterpretation(@NonNull Collection<CodeableConcept> interpretation) {
   ...
   */
  public HeartrateBuilder withDataAbsentReason(@NonNull CodeableConcept dataAbsentReason) {
   ...
   */
  public HeartrateBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public HeartrateBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param component - Used when reporting systolic and diastolic blood pressure. */
  public HeartrateBuilder withComponent(@NonNull Observation.Component... component) {
    this.component = Arrays.asList(component);
    return this;
  }
  /** @param component - Used when reporting systolic and diastolic blood pressure. */
  public HeartrateBuilder withComponent(@NonNull Collection<Observation.Component> component) {
   ...
   */
  public HeartrateBuilder withReferenceRange(
