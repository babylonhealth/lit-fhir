...
public interface Patient_cadavericDonorBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Patient_cadavericDonorBuilder {
     ...
     */
    public Patient_cadavericDonorBuilder.Impl withId(@NonNull String id) {
