...
public interface HeadcircumBuilder extends VitalsignsBuilder {
  public Headcircum build();
  ...
  public class Impl implements HeadcircumBuilder {
    private Optional<String> id = Optional.empty();
    private Optional<Meta> meta =
        Optional.of(
            MetaBuilder.init()
                .withProfile("http://hl7.org/fhir/StructureDefinition/headcircum")
                .build());
    ...
    /**
     * Required fields for {@link Headcircum}
     *
     ...
     */
    public HeadcircumBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public HeadcircumBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public HeadcircumBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public HeadcircumBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public HeadcircumBuilder.Impl withText(@NonNull NarrativeBuilder text) {
      this.text = Optional.of(text.build());
      return this;
    }
    /** @param note - Comments about the observation or the results. */
    public HeadcircumBuilder.Impl withNote(@NonNull Annotation... note) {
      this.note = Arrays.asList(note);
      return this;
    }
    /** @param note - Comments about the observation or the results. */
    public HeadcircumBuilder.Impl withNote(@NonNull Collection<Annotation> note) {
      this.note = Collections.unmodifiableCollection(note);
      return this;
    }

    public HeadcircumBuilder.Impl withNote(@NonNull AnnotationBuilder... note) {
     ...
     */
    public HeadcircumBuilder.Impl withFocus(@NonNull Reference... focus) {
     ...
     *     is the patient of record and the mother is the focus.
     */
    public HeadcircumBuilder.Impl withFocus(@NonNull Collection<Reference> focus) {
      this.focus = Collections.unmodifiableCollection(focus);
      return this;
    }

    public HeadcircumBuilder.Impl withFocus(@NonNull ReferenceBuilder... focus) {
     ...
     */
    public HeadcircumBuilder.Impl withPartOf(@NonNull Reference... partOf) {
     ...
     *     For example, an observation as part of a procedure.
     */
    public HeadcircumBuilder.Impl withPartOf(@NonNull Collection<Reference> partOf) {
      this.partOf = Collections.unmodifiableCollection(partOf);
      return this;
    }

    public HeadcircumBuilder.Impl withPartOf(@NonNull ReferenceBuilder... partOf) {
     ...
     */
    public HeadcircumBuilder.Impl withIssued(@NonNull ZonedDateTime issued) {
      this.issued = Optional.of(issued);
      return this;
    }
    /** @param method - Indicates the mechanism used to perform the observation. */
    public HeadcircumBuilder.Impl withMethod(@NonNull CodeableConcept method) {
      this.method = Optional.of(method);
      return this;
    }

    public HeadcircumBuilder.Impl withMethod(@NonNull CodeableConceptBuilder method) {
      this.method = Optional.of(method.build());
      return this;
    }
    /** @param device - The device used to generate the observation data. */
    public HeadcircumBuilder.Impl withDevice(@NonNull Reference device) {
      this.device = Optional.of(device);
      return this;
    }

    public HeadcircumBuilder.Impl withDevice(@NonNull ReferenceBuilder device) {
     ...
     */
    public HeadcircumBuilder.Impl withBasedOn(@NonNull Reference... basedOn) {
     ...
     *     performed before it is dispensed.
     */
    public HeadcircumBuilder.Impl withBasedOn(@NonNull Collection<Reference> basedOn) {
      this.basedOn = Collections.unmodifiableCollection(basedOn);
      return this;
    }

    public HeadcircumBuilder.Impl withBasedOn(@NonNull ReferenceBuilder... basedOn) {
      this.basedOn = Arrays.stream(basedOn).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public HeadcircumBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public HeadcircumBuilder.Impl withValue(@NonNull Quantity value) {
      this.value = Optional.of(value);
      return this;
    }

    public HeadcircumBuilder.Impl withValue(@NonNull QuantityBuilder value) {
     ...
     *     (i.e. the target site).
     */
    public HeadcircumBuilder.Impl withBodySite(@NonNull CodeableConcept bodySite) {
      this.bodySite = Optional.of(bodySite);
      return this;
    }

    public HeadcircumBuilder.Impl withBodySite(@NonNull CodeableConceptBuilder bodySite) {
      this.bodySite = Optional.of(bodySite.build());
      return this;
    }
    /** @param specimen - The specimen that was used when this observation was made. */
    public HeadcircumBuilder.Impl withSpecimen(@NonNull Reference specimen) {
      this.specimen = Optional.of(specimen);
      return this;
    }

    public HeadcircumBuilder.Impl withSpecimen(@NonNull ReferenceBuilder specimen) {
     ...
     */
    public HeadcircumBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public HeadcircumBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
      this.contained = Collections.unmodifiableCollection(contained);
      return this;
    }

    public HeadcircumBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public HeadcircumBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public HeadcircumBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public HeadcircumBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
     ...
     */
    public HeadcircumBuilder.Impl withEncounter(@NonNull Reference encounter) {
      this.encounter = Optional.of(encounter);
      return this;
    }

    public HeadcircumBuilder.Impl withEncounter(@NonNull ReferenceBuilder encounter) {
      this.encounter = Optional.of(encounter.build());
      return this;
    }
    /** @param performer - Who was responsible for asserting the observed value as "true". */
    public HeadcircumBuilder.Impl withPerformer(@NonNull Reference... performer) {
      this.performer = Arrays.asList(performer);
      return this;
    }
    /** @param performer - Who was responsible for asserting the observed value as "true". */
    public HeadcircumBuilder.Impl withPerformer(@NonNull Collection<Reference> performer) {
      this.performer = Collections.unmodifiableCollection(performer);
      return this;
    }

    public HeadcircumBuilder.Impl withPerformer(@NonNull ReferenceBuilder... performer) {
    ...
    public HeadcircumBuilder.Impl withHasMember(@NonNull Reference... hasMember) {
      this.hasMember = Arrays.asList(hasMember);
      return this;
    }
    /** @param hasMember - Used when reporting vital signs panel components. */
    public HeadcircumBuilder.Impl withHasMember(@NonNull Collection<Reference> hasMember) {
      this.hasMember = Collections.unmodifiableCollection(hasMember);
      return this;
    }

    public HeadcircumBuilder.Impl withHasMember(@NonNull ReferenceBuilder... hasMember) {
    ...
    public HeadcircumBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
      this.identifier = Arrays.asList(identifier);
      return this;
    }
    /** @param identifier - A unique identifier assigned to this observation. */
    public HeadcircumBuilder.Impl withIdentifier(@NonNull Collection<Identifier> identifier) {
      this.identifier = Collections.unmodifiableCollection(identifier);
      return this;
    }

    public HeadcircumBuilder.Impl withIdentifier(@NonNull IdentifierBuilder... identifier) {
     ...
     */
    public HeadcircumBuilder.Impl withDerivedFrom(@NonNull Reference... derivedFrom) {
     ...
     *     based on an ultrasound image.
     */
    public HeadcircumBuilder.Impl withDerivedFrom(@NonNull Collection<Reference> derivedFrom) {
      this.derivedFrom = Collections.unmodifiableCollection(derivedFrom);
      return this;
    }

    public HeadcircumBuilder.Impl withDerivedFrom(@NonNull ReferenceBuilder... derivedFrom) {
     ...
     *     profiles etc.
     */
    public HeadcircumBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     *     low, normal.
     */
    public HeadcircumBuilder.Impl withInterpretation(@NonNull CodeableConcept... interpretation) {
     ...
     *     low, normal.
     */
    public HeadcircumBuilder.Impl withInterpretation(
     ...
     */
    public HeadcircumBuilder.Impl withDataAbsentReason(@NonNull CodeableConcept dataAbsentReason) {
      this.dataAbsentReason = Optional.of(dataAbsentReason);
      return this;
    }

    public HeadcircumBuilder.Impl withDataAbsentReason(
     ...
     */
    public HeadcircumBuilder.Impl withModifierExtension(@NonNull Extension... modifierExtension) {
     ...
     *     DomainResource (including cannot change the meaning of modifierExtension itself).
     */
    public HeadcircumBuilder.Impl withModifierExtension(
    ...
    public HeadcircumBuilder.Impl withComponent(@NonNull Observation.Component... component) {
      this.component = Arrays.asList(component);
      return this;
    }
    /** @param component - Used when reporting systolic and diastolic blood pressure. */
    public HeadcircumBuilder.Impl withComponent(
     ...
     *     used.
     */
    public HeadcircumBuilder.Impl withReferenceRange(
