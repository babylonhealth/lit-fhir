...
public class HeadcircumBuilder {
   ...
   */
  public HeadcircumBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public HeadcircumBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public HeadcircumBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public HeadcircumBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public HeadcircumBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   */
  public HeadcircumBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     patient of record and the mother is the focus.
   */
  public HeadcircumBuilder withFocus(@NonNull Collection<Reference> focus) {
   ...
   */
  public HeadcircumBuilder withPartOf(@NonNull Reference... partOf) {
   ...
   *     example, an observation as part of a procedure.
   */
  public HeadcircumBuilder withPartOf(@NonNull Collection<Reference> partOf) {
   ...
   */
  public HeadcircumBuilder withIssued(@NonNull ZonedDateTime issued) {
    this.issued = Optional.of(issued);
    return this;
  }
  /** @param method - Indicates the mechanism used to perform the observation. */
  public HeadcircumBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param device - The device used to generate the observation data. */
  public HeadcircumBuilder withDevice(@NonNull Reference device) {
   ...
   */
  public HeadcircumBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     before it is dispensed.
   */
  public HeadcircumBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public HeadcircumBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public HeadcircumBuilder withValue(@NonNull Quantity value) {
   ...
   *     the target site).
   */
  public HeadcircumBuilder withBodySite(@NonNull CodeableConcept bodySite) {
    this.bodySite = Optional.of(bodySite);
    return this;
  }
  /** @param specimen - The specimen that was used when this observation was made. */
  public HeadcircumBuilder withSpecimen(@NonNull Reference specimen) {
   ...
   */
  public HeadcircumBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public HeadcircumBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public HeadcircumBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public HeadcircumBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public HeadcircumBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public HeadcircumBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public HeadcircumBuilder withPerformer(@NonNull Collection<Reference> performer) {
    this.performer = Collections.unmodifiableCollection(performer);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public HeadcircumBuilder withHasMember(@NonNull Reference... hasMember) {
    this.hasMember = Arrays.asList(hasMember);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public HeadcircumBuilder withHasMember(@NonNull Collection<Reference> hasMember) {
  ...
  public HeadcircumBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public HeadcircumBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public HeadcircumBuilder withDerivedFrom(@NonNull Reference... derivedFrom) {
   ...
   *     based on an ultrasound image.
   */
  public HeadcircumBuilder withDerivedFrom(@NonNull Collection<Reference> derivedFrom) {
   ...
   *     profiles etc.
   */
  public HeadcircumBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     low, normal.
   */
  public HeadcircumBuilder withInterpretation(@NonNull CodeableConcept... interpretation) {
   ...
   *     low, normal.
   */
  public HeadcircumBuilder withInterpretation(@NonNull Collection<CodeableConcept> interpretation) {
   ...
   */
  public HeadcircumBuilder withDataAbsentReason(@NonNull CodeableConcept dataAbsentReason) {
   ...
   */
  public HeadcircumBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public HeadcircumBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param component - Used when reporting systolic and diastolic blood pressure. */
  public HeadcircumBuilder withComponent(@NonNull Observation.Component... component) {
    this.component = Arrays.asList(component);
    return this;
  }
  /** @param component - Used when reporting systolic and diastolic blood pressure. */
  public HeadcircumBuilder withComponent(@NonNull Collection<Observation.Component> component) {
   ...
   */
  public HeadcircumBuilder withReferenceRange(
