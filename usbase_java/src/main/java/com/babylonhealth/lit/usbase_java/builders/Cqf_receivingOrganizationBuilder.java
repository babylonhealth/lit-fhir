...
public class Cqf_receivingOrganizationBuilder {
   ...
   */
  public Cqf_receivingOrganizationBuilder(String url, Reference value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Cqf_receivingOrganizationBuilder withId(@NonNull String id) {
