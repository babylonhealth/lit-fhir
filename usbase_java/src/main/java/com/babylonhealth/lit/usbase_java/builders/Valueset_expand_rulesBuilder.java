...
public class Valueset_expand_rulesBuilder {
   ...
   */
  public Valueset_expand_rulesBuilder(String url, EXPANSION_PROCESSING_RULE value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Valueset_expand_rulesBuilder withId(@NonNull String id) {
