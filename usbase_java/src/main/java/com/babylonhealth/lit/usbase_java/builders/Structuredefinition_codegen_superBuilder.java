...
public interface Structuredefinition_codegen_superBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Structuredefinition_codegen_superBuilder {
     ...
     */
    public Structuredefinition_codegen_superBuilder.Impl withId(@NonNull String id) {
