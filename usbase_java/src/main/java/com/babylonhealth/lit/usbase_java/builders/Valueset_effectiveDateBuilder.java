...
public class Valueset_effectiveDateBuilder {
   ...
   */
  public Valueset_effectiveDateBuilder(String url, FHIRDateTime value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Valueset_effectiveDateBuilder withId(@NonNull String id) {
