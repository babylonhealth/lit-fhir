...
public class Patient_interpreterRequiredBuilder {
   ...
   */
  public Patient_interpreterRequiredBuilder(String url, Boolean value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Patient_interpreterRequiredBuilder withId(@NonNull String id) {
