...
public class Structuredefinition_summaryBuilder {
   ...
   */
  public Structuredefinition_summaryBuilder(String url, String value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Structuredefinition_summaryBuilder withId(@NonNull String id) {
