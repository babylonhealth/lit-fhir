...
public interface Elementdefinition_deBuilder extends ElementDefinitionBuilder {
  ...
  public class Impl implements Elementdefinition_deBuilder {
     ...
     */
    public Elementdefinition_deBuilder.Impl withMinValue(@NonNull Choice_0603252906 minValue) {
     ...
     */
    public Elementdefinition_deBuilder.Impl withMaxValue(@NonNull Choice_0603252906 maxValue) {
