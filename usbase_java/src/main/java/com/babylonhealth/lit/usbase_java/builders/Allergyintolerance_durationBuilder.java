...
public class Allergyintolerance_durationBuilder {
   ...
   */
  public Allergyintolerance_durationBuilder(String url, Duration value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Allergyintolerance_durationBuilder withId(@NonNull String id) {
