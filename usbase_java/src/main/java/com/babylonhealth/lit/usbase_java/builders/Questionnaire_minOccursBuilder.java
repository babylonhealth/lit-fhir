...
public class Questionnaire_minOccursBuilder {
   ...
   */
  public Questionnaire_minOccursBuilder(String url, Integer value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Questionnaire_minOccursBuilder withId(@NonNull String id) {
