...
public interface Hla_genotyping_results_methodBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Hla_genotyping_results_methodBuilder {
     ...
     */
    public Hla_genotyping_results_methodBuilder.Impl withId(@NonNull String id) {
