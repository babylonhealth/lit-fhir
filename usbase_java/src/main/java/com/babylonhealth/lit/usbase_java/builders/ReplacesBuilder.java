...
public interface ReplacesBuilder extends ExtensionBuilder {
  ...
  public class Impl implements ReplacesBuilder {
     ...
     */
    public ReplacesBuilder.Impl withId(@NonNull String id) {
