...
public class Resource_approvalDateBuilder {
   ...
   */
  public Resource_approvalDateBuilder(String url, FHIRDate value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Resource_approvalDateBuilder withId(@NonNull String id) {
