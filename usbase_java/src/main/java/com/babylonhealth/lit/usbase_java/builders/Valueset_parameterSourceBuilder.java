...
public class Valueset_parameterSourceBuilder {
   ...
   */
  public Valueset_parameterSourceBuilder(String url, EXPANSION_PARAMETER_SOURCE value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Valueset_parameterSourceBuilder withId(@NonNull String id) {
