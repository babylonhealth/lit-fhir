...
public interface Event_locationBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Event_locationBuilder {
     ...
     */
    public Event_locationBuilder.Impl withId(@NonNull String id) {
