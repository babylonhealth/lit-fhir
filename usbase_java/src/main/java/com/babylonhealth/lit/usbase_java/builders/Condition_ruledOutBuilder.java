...
public interface Condition_ruledOutBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Condition_ruledOutBuilder {
     ...
     */
    public Condition_ruledOutBuilder.Impl withId(@NonNull String id) {
