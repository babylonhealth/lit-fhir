...
public class TriglycerideBuilder {
   ...
   *     pass the value in, wrap with one of the TriglycerideBuilder.effective static methods
   */
  public TriglycerideBuilder withEffective(@NonNull Choice01473702374 effective) {
