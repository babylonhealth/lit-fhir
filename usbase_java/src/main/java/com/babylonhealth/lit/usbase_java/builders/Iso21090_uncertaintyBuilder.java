...
public class Iso21090_uncertaintyBuilder {
   ...
   */
  public Iso21090_uncertaintyBuilder(String url, BigDecimal value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Iso21090_uncertaintyBuilder withId(@NonNull String id) {
