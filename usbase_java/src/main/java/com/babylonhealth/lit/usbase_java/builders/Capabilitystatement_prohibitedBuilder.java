...
public class Capabilitystatement_prohibitedBuilder {
   ...
   */
  public Capabilitystatement_prohibitedBuilder(String url, Boolean value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Capabilitystatement_prohibitedBuilder withId(@NonNull String id) {
