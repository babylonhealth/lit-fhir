...
public class ResprateBuilder {
    ...
    this.effective =
        (Choice)
            Choice$.MODULE$.fromSuffix(
                autoSuffix(effective.getClass().getSimpleName(), Resprate$.MODULE$.effective()),
                effective,
                Resprate$.MODULE$.effective());
    this.code = code;
  }
   ...
   */
  public ResprateBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public ResprateBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public ResprateBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public ResprateBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - Comments about the observation or the results. */
  public ResprateBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   */
  public ResprateBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     patient of record and the mother is the focus.
   */
  public ResprateBuilder withFocus(@NonNull Collection<Reference> focus) {
   ...
   */
  public ResprateBuilder withPartOf(@NonNull Reference... partOf) {
   ...
   *     example, an observation as part of a procedure.
   */
  public ResprateBuilder withPartOf(@NonNull Collection<Reference> partOf) {
   ...
   */
  public ResprateBuilder withIssued(@NonNull ZonedDateTime issued) {
    this.issued = Optional.of(issued);
    return this;
  }
  /** @param method - Indicates the mechanism used to perform the observation. */
  public ResprateBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param device - The device used to generate the observation data. */
  public ResprateBuilder withDevice(@NonNull Reference device) {
   ...
   */
  public ResprateBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     before it is dispensed.
   */
  public ResprateBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
    this.basedOn = Collections.unmodifiableCollection(basedOn);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public ResprateBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public ResprateBuilder withValue(@NonNull Quantity value) {
   ...
   *     the target site).
   */
  public ResprateBuilder withBodySite(@NonNull CodeableConcept bodySite) {
    this.bodySite = Optional.of(bodySite);
    return this;
  }
  /** @param specimen - The specimen that was used when this observation was made. */
  public ResprateBuilder withSpecimen(@NonNull Reference specimen) {
   ...
   */
  public ResprateBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public ResprateBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public ResprateBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ResprateBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public ResprateBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public ResprateBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public ResprateBuilder withPerformer(@NonNull Collection<Reference> performer) {
    this.performer = Collections.unmodifiableCollection(performer);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public ResprateBuilder withHasMember(@NonNull Reference... hasMember) {
    this.hasMember = Arrays.asList(hasMember);
    return this;
  }
  /** @param hasMember - Used when reporting vital signs panel components. */
  public ResprateBuilder withHasMember(@NonNull Collection<Reference> hasMember) {
  ...
  public ResprateBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public ResprateBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public ResprateBuilder withDerivedFrom(@NonNull Reference... derivedFrom) {
   ...
   *     based on an ultrasound image.
   */
  public ResprateBuilder withDerivedFrom(@NonNull Collection<Reference> derivedFrom) {
   ...
   *     profiles etc.
   */
  public ResprateBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   *     low, normal.
   */
  public ResprateBuilder withInterpretation(@NonNull CodeableConcept... interpretation) {
   ...
   *     low, normal.
   */
  public ResprateBuilder withInterpretation(@NonNull Collection<CodeableConcept> interpretation) {
   ...
   */
  public ResprateBuilder withDataAbsentReason(@NonNull CodeableConcept dataAbsentReason) {
   ...
   */
  public ResprateBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public ResprateBuilder withModifierExtension(@NonNull Collection<Extension> modifierExtension) {
    this.modifierExtension = Collections.unmodifiableCollection(modifierExtension);
    return this;
  }
  /** @param component - Used when reporting systolic and diastolic blood pressure. */
  public ResprateBuilder withComponent(@NonNull Observation.Component... component) {
    this.component = Arrays.asList(component);
    return this;
  }
  /** @param component - Used when reporting systolic and diastolic blood pressure. */
  public ResprateBuilder withComponent(@NonNull Collection<Observation.Component> component) {
   ...
   */
  public ResprateBuilder withReferenceRange(@NonNull Observation.ReferenceRange... referenceRange) {
   ...
   *     represent two distinct target populations, two `referenceRange` elements would be used.
   */
  public ResprateBuilder withReferenceRange(
