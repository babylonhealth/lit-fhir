...
public class CholesterolBuilder {
   ...
   *     pass the value in, wrap with one of the CholesterolBuilder.effective static methods
   */
  public CholesterolBuilder withEffective(@NonNull Choice01473702374 effective) {
