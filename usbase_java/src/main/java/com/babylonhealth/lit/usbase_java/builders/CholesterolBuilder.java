...
public class CholesterolBuilder {
   ...
   */
  public CholesterolBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public CholesterolBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public CholesterolBuilder withText(@NonNull Narrative text) {
    this.text = Optional.of(text);
    return this;
  }
  /**
   * @param note - May include statements about significant, unexpected or unreliable. values, or
   *     information about the source of the value where this may be relevant to the interpretation
   *     of the result.
   */
  public CholesterolBuilder withNote(@NonNull Annotation... note) {
   ...
   *     of the result.
   */
  public CholesterolBuilder withNote(@NonNull Collection<Annotation> note) {
   ...
   */
  public CholesterolBuilder withFocus(@NonNull Reference... focus) {
   ...
   *     patient of record and the mother is the focus.
   */
  public CholesterolBuilder withFocus(@NonNull Collection<Reference> focus) {
   ...
   */
  public CholesterolBuilder withPartOf(@NonNull Reference... partOf) {
   ...
   *     example, an observation as part of a procedure.
   */
  public CholesterolBuilder withPartOf(@NonNull Collection<Reference> partOf) {
   ...
   */
  public CholesterolBuilder withIssued(@NonNull ZonedDateTime issued) {
    this.issued = Optional.of(issued);
    return this;
  }
  /** @param method - Indicates the mechanism used to perform the observation. */
  public CholesterolBuilder withMethod(@NonNull CodeableConcept method) {
    this.method = Optional.of(method);
    return this;
  }
  /** @param device - The device used to generate the observation data. */
  public CholesterolBuilder withDevice(@NonNull Reference device) {
   ...
   */
  public CholesterolBuilder withBasedOn(@NonNull Reference... basedOn) {
   ...
   *     before it is dispensed.
   */
  public CholesterolBuilder withBasedOn(@NonNull Collection<Reference> basedOn) {
   ...
   */
  public CholesterolBuilder withSubject(@NonNull Reference subject) {
    this.subject = Optional.of(subject);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public CholesterolBuilder withLanguage(@NonNull LANGUAGES language) {
    this.language = Optional.of(language);
    return this;
  }
  /** @param category - A code that classifies the general type of observation being made. */
  public CholesterolBuilder withCategory(@NonNull CodeableConcept... category) {
    this.category = Arrays.asList(category);
    return this;
  }
  /** @param category - A code that classifies the general type of observation being made. */
  public CholesterolBuilder withCategory(@NonNull Collection<CodeableConcept> category) {
   ...
   */
  public CholesterolBuilder withValue(@NonNull Quantity value) {
   ...
   *     the target site).
   */
  public CholesterolBuilder withBodySite(@NonNull CodeableConcept bodySite) {
    this.bodySite = Optional.of(bodySite);
    return this;
  }
  /** @param specimen - The specimen that was used when this observation was made. */
  public CholesterolBuilder withSpecimen(@NonNull Reference specimen) {
   ...
   */
  public CholesterolBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public CholesterolBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public CholesterolBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public CholesterolBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public CholesterolBuilder withEncounter(@NonNull Reference encounter) {
    this.encounter = Optional.of(encounter);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public CholesterolBuilder withPerformer(@NonNull Reference... performer) {
    this.performer = Arrays.asList(performer);
    return this;
  }
  /** @param performer - Who was responsible for asserting the observed value as "true". */
  public CholesterolBuilder withPerformer(@NonNull Collection<Reference> performer) {
    this.performer = Collections.unmodifiableCollection(performer);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public CholesterolBuilder withIdentifier(@NonNull Identifier... identifier) {
    this.identifier = Arrays.asList(identifier);
    return this;
  }
  /** @param identifier - A unique identifier assigned to this observation. */
  public CholesterolBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public <T> CholesterolBuilder withEffective(@NonNull T effective) {
    var guessedSuffix =
        autoSuffix(effective.getClass().getSimpleName(), Cholesterol$.MODULE$.effective());
   ...
   */
  public <T> CholesterolBuilder withEffective(String suffix, @NonNull T effective) {
    guard(effective.getClass().getSimpleName(), suffix, Cholesterol$.MODULE$.effective());
    this.effective =
        Optional.of(
            (Choice)
                Choice$.MODULE$.fromSuffix(suffix, effective, Cholesterol$.MODULE$.effective()));
    return this;
  }
  /**
   ...
   *     profiles etc.
   */
  public CholesterolBuilder withImplicitRules(@NonNull String implicitRules) {
    this.implicitRules = Optional.of(implicitRules);
    return this;
  }
  /** @param interpretation - + | ++ | +++ | - | -- | ---. */
  public CholesterolBuilder withInterpretation(@NonNull CodeableConcept interpretation) {
   ...
   */
  public CholesterolBuilder withDataAbsentReason(@NonNull CodeableConcept dataAbsentReason) {
   ...
   */
  public CholesterolBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public CholesterolBuilder withModifierExtension(
   ...
   */
  public CholesterolBuilder withComponent(@NonNull Observation.Component... component) {
   ...
   *     measurement and multiple component observations for genetics observations.
   */
  public CholesterolBuilder withComponent(@NonNull Collection<Observation.Component> component) {
