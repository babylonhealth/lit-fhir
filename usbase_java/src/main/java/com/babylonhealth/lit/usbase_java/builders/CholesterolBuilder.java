...
public interface CholesterolBuilder extends ObservationBuilder {
  public Cholesterol build();
  ...
  public class Impl implements CholesterolBuilder {
    private Optional<String> id = Optional.empty();
    private Optional<Meta> meta =
        Optional.of(
            MetaBuilder.init()
                .withProfile("http://hl7.org/fhir/StructureDefinition/cholesterol")
                .build());
    ...
    /**
     * Required fields for {@link Cholesterol}
     *
     * @param code - Cholesterol.
     ...
     */
    public CholesterolBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public CholesterolBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public CholesterolBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public CholesterolBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public CholesterolBuilder.Impl withText(@NonNull NarrativeBuilder text) {
      this.text = Optional.of(text.build());
      return this;
    }
    /**
     * @param note - May include statements about significant, unexpected or unreliable. values, or
     *     information about the source of the value where this may be relevant to the
     *     interpretation of the result.
     */
    public CholesterolBuilder.Impl withNote(@NonNull Annotation... note) {
     ...
     *     interpretation of the result.
     */
    public CholesterolBuilder.Impl withNote(@NonNull Collection<Annotation> note) {
      this.note = Collections.unmodifiableCollection(note);
      return this;
    }

    public CholesterolBuilder.Impl withNote(@NonNull AnnotationBuilder... note) {
     ...
     */
    public CholesterolBuilder.Impl withFocus(@NonNull Reference... focus) {
     ...
     *     is the patient of record and the mother is the focus.
     */
    public CholesterolBuilder.Impl withFocus(@NonNull Collection<Reference> focus) {
      this.focus = Collections.unmodifiableCollection(focus);
      return this;
    }

    public CholesterolBuilder.Impl withFocus(@NonNull ReferenceBuilder... focus) {
     ...
     */
    public CholesterolBuilder.Impl withPartOf(@NonNull Reference... partOf) {
     ...
     *     For example, an observation as part of a procedure.
     */
    public CholesterolBuilder.Impl withPartOf(@NonNull Collection<Reference> partOf) {
      this.partOf = Collections.unmodifiableCollection(partOf);
      return this;
    }

    public CholesterolBuilder.Impl withPartOf(@NonNull ReferenceBuilder... partOf) {
     ...
     */
    public CholesterolBuilder.Impl withIssued(@NonNull ZonedDateTime issued) {
      this.issued = Optional.of(issued);
      return this;
    }
    /** @param method - Indicates the mechanism used to perform the observation. */
    public CholesterolBuilder.Impl withMethod(@NonNull CodeableConcept method) {
      this.method = Optional.of(method);
      return this;
    }

    public CholesterolBuilder.Impl withMethod(@NonNull CodeableConceptBuilder method) {
      this.method = Optional.of(method.build());
      return this;
    }
    /** @param device - The device used to generate the observation data. */
    public CholesterolBuilder.Impl withDevice(@NonNull Reference device) {
      this.device = Optional.of(device);
      return this;
    }

    public CholesterolBuilder.Impl withDevice(@NonNull ReferenceBuilder device) {
     ...
     */
    public CholesterolBuilder.Impl withBasedOn(@NonNull Reference... basedOn) {
     ...
     *     performed before it is dispensed.
     */
    public CholesterolBuilder.Impl withBasedOn(@NonNull Collection<Reference> basedOn) {
      this.basedOn = Collections.unmodifiableCollection(basedOn);
      return this;
    }

    public CholesterolBuilder.Impl withBasedOn(@NonNull ReferenceBuilder... basedOn) {
     ...
     *     observation.
     */
    public CholesterolBuilder.Impl withSubject(@NonNull Reference subject) {
      this.subject = Optional.of(subject);
      return this;
    }

    public CholesterolBuilder.Impl withSubject(@NonNull ReferenceBuilder subject) {
      this.subject = Optional.of(subject.build());
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public CholesterolBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
      this.language = Optional.of(language);
      return this;
    }
    /** @param category - A code that classifies the general type of observation being made. */
    public CholesterolBuilder.Impl withCategory(@NonNull CodeableConcept... category) {
      this.category = Arrays.asList(category);
      return this;
    }
    /** @param category - A code that classifies the general type of observation being made. */
    public CholesterolBuilder.Impl withCategory(@NonNull Collection<CodeableConcept> category) {
      this.category = Collections.unmodifiableCollection(category);
      return this;
    }

    public CholesterolBuilder.Impl withCategory(@NonNull CodeableConceptBuilder... category) {
     ...
     */
    public CholesterolBuilder.Impl withValue(@NonNull Quantity value) {
      this.value = Optional.of(value);
      return this;
    }

    public CholesterolBuilder.Impl withValue(@NonNull QuantityBuilder value) {
     ...
     *     (i.e. the target site).
     */
    public CholesterolBuilder.Impl withBodySite(@NonNull CodeableConcept bodySite) {
      this.bodySite = Optional.of(bodySite);
      return this;
    }

    public CholesterolBuilder.Impl withBodySite(@NonNull CodeableConceptBuilder bodySite) {
      this.bodySite = Optional.of(bodySite.build());
      return this;
    }
    /** @param specimen - The specimen that was used when this observation was made. */
    public CholesterolBuilder.Impl withSpecimen(@NonNull Reference specimen) {
      this.specimen = Optional.of(specimen);
      return this;
    }

    public CholesterolBuilder.Impl withSpecimen(@NonNull ReferenceBuilder specimen) {
     ...
     */
    public CholesterolBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public CholesterolBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
      this.contained = Collections.unmodifiableCollection(contained);
      return this;
    }

    public CholesterolBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public CholesterolBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public CholesterolBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public CholesterolBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
     ...
     */
    public CholesterolBuilder.Impl withEncounter(@NonNull Reference encounter) {
      this.encounter = Optional.of(encounter);
      return this;
    }

    public CholesterolBuilder.Impl withEncounter(@NonNull ReferenceBuilder encounter) {
      this.encounter = Optional.of(encounter.build());
      return this;
    }
    /** @param performer - Who was responsible for asserting the observed value as "true". */
    public CholesterolBuilder.Impl withPerformer(@NonNull Reference... performer) {
      this.performer = Arrays.asList(performer);
      return this;
    }
    /** @param performer - Who was responsible for asserting the observed value as "true". */
    public CholesterolBuilder.Impl withPerformer(@NonNull Collection<Reference> performer) {
      this.performer = Collections.unmodifiableCollection(performer);
      return this;
    }

    public CholesterolBuilder.Impl withPerformer(@NonNull ReferenceBuilder... performer) {
    ...
    public CholesterolBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
      this.identifier = Arrays.asList(identifier);
      return this;
    }
    /** @param identifier - A unique identifier assigned to this observation. */
    public CholesterolBuilder.Impl withIdentifier(@NonNull Collection<Identifier> identifier) {
      this.identifier = Collections.unmodifiableCollection(identifier);
      return this;
    }

    public CholesterolBuilder.Impl withIdentifier(@NonNull IdentifierBuilder... identifier) {
     ...
     *     ZonedDateTime. To pass the value in, wrap with one of the CholesterolBuilder.effective
     *     static methods
     */
    public CholesterolBuilder.Impl withEffective(@NonNull ChoiceObservation_Effective effective) {
     ...
     *     profiles etc.
     */
    public CholesterolBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
      this.implicitRules = Optional.of(implicitRules);
      return this;
    }
    /** @param interpretation - + | ++ | +++ | - | -- | ---. */
    public CholesterolBuilder.Impl withInterpretation(@NonNull CodeableConcept interpretation) {
      this.interpretation = Optional.of(interpretation);
      return this;
    }

    public CholesterolBuilder.Impl withInterpretation(
     ...
     */
    public CholesterolBuilder.Impl withDataAbsentReason(@NonNull CodeableConcept dataAbsentReason) {
      this.dataAbsentReason = Optional.of(dataAbsentReason);
      return this;
    }

    public CholesterolBuilder.Impl withDataAbsentReason(
     ...
     */
    public CholesterolBuilder.Impl withModifierExtension(@NonNull Extension... modifierExtension) {
     ...
     *     DomainResource (including cannot change the meaning of modifierExtension itself).
     */
    public CholesterolBuilder.Impl withModifierExtension(
     ...
     */
    public CholesterolBuilder.Impl withComponent(@NonNull Observation.Component... component) {
     ...
     *     measurement and multiple component observations for genetics observations.
     */
    public CholesterolBuilder.Impl withComponent(
    ...
    public CholesterolBuilder withoutMeta() {
