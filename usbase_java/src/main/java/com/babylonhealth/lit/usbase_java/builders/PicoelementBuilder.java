...
public class PicoelementBuilder {
   ...
   */
  public PicoelementBuilder withId(@NonNull String id) {
   ...
   */
  public PicoelementBuilder withUrl(@NonNull String url) {
   ...
   *     to the resource.
   */
  public PicoelementBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public PicoelementBuilder withText(@NonNull Narrative text) {
   ...
   *     generation.
   */
  public PicoelementBuilder withName(@NonNull String name) {
   ...
   *     variable changes.
   */
  public PicoelementBuilder withDate(@NonNull FHIRDateTime date) {
    this.date = Optional.of(date);
    return this;
  }
  /** @param note - A human-readable string to clarify or explain concepts about the resource. */
  public PicoelementBuilder withNote(@NonNull Annotation... note) {
    this.note = Arrays.asList(note);
    return this;
  }
  /** @param note - A human-readable string to clarify or explain concepts about the resource. */
  public PicoelementBuilder withNote(@NonNull Collection<Annotation> note) {
    this.note = Collections.unmodifiableCollection(note);
    return this;
  }
  /** @param _type - The type of evidence element, a population, an exposure, or an outcome. */
  public PicoelementBuilder withType(@NonNull VARIABLE_TYPE _type) {
    this._type = Optional.of(_type);
    return this;
  }
  /** @param title - A short, descriptive, user-friendly title for the evidence variable. */
  public PicoelementBuilder withTitle(@NonNull String title) {
   ...
   */
  public PicoelementBuilder withTopic(@NonNull CodeableConcept... topic) {
   ...
   *     for filtering and searching.
   */
  public PicoelementBuilder withTopic(@NonNull Collection<CodeableConcept> topic) {
   ...
   */
  public PicoelementBuilder withAuthor(@NonNull ContactDetail... author) {
   ...
   *     maintenance of the content.
   */
  public PicoelementBuilder withAuthor(@NonNull Collection<ContactDetail> author) {
   ...
   *     the content.
   */
  public PicoelementBuilder withEditor(@NonNull ContactDetail... editor) {
   ...
   *     the content.
   */
  public PicoelementBuilder withEditor(@NonNull Collection<ContactDetail> editor) {
   ...
   */
  public PicoelementBuilder withVersion(@NonNull String version) {
   ...
   *     publisher.
   */
  public PicoelementBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public PicoelementBuilder withContact(@NonNull Collection<ContactDetail> contact) {
    this.contact = Collections.unmodifiableCollection(contact);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public PicoelementBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public PicoelementBuilder withSubtitle(@NonNull String subtitle) {
   ...
   *     of the content.
   */
  public PicoelementBuilder withReviewer(@NonNull ContactDetail... reviewer) {
   ...
   *     of the content.
   */
  public PicoelementBuilder withReviewer(@NonNull Collection<ContactDetail> reviewer) {
   ...
   */
  public PicoelementBuilder withEndorser(@NonNull ContactDetail... endorser) {
   ...
   *     content for use in some setting.
   */
  public PicoelementBuilder withEndorser(@NonNull Collection<ContactDetail> endorser) {
   ...
   */
  public PicoelementBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public PicoelementBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public PicoelementBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public PicoelementBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   *     variable.
   */
  public PicoelementBuilder withPublisher(@NonNull String publisher) {
   ...
   *     evidence variable.
   */
  public PicoelementBuilder withCopyright(@NonNull String copyright) {
   ...
   *     instance.
   */
  public PicoelementBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     instance.
   */
  public PicoelementBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   */
  public PicoelementBuilder withShortTitle(@NonNull String shortTitle) {
   ...
   */
  public PicoelementBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate evidence variable instances.
   */
  public PicoelementBuilder withUseContext(@NonNull Collection<UsageContext> useContext) {
   ...
   */
  public PicoelementBuilder withDescription(@NonNull String description) {
   ...
   *     to be used.
   */
  public PicoelementBuilder withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
   ...
   *     to be used.
   */
  public PicoelementBuilder withJurisdiction(@NonNull Collection<CodeableConcept> jurisdiction) {
   ...
   */
  public PicoelementBuilder withApprovalDate(@NonNull FHIRDate approvalDate) {
   ...
   *     profiles etc.
   */
  public PicoelementBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public PicoelementBuilder withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
   ...
   */
  public PicoelementBuilder withEffectivePeriod(@NonNull Period effectivePeriod) {
   ...
   */
  public PicoelementBuilder withRelatedArtifact(@NonNull RelatedArtifact... relatedArtifact) {
   ...
   *     bibliographic references.
   */
  public PicoelementBuilder withRelatedArtifact(
   ...
   */
  public PicoelementBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public PicoelementBuilder withModifierExtension(
