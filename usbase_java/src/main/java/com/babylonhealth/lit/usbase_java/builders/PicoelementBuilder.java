...
public interface PicoelementBuilder extends EvidenceVariableBuilder {
  public Picoelement build();
  ...
  public class Impl implements PicoelementBuilder {
    ...
    private Optional<Meta> meta =
        Optional.of(
            MetaBuilder.init()
                .withProfile("http://hl7.org/fhir/StructureDefinition/picoelement")
                .build());
    ...
    /**
     * Required fields for {@link Picoelement}
     *
     ...
     */
    public PicoelementBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public PicoelementBuilder.Impl withUrl(@NonNull String url) {
     ...
     */
    public PicoelementBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public PicoelementBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public PicoelementBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public PicoelementBuilder.Impl withText(@NonNull NarrativeBuilder text) {
     ...
     *     generation.
     */
    public PicoelementBuilder.Impl withName(@NonNull String name) {
     ...
     *     variable changes.
     */
    public PicoelementBuilder.Impl withDate(@NonNull FHIRDateTime date) {
      this.date = Optional.of(date);
      return this;
    }
    /** @param note - A human-readable string to clarify or explain concepts about the resource. */
    public PicoelementBuilder.Impl withNote(@NonNull Annotation... note) {
      this.note = Arrays.asList(note);
      return this;
    }
    /** @param note - A human-readable string to clarify or explain concepts about the resource. */
    public PicoelementBuilder.Impl withNote(@NonNull Collection<Annotation> note) {
      this.note = Collections.unmodifiableCollection(note);
      return this;
    }

    public PicoelementBuilder.Impl withNote(@NonNull AnnotationBuilder... note) {
      this.note = Arrays.stream(note).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param _type - The type of evidence element, a population, an exposure, or an outcome. */
    public PicoelementBuilder.Impl withType(@NonNull VARIABLE_TYPE _type) {
      this._type = Optional.of(_type);
      return this;
    }
    /** @param title - A short, descriptive, user-friendly title for the evidence variable. */
    public PicoelementBuilder.Impl withTitle(@NonNull String title) {
     ...
     */
    public PicoelementBuilder.Impl withTopic(@NonNull CodeableConcept... topic) {
     ...
     *     useful for filtering and searching.
     */
    public PicoelementBuilder.Impl withTopic(@NonNull Collection<CodeableConcept> topic) {
      this.topic = Collections.unmodifiableCollection(topic);
      return this;
    }

    public PicoelementBuilder.Impl withTopic(@NonNull CodeableConceptBuilder... topic) {
     ...
     */
    public PicoelementBuilder.Impl withAuthor(@NonNull ContactDetail... author) {
     ...
     *     maintenance of the content.
     */
    public PicoelementBuilder.Impl withAuthor(@NonNull Collection<ContactDetail> author) {
      this.author = Collections.unmodifiableCollection(author);
      return this;
    }

    public PicoelementBuilder.Impl withAuthor(@NonNull ContactDetailBuilder... author) {
     ...
     *     the content.
     */
    public PicoelementBuilder.Impl withEditor(@NonNull ContactDetail... editor) {
     ...
     *     the content.
     */
    public PicoelementBuilder.Impl withEditor(@NonNull Collection<ContactDetail> editor) {
      this.editor = Collections.unmodifiableCollection(editor);
      return this;
    }

    public PicoelementBuilder.Impl withEditor(@NonNull ContactDetailBuilder... editor) {
     ...
     */
    public PicoelementBuilder.Impl withVersion(@NonNull String version) {
     ...
     *     publisher.
     */
    public PicoelementBuilder.Impl withContact(@NonNull ContactDetail... contact) {
     ...
     *     publisher.
     */
    public PicoelementBuilder.Impl withContact(@NonNull Collection<ContactDetail> contact) {
      this.contact = Collections.unmodifiableCollection(contact);
      return this;
    }

    public PicoelementBuilder.Impl withContact(@NonNull ContactDetailBuilder... contact) {
      this.contact = Arrays.stream(contact).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public PicoelementBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public PicoelementBuilder.Impl withSubtitle(@NonNull String subtitle) {
     ...
     */
    public PicoelementBuilder.Impl withReviewer(@NonNull ContactDetail... reviewer) {
     ...
     *     aspect of the content.
     */
    public PicoelementBuilder.Impl withReviewer(@NonNull Collection<ContactDetail> reviewer) {
      this.reviewer = Collections.unmodifiableCollection(reviewer);
      return this;
    }

    public PicoelementBuilder.Impl withReviewer(@NonNull ContactDetailBuilder... reviewer) {
     ...
     */
    public PicoelementBuilder.Impl withEndorser(@NonNull ContactDetail... endorser) {
     ...
     *     content for use in some setting.
     */
    public PicoelementBuilder.Impl withEndorser(@NonNull Collection<ContactDetail> endorser) {
      this.endorser = Collections.unmodifiableCollection(endorser);
      return this;
    }

    public PicoelementBuilder.Impl withEndorser(@NonNull ContactDetailBuilder... endorser) {
     ...
     */
    public PicoelementBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public PicoelementBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
      this.contained = Collections.unmodifiableCollection(contained);
      return this;
    }

    public PicoelementBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public PicoelementBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public PicoelementBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public PicoelementBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
     ...
     *     variable.
     */
    public PicoelementBuilder.Impl withPublisher(@NonNull String publisher) {
     ...
     */
    public PicoelementBuilder.Impl withCopyright(@NonNull String copyright) {
     ...
     *     instance.
     */
    public PicoelementBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     *     instance.
     */
    public PicoelementBuilder.Impl withIdentifier(@NonNull Collection<Identifier> identifier) {
      this.identifier = Collections.unmodifiableCollection(identifier);
      return this;
    }

    public PicoelementBuilder.Impl withIdentifier(@NonNull IdentifierBuilder... identifier) {
     ...
     */
    public PicoelementBuilder.Impl withShortTitle(@NonNull String shortTitle) {
     ...
     */
    public PicoelementBuilder.Impl withUseContext(@NonNull UsageContext... useContext) {
     ...
     *     assist with indexing and searching for appropriate evidence variable instances.
     */
    public PicoelementBuilder.Impl withUseContext(@NonNull Collection<UsageContext> useContext) {
      this.useContext = Collections.unmodifiableCollection(useContext);
      return this;
    }

    public PicoelementBuilder.Impl withUseContext(@NonNull UsageContextBuilder... useContext) {
     ...
     */
    public PicoelementBuilder.Impl withDescription(@NonNull String description) {
     ...
     *     to be used.
     */
    public PicoelementBuilder.Impl withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
     ...
     *     to be used.
     */
    public PicoelementBuilder.Impl withJurisdiction(
     ...
     */
    public PicoelementBuilder.Impl withApprovalDate(@NonNull FHIRDate approvalDate) {
     ...
     *     profiles etc.
     */
    public PicoelementBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public PicoelementBuilder.Impl withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
     ...
     */
    public PicoelementBuilder.Impl withEffectivePeriod(@NonNull Period effectivePeriod) {
      this.effectivePeriod = Optional.of(effectivePeriod);
      return this;
    }

    public PicoelementBuilder.Impl withEffectivePeriod(@NonNull PeriodBuilder effectivePeriod) {
     ...
     */
    public PicoelementBuilder.Impl withRelatedArtifact(
     ...
     */
    public PicoelementBuilder.Impl withModifierExtension(@NonNull Extension... modifierExtension) {
     ...
     *     DomainResource (including cannot change the meaning of modifierExtension itself).
     */
    public PicoelementBuilder.Impl withModifierExtension(
