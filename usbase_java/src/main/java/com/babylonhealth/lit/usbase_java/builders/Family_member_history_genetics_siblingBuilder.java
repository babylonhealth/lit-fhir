...
public interface Family_member_history_genetics_siblingBuilder extends ExtensionBuilder {
  public Family_member_history_genetics_sibling build();
  ...
  public class Impl implements Family_member_history_genetics_siblingBuilder {
    private Optional<String> id = Optional.empty();
    private Collection<Extension> extension;

    /**
     * Required fields for {@link Family_member_history_genetics_sibling}
     *
     ...
     */
    public Family_member_history_genetics_siblingBuilder.Impl withId(@NonNull String id) {
      this.id = Optional.of(id);
      return this;
    }

    public Family_member_history_genetics_sibling build() {
      return new Family_member_history_genetics_sibling(
