...
public interface Composition_clinicaldocument_otherConfidentialityBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Composition_clinicaldocument_otherConfidentialityBuilder {
     ...
     */
    public Composition_clinicaldocument_otherConfidentialityBuilder.Impl withId(
        @NonNull String id) {
