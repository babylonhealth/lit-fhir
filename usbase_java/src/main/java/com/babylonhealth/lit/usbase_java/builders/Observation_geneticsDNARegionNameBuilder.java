...
public interface Observation_geneticsDNARegionNameBuilder extends ExtensionBuilder {
  ...
  public class Impl implements Observation_geneticsDNARegionNameBuilder {
     ...
     */
    public Observation_geneticsDNARegionNameBuilder.Impl withId(@NonNull String id) {
