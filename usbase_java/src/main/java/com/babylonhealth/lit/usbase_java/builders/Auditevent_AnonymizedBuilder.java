...
public class Auditevent_AnonymizedBuilder {
   ...
   */
  public Auditevent_AnonymizedBuilder(String url, Boolean value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public Auditevent_AnonymizedBuilder withId(@NonNull String id) {
