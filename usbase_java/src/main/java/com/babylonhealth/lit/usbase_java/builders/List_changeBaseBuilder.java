...
public interface List_changeBaseBuilder extends ExtensionBuilder {
  ...
  public class Impl implements List_changeBaseBuilder {
     ...
     */
    public List_changeBaseBuilder.Impl withId(@NonNull String id) {
