...
public class DiagnosticReport_replacesBuilder {
   ...
   */
  public DiagnosticReport_replacesBuilder(String url, Reference value) {
    this.url = url;
    this.value = value;
  }
   ...
   */
  public DiagnosticReport_replacesBuilder withId(@NonNull String id) {
