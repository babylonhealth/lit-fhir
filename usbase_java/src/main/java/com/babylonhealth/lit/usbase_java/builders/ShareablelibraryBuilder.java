...
public class ShareablelibraryBuilder {
  private Optional<String> id = Optional.empty();
  private String url;
  private Optional<Meta> meta =
      Optional.of(
          new MetaBuilder()
              .withProfile("http://hl7.org/fhir/StructureDefinition/shareablelibrary")
              .build());
  ...
  /**
   * Required fields for {@link Shareablelibrary}
   *
   ...
   *     usage.
   */
  public ShareablelibraryBuilder(
      String url,
      String name,
   ...
   */
  public ShareablelibraryBuilder withId(@NonNull String id) {
   ...
   *     to the resource.
   */
  public ShareablelibraryBuilder withMeta(@NonNull Meta meta) {
   ...
   */
  public ShareablelibraryBuilder withText(@NonNull Narrative text) {
   ...
   */
  public ShareablelibraryBuilder withDate(@NonNull FHIRDateTime date) {
    this.date = Optional.of(date);
    return this;
  }
  /** @param title - A short, descriptive, user-friendly title for the library. */
  public ShareablelibraryBuilder withTitle(@NonNull String title) {
   ...
   */
  public ShareablelibraryBuilder withUsage(@NonNull String usage) {
   ...
   */
  public ShareablelibraryBuilder withTopic(@NonNull CodeableConcept... topic) {
   ...
   *     high-level categorization of the library that can be useful for filtering and searching.
   */
  public ShareablelibraryBuilder withTopic(@NonNull Collection<CodeableConcept> topic) {
   ...
   */
  public ShareablelibraryBuilder withAuthor(@NonNull ContactDetail... author) {
   ...
   *     maintenance of the content.
   */
  public ShareablelibraryBuilder withAuthor(@NonNull Collection<ContactDetail> author) {
   ...
   *     the content.
   */
  public ShareablelibraryBuilder withEditor(@NonNull ContactDetail... editor) {
   ...
   *     the content.
   */
  public ShareablelibraryBuilder withEditor(@NonNull Collection<ContactDetail> editor) {
   ...
   *     publisher.
   */
  public ShareablelibraryBuilder withContact(@NonNull ContactDetail... contact) {
   ...
   *     publisher.
   */
  public ShareablelibraryBuilder withContact(@NonNull Collection<ContactDetail> contact) {
   ...
   *     has.
   */
  public ShareablelibraryBuilder withPurpose(@NonNull String purpose) {
   ...
   */
  public ShareablelibraryBuilder withContent(@NonNull Attachment... content) {
   ...
   *     attachment determines how to interpret the content.
   */
  public ShareablelibraryBuilder withContent(@NonNull Collection<Attachment> content) {
    this.content = Collections.unmodifiableCollection(content);
    return this;
  }
  /** @param language - The base language in which the resource is written. */
  public ShareablelibraryBuilder withLanguage(@NonNull LANGUAGES language) {
   ...
   */
  public ShareablelibraryBuilder withSubtitle(@NonNull String subtitle) {
   ...
   *     of the content.
   */
  public ShareablelibraryBuilder withReviewer(@NonNull ContactDetail... reviewer) {
   ...
   *     of the content.
   */
  public ShareablelibraryBuilder withReviewer(@NonNull Collection<ContactDetail> reviewer) {
   ...
   */
  public ShareablelibraryBuilder withEndorser(@NonNull ContactDetail... endorser) {
   ...
   *     content for use in some setting.
   */
  public ShareablelibraryBuilder withEndorser(@NonNull Collection<ContactDetail> endorser) {
   ...
   */
  public ShareablelibraryBuilder withContained(@NonNull Resource... contained) {
   ...
   *     own independent transaction scope.
   */
  public ShareablelibraryBuilder withContained(@NonNull Collection<Resource> contained) {
   ...
   */
  public ShareablelibraryBuilder withExtension(@NonNull Extension... extension) {
   ...
   *     part of the definition of the extension.
   */
  public ShareablelibraryBuilder withExtension(@NonNull Collection<Extension> extension) {
   ...
   */
  public ShareablelibraryBuilder withCopyright(@NonNull String copyright) {
    this.copyright = Optional.of(copyright);
    return this;
  }
  /** @param parameter - The parameter element defines parameters used by the library. */
  public ShareablelibraryBuilder withParameter(@NonNull ParameterDefinition... parameter) {
    this.parameter = Arrays.asList(parameter);
    return this;
  }
  /** @param parameter - The parameter element defines parameters used by the library. */
  public ShareablelibraryBuilder withParameter(@NonNull Collection<ParameterDefinition> parameter) {
   ...
   */
  public ShareablelibraryBuilder withIdentifier(@NonNull Identifier... identifier) {
   ...
   *     identifier is required for non-experimental active artifacts.
   */
  public ShareablelibraryBuilder withIdentifier(@NonNull Collection<Identifier> identifier) {
   ...
   *     Reference.
   */
  public <T> ShareablelibraryBuilder withSubject(@NonNull T subject) {
    var guessedSuffix =
        autoSuffix(subject.getClass().getSimpleName(), Shareablelibrary$.MODULE$.subject());
   ...
   */
  public <T> ShareablelibraryBuilder withSubject(String suffix, @NonNull T subject) {
    guard(subject.getClass().getSimpleName(), suffix, Shareablelibrary$.MODULE$.subject());
    this.subject =
        Optional.of(
            (Choice)
                Choice$.MODULE$.fromSuffix(suffix, subject, Shareablelibrary$.MODULE$.subject()));
    return this;
  }
  /**
   ...
   */
  public ShareablelibraryBuilder withUseContext(@NonNull UsageContext... useContext) {
   ...
   *     assist with indexing and searching for appropriate library instances.
   */
  public ShareablelibraryBuilder withUseContext(@NonNull Collection<UsageContext> useContext) {
   ...
   */
  public ShareablelibraryBuilder withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
   ...
   * @param jurisdiction - A legal or geographic region in which the library is intended to be used.
   */
  public ShareablelibraryBuilder withJurisdiction(
   ...
   */
  public ShareablelibraryBuilder withApprovalDate(@NonNull FHIRDate approvalDate) {
   ...
   *     profiles etc.
   */
  public ShareablelibraryBuilder withImplicitRules(@NonNull String implicitRules) {
   ...
   */
  public ShareablelibraryBuilder withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
   ...
   *     active use.
   */
  public ShareablelibraryBuilder withEffectivePeriod(@NonNull Period effectivePeriod) {
   ...
   */
  public ShareablelibraryBuilder withRelatedArtifact(@NonNull RelatedArtifact... relatedArtifact) {
   ...
   *     bibliographic references.
   */
  public ShareablelibraryBuilder withRelatedArtifact(
   ...
   */
  public ShareablelibraryBuilder withDataRequirement(@NonNull DataRequirement... dataRequirement) {
   ...
   *     successfully perform the computations defined by the library.
   */
  public ShareablelibraryBuilder withDataRequirement(
   ...
   */
  public ShareablelibraryBuilder withModifierExtension(@NonNull Extension... modifierExtension) {
   ...
   *     DomainResource (including cannot change the meaning of modifierExtension itself).
   */
  public ShareablelibraryBuilder withModifierExtension(
  ...
  public Shareablelibrary build() {
    return new Shareablelibrary(
