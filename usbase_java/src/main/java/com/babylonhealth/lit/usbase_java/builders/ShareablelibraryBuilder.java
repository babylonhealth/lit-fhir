...
public interface ShareablelibraryBuilder extends LibraryBuilder {
  ...
  public class Impl implements ShareablelibraryBuilder {
     ...
     */
    public ShareablelibraryBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public ShareablelibraryBuilder.Impl withMeta(@NonNull Meta meta) {
     ...
     */
    public ShareablelibraryBuilder.Impl withDate(@NonNull FHIRDateTime date) {
      this.date = Optional.of(date);
      return this;
    }
    /** @param title - A short, descriptive, user-friendly title for the library. */
    public ShareablelibraryBuilder.Impl withTitle(@NonNull String title) {
     ...
     */
    public ShareablelibraryBuilder.Impl withUsage(@NonNull String usage) {
     ...
     */
    public ShareablelibraryBuilder.Impl withTopic(@NonNull CodeableConcept... topic) {
     ...
     *     high-level categorization of the library that can be useful for filtering and searching.
     */
    public ShareablelibraryBuilder.Impl withTopic(@NonNull Collection<CodeableConcept> topic) {
     ...
     */
    public ShareablelibraryBuilder.Impl withAuthor(@NonNull ContactDetail... author) {
     ...
     *     the content.
     */
    public ShareablelibraryBuilder.Impl withEditor(@NonNull ContactDetail... editor) {
     ...
     *     the content.
     */
    public ShareablelibraryBuilder.Impl withEditor(@NonNull Collection<ContactDetail> editor) {
     ...
     *     publisher.
     */
    public ShareablelibraryBuilder.Impl withContact(@NonNull ContactDetail... contact) {
     ...
     *     has.
     */
    public ShareablelibraryBuilder.Impl withPurpose(@NonNull String purpose) {
     ...
     */
    public ShareablelibraryBuilder.Impl withContent(@NonNull Attachment... content) {
    ...
    public ShareablelibraryBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public ShareablelibraryBuilder.Impl withSubtitle(@NonNull String subtitle) {
     ...
     */
    public ShareablelibraryBuilder.Impl withReviewer(@NonNull ContactDetail... reviewer) {
     ...
     *     aspect of the content.
     */
    public ShareablelibraryBuilder.Impl withReviewer(@NonNull Collection<ContactDetail> reviewer) {
     ...
     */
    public ShareablelibraryBuilder.Impl withEndorser(@NonNull ContactDetail... endorser) {
     ...
     */
    public ShareablelibraryBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     */
    public ShareablelibraryBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public ShareablelibraryBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
     ...
     *     library.
     */
    public ShareablelibraryBuilder.Impl withCopyright(@NonNull String copyright) {
      this.copyright = Optional.of(copyright);
      return this;
    }
    /** @param parameter - The parameter element defines parameters used by the library. */
    public ShareablelibraryBuilder.Impl withParameter(@NonNull ParameterDefinition... parameter) {
     ...
     */
    public ShareablelibraryBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     */
    public ShareablelibraryBuilder.Impl withUseContext(@NonNull UsageContext... useContext) {
     ...
     *     assist with indexing and searching for appropriate library instances.
     */
    public ShareablelibraryBuilder.Impl withUseContext(
     ...
     *     used.
     */
    public ShareablelibraryBuilder.Impl withJurisdiction(@NonNull CodeableConcept... jurisdiction) {
     ...
     */
    public ShareablelibraryBuilder.Impl withApprovalDate(@NonNull FHIRDate approvalDate) {
     ...
     *     profiles etc.
     */
    public ShareablelibraryBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public ShareablelibraryBuilder.Impl withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
     ...
     *     in active use.
     */
    public ShareablelibraryBuilder.Impl withEffectivePeriod(@NonNull Period effectivePeriod) {
