...
object UnionAliases {
  ...
  type Union00492977252 =
    BigDecimal \/ FHIRDate \/ FHIRDateTime \/ Int \/ LocalTime \/ Long \/ PositiveInt \/ Quantity \/ UnsignedInt \/ ZonedDateTime
  ...
  type Union00955719581 = Age \/ FHIRDateTime \/ Period \/ Range \/ String \/ Timing
  ...
  type Union01198965985 = Canonical \/ CodeableConcept \/ Expression \/ Reference
  ...
  type Union01540702691 = Age \/ Duration \/ Range \/ Timing
  type Union01718482969 =
    Attachment \/ Boolean \/ CodeableConcept \/ FHIRDateTime \/ Int \/ LocalTime \/ Period \/ Quantity \/ Range \/ Ratio \/ SampledData \/ String
  type Union01850316684                            = Boolean \/ CodeableConcept \/ Quantity \/ Range
  type Union02123692961                            = CodeableConcept \/ Duration \/ FHIRDateTime \/ Period \/ Quantity \/ Range
  ...
  type UnionAttachmentOrCodeableConceptOrReference = Attachment \/ CodeableConcept \/ Reference
  ...
  type UnionCanonicalOrCodeableConceptOrReference  = Canonical \/ CodeableConcept \/ Reference
  type UnionCanonicalOrCodeableConceptOrUri        = Canonical \/ CodeableConcept \/ UriStr
  type UnionCanonicalOrReference                   = Canonical \/ Reference
  ...
  type UnionCodeableConceptOrMoney                 = CodeableConcept \/ Money
  ...
  type UnionCodeableConceptOrQuantityOrRatio       = CodeableConcept \/ Quantity \/ Ratio
  ...
  type UnionDurationOrQuantity                     = Duration \/ Quantity
  type UnionDurationOrRange                        = Duration \/ Range
  type UnionIdentifierOrReference                  = Identifier \/ Reference
  type UnionIdentifierOrUri                        = Identifier \/ UriStr
  type UnionMarkdownOrReference                    = Markdown \/ Reference
  ...
  type UnionPeriodOrTiming                         = Period \/ Timing
  ...
  type Union_1045052359                            = Attachment \/ Base64Binary \/ CodeableConcept \/ Quantity \/ String
  ...
  val Union00492977252Tag: LTag[Union00492977252] = LTag[Union00492977252]
  ...
  val Union00955719581Tag: LTag[Union00955719581] = LTag[Union00955719581]
  val Union01113166363Tag: LTag[Union01113166363] = LTag[Union01113166363]
  val Union01198965985Tag: LTag[Union01198965985] = LTag[Union01198965985]
  ...
  val Union01540702691Tag: LTag[Union01540702691] = LTag[Union01540702691]
  val Union01718482969Tag: LTag[Union01718482969] = LTag[Union01718482969]
  val Union01850316684Tag: LTag[Union01850316684] = LTag[Union01850316684]
  val Union02123692961Tag: LTag[Union02123692961] = LTag[Union02123692961]
  ...
  val UnionAttachmentOrCodeableConceptOrReferenceTag: LTag[UnionAttachmentOrCodeableConceptOrReference] =
    LTag[UnionAttachmentOrCodeableConceptOrReference]
  ...
  val UnionCanonicalOrCodeableConceptOrReferenceTag: LTag[UnionCanonicalOrCodeableConceptOrReference] =
    LTag[UnionCanonicalOrCodeableConceptOrReference]
  ...
  val UnionCanonicalOrReferenceTag: LTag[UnionCanonicalOrReference]           = LTag[UnionCanonicalOrReference]
  ...
  val UnionCodeableConceptOrMoneyTag: LTag[UnionCodeableConceptOrMoney]       = LTag[UnionCodeableConceptOrMoney]
  ...
  val UnionCodeableConceptOrQuantityOrRatioTag: LTag[UnionCodeableConceptOrQuantityOrRatio] =
    LTag[UnionCodeableConceptOrQuantityOrRatio]
  ...
  val UnionDurationOrQuantityTag: LTag[UnionDurationOrQuantity]                 = LTag[UnionDurationOrQuantity]
  ...
  val UnionIdentifierOrUriTag: LTag[UnionIdentifierOrUri]                       = LTag[UnionIdentifierOrUri]
  val UnionMarkdownOrReferenceTag: LTag[UnionMarkdownOrReference]               = LTag[UnionMarkdownOrReference]
  ...
  val UnionPeriodOrTimingTag: LTag[UnionPeriodOrTiming]                         = LTag[UnionPeriodOrTiming]
  ...
  val Union_1045052359Tag: LTag[Union_1045052359]                               = LTag[Union_1045052359]
...
object Module
    extends ModuleDict(
      Map(
        ...
        "http://hl7.org/fhir/StructureDefinition/Statistic"                     -> Statistic,
        ...
        "http://hl7.org/fhir/StructureDefinition/OrderedDistribution"           -> OrderedDistribution,
