...
object UnionAliases {
  ...
  type UnionAnswer_Value = Attachment | BigDecimal | Boolean | Coding | FHIRDate | FHIRDateTime | Int | LocalTime | Quantity |
  ...
  type UnionCharacteristic_Definition = Canonical | CodeableConcept | DataRequirement | Expression | Reference | TriggerDefinition
  ...
  type UnionElementDefinition_MinValue = BigDecimal | FHIRDate | FHIRDateTime | Int | LocalTime | PositiveInt | Quantity |
    UnsignedInt | ZonedDateTime
  type UnionEnableWhen_Answer = BigDecimal | Boolean | Coding | FHIRDate | FHIRDateTime | Int | LocalTime | Quantity | Reference |
    String
  ...
  type UnionObservation_Value = Boolean | CodeableConcept | FHIRDateTime | Int | LocalTime | Period | Quantity | Range | Ratio |
    SampledData | String
