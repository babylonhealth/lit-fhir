...
object UnionAliases {
  ...
  type Union00492977252 = BigDecimal | FHIRDate | FHIRDateTime | Int | LocalTime | Long | PositiveInt | Quantity | UnsignedInt |
    ZonedDateTime
  ...
  type Union01718482969 = Attachment | Boolean | CodeableConcept | FHIRDateTime | Int | LocalTime | Period | Quantity | Range |
    Ratio | SampledData | String
