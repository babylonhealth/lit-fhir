...
object UnionAliases {
  ...
  type Union_0388264667 = BigDecimal | Boolean | Coding | FHIRDate | FHIRDateTime | Int | LocalTime | Quantity |
    Reference | String
  type Union_0503196159 = FHIRDate | Period
  type Union_0543144563 = Attachment | Boolean | Quantity | Reference | String
  type Union_0637176084 = BigDecimal | FHIRDate | FHIRDateTime | Int | LocalTime | PositiveInt | Quantity |
    UnsignedInt | ZonedDateTime
  type Union_0687680458 = Canonical | CodeableConcept | UriStr
  type Union_0802685816 = Boolean | CodeableConcept | FHIRDateTime | Int | LocalTime | Period | Quantity | Range |
  ...
  type Union_2101127777 = Attachment | BigDecimal | Boolean | Coding | FHIRDate | FHIRDateTime | Int | LocalTime |
    Quantity | Reference | String | UriStr
