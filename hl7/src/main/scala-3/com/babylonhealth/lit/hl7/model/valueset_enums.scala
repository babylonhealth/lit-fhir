...
enum ACTION_CARDINALITY_BEHAVIOR(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case MULTIPLE
      extends ACTION_CARDINALITY_BEHAVIOR("multiple", Some("Multiple"), Some("http://hl7.org/fhir/action-cardinality-behavior"))
  case SINGLE
      extends ACTION_CARDINALITY_BEHAVIOR("single", Some("Single"), Some("http://hl7.org/fhir/action-cardinality-behavior"))
}
...
enum ACTION_GROUPING_BEHAVIOR(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case SENTENCE_GROUP
      extends ACTION_GROUPING_BEHAVIOR(
        ...
        Some("http://hl7.org/fhir/action-grouping-behavior"))
  case VISUAL_GROUP
      extends ACTION_GROUPING_BEHAVIOR("visual-group", Some("Visual Group"), Some("http://hl7.org/fhir/action-grouping-behavior"))
}
...
enum ACTION_RELATIONSHIP_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case AFTER_END
      extends ACTION_RELATIONSHIP_TYPE("after-end", Some("After End"), Some("http://hl7.org/fhir/action-relationship-type"))
  case AFTER_START
      extends ACTION_RELATIONSHIP_TYPE("after-start", Some("After Start"), Some("http://hl7.org/fhir/action-relationship-type"))
  case BEFORE extends ACTION_RELATIONSHIP_TYPE("before", Some("Before"), Some("http://hl7.org/fhir/action-relationship-type"))
  case BEFORE_END
      extends ACTION_RELATIONSHIP_TYPE("before-end", Some("Before End"), Some("http://hl7.org/fhir/action-relationship-type"))
  case BEFORE_START
      extends ACTION_RELATIONSHIP_TYPE("before-start", Some("Before Start"), Some("http://hl7.org/fhir/action-relationship-type"))
  case CONCURRENT
      extends ACTION_RELATIONSHIP_TYPE("concurrent", Some("Concurrent"), Some("http://hl7.org/fhir/action-relationship-type"))
...
enum ACTION_SELECTION_BEHAVIOR(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ALL_OR_NONE
      extends ACTION_SELECTION_BEHAVIOR("all-or-none", Some("All Or None"), Some("http://hl7.org/fhir/action-selection-behavior"))
  case ANY extends ACTION_SELECTION_BEHAVIOR("any", Some("Any"), Some("http://hl7.org/fhir/action-selection-behavior"))
  case AT_MOST_ONE
      extends ACTION_SELECTION_BEHAVIOR("at-most-one", Some("At Most One"), Some("http://hl7.org/fhir/action-selection-behavior"))
  case EXACTLY_ONE
      extends ACTION_SELECTION_BEHAVIOR("exactly-one", Some("Exactly One"), Some("http://hl7.org/fhir/action-selection-behavior"))
  case ONE_OR_MORE
      extends ACTION_SELECTION_BEHAVIOR("one-or-more", Some("One Or More"), Some("http://hl7.org/fhir/action-selection-behavior"))
}
...
enum ADVERSE_EVENT_ACTUALITY(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case ACTUAL
      extends ADVERSE_EVENT_ACTUALITY("actual", Some("Adverse Event"), Some("http://hl7.org/fhir/adverse-event-actuality"))
  case POTENTIAL
...
enum ALLERGY_INTOLERANCE_CATEGORY(val name: String, val display: Option[String], val system: Option[String])
  ...
  case BIOLOGIC
      extends ALLERGY_INTOLERANCE_CATEGORY("biologic", Some("Biologic"), Some("http://hl7.org/fhir/allergy-intolerance-category"))
  case ENVIRONMENT
...
enum ALLERGY_INTOLERANCE_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case INTOLERANCE
      extends ALLERGY_INTOLERANCE_TYPE("intolerance", Some("Intolerance"), Some("http://hl7.org/fhir/allergy-intolerance-type"))
}
...
enum ASSERT_RESPONSE_CODE_TYPES(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case CONFLICT
      extends ASSERT_RESPONSE_CODE_TYPES("conflict", Some("conflict"), Some("http://hl7.org/fhir/assert-response-code-types"))
  case CREATED
      extends ASSERT_RESPONSE_CODE_TYPES("created", Some("created"), Some("http://hl7.org/fhir/assert-response-code-types"))
  case FORBIDDEN
      extends ASSERT_RESPONSE_CODE_TYPES("forbidden", Some("forbidden"), Some("http://hl7.org/fhir/assert-response-code-types"))
  ...
  case NOCONTENT
      extends ASSERT_RESPONSE_CODE_TYPES("noContent", Some("noContent"), Some("http://hl7.org/fhir/assert-response-code-types"))
  case NOTFOUND
      extends ASSERT_RESPONSE_CODE_TYPES("notFound", Some("notFound"), Some("http://hl7.org/fhir/assert-response-code-types"))
  case NOTMODIFIED
      extends ASSERT_RESPONSE_CODE_TYPES(
        "notModified",
        Some("notModified"),
...
enum CAPABILITY_STATEMENT_KIND(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case CAPABILITY
      extends CAPABILITY_STATEMENT_KIND("capability", Some("Capability"), Some("http://hl7.org/fhir/capability-statement-kind"))
  case INSTANCE
      extends CAPABILITY_STATEMENT_KIND("instance", Some("Instance"), Some("http://hl7.org/fhir/capability-statement-kind"))
  case REQUIREMENTS
...
enum CARE_PLAN_ACTIVITY_KIND(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case DEVICEREQUEST
      extends CARE_PLAN_ACTIVITY_KIND("DeviceRequest", Some("DeviceRequest"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICATIONREQUEST
      extends CARE_PLAN_ACTIVITY_KIND("MedicationRequest", Some("MedicationRequest"), Some("http://hl7.org/fhir/resource-types"))
  case NUTRITIONORDER
      extends CARE_PLAN_ACTIVITY_KIND("NutritionOrder", Some("NutritionOrder"), Some("http://hl7.org/fhir/resource-types"))
  case SERVICEREQUEST
      extends CARE_PLAN_ACTIVITY_KIND("ServiceRequest", Some("ServiceRequest"), Some("http://hl7.org/fhir/resource-types"))
...
enum CARE_PLAN_ACTIVITY_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case CANCELLED
      extends CARE_PLAN_ACTIVITY_STATUS("cancelled", Some("Cancelled"), Some("http://hl7.org/fhir/care-plan-activity-status"))
  case COMPLETED
      extends CARE_PLAN_ACTIVITY_STATUS("completed", Some("Completed"), Some("http://hl7.org/fhir/care-plan-activity-status"))
  case ENTERED_IN_ERROR
  ...
  case IN_PROGRESS
      extends CARE_PLAN_ACTIVITY_STATUS("in-progress", Some("In Progress"), Some("http://hl7.org/fhir/care-plan-activity-status"))
  case NOT_STARTED
      extends CARE_PLAN_ACTIVITY_STATUS("not-started", Some("Not Started"), Some("http://hl7.org/fhir/care-plan-activity-status"))
  case ON_HOLD
      extends CARE_PLAN_ACTIVITY_STATUS("on-hold", Some("On Hold"), Some("http://hl7.org/fhir/care-plan-activity-status"))
  case SCHEDULED
      extends CARE_PLAN_ACTIVITY_STATUS("scheduled", Some("Scheduled"), Some("http://hl7.org/fhir/care-plan-activity-status"))
  case STOPPED
      extends CARE_PLAN_ACTIVITY_STATUS("stopped", Some("Stopped"), Some("http://hl7.org/fhir/care-plan-activity-status"))
  case UNKNOWN
      extends CARE_PLAN_ACTIVITY_STATUS("unknown", Some("Unknown"), Some("http://hl7.org/fhir/care-plan-activity-status"))
}
...
enum CLINICALIMPRESSION_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ENTERED_IN_ERROR
      extends CLINICALIMPRESSION_STATUS("entered-in-error", Some("entered-in-error"), Some("http://hl7.org/fhir/event-status"))
...
enum CODESYSTEM_CONTENT_MODE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case SUPPLEMENT
      extends CODESYSTEM_CONTENT_MODE("supplement", Some("Supplement"), Some("http://hl7.org/fhir/codesystem-content-mode"))
}
...
enum CODESYSTEM_HIERARCHY_MEANING(val name: String, val display: Option[String], val system: Option[String])
  ...
  case PART_OF
      extends CODESYSTEM_HIERARCHY_MEANING("part-of", Some("Part Of"), Some("http://hl7.org/fhir/codesystem-hierarchy-meaning"))
}
...
enum COMPOSITION_ATTESTATION_MODE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case LEGAL
      extends COMPOSITION_ATTESTATION_MODE("legal", Some("Legal"), Some("http://hl7.org/fhir/composition-attestation-mode"))
  case OFFICIAL
      extends COMPOSITION_ATTESTATION_MODE("official", Some("Official"), Some("http://hl7.org/fhir/composition-attestation-mode"))
  case PERSONAL
      extends COMPOSITION_ATTESTATION_MODE("personal", Some("Personal"), Some("http://hl7.org/fhir/composition-attestation-mode"))
  case PROFESSIONAL
...
enum CONCEPTMAP_UNMAPPED_MODE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case OTHER_MAP
      extends CONCEPTMAP_UNMAPPED_MODE("other-map", Some("Other Map"), Some("http://hl7.org/fhir/conceptmap-unmapped-mode"))
  case PROVIDED
      extends CONCEPTMAP_UNMAPPED_MODE("provided", Some("Provided Code"), Some("http://hl7.org/fhir/conceptmap-unmapped-mode"))
}
...
enum CONCEPT_MAP_EQUIVALENCE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case SPECIALIZES
      extends CONCEPT_MAP_EQUIVALENCE("specializes", Some("Specializes"), Some("http://hl7.org/fhir/concept-map-equivalence"))
  case SUBSUMES extends CONCEPT_MAP_EQUIVALENCE("subsumes", Some("Subsumes"), Some("http://hl7.org/fhir/concept-map-equivalence"))
  case UNMATCHED
      extends CONCEPT_MAP_EQUIVALENCE("unmatched", Some("Unmatched"), Some("http://hl7.org/fhir/concept-map-equivalence"))
...
enum CONCEPT_PROPERTY_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case CODE
      extends CONCEPT_PROPERTY_TYPE("code", Some("code (internal reference)"), Some("http://hl7.org/fhir/concept-property-type"))
  case CODING
...
enum CONDITIONAL_READ_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case FULL_SUPPORT
      extends CONDITIONAL_READ_STATUS("full-support", Some("Full Support"), Some("http://hl7.org/fhir/conditional-read-status"))
  ...
  case IF_NONE_MATCH
      extends CONDITIONAL_READ_STATUS("not-match", Some("If-None-Match"), Some("http://hl7.org/fhir/conditional-read-status"))
  case NOT_SUPPORTED
      extends CONDITIONAL_READ_STATUS("not-supported", Some("Not Supported"), Some("http://hl7.org/fhir/conditional-read-status"))
}
...
enum CONTRACT_PUBLICATIONSTATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case AMENDED
      extends CONTRACT_PUBLICATIONSTATUS("amended", Some("Amended"), Some("http://hl7.org/fhir/contract-publicationstatus"))
  case APPENDED
      extends CONTRACT_PUBLICATIONSTATUS("appended", Some("Appended"), Some("http://hl7.org/fhir/contract-publicationstatus"))
  case CANCELLED
      extends CONTRACT_PUBLICATIONSTATUS("cancelled", Some("Cancelled"), Some("http://hl7.org/fhir/contract-publicationstatus"))
  case DISPUTED
      extends CONTRACT_PUBLICATIONSTATUS("disputed", Some("Disputed"), Some("http://hl7.org/fhir/contract-publicationstatus"))
  case ENTERED_IN_ERROR
  ...
  case EXECUTABLE
      extends CONTRACT_PUBLICATIONSTATUS("executable", Some("Executable"), Some("http://hl7.org/fhir/contract-publicationstatus"))
  case EXECUTED
      extends CONTRACT_PUBLICATIONSTATUS("executed", Some("Executed"), Some("http://hl7.org/fhir/contract-publicationstatus"))
  case NEGOTIABLE
      extends CONTRACT_PUBLICATIONSTATUS("negotiable", Some("Negotiable"), Some("http://hl7.org/fhir/contract-publicationstatus"))
  case OFFERED
      extends CONTRACT_PUBLICATIONSTATUS("offered", Some("Offered"), Some("http://hl7.org/fhir/contract-publicationstatus"))
  case POLICY extends CONTRACT_PUBLICATIONSTATUS("policy", Some("Policy"), Some("http://hl7.org/fhir/contract-publicationstatus"))
  case REJECTED
      extends CONTRACT_PUBLICATIONSTATUS("rejected", Some("Rejected"), Some("http://hl7.org/fhir/contract-publicationstatus"))
  case RENEWED
      extends CONTRACT_PUBLICATIONSTATUS("renewed", Some("Renewed"), Some("http://hl7.org/fhir/contract-publicationstatus"))
  case RESOLVED
      extends CONTRACT_PUBLICATIONSTATUS("resolved", Some("Resolved"), Some("http://hl7.org/fhir/contract-publicationstatus"))
  case REVOKED
      extends CONTRACT_PUBLICATIONSTATUS("revoked", Some("Revoked"), Some("http://hl7.org/fhir/contract-publicationstatus"))
  case TERMINATED
      extends CONTRACT_PUBLICATIONSTATUS("terminated", Some("Terminated"), Some("http://hl7.org/fhir/contract-publicationstatus"))
}
...
enum DEFINED_TYPES(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ENROLLMENTRESPONSE
      extends DEFINED_TYPES("EnrollmentResponse", Some("EnrollmentResponse"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case IMMUNIZATIONEVALUATION
      extends DEFINED_TYPES("ImmunizationEvaluation", Some("ImmunizationEvaluation"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case MEDICATIONDISPENSE
      extends DEFINED_TYPES("MedicationDispense", Some("MedicationDispense"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICATIONKNOWLEDGE
      extends DEFINED_TYPES("MedicationKnowledge", Some("MedicationKnowledge"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICATIONREQUEST
      extends DEFINED_TYPES("MedicationRequest", Some("MedicationRequest"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICATIONSTATEMENT
      extends DEFINED_TYPES("MedicationStatement", Some("MedicationStatement"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case OPERATIONDEFINITION
      extends DEFINED_TYPES("OperationDefinition", Some("OperationDefinition"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case VISIONPRESCRIPTION
      extends DEFINED_TYPES("VisionPrescription", Some("VisionPrescription"), Some("http://hl7.org/fhir/resource-types"))
...
enum DEVICE_NAMETYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case USER_FRIENDLY_NAME
      extends DEVICE_NAMETYPE("user-friendly-name", Some("User Friendly name"), Some("http://hl7.org/fhir/device-nametype"))
}
...
enum DEVICE_STATEMENT_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case COMPLETED
      extends DEVICE_STATEMENT_STATUS("completed", Some("Completed"), Some("http://hl7.org/fhir/device-statement-status"))
  case ENTERED_IN_ERROR
...
enum DIAGNOSTIC_REPORT_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case APPENDED
      extends DIAGNOSTIC_REPORT_STATUS("appended", Some("Appended"), Some("http://hl7.org/fhir/diagnostic-report-status"))
  case CANCELLED
      extends DIAGNOSTIC_REPORT_STATUS("cancelled", Some("Cancelled"), Some("http://hl7.org/fhir/diagnostic-report-status"))
  case CORRECTED
      extends DIAGNOSTIC_REPORT_STATUS("corrected", Some("Corrected"), Some("http://hl7.org/fhir/diagnostic-report-status"))
  case ENTERED_IN_ERROR
  ...
  case REGISTERED
      extends DIAGNOSTIC_REPORT_STATUS("registered", Some("Registered"), Some("http://hl7.org/fhir/diagnostic-report-status"))
...
enum DOCUMENT_REFERENCE_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case CURRENT
      extends DOCUMENT_REFERENCE_STATUS("current", Some("Current"), Some("http://hl7.org/fhir/document-reference-status"))
  case ENTERED_IN_ERROR
  ...
  case SUPERSEDED
      extends DOCUMENT_REFERENCE_STATUS("superseded", Some("Superseded"), Some("http://hl7.org/fhir/document-reference-status"))
}
...
enum DOCUMENT_RELATIONSHIP_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case APPENDS
      extends DOCUMENT_RELATIONSHIP_TYPE("appends", Some("Appends"), Some("http://hl7.org/fhir/document-relationship-type"))
  case REPLACES
      extends DOCUMENT_RELATIONSHIP_TYPE("replaces", Some("Replaces"), Some("http://hl7.org/fhir/document-relationship-type"))
  case SIGNS extends DOCUMENT_RELATIONSHIP_TYPE("signs", Some("Signs"), Some("http://hl7.org/fhir/document-relationship-type"))
  case TRANSFORMS
      extends DOCUMENT_RELATIONSHIP_TYPE("transforms", Some("Transforms"), Some("http://hl7.org/fhir/document-relationship-type"))
}
...
enum ENCOUNTER_LOCATION_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case COMPLETED
      extends ENCOUNTER_LOCATION_STATUS("completed", Some("Completed"), Some("http://hl7.org/fhir/encounter-location-status"))
  case PLANNED
      extends ENCOUNTER_LOCATION_STATUS("planned", Some("Planned"), Some("http://hl7.org/fhir/encounter-location-status"))
  case RESERVED
      extends ENCOUNTER_LOCATION_STATUS("reserved", Some("Reserved"), Some("http://hl7.org/fhir/encounter-location-status"))
}
...
enum EXPLANATIONOFBENEFIT_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case ACTIVE
      extends EXPLANATIONOFBENEFIT_STATUS("active", Some("Active"), Some("http://hl7.org/fhir/explanationofbenefit-status"))
  case CANCELLED
      extends EXPLANATIONOFBENEFIT_STATUS("cancelled", Some("Cancelled"), Some("http://hl7.org/fhir/explanationofbenefit-status"))
...
enum EXPOSURE_STATE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case EXPOSURE_ALTERNATIVE
      extends EXPOSURE_STATE("exposure-alternative", Some("Exposure Alternative"), Some("http://hl7.org/fhir/exposure-state"))
}
...
enum EXTENSION_CONTEXT_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case EXTENSION
      extends EXTENSION_CONTEXT_TYPE("extension", Some("Extension URL"), Some("http://hl7.org/fhir/extension-context-type"))
...
enum GRAPH_COMPARTMENT_USE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case REQUIREMENT
      extends GRAPH_COMPARTMENT_USE("requirement", Some("Requirement"), Some("http://hl7.org/fhir/graph-compartment-use"))
}
...
enum GROUP_MEASURE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case MEDIAN_OF_STUDY_MEDIANS
      extends GROUP_MEASURE("median-of-median", Some("Median of Study Medians"), Some("http://hl7.org/fhir/group-measure"))
}
...
enum GUIDANCE_RESPONSE_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case IN_PROGRESS
      extends GUIDANCE_RESPONSE_STATUS("in-progress", Some("In Progress"), Some("http://hl7.org/fhir/guidance-response-status"))
...
enum GUIDE_PARAMETER_CODE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case EXPANSION_PROFILE
      extends GUIDE_PARAMETER_CODE(
        ...
        Some("http://hl7.org/fhir/guide-parameter-code"))
  case GENERATE_JSON
      extends GUIDE_PARAMETER_CODE("generate-json", Some("Generate JSON"), Some("http://hl7.org/fhir/guide-parameter-code"))
  case GENERATE_TURTLE
      extends GUIDE_PARAMETER_CODE("generate-turtle", Some("Generate Turtle"), Some("http://hl7.org/fhir/guide-parameter-code"))
  case GENERATE_XML
      extends GUIDE_PARAMETER_CODE("generate-xml", Some("Generate XML"), Some("http://hl7.org/fhir/guide-parameter-code"))
  case HTML_TEMPLATE
      extends GUIDE_PARAMETER_CODE("html-template", Some("HTML Template"), Some("http://hl7.org/fhir/guide-parameter-code"))
  case PAGES_PATH extends GUIDE_PARAMETER_CODE("path-pages", Some("Pages Path"), Some("http://hl7.org/fhir/guide-parameter-code"))
  case RESOURCE_PATH
      extends GUIDE_PARAMETER_CODE("path-resource", Some("Resource Path"), Some("http://hl7.org/fhir/guide-parameter-code"))
...
enum IMMUNIZATION_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ENTERED_IN_ERROR
      extends IMMUNIZATION_STATUS("entered-in-error", Some("entered-in-error"), Some("http://hl7.org/fhir/event-status"))
...
enum INVOICE_PRICECOMPONENTTYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case DEDUCTION
      extends INVOICE_PRICECOMPONENTTYPE("deduction", Some("deduction"), Some("http://hl7.org/fhir/invoice-priceComponentType"))
  case DISCOUNT
      extends INVOICE_PRICECOMPONENTTYPE("discount", Some("discount"), Some("http://hl7.org/fhir/invoice-priceComponentType"))
  case INFORMATIONAL
  ...
  case SURCHARGE
      extends INVOICE_PRICECOMPONENTTYPE("surcharge", Some("surcharge"), Some("http://hl7.org/fhir/invoice-priceComponentType"))
...
enum MAP_GROUP_TYPE_MODE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case TYPES
      extends MAP_GROUP_TYPE_MODE("types", Some("Default for Type Combination"), Some("http://hl7.org/fhir/map-group-type-mode"))
  case TYPE_AND_TYPES
...
enum MAP_SOURCE_LIST_MODE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case NOT_LAST
      extends MAP_SOURCE_LIST_MODE("not_last", Some("All but the last"), Some("http://hl7.org/fhir/map-source-list-mode"))
  case ONLY_ONE
      extends MAP_SOURCE_LIST_MODE("only_one", Some("Enforce only one"), Some("http://hl7.org/fhir/map-source-list-mode"))
}
...
enum MEASURE_REPORT_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case DATA_COLLECTION
      extends MEASURE_REPORT_TYPE("data-collection", Some("Data Collection"), Some("http://hl7.org/fhir/measure-report-type"))
...
enum MEDICATIONREQUEST_INTENT(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case INSTANCE_ORDER
      extends MEDICATIONREQUEST_INTENT(
        ...
        Some("http://hl7.org/fhir/CodeSystem/medicationrequest-intent"))
  case OPTION
      extends MEDICATIONREQUEST_INTENT("option", Some("Option"), Some("http://hl7.org/fhir/CodeSystem/medicationrequest-intent"))
  case ORDER
      extends MEDICATIONREQUEST_INTENT("order", Some("Order"), Some("http://hl7.org/fhir/CodeSystem/medicationrequest-intent"))
  case ORIGINAL_ORDER
      extends MEDICATIONREQUEST_INTENT(
        "original-order",
        Some("Original Order"),
        Some("http://hl7.org/fhir/CodeSystem/medicationrequest-intent"))
  case PLAN
      extends MEDICATIONREQUEST_INTENT("plan", Some("Plan"), Some("http://hl7.org/fhir/CodeSystem/medicationrequest-intent"))
  case PROPOSAL
      extends MEDICATIONREQUEST_INTENT(
        "proposal",
        Some("Proposal"),
...
enum MEDICATIONREQUEST_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case ACTIVE
      extends MEDICATIONREQUEST_STATUS("active", Some("Active"), Some("http://hl7.org/fhir/CodeSystem/medicationrequest-status"))
  case CANCELLED
  ...
  case COMPLETED
      extends MEDICATIONREQUEST_STATUS(
        ...
        Some("http://hl7.org/fhir/CodeSystem/medicationrequest-status"))
  case DRAFT
      extends MEDICATIONREQUEST_STATUS("draft", Some("Draft"), Some("http://hl7.org/fhir/CodeSystem/medicationrequest-status"))
  case ENTERED_IN_ERROR
      extends MEDICATIONREQUEST_STATUS(
        "entered-in-error",
        Some("Entered in Error"),
...
enum MESSAGEHEADER_RESPONSE_REQUEST(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ALWAYS
      extends MESSAGEHEADER_RESPONSE_REQUEST("always", Some("Always"), Some("http://hl7.org/fhir/messageheader-response-request"))
  case NEVER
      extends MESSAGEHEADER_RESPONSE_REQUEST("never", Some("Never"), Some("http://hl7.org/fhir/messageheader-response-request"))
  case ON_ERROR
...
enum METRIC_CALIBRATION_STATE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case CALIBRATED
      extends METRIC_CALIBRATION_STATE("calibrated", Some("Calibrated"), Some("http://hl7.org/fhir/metric-calibration-state"))
  ...
  case NOT_CALIBRATED
      extends METRIC_CALIBRATION_STATE(
        ...
        Some("http://hl7.org/fhir/metric-calibration-state"))
  case UNSPECIFIED
      extends METRIC_CALIBRATION_STATE("unspecified", Some("Unspecified"), Some("http://hl7.org/fhir/metric-calibration-state"))
}
...
enum METRIC_CALIBRATION_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case UNSPECIFIED
      extends METRIC_CALIBRATION_TYPE("unspecified", Some("Unspecified"), Some("http://hl7.org/fhir/metric-calibration-type"))
}
...
enum ORIENTATION_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case SENSE
      extends ORIENTATION_TYPE("sense", Some("Sense orientation of referenceSeq"), Some("http://hl7.org/fhir/orientation-type"))
}
...
enum PARTICIPANTREQUIRED(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case INFORMATION_ONLY
      extends PARTICIPANTREQUIRED("information-only", Some("Information Only"), Some("http://hl7.org/fhir/participantrequired"))
...
enum PROPERTY_REPRESENTATION(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case CDATEXT
      extends PROPERTY_REPRESENTATION("cdaText", Some("CDA Text Format"), Some("http://hl7.org/fhir/property-representation"))
  case TYPEATTR
      extends PROPERTY_REPRESENTATION("typeAttr", Some("Type Attribute"), Some("http://hl7.org/fhir/property-representation"))
  case XHTML extends PROPERTY_REPRESENTATION("xhtml", Some("XHTML"), Some("http://hl7.org/fhir/property-representation"))
  case XMLATTR
      extends PROPERTY_REPRESENTATION("xmlAttr", Some("XML Attribute"), Some("http://hl7.org/fhir/property-representation"))
...
enum QUESTIONNAIRE_ANSWERS_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case AMENDED
      extends QUESTIONNAIRE_ANSWERS_STATUS("amended", Some("Amended"), Some("http://hl7.org/fhir/questionnaire-answers-status"))
  case COMPLETED
  ...
  case IN_PROGRESS
      extends QUESTIONNAIRE_ANSWERS_STATUS(
        ...
        Some("http://hl7.org/fhir/questionnaire-answers-status"))
  case STOPPED
      extends QUESTIONNAIRE_ANSWERS_STATUS("stopped", Some("Stopped"), Some("http://hl7.org/fhir/questionnaire-answers-status"))
}
...
enum QUESTIONNAIRE_ENABLE_OPERATOR(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case EQUALS
      extends QUESTIONNAIRE_ENABLE_OPERATOR("=", Some("Equals"), Some("http://hl7.org/fhir/questionnaire-enable-operator"))
  case EXISTS
      extends QUESTIONNAIRE_ENABLE_OPERATOR("exists", Some("Exists"), Some("http://hl7.org/fhir/questionnaire-enable-operator"))
  ...
  case GREATER_THAN
      extends QUESTIONNAIRE_ENABLE_OPERATOR(">", Some("Greater Than"), Some("http://hl7.org/fhir/questionnaire-enable-operator"))
  case LESS_OR_EQUALS
      extends QUESTIONNAIRE_ENABLE_OPERATOR(
        "<=",
        Some("Less or Equals"),
        Some("http://hl7.org/fhir/questionnaire-enable-operator"))
  case LESS_THAN
      extends QUESTIONNAIRE_ENABLE_OPERATOR("<", Some("Less Than"), Some("http://hl7.org/fhir/questionnaire-enable-operator"))
  case NOT_EQUALS
      extends QUESTIONNAIRE_ENABLE_OPERATOR("!=", Some("Not Equals"), Some("http://hl7.org/fhir/questionnaire-enable-operator"))
}
...
enum REFERENCE_VERSION_RULES(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case INDEPENDENT
      extends REFERENCE_VERSION_RULES(
        ...
        Some("http://hl7.org/fhir/reference-version-rules"))
  case SPECIFIC
      extends REFERENCE_VERSION_RULES("specific", Some("Version Specific"), Some("http://hl7.org/fhir/reference-version-rules"))
}
...
enum REPORT_PARTICIPANT_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case TEST_ENGINE
      extends REPORT_PARTICIPANT_TYPE("test-engine", Some("Test Engine"), Some("http://hl7.org/fhir/report-participant-type"))
}
...
enum REPORT_STATUS_CODES(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ENTERED_IN_ERROR
      extends REPORT_STATUS_CODES("entered-in-error", Some("Entered In Error"), Some("http://hl7.org/fhir/report-status-codes"))
  case IN_PROGRESS
...
enum REQUEST_RESOURCE_TYPES(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case APPOINTMENT
      extends REQUEST_RESOURCE_TYPES("Appointment", Some("Appointment"), Some("http://hl7.org/fhir/request-resource-types"))
  case APPOINTMENTRESPONSE
  ...
  case DEVICEREQUEST
      extends REQUEST_RESOURCE_TYPES("DeviceRequest", Some("DeviceRequest"), Some("http://hl7.org/fhir/request-resource-types"))
  case ENROLLMENTREQUEST
      extends REQUEST_RESOURCE_TYPES(
        "EnrollmentRequest",
  ...
  case MEDICATIONREQUEST
      extends REQUEST_RESOURCE_TYPES(
        ...
        Some("http://hl7.org/fhir/request-resource-types"))
  case NUTRITIONORDER
      extends REQUEST_RESOURCE_TYPES("NutritionOrder", Some("NutritionOrder"), Some("http://hl7.org/fhir/request-resource-types"))
  case SERVICEREQUEST
      extends REQUEST_RESOURCE_TYPES("ServiceRequest", Some("ServiceRequest"), Some("http://hl7.org/fhir/request-resource-types"))
  case SUPPLYREQUEST
      extends REQUEST_RESOURCE_TYPES("SupplyRequest", Some("SupplyRequest"), Some("http://hl7.org/fhir/request-resource-types"))
...
enum RESEARCH_STUDY_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case DISAPPROVED
      extends RESEARCH_STUDY_STATUS("disapproved", Some("Disapproved"), Some("http://hl7.org/fhir/research-study-status"))
...
enum RESEARCH_SUBJECT_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case CANDIDATE
      extends RESEARCH_SUBJECT_STATUS("candidate", Some("Candidate"), Some("http://hl7.org/fhir/research-subject-status"))
  case ELIGIBLE extends RESEARCH_SUBJECT_STATUS("eligible", Some("Eligible"), Some("http://hl7.org/fhir/research-subject-status"))
  case FOLLOW_UP
      extends RESEARCH_SUBJECT_STATUS("follow-up", Some("Follow-up"), Some("http://hl7.org/fhir/research-subject-status"))
  case INELIGIBLE
      extends RESEARCH_SUBJECT_STATUS("ineligible", Some("Ineligible"), Some("http://hl7.org/fhir/research-subject-status"))
  case NOT_REGISTERED
  ...
  case OFF_STUDY
      extends RESEARCH_SUBJECT_STATUS("off-study", Some("Off-study"), Some("http://hl7.org/fhir/research-subject-status"))
  ...
  case POTENTIAL_CANDIDATE
      extends RESEARCH_SUBJECT_STATUS(
        ...
        Some("http://hl7.org/fhir/research-subject-status"))
  case SCREENING
      extends RESEARCH_SUBJECT_STATUS("screening", Some("Screening"), Some("http://hl7.org/fhir/research-subject-status"))
  case WITHDRAWN
      extends RESEARCH_SUBJECT_STATUS("withdrawn", Some("Withdrawn"), Some("http://hl7.org/fhir/research-subject-status"))
}
...
enum RESOURCE_AGGREGATION_MODE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case BUNDLED
      extends RESOURCE_AGGREGATION_MODE("bundled", Some("Bundled"), Some("http://hl7.org/fhir/resource-aggregation-mode"))
  case CONTAINED
      extends RESOURCE_AGGREGATION_MODE("contained", Some("Contained"), Some("http://hl7.org/fhir/resource-aggregation-mode"))
  case REFERENCED
      extends RESOURCE_AGGREGATION_MODE("referenced", Some("Referenced"), Some("http://hl7.org/fhir/resource-aggregation-mode"))
}
...
enum RESOURCE_TYPES(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ACTIVITYDEFINITION
      extends RESOURCE_TYPES("ActivityDefinition", Some("ActivityDefinition"), Some("http://hl7.org/fhir/resource-types"))
  case ADVERSEEVENT extends RESOURCE_TYPES("AdverseEvent", Some("AdverseEvent"), Some("http://hl7.org/fhir/resource-types"))
  case ALLERGYINTOLERANCE
      extends RESOURCE_TYPES("AllergyIntolerance", Some("AllergyIntolerance"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case ENROLLMENTRESPONSE
      extends RESOURCE_TYPES("EnrollmentResponse", Some("EnrollmentResponse"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case EXPLANATIONOFBENEFIT
      extends RESOURCE_TYPES("ExplanationOfBenefit", Some("ExplanationOfBenefit"), Some("http://hl7.org/fhir/resource-types"))
  case FAMILYMEMBERHISTORY
      extends RESOURCE_TYPES("FamilyMemberHistory", Some("FamilyMemberHistory"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case IMMUNIZATIONEVALUATION
      extends RESOURCE_TYPES("ImmunizationEvaluation", Some("ImmunizationEvaluation"), Some("http://hl7.org/fhir/resource-types"))
  case IMMUNIZATIONRECOMMENDATION
      extends RESOURCE_TYPES(
        "ImmunizationRecommendation",
        Some("ImmunizationRecommendation"),
  ...
  case MEDICATIONADMINISTRATION
      extends RESOURCE_TYPES(
        ...
        Some("http://hl7.org/fhir/resource-types"))
  case MEDICATIONDISPENSE
      extends RESOURCE_TYPES("MedicationDispense", Some("MedicationDispense"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICATIONKNOWLEDGE
      extends RESOURCE_TYPES("MedicationKnowledge", Some("MedicationKnowledge"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICATIONREQUEST
      extends RESOURCE_TYPES("MedicationRequest", Some("MedicationRequest"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICATIONSTATEMENT
      extends RESOURCE_TYPES("MedicationStatement", Some("MedicationStatement"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICINALPRODUCT
  ...
  case OPERATIONDEFINITION
      extends RESOURCE_TYPES("OperationDefinition", Some("OperationDefinition"), Some("http://hl7.org/fhir/resource-types"))
  case OPERATIONOUTCOME
  ...
  case VISIONPRESCRIPTION
      extends RESOURCE_TYPES("VisionPrescription", Some("VisionPrescription"), Some("http://hl7.org/fhir/resource-types"))
}
...
enum SPDX_LICENSE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case APPLE_PUBLIC_SOURCE_LICENSE_1_0
      extends SPDX_LICENSE("APSL-1.0", Some("Apple Public Source License 1.0"), Some("http://hl7.org/fhir/spdx-license"))
  case APPLE_PUBLIC_SOURCE_LICENSE_1_1
      extends SPDX_LICENSE("APSL-1.1", Some("Apple Public Source License 1.1"), Some("http://hl7.org/fhir/spdx-license"))
  case APPLE_PUBLIC_SOURCE_LICENSE_1_2
      extends SPDX_LICENSE("APSL-1.2", Some("Apple Public Source License 1.2"), Some("http://hl7.org/fhir/spdx-license"))
  case APPLE_PUBLIC_SOURCE_LICENSE_2_0
      extends SPDX_LICENSE("APSL-2.0", Some("Apple Public Source License 2.0"), Some("http://hl7.org/fhir/spdx-license"))
  case ARTISTIC_10_CL8
      extends SPDX_LICENSE("Artistic-1.0-cl8", Some("Artistic License 1.0 w/clause 8"), Some("http://hl7.org/fhir/spdx-license"))
  case ARTISTIC_10_PERL
      extends SPDX_LICENSE("Artistic-1.0-Perl", Some("Artistic License 1.0 (Perl)"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case BSD_2_CLAUSE
      extends SPDX_LICENSE("BSD-2-Clause", Some("BSD 2-Clause \"Simplified\" License"), Some("http://hl7.org/fhir/spdx-license"))
  case BSD_2_CLAUSE_FREEBSD_LICENSE
      extends SPDX_LICENSE("BSD-2-Clause-FreeBSD", Some("BSD 2-Clause FreeBSD License"), Some("http://hl7.org/fhir/spdx-license"))
  case BSD_2_CLAUSE_NETBSD_LICENSE
      extends SPDX_LICENSE("BSD-2-Clause-NetBSD", Some("BSD 2-Clause NetBSD License"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case BSD_3_CLAUSE_CLEAR_LICENSE
      extends SPDX_LICENSE("BSD-3-Clause-Clear", Some("BSD 3-Clause Clear License"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case BSD_SOURCE_CODE_ATTRIBUTION
      extends SPDX_LICENSE("BSD-Source-Code", Some("BSD Source Code Attribution"), Some("http://hl7.org/fhir/spdx-license"))
  case BSD_WITH_ATTRIBUTION
      extends SPDX_LICENSE("BSD-3-Clause-Attribution", Some("BSD with attribution"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case BZIP2_AND_LIBBZIP2_LICENSE_V1_0_5
      extends SPDX_LICENSE("bzip2-1.0.5", Some("bzip2 and libbzip2 License v1.0.5"), Some("http://hl7.org/fhir/spdx-license"))
  case BZIP2_AND_LIBBZIP2_LICENSE_V1_0_6
      extends SPDX_LICENSE("bzip2-1.0.6", Some("bzip2 and libbzip2 License v1.0.6"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case CECILL_B_FREE_SOFTWARE_LICENSE_AGREEMENT
      extends SPDX_LICENSE("CECILL-B", Some("CeCILL-B Free Software License Agreement"), Some("http://hl7.org/fhir/spdx-license"))
  case CECILL_C_FREE_SOFTWARE_LICENSE_AGREEMENT
      extends SPDX_LICENSE("CECILL-C", Some("CeCILL-C Free Software License Agreement"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case CODE_PROJECT_OPEN_LICENSE_1_02
      extends SPDX_LICENSE("CPOL-1.02", Some("Code Project Open License 1.02"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case COMMON_PUBLIC_ATTRIBUTION_LICENSE_1_0
      extends SPDX_LICENSE("CPAL-1.0", Some("Common Public Attribution License 1.0"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case CREATIVE_COMMONS_ZERO_V1_0_UNIVERSAL
      extends SPDX_LICENSE("CC0-1.0", Some("Creative Commons Zero v1.0 Universal"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case CUA_OFFICE_PUBLIC_LICENSE_V1_0
      extends SPDX_LICENSE("CUA-OPL-1.0", Some("CUA Office Public License v1.0"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case EDUCATIONAL_COMMUNITY_LICENSE_V1_0
      extends SPDX_LICENSE("ECL-1.0", Some("Educational Community License v1.0"), Some("http://hl7.org/fhir/spdx-license"))
  case EDUCATIONAL_COMMUNITY_LICENSE_V2_0
      extends SPDX_LICENSE("ECL-2.0", Some("Educational Community License v2.0"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case EUROPEAN_UNION_PUBLIC_LICENSE_1_0
      extends SPDX_LICENSE("EUPL-1.0", Some("European Union Public License 1.0"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case GNU_GENERAL_PUBLIC_LICENSE_V1_0_ONLY
      extends SPDX_LICENSE("GPL-1.0-only", Some("GNU General Public License v1.0 only"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case GNU_GENERAL_PUBLIC_LICENSE_V2_0_ONLY
      extends SPDX_LICENSE("GPL-2.0-only", Some("GNU General Public License v2.0 only"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case GNU_GENERAL_PUBLIC_LICENSE_V3_0_ONLY
      extends SPDX_LICENSE("GPL-3.0-only", Some("GNU General Public License v3.0 only"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case HASKELLREPORT
      extends SPDX_LICENSE("HaskellReport", Some("Haskell Language Report License"), Some("http://hl7.org/fhir/spdx-license"))
  case HPND
      extends SPDX_LICENSE("HPND", Some("Historical Permission Notice and Disclaimer"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case LATEX_PROJECT_PUBLIC_LICENSE_V1_1
      extends SPDX_LICENSE("LPPL-1.1", Some("LaTeX Project Public License v1.1"), Some("http://hl7.org/fhir/spdx-license"))
  case LATEX_PROJECT_PUBLIC_LICENSE_V1_2
      extends SPDX_LICENSE("LPPL-1.2", Some("LaTeX Project Public License v1.2"), Some("http://hl7.org/fhir/spdx-license"))
  case LATEX_PROJECT_PUBLIC_LICENSE_V1_3A
      extends SPDX_LICENSE("LPPL-1.3a", Some("LaTeX Project Public License v1.3a"), Some("http://hl7.org/fhir/spdx-license"))
  case LATEX_PROJECT_PUBLIC_LICENSE_V1_3C
      extends SPDX_LICENSE("LPPL-1.3c", Some("LaTeX Project Public License v1.3c"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case LUCENT_PUBLIC_LICENSE_VERSION_1_0
      extends SPDX_LICENSE("LPL-1.0", Some("Lucent Public License Version 1.0"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case OPEN_LDAP_PUBLIC_LICENSE_2_2_2
      extends SPDX_LICENSE("OLDAP-2.2.2", Some("Open LDAP Public License 2.2.2"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case OPEN_LDAP_PUBLIC_LICENSE_V2_0_1
      extends SPDX_LICENSE("OLDAP-2.0.1", Some("Open LDAP Public License v2.0.1"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case OPEN_LDAP_PUBLIC_LICENSE_V2_2_1
      extends SPDX_LICENSE("OLDAP-2.2.1", Some("Open LDAP Public License v2.2.1"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case OSET_PUBLIC_LICENSE_VERSION_2_1
      extends SPDX_LICENSE("OSET-PL-2.1", Some("OSET Public License version 2.1"), Some("http://hl7.org/fhir/spdx-license"))
  case PDDL_10
      extends SPDX_LICENSE(
        "PDDL-1.0",
  ...
  case REALNETWORKS_PUBLIC_SOURCE_LICENSE_V1_0
      extends SPDX_LICENSE("RPSL-1.0", Some("RealNetworks Public Source License v1.0"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case SGI_FREE_SOFTWARE_LICENSE_B_V1_1
      extends SPDX_LICENSE("SGI-B-1.1", Some("SGI Free Software License B v1.1"), Some("http://hl7.org/fhir/spdx-license"))
  case SGI_FREE_SOFTWARE_LICENSE_B_V2_0
      extends SPDX_LICENSE("SGI-B-2.0", Some("SGI Free Software License B v2.0"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case SISSL
      extends SPDX_LICENSE("SISSL", Some("Sun Industry Standards Source License v1.1"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case SUGARCRM_PUBLIC_LICENSE_V1_1_3
      extends SPDX_LICENSE("SugarCRM-1.1.3", Some("SugarCRM Public License v1.1.3"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case SYBASE_OPEN_WATCOM_PUBLIC_LICENSE_1_0
      extends SPDX_LICENSE("Watcom-1.0", Some("Sybase Open Watcom Public License 1.0"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case TORQUE_11
      extends SPDX_LICENSE("TORQUE-1.1", Some("TORQUE v2.5+ Software License v1.1"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case W3C
      extends SPDX_LICENSE("W3C", Some("W3C Software Notice and License (2002-12-31)"), Some("http://hl7.org/fhir/spdx-license"))
  case W3C_19980720
      extends SPDX_LICENSE(
        "W3C-19980720",
...
enum STRUCTURE_DEFINITION_KIND(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case LOGICAL
      extends STRUCTURE_DEFINITION_KIND("logical", Some("Logical"), Some("http://hl7.org/fhir/structure-definition-kind"))
  case PRIMITIVE_DATA_TYPE
      extends STRUCTURE_DEFINITION_KIND(
        ...
        Some("http://hl7.org/fhir/structure-definition-kind"))
  case RESOURCE
      extends STRUCTURE_DEFINITION_KIND("resource", Some("Resource"), Some("http://hl7.org/fhir/structure-definition-kind"))
}
...
enum SUBSCRIPTION_CHANNEL_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case MESSAGE
      extends SUBSCRIPTION_CHANNEL_TYPE("message", Some("Message"), Some("http://hl7.org/fhir/subscription-channel-type"))
  case REST_HOOK
      extends SUBSCRIPTION_CHANNEL_TYPE("rest-hook", Some("Rest Hook"), Some("http://hl7.org/fhir/subscription-channel-type"))
  case SMS extends SUBSCRIPTION_CHANNEL_TYPE("sms", Some("SMS"), Some("http://hl7.org/fhir/subscription-channel-type"))
  case WEBSOCKET
      extends SUBSCRIPTION_CHANNEL_TYPE("websocket", Some("Websocket"), Some("http://hl7.org/fhir/subscription-channel-type"))
}
...
enum SUBSTANCE_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ENTERED_IN_ERROR
      extends SUBSTANCE_STATUS("entered-in-error", Some("Entered in Error"), Some("http://hl7.org/fhir/substance-status"))
...
enum SYSTEM_RESTFUL_INTERACTION(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case SEARCH_SYSTEM
      extends SYSTEM_RESTFUL_INTERACTION("search-system", Some("search-system"), Some("http://hl7.org/fhir/restful-interaction"))
  case TRANSACTION
      extends SYSTEM_RESTFUL_INTERACTION("transaction", Some("transaction"), Some("http://hl7.org/fhir/restful-interaction"))
}
...
enum TYPE_DERIVATION_RULE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case SPECIALIZATION
      extends TYPE_DERIVATION_RULE("specialization", Some("Specialization"), Some("http://hl7.org/fhir/type-derivation-rule"))
}
...
enum V3_CONFIDENTIALITYCLASSIFICATION(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case L
      extends V3_CONFIDENTIALITYCLASSIFICATION("L", Some("L"), Some("http://terminology.hl7.org/CodeSystem/v3-Confidentiality"))
  case M
      extends V3_CONFIDENTIALITYCLASSIFICATION("M", Some("M"), Some("http://terminology.hl7.org/CodeSystem/v3-Confidentiality"))
  case N
      extends V3_CONFIDENTIALITYCLASSIFICATION("N", Some("N"), Some("http://terminology.hl7.org/CodeSystem/v3-Confidentiality"))
  case R
      extends V3_CONFIDENTIALITYCLASSIFICATION("R", Some("R"), Some("http://terminology.hl7.org/CodeSystem/v3-Confidentiality"))
  case U
      extends V3_CONFIDENTIALITYCLASSIFICATION("U", Some("U"), Some("http://terminology.hl7.org/CodeSystem/v3-Confidentiality"))
  case V
      extends V3_CONFIDENTIALITYCLASSIFICATION("V", Some("V"), Some("http://terminology.hl7.org/CodeSystem/v3-Confidentiality"))
}
...
enum VERIFICATIONRESULT_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case RE_VALIDATION_FAILED
      extends VERIFICATIONRESULT_STATUS("reval-fail", Some("Re-Validation failed"), Some("http://hl7.org/fhir/CodeSystem/status"))
  case VALIDATED extends VERIFICATIONRESULT_STATUS("validated", Some("Validated"), Some("http://hl7.org/fhir/CodeSystem/status"))
  case VALIDATION_FAILED
      extends VERIFICATIONRESULT_STATUS("val-fail", Some("Validation failed"), Some("http://hl7.org/fhir/CodeSystem/status"))
}
...
enum VERSIONING_POLICY(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case NO_VERSIONID_SUPPORT
      extends VERSIONING_POLICY("no-version", Some("No VersionId Support"), Some("http://hl7.org/fhir/versioning-policy"))
