...
enum ACTION_CARDINALITY_BEHAVIOR(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case MULTIPLE
      extends ACTION_CARDINALITY_BEHAVIOR(
        "multiple",
        Some("Multiple"),
        Some("http://hl7.org/fhir/action-cardinality-behavior"))
  case SINGLE
      extends ACTION_CARDINALITY_BEHAVIOR(
        "single",
        Some("Single"),
...
object ACTION_CARDINALITY_BEHAVIOR
    extends EType[ACTION_CARDINALITY_BEHAVIOR]("http://hl7.org/fhir/ValueSet/action-cardinality-behavior")

enum ACTION_CONDITION_KIND(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case APPLICABILITY
      extends ACTION_CONDITION_KIND(
        "applicability",
        Some("Applicability"),
        Some("http://hl7.org/fhir/action-condition-kind"))
...
enum ACTION_GROUPING_BEHAVIOR(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case LOGICAL_GROUP
      extends ACTION_GROUPING_BEHAVIOR(
        "logical-group",
        Some("Logical Group"),
        Some("http://hl7.org/fhir/action-grouping-behavior"))
  case SENTENCE_GROUP
      extends ACTION_GROUPING_BEHAVIOR(
        "sentence-group",
        Some("Sentence Group"),
...
object ACTION_GROUPING_BEHAVIOR
    extends EType[ACTION_GROUPING_BEHAVIOR]("http://hl7.org/fhir/ValueSet/action-grouping-behavior")

enum ACTION_PARTICIPANT_TYPE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case DEVICE
      extends ACTION_PARTICIPANT_TYPE("device", Some("Device"), Some("http://hl7.org/fhir/action-participant-type"))
  case PATIENT
      extends ACTION_PARTICIPANT_TYPE("patient", Some("Patient"), Some("http://hl7.org/fhir/action-participant-type"))
  case PRACTITIONER
      extends ACTION_PARTICIPANT_TYPE(
        "practitioner",
        Some("Practitioner"),
        Some("http://hl7.org/fhir/action-participant-type"))
  case RELATED_PERSON
      extends ACTION_PARTICIPANT_TYPE(
        "related-person",
        Some("Related Person"),
...
object ACTION_PARTICIPANT_TYPE
    extends EType[ACTION_PARTICIPANT_TYPE]("http://hl7.org/fhir/ValueSet/action-participant-type")

enum ACTION_PRECHECK_BEHAVIOR(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
...
object ACTION_PRECHECK_BEHAVIOR
    extends EType[ACTION_PRECHECK_BEHAVIOR]("http://hl7.org/fhir/ValueSet/action-precheck-behavior")

enum ACTION_RELATIONSHIP_TYPE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case AFTER
      extends ACTION_RELATIONSHIP_TYPE("after", Some("After"), Some("http://hl7.org/fhir/action-relationship-type"))
  case AFTER_END
      extends ACTION_RELATIONSHIP_TYPE(
        "after-end",
        Some("After End"),
        Some("http://hl7.org/fhir/action-relationship-type"))
  case AFTER_START
      extends ACTION_RELATIONSHIP_TYPE(
        "after-start",
        Some("After Start"),
        Some("http://hl7.org/fhir/action-relationship-type"))
  case BEFORE
      extends ACTION_RELATIONSHIP_TYPE("before", Some("Before"), Some("http://hl7.org/fhir/action-relationship-type"))
  case BEFORE_END
      extends ACTION_RELATIONSHIP_TYPE(
        "before-end",
        Some("Before End"),
  ...
  case CONCURRENT_WITH_END
      extends ACTION_RELATIONSHIP_TYPE(
        "concurrent-with-end",
        Some("Concurrent With End"),
        Some("http://hl7.org/fhir/action-relationship-type"))
  case CONCURRENT_WITH_START
      extends ACTION_RELATIONSHIP_TYPE(
        "concurrent-with-start",
        Some("Concurrent With Start"),
        Some("http://hl7.org/fhir/action-relationship-type"))
}
object ACTION_RELATIONSHIP_TYPE
    extends EType[ACTION_RELATIONSHIP_TYPE]("http://hl7.org/fhir/ValueSet/action-relationship-type")

enum ACTION_REQUIRED_BEHAVIOR(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case COULD
      extends ACTION_REQUIRED_BEHAVIOR("could", Some("Could"), Some("http://hl7.org/fhir/action-required-behavior"))
  ...
  case MUST_UNLESS_DOCUMENTED
      extends ACTION_REQUIRED_BEHAVIOR(
        ...
        Some("Must Unless Documented"),
        Some("http://hl7.org/fhir/action-required-behavior"))
}
object ACTION_REQUIRED_BEHAVIOR
    extends EType[ACTION_REQUIRED_BEHAVIOR]("http://hl7.org/fhir/ValueSet/action-required-behavior")

enum ACTION_SELECTION_BEHAVIOR(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ALL extends ACTION_SELECTION_BEHAVIOR("all", Some("All"), Some("http://hl7.org/fhir/action-selection-behavior"))
  case ALL_OR_NONE
      extends ACTION_SELECTION_BEHAVIOR(
        "all-or-none",
        Some("All Or None"),
        Some("http://hl7.org/fhir/action-selection-behavior"))
...
enum ADMINISTRATIVE_GENDER(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  ...
  case UNKNOWN
      extends ADMINISTRATIVE_GENDER("unknown", Some("Unknown"), Some("http://hl7.org/fhir/administrative-gender"))
}
object ADMINISTRATIVE_GENDER extends EType[ADMINISTRATIVE_GENDER]("http://hl7.org/fhir/ValueSet/administrative-gender")

enum ADVERSE_EVENT_ACTUALITY(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ACTUAL
      extends ADVERSE_EVENT_ACTUALITY(
        "actual",
        Some("Adverse Event"),
        Some("http://hl7.org/fhir/adverse-event-actuality"))
  case POTENTIAL
      extends ADVERSE_EVENT_ACTUALITY(
        "potential",
        Some("Potential Adverse Event"),
        Some("http://hl7.org/fhir/adverse-event-actuality"))
}
object ADVERSE_EVENT_ACTUALITY
    extends EType[ADVERSE_EVENT_ACTUALITY]("http://hl7.org/fhir/ValueSet/adverse-event-actuality")

enum ALLERGY_INTOLERANCE_CATEGORY(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case BIOLOGIC
      extends ALLERGY_INTOLERANCE_CATEGORY(
        "biologic",
        Some("Biologic"),
        Some("http://hl7.org/fhir/allergy-intolerance-category"))
  case ENVIRONMENT
      extends ALLERGY_INTOLERANCE_CATEGORY(
        "environment",
        Some("Environment"),
...
object ALLERGY_INTOLERANCE_CATEGORY
    extends EType[ALLERGY_INTOLERANCE_CATEGORY]("http://hl7.org/fhir/ValueSet/allergy-intolerance-category")

enum ALLERGY_INTOLERANCE_CRITICALITY(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case HIGH
      extends ALLERGY_INTOLERANCE_CRITICALITY(
        "high",
        Some("High Risk"),
        Some("http://hl7.org/fhir/allergy-intolerance-criticality"))
  case LOW
      extends ALLERGY_INTOLERANCE_CRITICALITY(
        "low",
        Some("Low Risk"),
        Some("http://hl7.org/fhir/allergy-intolerance-criticality"))
  case UNABLE_TO_ASSESS_RISK
      extends ALLERGY_INTOLERANCE_CRITICALITY(
        "unable-to-assess",
        Some("Unable to Assess Risk"),
        Some("http://hl7.org/fhir/allergy-intolerance-criticality"))
}
object ALLERGY_INTOLERANCE_CRITICALITY
    extends EType[ALLERGY_INTOLERANCE_CRITICALITY]("http://hl7.org/fhir/ValueSet/allergy-intolerance-criticality")

enum ALLERGY_INTOLERANCE_TYPE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ALLERGY
      extends ALLERGY_INTOLERANCE_TYPE("allergy", Some("Allergy"), Some("http://hl7.org/fhir/allergy-intolerance-type"))
  case INTOLERANCE
      extends ALLERGY_INTOLERANCE_TYPE(
        "intolerance",
        Some("Intolerance"),
        Some("http://hl7.org/fhir/allergy-intolerance-type"))
}
object ALLERGY_INTOLERANCE_TYPE
    extends EType[ALLERGY_INTOLERANCE_TYPE]("http://hl7.org/fhir/ValueSet/allergy-intolerance-type")
...
enum APPOINTMENTSTATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case CANCELLED
      extends APPOINTMENTSTATUS("cancelled", Some("Cancelled"), Some("http://hl7.org/fhir/appointmentstatus"))
  case CHECKED_IN
      extends APPOINTMENTSTATUS("checked-in", Some("Checked In"), Some("http://hl7.org/fhir/appointmentstatus"))
  case ENTERED_IN_ERROR
      extends APPOINTMENTSTATUS(
        "entered-in-error",
        Some("Entered in error"),
        Some("http://hl7.org/fhir/appointmentstatus"))
  case FULFILLED
      extends APPOINTMENTSTATUS("fulfilled", Some("Fulfilled"), Some("http://hl7.org/fhir/appointmentstatus"))
...
enum ASSERT_DIRECTION_CODES(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case REQUEST
      extends ASSERT_DIRECTION_CODES("request", Some("request"), Some("http://hl7.org/fhir/assert-direction-codes"))
  case RESPONSE
      extends ASSERT_DIRECTION_CODES("response", Some("response"), Some("http://hl7.org/fhir/assert-direction-codes"))
}
object ASSERT_DIRECTION_CODES
    extends EType[ASSERT_DIRECTION_CODES]("http://hl7.org/fhir/ValueSet/assert-direction-codes")

enum ASSERT_OPERATOR_CODES(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case CONTAINS
      extends ASSERT_OPERATOR_CODES("contains", Some("contains"), Some("http://hl7.org/fhir/assert-operator-codes"))
  ...
  case GREATERTHAN
      extends ASSERT_OPERATOR_CODES(
        "greaterThan",
        Some("greaterThan"),
        Some("http://hl7.org/fhir/assert-operator-codes"))
  case IN extends ASSERT_OPERATOR_CODES("in", Some("in"), Some("http://hl7.org/fhir/assert-operator-codes"))
  case LESSTHAN
      extends ASSERT_OPERATOR_CODES("lessThan", Some("lessThan"), Some("http://hl7.org/fhir/assert-operator-codes"))
  case NOTCONTAINS
      extends ASSERT_OPERATOR_CODES(
        "notContains",
        Some("notContains"),
        Some("http://hl7.org/fhir/assert-operator-codes"))
  case NOTEMPTY
      extends ASSERT_OPERATOR_CODES("notEmpty", Some("notEmpty"), Some("http://hl7.org/fhir/assert-operator-codes"))
  case NOTEQUALS
      extends ASSERT_OPERATOR_CODES("notEquals", Some("notEquals"), Some("http://hl7.org/fhir/assert-operator-codes"))
...
enum ASSERT_RESPONSE_CODE_TYPES(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case BAD
      extends ASSERT_RESPONSE_CODE_TYPES("bad", Some("bad"), Some("http://hl7.org/fhir/assert-response-code-types"))
  case CONFLICT
      extends ASSERT_RESPONSE_CODE_TYPES(
        "conflict",
        Some("conflict"),
        Some("http://hl7.org/fhir/assert-response-code-types"))
  case CREATED
      extends ASSERT_RESPONSE_CODE_TYPES(
        "created",
        Some("created"),
  ...
  case FORBIDDEN
      extends ASSERT_RESPONSE_CODE_TYPES(
        ...
        Some("http://hl7.org/fhir/assert-response-code-types"))
  case GONE
      extends ASSERT_RESPONSE_CODE_TYPES("gone", Some("gone"), Some("http://hl7.org/fhir/assert-response-code-types"))
  ...
  case NOTMODIFIED
      extends ASSERT_RESPONSE_CODE_TYPES(
        ...
        Some("http://hl7.org/fhir/assert-response-code-types"))
  case OKAY
      extends ASSERT_RESPONSE_CODE_TYPES("okay", Some("okay"), Some("http://hl7.org/fhir/assert-response-code-types"))
...
object ASSERT_RESPONSE_CODE_TYPES
    extends EType[ASSERT_RESPONSE_CODE_TYPES]("http://hl7.org/fhir/ValueSet/assert-response-code-types")

enum AUDIT_EVENT_ACTION(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
...
enum AUDIT_EVENT_OUTCOME(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case MAJOR_FAILURE
      extends AUDIT_EVENT_OUTCOME("12", Some("Major failure"), Some("http://hl7.org/fhir/audit-event-outcome"))
  case MINOR_FAILURE
      extends AUDIT_EVENT_OUTCOME("4", Some("Minor failure"), Some("http://hl7.org/fhir/audit-event-outcome"))
  case SERIOUS_FAILURE
      extends AUDIT_EVENT_OUTCOME("8", Some("Serious failure"), Some("http://hl7.org/fhir/audit-event-outcome"))
...
enum BINDING_STRENGTH(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case EXTENSIBLE
      extends BINDING_STRENGTH("extensible", Some("Extensible"), Some("http://hl7.org/fhir/binding-strength"))
...
enum BUNDLE_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case BATCH_RESPONSE
      extends BUNDLE_TYPE("batch-response", Some("Batch Response"), Some("http://hl7.org/fhir/bundle-type"))
...
enum CAPABILITY_STATEMENT_KIND(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case CAPABILITY
      extends CAPABILITY_STATEMENT_KIND(
        "capability",
        Some("Capability"),
        Some("http://hl7.org/fhir/capability-statement-kind"))
  case INSTANCE
      extends CAPABILITY_STATEMENT_KIND(
        "instance",
        Some("Instance"),
...
object CAPABILITY_STATEMENT_KIND
    extends EType[CAPABILITY_STATEMENT_KIND]("http://hl7.org/fhir/ValueSet/capability-statement-kind")

enum CARE_PLAN_ACTIVITY_KIND(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case APPOINTMENT
      extends CARE_PLAN_ACTIVITY_KIND("Appointment", Some("Appointment"), Some("http://hl7.org/fhir/resource-types"))
  case COMMUNICATIONREQUEST
      extends CARE_PLAN_ACTIVITY_KIND(
...
object CARE_PLAN_ACTIVITY_KIND
    extends EType[CARE_PLAN_ACTIVITY_KIND]("http://hl7.org/fhir/ValueSet/care-plan-activity-kind")

enum CARE_PLAN_ACTIVITY_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case CANCELLED
      extends CARE_PLAN_ACTIVITY_STATUS(
        "cancelled",
        Some("Cancelled"),
        Some("http://hl7.org/fhir/care-plan-activity-status"))
  case COMPLETED
      extends CARE_PLAN_ACTIVITY_STATUS(
        "completed",
        Some("Completed"),
...
enum CARE_TEAM_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ENTERED_IN_ERROR
      extends CARE_TEAM_STATUS(
        "entered-in-error",
        Some("Entered in Error"),
        Some("http://hl7.org/fhir/care-team-status"))
...
enum CHARGEITEM_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ENTERED_IN_ERROR
      extends CHARGEITEM_STATUS(
        "entered-in-error",
        Some("Entered in Error"),
        Some("http://hl7.org/fhir/chargeitem-status"))
  case NOT_BILLABLE
      extends CHARGEITEM_STATUS("not-billable", Some("Not billable"), Some("http://hl7.org/fhir/chargeitem-status"))
...
enum CLAIM_USE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case PREAUTHORIZATION
      extends CLAIM_USE("preauthorization", Some("Preauthorization"), Some("http://hl7.org/fhir/claim-use"))
  case PREDETERMINATION
      extends CLAIM_USE("predetermination", Some("Predetermination"), Some("http://hl7.org/fhir/claim-use"))
}
object CLAIM_USE extends EType[CLAIM_USE]("http://hl7.org/fhir/ValueSet/claim-use")

enum CLINICALIMPRESSION_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case COMPLETED
      extends CLINICALIMPRESSION_STATUS("completed", Some("completed"), Some("http://hl7.org/fhir/event-status"))
  case ENTERED_IN_ERROR
      extends CLINICALIMPRESSION_STATUS(
        "entered-in-error",
        Some("entered-in-error"),
        Some("http://hl7.org/fhir/event-status"))
  case IN_PROGRESS
      extends CLINICALIMPRESSION_STATUS("in-progress", Some("in-progress"), Some("http://hl7.org/fhir/event-status"))
}
object CLINICALIMPRESSION_STATUS
    extends EType[CLINICALIMPRESSION_STATUS]("http://hl7.org/fhir/ValueSet/clinicalimpression-status")

enum CODESYSTEM_CONTENT_MODE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case COMPLETE
      extends CODESYSTEM_CONTENT_MODE("complete", Some("Complete"), Some("http://hl7.org/fhir/codesystem-content-mode"))
  case EXAMPLE
      extends CODESYSTEM_CONTENT_MODE("example", Some("Example"), Some("http://hl7.org/fhir/codesystem-content-mode"))
  case FRAGMENT
      extends CODESYSTEM_CONTENT_MODE("fragment", Some("Fragment"), Some("http://hl7.org/fhir/codesystem-content-mode"))
  case NOT_PRESENT
      extends CODESYSTEM_CONTENT_MODE(
        "not-present",
        Some("Not Present"),
        Some("http://hl7.org/fhir/codesystem-content-mode"))
  case SUPPLEMENT
      extends CODESYSTEM_CONTENT_MODE(
        "supplement",
        Some("Supplement"),
...
object CODESYSTEM_CONTENT_MODE
    extends EType[CODESYSTEM_CONTENT_MODE]("http://hl7.org/fhir/ValueSet/codesystem-content-mode")

enum CODESYSTEM_HIERARCHY_MEANING(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case CLASSIFIED_WITH
      extends CODESYSTEM_HIERARCHY_MEANING(
        "classified-with",
        Some("Classified With"),
        Some("http://hl7.org/fhir/codesystem-hierarchy-meaning"))
  case GROUPED_BY
      extends CODESYSTEM_HIERARCHY_MEANING(
        "grouped-by",
        Some("Grouped By"),
...
enum CODE_SEARCH_SUPPORT(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ALL extends CODE_SEARCH_SUPPORT("all", Some("Implicit Codes"), Some("http://hl7.org/fhir/code-search-support"))
  case EXPLICIT
      extends CODE_SEARCH_SUPPORT("explicit", Some("Explicit Codes"), Some("http://hl7.org/fhir/code-search-support"))
}
...
enum COMPARTMENT_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case PRACTITIONER
      extends COMPARTMENT_TYPE("Practitioner", Some("Practitioner"), Some("http://hl7.org/fhir/compartment-type"))
  case RELATEDPERSON
...
enum COMPOSITION_ATTESTATION_MODE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case LEGAL
      extends COMPOSITION_ATTESTATION_MODE(
        "legal",
        Some("Legal"),
        Some("http://hl7.org/fhir/composition-attestation-mode"))
  case OFFICIAL
      extends COMPOSITION_ATTESTATION_MODE(
        "official",
        Some("Official"),
...
object COMPOSITION_ATTESTATION_MODE
    extends EType[COMPOSITION_ATTESTATION_MODE]("http://hl7.org/fhir/ValueSet/composition-attestation-mode")

enum COMPOSITION_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case AMENDED extends COMPOSITION_STATUS("amended", Some("Amended"), Some("http://hl7.org/fhir/composition-status"))
  case ENTERED_IN_ERROR
      extends COMPOSITION_STATUS(
        "entered-in-error",
        Some("Entered in Error"),
        Some("http://hl7.org/fhir/composition-status"))
  case FINAL extends COMPOSITION_STATUS("final", Some("Final"), Some("http://hl7.org/fhir/composition-status"))
  case PRELIMINARY
      extends COMPOSITION_STATUS("preliminary", Some("Preliminary"), Some("http://hl7.org/fhir/composition-status"))
}
object COMPOSITION_STATUS extends EType[COMPOSITION_STATUS]("http://hl7.org/fhir/ValueSet/composition-status")

enum CONCEPTMAP_UNMAPPED_MODE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case FIXED
      extends CONCEPTMAP_UNMAPPED_MODE(
        "fixed",
        Some("Fixed Code"),
        Some("http://hl7.org/fhir/conceptmap-unmapped-mode"))
  case OTHER_MAP
      extends CONCEPTMAP_UNMAPPED_MODE(
        "other-map",
        Some("Other Map"),
...
object CONCEPTMAP_UNMAPPED_MODE
    extends EType[CONCEPTMAP_UNMAPPED_MODE]("http://hl7.org/fhir/ValueSet/conceptmap-unmapped-mode")

enum CONCEPT_MAP_EQUIVALENCE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case DISJOINT
      extends CONCEPT_MAP_EQUIVALENCE("disjoint", Some("Disjoint"), Some("http://hl7.org/fhir/concept-map-equivalence"))
  case EQUAL
      extends CONCEPT_MAP_EQUIVALENCE("equal", Some("Equal"), Some("http://hl7.org/fhir/concept-map-equivalence"))
  case EQUIVALENT
      extends CONCEPT_MAP_EQUIVALENCE(
        "equivalent",
        Some("Equivalent"),
        Some("http://hl7.org/fhir/concept-map-equivalence"))
  case INEXACT
      extends CONCEPT_MAP_EQUIVALENCE("inexact", Some("Inexact"), Some("http://hl7.org/fhir/concept-map-equivalence"))
  case NARROWER
      extends CONCEPT_MAP_EQUIVALENCE("narrower", Some("Narrower"), Some("http://hl7.org/fhir/concept-map-equivalence"))
  case RELATEDTO
      extends CONCEPT_MAP_EQUIVALENCE(
        "relatedto",
        Some("Related To"),
  ...
  case SPECIALIZES
      extends CONCEPT_MAP_EQUIVALENCE(
        ...
        Some("http://hl7.org/fhir/concept-map-equivalence"))
  case SUBSUMES
      extends CONCEPT_MAP_EQUIVALENCE("subsumes", Some("Subsumes"), Some("http://hl7.org/fhir/concept-map-equivalence"))
  case UNMATCHED
      extends CONCEPT_MAP_EQUIVALENCE(
        "unmatched",
        Some("Unmatched"),
        Some("http://hl7.org/fhir/concept-map-equivalence"))
  case WIDER
      extends CONCEPT_MAP_EQUIVALENCE("wider", Some("Wider"), Some("http://hl7.org/fhir/concept-map-equivalence"))
}
object CONCEPT_MAP_EQUIVALENCE
    extends EType[CONCEPT_MAP_EQUIVALENCE]("http://hl7.org/fhir/ValueSet/concept-map-equivalence")

enum CONCEPT_PROPERTY_TYPE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case BOOLEAN
      extends CONCEPT_PROPERTY_TYPE("boolean", Some("boolean"), Some("http://hl7.org/fhir/concept-property-type"))
  case CODE
      extends CONCEPT_PROPERTY_TYPE(
        "code",
        Some("code (internal reference)"),
  ...
  case CODING
      extends CONCEPT_PROPERTY_TYPE(
        ...
        Some("http://hl7.org/fhir/concept-property-type"))
  case DATETIME
      extends CONCEPT_PROPERTY_TYPE("dateTime", Some("dateTime"), Some("http://hl7.org/fhir/concept-property-type"))
  case DECIMAL
      extends CONCEPT_PROPERTY_TYPE("decimal", Some("decimal"), Some("http://hl7.org/fhir/concept-property-type"))
  case INTEGER
      extends CONCEPT_PROPERTY_TYPE("integer", Some("integer"), Some("http://hl7.org/fhir/concept-property-type"))
...
enum CONDITIONAL_DELETE_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case MULTIPLE
      extends CONDITIONAL_DELETE_STATUS(
        "multiple",
        Some("Multiple Deletes Supported"),
        Some("http://hl7.org/fhir/conditional-delete-status"))
  case NOT_SUPPORTED
      extends CONDITIONAL_DELETE_STATUS(
        "not-supported",
        Some("Not Supported"),
  ...
  case SINGLE
      extends CONDITIONAL_DELETE_STATUS(
        "single",
        Some("Single Deletes Supported"),
        Some("http://hl7.org/fhir/conditional-delete-status"))
}
object CONDITIONAL_DELETE_STATUS
    extends EType[CONDITIONAL_DELETE_STATUS]("http://hl7.org/fhir/ValueSet/conditional-delete-status")

enum CONDITIONAL_READ_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case FULL_SUPPORT
      extends CONDITIONAL_READ_STATUS(
        "full-support",
        Some("Full Support"),
        Some("http://hl7.org/fhir/conditional-read-status"))
  case IF_MODIFIED_SINCE
      extends CONDITIONAL_READ_STATUS(
        "modified-since",
        Some("If-Modified-Since"),
        Some("http://hl7.org/fhir/conditional-read-status"))
  case IF_NONE_MATCH
      extends CONDITIONAL_READ_STATUS(
        "not-match",
...
object CONDITIONAL_READ_STATUS
    extends EType[CONDITIONAL_READ_STATUS]("http://hl7.org/fhir/ValueSet/conditional-read-status")

enum CONSENT_DATA_MEANING(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case AUTHOREDBY
      extends CONSENT_DATA_MEANING("authoredby", Some("AuthoredBy"), Some("http://hl7.org/fhir/consent-data-meaning"))
  case DEPENDENTS
      extends CONSENT_DATA_MEANING("dependents", Some("Dependents"), Some("http://hl7.org/fhir/consent-data-meaning"))
  case INSTANCE
      extends CONSENT_DATA_MEANING("instance", Some("Instance"), Some("http://hl7.org/fhir/consent-data-meaning"))
  case RELATED
      extends CONSENT_DATA_MEANING("related", Some("Related"), Some("http://hl7.org/fhir/consent-data-meaning"))
}
object CONSENT_DATA_MEANING extends EType[CONSENT_DATA_MEANING]("http://hl7.org/fhir/ValueSet/consent-data-meaning")

enum CONSENT_PROVISION_TYPE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case DENY extends CONSENT_PROVISION_TYPE("deny", Some("Opt Out"), Some("http://hl7.org/fhir/consent-provision-type"))
  case PERMIT
      extends CONSENT_PROVISION_TYPE("permit", Some("Opt In"), Some("http://hl7.org/fhir/consent-provision-type"))
}
object CONSENT_PROVISION_TYPE
    extends EType[CONSENT_PROVISION_TYPE]("http://hl7.org/fhir/ValueSet/consent-provision-type")

enum CONSENT_STATE_CODES(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  ...
  case ENTERED_IN_ERROR
      extends CONSENT_STATE_CODES(
        "entered-in-error",
        Some("Entered in Error"),
        Some("http://hl7.org/fhir/consent-state-codes"))
  case INACTIVE
      extends CONSENT_STATE_CODES("inactive", Some("Inactive"), Some("http://hl7.org/fhir/consent-state-codes"))
  case PROPOSED
      extends CONSENT_STATE_CODES("proposed", Some("Proposed"), Some("http://hl7.org/fhir/consent-state-codes"))
  case REJECTED
      extends CONSENT_STATE_CODES("rejected", Some("Rejected"), Some("http://hl7.org/fhir/consent-state-codes"))
}
object CONSENT_STATE_CODES extends EType[CONSENT_STATE_CODES]("http://hl7.org/fhir/ValueSet/consent-state-codes")

enum CONSTRAINT_SEVERITY(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
...
enum CONTRACT_PUBLICATIONSTATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case AMENDED
      extends CONTRACT_PUBLICATIONSTATUS(
        "amended",
        Some("Amended"),
        Some("http://hl7.org/fhir/contract-publicationstatus"))
  case APPENDED
      extends CONTRACT_PUBLICATIONSTATUS(
        "appended",
        Some("Appended"),
...
enum DEFINED_TYPES(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ADVERSEEVENT
      extends DEFINED_TYPES("AdverseEvent", Some("AdverseEvent"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case BACKBONEELEMENT
      extends DEFINED_TYPES("BackboneElement", Some("BackboneElement"), Some("http://hl7.org/fhir/data-types"))
  ...
  case BIOLOGICALLYDERIVEDPRODUCT
      extends DEFINED_TYPES(
        ...
        Some("http://hl7.org/fhir/resource-types"))
  case BODYSTRUCTURE
      extends DEFINED_TYPES("BodyStructure", Some("BodyStructure"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case CATALOGENTRY
      extends DEFINED_TYPES("CatalogEntry", Some("CatalogEntry"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case CLAIMRESPONSE
      extends DEFINED_TYPES("ClaimResponse", Some("ClaimResponse"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case CODEABLECONCEPT
      extends DEFINED_TYPES("CodeableConcept", Some("CodeableConcept"), Some("http://hl7.org/fhir/data-types"))
  ...
  case COMMUNICATION
      extends DEFINED_TYPES("Communication", Some("Communication"), Some("http://hl7.org/fhir/resource-types"))
  case COMMUNICATIONREQUEST
      extends DEFINED_TYPES(
        "CommunicationRequest",
        Some("CommunicationRequest"),
  ...
  case CONTACTDETAIL
      extends DEFINED_TYPES("ContactDetail", Some("ContactDetail"), Some("http://hl7.org/fhir/data-types"))
  ...
  case DATAREQUIREMENT
      extends DEFINED_TYPES("DataRequirement", Some("DataRequirement"), Some("http://hl7.org/fhir/data-types"))
  ...
  case DETECTEDISSUE
      extends DEFINED_TYPES("DetectedIssue", Some("DetectedIssue"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case DEVICEMETRIC
      extends DEFINED_TYPES("DeviceMetric", Some("DeviceMetric"), Some("http://hl7.org/fhir/resource-types"))
  case DEVICEREQUEST
      extends DEFINED_TYPES("DeviceRequest", Some("DeviceRequest"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case DIAGNOSTICREPORT
      extends DEFINED_TYPES("DiagnosticReport", Some("DiagnosticReport"), Some("http://hl7.org/fhir/resource-types"))
  case DISTANCE extends DEFINED_TYPES("Distance", Some("Distance"), Some("http://hl7.org/fhir/data-types"))
  case DOCUMENTMANIFEST
      extends DEFINED_TYPES("DocumentManifest", Some("DocumentManifest"), Some("http://hl7.org/fhir/resource-types"))
  case DOCUMENTREFERENCE
      extends DEFINED_TYPES("DocumentReference", Some("DocumentReference"), Some("http://hl7.org/fhir/resource-types"))
  case DOMAINRESOURCE
      extends DEFINED_TYPES("DomainResource", Some("DomainResource"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case ENROLLMENTRESPONSE
      extends DEFINED_TYPES(
        ...
        Some("http://hl7.org/fhir/resource-types"))
  case EPISODEOFCARE
      extends DEFINED_TYPES("EpisodeOfCare", Some("EpisodeOfCare"), Some("http://hl7.org/fhir/resource-types"))
  case EVENTDEFINITION
      extends DEFINED_TYPES("EventDefinition", Some("EventDefinition"), Some("http://hl7.org/fhir/resource-types"))
  case EVIDENCE extends DEFINED_TYPES("Evidence", Some("Evidence"), Some("http://hl7.org/fhir/resource-types"))
  case EVIDENCEVARIABLE
      extends DEFINED_TYPES("EvidenceVariable", Some("EvidenceVariable"), Some("http://hl7.org/fhir/resource-types"))
  case EXAMPLESCENARIO
      extends DEFINED_TYPES("ExampleScenario", Some("ExampleScenario"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case GRAPHDEFINITION
      extends DEFINED_TYPES("GraphDefinition", Some("GraphDefinition"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case IMAGINGSTUDY
      extends DEFINED_TYPES("ImagingStudy", Some("ImagingStudy"), Some("http://hl7.org/fhir/resource-types"))
  case IMMUNIZATION
      extends DEFINED_TYPES("Immunization", Some("Immunization"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case INSURANCEPLAN
      extends DEFINED_TYPES("InsurancePlan", Some("InsurancePlan"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case MARKETINGSTATUS
      extends DEFINED_TYPES("MarketingStatus", Some("MarketingStatus"), Some("http://hl7.org/fhir/data-types"))
  case MEASURE extends DEFINED_TYPES("Measure", Some("Measure"), Some("http://hl7.org/fhir/resource-types"))
  case MEASUREREPORT
      extends DEFINED_TYPES("MeasureReport", Some("MeasureReport"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case MEDICATIONKNOWLEDGE
      extends DEFINED_TYPES(
        ...
        Some("http://hl7.org/fhir/resource-types"))
  case MEDICATIONREQUEST
      extends DEFINED_TYPES("MedicationRequest", Some("MedicationRequest"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case MEDICINALPRODUCT
      extends DEFINED_TYPES("MedicinalProduct", Some("MedicinalProduct"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case MESSAGEHEADER
      extends DEFINED_TYPES("MessageHeader", Some("MessageHeader"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case MONEYQUANTITY
      extends DEFINED_TYPES("MoneyQuantity", Some("MoneyQuantity"), Some("http://hl7.org/fhir/data-types"))
  case NAMINGSYSTEM
      extends DEFINED_TYPES("NamingSystem", Some("NamingSystem"), Some("http://hl7.org/fhir/resource-types"))
  case NARRATIVE extends DEFINED_TYPES("Narrative", Some("Narrative"), Some("http://hl7.org/fhir/data-types"))
  case NUTRITIONORDER
      extends DEFINED_TYPES("NutritionOrder", Some("NutritionOrder"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case OPERATIONOUTCOME
      extends DEFINED_TYPES("OperationOutcome", Some("OperationOutcome"), Some("http://hl7.org/fhir/resource-types"))
  case ORGANIZATION
      extends DEFINED_TYPES("Organization", Some("Organization"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case PAYMENTNOTICE
      extends DEFINED_TYPES("PaymentNotice", Some("PaymentNotice"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case PLANDEFINITION
      extends DEFINED_TYPES("PlanDefinition", Some("PlanDefinition"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case PRACTITIONER
      extends DEFINED_TYPES("Practitioner", Some("Practitioner"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case QUESTIONNAIRE
      extends DEFINED_TYPES("Questionnaire", Some("Questionnaire"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case RELATEDARTIFACT
      extends DEFINED_TYPES("RelatedArtifact", Some("RelatedArtifact"), Some("http://hl7.org/fhir/data-types"))
  case RELATEDPERSON
      extends DEFINED_TYPES("RelatedPerson", Some("RelatedPerson"), Some("http://hl7.org/fhir/resource-types"))
  case REQUESTGROUP
      extends DEFINED_TYPES("RequestGroup", Some("RequestGroup"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case RESEARCHELEMENTDEFINITION
      extends DEFINED_TYPES(
        ...
        Some("http://hl7.org/fhir/resource-types"))
  case RESEARCHSTUDY
      extends DEFINED_TYPES("ResearchStudy", Some("ResearchStudy"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case RISKASSESSMENT
      extends DEFINED_TYPES("RiskAssessment", Some("RiskAssessment"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case SERVICEREQUEST
      extends DEFINED_TYPES("ServiceRequest", Some("ServiceRequest"), Some("http://hl7.org/fhir/resource-types"))
  case SIGNATURE extends DEFINED_TYPES("Signature", Some("Signature"), Some("http://hl7.org/fhir/data-types"))
  case SIMPLEQUANTITY
      extends DEFINED_TYPES("SimpleQuantity", Some("SimpleQuantity"), Some("http://hl7.org/fhir/data-types"))
  ...
  case STRUCTUREDEFINITION
      extends DEFINED_TYPES(
        ...
        Some("http://hl7.org/fhir/resource-types"))
  case STRUCTUREMAP
      extends DEFINED_TYPES("StructureMap", Some("StructureMap"), Some("http://hl7.org/fhir/resource-types"))
  case SUBSCRIPTION
      extends DEFINED_TYPES("Subscription", Some("Subscription"), Some("http://hl7.org/fhir/resource-types"))
  case SUBSTANCE extends DEFINED_TYPES("Substance", Some("Substance"), Some("http://hl7.org/fhir/resource-types"))
  case SUBSTANCEAMOUNT
      extends DEFINED_TYPES("SubstanceAmount", Some("SubstanceAmount"), Some("http://hl7.org/fhir/data-types"))
  ...
  case SUBSTANCEPOLYMER
      extends DEFINED_TYPES("SubstancePolymer", Some("SubstancePolymer"), Some("http://hl7.org/fhir/resource-types"))
  case SUBSTANCEPROTEIN
      extends DEFINED_TYPES("SubstanceProtein", Some("SubstanceProtein"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case SUBSTANCESPECIFICATION
      extends DEFINED_TYPES(
        ...
        Some("http://hl7.org/fhir/resource-types"))
  case SUPPLYDELIVERY
      extends DEFINED_TYPES("SupplyDelivery", Some("SupplyDelivery"), Some("http://hl7.org/fhir/resource-types"))
  case SUPPLYREQUEST
      extends DEFINED_TYPES("SupplyRequest", Some("SupplyRequest"), Some("http://hl7.org/fhir/resource-types"))
...
enum DETECTEDISSUE_SEVERITY(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  ...
  case MODERATE
      extends DETECTEDISSUE_SEVERITY("moderate", Some("Moderate"), Some("http://hl7.org/fhir/detectedissue-severity"))
}
object DETECTEDISSUE_SEVERITY
    extends EType[DETECTEDISSUE_SEVERITY]("http://hl7.org/fhir/ValueSet/detectedissue-severity")

enum DEVICE_NAMETYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case MANUFACTURER_NAME
      extends DEVICE_NAMETYPE(
        "manufacturer-name",
        Some("Manufacturer name"),
        Some("http://hl7.org/fhir/device-nametype"))
  ...
  case PATIENT_REPORTED_NAME
      extends DEVICE_NAMETYPE(
        ...
        Some("Patient Reported name"),
        Some("http://hl7.org/fhir/device-nametype"))
  case UDI_LABEL_NAME
      extends DEVICE_NAMETYPE("udi-label-name", Some("UDI Label name"), Some("http://hl7.org/fhir/device-nametype"))
  case USER_FRIENDLY_NAME
      extends DEVICE_NAMETYPE(
        "user-friendly-name",
        Some("User Friendly name"),
        Some("http://hl7.org/fhir/device-nametype"))
}
object DEVICE_NAMETYPE extends EType[DEVICE_NAMETYPE]("http://hl7.org/fhir/ValueSet/device-nametype")

enum DEVICE_STATEMENT_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ACTIVE
      extends DEVICE_STATEMENT_STATUS("active", Some("Active"), Some("http://hl7.org/fhir/device-statement-status"))
  case COMPLETED
      extends DEVICE_STATEMENT_STATUS(
        "completed",
        Some("Completed"),
  ...
  case ENTERED_IN_ERROR
      extends DEVICE_STATEMENT_STATUS(
        ...
        Some("http://hl7.org/fhir/device-statement-status"))
  case INTENDED
      extends DEVICE_STATEMENT_STATUS("intended", Some("Intended"), Some("http://hl7.org/fhir/device-statement-status"))
  case ON_HOLD
      extends DEVICE_STATEMENT_STATUS("on-hold", Some("On Hold"), Some("http://hl7.org/fhir/device-statement-status"))
  case STOPPED
      extends DEVICE_STATEMENT_STATUS("stopped", Some("Stopped"), Some("http://hl7.org/fhir/device-statement-status"))
}
object DEVICE_STATEMENT_STATUS
    extends EType[DEVICE_STATEMENT_STATUS]("http://hl7.org/fhir/ValueSet/device-statement-status")
...
enum DIAGNOSTIC_REPORT_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case AMENDED
      extends DIAGNOSTIC_REPORT_STATUS("amended", Some("Amended"), Some("http://hl7.org/fhir/diagnostic-report-status"))
  case APPENDED
      extends DIAGNOSTIC_REPORT_STATUS(
        "appended",
        Some("Appended"),
  ...
  case ENTERED_IN_ERROR
      extends DIAGNOSTIC_REPORT_STATUS(
        ...
        Some("http://hl7.org/fhir/diagnostic-report-status"))
  case FINAL
      extends DIAGNOSTIC_REPORT_STATUS("final", Some("Final"), Some("http://hl7.org/fhir/diagnostic-report-status"))
  case PARTIAL
      extends DIAGNOSTIC_REPORT_STATUS("partial", Some("Partial"), Some("http://hl7.org/fhir/diagnostic-report-status"))
  case PRELIMINARY
      extends DIAGNOSTIC_REPORT_STATUS(
        "preliminary",
        Some("Preliminary"),
  ...
  case REGISTERED
      extends DIAGNOSTIC_REPORT_STATUS(
        ...
        Some("http://hl7.org/fhir/diagnostic-report-status"))
  case UNKNOWN
      extends DIAGNOSTIC_REPORT_STATUS("unknown", Some("Unknown"), Some("http://hl7.org/fhir/diagnostic-report-status"))
}
object DIAGNOSTIC_REPORT_STATUS
    extends EType[DIAGNOSTIC_REPORT_STATUS]("http://hl7.org/fhir/ValueSet/diagnostic-report-status")

enum DISCRIMINATOR_TYPE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
...
enum DOCUMENT_REFERENCE_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case CURRENT
      extends DOCUMENT_REFERENCE_STATUS(
        "current",
        Some("Current"),
        Some("http://hl7.org/fhir/document-reference-status"))
  case ENTERED_IN_ERROR
      extends DOCUMENT_REFERENCE_STATUS(
        "entered-in-error",
        Some("Entered in Error"),
...
object DOCUMENT_REFERENCE_STATUS
    extends EType[DOCUMENT_REFERENCE_STATUS]("http://hl7.org/fhir/ValueSet/document-reference-status")

enum DOCUMENT_RELATIONSHIP_TYPE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case APPENDS
      extends DOCUMENT_RELATIONSHIP_TYPE(
        "appends",
        Some("Appends"),
        Some("http://hl7.org/fhir/document-relationship-type"))
  case REPLACES
      extends DOCUMENT_RELATIONSHIP_TYPE(
        "replaces",
        Some("Replaces"),
        Some("http://hl7.org/fhir/document-relationship-type"))
  case SIGNS
      extends DOCUMENT_RELATIONSHIP_TYPE("signs", Some("Signs"), Some("http://hl7.org/fhir/document-relationship-type"))
  case TRANSFORMS
      extends DOCUMENT_RELATIONSHIP_TYPE(
        "transforms",
        Some("Transforms"),
...
object DOCUMENT_RELATIONSHIP_TYPE
    extends EType[DOCUMENT_RELATIONSHIP_TYPE]("http://hl7.org/fhir/ValueSet/document-relationship-type")

enum ELIGIBILITYREQUEST_PURPOSE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case BENEFITS
      extends ELIGIBILITYREQUEST_PURPOSE(
        "benefits",
        Some("Coverage benefits"),
        Some("http://hl7.org/fhir/eligibilityrequest-purpose"))
  case COVERAGE_AUTH_REQUIREMENTS
      extends ELIGIBILITYREQUEST_PURPOSE(
        "auth-requirements",
        Some("Coverage auth-requirements"),
        Some("http://hl7.org/fhir/eligibilityrequest-purpose"))
  case DISCOVERY
      extends ELIGIBILITYREQUEST_PURPOSE(
        "discovery",
        Some("Coverage Discovery"),
        Some("http://hl7.org/fhir/eligibilityrequest-purpose"))
  case VALIDATION
      extends ELIGIBILITYREQUEST_PURPOSE(
        "validation",
        Some("Coverage Validation"),
        Some("http://hl7.org/fhir/eligibilityrequest-purpose"))
}
object ELIGIBILITYREQUEST_PURPOSE
    extends EType[ELIGIBILITYREQUEST_PURPOSE]("http://hl7.org/fhir/ValueSet/eligibilityrequest-purpose")

enum ELIGIBILITYRESPONSE_PURPOSE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case BENEFITS
      extends ELIGIBILITYRESPONSE_PURPOSE(
        "benefits",
        Some("Coverage benefits"),
        Some("http://hl7.org/fhir/eligibilityresponse-purpose"))
  case COVERAGE_AUTH_REQUIREMENTS
      extends ELIGIBILITYRESPONSE_PURPOSE(
        "auth-requirements",
        Some("Coverage auth-requirements"),
...
object ELIGIBILITYRESPONSE_PURPOSE
    extends EType[ELIGIBILITYRESPONSE_PURPOSE]("http://hl7.org/fhir/ValueSet/eligibilityresponse-purpose")

enum ENCOUNTER_LOCATION_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ACTIVE
      extends ENCOUNTER_LOCATION_STATUS("active", Some("Active"), Some("http://hl7.org/fhir/encounter-location-status"))
  case COMPLETED
      extends ENCOUNTER_LOCATION_STATUS(
        "completed",
        Some("Completed"),
        Some("http://hl7.org/fhir/encounter-location-status"))
  case PLANNED
      extends ENCOUNTER_LOCATION_STATUS(
        "planned",
        Some("Planned"),
...
enum ENCOUNTER_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case IN_PROGRESS
      extends ENCOUNTER_STATUS("in-progress", Some("In Progress"), Some("http://hl7.org/fhir/encounter-status"))
...
enum EPISODE_OF_CARE_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ACTIVE
      extends EPISODE_OF_CARE_STATUS("active", Some("Active"), Some("http://hl7.org/fhir/episode-of-care-status"))
  case CANCELLED
      extends EPISODE_OF_CARE_STATUS("cancelled", Some("Cancelled"), Some("http://hl7.org/fhir/episode-of-care-status"))
  case ENTERED_IN_ERROR
      extends EPISODE_OF_CARE_STATUS(
        "entered-in-error",
        Some("Entered in Error"),
        Some("http://hl7.org/fhir/episode-of-care-status"))
  case FINISHED
      extends EPISODE_OF_CARE_STATUS("finished", Some("Finished"), Some("http://hl7.org/fhir/episode-of-care-status"))
  case ONHOLD
      extends EPISODE_OF_CARE_STATUS("onhold", Some("On Hold"), Some("http://hl7.org/fhir/episode-of-care-status"))
  case PLANNED
      extends EPISODE_OF_CARE_STATUS("planned", Some("Planned"), Some("http://hl7.org/fhir/episode-of-care-status"))
  case WAITLIST
      extends EPISODE_OF_CARE_STATUS("waitlist", Some("Waitlist"), Some("http://hl7.org/fhir/episode-of-care-status"))
}
object EPISODE_OF_CARE_STATUS
    extends EType[EPISODE_OF_CARE_STATUS]("http://hl7.org/fhir/ValueSet/episode-of-care-status")

enum EVENT_CAPABILITY_MODE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case RECEIVER
      extends EVENT_CAPABILITY_MODE("receiver", Some("Receiver"), Some("http://hl7.org/fhir/event-capability-mode"))
...
enum EXAMPLESCENARIO_ACTOR_TYPE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ENTITY
      extends EXAMPLESCENARIO_ACTOR_TYPE(
        "entity",
        Some("System"),
        Some("http://hl7.org/fhir/examplescenario-actor-type"))
  case PERSON
      extends EXAMPLESCENARIO_ACTOR_TYPE(
        "person",
        Some("Person"),
...
object EXAMPLESCENARIO_ACTOR_TYPE
    extends EType[EXAMPLESCENARIO_ACTOR_TYPE]("http://hl7.org/fhir/ValueSet/examplescenario-actor-type")

enum EXPLANATIONOFBENEFIT_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ACTIVE
      extends EXPLANATIONOFBENEFIT_STATUS(
        "active",
        Some("Active"),
        Some("http://hl7.org/fhir/explanationofbenefit-status"))
  case CANCELLED
      extends EXPLANATIONOFBENEFIT_STATUS(
        "cancelled",
        Some("Cancelled"),
...
object EXPLANATIONOFBENEFIT_STATUS
    extends EType[EXPLANATIONOFBENEFIT_STATUS]("http://hl7.org/fhir/ValueSet/explanationofbenefit-status")
...
enum EXPOSURE_STATE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case EXPOSURE_ALTERNATIVE
      extends EXPOSURE_STATE(
        "exposure-alternative",
        Some("Exposure Alternative"),
        Some("http://hl7.org/fhir/exposure-state"))
}
object EXPOSURE_STATE extends EType[EXPOSURE_STATE]("http://hl7.org/fhir/ValueSet/exposure-state")

enum EXTENSION_CONTEXT_TYPE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ELEMENT
      extends EXTENSION_CONTEXT_TYPE("element", Some("Element ID"), Some("http://hl7.org/fhir/extension-context-type"))
  case EXTENSION
      extends EXTENSION_CONTEXT_TYPE(
        "extension",
        Some("Extension URL"),
        Some("http://hl7.org/fhir/extension-context-type"))
  case FHIRPATH
      extends EXTENSION_CONTEXT_TYPE("fhirpath", Some("FHIRPath"), Some("http://hl7.org/fhir/extension-context-type"))
}
object EXTENSION_CONTEXT_TYPE
    extends EType[EXTENSION_CONTEXT_TYPE]("http://hl7.org/fhir/ValueSet/extension-context-type")
...
enum FILTER_OPERATOR(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case DESCENDENT_OF
      extends FILTER_OPERATOR(
        "descendent-of",
        Some("Descendent Of (by subsumption)"),
        Some("http://hl7.org/fhir/filter-operator"))
  ...
  case GENERALIZES
      extends FILTER_OPERATOR(
        "generalizes",
        Some("Generalizes (by Subsumption)"),
        Some("http://hl7.org/fhir/filter-operator"))
...
enum FLAG_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ENTERED_IN_ERROR
      extends FLAG_STATUS("entered-in-error", Some("Entered in Error"), Some("http://hl7.org/fhir/flag-status"))
...
enum FM_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ENTERED_IN_ERROR
      extends FM_STATUS("entered-in-error", Some("Entered in Error"), Some("http://hl7.org/fhir/fm-status"))
}
...
enum GOAL_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ENTERED_IN_ERROR
      extends GOAL_STATUS("entered-in-error", Some("Entered in Error"), Some("http://hl7.org/fhir/goal-status"))
...
enum GRAPH_COMPARTMENT_RULE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case CUSTOM
      extends GRAPH_COMPARTMENT_RULE("custom", Some("Custom"), Some("http://hl7.org/fhir/graph-compartment-rule"))
  case DIFFERENT
      extends GRAPH_COMPARTMENT_RULE("different", Some("Different"), Some("http://hl7.org/fhir/graph-compartment-rule"))
  case IDENTICAL
      extends GRAPH_COMPARTMENT_RULE("identical", Some("Identical"), Some("http://hl7.org/fhir/graph-compartment-rule"))
  case MATCHING
      extends GRAPH_COMPARTMENT_RULE("matching", Some("Matching"), Some("http://hl7.org/fhir/graph-compartment-rule"))
}
object GRAPH_COMPARTMENT_RULE
    extends EType[GRAPH_COMPARTMENT_RULE]("http://hl7.org/fhir/ValueSet/graph-compartment-rule")

enum GRAPH_COMPARTMENT_USE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case CONDITION
      extends GRAPH_COMPARTMENT_USE("condition", Some("Condition"), Some("http://hl7.org/fhir/graph-compartment-use"))
  case REQUIREMENT
      extends GRAPH_COMPARTMENT_USE(
        "requirement",
        Some("Requirement"),
        Some("http://hl7.org/fhir/graph-compartment-use"))
}
...
enum GROUP_MEASURE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case MEAN_OF_STUDY_MEANS
      extends GROUP_MEASURE("mean-of-mean", Some("Mean of Study Means"), Some("http://hl7.org/fhir/group-measure"))
  case MEAN_OF_STUDY_MEDINS
      extends GROUP_MEASURE("mean-of-median", Some("Mean of Study Medins"), Some("http://hl7.org/fhir/group-measure"))
  case MEDIAN extends GROUP_MEASURE("median", Some("Median"), Some("http://hl7.org/fhir/group-measure"))
  case MEDIAN_OF_STUDY_MEANS
      extends GROUP_MEASURE("median-of-mean", Some("Median of Study Means"), Some("http://hl7.org/fhir/group-measure"))
  case MEDIAN_OF_STUDY_MEDIANS
      extends GROUP_MEASURE(
        "median-of-median",
        Some("Median of Study Medians"),
        Some("http://hl7.org/fhir/group-measure"))
}
...
enum GUIDANCE_RESPONSE_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case DATA_REQUESTED
      extends GUIDANCE_RESPONSE_STATUS(
        "data-requested",
        Some("Data Requested"),
        Some("http://hl7.org/fhir/guidance-response-status"))
  case DATA_REQUIRED
      extends GUIDANCE_RESPONSE_STATUS(
        "data-required",
        Some("Data Required"),
  ...
  case ENTERED_IN_ERROR
      extends GUIDANCE_RESPONSE_STATUS(
        ...
        Some("http://hl7.org/fhir/guidance-response-status"))
  case FAILURE
      extends GUIDANCE_RESPONSE_STATUS("failure", Some("Failure"), Some("http://hl7.org/fhir/guidance-response-status"))
  case IN_PROGRESS
      extends GUIDANCE_RESPONSE_STATUS(
        "in-progress",
        Some("In Progress"),
        Some("http://hl7.org/fhir/guidance-response-status"))
  case SUCCESS
      extends GUIDANCE_RESPONSE_STATUS("success", Some("Success"), Some("http://hl7.org/fhir/guidance-response-status"))
}
object GUIDANCE_RESPONSE_STATUS
    extends EType[GUIDANCE_RESPONSE_STATUS]("http://hl7.org/fhir/ValueSet/guidance-response-status")

enum GUIDE_PAGE_GENERATION(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case GENERATED
      extends GUIDE_PAGE_GENERATION("generated", Some("Generated"), Some("http://hl7.org/fhir/guide-page-generation"))
  case HTML extends GUIDE_PAGE_GENERATION("html", Some("HTML"), Some("http://hl7.org/fhir/guide-page-generation"))
  case MARKDOWN
      extends GUIDE_PAGE_GENERATION("markdown", Some("Markdown"), Some("http://hl7.org/fhir/guide-page-generation"))
...
enum GUIDE_PARAMETER_CODE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case APPLY
      extends GUIDE_PARAMETER_CODE(
        "apply",
        Some("Apply Metadata Value"),
        Some("http://hl7.org/fhir/guide-parameter-code"))
  case BROKEN_LINKS_RULE
      extends GUIDE_PARAMETER_CODE(
        "rule-broken-links",
  ...
  case HTML_TEMPLATE
      extends GUIDE_PARAMETER_CODE(
        ...
        Some("http://hl7.org/fhir/guide-parameter-code"))
  case PAGES_PATH
      extends GUIDE_PARAMETER_CODE("path-pages", Some("Pages Path"), Some("http://hl7.org/fhir/guide-parameter-code"))
  case RESOURCE_PATH
      extends GUIDE_PARAMETER_CODE(
        "path-resource",
        Some("Resource Path"),
        Some("http://hl7.org/fhir/guide-parameter-code"))
  case TERMINOLOGY_CACHE_PATH
      extends GUIDE_PARAMETER_CODE(
        "path-tx-cache",
...
enum HISTORY_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case HEALTH_UNKNOWN
      extends HISTORY_STATUS("health-unknown", Some("Health Unknown"), Some("http://hl7.org/fhir/history-status"))
...
enum IDENTITY_ASSURANCELEVEL(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case LEVEL1
      extends IDENTITY_ASSURANCELEVEL("level1", Some("Level 1"), Some("http://hl7.org/fhir/identity-assuranceLevel"))
  case LEVEL2
      extends IDENTITY_ASSURANCELEVEL("level2", Some("Level 2"), Some("http://hl7.org/fhir/identity-assuranceLevel"))
  case LEVEL3
      extends IDENTITY_ASSURANCELEVEL("level3", Some("Level 3"), Some("http://hl7.org/fhir/identity-assuranceLevel"))
  case LEVEL4
      extends IDENTITY_ASSURANCELEVEL("level4", Some("Level 4"), Some("http://hl7.org/fhir/identity-assuranceLevel"))
}
object IDENTITY_ASSURANCELEVEL
    extends EType[IDENTITY_ASSURANCELEVEL]("http://hl7.org/fhir/ValueSet/identity-assuranceLevel")

enum IMAGINGSTUDY_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case AVAILABLE
      extends IMAGINGSTUDY_STATUS("available", Some("Available"), Some("http://hl7.org/fhir/imagingstudy-status"))
  case CANCELLED
      extends IMAGINGSTUDY_STATUS("cancelled", Some("Cancelled"), Some("http://hl7.org/fhir/imagingstudy-status"))
  case ENTERED_IN_ERROR
      extends IMAGINGSTUDY_STATUS(
        "entered-in-error",
        Some("Entered in Error"),
        Some("http://hl7.org/fhir/imagingstudy-status"))
  case REGISTERED
      extends IMAGINGSTUDY_STATUS("registered", Some("Registered"), Some("http://hl7.org/fhir/imagingstudy-status"))
...
enum IMMUNIZATION_EVALUATION_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case COMPLETED
      extends IMMUNIZATION_EVALUATION_STATUS(
        "completed",
        Some("completed"),
        Some("http://terminology.hl7.org/CodeSystem/medication-admin-status"))
  case ENTERED_IN_ERROR
      extends IMMUNIZATION_EVALUATION_STATUS(
        "entered-in-error",
        Some("entered-in-error"),
...
object IMMUNIZATION_EVALUATION_STATUS
    extends EType[IMMUNIZATION_EVALUATION_STATUS]("http://hl7.org/fhir/ValueSet/immunization-evaluation-status")

enum IMMUNIZATION_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case COMPLETED extends IMMUNIZATION_STATUS("completed", Some("completed"), Some("http://hl7.org/fhir/event-status"))
  case ENTERED_IN_ERROR
      extends IMMUNIZATION_STATUS(
        "entered-in-error",
        Some("entered-in-error"),
        Some("http://hl7.org/fhir/event-status"))
...
enum INVOICE_PRICECOMPONENTTYPE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case BASE
      extends INVOICE_PRICECOMPONENTTYPE(
        "base",
        Some("base price"),
        Some("http://hl7.org/fhir/invoice-priceComponentType"))
  case DEDUCTION
      extends INVOICE_PRICECOMPONENTTYPE(
        "deduction",
        Some("deduction"),
  ...
  case SURCHARGE
      extends INVOICE_PRICECOMPONENTTYPE(
        ...
        Some("http://hl7.org/fhir/invoice-priceComponentType"))
  case TAX
      extends INVOICE_PRICECOMPONENTTYPE("tax", Some("tax"), Some("http://hl7.org/fhir/invoice-priceComponentType"))
}
...
enum ISSUE_SEVERITY(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case INFORMATION
      extends ISSUE_SEVERITY("information", Some("Information"), Some("http://hl7.org/fhir/issue-severity"))
...
enum ISSUE_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case BUSINESS_RULE_VIOLATION
      extends ISSUE_TYPE("business-rule", Some("Business Rule Violation"), Some("http://hl7.org/fhir/issue-type"))
  ...
  case INFORMATIONAL
      extends ISSUE_TYPE("informational", Some("Informational Note"), Some("http://hl7.org/fhir/issue-type"))
  ...
  case MULTIPLE_MATCHES
      extends ISSUE_TYPE("multiple-matches", Some("Multiple Matches"), Some("http://hl7.org/fhir/issue-type"))
  case NOT_FOUND extends ISSUE_TYPE("not-found", Some("Not Found"), Some("http://hl7.org/fhir/issue-type"))
  case NO_STORE_AVAILABLE
      extends ISSUE_TYPE("no-store", Some("No Store Available"), Some("http://hl7.org/fhir/issue-type"))
  case OPERATION_TOO_COSTLY
      extends ISSUE_TYPE("too-costly", Some("Operation Too Costly"), Some("http://hl7.org/fhir/issue-type"))
  ...
  case SUPPRESSED
      extends ISSUE_TYPE("suppressed", Some("Information  Suppressed"), Some("http://hl7.org/fhir/issue-type"))
...
enum LINKAGE_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case HISTORICAL
      extends LINKAGE_TYPE("historical", Some("Historical/Obsolete Record"), Some("http://hl7.org/fhir/linkage-type"))
...
enum LIST_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ENTERED_IN_ERROR
      extends LIST_STATUS("entered-in-error", Some("Entered In Error"), Some("http://hl7.org/fhir/list-status"))
...
enum MAP_GROUP_TYPE_MODE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case NONE extends MAP_GROUP_TYPE_MODE("none", Some("Not a Default"), Some("http://hl7.org/fhir/map-group-type-mode"))
  case TYPES
      extends MAP_GROUP_TYPE_MODE(
        "types",
        Some("Default for Type Combination"),
        Some("http://hl7.org/fhir/map-group-type-mode"))
  case TYPE_AND_TYPES
      extends MAP_GROUP_TYPE_MODE(
        "type-and-types",
        Some("Default for type + combination"),
...
enum MAP_MODEL_MODE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case PRODUCED
      extends MAP_MODEL_MODE(
        "produced",
        Some("Produced Structure Definition"),
        Some("http://hl7.org/fhir/map-model-mode"))
  case QUERIED
      extends MAP_MODEL_MODE(
        "queried",
        Some("Queried Structure Definition"),
        Some("http://hl7.org/fhir/map-model-mode"))
  case SOURCE
      extends MAP_MODEL_MODE("source", Some("Source Structure Definition"), Some("http://hl7.org/fhir/map-model-mode"))
  case TARGET
      extends MAP_MODEL_MODE("target", Some("Target Structure Definition"), Some("http://hl7.org/fhir/map-model-mode"))
}
object MAP_MODEL_MODE extends EType[MAP_MODEL_MODE]("http://hl7.org/fhir/ValueSet/map-model-mode")

enum MAP_SOURCE_LIST_MODE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  ...
  case NOT_FIRST
      extends MAP_SOURCE_LIST_MODE(
        "not_first",
        Some("All but the first"),
        Some("http://hl7.org/fhir/map-source-list-mode"))
  case NOT_LAST
      extends MAP_SOURCE_LIST_MODE(
        "not_last",
        Some("All but the last"),
        Some("http://hl7.org/fhir/map-source-list-mode"))
  case ONLY_ONE
      extends MAP_SOURCE_LIST_MODE(
        "only_one",
        Some("Enforce only one"),
        Some("http://hl7.org/fhir/map-source-list-mode"))
}
object MAP_SOURCE_LIST_MODE extends EType[MAP_SOURCE_LIST_MODE]("http://hl7.org/fhir/ValueSet/map-source-list-mode")

enum MAP_TARGET_LIST_MODE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case COLLATE
      extends MAP_TARGET_LIST_MODE("collate", Some("Collate"), Some("http://hl7.org/fhir/map-target-list-mode"))
...
enum MEASURE_REPORT_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case COMPLETE
      extends MEASURE_REPORT_STATUS("complete", Some("Complete"), Some("http://hl7.org/fhir/measure-report-status"))
  case ERROR extends MEASURE_REPORT_STATUS("error", Some("Error"), Some("http://hl7.org/fhir/measure-report-status"))
  case PENDING
      extends MEASURE_REPORT_STATUS("pending", Some("Pending"), Some("http://hl7.org/fhir/measure-report-status"))
}
object MEASURE_REPORT_STATUS extends EType[MEASURE_REPORT_STATUS]("http://hl7.org/fhir/ValueSet/measure-report-status")

enum MEASURE_REPORT_TYPE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case DATA_COLLECTION
      extends MEASURE_REPORT_TYPE(
        "data-collection",
        Some("Data Collection"),
        Some("http://hl7.org/fhir/measure-report-type"))
  case INDIVIDUAL
      extends MEASURE_REPORT_TYPE("individual", Some("Individual"), Some("http://hl7.org/fhir/measure-report-type"))
  case SUBJECT_LIST
      extends MEASURE_REPORT_TYPE("subject-list", Some("Subject List"), Some("http://hl7.org/fhir/measure-report-type"))
...
enum MEDICATIONDISPENSE_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case CANCELLED
      extends MEDICATIONDISPENSE_STATUS(
        "cancelled",
        Some("Cancelled"),
        Some("http://terminology.hl7.org/CodeSystem/medicationdispense-status"))
  case COMPLETED
      extends MEDICATIONDISPENSE_STATUS(
        "completed",
        Some("Completed"),
...
object MEDICATIONDISPENSE_STATUS
    extends EType[MEDICATIONDISPENSE_STATUS]("http://hl7.org/fhir/ValueSet/medicationdispense-status")

enum MEDICATIONKNOWLEDGE_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ACTIVE
      extends MEDICATIONKNOWLEDGE_STATUS(
        "active",
        Some("Active"),
        Some("http://terminology.hl7.org/CodeSystem/medicationknowledge-status"))
  case ENTERED_IN_ERROR
      extends MEDICATIONKNOWLEDGE_STATUS(
        "entered-in-error",
        Some("Entered in Error"),
...
object MEDICATIONKNOWLEDGE_STATUS
    extends EType[MEDICATIONKNOWLEDGE_STATUS]("http://hl7.org/fhir/ValueSet/medicationknowledge-status")

enum MEDICATIONREQUEST_INTENT(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case FILLER_ORDER
      extends MEDICATIONREQUEST_INTENT(
        "filler-order",
        Some("Filler Order"),
        Some("http://hl7.org/fhir/CodeSystem/medicationrequest-intent"))
  case INSTANCE_ORDER
      extends MEDICATIONREQUEST_INTENT(
        "instance-order",
        Some("Instance Order"),
...
object MEDICATIONREQUEST_INTENT
    extends EType[MEDICATIONREQUEST_INTENT]("http://hl7.org/fhir/ValueSet/medicationrequest-intent")

enum MEDICATIONREQUEST_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ACTIVE
      extends MEDICATIONREQUEST_STATUS(
        "active",
        Some("Active"),
        Some("http://hl7.org/fhir/CodeSystem/medicationrequest-status"))
  case CANCELLED
      extends MEDICATIONREQUEST_STATUS(
        "cancelled",
        Some("Cancelled"),
...
object MEDICATIONREQUEST_STATUS
    extends EType[MEDICATIONREQUEST_STATUS]("http://hl7.org/fhir/ValueSet/medicationrequest-status")

enum MEDICATION_ADMIN_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case COMPLETED
      extends MEDICATION_ADMIN_STATUS(
        "completed",
        Some("Completed"),
        Some("http://terminology.hl7.org/CodeSystem/medication-admin-status"))
  case ENTERED_IN_ERROR
...
object MEDICATION_ADMIN_STATUS
    extends EType[MEDICATION_ADMIN_STATUS]("http://hl7.org/fhir/ValueSet/medication-admin-status")

enum MEDICATION_STATEMENT_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ACTIVE
      extends MEDICATION_STATEMENT_STATUS(
        "active",
        Some("Active"),
        Some("http://hl7.org/fhir/CodeSystem/medication-statement-status"))
  case COMPLETED
      extends MEDICATION_STATEMENT_STATUS(
        "completed",
        Some("Completed"),
...
object MEDICATION_STATEMENT_STATUS
    extends EType[MEDICATION_STATEMENT_STATUS]("http://hl7.org/fhir/ValueSet/medication-statement-status")

enum MEDICATION_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case ACTIVE
      extends MEDICATION_STATUS("active", Some("Active"), Some("http://hl7.org/fhir/CodeSystem/medication-status"))
  case ENTERED_IN_ERROR
      extends MEDICATION_STATUS(
        "entered-in-error",
        Some("Entered in Error"),
        Some("http://hl7.org/fhir/CodeSystem/medication-status"))
  case INACTIVE
      extends MEDICATION_STATUS("inactive", Some("Inactive"), Some("http://hl7.org/fhir/CodeSystem/medication-status"))
}
object MEDICATION_STATUS extends EType[MEDICATION_STATUS]("http://hl7.org/fhir/ValueSet/medication-status")

enum MESSAGEHEADER_RESPONSE_REQUEST(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ALWAYS
      extends MESSAGEHEADER_RESPONSE_REQUEST(
        "always",
        Some("Always"),
        Some("http://hl7.org/fhir/messageheader-response-request"))
  case NEVER
      extends MESSAGEHEADER_RESPONSE_REQUEST(
        "never",
        Some("Never"),
  ...
  case ON_ERROR
      extends MESSAGEHEADER_RESPONSE_REQUEST(
        "on-error",
        Some("Error/reject conditions only"),
        Some("http://hl7.org/fhir/messageheader-response-request"))
  case SUCCESSFUL_COMPLETION_ONLY
      extends MESSAGEHEADER_RESPONSE_REQUEST(
        "on-success",
        Some("Successful completion only"),
        Some("http://hl7.org/fhir/messageheader-response-request"))
}
object MESSAGEHEADER_RESPONSE_REQUEST
    extends EType[MESSAGEHEADER_RESPONSE_REQUEST]("http://hl7.org/fhir/ValueSet/messageheader-response-request")

enum MESSAGE_SIGNIFICANCE_CATEGORY(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case CONSEQUENCE
      extends MESSAGE_SIGNIFICANCE_CATEGORY(
        "consequence",
        Some("Consequence"),
        Some("http://hl7.org/fhir/message-significance-category"))
  case CURRENCY
      extends MESSAGE_SIGNIFICANCE_CATEGORY(
        "currency",
        Some("Currency"),
...
object MESSAGE_SIGNIFICANCE_CATEGORY
    extends EType[MESSAGE_SIGNIFICANCE_CATEGORY]("http://hl7.org/fhir/ValueSet/message-significance-category")

enum METRIC_CALIBRATION_STATE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case CALIBRATED
      extends METRIC_CALIBRATION_STATE(
        "calibrated",
        Some("Calibrated"),
        Some("http://hl7.org/fhir/metric-calibration-state"))
...
object METRIC_CALIBRATION_STATE
    extends EType[METRIC_CALIBRATION_STATE]("http://hl7.org/fhir/ValueSet/metric-calibration-state")

enum METRIC_CALIBRATION_TYPE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case GAIN extends METRIC_CALIBRATION_TYPE("gain", Some("Gain"), Some("http://hl7.org/fhir/metric-calibration-type"))
  case OFFSET
      extends METRIC_CALIBRATION_TYPE("offset", Some("Offset"), Some("http://hl7.org/fhir/metric-calibration-type"))
  case TWO_POINT
      extends METRIC_CALIBRATION_TYPE(
        "two-point",
        Some("Two Point"),
        Some("http://hl7.org/fhir/metric-calibration-type"))
  case UNSPECIFIED
      extends METRIC_CALIBRATION_TYPE(
        "unspecified",
        Some("Unspecified"),
...
object METRIC_CALIBRATION_TYPE
    extends EType[METRIC_CALIBRATION_TYPE]("http://hl7.org/fhir/ValueSet/metric-calibration-type")

enum METRIC_CATEGORY(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case CALCULATION
      extends METRIC_CATEGORY("calculation", Some("Calculation"), Some("http://hl7.org/fhir/metric-category"))
  case MEASUREMENT
      extends METRIC_CATEGORY("measurement", Some("Measurement"), Some("http://hl7.org/fhir/metric-category"))
  case SETTING extends METRIC_CATEGORY("setting", Some("Setting"), Some("http://hl7.org/fhir/metric-category"))
  case UNSPECIFIED
      extends METRIC_CATEGORY("unspecified", Some("Unspecified"), Some("http://hl7.org/fhir/metric-category"))
}
...
enum METRIC_OPERATIONAL_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ENTERED_IN_ERROR
      extends METRIC_OPERATIONAL_STATUS(
        "entered-in-error",
        Some("Entered In Error"),
...
object METRIC_OPERATIONAL_STATUS
    extends EType[METRIC_OPERATIONAL_STATUS]("http://hl7.org/fhir/ValueSet/metric-operational-status")

enum NAMINGSYSTEM_IDENTIFIER_TYPE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case OID
      extends NAMINGSYSTEM_IDENTIFIER_TYPE("oid", Some("OID"), Some("http://hl7.org/fhir/namingsystem-identifier-type"))
  case OTHER
      extends NAMINGSYSTEM_IDENTIFIER_TYPE(
        "other",
        Some("Other"),
        Some("http://hl7.org/fhir/namingsystem-identifier-type"))
  case URI
      extends NAMINGSYSTEM_IDENTIFIER_TYPE("uri", Some("URI"), Some("http://hl7.org/fhir/namingsystem-identifier-type"))
  case UUID
      extends NAMINGSYSTEM_IDENTIFIER_TYPE(
        "uuid",
        Some("UUID"),
...
object NAMINGSYSTEM_IDENTIFIER_TYPE
    extends EType[NAMINGSYSTEM_IDENTIFIER_TYPE]("http://hl7.org/fhir/ValueSet/namingsystem-identifier-type")

enum NAMINGSYSTEM_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case CODESYSTEM
      extends NAMINGSYSTEM_TYPE("codesystem", Some("Code System"), Some("http://hl7.org/fhir/namingsystem-type"))
  case IDENTIFIER
      extends NAMINGSYSTEM_TYPE("identifier", Some("Identifier"), Some("http://hl7.org/fhir/namingsystem-type"))
...
enum NARRATIVE_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case ADDITIONAL
      extends NARRATIVE_STATUS("additional", Some("Additional"), Some("http://hl7.org/fhir/narrative-status"))
  case EMPTY extends NARRATIVE_STATUS("empty", Some("Empty"), Some("http://hl7.org/fhir/narrative-status"))
  case EXTENSIONS
      extends NARRATIVE_STATUS("extensions", Some("Extensions"), Some("http://hl7.org/fhir/narrative-status"))
...
enum OBSERVATION_RANGE_CATEGORY(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ABSOLUTE
      extends OBSERVATION_RANGE_CATEGORY(
        "absolute",
        Some("absolute range"),
        Some("http://hl7.org/fhir/observation-range-category"))
  case CRITICAL
      extends OBSERVATION_RANGE_CATEGORY(
        "critical",
        Some("critical range"),
...
enum OBSERVATION_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case AMENDED extends OBSERVATION_STATUS("amended", Some("Amended"), Some("http://hl7.org/fhir/observation-status"))
  case CANCELLED
      extends OBSERVATION_STATUS("cancelled", Some("Cancelled"), Some("http://hl7.org/fhir/observation-status"))
  case CORRECTED
      extends OBSERVATION_STATUS("corrected", Some("Corrected"), Some("http://hl7.org/fhir/observation-status"))
  case ENTERED_IN_ERROR
      extends OBSERVATION_STATUS(
        "entered-in-error",
        Some("Entered in Error"),
  ...
  case PRELIMINARY
      extends OBSERVATION_STATUS("preliminary", Some("Preliminary"), Some("http://hl7.org/fhir/observation-status"))
  case REGISTERED
      extends OBSERVATION_STATUS("registered", Some("Registered"), Some("http://hl7.org/fhir/observation-status"))
...
enum ORIENTATION_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case ANTISENSE
      extends ORIENTATION_TYPE(
        "antisense",
        Some("Antisense orientation of referenceSeq"),
        Some("http://hl7.org/fhir/orientation-type"))
  case SENSE
      extends ORIENTATION_TYPE(
        "sense",
        Some("Sense orientation of referenceSeq"),
        Some("http://hl7.org/fhir/orientation-type"))
}
object ORIENTATION_TYPE extends EType[ORIENTATION_TYPE]("http://hl7.org/fhir/ValueSet/orientation-type")

enum PARTICIPANTREQUIRED(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case INFORMATION_ONLY
      extends PARTICIPANTREQUIRED(
        "information-only",
        Some("Information Only"),
        Some("http://hl7.org/fhir/participantrequired"))
  case OPTIONAL
      extends PARTICIPANTREQUIRED("optional", Some("Optional"), Some("http://hl7.org/fhir/participantrequired"))
  case REQUIRED
      extends PARTICIPANTREQUIRED("required", Some("Required"), Some("http://hl7.org/fhir/participantrequired"))
}
object PARTICIPANTREQUIRED extends EType[PARTICIPANTREQUIRED]("http://hl7.org/fhir/ValueSet/participantrequired")

enum PARTICIPATIONSTATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ACCEPTED
      extends PARTICIPATIONSTATUS("accepted", Some("Accepted"), Some("http://hl7.org/fhir/participationstatus"))
  case DECLINED
      extends PARTICIPATIONSTATUS("declined", Some("Declined"), Some("http://hl7.org/fhir/participationstatus"))
  case NEEDS_ACTION
      extends PARTICIPATIONSTATUS("needs-action", Some("Needs Action"), Some("http://hl7.org/fhir/participationstatus"))
  case TENTATIVE
      extends PARTICIPATIONSTATUS("tentative", Some("Tentative"), Some("http://hl7.org/fhir/participationstatus"))
}
object PARTICIPATIONSTATUS extends EType[PARTICIPATIONSTATUS]("http://hl7.org/fhir/ValueSet/participationstatus")

enum PERMITTED_DATA_TYPE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case BOOLEAN extends PERMITTED_DATA_TYPE("boolean", Some("boolean"), Some("http://hl7.org/fhir/permitted-data-type"))
  case CODEABLECONCEPT
      extends PERMITTED_DATA_TYPE(
        "CodeableConcept",
        Some("CodeableConcept"),
        Some("http://hl7.org/fhir/permitted-data-type"))
  case DATETIME
      extends PERMITTED_DATA_TYPE("dateTime", Some("dateTime"), Some("http://hl7.org/fhir/permitted-data-type"))
  ...
  case QUANTITY
      extends PERMITTED_DATA_TYPE("Quantity", Some("Quantity"), Some("http://hl7.org/fhir/permitted-data-type"))
...
enum PRODUCT_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case UNAVAILABLE
      extends PRODUCT_STATUS("unavailable", Some("Unavailable"), Some("http://hl7.org/fhir/product-status"))
}
object PRODUCT_STATUS extends EType[PRODUCT_STATUS]("http://hl7.org/fhir/ValueSet/product-status")

enum PRODUCT_STORAGE_SCALE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case CELSIUS
      extends PRODUCT_STORAGE_SCALE("celsius", Some("Celsius"), Some("http://hl7.org/fhir/product-storage-scale"))
  case FARENHEIT
      extends PRODUCT_STORAGE_SCALE("farenheit", Some("Fahrenheit"), Some("http://hl7.org/fhir/product-storage-scale"))
...
enum PROPERTY_REPRESENTATION(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case CDATEXT
      extends PROPERTY_REPRESENTATION(
        "cdaText",
        Some("CDA Text Format"),
        Some("http://hl7.org/fhir/property-representation"))
  case TYPEATTR
      extends PROPERTY_REPRESENTATION(
        "typeAttr",
        Some("Type Attribute"),
        Some("http://hl7.org/fhir/property-representation"))
  case XHTML
      extends PROPERTY_REPRESENTATION("xhtml", Some("XHTML"), Some("http://hl7.org/fhir/property-representation"))
  case XMLATTR
      extends PROPERTY_REPRESENTATION(
        "xmlAttr",
        Some("XML Attribute"),
        Some("http://hl7.org/fhir/property-representation"))
  case XMLTEXT
      extends PROPERTY_REPRESENTATION("xmlText", Some("XML Text"), Some("http://hl7.org/fhir/property-representation"))
}
object PROPERTY_REPRESENTATION
    extends EType[PROPERTY_REPRESENTATION]("http://hl7.org/fhir/ValueSet/property-representation")

enum PROVENANCE_ENTITY_ROLE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case DERIVATION
      extends PROVENANCE_ENTITY_ROLE(
        "derivation",
        Some("Derivation"),
        Some("http://hl7.org/fhir/provenance-entity-role"))
  case QUOTATION
      extends PROVENANCE_ENTITY_ROLE("quotation", Some("Quotation"), Some("http://hl7.org/fhir/provenance-entity-role"))
  case REMOVAL
      extends PROVENANCE_ENTITY_ROLE("removal", Some("Removal"), Some("http://hl7.org/fhir/provenance-entity-role"))
  case REVISION
      extends PROVENANCE_ENTITY_ROLE("revision", Some("Revision"), Some("http://hl7.org/fhir/provenance-entity-role"))
  case SOURCE
      extends PROVENANCE_ENTITY_ROLE("source", Some("Source"), Some("http://hl7.org/fhir/provenance-entity-role"))
}
object PROVENANCE_ENTITY_ROLE
    extends EType[PROVENANCE_ENTITY_ROLE]("http://hl7.org/fhir/ValueSet/provenance-entity-role")

enum PUBLICATION_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
...
enum QUESTIONNAIRE_ANSWERS_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case AMENDED
      extends QUESTIONNAIRE_ANSWERS_STATUS(
        "amended",
        Some("Amended"),
        Some("http://hl7.org/fhir/questionnaire-answers-status"))
  case COMPLETED
      extends QUESTIONNAIRE_ANSWERS_STATUS(
        "completed",
        Some("Completed"),
...
object QUESTIONNAIRE_ANSWERS_STATUS
    extends EType[QUESTIONNAIRE_ANSWERS_STATUS]("http://hl7.org/fhir/ValueSet/questionnaire-answers-status")

enum QUESTIONNAIRE_ENABLE_BEHAVIOR(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ALL
      extends QUESTIONNAIRE_ENABLE_BEHAVIOR(
        "all",
        Some("All"),
        Some("http://hl7.org/fhir/questionnaire-enable-behavior"))
  case ANY
      extends QUESTIONNAIRE_ENABLE_BEHAVIOR(
        "any",
        Some("Any"),
...
object QUESTIONNAIRE_ENABLE_BEHAVIOR
    extends EType[QUESTIONNAIRE_ENABLE_BEHAVIOR]("http://hl7.org/fhir/ValueSet/questionnaire-enable-behavior")

enum QUESTIONNAIRE_ENABLE_OPERATOR(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case EQUALS
      extends QUESTIONNAIRE_ENABLE_OPERATOR(
        "=",
        Some("Equals"),
        Some("http://hl7.org/fhir/questionnaire-enable-operator"))
  case EXISTS
      extends QUESTIONNAIRE_ENABLE_OPERATOR(
        "exists",
        Some("Exists"),
...
enum REACTION_EVENT_SEVERITY(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case MILD extends REACTION_EVENT_SEVERITY("mild", Some("Mild"), Some("http://hl7.org/fhir/reaction-event-severity"))
  case MODERATE
      extends REACTION_EVENT_SEVERITY("moderate", Some("Moderate"), Some("http://hl7.org/fhir/reaction-event-severity"))
  case SEVERE
      extends REACTION_EVENT_SEVERITY("severe", Some("Severe"), Some("http://hl7.org/fhir/reaction-event-severity"))
}
object REACTION_EVENT_SEVERITY
    extends EType[REACTION_EVENT_SEVERITY]("http://hl7.org/fhir/ValueSet/reaction-event-severity")

enum REFERENCE_HANDLING_POLICY(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ENFORCED
      extends REFERENCE_HANDLING_POLICY(
        "enforced",
        Some("Reference Integrity Enforced"),
        Some("http://hl7.org/fhir/reference-handling-policy"))
  case LITERAL
      extends REFERENCE_HANDLING_POLICY(
        "literal",
        Some("Literal References"),
        Some("http://hl7.org/fhir/reference-handling-policy"))
  case LOCAL
      extends REFERENCE_HANDLING_POLICY(
        "local",
        Some("Local References Only"),
        Some("http://hl7.org/fhir/reference-handling-policy"))
  case LOGICAL
      extends REFERENCE_HANDLING_POLICY(
        "logical",
        Some("Logical References"),
        Some("http://hl7.org/fhir/reference-handling-policy"))
  case RESOLVES
      extends REFERENCE_HANDLING_POLICY(
        "resolves",
        Some("Resolves References"),
        Some("http://hl7.org/fhir/reference-handling-policy"))
}
object REFERENCE_HANDLING_POLICY
    extends EType[REFERENCE_HANDLING_POLICY]("http://hl7.org/fhir/ValueSet/reference-handling-policy")

enum REFERENCE_VERSION_RULES(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case EITHER
      extends REFERENCE_VERSION_RULES(
        "either",
        Some("Either Specific or independent"),
        Some("http://hl7.org/fhir/reference-version-rules"))
  case INDEPENDENT
      extends REFERENCE_VERSION_RULES(
        "independent",
        Some("Version independent"),
        Some("http://hl7.org/fhir/reference-version-rules"))
  case SPECIFIC
      extends REFERENCE_VERSION_RULES(
        "specific",
...
object REFERENCE_VERSION_RULES
    extends EType[REFERENCE_VERSION_RULES]("http://hl7.org/fhir/ValueSet/reference-version-rules")

enum RELATION_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case REPLACED_BY
      extends RELATION_TYPE("is-replaced-by", Some("Replaced By"), Some("http://hl7.org/fhir/relation-type"))
...
enum REMITTANCE_OUTCOME(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case COMPLETE
      extends REMITTANCE_OUTCOME(
        "complete",
        Some("Processing Complete"),
        Some("http://hl7.org/fhir/remittance-outcome"))
  case ERROR extends REMITTANCE_OUTCOME("error", Some("Error"), Some("http://hl7.org/fhir/remittance-outcome"))
  case PARTIAL
      extends REMITTANCE_OUTCOME("partial", Some("Partial Processing"), Some("http://hl7.org/fhir/remittance-outcome"))
...
enum REPORT_ACTION_RESULT_CODES(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ERROR
      extends REPORT_ACTION_RESULT_CODES("error", Some("Error"), Some("http://hl7.org/fhir/report-action-result-codes"))
  case FAIL
      extends REPORT_ACTION_RESULT_CODES("fail", Some("Fail"), Some("http://hl7.org/fhir/report-action-result-codes"))
  case PASS
      extends REPORT_ACTION_RESULT_CODES("pass", Some("Pass"), Some("http://hl7.org/fhir/report-action-result-codes"))
  case SKIP
      extends REPORT_ACTION_RESULT_CODES("skip", Some("Skip"), Some("http://hl7.org/fhir/report-action-result-codes"))
  case WARNING
      extends REPORT_ACTION_RESULT_CODES(
        "warning",
        Some("Warning"),
        Some("http://hl7.org/fhir/report-action-result-codes"))
}
object REPORT_ACTION_RESULT_CODES
    extends EType[REPORT_ACTION_RESULT_CODES]("http://hl7.org/fhir/ValueSet/report-action-result-codes")

enum REPORT_PARTICIPANT_TYPE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case CLIENT
      extends REPORT_PARTICIPANT_TYPE("client", Some("Client"), Some("http://hl7.org/fhir/report-participant-type"))
  case SERVER
      extends REPORT_PARTICIPANT_TYPE("server", Some("Server"), Some("http://hl7.org/fhir/report-participant-type"))
  case TEST_ENGINE
      extends REPORT_PARTICIPANT_TYPE(
        "test-engine",
        Some("Test Engine"),
        Some("http://hl7.org/fhir/report-participant-type"))
}
object REPORT_PARTICIPANT_TYPE
    extends EType[REPORT_PARTICIPANT_TYPE]("http://hl7.org/fhir/ValueSet/report-participant-type")

enum REPORT_RESULT_CODES(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
...
enum REPORT_STATUS_CODES(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case COMPLETED
      extends REPORT_STATUS_CODES("completed", Some("Completed"), Some("http://hl7.org/fhir/report-status-codes"))
  case ENTERED_IN_ERROR
      extends REPORT_STATUS_CODES(
        "entered-in-error",
        Some("Entered In Error"),
        Some("http://hl7.org/fhir/report-status-codes"))
  case IN_PROGRESS
      extends REPORT_STATUS_CODES("in-progress", Some("In Progress"), Some("http://hl7.org/fhir/report-status-codes"))
...
enum REPOSITORY_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case DIRECTLINK
      extends REPOSITORY_TYPE("directlink", Some("Click and see"), Some("http://hl7.org/fhir/repository-type"))
  case LOGIN
      extends REPOSITORY_TYPE(
        "login",
        Some("Result cannot be access unless an account is logged in"),
...
enum REQUEST_INTENT(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case FILLER_ORDER
      extends REQUEST_INTENT("filler-order", Some("Filler Order"), Some("http://hl7.org/fhir/request-intent"))
  case INSTANCE_ORDER
      extends REQUEST_INTENT("instance-order", Some("Instance Order"), Some("http://hl7.org/fhir/request-intent"))
  ...
  case ORIGINAL_ORDER
      extends REQUEST_INTENT("original-order", Some("Original Order"), Some("http://hl7.org/fhir/request-intent"))
  ...
  case REFLEX_ORDER
      extends REQUEST_INTENT("reflex-order", Some("Reflex Order"), Some("http://hl7.org/fhir/request-intent"))
}
...
enum REQUEST_RESOURCE_TYPES(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case APPOINTMENT
  ...
  case APPOINTMENTRESPONSE
      extends REQUEST_RESOURCE_TYPES(
        ...
        Some("http://hl7.org/fhir/request-resource-types"))
  case CAREPLAN
      extends REQUEST_RESOURCE_TYPES("CarePlan", Some("CarePlan"), Some("http://hl7.org/fhir/request-resource-types"))
  ...
  case COMMUNICATIONREQUEST
      extends REQUEST_RESOURCE_TYPES(
        ...
        Some("http://hl7.org/fhir/request-resource-types"))
  case CONTRACT
      extends REQUEST_RESOURCE_TYPES("Contract", Some("Contract"), Some("http://hl7.org/fhir/request-resource-types"))
  case DEVICEREQUEST
      extends REQUEST_RESOURCE_TYPES(
        "DeviceRequest",
        Some("DeviceRequest"),
...
object REQUEST_RESOURCE_TYPES
    extends EType[REQUEST_RESOURCE_TYPES]("http://hl7.org/fhir/ValueSet/request-resource-types")
...
enum RESEARCH_ELEMENT_TYPE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case EXPOSURE
      extends RESEARCH_ELEMENT_TYPE("exposure", Some("Exposure"), Some("http://hl7.org/fhir/research-element-type"))
  case OUTCOME
      extends RESEARCH_ELEMENT_TYPE("outcome", Some("Outcome"), Some("http://hl7.org/fhir/research-element-type"))
  case POPULATION
...
enum RESEARCH_STUDY_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  ...
  case APPROVED
      extends RESEARCH_STUDY_STATUS("approved", Some("Approved"), Some("http://hl7.org/fhir/research-study-status"))
  ...
  case CLOSED_TO_ACCRUAL_AND_INTERVENTION
      extends RESEARCH_STUDY_STATUS(
        ...
        Some("http://hl7.org/fhir/research-study-status"))
  case COMPLETED
      extends RESEARCH_STUDY_STATUS("completed", Some("Completed"), Some("http://hl7.org/fhir/research-study-status"))
  case DISAPPROVED
      extends RESEARCH_STUDY_STATUS(
        "disapproved",
        Some("Disapproved"),
        Some("http://hl7.org/fhir/research-study-status"))
  case IN_REVIEW
      extends RESEARCH_STUDY_STATUS("in-review", Some("In Review"), Some("http://hl7.org/fhir/research-study-status"))
  ...
  case TEMPORARILY_CLOSED_TO_ACCRUAL_AND_INTERVENTION
      extends RESEARCH_STUDY_STATUS(
        ...
        Some("http://hl7.org/fhir/research-study-status"))
  case WITHDRAWN
      extends RESEARCH_STUDY_STATUS("withdrawn", Some("Withdrawn"), Some("http://hl7.org/fhir/research-study-status"))
}
object RESEARCH_STUDY_STATUS extends EType[RESEARCH_STUDY_STATUS]("http://hl7.org/fhir/ValueSet/research-study-status")

enum RESEARCH_SUBJECT_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case CANDIDATE
      extends RESEARCH_SUBJECT_STATUS(
        "candidate",
        Some("Candidate"),
        Some("http://hl7.org/fhir/research-subject-status"))
  case ELIGIBLE
      extends RESEARCH_SUBJECT_STATUS("eligible", Some("Eligible"), Some("http://hl7.org/fhir/research-subject-status"))
  case FOLLOW_UP
      extends RESEARCH_SUBJECT_STATUS(
        "follow-up",
        Some("Follow-up"),
  ...
  case OFF_STUDY
      extends RESEARCH_SUBJECT_STATUS(
        ...
        Some("http://hl7.org/fhir/research-subject-status"))
  case ON_STUDY
      extends RESEARCH_SUBJECT_STATUS("on-study", Some("On-study"), Some("http://hl7.org/fhir/research-subject-status"))
  case ON_STUDY_INTERVENTION
      extends RESEARCH_SUBJECT_STATUS(
        "on-study-intervention",
        Some("On-study-intervention"),
        Some("http://hl7.org/fhir/research-subject-status"))
  case ON_STUDY_OBSERVATION
      extends RESEARCH_SUBJECT_STATUS(
        "on-study-observation",
        Some("On-study-observation"),
        Some("http://hl7.org/fhir/research-subject-status"))
  case PENDING_ON_STUDY
      extends RESEARCH_SUBJECT_STATUS(
        "pending-on-study",
        Some("Pending on-study"),
        Some("http://hl7.org/fhir/research-subject-status"))
...
object RESEARCH_SUBJECT_STATUS
    extends EType[RESEARCH_SUBJECT_STATUS]("http://hl7.org/fhir/ValueSet/research-subject-status")

enum RESOURCE_AGGREGATION_MODE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case BUNDLED
      extends RESOURCE_AGGREGATION_MODE(
        "bundled",
        Some("Bundled"),
        Some("http://hl7.org/fhir/resource-aggregation-mode"))
  case CONTAINED
      extends RESOURCE_AGGREGATION_MODE(
        "contained",
        Some("Contained"),
...
object RESOURCE_AGGREGATION_MODE
    extends EType[RESOURCE_AGGREGATION_MODE]("http://hl7.org/fhir/ValueSet/resource-aggregation-mode")

enum RESOURCE_SLICING_RULES(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case CLOSED
      extends RESOURCE_SLICING_RULES("closed", Some("Closed"), Some("http://hl7.org/fhir/resource-slicing-rules"))
  case OPEN extends RESOURCE_SLICING_RULES("open", Some("Open"), Some("http://hl7.org/fhir/resource-slicing-rules"))
  case OPENATEND
      extends RESOURCE_SLICING_RULES(
        "openAtEnd",
        Some("Open at End"),
        Some("http://hl7.org/fhir/resource-slicing-rules"))
}
object RESOURCE_SLICING_RULES
    extends EType[RESOURCE_SLICING_RULES]("http://hl7.org/fhir/ValueSet/resource-slicing-rules")
...
enum RESOURCE_TYPES(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ACTIVITYDEFINITION
      extends RESOURCE_TYPES(
        ...
        Some("http://hl7.org/fhir/resource-types"))
  case ADVERSEEVENT
      extends RESOURCE_TYPES("AdverseEvent", Some("AdverseEvent"), Some("http://hl7.org/fhir/resource-types"))
  case ALLERGYINTOLERANCE
      extends RESOURCE_TYPES(
        "AllergyIntolerance",
        Some("AllergyIntolerance"),
        Some("http://hl7.org/fhir/resource-types"))
  case APPOINTMENT
      extends RESOURCE_TYPES("Appointment", Some("Appointment"), Some("http://hl7.org/fhir/resource-types"))
  case APPOINTMENTRESPONSE
      extends RESOURCE_TYPES(
        "AppointmentResponse",
        Some("AppointmentResponse"),
  ...
  case BIOLOGICALLYDERIVEDPRODUCT
      extends RESOURCE_TYPES(
        ...
        Some("http://hl7.org/fhir/resource-types"))
  case BODYSTRUCTURE
      extends RESOURCE_TYPES("BodyStructure", Some("BodyStructure"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case CATALOGENTRY
      extends RESOURCE_TYPES("CatalogEntry", Some("CatalogEntry"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case CLAIMRESPONSE
      extends RESOURCE_TYPES("ClaimResponse", Some("ClaimResponse"), Some("http://hl7.org/fhir/resource-types"))
  case CLINICALIMPRESSION
      extends RESOURCE_TYPES(
        "ClinicalImpression",
        Some("ClinicalImpression"),
  ...
  case COMMUNICATION
      extends RESOURCE_TYPES("Communication", Some("Communication"), Some("http://hl7.org/fhir/resource-types"))
  case COMMUNICATIONREQUEST
      extends RESOURCE_TYPES(
        "CommunicationRequest",
        Some("CommunicationRequest"),
  ...
  case COMPARTMENTDEFINITION
      extends RESOURCE_TYPES(
        ...
        Some("http://hl7.org/fhir/resource-types"))
  case COMPOSITION
      extends RESOURCE_TYPES("Composition", Some("Composition"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case COVERAGEELIGIBILITYRESPONSE
      extends RESOURCE_TYPES(
        ...
        Some("http://hl7.org/fhir/resource-types"))
  case DETECTEDISSUE
      extends RESOURCE_TYPES("DetectedIssue", Some("DetectedIssue"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case DEVICEMETRIC
      extends RESOURCE_TYPES("DeviceMetric", Some("DeviceMetric"), Some("http://hl7.org/fhir/resource-types"))
  case DEVICEREQUEST
      extends RESOURCE_TYPES("DeviceRequest", Some("DeviceRequest"), Some("http://hl7.org/fhir/resource-types"))
  case DEVICEUSESTATEMENT
      extends RESOURCE_TYPES(
        "DeviceUseStatement",
        Some("DeviceUseStatement"),
        Some("http://hl7.org/fhir/resource-types"))
  case DIAGNOSTICREPORT
      extends RESOURCE_TYPES("DiagnosticReport", Some("DiagnosticReport"), Some("http://hl7.org/fhir/resource-types"))
  case DOCUMENTMANIFEST
      extends RESOURCE_TYPES("DocumentManifest", Some("DocumentManifest"), Some("http://hl7.org/fhir/resource-types"))
  case DOCUMENTREFERENCE
      extends RESOURCE_TYPES("DocumentReference", Some("DocumentReference"), Some("http://hl7.org/fhir/resource-types"))
  case DOMAINRESOURCE
      extends RESOURCE_TYPES("DomainResource", Some("DomainResource"), Some("http://hl7.org/fhir/resource-types"))
  case EFFECTEVIDENCESYNTHESIS
      extends RESOURCE_TYPES(
        "EffectEvidenceSynthesis",
        Some("EffectEvidenceSynthesis"),
  ...
  case ENROLLMENTRESPONSE
      extends RESOURCE_TYPES(
        ...
        Some("http://hl7.org/fhir/resource-types"))
  case EPISODEOFCARE
      extends RESOURCE_TYPES("EpisodeOfCare", Some("EpisodeOfCare"), Some("http://hl7.org/fhir/resource-types"))
  case EVENTDEFINITION
      extends RESOURCE_TYPES("EventDefinition", Some("EventDefinition"), Some("http://hl7.org/fhir/resource-types"))
  case EVIDENCE extends RESOURCE_TYPES("Evidence", Some("Evidence"), Some("http://hl7.org/fhir/resource-types"))
  case EVIDENCEVARIABLE
      extends RESOURCE_TYPES("EvidenceVariable", Some("EvidenceVariable"), Some("http://hl7.org/fhir/resource-types"))
  case EXAMPLESCENARIO
      extends RESOURCE_TYPES("ExampleScenario", Some("ExampleScenario"), Some("http://hl7.org/fhir/resource-types"))
  case EXPLANATIONOFBENEFIT
      extends RESOURCE_TYPES(
        "ExplanationOfBenefit",
        Some("ExplanationOfBenefit"),
  ...
  case GRAPHDEFINITION
      extends RESOURCE_TYPES("GraphDefinition", Some("GraphDefinition"), Some("http://hl7.org/fhir/resource-types"))
  case GROUP extends RESOURCE_TYPES("Group", Some("Group"), Some("http://hl7.org/fhir/resource-types"))
  case GUIDANCERESPONSE
      extends RESOURCE_TYPES("GuidanceResponse", Some("GuidanceResponse"), Some("http://hl7.org/fhir/resource-types"))
  case HEALTHCARESERVICE
      extends RESOURCE_TYPES("HealthcareService", Some("HealthcareService"), Some("http://hl7.org/fhir/resource-types"))
  case IMAGINGSTUDY
      extends RESOURCE_TYPES("ImagingStudy", Some("ImagingStudy"), Some("http://hl7.org/fhir/resource-types"))
  case IMMUNIZATION
      extends RESOURCE_TYPES("Immunization", Some("Immunization"), Some("http://hl7.org/fhir/resource-types"))
  case IMMUNIZATIONEVALUATION
      extends RESOURCE_TYPES(
        "ImmunizationEvaluation",
        Some("ImmunizationEvaluation"),
  ...
  case IMPLEMENTATIONGUIDE
      extends RESOURCE_TYPES(
        ...
        Some("http://hl7.org/fhir/resource-types"))
  case INSURANCEPLAN
      extends RESOURCE_TYPES("InsurancePlan", Some("InsurancePlan"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case MEASUREREPORT
      extends RESOURCE_TYPES("MeasureReport", Some("MeasureReport"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case MEDICATIONKNOWLEDGE
      extends RESOURCE_TYPES(
        ...
        Some("http://hl7.org/fhir/resource-types"))
  case MEDICATIONREQUEST
      extends RESOURCE_TYPES("MedicationRequest", Some("MedicationRequest"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICATIONSTATEMENT
      extends RESOURCE_TYPES(
        "MedicationStatement",
        Some("MedicationStatement"),
        Some("http://hl7.org/fhir/resource-types"))
  case MEDICINALPRODUCT
      extends RESOURCE_TYPES("MedicinalProduct", Some("MedicinalProduct"), Some("http://hl7.org/fhir/resource-types"))
  case MEDICINALPRODUCTAUTHORIZATION
      extends RESOURCE_TYPES(
        "MedicinalProductAuthorization",
        Some("MedicinalProductAuthorization"),
  ...
  case MEDICINALPRODUCTUNDESIRABLEEFFECT
      extends RESOURCE_TYPES(
        ...
        Some("http://hl7.org/fhir/resource-types"))
  case MESSAGEDEFINITION
      extends RESOURCE_TYPES("MessageDefinition", Some("MessageDefinition"), Some("http://hl7.org/fhir/resource-types"))
  case MESSAGEHEADER
      extends RESOURCE_TYPES("MessageHeader", Some("MessageHeader"), Some("http://hl7.org/fhir/resource-types"))
  case MOLECULARSEQUENCE
      extends RESOURCE_TYPES("MolecularSequence", Some("MolecularSequence"), Some("http://hl7.org/fhir/resource-types"))
  case NAMINGSYSTEM
      extends RESOURCE_TYPES("NamingSystem", Some("NamingSystem"), Some("http://hl7.org/fhir/resource-types"))
  case NUTRITIONORDER
      extends RESOURCE_TYPES("NutritionOrder", Some("NutritionOrder"), Some("http://hl7.org/fhir/resource-types"))
  case OBSERVATION
      extends RESOURCE_TYPES("Observation", Some("Observation"), Some("http://hl7.org/fhir/resource-types"))
  case OBSERVATIONDEFINITION
      extends RESOURCE_TYPES(
        "ObservationDefinition",
        Some("ObservationDefinition"),
  ...
  case OPERATIONDEFINITION
      extends RESOURCE_TYPES(
        ...
        Some("http://hl7.org/fhir/resource-types"))
  case OPERATIONOUTCOME
      extends RESOURCE_TYPES("OperationOutcome", Some("OperationOutcome"), Some("http://hl7.org/fhir/resource-types"))
  case ORGANIZATION
      extends RESOURCE_TYPES("Organization", Some("Organization"), Some("http://hl7.org/fhir/resource-types"))
  case ORGANIZATIONAFFILIATION
      extends RESOURCE_TYPES(
        "OrganizationAffiliation",
        Some("OrganizationAffiliation"),
  ...
  case PAYMENTNOTICE
      extends RESOURCE_TYPES("PaymentNotice", Some("PaymentNotice"), Some("http://hl7.org/fhir/resource-types"))
  case PAYMENTRECONCILIATION
      extends RESOURCE_TYPES(
        "PaymentReconciliation",
        Some("PaymentReconciliation"),
  ...
  case PLANDEFINITION
      extends RESOURCE_TYPES("PlanDefinition", Some("PlanDefinition"), Some("http://hl7.org/fhir/resource-types"))
  case PRACTITIONER
      extends RESOURCE_TYPES("Practitioner", Some("Practitioner"), Some("http://hl7.org/fhir/resource-types"))
  case PRACTITIONERROLE
  ...
  case QUESTIONNAIRE
      extends RESOURCE_TYPES("Questionnaire", Some("Questionnaire"), Some("http://hl7.org/fhir/resource-types"))
  case QUESTIONNAIRERESPONSE
      extends RESOURCE_TYPES(
        "QuestionnaireResponse",
        Some("QuestionnaireResponse"),
        Some("http://hl7.org/fhir/resource-types"))
  case RELATEDPERSON
      extends RESOURCE_TYPES("RelatedPerson", Some("RelatedPerson"), Some("http://hl7.org/fhir/resource-types"))
  case REQUESTGROUP
      extends RESOURCE_TYPES("RequestGroup", Some("RequestGroup"), Some("http://hl7.org/fhir/resource-types"))
  case RESEARCHDEFINITION
      extends RESOURCE_TYPES(
        "ResearchDefinition",
        Some("ResearchDefinition"),
  ...
  case RESEARCHELEMENTDEFINITION
      extends RESOURCE_TYPES(
        ...
        Some("http://hl7.org/fhir/resource-types"))
  case RESEARCHSTUDY
      extends RESOURCE_TYPES("ResearchStudy", Some("ResearchStudy"), Some("http://hl7.org/fhir/resource-types"))
  case RESEARCHSUBJECT
  ...
  case RISKASSESSMENT
      extends RESOURCE_TYPES("RiskAssessment", Some("RiskAssessment"), Some("http://hl7.org/fhir/resource-types"))
  case RISKEVIDENCESYNTHESIS
      extends RESOURCE_TYPES(
        "RiskEvidenceSynthesis",
        Some("RiskEvidenceSynthesis"),
  ...
  case SERVICEREQUEST
      extends RESOURCE_TYPES("ServiceRequest", Some("ServiceRequest"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case STRUCTUREDEFINITION
      extends RESOURCE_TYPES(
        ...
        Some("http://hl7.org/fhir/resource-types"))
  case STRUCTUREMAP
      extends RESOURCE_TYPES("StructureMap", Some("StructureMap"), Some("http://hl7.org/fhir/resource-types"))
  case SUBSCRIPTION
      extends RESOURCE_TYPES("Subscription", Some("Subscription"), Some("http://hl7.org/fhir/resource-types"))
  ...
  case SUBSTANCENUCLEICACID
      extends RESOURCE_TYPES(
        ...
        Some("http://hl7.org/fhir/resource-types"))
  case SUBSTANCEPOLYMER
      extends RESOURCE_TYPES("SubstancePolymer", Some("SubstancePolymer"), Some("http://hl7.org/fhir/resource-types"))
  case SUBSTANCEPROTEIN
      extends RESOURCE_TYPES("SubstanceProtein", Some("SubstanceProtein"), Some("http://hl7.org/fhir/resource-types"))
  case SUBSTANCEREFERENCEINFORMATION
      extends RESOURCE_TYPES(
        "SubstanceReferenceInformation",
        Some("SubstanceReferenceInformation"),
  ...
  case SUBSTANCESPECIFICATION
      extends RESOURCE_TYPES(
        ...
        Some("http://hl7.org/fhir/resource-types"))
  case SUPPLYDELIVERY
      extends RESOURCE_TYPES("SupplyDelivery", Some("SupplyDelivery"), Some("http://hl7.org/fhir/resource-types"))
  case SUPPLYREQUEST
      extends RESOURCE_TYPES("SupplyRequest", Some("SupplyRequest"), Some("http://hl7.org/fhir/resource-types"))
...
enum RESTFUL_CAPABILITY_MODE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case CLIENT
      extends RESTFUL_CAPABILITY_MODE("client", Some("Client"), Some("http://hl7.org/fhir/restful-capability-mode"))
  case SERVER
      extends RESTFUL_CAPABILITY_MODE("server", Some("Server"), Some("http://hl7.org/fhir/restful-capability-mode"))
}
object RESTFUL_CAPABILITY_MODE
    extends EType[RESTFUL_CAPABILITY_MODE]("http://hl7.org/fhir/ValueSet/restful-capability-mode")
...
enum SEARCH_MODIFIER_CODE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  ...
  case CONTAINS
      extends SEARCH_MODIFIER_CODE("contains", Some("Contains"), Some("http://hl7.org/fhir/search-modifier-code"))
  case EXACT extends SEARCH_MODIFIER_CODE("exact", Some("Exact"), Some("http://hl7.org/fhir/search-modifier-code"))
  case IDENTIFIER
      extends SEARCH_MODIFIER_CODE("identifier", Some("Identifier"), Some("http://hl7.org/fhir/search-modifier-code"))
  case IN extends SEARCH_MODIFIER_CODE("in", Some("In"), Some("http://hl7.org/fhir/search-modifier-code"))
  case MISSING
      extends SEARCH_MODIFIER_CODE("missing", Some("Missing"), Some("http://hl7.org/fhir/search-modifier-code"))
...
enum SEARCH_PARAM_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case COMPOSITE
      extends SEARCH_PARAM_TYPE("composite", Some("Composite"), Some("http://hl7.org/fhir/search-param-type"))
  ...
  case REFERENCE
      extends SEARCH_PARAM_TYPE("reference", Some("Reference"), Some("http://hl7.org/fhir/search-param-type"))
...
enum SEARCH_XPATH_USAGE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
...
enum SLOTSTATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case BUSY_TENTATIVE
      extends SLOTSTATUS("busy-tentative", Some("Busy (Tentative)"), Some("http://hl7.org/fhir/slotstatus"))
  case BUSY_UNAVAILABLE
      extends SLOTSTATUS("busy-unavailable", Some("Busy (Unavailable)"), Some("http://hl7.org/fhir/slotstatus"))
  case ENTERED_IN_ERROR
      extends SLOTSTATUS("entered-in-error", Some("Entered in error"), Some("http://hl7.org/fhir/slotstatus"))
...
enum SPDX_LICENSE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ACADEMIC_FREE_LICENSE_V1_2
      extends SPDX_LICENSE("AFL-1.2", Some("Academic Free License v1.2"), Some("http://hl7.org/fhir/spdx-license"))
  case ACADEMIC_FREE_LICENSE_V2_0
      extends SPDX_LICENSE("AFL-2.0", Some("Academic Free License v2.0"), Some("http://hl7.org/fhir/spdx-license"))
  case ACADEMIC_FREE_LICENSE_V2_1
      extends SPDX_LICENSE("AFL-2.1", Some("Academic Free License v2.1"), Some("http://hl7.org/fhir/spdx-license"))
  case ACADEMIC_FREE_LICENSE_V3_0
      extends SPDX_LICENSE("AFL-3.0", Some("Academic Free License v3.0"), Some("http://hl7.org/fhir/spdx-license"))
  case ADAPTIVE_PUBLIC_LICENSE_1_0
      extends SPDX_LICENSE("APL-1.0", Some("Adaptive Public License 1.0"), Some("http://hl7.org/fhir/spdx-license"))
  case ADOBE_GLYPH_LIST_LICENSE
      extends SPDX_LICENSE("Adobe-Glyph", Some("Adobe Glyph List License"), Some("http://hl7.org/fhir/spdx-license"))
  case ADOBE_SYSTEMS_INCORPORATED_SOURCE_CODE_LICENSE_AGREEMENT
      extends SPDX_LICENSE(
        "Adobe-2006",
        Some("Adobe Systems Incorporated Source Code License Agreement"),
        Some("http://hl7.org/fhir/spdx-license"))
  case ADSL
      extends SPDX_LICENSE("ADSL", Some("Amazon Digital Services License"), Some("http://hl7.org/fhir/spdx-license"))
  case AFFERO_GENERAL_PUBLIC_LICENSE_V1_0_ONLY
      extends SPDX_LICENSE(
        "AGPL-1.0-only",
        Some("Affero General Public License v1.0 only"),
        Some("http://hl7.org/fhir/spdx-license"))
  case AFFERO_GENERAL_PUBLIC_LICENSE_V1_0_OR_LATER
      extends SPDX_LICENSE(
        "AGPL-1.0-or-later",
  ...
  case ALADDIN
      extends SPDX_LICENSE("Aladdin", Some("Aladdin Free Public License"), Some("http://hl7.org/fhir/spdx-license"))
  case AMDPLPA
      extends SPDX_LICENSE("AMDPLPA", Some("AMD's plpa_map.c License"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case AMPAS
      extends SPDX_LICENSE(
        ...
        Some("http://hl7.org/fhir/spdx-license"))
  case ANTLR_SOFTWARE_RIGHTS_NOTICE
      extends SPDX_LICENSE("ANTLR-PD", Some("ANTLR Software Rights Notice"), Some("http://hl7.org/fhir/spdx-license"))
  case APACHE_LICENSE_1_0
      extends SPDX_LICENSE("Apache-1.0", Some("Apache License 1.0"), Some("http://hl7.org/fhir/spdx-license"))
  case APACHE_LICENSE_1_1
      extends SPDX_LICENSE("Apache-1.1", Some("Apache License 1.1"), Some("http://hl7.org/fhir/spdx-license"))
  case APACHE_LICENSE_2_0
      extends SPDX_LICENSE("Apache-2.0", Some("Apache License 2.0"), Some("http://hl7.org/fhir/spdx-license"))
  case APAFML
      extends SPDX_LICENSE("APAFML", Some("Adobe Postscript AFM License"), Some("http://hl7.org/fhir/spdx-license"))
  case APPLE_PUBLIC_SOURCE_LICENSE_1_0
      extends SPDX_LICENSE(
        "APSL-1.0",
        Some("Apple Public Source License 1.0"),
        Some("http://hl7.org/fhir/spdx-license"))
  case APPLE_PUBLIC_SOURCE_LICENSE_1_1
      extends SPDX_LICENSE(
        "APSL-1.1",
        Some("Apple Public Source License 1.1"),
        Some("http://hl7.org/fhir/spdx-license"))
  case APPLE_PUBLIC_SOURCE_LICENSE_1_2
      extends SPDX_LICENSE(
        "APSL-1.2",
        Some("Apple Public Source License 1.2"),
        Some("http://hl7.org/fhir/spdx-license"))
  case APPLE_PUBLIC_SOURCE_LICENSE_2_0
      extends SPDX_LICENSE(
        "APSL-2.0",
        Some("Apple Public Source License 2.0"),
        Some("http://hl7.org/fhir/spdx-license"))
  case ARTISTIC_10_CL8
      extends SPDX_LICENSE(
        "Artistic-1.0-cl8",
        Some("Artistic License 1.0 w/clause 8"),
        Some("http://hl7.org/fhir/spdx-license"))
  case ARTISTIC_10_PERL
      extends SPDX_LICENSE(
        "Artistic-1.0-Perl",
        Some("Artistic License 1.0 (Perl)"),
        Some("http://hl7.org/fhir/spdx-license"))
  case ARTISTIC_LICENSE_1_0
  ...
  case BITTORRENT_OPEN_SOURCE_LICENSE_V1_0
      extends SPDX_LICENSE(
        ...
        Some("http://hl7.org/fhir/spdx-license"))
  case BITTORRENT_OPEN_SOURCE_LICENSE_V1_1
      extends SPDX_LICENSE(
        "BitTorrent-1.1",
        Some("BitTorrent Open Source License v1.1"),
        Some("http://hl7.org/fhir/spdx-license"))
  case BOOST_SOFTWARE_LICENSE_1_0
      extends SPDX_LICENSE("BSL-1.0", Some("Boost Software License 1.0"), Some("http://hl7.org/fhir/spdx-license"))
  case BORCEUX extends SPDX_LICENSE("Borceux", Some("Borceux license"), Some("http://hl7.org/fhir/spdx-license"))
  case BSD_1_CLAUSE_LICENSE
      extends SPDX_LICENSE("BSD-1-Clause", Some("BSD 1-Clause License"), Some("http://hl7.org/fhir/spdx-license"))
  case BSD_2_CLAUSE
      extends SPDX_LICENSE(
        "BSD-2-Clause",
        Some("BSD 2-Clause \"Simplified\" License"),
        Some("http://hl7.org/fhir/spdx-license"))
  case BSD_2_CLAUSE_FREEBSD_LICENSE
      extends SPDX_LICENSE(
        "BSD-2-Clause-FreeBSD",
        Some("BSD 2-Clause FreeBSD License"),
        Some("http://hl7.org/fhir/spdx-license"))
  case BSD_2_CLAUSE_NETBSD_LICENSE
      extends SPDX_LICENSE(
        "BSD-2-Clause-NetBSD",
        Some("BSD 2-Clause NetBSD License"),
        Some("http://hl7.org/fhir/spdx-license"))
  case BSD_2_CLAUSE_PLUS_PATENT_LICENSE
      extends SPDX_LICENSE(
        "BSD-2-Clause-Patent",
  ...
  case BSD_3_CLAUSE
      extends SPDX_LICENSE(
        ...
        Some("http://hl7.org/fhir/spdx-license"))
  case BSD_3_CLAUSE_CLEAR_LICENSE
      extends SPDX_LICENSE(
        "BSD-3-Clause-Clear",
  ...
  case BSD_4_CLAUSE_UC
      extends SPDX_LICENSE(
        ...
        Some("http://hl7.org/fhir/spdx-license"))
  case BSD_PROTECTION_LICENSE
      extends SPDX_LICENSE("BSD-Protection", Some("BSD Protection License"), Some("http://hl7.org/fhir/spdx-license"))
  case BSD_SOURCE_CODE_ATTRIBUTION
      extends SPDX_LICENSE(
        "BSD-Source-Code",
        Some("BSD Source Code Attribution"),
        Some("http://hl7.org/fhir/spdx-license"))
  case BSD_WITH_ATTRIBUTION
      extends SPDX_LICENSE(
        "BSD-3-Clause-Attribution",
        Some("BSD with attribution"),
        Some("http://hl7.org/fhir/spdx-license"))
  case BSD_ZERO_CLAUSE_LICENSE
      extends SPDX_LICENSE("0BSD", Some("BSD Zero Clause License"), Some("http://hl7.org/fhir/spdx-license"))
  case BZIP2_AND_LIBBZIP2_LICENSE_V1_0_5
      extends SPDX_LICENSE(
        "bzip2-1.0.5",
        Some("bzip2 and libbzip2 License v1.0.5"),
        Some("http://hl7.org/fhir/spdx-license"))
  case BZIP2_AND_LIBBZIP2_LICENSE_V1_0_6
      extends SPDX_LICENSE(
        "bzip2-1.0.6",
  ...
  case CECILL_B_FREE_SOFTWARE_LICENSE_AGREEMENT
      extends SPDX_LICENSE(
        "CECILL-B",
        Some("CeCILL-B Free Software License Agreement"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CECILL_C_FREE_SOFTWARE_LICENSE_AGREEMENT
      extends SPDX_LICENSE(
        "CECILL-C",
        Some("CeCILL-C Free Software License Agreement"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CECILL_FREE_SOFTWARE_LICENSE_AGREEMENT_V1_0
      extends SPDX_LICENSE(
        "CECILL-1.0",
        Some("CeCILL Free Software License Agreement v1.0"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CECILL_FREE_SOFTWARE_LICENSE_AGREEMENT_V1_1
      extends SPDX_LICENSE(
        "CECILL-1.1",
        Some("CeCILL Free Software License Agreement v1.1"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CECILL_FREE_SOFTWARE_LICENSE_AGREEMENT_V2_0
      extends SPDX_LICENSE(
        "CECILL-2.0",
        Some("CeCILL Free Software License Agreement v2.0"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CECILL_FREE_SOFTWARE_LICENSE_AGREEMENT_V2_1
      extends SPDX_LICENSE(
        "CECILL-2.1",
        Some("CeCILL Free Software License Agreement v2.1"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CLARTISTIC
      extends SPDX_LICENSE("ClArtistic", Some("Clarified Artistic License"), Some("http://hl7.org/fhir/spdx-license"))
  case CMU_LICENSE extends SPDX_LICENSE("MIT-CMU", Some("CMU License"), Some("http://hl7.org/fhir/spdx-license"))
  case CNRI_JYTHON_LICENSE
      extends SPDX_LICENSE("CNRI-Jython", Some("CNRI Jython License"), Some("http://hl7.org/fhir/spdx-license"))
  case CNRI_PYTHON_LICENSE
      extends SPDX_LICENSE("CNRI-Python", Some("CNRI Python License"), Some("http://hl7.org/fhir/spdx-license"))
  case CNRI_PYTHON_OPEN_SOURCE_GPL_COMPATIBLE_LICENSE_AGREEMENT
      extends SPDX_LICENSE(
        "CNRI-Python-GPL-Compatible",
        Some("CNRI Python Open Source GPL Compatible License Agreement"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CODE_PROJECT_OPEN_LICENSE_1_02
      extends SPDX_LICENSE(
        "CPOL-1.02",
        Some("Code Project Open License 1.02"),
        Some("http://hl7.org/fhir/spdx-license"))
  case COMMON_DEVELOPMENT_AND_DISTRIBUTION_LICENSE_1_0
      extends SPDX_LICENSE(
        "CDDL-1.0",
        Some("Common Development and Distribution License 1.0"),
        Some("http://hl7.org/fhir/spdx-license"))
  case COMMON_DEVELOPMENT_AND_DISTRIBUTION_LICENSE_1_1
      extends SPDX_LICENSE(
        "CDDL-1.1",
        Some("Common Development and Distribution License 1.1"),
        Some("http://hl7.org/fhir/spdx-license"))
  case COMMON_PUBLIC_ATTRIBUTION_LICENSE_1_0
      extends SPDX_LICENSE(
        "CPAL-1.0",
        Some("Common Public Attribution License 1.0"),
        Some("http://hl7.org/fhir/spdx-license"))
  case COMMON_PUBLIC_LICENSE_1_0
      extends SPDX_LICENSE("CPL-1.0", Some("Common Public License 1.0"), Some("http://hl7.org/fhir/spdx-license"))
  case COMMUNITY_DATA_LICENSE_AGREEMENT_PERMISSIVE_1_0
      extends SPDX_LICENSE(
        "CDLA-Permissive-1.0",
        Some("Community Data License Agreement Permissive 1.0"),
        Some("http://hl7.org/fhir/spdx-license"))
  case COMMUNITY_DATA_LICENSE_AGREEMENT_SHARING_1_0
      extends SPDX_LICENSE(
        "CDLA-Sharing-1.0",
        Some("Community Data License Agreement Sharing 1.0"),
        Some("http://hl7.org/fhir/spdx-license"))
  case COMPUTER_ASSOCIATES_TRUSTED_OPEN_SOURCE_LICENSE_1_1
      extends SPDX_LICENSE(
        "CATOSL-1.1",
        Some("Computer Associates Trusted Open Source License 1.1"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CONDOR_PUBLIC_LICENSE_V1_1
      extends SPDX_LICENSE("Condor-1.1", Some("Condor Public License v1.1"), Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_1_0_GENERIC
      extends SPDX_LICENSE(
        "CC-BY-1.0",
        Some("Creative Commons Attribution 1.0 Generic"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_2_0_GENERIC
      extends SPDX_LICENSE(
        "CC-BY-2.0",
        Some("Creative Commons Attribution 2.0 Generic"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_2_5_GENERIC
      extends SPDX_LICENSE(
        "CC-BY-2.5",
        Some("Creative Commons Attribution 2.5 Generic"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_3_0_UNPORTED
      extends SPDX_LICENSE(
        "CC-BY-3.0",
        Some("Creative Commons Attribution 3.0 Unported"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_4_0_INTERNATIONAL
      extends SPDX_LICENSE(
        "CC-BY-4.0",
        Some("Creative Commons Attribution 4.0 International"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_NON_COMMERCIAL_1_0_GENERIC
      extends SPDX_LICENSE(
        "CC-BY-NC-1.0",
        Some("Creative Commons Attribution Non Commercial 1.0 Generic"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_NON_COMMERCIAL_2_0_GENERIC
      extends SPDX_LICENSE(
        "CC-BY-NC-2.0",
        Some("Creative Commons Attribution Non Commercial 2.0 Generic"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_NON_COMMERCIAL_2_5_GENERIC
      extends SPDX_LICENSE(
        "CC-BY-NC-2.5",
        Some("Creative Commons Attribution Non Commercial 2.5 Generic"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_NON_COMMERCIAL_3_0_UNPORTED
      extends SPDX_LICENSE(
        "CC-BY-NC-3.0",
        Some("Creative Commons Attribution Non Commercial 3.0 Unported"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_NON_COMMERCIAL_4_0_INTERNATIONAL
      extends SPDX_LICENSE(
        "CC-BY-NC-4.0",
        Some("Creative Commons Attribution Non Commercial 4.0 International"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_NON_COMMERCIAL_NO_DERIVATIVES_1_0_GENERIC
      extends SPDX_LICENSE(
        "CC-BY-NC-ND-1.0",
        Some("Creative Commons Attribution Non Commercial No Derivatives 1.0 Generic"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_NON_COMMERCIAL_NO_DERIVATIVES_2_0_GENERIC
      extends SPDX_LICENSE(
        "CC-BY-NC-ND-2.0",
        Some("Creative Commons Attribution Non Commercial No Derivatives 2.0 Generic"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_NON_COMMERCIAL_NO_DERIVATIVES_2_5_GENERIC
      extends SPDX_LICENSE(
        "CC-BY-NC-ND-2.5",
        Some("Creative Commons Attribution Non Commercial No Derivatives 2.5 Generic"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_NON_COMMERCIAL_NO_DERIVATIVES_3_0_UNPORTED
      extends SPDX_LICENSE(
        "CC-BY-NC-ND-3.0",
        Some("Creative Commons Attribution Non Commercial No Derivatives 3.0 Unported"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_NON_COMMERCIAL_NO_DERIVATIVES_4_0_INTERNATIONAL
      extends SPDX_LICENSE(
        "CC-BY-NC-ND-4.0",
        Some("Creative Commons Attribution Non Commercial No Derivatives 4.0 International"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_NON_COMMERCIAL_SHARE_ALIKE_1_0_GENERIC
      extends SPDX_LICENSE(
        "CC-BY-NC-SA-1.0",
        Some("Creative Commons Attribution Non Commercial Share Alike 1.0 Generic"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_NON_COMMERCIAL_SHARE_ALIKE_2_0_GENERIC
      extends SPDX_LICENSE(
        "CC-BY-NC-SA-2.0",
        Some("Creative Commons Attribution Non Commercial Share Alike 2.0 Generic"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_NON_COMMERCIAL_SHARE_ALIKE_2_5_GENERIC
      extends SPDX_LICENSE(
        "CC-BY-NC-SA-2.5",
        Some("Creative Commons Attribution Non Commercial Share Alike 2.5 Generic"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_NON_COMMERCIAL_SHARE_ALIKE_3_0_UNPORTED
      extends SPDX_LICENSE(
        "CC-BY-NC-SA-3.0",
        Some("Creative Commons Attribution Non Commercial Share Alike 3.0 Unported"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_NON_COMMERCIAL_SHARE_ALIKE_4_0_INTERNATIONAL
      extends SPDX_LICENSE(
        "CC-BY-NC-SA-4.0",
        Some("Creative Commons Attribution Non Commercial Share Alike 4.0 International"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_NO_DERIVATIVES_1_0_GENERIC
      extends SPDX_LICENSE(
        "CC-BY-ND-1.0",
        Some("Creative Commons Attribution No Derivatives 1.0 Generic"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_NO_DERIVATIVES_2_0_GENERIC
      extends SPDX_LICENSE(
        "CC-BY-ND-2.0",
        Some("Creative Commons Attribution No Derivatives 2.0 Generic"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_NO_DERIVATIVES_2_5_GENERIC
      extends SPDX_LICENSE(
        "CC-BY-ND-2.5",
        Some("Creative Commons Attribution No Derivatives 2.5 Generic"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_NO_DERIVATIVES_3_0_UNPORTED
      extends SPDX_LICENSE(
        "CC-BY-ND-3.0",
        Some("Creative Commons Attribution No Derivatives 3.0 Unported"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_NO_DERIVATIVES_4_0_INTERNATIONAL
      extends SPDX_LICENSE(
        "CC-BY-ND-4.0",
        Some("Creative Commons Attribution No Derivatives 4.0 International"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_SHARE_ALIKE_1_0_GENERIC
      extends SPDX_LICENSE(
        "CC-BY-SA-1.0",
        Some("Creative Commons Attribution Share Alike 1.0 Generic"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_SHARE_ALIKE_2_0_GENERIC
      extends SPDX_LICENSE(
        "CC-BY-SA-2.0",
        Some("Creative Commons Attribution Share Alike 2.0 Generic"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_SHARE_ALIKE_2_5_GENERIC
      extends SPDX_LICENSE(
        "CC-BY-SA-2.5",
        Some("Creative Commons Attribution Share Alike 2.5 Generic"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_SHARE_ALIKE_3_0_UNPORTED
      extends SPDX_LICENSE(
        "CC-BY-SA-3.0",
        Some("Creative Commons Attribution Share Alike 3.0 Unported"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ATTRIBUTION_SHARE_ALIKE_4_0_INTERNATIONAL
      extends SPDX_LICENSE(
        "CC-BY-SA-4.0",
        Some("Creative Commons Attribution Share Alike 4.0 International"),
        Some("http://hl7.org/fhir/spdx-license"))
  case CREATIVE_COMMONS_ZERO_V1_0_UNIVERSAL
      extends SPDX_LICENSE(
        "CC0-1.0",
  ...
  case CRYSTALSTACKER
      extends SPDX_LICENSE("CrystalStacker", Some("CrystalStacker License"), Some("http://hl7.org/fhir/spdx-license"))
  case CUA_OFFICE_PUBLIC_LICENSE_V1_0
      extends SPDX_LICENSE(
        "CUA-OPL-1.0",
  ...
  case ECLIPSE_PUBLIC_LICENSE_2_0
      extends SPDX_LICENSE("EPL-2.0", Some("Eclipse Public License 2.0"), Some("http://hl7.org/fhir/spdx-license"))
  case EDUCATIONAL_COMMUNITY_LICENSE_V1_0
      extends SPDX_LICENSE(
        "ECL-1.0",
        Some("Educational Community License v1.0"),
        Some("http://hl7.org/fhir/spdx-license"))
  case EDUCATIONAL_COMMUNITY_LICENSE_V2_0
      extends SPDX_LICENSE(
        "ECL-2.0",
        Some("Educational Community License v2.0"),
        Some("http://hl7.org/fhir/spdx-license"))
  case EGENIX
      extends SPDX_LICENSE("eGenix", Some("eGenix.com Public License 1.1.0"), Some("http://hl7.org/fhir/spdx-license"))
  case EIFFEL_FORUM_LICENSE_V1_0
      extends SPDX_LICENSE("EFL-1.0", Some("Eiffel Forum License v1.0"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case ENTESSA
      extends SPDX_LICENSE("Entessa", Some("Entessa Public License v1.0"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case EUDATAGRID
      extends SPDX_LICENSE("EUDatagrid", Some("EU DataGrid Software License"), Some("http://hl7.org/fhir/spdx-license"))
  case EUROPEAN_UNION_PUBLIC_LICENSE_1_0
      extends SPDX_LICENSE(
        "EUPL-1.0",
        Some("European Union Public License 1.0"),
        Some("http://hl7.org/fhir/spdx-license"))
  case EUROPEAN_UNION_PUBLIC_LICENSE_1_1
      extends SPDX_LICENSE(
        "EUPL-1.1",
  ...
  case FRAMEWORX_OPEN_LICENSE_1_0
      extends SPDX_LICENSE(
        ...
        Some("http://hl7.org/fhir/spdx-license"))
  case FREEIMAGE
      extends SPDX_LICENSE("FreeImage", Some("FreeImage Public License v1.0"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case GNU_AFFERO_GENERAL_PUBLIC_LICENSE_V3_0_ONLY
      extends SPDX_LICENSE(
        ...
        Some("http://hl7.org/fhir/spdx-license"))
  case GNU_AFFERO_GENERAL_PUBLIC_LICENSE_V3_0_OR_LATER
      extends SPDX_LICENSE(
        "AGPL-3.0-or-later",
        Some("GNU Affero General Public License v3.0 or later"),
        Some("http://hl7.org/fhir/spdx-license"))
  case GNU_FREE_DOCUMENTATION_LICENSE_V1_1_ONLY
      extends SPDX_LICENSE(
        "GFDL-1.1-only",
        Some("GNU Free Documentation License v1.1 only"),
        Some("http://hl7.org/fhir/spdx-license"))
  case GNU_FREE_DOCUMENTATION_LICENSE_V1_1_OR_LATER
      extends SPDX_LICENSE(
        "GFDL-1.1-or-later",
        Some("GNU Free Documentation License v1.1 or later"),
        Some("http://hl7.org/fhir/spdx-license"))
  case GNU_FREE_DOCUMENTATION_LICENSE_V1_2_ONLY
      extends SPDX_LICENSE(
        "GFDL-1.2-only",
        Some("GNU Free Documentation License v1.2 only"),
        Some("http://hl7.org/fhir/spdx-license"))
  case GNU_FREE_DOCUMENTATION_LICENSE_V1_2_OR_LATER
      extends SPDX_LICENSE(
        "GFDL-1.2-or-later",
        Some("GNU Free Documentation License v1.2 or later"),
        Some("http://hl7.org/fhir/spdx-license"))
  case GNU_FREE_DOCUMENTATION_LICENSE_V1_3_ONLY
      extends SPDX_LICENSE(
        "GFDL-1.3-only",
        Some("GNU Free Documentation License v1.3 only"),
        Some("http://hl7.org/fhir/spdx-license"))
  case GNU_FREE_DOCUMENTATION_LICENSE_V1_3_OR_LATER
      extends SPDX_LICENSE(
        "GFDL-1.3-or-later",
        Some("GNU Free Documentation License v1.3 or later"),
        Some("http://hl7.org/fhir/spdx-license"))
  case GNU_GENERAL_PUBLIC_LICENSE_V1_0_ONLY
      extends SPDX_LICENSE(
        "GPL-1.0-only",
        Some("GNU General Public License v1.0 only"),
        Some("http://hl7.org/fhir/spdx-license"))
  case GNU_GENERAL_PUBLIC_LICENSE_V1_0_OR_LATER
      extends SPDX_LICENSE(
        "GPL-1.0-or-later",
        Some("GNU General Public License v1.0 or later"),
        Some("http://hl7.org/fhir/spdx-license"))
  case GNU_GENERAL_PUBLIC_LICENSE_V2_0_ONLY
      extends SPDX_LICENSE(
        "GPL-2.0-only",
        Some("GNU General Public License v2.0 only"),
        Some("http://hl7.org/fhir/spdx-license"))
  case GNU_GENERAL_PUBLIC_LICENSE_V2_0_OR_LATER
      extends SPDX_LICENSE(
        "GPL-2.0-or-later",
        Some("GNU General Public License v2.0 or later"),
        Some("http://hl7.org/fhir/spdx-license"))
  case GNU_GENERAL_PUBLIC_LICENSE_V3_0_ONLY
      extends SPDX_LICENSE(
        "GPL-3.0-only",
        Some("GNU General Public License v3.0 only"),
        Some("http://hl7.org/fhir/spdx-license"))
  case GNU_GENERAL_PUBLIC_LICENSE_V3_0_OR_LATER
      extends SPDX_LICENSE(
        "GPL-3.0-or-later",
        Some("GNU General Public License v3.0 or later"),
        Some("http://hl7.org/fhir/spdx-license"))
  case GNU_LESSER_GENERAL_PUBLIC_LICENSE_V2_1_ONLY
      extends SPDX_LICENSE(
        "LGPL-2.1-only",
        Some("GNU Lesser General Public License v2.1 only"),
        Some("http://hl7.org/fhir/spdx-license"))
  case GNU_LESSER_GENERAL_PUBLIC_LICENSE_V2_1_OR_LATER
      extends SPDX_LICENSE(
        "LGPL-2.1-or-later",
        Some("GNU Lesser General Public License v2.1 or later"),
        Some("http://hl7.org/fhir/spdx-license"))
  case GNU_LESSER_GENERAL_PUBLIC_LICENSE_V3_0_ONLY
      extends SPDX_LICENSE(
        "LGPL-3.0-only",
        Some("GNU Lesser General Public License v3.0 only"),
        Some("http://hl7.org/fhir/spdx-license"))
  case GNU_LESSER_GENERAL_PUBLIC_LICENSE_V3_0_OR_LATER
      extends SPDX_LICENSE(
        "LGPL-3.0-or-later",
        Some("GNU Lesser General Public License v3.0 or later"),
        Some("http://hl7.org/fhir/spdx-license"))
  case GNU_LIBRARY_GENERAL_PUBLIC_LICENSE_V2_ONLY
      extends SPDX_LICENSE(
        "LGPL-2.0-only",
        Some("GNU Library General Public License v2 only"),
        Some("http://hl7.org/fhir/spdx-license"))
  case GNU_LIBRARY_GENERAL_PUBLIC_LICENSE_V2_OR_LATER
      extends SPDX_LICENSE(
        "LGPL-2.0-or-later",
        Some("GNU Library General Public License v2 or later"),
        Some("http://hl7.org/fhir/spdx-license"))
  case GSOAP_PUBLIC_LICENSE_V1_3B
      extends SPDX_LICENSE("gSOAP-1.3b", Some("gSOAP Public License v1.3b"), Some("http://hl7.org/fhir/spdx-license"))
  case HASKELLREPORT
      extends SPDX_LICENSE(
        "HaskellReport",
  ...
  case HPND
      extends SPDX_LICENSE(
        ...
        Some("http://hl7.org/fhir/spdx-license"))
  case IBM_POWERPC_INITIALIZATION_AND_BOOT_SOFTWARE
      extends SPDX_LICENSE(
        "IBM-pibs",
  ...
  case IMAGEMAGICK
      extends SPDX_LICENSE("ImageMagick", Some("ImageMagick License"), Some("http://hl7.org/fhir/spdx-license"))
  case IMATIX
      extends SPDX_LICENSE(
        "iMatix",
  ...
  case INFO_ZIP_LICENSE
      extends SPDX_LICENSE("Info-ZIP", Some("Info-ZIP License"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case JASPER_LICENSE
      extends SPDX_LICENSE("JasPer-2.0", Some("JasPer License"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case LATEX_PROJECT_PUBLIC_LICENSE_V1_1
      extends SPDX_LICENSE(
        ...
        Some("http://hl7.org/fhir/spdx-license"))
  case LATEX_PROJECT_PUBLIC_LICENSE_V1_2
      extends SPDX_LICENSE(
        "LPPL-1.2",
        Some("LaTeX Project Public License v1.2"),
        Some("http://hl7.org/fhir/spdx-license"))
  case LATEX_PROJECT_PUBLIC_LICENSE_V1_3A
      extends SPDX_LICENSE(
        "LPPL-1.3a",
        Some("LaTeX Project Public License v1.3a"),
        Some("http://hl7.org/fhir/spdx-license"))
  case LATEX_PROJECT_PUBLIC_LICENSE_V1_3C
      extends SPDX_LICENSE(
        "LPPL-1.3c",
        Some("LaTeX Project Public License v1.3c"),
        Some("http://hl7.org/fhir/spdx-license"))
  case LAWRENCE_BERKELEY_NATIONAL_LABS_BSD_VARIANT_LICENSE
      extends SPDX_LICENSE(
        "BSD-3-Clause-LBNL",
  ...
  case LICENCE_ART_LIBRE_1_3
      extends SPDX_LICENSE("LAL-1.3", Some("Licence Art Libre 1.3"), Some("http://hl7.org/fhir/spdx-license"))
  case LILIQ_P_11
      extends SPDX_LICENSE(
        "LiLiQ-P-1.1",
  ...
  case LILIQ_R_11
      extends SPDX_LICENSE(
        ...
        Some("http://hl7.org/fhir/spdx-license"))
  case LINUX_KERNEL_VARIANT_OF_OPENIB_ORG_LICENSE
      extends SPDX_LICENSE(
        "Linux-OpenIB",
        Some("Linux Kernel Variant of OpenIB.org license"),
        Some("http://hl7.org/fhir/spdx-license"))
  case LUCENT_PUBLIC_LICENSE_V1_02
      extends SPDX_LICENSE("LPL-1.02", Some("Lucent Public License v1.02"), Some("http://hl7.org/fhir/spdx-license"))
  case LUCENT_PUBLIC_LICENSE_VERSION_1_0
      extends SPDX_LICENSE(
        "LPL-1.0",
  ...
  case MITNFA
      extends SPDX_LICENSE("MITNFA", Some("MIT +no-false-attribs license"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case MIT_NO_ATTRIBUTION
      extends SPDX_LICENSE("MIT-0", Some("MIT No Attribution"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case MOZILLA_PUBLIC_LICENSE_1_1
      extends SPDX_LICENSE("MPL-1.1", Some("Mozilla Public License 1.1"), Some("http://hl7.org/fhir/spdx-license"))
  case MOZILLA_PUBLIC_LICENSE_2_0
      extends SPDX_LICENSE("MPL-2.0", Some("Mozilla Public License 2.0"), Some("http://hl7.org/fhir/spdx-license"))
  case MPICH2 extends SPDX_LICENSE("mpich2", Some("mpich2 License"), Some("http://hl7.org/fhir/spdx-license"))
  case MPL_20_NO_COPYLEFT_EXCEPTION
      extends SPDX_LICENSE(
        "MPL-2.0-no-copyleft-exception",
        Some("Mozilla Public License 2.0 (no copyleft exception)"),
        Some("http://hl7.org/fhir/spdx-license"))
  case MTLL
      extends SPDX_LICENSE("MTLL", Some("Matrix Template Library License"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case NETSCAPE_PUBLIC_LICENSE_V1_0
      extends SPDX_LICENSE("NPL-1.0", Some("Netscape Public License v1.0"), Some("http://hl7.org/fhir/spdx-license"))
  case NETSCAPE_PUBLIC_LICENSE_V1_1
      extends SPDX_LICENSE("NPL-1.1", Some("Netscape Public License v1.1"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case NET_SNMP_LICENSE
      extends SPDX_LICENSE("Net-SNMP", Some("Net-SNMP License"), Some("http://hl7.org/fhir/spdx-license"))
  case NEWSLETR extends SPDX_LICENSE("Newsletr", Some("Newsletr License"), Some("http://hl7.org/fhir/spdx-license"))
  case NGPL
      extends SPDX_LICENSE("NGPL", Some("Nethack General Public License"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case NON_PROFIT_OPEN_SOFTWARE_LICENSE_3_0
      extends SPDX_LICENSE(
        ...
        Some("http://hl7.org/fhir/spdx-license"))
  case NORWEGIAN_LICENCE_FOR_OPEN_GOVERNMENT_DATA
      extends SPDX_LICENSE(
        "NLOD-1.0",
  ...
  case NOT_OPEN_SOURCE
      extends SPDX_LICENSE("not-open-source", Some("Not open source"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case ODC_OPEN_DATABASE_LICENSE_V1_0
      extends SPDX_LICENSE("ODbL-1.0", Some("ODC Open Database License v1.0"), Some("http://hl7.org/fhir/spdx-license"))
  case OGTSL
      extends SPDX_LICENSE("OGTSL", Some("Open Group Test Suite License"), Some("http://hl7.org/fhir/spdx-license"))
  case OLDAP_20
      extends SPDX_LICENSE(
        "OLDAP-2.0",
  ...
  case OPEN_CASCADE_TECHNOLOGY_PUBLIC_LICENSE
      extends SPDX_LICENSE(
        ...
        Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_LDAP_PUBLIC_LICENSE_2_2_2
      extends SPDX_LICENSE(
        "OLDAP-2.2.2",
        Some("Open LDAP Public License 2.2.2"),
        Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_LDAP_PUBLIC_LICENSE_V1_1
      extends SPDX_LICENSE("OLDAP-1.1", Some("Open LDAP Public License v1.1"), Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_LDAP_PUBLIC_LICENSE_V1_2
      extends SPDX_LICENSE("OLDAP-1.2", Some("Open LDAP Public License v1.2"), Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_LDAP_PUBLIC_LICENSE_V1_3
      extends SPDX_LICENSE("OLDAP-1.3", Some("Open LDAP Public License v1.3"), Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_LDAP_PUBLIC_LICENSE_V1_4
      extends SPDX_LICENSE("OLDAP-1.4", Some("Open LDAP Public License v1.4"), Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_LDAP_PUBLIC_LICENSE_V2_0_1
      extends SPDX_LICENSE(
        "OLDAP-2.0.1",
        Some("Open LDAP Public License v2.0.1"),
        Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_LDAP_PUBLIC_LICENSE_V2_1
      extends SPDX_LICENSE("OLDAP-2.1", Some("Open LDAP Public License v2.1"), Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_LDAP_PUBLIC_LICENSE_V2_2
      extends SPDX_LICENSE("OLDAP-2.2", Some("Open LDAP Public License v2.2"), Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_LDAP_PUBLIC_LICENSE_V2_2_1
      extends SPDX_LICENSE(
        "OLDAP-2.2.1",
        Some("Open LDAP Public License v2.2.1"),
        Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_LDAP_PUBLIC_LICENSE_V2_3
      extends SPDX_LICENSE("OLDAP-2.3", Some("Open LDAP Public License v2.3"), Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_LDAP_PUBLIC_LICENSE_V2_4
      extends SPDX_LICENSE("OLDAP-2.4", Some("Open LDAP Public License v2.4"), Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_LDAP_PUBLIC_LICENSE_V2_5
      extends SPDX_LICENSE("OLDAP-2.5", Some("Open LDAP Public License v2.5"), Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_LDAP_PUBLIC_LICENSE_V2_6
      extends SPDX_LICENSE("OLDAP-2.6", Some("Open LDAP Public License v2.6"), Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_LDAP_PUBLIC_LICENSE_V2_7
      extends SPDX_LICENSE("OLDAP-2.7", Some("Open LDAP Public License v2.7"), Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_LDAP_PUBLIC_LICENSE_V2_8
      extends SPDX_LICENSE("OLDAP-2.8", Some("Open LDAP Public License v2.8"), Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_PUBLIC_LICENSE_V1_0
      extends SPDX_LICENSE("OPL-1.0", Some("Open Public License v1.0"), Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_SOFTWARE_LICENSE_1_0
      extends SPDX_LICENSE("OSL-1.0", Some("Open Software License 1.0"), Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_SOFTWARE_LICENSE_1_1
      extends SPDX_LICENSE("OSL-1.1", Some("Open Software License 1.1"), Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_SOFTWARE_LICENSE_2_0
      extends SPDX_LICENSE("OSL-2.0", Some("Open Software License 2.0"), Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_SOFTWARE_LICENSE_2_1
      extends SPDX_LICENSE("OSL-2.1", Some("Open Software License 2.1"), Some("http://hl7.org/fhir/spdx-license"))
  case OPEN_SOFTWARE_LICENSE_3_0
      extends SPDX_LICENSE("OSL-3.0", Some("Open Software License 3.0"), Some("http://hl7.org/fhir/spdx-license"))
  case OSET_PUBLIC_LICENSE_VERSION_2_1
      extends SPDX_LICENSE(
        "OSET-PL-2.1",
  ...
  case PDDL_10
      extends SPDX_LICENSE(
        ...
        Some("http://hl7.org/fhir/spdx-license"))
  case PHP_LICENSE_V3_0
      extends SPDX_LICENSE("PHP-3.0", Some("PHP License v3.0"), Some("http://hl7.org/fhir/spdx-license"))
  case PHP_LICENSE_V3_01
      extends SPDX_LICENSE("PHP-3.01", Some("PHP License v3.01"), Some("http://hl7.org/fhir/spdx-license"))
  case PLEXUS
      extends SPDX_LICENSE("Plexus", Some("Plexus Classworlds License"), Some("http://hl7.org/fhir/spdx-license"))
  case POSTGRESQL
      extends SPDX_LICENSE("PostgreSQL", Some("PostgreSQL License"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case PYTHON_LICENSE_2_0
      extends SPDX_LICENSE("Python-2.0", Some("Python License 2.0"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case REALNETWORKS_PUBLIC_SOURCE_LICENSE_V1_0
      extends SPDX_LICENSE(
        "RPSL-1.0",
        Some("RealNetworks Public Source License v1.0"),
        Some("http://hl7.org/fhir/spdx-license"))
  case RECIPROCAL_PUBLIC_LICENSE_1_1
      extends SPDX_LICENSE("RPL-1.1", Some("Reciprocal Public License 1.1"), Some("http://hl7.org/fhir/spdx-license"))
  case RECIPROCAL_PUBLIC_LICENSE_1_5
      extends SPDX_LICENSE("RPL-1.5", Some("Reciprocal Public License 1.5"), Some("http://hl7.org/fhir/spdx-license"))
  case RED_HAT_ECOS_PUBLIC_LICENSE_V1_1
      extends SPDX_LICENSE(
        "RHeCos-1.1",
  ...
  case RSCPL
      extends SPDX_LICENSE("RSCPL", Some("Ricoh Source Code Public License"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case SGI_FREE_SOFTWARE_LICENSE_B_V1_0
      extends SPDX_LICENSE(
        ...
        Some("http://hl7.org/fhir/spdx-license"))
  case SGI_FREE_SOFTWARE_LICENSE_B_V1_1
      extends SPDX_LICENSE(
        "SGI-B-1.1",
        Some("SGI Free Software License B v1.1"),
        Some("http://hl7.org/fhir/spdx-license"))
  case SGI_FREE_SOFTWARE_LICENSE_B_V2_0
      extends SPDX_LICENSE(
        "SGI-B-2.0",
        Some("SGI Free Software License B v2.0"),
        Some("http://hl7.org/fhir/spdx-license"))
  case SIL_OPEN_FONT_LICENSE_1_0
      extends SPDX_LICENSE("OFL-1.0", Some("SIL Open Font License 1.0"), Some("http://hl7.org/fhir/spdx-license"))
  case SIL_OPEN_FONT_LICENSE_1_1
      extends SPDX_LICENSE("OFL-1.1", Some("SIL Open Font License 1.1"), Some("http://hl7.org/fhir/spdx-license"))
  case SIMPLE_PUBLIC_LICENSE_2_0
      extends SPDX_LICENSE("SimPL-2.0", Some("Simple Public License 2.0"), Some("http://hl7.org/fhir/spdx-license"))
  case SISSL
      extends SPDX_LICENSE(
        "SISSL",
  ...
  case SMLNJ
      extends SPDX_LICENSE("SMLNJ", Some("Standard ML of New Jersey License"), Some("http://hl7.org/fhir/spdx-license"))
  case SMPPL
      extends SPDX_LICENSE(
        "SMPPL",
  ...
  case SPENCER_LICENSE_86
      extends SPDX_LICENSE("Spencer-86", Some("Spencer License 86"), Some("http://hl7.org/fhir/spdx-license"))
  case SPENCER_LICENSE_94
      extends SPDX_LICENSE("Spencer-94", Some("Spencer License 94"), Some("http://hl7.org/fhir/spdx-license"))
  case SPENCER_LICENSE_99
      extends SPDX_LICENSE("Spencer-99", Some("Spencer License 99"), Some("http://hl7.org/fhir/spdx-license"))
  case SUGARCRM_PUBLIC_LICENSE_V1_1_3
      extends SPDX_LICENSE(
        "SugarCRM-1.1.3",
        Some("SugarCRM Public License v1.1.3"),
        Some("http://hl7.org/fhir/spdx-license"))
  case SUN_INDUSTRY_STANDARDS_SOURCE_LICENSE_V1_2
      extends SPDX_LICENSE(
        "SISSL-1.2",
        Some("Sun Industry Standards Source License v1.2"),
        Some("http://hl7.org/fhir/spdx-license"))
  case SUN_PUBLIC_LICENSE_V1_0
      extends SPDX_LICENSE("SPL-1.0", Some("Sun Public License v1.0"), Some("http://hl7.org/fhir/spdx-license"))
  case SWL
      extends SPDX_LICENSE(
        "SWL",
        Some("Scheme Widget Library (SWL) Software License Agreement"),
        Some("http://hl7.org/fhir/spdx-license"))
  case SYBASE_OPEN_WATCOM_PUBLIC_LICENSE_1_0
      extends SPDX_LICENSE(
        "Watcom-1.0",
  ...
  case TCP_WRAPPERS_LICENSE
      extends SPDX_LICENSE("TCP-wrappers", Some("TCP Wrappers License"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case UNICODE_DFS_2016
      extends SPDX_LICENSE(
        ...
        Some("http://hl7.org/fhir/spdx-license"))
  case UNICODE_TERMS_OF_USE
      extends SPDX_LICENSE("Unicode-TOU", Some("Unicode Terms of Use"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case VOVIDA_SOFTWARE_LICENSE_V1_0
      extends SPDX_LICENSE("VSL-1.0", Some("Vovida Software License v1.0"), Some("http://hl7.org/fhir/spdx-license"))
  case W3C
      extends SPDX_LICENSE(
        "W3C",
  ...
  case YPL_10
      extends SPDX_LICENSE("YPL-1.0", Some("Yahoo! Public License v1.0"), Some("http://hl7.org/fhir/spdx-license"))
  case YPL_11
      extends SPDX_LICENSE("YPL-1.1", Some("Yahoo! Public License v1.1"), Some("http://hl7.org/fhir/spdx-license"))
  case ZED extends SPDX_LICENSE("Zed", Some("Zed License"), Some("http://hl7.org/fhir/spdx-license"))
  case ZEND_LICENSE_V2_0
      extends SPDX_LICENSE("Zend-2.0", Some("Zend License v2.0"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case ZIMBRA_PUBLIC_LICENSE_V1_4
      extends SPDX_LICENSE("Zimbra-1.4", Some("Zimbra Public License v1.4"), Some("http://hl7.org/fhir/spdx-license"))
  ...
  case ZLIB_ACKNOWLEDGEMENT
      extends SPDX_LICENSE(
        ...
        Some("http://hl7.org/fhir/spdx-license"))
  case ZOPE_PUBLIC_LICENSE_1_1
      extends SPDX_LICENSE("ZPL-1.1", Some("Zope Public License 1.1"), Some("http://hl7.org/fhir/spdx-license"))
  case ZOPE_PUBLIC_LICENSE_2_0
      extends SPDX_LICENSE("ZPL-2.0", Some("Zope Public License 2.0"), Some("http://hl7.org/fhir/spdx-license"))
  case ZOPE_PUBLIC_LICENSE_2_1
      extends SPDX_LICENSE("ZPL-2.1", Some("Zope Public License 2.1"), Some("http://hl7.org/fhir/spdx-license"))
}
object SPDX_LICENSE extends EType[SPDX_LICENSE]("http://hl7.org/fhir/ValueSet/spdx-license")

enum SPECIMEN_CONTAINED_PREFERENCE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ALTERNATE
      extends SPECIMEN_CONTAINED_PREFERENCE(
        "alternate",
        Some("Alternate"),
        Some("http://hl7.org/fhir/specimen-contained-preference"))
  case PREFERRED
      extends SPECIMEN_CONTAINED_PREFERENCE(
        "preferred",
        Some("Preferred"),
...
object SPECIMEN_CONTAINED_PREFERENCE
    extends EType[SPECIMEN_CONTAINED_PREFERENCE]("http://hl7.org/fhir/ValueSet/specimen-contained-preference")
...
enum SPECIMEN_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ENTERED_IN_ERROR
      extends SPECIMEN_STATUS("entered-in-error", Some("Entered in Error"), Some("http://hl7.org/fhir/specimen-status"))
  case UNAVAILABLE
      extends SPECIMEN_STATUS("unavailable", Some("Unavailable"), Some("http://hl7.org/fhir/specimen-status"))
  case UNSATISFACTORY
      extends SPECIMEN_STATUS("unsatisfactory", Some("Unsatisfactory"), Some("http://hl7.org/fhir/specimen-status"))
}
...
enum STRAND_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case WATSON
      extends STRAND_TYPE("watson", Some("Watson strand of referenceSeq"), Some("http://hl7.org/fhir/strand-type"))
}
object STRAND_TYPE extends EType[STRAND_TYPE]("http://hl7.org/fhir/ValueSet/strand-type")

enum STRUCTURE_DEFINITION_KIND(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case COMPLEX_DATA_TYPE
      extends STRUCTURE_DEFINITION_KIND(
        "complex-type",
        Some("Complex Data Type"),
        Some("http://hl7.org/fhir/structure-definition-kind"))
  case LOGICAL
      extends STRUCTURE_DEFINITION_KIND(
        "logical",
        Some("Logical"),
...
object STRUCTURE_DEFINITION_KIND
    extends EType[STRUCTURE_DEFINITION_KIND]("http://hl7.org/fhir/ValueSet/structure-definition-kind")

enum SUBSCRIPTION_CHANNEL_TYPE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case EMAIL
      extends SUBSCRIPTION_CHANNEL_TYPE("email", Some("Email"), Some("http://hl7.org/fhir/subscription-channel-type"))
  case MESSAGE
      extends SUBSCRIPTION_CHANNEL_TYPE(
        "message",
        Some("Message"),
        Some("http://hl7.org/fhir/subscription-channel-type"))
  case REST_HOOK
      extends SUBSCRIPTION_CHANNEL_TYPE(
        "rest-hook",
        Some("Rest Hook"),
...
enum SUBSCRIPTION_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  ...
  case REQUESTED
      extends SUBSCRIPTION_STATUS("requested", Some("Requested"), Some("http://hl7.org/fhir/subscription-status"))
}
...
enum SUBSTANCE_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ENTERED_IN_ERROR
      extends SUBSTANCE_STATUS(
        "entered-in-error",
        Some("Entered in Error"),
        Some("http://hl7.org/fhir/substance-status"))
...
enum SUPPLYDELIVERY_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ABANDONED
      extends SUPPLYDELIVERY_STATUS("abandoned", Some("Abandoned"), Some("http://hl7.org/fhir/supplydelivery-status"))
  case COMPLETED
      extends SUPPLYDELIVERY_STATUS("completed", Some("Delivered"), Some("http://hl7.org/fhir/supplydelivery-status"))
  case ENTERED_IN_ERROR
      extends SUPPLYDELIVERY_STATUS(
        "entered-in-error",
        Some("Entered In Error"),
        Some("http://hl7.org/fhir/supplydelivery-status"))
  case IN_PROGRESS
      extends SUPPLYDELIVERY_STATUS(
        "in-progress",
        Some("In Progress"),
...
enum SUPPLYREQUEST_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ACTIVE extends SUPPLYREQUEST_STATUS("active", Some("Active"), Some("http://hl7.org/fhir/supplyrequest-status"))
  case CANCELLED
      extends SUPPLYREQUEST_STATUS("cancelled", Some("Cancelled"), Some("http://hl7.org/fhir/supplyrequest-status"))
  case COMPLETED
      extends SUPPLYREQUEST_STATUS("completed", Some("Completed"), Some("http://hl7.org/fhir/supplyrequest-status"))
  case DRAFT extends SUPPLYREQUEST_STATUS("draft", Some("Draft"), Some("http://hl7.org/fhir/supplyrequest-status"))
  case ENTERED_IN_ERROR
      extends SUPPLYREQUEST_STATUS(
        "entered-in-error",
        Some("Entered in Error"),
        Some("http://hl7.org/fhir/supplyrequest-status"))
  case SUSPENDED
      extends SUPPLYREQUEST_STATUS("suspended", Some("Suspended"), Some("http://hl7.org/fhir/supplyrequest-status"))
  case UNKNOWN
      extends SUPPLYREQUEST_STATUS("unknown", Some("Unknown"), Some("http://hl7.org/fhir/supplyrequest-status"))
}
object SUPPLYREQUEST_STATUS extends EType[SUPPLYREQUEST_STATUS]("http://hl7.org/fhir/ValueSet/supplyrequest-status")

enum SYSTEM_RESTFUL_INTERACTION(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case BATCH extends SYSTEM_RESTFUL_INTERACTION("batch", Some("batch"), Some("http://hl7.org/fhir/restful-interaction"))
  case HISTORY_SYSTEM
      extends SYSTEM_RESTFUL_INTERACTION(
        "history-system",
        Some("history-system"),
        Some("http://hl7.org/fhir/restful-interaction"))
  case SEARCH_SYSTEM
      extends SYSTEM_RESTFUL_INTERACTION(
        "search-system",
        Some("search-system"),
...
enum TASK_INTENT(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case FILLER_ORDER
      extends TASK_INTENT("filler-order", Some("filler-order"), Some("http://hl7.org/fhir/request-intent"))
  case INSTANCE_ORDER
      extends TASK_INTENT("instance-order", Some("instance-order"), Some("http://hl7.org/fhir/request-intent"))
  ...
  case ORIGINAL_ORDER
      extends TASK_INTENT("original-order", Some("original-order"), Some("http://hl7.org/fhir/request-intent"))
  ...
  case REFLEX_ORDER
      extends TASK_INTENT("reflex-order", Some("reflex-order"), Some("http://hl7.org/fhir/request-intent"))
...
enum TASK_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ENTERED_IN_ERROR
      extends TASK_STATUS("entered-in-error", Some("Entered in Error"), Some("http://hl7.org/fhir/task-status"))
...
enum TYPE_DERIVATION_RULE(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case CONSTRAINT
      extends TYPE_DERIVATION_RULE("constraint", Some("Constraint"), Some("http://hl7.org/fhir/type-derivation-rule"))
  case SPECIALIZATION
      extends TYPE_DERIVATION_RULE(
        "specialization",
        Some("Specialization"),
        Some("http://hl7.org/fhir/type-derivation-rule"))
}
object TYPE_DERIVATION_RULE extends EType[TYPE_DERIVATION_RULE]("http://hl7.org/fhir/ValueSet/type-derivation-rule")

enum TYPE_RESTFUL_INTERACTION(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case CREATE
      extends TYPE_RESTFUL_INTERACTION("create", Some("create"), Some("http://hl7.org/fhir/restful-interaction"))
  case DELETE
      extends TYPE_RESTFUL_INTERACTION("delete", Some("delete"), Some("http://hl7.org/fhir/restful-interaction"))
  case HISTORY_INSTANCE
      extends TYPE_RESTFUL_INTERACTION(
        "history-instance",
  ...
  case SEARCH_TYPE
      extends TYPE_RESTFUL_INTERACTION(
        ...
        Some("http://hl7.org/fhir/restful-interaction"))
  case UPDATE
      extends TYPE_RESTFUL_INTERACTION("update", Some("update"), Some("http://hl7.org/fhir/restful-interaction"))
...
object TYPE_RESTFUL_INTERACTION
    extends EType[TYPE_RESTFUL_INTERACTION]("http://hl7.org/fhir/ValueSet/type-restful-interaction")
...
enum UDI_ENTRY_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case SELF_REPORTED
      extends UDI_ENTRY_TYPE("self-reported", Some("Self Reported"), Some("http://hl7.org/fhir/udi-entry-type"))
...
enum V3_CONFIDENTIALITYCLASSIFICATION(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case L
      extends V3_CONFIDENTIALITYCLASSIFICATION(
        "L",
        Some("L"),
        Some("http://terminology.hl7.org/CodeSystem/v3-Confidentiality"))
  case M
      extends V3_CONFIDENTIALITYCLASSIFICATION(
        "M",
        Some("M"),
...
object V3_CONFIDENTIALITYCLASSIFICATION
    extends EType[V3_CONFIDENTIALITYCLASSIFICATION](
...
enum VERIFICATIONRESULT_STATUS(val name: String, val display: Option[String], val system: Option[String])
    extends ToCodingAble {
  case ATTESTED
      extends VERIFICATIONRESULT_STATUS("attested", Some("Attested"), Some("http://hl7.org/fhir/CodeSystem/status"))
  case IN_PROCESS
      extends VERIFICATIONRESULT_STATUS("in-process", Some("In process"), Some("http://hl7.org/fhir/CodeSystem/status"))
  case REQUIRES_REVALIDATION
      extends VERIFICATIONRESULT_STATUS(
        "req-revalid",
        Some("Requires revalidation"),
        Some("http://hl7.org/fhir/CodeSystem/status"))
  case RE_VALIDATION_FAILED
      extends VERIFICATIONRESULT_STATUS(
        "reval-fail",
        Some("Re-Validation failed"),
        Some("http://hl7.org/fhir/CodeSystem/status"))
  case VALIDATED
      extends VERIFICATIONRESULT_STATUS("validated", Some("Validated"), Some("http://hl7.org/fhir/CodeSystem/status"))
...
object VERIFICATIONRESULT_STATUS
    extends EType[VERIFICATIONRESULT_STATUS]("http://hl7.org/fhir/ValueSet/verificationresult-status")

enum VERSIONING_POLICY(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case NO_VERSIONID_SUPPORT
      extends VERSIONING_POLICY(
        "no-version",
        Some("No VersionId Support"),
        Some("http://hl7.org/fhir/versioning-policy"))
  case VERSIONED
      extends VERSIONING_POLICY("versioned", Some("Versioned"), Some("http://hl7.org/fhir/versioning-policy"))
  case VERSIONID_TRACKED_FULLY
      extends VERSIONING_POLICY(
        "versioned-update",
        Some("VersionId tracked fully"),
        Some("http://hl7.org/fhir/versioning-policy"))
}
