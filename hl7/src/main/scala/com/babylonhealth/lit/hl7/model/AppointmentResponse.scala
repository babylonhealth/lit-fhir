...
object AppointmentResponse extends CompanionFor[AppointmentResponse] {
  implicit def summonObjectAndCompanionAppointmentResponse989255542(
      o: AppointmentResponse): ObjectAndCompanion[AppointmentResponse, AppointmentResponse.type] =
...
/** A reply to an appointment request for a patient and/or practitioner(s), such as a confirmation or rejection.
  ...
  * @param end
  *   - This may be either the same as the appointment request to confirm the details of the appointment, or alternately
  *   a new time to request a re-negotiation of the end time.
  * @param meta
  ...
  * @param identifier
  *   - This records identifiers associated with this appointment response concern that are defined by business
  ...
  *   is accepted, the times can either be the time of the appointment (as a confirmation of the time) or can be empty.
  */
@POJOBoilerplate
