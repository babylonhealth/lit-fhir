...
/** This resource provides eligibility and plan details from the processing of an CoverageEligibilityRequest resource.
  ...
  *
  * @constructor
  *   Introduces the fields form, status, purpose, patient, created, request, outcome, insurer, requestor, identifier,
  *   preAuthRef, serviced, disposition, error, insurance.
  * @param id
  ...
  * @param preAuthRef
  *   - A reference from the Insurer to which these services pertain to be used on further communication and as proof
