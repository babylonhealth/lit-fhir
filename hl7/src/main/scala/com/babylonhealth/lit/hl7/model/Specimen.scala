...
/** A sample to be used for analysis.
  ...
  *
  * @constructor
  *   Introduces the fields `type`, note, status, parent, subject, request, condition, identifier, receivedTime,
  *   accessionIdentifier, container, collection, processing.
  * @param id
  ...
  * @param note
  *   - To communicate any details or issues about the specimen or during the specimen collection. (for example: broken
  *   vial, sent with patient, frozen).
  * @param status
  *   - The availability of the specimen.
  * @param parent
  *   - Reference to the parent (source) specimen which is used when the specimen was either derived from or a component
  *   of another specimen.
  * @param subject
  ...
  *   - The identifier assigned by the lab when accessioning specimen(s). This is not necessarily the same as the
