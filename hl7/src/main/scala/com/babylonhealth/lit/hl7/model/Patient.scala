...
/** Demographics and other administrative information about an individual or animal receiving care or other
  ...
  *
  * @constructor
  *   Introduces the fields name, photo, active, gender, telecom, address, birthDate, identifier, deceased,
  *   maritalStatus, multipleBirth, generalPractitioner, managingOrganization, link, contact, communication.
  * @param id
