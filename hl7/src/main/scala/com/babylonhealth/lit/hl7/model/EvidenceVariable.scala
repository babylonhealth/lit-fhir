...
/** The EvidenceVariable resource describes a "PICO" element that knowledge (evidence, assertion, recommendation) is
  ...
  *
  * @constructor
  *   Introduces the fields url, name, date, note, `type`, title, topic, status, author, editor, version, contact,
  *   subtitle, reviewer, endorser, publisher, copyright, identifier, shortTitle, useContext, description, jurisdiction,
  *   approvalDate, lastReviewDate, effectivePeriod, relatedArtifact, characteristic.
  * @param id
  ...
  *   literal address at which at which an authoritative instance of this evidence variable is (or will be) published.
  *   This URL can be the target of a canonical reference. It SHALL remain the same when the evidence variable is stored
  ...
  * @param name
  *   - A natural language name identifying the evidence variable. This name should be usable as an identifier for the
  ...
  * @param topic
  *   - Descriptive topics related to the content of the EvidenceVariable. Topics provide a high-level categorization
  *   grouping types of EvidenceVariables that can be useful for filtering and searching.
  * @param status
  ...
  *   specification, model, design or instance. This is an arbitrary value managed by the evidence variable author and
  ...
  * @param copyright
  *   - A copyright statement relating to the evidence variable and/or its contents. Copyright statements are generally
  *   legal restrictions on the use and publishing of the evidence variable.
  * @param identifier
  ...
  *   and may be used to assist with indexing and searching for appropriate evidence variable instances.
  * @param description
  ...
  *   - A characteristic that defines the members of the evidence element. Multiple characteristics are applied with
  *   "and" semantics.
  */
@POJOBoilerplate
