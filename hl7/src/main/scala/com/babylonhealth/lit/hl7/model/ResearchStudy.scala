...
object ResearchStudy extends CompanionFor[ResearchStudy] {
  implicit def summonObjectAndCompanionResearchStudy1019690495(
...
/** A process where a researcher or organization plans and then executes a series of steps intended to increase the
  ...
  *
  * @constructor
  *   Introduces the fields site, note, title, phase, focus, partOf, status, period, contact, keyword, sponsor,
  *   protocol, category, location, condition, identifier, enrollment, description, reasonStopped, relatedArtifact,
  *   primaryPurposeType, principalInvestigator, arm, objective.
  * @param id
  ...
  * @param phase
  *   - The stage in the progression of a therapy from initial experimental use in humans in clinical trials to
  *   post-market evaluation.
  * @param focus
  *   - The medication(s), food(s), therapy(ies), device(s) or other concerns or interventions that the study is seeking
  ...
  * @param condition
  *   - The condition that is the focus of the study. For example, In a study to examine risk factors for Lupus, might
  *   have as an inclusion criterion "healthy volunteer", but the target condition code would be a Lupus SNOMED code.
  * @param identifier
  *   - Identifiers assigned to this research study by the sponsor or other systems.
  * @param enrollment
  *   - Reference to a Group that defines the criteria for and quantity of subjects participating in the study. E.g. "
  *   200 female Europeans between the ages of 20 and 45 with early onset diabetes".
  * @param description
  ...
  *   - A researcher in a study who oversees multiple aspects of the study, such as concept development, protocol
  *   writing, protocol submission for IRB approval, participant recruitment, informed consent, data collection,
  *   analysis, interpretation and presentation.
  * @param arm
  *   - Describes an expected sequence of events for one of the participants of a study. E.g. Exposure to drug A,
  *   wash-out, exposure to drug B, wash-out, follow-up.
  * @param objective
