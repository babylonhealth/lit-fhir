...
/** Record of delivery of what is supplied.
  ...
  *
  * @constructor Introduces the fields `type`, partOf, status, basedOn, patient, supplier, receiver, identifier, destination, occurrence, suppliedItem.
  ...
  * @param `type` - Indicates the type of dispensing event that is performed. Examples include: Trial Fill, Completion of Trial, Partial Fill, Emergency Fill, Samples, etc.
  ...
  * @param identifier - Identifier for the supply delivery event that is used to identify it across multiple disparate systems.
  * @param destination - Identification of the facility/location where the Supply was shipped to, as part of the dispense event.
  * @param implicitRules - A reference to a set of rules that were followed when the resource was constructed, and which must be understood when processing the content. Often, this is a reference to an implementation guide that defines the special rules along with other profiles etc.
  * @param occurrence - The date or time(s) the activity occurred.
