...
/** Record of delivery of what is supplied.
  ...
  *
  * @constructor
  *   Introduces the fields `type`, partOf, status, basedOn, patient, supplier, receiver, identifier, destination,
  *   occurrence, suppliedItem.
  * @param id
  ...
  * @param `type`
  *   - Indicates the type of dispensing event that is performed. Examples include: Trial Fill, Completion of Trial,
