...
object MedicinalProductManufactured extends CompanionFor[MedicinalProductManufactured] {
  override val baseType: CompanionFor[MedicinalProductManufactured] = MedicinalProductManufactured
  def apply(
...
/** The manufactured item as contained in the packaged medicinal product.
  ...
  *
  * @constructor Introduces the fields quantity, ingredient, manufacturer, unitOfPresentation, manufacturedDoseForm, otherCharacteristics, physicalCharacteristics.
  ...
  * @param manufacturer - Manufacturer of the item (Note that this should be named "manufacturer" but it currently causes technical issues).
  ...
  * @param unitOfPresentation - The “real world” units in which the quantity of the manufactured item is described.
  * @param manufacturedDoseForm - Dose form as manufactured and before any transformation into the pharmaceutical product.
