...
object MedicinalProductUndesirableEffect extends CompanionFor[MedicinalProductUndesirableEffect] {
  ...
  def extractFrequencyOfOccurrence(t: MedicinalProductUndesirableEffect): Option[CodeableConcept] =
    t.frequencyOfOccurrence
  def extractSymptomConditionEffect(t: MedicinalProductUndesirableEffect): Option[CodeableConcept] =
    t.symptomConditionEffect
  override val thisName: String = "MedicinalProductUndesirableEffect"
  override val searchParams: Map[String, MedicinalProductUndesirableEffect => Seq[Any]] = Map(
...
/** Describe the undesirable effects of the medicinal product.
  ...
  *
  * @constructor Introduces the fields subject, population, classification, frequencyOfOccurrence, symptomConditionEffect.
