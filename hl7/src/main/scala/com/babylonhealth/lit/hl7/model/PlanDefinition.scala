...
/** This resource allows for the definition of various types of plans as a sharable, consumable, and executable
  ...
  *   purpose, library, subtitle, reviewer, endorser, publisher, copyright, identifier, subject, useContext,
  *   description, experimental, jurisdiction, approvalDate, lastReviewDate, effectivePeriod, relatedArtifact, goal,
  *   action.
  * @param id
