...
object CommunicationRequest extends CompanionFor[CommunicationRequest] {
  implicit def summonObjectAndCompanionCommunicationRequest_848340778(
      o: CommunicationRequest): ObjectAndCompanion[CommunicationRequest, CommunicationRequest.type] =
  ...
  object Payload extends CompanionFor[Payload] {
    ...
    def unapply(o: Payload): Option[(Option[String], LitSeq[Extension], Payload.ContentChoice, LitSeq[Extension])] =
  ...
  val payload: FHIRComponentFieldMeta[LitSeq[CommunicationRequest.Payload]] =
    FHIRComponentFieldMeta(
      "payload",
      lTagOf[LitSeq[CommunicationRequest.Payload]],
      false,
      lTagOf[CommunicationRequest.Payload])
...
/** A request to convey information; e.g. the CDS system proposes that an alert be sent to a responsible provider, the CDS system proposes that the public health agency be notified about a reportable condition.
  ...
  *
  * @constructor Introduces the fields note, about, status, medium, sender, basedOn, subject, replaces, category, priority, encounter, requester, recipient, identifier, authoredOn, reasonCode, statusReason, doNotPerform, occurrence, groupIdentifier, reasonReference, payload.
  ...
  * @param note - Comments made about the request by the requester, sender, recipient, subject or other participants.
  * @param about - Other resources that pertain to this communication request and to which this communication request should be associated.
  ...
  * @param sender - The entity (e.g. person, organization, clinical information system, or device) which is to be the source of the communication.
  ...
  * @param replaces - Completed or terminated request(s) whose function is taken by this new request.
  * @param category - The type of message to be sent such as alert, notification, reminder, instruction, etc.
  * @param priority - Characterizes how quickly the proposed act must be initiated. Includes concepts such as stat, urgent, routine.
  * @param contained - These resources do not have an independent existence apart from the resource that contains them - they cannot be identified independently, and nor can they have their own independent transaction scope.
  * @param extension - May be used to represent additional information that is not part of the basic definition of the resource. To make the use of extensions safe and manageable, there is a strict set of governance  applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
  * @param encounter - The Encounter during which this CommunicationRequest was created or to which the creation of this record is tightly associated.
  * @param requester - The device, individual, or organization who initiated the request and has responsibility for its activation.
  * @param recipient - The entity (e.g. person, organization, clinical information system, device, group, or care team) which is the intended target of the communication.
  * @param identifier - Business identifiers assigned to this communication request by the performer or other systems which remain constant as the resource is updated and propagates from server to server.
  * @param authoredOn - For draft requests, indicates the date of initial creation.  For requests with other statuses, indicates the date of activation.
  ...
  * @param doNotPerform - If true indicates that the CommunicationRequest is asking for the specified action to *not* occur.
  * @param implicitRules - A reference to a set of rules that were followed when the resource was constructed, and which must be understood when processing the content. Often, this is a reference to an implementation guide that defines the special rules along with other profiles etc.
  * @param occurrence - The time when this communication is to occur.
  * @param groupIdentifier - A shared identifier common to all requests that were authorized more or less simultaneously by a single author, representing the identifier of the requisition, prescription or similar form.
