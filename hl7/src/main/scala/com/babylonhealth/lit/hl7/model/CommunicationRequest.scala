...
/** A request to convey information; e.g. the CDS system proposes that an alert be sent to a responsible provider, the
  ...
  *
  * @constructor
  *   Introduces the fields note, about, status, medium, sender, basedOn, subject, replaces, category, priority,
  *   encounter, requester, recipient, identifier, authoredOn, reasonCode, statusReason, doNotPerform, occurrence,
  *   groupIdentifier, reasonReference, payload.
  * @param id
  ...
  * @param encounter
  *   - The Encounter during which this CommunicationRequest was created or to which the creation of this record is
  *   tightly associated.
  * @param requester
  *   - The device, individual, or organization who initiated the request and has responsibility for its activation.
  * @param recipient
  *   - The entity (e.g. person, organization, clinical information system, device, group, or care team) which is the
  *   intended target of the communication.
  * @param identifier
  *   - Business identifiers assigned to this communication request by the performer or other systems which remain
  *   constant as the resource is updated and propagates from server to server.
  * @param authoredOn
  *   - For draft requests, indicates the date of initial creation. For requests with other statuses, indicates the date
  *   of activation.
  * @param reasonCode
