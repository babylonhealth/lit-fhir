...
/** The regulatory authorization of a medicinal product.
  ...
  *
  * @constructor
  *   Introduces the fields status, holder, subject, country, regulator, identifier, statusDate, legalBasis,
  *   restoreDate, jurisdiction, validityPeriod, dataExclusivityPeriod, internationalBirthDate,
  *   dateOfFirstAuthorization, procedure, jurisdictionalAuthorization.
  * @param id
