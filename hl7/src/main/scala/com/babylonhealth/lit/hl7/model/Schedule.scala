...
/** A container for slots of time that may be available for booking appointments.
  ...
  *
  * @constructor
  *   Introduces the fields actor, active, comment, specialty, identifier, serviceType, serviceCategory,
  *   planningHorizon.
  * @param id
  ...
  *   - The period of time that the slots that reference this Schedule resource cover (even if none exist). These cover
  *   the amount of time that an organization's planning horizon; the interval for which they are currently accepting
