...
object ImmunizationEvaluation extends CompanionFor[ImmunizationEvaluation] {
  override val baseType: CompanionFor[ImmunizationEvaluation] = ImmunizationEvaluation
  ...
  val status: FHIRComponentFieldMeta[IMMUNIZATION_EVALUATION_STATUS] =
    FHIRComponentFieldMeta(
      "status",
      lTagOf[IMMUNIZATION_EVALUATION_STATUS],
      false,
      lTagOf[IMMUNIZATION_EVALUATION_STATUS])
...
/** Describes a comparison of an immunization event against published recommendations to determine if the administration is "valid" in relation to those  recommendations.
  ...
  *
  * @constructor Introduces the fields date, status, series, patient, authority, identifier, doseStatus, description, targetDisease, doseNumber, seriesDoses, doseStatusReason, immunizationEvent.
  ...
  * @param status - Indicates the current status of the evaluation of the vaccination administration event.
  * @param series - One possible path to achieve presumed immunity against a disease - within the context of an authority.
  ...
  * @param doseStatus - Indicates if the dose is valid or not valid with respect to the published recommendations.
  ...
  * @param doseNumber - Nominal position in a series.
  * @param seriesDoses - The recommended number of doses to achieve immunity.
  * @param doseStatusReason - Provides an explanation as to why the vaccine administration event is valid or not relative to the published recommendations.
