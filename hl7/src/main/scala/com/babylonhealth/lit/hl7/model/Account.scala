...
object Account extends CompanionFor[Account] {
  ...
  object Guarantor extends CompanionFor[Guarantor] {
    implicit def summonObjectAndCompanionGuarantor280006109(
        o: Guarantor): ObjectAndCompanion[Guarantor, Guarantor.type] = ObjectAndCompanion(o, this)
...
/** A financial tool for tracking value accrued for a particular purpose. In the healthcare field, used to track charges
  ...
  *
  * @constructor
  *   Introduces the fields `type`, name, owner, status, partOf, subject, identifier, description, servicePeriod,
  *   coverage, guarantor.
  * @param id
  ...
  * @param subject
  *   - Identifies the entity which incurs the expenses. While the immediate recipients of services or goods might be
  *   entities related to the subject, the expenses were ultimately incurred by the subject of the Account.
  * @param language
