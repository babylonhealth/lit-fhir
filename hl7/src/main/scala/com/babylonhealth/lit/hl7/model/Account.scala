...
object Account extends CompanionFor[Account] {
  ...
  object Coverage extends CompanionFor[Coverage] {
    ...
    def unapply(o: Coverage): Option[(Option[String], Reference, Option[PositiveInt], LitSeq[Extension], LitSeq[Extension])] =
...
/** A financial tool for tracking value accrued for a particular purpose. In the healthcare field, used to track charges for a
  * patient, cost centers, etc.
  *
  * Subclass of [[hl7.model.DomainResource]] (A resource that includes narrative, extensions, and contained resources.)
  *
  * @constructor
  *   Introduces the fields `type`, name, owner, status, partOf, subject, identifier, description, servicePeriod, coverage,
  *   guarantor.
  * @param id
