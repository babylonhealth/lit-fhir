...
/** A slot of time on a schedule that may be available for booking appointments.
  ...
  * @param serviceType
  *   - The type of appointments that can be booked into this slot (ideally this would be an identifiable service - which is at a
  *   location, rather than the location itself). If provided then this overrides the value provided on the availability resource.
  * @param implicitRules
