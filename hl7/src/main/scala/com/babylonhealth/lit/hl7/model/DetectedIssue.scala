...
object DetectedIssue extends CompanionFor[DetectedIssue] {
  ...
  val mitigation: FHIRComponentFieldMeta[LitSeq[DetectedIssue.Mitigation]] =
    FHIRComponentFieldMeta(
      "mitigation",
      lTagOf[LitSeq[DetectedIssue.Mitigation]],
      false,
      lTagOf[DetectedIssue.Mitigation])
...
/** Indicates an actual or potential clinical issue with or between one or more active or proposed clinical actions for a patient; e.g. Drug-drug interaction, Ineffective treatment frequency, Procedure-condition conflict, etc.
  ...
  *
  * @constructor Introduces the fields code, status, author, detail, patient, severity, reference, identifier, implicated, identified, evidence, mitigation.
  ...
  * @param author - Individual or device responsible for the issue being raised.  For example, a decision support application or a pharmacist conducting a medication review.
  ...
  * @param severity - Indicates the degree of importance associated with the identified issue based on the potential impact on the patient.
  * @param contained - These resources do not have an independent existence apart from the resource that contains them - they cannot be identified independently, and nor can they have their own independent transaction scope.
  * @param extension - May be used to represent additional information that is not part of the basic definition of the resource. To make the use of extensions safe and manageable, there is a strict set of governance  applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
  * @param reference - The literature, knowledge-base or similar reference that describes the propensity for the detected issue identified.
  * @param identifier - Business identifier associated with the detected issue record.
  * @param implicated - Indicates the resource representing the current activity or proposed activity that is potentially problematic.
  ...
  * @param evidence - Supporting evidence or manifestations that provide the basis for identifying the detected issue such as a GuidanceResponse or MeasureReport.
  * @param mitigation - Indicates an action that has been taken or is committed to reduce or eliminate the likelihood of the risk identified by the detected issue from manifesting.  Can also reflect an observation of known mitigating factors that may reduce/eliminate the need for any action.
  */
@POJOBoilerplate
class DetectedIssue(
    override val id: Option[String] = None,
