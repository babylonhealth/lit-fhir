...
/** Indicates an actual or potential clinical issue with or between one or more active or proposed clinical actions for
  ...
  *
  * @constructor
  *   Introduces the fields code, status, author, detail, patient, severity, reference, identifier, implicated,
  *   identified, evidence, mitigation.
  * @param id
  ...
  *   identified by the detected issue from manifesting. Can also reflect an observation of known mitigating factors
