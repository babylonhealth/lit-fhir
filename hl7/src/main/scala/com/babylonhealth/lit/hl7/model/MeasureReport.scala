...
/** The MeasureReport resource contains the results of the calculation of a measure; and optionally a reference to the resources involved in that calculation.
  ...
  *
  * @constructor Introduces the fields `type`, date, status, period, measure, subject, reporter, identifier, evaluatedResource, improvementNotation, group.
  ...
  * @param status - The MeasureReport status. No data will be available until the MeasureReport status is complete.
  ...
  * @param identifier - A formal identifier that is used to identify this MeasureReport when it is represented in other formats or referenced in a specification, model, design or an instance.
  ...
  * @param evaluatedResource - A reference to a Bundle containing the Resources that were used in the calculation of this measure.
  * @param improvementNotation - Whether improvement in the measure is noted by an increase or decrease in the measure score.
