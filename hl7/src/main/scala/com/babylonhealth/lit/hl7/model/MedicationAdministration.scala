...
/** Describes the event of a patient consuming or otherwise being administered a medication. This may be as simple as
  ...
  *   instantiates, statusReason, effective, eventHistory, medication, reasonReference, supportingInformation, dosage,
  *   performer.
  * @param id
  ...
  * @param identifier
  *   - Identifiers associated with this Medication Administration that are defined by business processes and/or used to
  ...
  * @param effective
  *   - A specific date/time or interval of time during which the administration took place (or did not take place, when
  *   the 'notGiven' attribute is true). For many administrations, such as swallowing a tablet the use of dateTime is
  *   more appropriate.
  * @param eventHistory
  ...
  * @param medication
  *   - Identifies the medication that was administered. This is either a link to a resource representing the details of
  ...
  *   - Additional information (for example, patient height and weight) that supports the administration of the
  *   medication.
  * @param dosage
