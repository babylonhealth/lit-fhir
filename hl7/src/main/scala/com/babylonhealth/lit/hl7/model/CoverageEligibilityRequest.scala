...
object CoverageEligibilityRequest extends CompanionFor[CoverageEligibilityRequest] {
  ...
  object Item extends CompanionFor[Item] {
    ...
    object Diagnosis extends CompanionFor[Diagnosis] {
      implicit def summonObjectAndCompanionDiagnosis_47587865(
      ...
      def unapply(
          o: Diagnosis): Option[(Option[String], LitSeq[Extension], Option[Diagnosis.DiagnosisChoice], LitSeq[Extension])] =
        Some((o.id, o.extension, o.diagnosis, o.modifierExtension))
  ...
  object SupportingInfo extends CompanionFor[SupportingInfo] {
    ...
    val fieldsMeta: Seq[FHIRComponentFieldMeta[_]] =
      Seq(id, sequence, extension, information, appliesToAll, modifierExtension)
    override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Success(fields(t))
  ...
  object Insurance extends CompanionFor[Insurance] {
    implicit def summonObjectAndCompanionInsurance550037473(
    ...
    val fieldsMeta: Seq[FHIRComponentFieldMeta[_]] =
      Seq(id, focal, coverage, extension, modifierExtension, businessArrangement)
    override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Success(fields(t))
  ...
  def extractSupportingInfo(t: CoverageEligibilityRequest): LitSeq[CoverageEligibilityRequest.SupportingInfo] =
    t.supportingInfo
...
/** The CoverageEligibilityRequest provides patient and insurance coverage information to an insurer for them to respond, in the form of an CoverageEligibilityResponse, with information regarding whether the stated coverage is valid and in-force and optionally to provide the insurance details of the policy.
  ...
  *
  * @constructor Introduces the fields status, purpose, patient, created, enterer, insurer, priority, provider, facility, identifier, serviced, insurance, supportingInfo, item.
  ...
  * @param purpose - Code to specify whether requesting: prior authorization requirements for some service categories or billing codes; benefits for coverages specified or discovered; discovery and return of coverages for the patient; and/or validation that the specified coverage is in-force at the date/period specified or 'now' if not specified.
  * @param patient - The party who is the beneficiary of the supplied coverage and for whom eligibility is sought.
  * @param created - The date when this resource was created.
  * @param enterer - Person who created the request.
  * @param insurer - The Insurer who issued the coverage in question and is the recipient of the request.
  ...
  * @param serviced - The date or dates when the enclosed suite of services were performed or completed.
  ...
  * @param insurance - Financial instruments for reimbursement for the health care products and services.
  ...
  * @param item - Service categories or billable services for which benefit details and/or an authorization prior to service delivery may be required by the payor.
  */
@POJOBoilerplate
