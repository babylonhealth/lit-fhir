...
object DeviceMetric extends CompanionFor[DeviceMetric] {
  ...
  object Calibration extends CompanionFor[Calibration] {
    implicit def summonObjectAndCompanionCalibration_23995587(o: Calibration): ObjectAndCompanion[Calibration, Calibration.type] =
...
/** Describes a measurement, calculation or setting capability of a medical device.
  ...
  *   DeviceMetric in the containment structure of the parent Device. An example would be a Device that represents a Channel. This
  *   reference can be used by a client application to distinguish DeviceMetrics that have the same type, but should be
