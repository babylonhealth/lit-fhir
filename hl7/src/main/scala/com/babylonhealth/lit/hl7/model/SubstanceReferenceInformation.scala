...
object SubstanceReferenceInformation extends CompanionFor[SubstanceReferenceInformation] {
  ...
  object Target extends CompanionFor[Target] {
    ...
    val modifierExtension: FHIRComponentFieldMeta[LitSeq[Extension]] =
      FHIRComponentFieldMeta("modifierExtension", lTagOf[LitSeq[Extension]], false, lTagOf[Extension])
    val fieldsMeta: Seq[FHIRComponentFieldMeta[_]] =
      Seq(id, `type`, target, source, organism, extension, amount, amountType, interaction, organismType, modifierExtension)
    override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Success(fields(t))
  ...
  object Gene extends CompanionFor[Gene] {
    ...
    val fieldsMeta: Seq[FHIRComponentFieldMeta[_]] = Seq(id, gene, source, extension, modifierExtension, geneSequenceOrigin)
    override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Success(fields(t))
