...
object OperationOutcome extends CompanionFor[OperationOutcome] {
  override val baseType: CompanionFor[OperationOutcome] = OperationOutcome
  ...
  val issue: FHIRComponentFieldMeta[NonEmptyLitSeq[OperationOutcome.Issue]] =
    FHIRComponentFieldMeta(
      "issue",
      lTagOf[NonEmptyLitSeq[OperationOutcome.Issue]],
      false,
      lTagOf[OperationOutcome.Issue])
  val fieldsMeta: Seq[FHIRComponentFieldMeta[_]] =
...
/** A collection of error, warning, or information messages that result from a system action.
  ...
  *
  * @constructor Introduces the fields issue.
