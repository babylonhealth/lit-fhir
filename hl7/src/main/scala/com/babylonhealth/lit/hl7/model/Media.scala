...
/** A photo, video, or audio recording acquired or used in healthcare. The actual content may be inline or provided by direct reference.
  ...
  *
  * @constructor Introduces the fields `type`, view, note, width, partOf, status, issued, device, height, frames, basedOn, subject, content, modality, operator, bodySite, duration, encounter, identifier, created, reasonCode, deviceName.
  ...
  * @param `type` - A code that classifies whether the media is an image, video or audio recording or some other media category.
  ...
  * @param issued - The date and time this version of the media was made available to providers, typically after having been reviewed.
  ...
  * @param basedOn - A procedure that is fulfilled in whole or in part by the creation of this media.
  ...
  * @param modality - Details of the type of the media - usually, how it was acquired (what type of device). If images sourced from a DICOM system, are wrapped in a Media resource, then this is the modality.
  ...
  * @param identifier - Identifiers associated with the image - these may include identifiers for the image itself, identifiers for the context of its collection (e.g. series ids) and context ids such as accession numbers or other workflow identifiers.
  * @param created - The date and time(s) at which the media was collected.
