...
object NamingSystem extends CompanionFor[NamingSystem] {
  ...
  val uniqueId: FHIRComponentFieldMeta[NonEmptyLitSeq[NamingSystem.UniqueId]] =
    FHIRComponentFieldMeta(
      "uniqueId",
      lTagOf[NonEmptyLitSeq[NamingSystem.UniqueId]],
      false,
      lTagOf[NamingSystem.UniqueId])
...
/** A curated namespace that issues unique symbols within that namespace for the identification of concepts, people, devices, etc.  Represents a "System" used within the Identifier and Coding data types.
  ...
  *
  * @constructor Introduces the fields name, kind, date, `type`, usage, status, contact, publisher, useContext, responsible, description, jurisdiction, uniqueId.
  ...
  * @param name - A natural language name identifying the naming system. This name should be usable as an identifier for the module by machine processing applications such as code generation.
  * @param kind - Indicates the purpose for the naming system - what kinds of things does it make unique?
  * @param date - The date  (and optionally time) when the naming system was published. The date must change when the business version changes and it must change if the status code changes. In addition, it should change when the substantive content of the naming system changes.
  * @param `type` - Categorizes a naming system for easier search by grouping related naming systems.
  * @param usage - Provides guidance on the use of the namespace, including the handling of formatting characters, use of upper vs. lower case, etc.
  * @param status - The status of this naming system. Enables tracking the life-cycle of the content.
  ...
  * @param useContext - The content was developed with a focus and intent of supporting the contexts that are listed. These contexts may be general categories (gender, age, ...) or may be references to specific programs (insurance plans, studies, ...) and may be used to assist with indexing and searching for appropriate naming system instances.
  * @param responsible - The name of the organization that is responsible for issuing identifiers or codes for this namespace and ensuring their non-collision.
  * @param description - A free text natural language description of the naming system from a consumer's perspective. Details about what the namespace identifies including scope, granularity, version labeling, etc.
  * @param jurisdiction - A legal or geographic region in which the naming system is intended to be used.
  ...
  * @param uniqueId - Indicates how the system may be identified when referenced in electronic exchange.
  */
@POJOBoilerplate
class NamingSystem(
    override val id: Option[String] = None,
