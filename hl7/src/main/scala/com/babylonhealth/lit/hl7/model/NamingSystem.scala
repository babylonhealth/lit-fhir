...
/** A curated namespace that issues unique symbols within that namespace for the identification of concepts, people,
  ...
  *
  * @constructor
  *   Introduces the fields name, kind, date, `type`, usage, status, contact, publisher, useContext, responsible,
  *   description, jurisdiction, uniqueId.
  * @param id
  ...
  * @param name
  *   - A natural language name identifying the naming system. This name should be usable as an identifier for the
  *   module by machine processing applications such as code generation.
  * @param kind
  *   - Indicates the purpose for the naming system - what kinds of things does it make unique?
  * @param date
  *   - The date (and optionally time) when the naming system was published. The date must change when the business
  ...
  *   and may be used to assist with indexing and searching for appropriate naming system instances.
  * @param responsible
  *   - The name of the organization that is responsible for issuing identifiers or codes for this namespace and
  *   ensuring their non-collision.
  * @param description
  *   - A free text natural language description of the naming system from a consumer's perspective. Details about what
  *   the namespace identifies including scope, granularity, version labeling, etc.
  * @param jurisdiction
