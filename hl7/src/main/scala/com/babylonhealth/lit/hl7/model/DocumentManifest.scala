...
object DocumentManifest extends CompanionFor[DocumentManifest] {
  override val baseType: CompanionFor[DocumentManifest] = DocumentManifest
...
/** A collection of documents compiled for a purpose together with metadata that applies to the collection.
  ...
  *
  * @constructor Introduces the fields `type`, status, author, source, subject, created, content, recipient, identifier, description, masterIdentifier, related.
  ...
  * @param `type` - The code specifying the type of clinical activity that resulted in placing the associated content into the DocumentManifest.
  * @param status - The status of this document manifest.
  * @param author - Identifies who is the author of the manifest. Manifest author is not necessarly the author of the references included.
  ...
  * @param identifier - Other identifiers associated with the document manifest, including version independent  identifiers.
