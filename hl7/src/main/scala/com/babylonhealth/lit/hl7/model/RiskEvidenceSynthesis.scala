...
object RiskEvidenceSynthesis extends CompanionFor[RiskEvidenceSynthesis] {
  implicit def summonObjectAndCompanionRiskEvidenceSynthesis_477561063(
  ...
  object Certainty extends CompanionFor[Certainty] {
    implicit def summonObjectAndCompanionCertainty_423385188(o: Certainty): ObjectAndCompanion[Certainty, Certainty.type] =
      ObjectAndCompanion(o, this)
    ...
    object CertaintySubcomponent extends CompanionFor[CertaintySubcomponent] {
      implicit def summonObjectAndCompanionCertaintySubcomponent_1159526180(
  ...
  object RiskEstimate extends CompanionFor[RiskEstimate] {
    implicit def summonObjectAndCompanionRiskEstimate_423385188(
    ...
    object PrecisionEstimate extends CompanionFor[PrecisionEstimate] {
      implicit def summonObjectAndCompanionPrecisionEstimate235923004(
  ...
  object SampleSize extends CompanionFor[SampleSize] {
    implicit def summonObjectAndCompanionSampleSize_423385188(o: SampleSize): ObjectAndCompanion[SampleSize, SampleSize.type] =
      ObjectAndCompanion(o, this)
...
/** The RiskEvidenceSynthesis resource describes the likelihood of an outcome in a population plus exposure state where the risk
  ...
  *   approvalDate, synthesisType, lastReviewDate, effectivePeriod, relatedArtifact, sampleSize, riskEstimate, certainty.
  * @param id
  ...
  *   at which at which an authoritative instance of this risk evidence synthesis is (or will be) published. This URL can be the
  *   target of a canonical reference. It SHALL remain the same when the risk evidence synthesis is stored on different servers.
  * @param meta
  ...
  *   the risk evidence synthesis changes.
  * @param note
  ...
  *   specification, model, design or instance. This is an arbitrary value managed by the risk evidence synthesis author and is
  ...
  *   used to assist with indexing and searching for appropriate risk evidence synthesis instances.
  * @param population
