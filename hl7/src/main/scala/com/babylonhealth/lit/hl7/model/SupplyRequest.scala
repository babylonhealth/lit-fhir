...
/** A record of a request for a medication, substance or device used in the healthcare setting.
  ...
  *
  * @constructor
  *   Introduces the fields status, item, category, priority, quantity, supplier, requester, deliverTo, identifier, authoredOn,
  *   reasonCode, deliverFrom, occurrence, reasonReference, parameter.
  * @param id
