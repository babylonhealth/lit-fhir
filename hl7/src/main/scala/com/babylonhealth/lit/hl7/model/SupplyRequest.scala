...
/** A record of a request for a medication, substance or device used in the healthcare setting.
  ...
  *
  * @constructor Introduces the fields status, item, category, priority, quantity, supplier, requester, deliverTo, identifier, authoredOn, reasonCode, deliverFrom, occurrence, reasonReference, parameter.
  ...
  * @param item - The item that is requested to be supplied. This is either a link to a resource representing the details of the item or a code that identifies the item from a known list.
  * @param language - The base language in which the resource is written.
  * @param category - Category of supply, e.g.  central, non-stock, etc. This is used to support work flows associated with the supply process.
  * @param priority - Indicates how quickly this SupplyRequest should be addressed with respect to other requests.
  ...
  * @param identifier - Business identifiers assigned to this SupplyRequest by the author and/or other systems. These identifiers remain constant as the resource is updated and propagates from server to server.
  ...
  * @param occurrence - When the request should be fulfilled.
  ...
  * @param parameter - Specific parameters for the ordered item.  For example, the size of the indicated item.
  */
@POJOBoilerplate
class SupplyRequest(
    override val id: Option[String] = None,
