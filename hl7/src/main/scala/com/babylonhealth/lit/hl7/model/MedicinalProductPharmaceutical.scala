...
object MedicinalProductPharmaceutical extends CompanionFor[MedicinalProductPharmaceutical] {
  override val baseType: CompanionFor[MedicinalProductPharmaceutical] = MedicinalProductPharmaceutical
  ...
  def extractCharacteristics(
      t: MedicinalProductPharmaceutical): LitSeq[MedicinalProductPharmaceutical.Characteristics] = t.characteristics
    ...
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new MedicinalProductPharmaceutical(
          ...
          cursor
            .decodeAs[LitSeq[MedicinalProductPharmaceutical.Characteristics]]("characteristics", Some(LitSeq.empty)),
          cursor.decodeAs[NonEmptyLitSeq[MedicinalProductPharmaceutical.RouteOfAdministration]](
            "routeOfAdministration",
            None),
          decodeAttributes(cursor)
        )
...
/** A pharmaceutical product described in terms of its composition and dose form.
  ...
  *
  * @constructor Introduces the fields device, identifier, ingredient, unitOfPresentation, administrableDoseForm, characteristics, routeOfAdministration.
  ...
  * @param routeOfAdministration - The path by which the pharmaceutical product is taken into or makes contact with the body.
  */
@POJOBoilerplate
