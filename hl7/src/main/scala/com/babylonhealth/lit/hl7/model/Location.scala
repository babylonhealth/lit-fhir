...
/** Details and position information for a physical place where services are provided and resources and participants may be stored, found, contained, or accommodated.
  ...
  *
  * @constructor Introduces the fields name, mode, `type`, alias, status, partOf, telecom, address, endpoint, identifier, description, physicalType, operationalStatus, managingOrganization, availabilityExceptions, position, hoursOfOperation.
  ...
  * @param status - The status property covers the general availability of the resource, not the current value which may be covered by the operationStatus, or by a schedule/slots if they are configured for the location.
  ...
  * @param operationalStatus - The operational status covers operation values most relevant to beds (but can also apply to rooms/units/chairs/etc. such as an isolation unit/dialysis chair). This typically covers concepts such as contamination, housekeeping, and other activities like maintenance.
  * @param managingOrganization - The organization responsible for the provisioning and upkeep of the location.
  * @param availabilityExceptions - A description of when the locations opening ours are different to normal, e.g. public holiday availability. Succinctly describing all possible exceptions to normal site availability as detailed in the opening hours Times.
  * @param position - The absolute geographic location of the Location, expressed using the WGS84 datum (This is the same co-ordinate system used in KML).
