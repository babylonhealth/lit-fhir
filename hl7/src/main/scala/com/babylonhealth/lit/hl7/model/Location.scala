...
/** Details and position information for a physical place where services are provided and resources and participants may
  ...
  *
  * @constructor
  *   Introduces the fields name, mode, `type`, alias, status, partOf, telecom, address, endpoint, identifier,
  *   description, physicalType, operationalStatus, managingOrganization, availabilityExceptions, position,
  *   hoursOfOperation.
  * @param id
