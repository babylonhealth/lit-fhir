...
object Person extends CompanionFor[Person] {
  implicit def summonObjectAndCompanionPerson671701236(o: Person): ObjectAndCompanion[Person, Person.type] =
  ...
  object Link extends CompanionFor[Link] {
    implicit def summonObjectAndCompanionLink838059260(o: Link): ObjectAndCompanion[Link, Link.type] =
      ObjectAndCompanion(o, this)
    ...
    val assurance: FHIRComponentFieldMeta[Option[IDENTITY_ASSURANCELEVEL]] =
      FHIRComponentFieldMeta(
        "assurance",
        lTagOf[Option[IDENTITY_ASSURANCELEVEL]],
        false,
...
/** Demographics and administrative information about a person independent of a specific health-related context.
  ...
  *
  * @constructor Introduces the fields name, photo, gender, active, telecom, address, birthDate, identifier, managingOrganization, link.
  ...
  * @param photo - An image that can be displayed as a thumbnail of the person to enhance the identification of the individual.
