...
/** An occurrence of information being transmitted; e.g. an alert that was sent to a responsible provider, a public health agency that was notified about a reportable condition.
  ...
  *
  * @constructor Introduces the fields sent, note, topic, about, partOf, status, medium, sender, basedOn, subject, category, priority, received, encounter, recipient, identifier, reasonCode, inResponseTo, statusReason, instantiatesUri, reasonReference, instantiatesCanonical, payload.
  ...
  * @param note - Additional notes or commentary about the communication by the sender, receiver or other interested parties.
  * @param topic - Description of the purpose/content, similar to a subject line in an email.
  * @param about - Other resources that pertain to this communication and to which this communication should be associated.
  * @param partOf - Part of this action.
  * @param status - The status of the transmission.
  * @param medium - A channel that was used for this communication (e.g. email, fax).
  * @param sender - The entity (e.g. person, organization, clinical information system, or device) which was the source of the communication.
  * @param basedOn - An order, proposal or plan fulfilled in whole or in part by this Communication.
  * @param subject - The patient or group that was the focus of this communication.
  * @param language - The base language in which the resource is written.
  * @param category - The type of message conveyed such as alert, notification, reminder, instruction, etc.
  * @param priority - Characterizes how quickly the planned or in progress communication must be addressed. Includes concepts such as stat, urgent, routine.
  ...
  * @param encounter - The Encounter during which this Communication was created or to which the creation of this record is tightly associated.
  * @param recipient - The entity (e.g. person, organization, clinical information system, care team or device) which was the target of the communication. If receipts need to be tracked by an individual, a separate resource instance will need to be created for each recipient.  Multiple recipient communications are intended where either receipts are not tracked (e.g. a mass mail-out) or a receipt is captured in aggregate (all emails confirmed received by a particular time).
  * @param identifier - Business identifiers assigned to this communication by the performer or other systems which remain constant as the resource is updated and propagates from server to server.
  ...
  * @param instantiatesUri - The URL pointing to an externally maintained protocol, guideline, orderset or other definition that is adhered to in whole or in part by this Communication.
  ...
  * @param instantiatesCanonical - The URL pointing to a FHIR-defined protocol, guideline, orderset or other definition that is adhered to in whole or in part by this Communication.
