...
/** A medicinal product in a container or package.
  ...
  *
  * @constructor Introduces the fields subject, identifier, description, manufacturer, marketingStatus, legalStatusOfSupply, marketingAuthorization, batchIdentifier, packageItem.
  ...
  * @param packageItem - A packaging item, as a contained for medicine, possibly with other packaging items within.
  */
@POJOBoilerplate
