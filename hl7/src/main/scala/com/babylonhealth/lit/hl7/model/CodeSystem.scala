...
object CodeSystem extends CompanionFor[CodeSystem] {
  implicit def summonObjectAndCompanionCodeSystem767738115(
  ...
  object Concept extends CompanionFor[Concept] {
    implicit def summonObjectAndCompanionConcept_1625262110(o: Concept): ObjectAndCompanion[Concept, Concept.type] =
    ...
    object Property extends CompanionFor[Property] {
      implicit def summonObjectAndCompanionProperty1180774993(
          o: Property): ObjectAndCompanion[Property, Property.type] = ObjectAndCompanion(o, this)
      ...
      def unapply(
          o: Property): Option[(Option[String], Code, Property.ValueChoice, LitSeq[Extension], LitSeq[Extension])] =
      ...
      val value: FHIRComponentFieldMeta[Property.ValueChoice] =
        FHIRComponentFieldMeta("value", lTagOf[Property.ValueChoice], true, lTagOf[Union_1489367071])
        ...
        checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
          Try(
            new Property(
              ...
              cursor.decodeRef[Union_1489367071]("value"),
    ...
    object Designation extends CompanionFor[Designation] {
      implicit def summonObjectAndCompanionDesignation_970351237(
    ...
    def unapply(
      ...
      Some(
        (o.id, o.code, o.display, o.concept, o.extension, o.definition, o.modifierExtension, o.property, o.designation))
    val id: FHIRComponentFieldMeta[Option[String]] =
      FHIRComponentFieldMeta("id", lTagOf[Option[String]], false, lTagOf[String])
    val code: FHIRComponentFieldMeta[Code] =
      FHIRComponentFieldMeta("code", lTagOf[Code], false, lTagOf[Code])
  ...
  class Concept(
      ...
      extends BackboneElement(id = id, extension = extension, modifierExtension = modifierExtension)
  object Property extends CompanionFor[Property] {
    implicit def summonObjectAndCompanionProperty613403181(o: Property): ObjectAndCompanion[Property, Property.type] =
      ObjectAndCompanion(o, this)
    override type ResourceType = Property
    override type ParentType   = Property
    override val parentType: CompanionFor[ResourceType] = Property
    ...
    val modifierExtension: FHIRComponentFieldMeta[LitSeq[Extension]] =
      FHIRComponentFieldMeta("modifierExtension", lTagOf[LitSeq[Extension]], false, lTagOf[Extension])
    val fieldsMeta: Seq[FHIRComponentFieldMeta[_]] =
      Seq(id, uri, code, `type`, extension, description, modifierExtension)
    override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Success(fields(t))
    override def fields(t: Property): Seq[FHIRComponentField[_]] = Seq(
      FHIRComponentField[Option[String]](id, t.id),
  ...
  object Filter extends CompanionFor[Filter] {
    implicit def summonObjectAndCompanionFilter1706686581(o: Filter): ObjectAndCompanion[Filter, Filter.type] =
      ObjectAndCompanion(o, this)
    ...
    val modifierExtension: FHIRComponentFieldMeta[LitSeq[Extension]] =
      FHIRComponentFieldMeta("modifierExtension", lTagOf[LitSeq[Extension]], false, lTagOf[Extension])
    val fieldsMeta: Seq[FHIRComponentFieldMeta[_]] =
      Seq(id, code, value, operator, extension, description, modifierExtension)
    override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Success(fields(t))
...
/** The CodeSystem resource is used to declare the existence of and describe a code system or code system supplement and its key properties, and optionally define a part or all of its content.
  ...
  *
  * @constructor Introduces the fields url, name, date, title, count, status, version, contact, purpose, content, valueSet, publisher, copyright, identifier, useContext, description, supplements, experimental, jurisdiction, caseSensitive, compositional, versionNeeded, hierarchyMeaning, filter, property, concept.
  * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned, this value never changes.
  * @param url - An absolute URI that is used to identify this code system when it is referenced in a specification, model, design or an instance; also called its canonical identifier. This SHOULD be globally unique and SHOULD be a literal address at which at which an authoritative instance of this code system is (or will be) published. This URL can be the target of a canonical reference. It SHALL remain the same when the code system is stored on different servers. This is used in [Coding](datatypes.html#Coding).system.
  * @param meta - The metadata about the resource. This is content that is maintained by the infrastructure. Changes to the content might not always be associated with version changes to the resource.
  * @param text - A human-readable narrative that contains a summary of the resource and can be used to represent the content of the resource to a human. The narrative need not encode all the structured data, but is required to contain sufficient detail to make it "clinically safe" for a human to just read the narrative. Resource definitions may define what content should be represented in the narrative to ensure clinical safety.
  * @param name - A natural language name identifying the code system. This name should be usable as an identifier for the module by machine processing applications such as code generation.
  * @param date - The date  (and optionally time) when the code system was published. The date must change when the business version changes and it must change if the status code changes. In addition, it should change when the substantive content of the code system changes.
  * @param title - A short, descriptive, user-friendly title for the code system.
  * @param count - The total number of concepts defined by the code system. Where the code system has a compositional grammar, the basis of this count is defined by the system steward.
  * @param status - The date (and optionally time) when the code system resource was created or revised.
  * @param version - The identifier that is used to identify this version of the code system when it is referenced in a specification, model, design or instance. This is an arbitrary value managed by the code system author and is not expected to be globally unique. For example, it might be a timestamp (e.g. yyyymmdd) if a managed version is not available. There is also no expectation that versions can be placed in a lexicographical sequence. This is used in [Coding](datatypes.html#Coding).version.
  * @param contact - Contact details to assist a user in finding and communicating with the publisher.
  * @param purpose - Explanation of why this code system is needed and why it has been designed as it has.
  * @param content - The extent of the content of the code system (the concepts and codes it defines) are represented in this resource instance.
  ...
  * @param copyright - A copyright statement relating to the code system and/or its contents. Copyright statements are generally legal restrictions on the use and publishing of the code system.
  * @param identifier - A formal identifier that is used to identify this code system when it is represented in other formats, or referenced in a specification, model, design or an instance.
  * @param useContext - The content was developed with a focus and intent of supporting the contexts that are listed. These contexts may be general categories (gender, age, ...) or may be references to specific programs (insurance plans, studies, ...) and may be used to assist with indexing and searching for appropriate code system instances.
  * @param description - A free text natural language description of the code system from a consumer's perspective.
  * @param supplements - The canonical URL of the code system that this code system supplement is adding designations and properties to.
  * @param experimental - A Boolean value to indicate that this code system is authored for testing purposes (or education/evaluation/marketing) and is not intended to be used for genuine usage.
  ...
  * @param caseSensitive - If code comparison is case sensitive when codes within this system are compared to each other.
  * @param compositional - The code system defines a compositional (post-coordination) grammar.
  * @param versionNeeded - This flag is used to signify that the code system does not commit to concept permanence across versions. If true, a version must be specified when referencing this code system.
  ...
  * @param filter - A filter that can be used in a value set compose statement when selecting concepts using a filter.
  * @param property - A property defines an additional slot through which additional information can be provided about a concept.
  * @param concept - Concepts that are in the code system. The concept definitions are inherently hierarchical, but the definitions must be consulted to determine what the meanings of the hierarchical relationships are.
  */
@POJOBoilerplate
class CodeSystem(
    override val id: Option[String] = None,
