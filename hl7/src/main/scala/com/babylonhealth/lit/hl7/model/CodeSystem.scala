...
/** The CodeSystem resource is used to declare the existence of and describe a code system or code system supplement and
  ...
  *
  * @constructor
  *   Introduces the fields url, name, date, title, count, status, version, contact, purpose, content, valueSet,
  *   publisher, copyright, identifier, useContext, description, supplements, experimental, jurisdiction, caseSensitive,
  *   compositional, versionNeeded, hierarchyMeaning, filter, property, concept.
  * @param id
  ...
  *   literal address at which at which an authoritative instance of this code system is (or will be) published. This
  *   URL can be the target of a canonical reference. It SHALL remain the same when the code system is stored on
  ...
  * @param name
  *   - A natural language name identifying the code system. This name should be usable as an identifier for the module
  *   by machine processing applications such as code generation.
  * @param date
  *   - The date (and optionally time) when the code system was published. The date must change when the business
  *   version changes and it must change if the status code changes. In addition, it should change when the substantive
  *   content of the code system changes.
  * @param title
  *   - A short, descriptive, user-friendly title for the code system.
  * @param count
  *   - The total number of concepts defined by the code system. Where the code system has a compositional grammar, the
  *   basis of this count is defined by the system steward.
  * @param status
  *   - The date (and optionally time) when the code system resource was created or revised.
  * @param version
  *   - The identifier that is used to identify this version of the code system when it is referenced in a
  *   specification, model, design or instance. This is an arbitrary value managed by the code system author and is not
  *   expected to be globally unique. For example, it might be a timestamp (e.g. yyyymmdd) if a managed version is not
  *   available. There is also no expectation that versions can be placed in a lexicographical sequence. This is used in
  ...
  * @param identifier
  *   - A formal identifier that is used to identify this code system when it is represented in other formats, or
  ...
  *   and may be used to assist with indexing and searching for appropriate code system instances.
  * @param description
  ...
  * @param versionNeeded
  *   - This flag is used to signify that the code system does not commit to concept permanence across versions. If
  *   true, a version must be specified when referencing this code system.
