...
object EffectEvidenceSynthesis extends CompanionFor[EffectEvidenceSynthesis] {
  ...
  object Certainty extends CompanionFor[Certainty] {
    implicit def summonObjectAndCompanionCertainty_250158880(
  ...
  object ResultsByExposure extends CompanionFor[ResultsByExposure] {
    implicit def summonObjectAndCompanionResultsByExposure190710627(
        o: ResultsByExposure): ObjectAndCompanion[ResultsByExposure, ResultsByExposure.type] =
      ObjectAndCompanion(o, this)
  ...
  object SampleSize extends CompanionFor[SampleSize] {
    implicit def summonObjectAndCompanionSampleSize_310099578(
  ...
  def extractEffectEstimate(t: EffectEvidenceSynthesis): LitSeq[EffectEvidenceSynthesis.EffectEstimate] =
    t.effectEstimate
...
/** The EffectEvidenceSynthesis resource describes the difference in an outcome between exposures states in a population where the effect estimate is derived from a combination of research studies.
  ...
  * @param url - An absolute URI that is used to identify this effect evidence synthesis when it is referenced in a specification, model, design or an instance; also called its canonical identifier. This SHOULD be globally unique and SHOULD be a literal address at which at which an authoritative instance of this effect evidence synthesis is (or will be) published. This URL can be the target of a canonical reference. It SHALL remain the same when the effect evidence synthesis is stored on different servers.
  * @param meta - The metadata about the resource. This is content that is maintained by the infrastructure. Changes to the content might not always be associated with version changes to the resource.
  * @param text - A human-readable narrative that contains a summary of the resource and can be used to represent the content of the resource to a human. The narrative need not encode all the structured data, but is required to contain sufficient detail to make it "clinically safe" for a human to just read the narrative. Resource definitions may define what content should be represented in the narrative to ensure clinical safety.
  * @param name - A natural language name identifying the effect evidence synthesis. This name should be usable as an identifier for the module by machine processing applications such as code generation.
  * @param date - The date  (and optionally time) when the effect evidence synthesis was published. The date must change when the business version changes and it must change if the status code changes. In addition, it should change when the substantive content of the effect evidence synthesis changes.
  ...
  * @param topic - Descriptive topics related to the content of the EffectEvidenceSynthesis. Topics provide a high-level categorization grouping types of EffectEvidenceSynthesiss that can be useful for filtering and searching.
  * @param status - The status of this effect evidence synthesis. Enables tracking the life-cycle of the content.
  ...
  * @param version - The identifier that is used to identify this version of the effect evidence synthesis when it is referenced in a specification, model, design or instance. This is an arbitrary value managed by the effect evidence synthesis author and is not expected to be globally unique. For example, it might be a timestamp (e.g. yyyymmdd) if a managed version is not available. There is also no expectation that versions can be placed in a lexicographical sequence.
  ...
  * @param publisher - The name of the organization or individual that published the effect evidence synthesis.
  * @param copyright - A copyright statement relating to the effect evidence synthesis and/or its contents. Copyright statements are generally legal restrictions on the use and publishing of the effect evidence synthesis.
  * @param studyType - Type of study eg randomized trial.
  * @param identifier - A formal identifier that is used to identify this effect evidence synthesis when it is represented in other formats, or referenced in a specification, model, design or an instance.
  * @param useContext - The content was developed with a focus and intent of supporting the contexts that are listed. These contexts may be general categories (gender, age, ...) or may be references to specific programs (insurance plans, studies, ...) and may be used to assist with indexing and searching for appropriate effect evidence synthesis instances.
  * @param population - A reference to a EvidenceVariable resource that defines the population for the research.
  * @param description - A free text natural language description of the effect evidence synthesis from a consumer's perspective.
  * @param jurisdiction - A legal or geographic region in which the effect evidence synthesis is intended to be used.
  ...
  * @param effectivePeriod - The period during which the effect evidence synthesis content was or is planned to be in active use.
  ...
  * @param exposureAlternative - A reference to a EvidenceVariable resource that defines the comparison exposure for the research.
  * @param sampleSize - A description of the size of the sample involved in the synthesis.
  * @param resultsByExposure - A description of the results for each exposure considered in the effect estimate.
