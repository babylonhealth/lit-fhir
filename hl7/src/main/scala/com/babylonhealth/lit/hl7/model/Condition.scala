...
/** A clinical condition, problem, diagnosis, or other event, situation, issue, or clinical concept that has risen to a
  ...
  *
  * @constructor
  *   Introduces the fields code, note, subject, category, severity, bodySite, onset, recorder, asserter, encounter,
  *   identifier, abatement, recordedDate, clinicalStatus, verificationStatus, stage, evidence.
  * @param id
