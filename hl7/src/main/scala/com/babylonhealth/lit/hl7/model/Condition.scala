...
object Condition extends CompanionFor[Condition] {
  ...
  type AbatementChoice = Choice[UnionAllergyIntolerance_Onset]
  def apply(
      id: Option[String] = None,
  ...
  val onset: FHIRComponentFieldMeta[Option[Condition.OnsetChoice]] =
    FHIRComponentFieldMeta("onset", lTagOf[Option[Condition.OnsetChoice]], true, lTagOf[UnionAllergyIntolerance_Onset])
  ...
  val abatement: FHIRComponentFieldMeta[Option[Condition.AbatementChoice]] =
    FHIRComponentFieldMeta("abatement", lTagOf[Option[Condition.AbatementChoice]], true, lTagOf[UnionAllergyIntolerance_Onset])
    ...
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Condition(
          ...
          cursor.decodeOptRef[UnionAllergyIntolerance_Onset]("abatement"),
