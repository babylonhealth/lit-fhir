...
/** A clinical condition, problem, diagnosis, or other event, situation, issue, or clinical concept that has risen to a level of concern.
  ...
  *
  * @constructor Introduces the fields code, note, subject, category, severity, bodySite, onset, recorder, asserter, encounter, identifier, abatement, recordedDate, clinicalStatus, verificationStatus, stage, evidence.
  ...
  * @param note - Additional information about the Condition. This is a general notes/comments entry  for description of the Condition, its diagnosis and prognosis.
  ...
  * @param onset - Estimated or actual date or date-time  the condition began, in the opinion of the clinician.
  ...
  * @param encounter - The Encounter during which this Condition was created or to which the creation of this record is tightly associated.
  * @param identifier - Business identifiers assigned to this condition by the performer or other systems which remain constant as the resource is updated and propagates from server to server.
  ...
  * @param recordedDate - The recordedDate represents when this particular Condition record was created in the system, which is often a system-generated date.
  ...
  * @param evidence - Supporting evidence / manifestations that are the basis of the Condition's verification status, such as evidence that confirmed or refuted the condition.
  */
@POJOBoilerplate
class Condition(
    override val id: Option[String] = None,
