...
/** The ResearchDefinition resource describes the conditional state (population and any exposures being compared within
  ...
  *
  * @constructor
  *   Introduces the fields url, name, date, title, usage, topic, status, author, editor, version, contact, comment,
  *   purpose, library, outcome, subtitle, reviewer, endorser, exposure, publisher, copyright, identifier, shortTitle,
  *   subject, useContext, population, description, experimental, jurisdiction, approvalDate, lastReviewDate,
  *   effectivePeriod, relatedArtifact, exposureAlternative.
  * @param id
  *   - The logical id of the resource, as used in the URL for the resource. Once assigned, this value never changes.
  * @param url
  *   - An absolute URI that is used to identify this research definition when it is referenced in a specification,
  *   model, design or an instance; also called its canonical identifier. This SHOULD be globally unique and SHOULD be a
  *   literal address at which at which an authoritative instance of this research definition is (or will be) published.
  *   This URL can be the target of a canonical reference. It SHALL remain the same when the research definition is
  ...
  * @param date
  *   - The date (and optionally time) when the research definition was published. The date must change when the
  ...
  *   specification, model, design or instance. This is an arbitrary value managed by the research definition author and
  ...
  * @param copyright
  *   - A copyright statement relating to the research definition and/or its contents. Copyright statements are
  *   generally legal restrictions on the use and publishing of the research definition.
  * @param identifier
  *   - A formal identifier that is used to identify this research definition when it is represented in other formats,
  ...
  * @param subject
  *   - The intended subjects for the ResearchDefinition. If this element is not provided, a Patient subject is assumed,
  *   but the subject of the ResearchDefinition can be anything.
  * @param useContext
  ...
  *   and may be used to assist with indexing and searching for appropriate research definition instances.
  * @param population
