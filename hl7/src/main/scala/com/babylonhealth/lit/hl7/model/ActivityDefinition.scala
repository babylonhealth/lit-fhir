...
object ActivityDefinition extends CompanionFor[ActivityDefinition] {
  ...
  object DynamicValue extends CompanionFor[DynamicValue] {
    ...
    def unapply(o: DynamicValue): Option[(Option[String], String, LitSeq[Extension], Expression, LitSeq[Extension])] =
...
/** This resource allows for the definition of some activity to be performed, independent of a particular patient,
  ...
  *
  * @constructor
  *   Introduces the fields url, name, date, kind, code, title, usage, topic, status, author, editor, intent, dosage,
  *   version, contact, purpose, library, profile, subtitle, reviewer, endorser, priority, location, quantity, bodySite,
  *   publisher, copyright, timing, transform, identifier, subject, useContext, product, description, experimental,
  *   jurisdiction, approvalDate, doNotPerform, lastReviewDate, effectivePeriod, relatedArtifact, specimenRequirement,
  *   observationRequirement, observationResultRequirement, participant, dynamicValue.
  * @param id
