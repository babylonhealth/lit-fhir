...
object CanonicalResource extends CompanionFor[CanonicalResource] {
  implicit def summonObjectAndCompanionCanonicalResource1014915533(
      o: CanonicalResource): ObjectAndCompanion[CanonicalResource, CanonicalResource.type] = ObjectAndCompanion(o, this)
  override type ResourceType = CanonicalResource
  override type ParentType   = CanonicalResource
  override val baseType: CompanionFor[ResourceType] = CanonicalResource
  override val parentType: CompanionFor[ParentType] = CanonicalResource
  override val profileUrl: Option[String]           = Some("http://hl7.org/fhir/StructureDefinition/CanonicalResource")
  def apply(
  ...
  ): CanonicalResource = new CanonicalResource(
    id,
    url,
    meta,
    text,
  ...
  override def fields(t: CanonicalResource): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractId(t: CanonicalResource): Option[String]                    = t.id
  def extractUrl(t: CanonicalResource): Option[UriStr]                   = t.url
  def extractMeta(t: CanonicalResource): Option[Meta]                    = t.meta
  def extractText(t: CanonicalResource): Option[Narrative]               = t.text
  def extractName(t: CanonicalResource): Option[String]                  = t.name
  def extractDate(t: CanonicalResource): Option[FHIRDateTime]            = t.date
  def extractTitle(t: CanonicalResource): Option[String]                 = t.title
  def extractStatus(t: CanonicalResource): PUBLICATION_STATUS            = t.status
  def extractVersion(t: CanonicalResource): Option[String]               = t.version
  def extractContact(t: CanonicalResource): LitSeq[ContactDetail]        = t.contact
  def extractPurpose(t: CanonicalResource): Option[Markdown]             = t.purpose
  def extractLanguage(t: CanonicalResource): Option[LANGUAGES]           = t.language
  def extractContained(t: CanonicalResource): LitSeq[Resource]           = t.contained
  def extractExtension(t: CanonicalResource): LitSeq[Extension]          = t.extension
  def extractPublisher(t: CanonicalResource): Option[String]             = t.publisher
  def extractCopyright(t: CanonicalResource): Option[Markdown]           = t.copyright
  def extractIdentifier(t: CanonicalResource): LitSeq[Identifier]        = t.identifier
  def extractUseContext(t: CanonicalResource): LitSeq[UsageContext]      = t.useContext
  def extractDescription(t: CanonicalResource): Option[Markdown]         = t.description
  def extractExperimental(t: CanonicalResource): Option[Boolean]         = t.experimental
  def extractJurisdiction(t: CanonicalResource): LitSeq[CodeableConcept] = t.jurisdiction
  def extractImplicitRules(t: CanonicalResource): Option[UriStr]         = t.implicitRules
  def extractModifierExtension(t: CanonicalResource): LitSeq[Extension]  = t.modifierExtension
  override val thisName: String                                          = "CanonicalResource"
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[CanonicalResource] =
...
/** Common Ancestor declaration for conformance and knowledge artifact resources.
  ...
  *
  * @constructor
  *   Introduces the fields url, name, date, title, status, version, contact, purpose, publisher, copyright, identifier,
  *   useContext, description, experimental, jurisdiction.
  * @param id
...
class CanonicalResource(
    ...
    override val primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
      ...
      primitiveAttributes = primitiveAttributes) {
  override val thisTypeName: String = "CanonicalResource"
}
