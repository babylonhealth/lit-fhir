...
/** Indicates that a medication product is to be or has been dispensed for a named person/patient. This includes a
  ...
  *
  * @constructor
  *   Introduces the fields `type`, note, partOf, status, subject, context, category, location, quantity, receiver,
  *   identifier, daysSupply, destination, whenPrepared, eventHistory, medication, detectedIssue, whenHandedOver,
  *   statusReason, dosageInstruction, supportingInformation, authorizingPrescription, performer, substitution.
  * @param id
  ...
  * @param `type`
  *   - Indicates the type of dispensing event that is performed. For example, Trial Fill, Completion of Trial, Partial
  ...
  * @param receiver
  *   - Identifies the person who picked up the medication. This will usually be a patient or their caregiver, but some
  ...
  * @param identifier
  *   - Identifiers associated with this Medication Dispense that are defined by business processes and/or used to refer
  ...
  *   expected but does not happen, in other cases substitution is not expected but does happen. This block explains
  *   what substitution did or did not happen and why. If nothing is specified, substitution was not done.
  */
@POJOBoilerplate
