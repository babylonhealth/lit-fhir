...
/** This resource provides the details including amount of a payment and allocates the payment items being paid.
  ...
  *
  * @constructor Introduces the fields status, period, created, request, outcome, formCode, requestor, identifier, disposition, paymentDate, paymentIssuer, paymentAmount, paymentIdentifier, detail, processNote.
  ...
  * @param period - The period of time for which payments have been gathered into this bulk payment for settlement.
  ...
  * @param disposition - A human readable description of the status of the request for the reconciliation.
