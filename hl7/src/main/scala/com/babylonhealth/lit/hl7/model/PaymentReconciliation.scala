...
object PaymentReconciliation extends CompanionFor[PaymentReconciliation] {
  ...
  val detail: FHIRComponentFieldMeta[LitSeq[PaymentReconciliation.Detail]] =
    FHIRComponentFieldMeta("detail", lTagOf[LitSeq[PaymentReconciliation.Detail]], false, lTagOf[PaymentReconciliation.Detail])
...
/** This resource provides the details including amount of a payment and allocates the payment items being paid.
  ...
  *
  * @constructor
  *   Introduces the fields status, period, created, request, outcome, formCode, requestor, identifier, disposition, paymentDate,
  *   paymentIssuer, paymentAmount, paymentIdentifier, detail, processNote.
  * @param id
