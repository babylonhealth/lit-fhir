...
/** An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.
  ...
  *
  * @constructor Introduces the fields `type`, `class`, status, period, length, partOf, subject, basedOn, account, priority, identifier, reasonCode, serviceType, appointment, episodeOfCare, reasonReference, serviceProvider, location, diagnosis, participant, classHistory, statusHistory, hospitalization.
