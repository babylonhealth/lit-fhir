...
object PaymentNotice extends CompanionFor[PaymentNotice] {
  implicit def summonObjectAndCompanionPaymentNotice1010855593(
  ...
  override val parentType: CompanionFor[ParentType] = PaymentNotice
...
/** This resource provides the status of the payment for goods and services rendered, and the request and response resource
  ...
  *
  * @constructor
  *   Introduces the fields payee, status, amount, request, created, payment, response, provider, recipient, identifier,
