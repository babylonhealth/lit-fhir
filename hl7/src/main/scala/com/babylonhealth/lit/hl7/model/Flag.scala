...
/** Prospective warnings of potential issues when providing care to the patient.
  ...
  * @param category
  *   - Allows a flag to be divided into different categories like clinical, administrative etc. Intended to be used as a means
  *   of filtering which flags are displayed to particular user or in a given context.
  * @param contained
