...
object Flag extends CompanionFor[Flag] {
  override val baseType: CompanionFor[Flag] = Flag
...
/** Prospective warnings of potential issues when providing care to the patient.
  ...
  *
  * @constructor Introduces the fields code, status, period, author, subject, category, encounter, identifier.
  ...
  * @param period - The period of time from the activation of the flag to inactivation of the flag. If the flag is active, the end of the period should be unspecified.
  * @param author - The person, organization or device that created the flag.
  * @param subject - The patient, location, group, organization, or practitioner etc. this is about record this flag is associated with.
  * @param language - The base language in which the resource is written.
  * @param category - Allows a flag to be divided into different categories like clinical, administrative etc. Intended to be used as a means of filtering which flags are displayed to particular user or in a given context.
  ...
  * @param identifier - Business identifiers assigned to this flag by the performer or other systems which remain constant as the resource is updated and propagates from server to server.
