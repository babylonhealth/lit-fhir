...
/** Prospective warnings of potential issues when providing care to the patient.
  ...
  * @param period
  *   - The period of time from the activation of the flag to inactivation of the flag. If the flag is active, the end
  ...
  * @param category
  *   - Allows a flag to be divided into different categories like clinical, administrative etc. Intended to be used as
  *   a means of filtering which flags are displayed to particular user or in a given context.
  * @param contained
  ...
  * @param identifier
  *   - Business identifiers assigned to this flag by the performer or other systems which remain constant as the
