...
object Composition extends CompanionFor[Composition] {
  implicit def summonObjectAndCompanionComposition_2106938514(
      o: Composition): ObjectAndCompanion[Composition, Composition.type] = ObjectAndCompanion(o, this)
  ...
  object RelatesTo extends CompanionFor[RelatesTo] {
    implicit def summonObjectAndCompanionRelatesTo_2011369864(
  ...
  object Attester extends CompanionFor[Attester] {
    implicit def summonObjectAndCompanionAttester_1782317507(o: Attester): ObjectAndCompanion[Attester, Attester.type] =
  ...
  object Section extends CompanionFor[Section] {
    implicit def summonObjectAndCompanionSection_315048399(o: Section): ObjectAndCompanion[Section, Section.type] =
      ObjectAndCompanion(o, this)
  ...
  object Event extends CompanionFor[Event] {
    implicit def summonObjectAndCompanionEvent_803352966(o: Event): ObjectAndCompanion[Event, Event.type] =
      ObjectAndCompanion(o, this)
...
/** A set of healthcare-related information that is assembled together into a single logical package that provides a single coherent statement of meaning, establishes its own context and that has clinical attestation with regard to who is making the statement. A Composition defines the structure and narrative content necessary for a document. However, a Composition alone does not constitute a document. Rather, the Composition must be the first entry in a Bundle where Bundle.type=document, and any other resources referenced from Composition must be included as subsequent entries in the Bundle (for example Patient, Practitioner, Encounter, etc.).
  ...
  *
  * @constructor Introduces the fields `type`, date, title, status, author, subject, category, encounter, custodian, identifier, confidentiality, event, section, attester, relatesTo.
  ...
  * @param subject - Who or what the composition is about. The composition can be about a person, (patient or healthcare practitioner), a device (e.g. a machine) or even a group of subjects (such as a document about a herd of livestock, or a set of patients that share a common exposure).
  * @param language - The base language in which the resource is written.
  * @param category - A categorization for the type of the composition - helps for indexing and searching. This may be implied by or derived from the code specified in the Composition Type.
  ...
  * @param identifier - A version-independent identifier for the Composition. This identifier stays constant as the composition is changed over time.
  ...
  * @param event - The clinical service, such as a colonoscopy or an appendectomy, being documented.
  ...
  * @param relatesTo - Relationships that this composition has with other compositions or documents that already exist.
  */
@POJOBoilerplate
class Composition(
    override val id: Option[String] = None,
