...
/** Describes the intended objective(s) for a patient, group or organization care, for example, weight loss, restoring
  ...
  *
  * @constructor
  *   Introduces the fields note, subject, category, priority, start, addresses, identifier, statusDate, description,
  *   expressedBy, outcomeCode, statusReason, lifecycleStatus, outcomeReference, achievementStatus, target.
  * @param id
  ...
  * @param identifier
  *   - Business identifiers assigned to this goal by the performer or other systems which remain constant as the
  *   resource is updated and propagates from server to server.
  * @param statusDate
  *   - Identifies when the current status. I.e. When initially created, when achieved, when cancelled, etc.
  * @param description
  *   - Human-readable and/or coded description of a specific desired objective of care, such as "control blood
  *   pressure" or "negotiate an obstacle course" or "dance with child at wedding".
  * @param expressedBy
