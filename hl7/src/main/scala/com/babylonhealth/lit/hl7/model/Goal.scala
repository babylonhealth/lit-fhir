...
object Goal extends CompanionFor[Goal] {
  implicit def summonObjectAndCompanionGoal_1296351574(o: Goal): ObjectAndCompanion[Goal, Goal.type] =
  ...
  object Target extends CompanionFor[Target] {
    implicit def summonObjectAndCompanionTarget1285289013(o: Target): ObjectAndCompanion[Target, Target.type] =
      ObjectAndCompanion(o, this)
...
/** Describes the intended objective(s) for a patient, group or organization care, for example, weight loss, restoring an activity of daily living, obtaining herd immunity via immunization, meeting a process improvement objective, etc.
  ...
  *
  * @constructor Introduces the fields note, subject, category, priority, start, addresses, identifier, statusDate, description, expressedBy, outcomeCode, statusReason, lifecycleStatus, outcomeReference, achievementStatus, target.
  ...
  * @param subject - Identifies the patient, group or organization for whom the goal is being established.
  ...
  * @param description - Human-readable and/or coded description of a specific desired objective of care, such as "control blood pressure" or "negotiate an obstacle course" or "dance with child at wedding".
