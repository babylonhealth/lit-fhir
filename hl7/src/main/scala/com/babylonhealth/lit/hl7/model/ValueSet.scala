...
object ValueSet extends CompanionFor[ValueSet] {
  ...
  object Expansion extends CompanionFor[Expansion] {
    implicit def summonObjectAndCompanionExpansion160822231(
    ...
    object Parameter extends CompanionFor[Parameter] {
      implicit def summonObjectAndCompanionParameter_1883265533(
...
/** A ValueSet resource instance specifies a set of codes drawn from one or more code systems, intended for use in a
  ...
  *
  * @constructor
  *   Introduces the fields url, name, date, title, status, version, contact, purpose, publisher, immutable, copyright,
  *   identifier, useContext, description, experimental, jurisdiction, expansion, compose.
  * @param id
