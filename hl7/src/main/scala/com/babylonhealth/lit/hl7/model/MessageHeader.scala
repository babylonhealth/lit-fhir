...
object MessageHeader extends CompanionFor[MessageHeader] {
  ...
  object Destination extends CompanionFor[Destination] {
    ...
    val fieldsMeta: Seq[FHIRComponentFieldMeta[_]] = Seq(id, name, target, endpoint, receiver, extension, modifierExtension)
  ...
  object Response extends CompanionFor[Response] {
    ...
    def unapply(
        o: Response): Option[(Option[String], RESPONSE_CODE, Option[Reference], LitSeq[Extension], Id, LitSeq[Extension])] = Some(
      (o.id, o.code, o.details, o.extension, o.identifier, o.modifierExtension))
    val id: FHIRComponentFieldMeta[Option[String]] =
      FHIRComponentFieldMeta("id", lTagOf[Option[String]], false, lTagOf[String])
...
/** The header for a message exchange that is either requesting or responding to an action. The reference(s) that are the subject
  * of the action as well as other information related to the action are typically transmitted in a bundle in which the
