...
object MessageHeader extends CompanionFor[MessageHeader] {
  override val baseType: CompanionFor[MessageHeader] = MessageHeader
...
/** The header for a message exchange that is either requesting or responding to an action.  The reference(s) that are the subject of the action as well as other information related to the action are typically transmitted in a bundle in which the MessageHeader resource instance is the first resource in the bundle.
  ...
  *
  * @constructor Introduces the fields focus, sender, author, reason, enterer, event, definition, responsible, source, response, destination.
  ...
  * @param focus - The actual data of the message - a reference to the root/focus class of the event.
  * @param sender - Identifies the sending system to allow the use of a trust relationship.
  * @param author - The logical author of the message - the person or device that decided the described event should happen. When there is more than one candidate, pick the most proximal to the MessageHeader. Can provide other authors in extensions.
  * @param reason - Coded indication of the cause for the event - indicates  a reason for the occurrence of the event that is a focus of this message.
  * @param enterer - The person or device that performed the data entry leading to this message. When there is more than one candidate, pick the most proximal to the message. Can provide other enterers in extensions.
  * @param language - The base language in which the resource is written.
  * @param event - Code that identifies the event this message represents and connects it with its definition. Events defined as part of the FHIR specification have the system value "http://terminology.hl7.org/CodeSystem/message-events".  Alternatively uri to the EventDefinition.
