...
/** The Evidence resource describes the conditional state (population and any exposures being compared within the population) and outcome (if specified) that the knowledge (evidence, assertion, recommendation) is about.
  ...
  *
  * @constructor Introduces the fields url, name, date, note, title, topic, status, author, editor, version, contact, outcome, subtitle, reviewer, endorser, publisher, copyright, identifier, shortTitle, useContext, description, jurisdiction, approvalDate, lastReviewDate, effectivePeriod, relatedArtifact, exposureVariant, exposureBackground.
