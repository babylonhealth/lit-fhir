...
/** Basic is used for handling concepts not yet defined in FHIR, narrative-only resources that don't map to an existing resource, and custom resources not appropriate for inclusion in the FHIR specification.
  ...
  *
  * @constructor Introduces the fields code, author, subject, created, identifier.
  ...
  * @param subject - Identifies the patient, practitioner, device or any other resource that is the "focus" of this resource.
  ...
  * @param identifier - Identifier assigned to the resource for business purposes, outside the context of FHIR.
