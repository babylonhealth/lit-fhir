...
/** A reference to a document of any kind for any purpose. Provides metadata about the document so that the document can
  ...
  *
  * @constructor
  *   Introduces the fields `type`, date, status, author, subject, category, docStatus, custodian, identifier,
  *   description, authenticator, securityLabel, masterIdentifier, content, context, relatesTo.
  * @param id
