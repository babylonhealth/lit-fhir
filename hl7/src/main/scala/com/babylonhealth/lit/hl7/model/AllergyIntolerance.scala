...
object AllergyIntolerance extends CompanionFor[AllergyIntolerance] {
  ...
  object Reaction extends CompanionFor[Reaction] {
    ...
    val severity: FHIRComponentFieldMeta[Option[REACTION_EVENT_SEVERITY]] =
      FHIRComponentFieldMeta("severity", lTagOf[Option[REACTION_EVENT_SEVERITY]], false, lTagOf[REACTION_EVENT_SEVERITY])
  ...
  val onset: FHIRComponentFieldMeta[Option[AllergyIntolerance.OnsetChoice]] =
    FHIRComponentFieldMeta("onset", lTagOf[Option[AllergyIntolerance.OnsetChoice]], true, lTagOf[Union01474038381])
...
/** Risk of harmful or undesirable, physiological response which is unique to an individual and associated with exposure to a
  * substance.
  *
  * Subclass of [[hl7.model.DomainResource]] (A resource that includes narrative, extensions, and contained resources.)
  *
  * @constructor
  *   Introduces the fields `type`, code, note, patient, category, onset, recorder, asserter, encounter, identifier, criticality,
  *   recordedDate, clinicalStatus, lastOccurrence, verificationStatus, reaction.
  * @param id
