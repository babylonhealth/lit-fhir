...
/** Risk of harmful or undesirable, physiological response which is unique to an individual and associated with exposure
  ...
  *
  * @constructor
  *   Introduces the fields `type`, code, note, patient, category, onset, recorder, asserter, encounter, identifier,
  *   criticality, recordedDate, clinicalStatus, lastOccurrence, verificationStatus, reaction.
  * @param id
