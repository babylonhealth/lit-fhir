...
/** The EventDefinition resource provides a reusable description of when a particular event can occur.
  ...
  *
  * @constructor
  *   Introduces the fields url, name, date, title, usage, topic, status, author, editor, version, contact, purpose,
  *   trigger, subtitle, reviewer, endorser, publisher, copyright, identifier, subject, useContext, description,
  *   experimental, jurisdiction, approvalDate, lastReviewDate, effectivePeriod, relatedArtifact.
  * @param id
  ...
  *   literal address at which at which an authoritative instance of this event definition is (or will be) published.
  *   This URL can be the target of a canonical reference. It SHALL remain the same when the event definition is stored
  ...
  * @param name
  *   - A natural language name identifying the event definition. This name should be usable as an identifier for the
  *   module by machine processing applications such as code generation.
  * @param date
  *   - The date (and optionally time) when the event definition was published. The date must change when the business
  ...
  * @param topic
  *   - Descriptive topics related to the module. Topics provide a high-level categorization of the module that can be
  ...
  * @param version
  *   - The identifier that is used to identify this version of the event definition when it is referenced in a
  *   specification, model, design or instance. This is an arbitrary value managed by the event definition author and is
  ...
  * @param trigger
  *   - The trigger element defines when the event occurs. If more than one trigger condition is specified, the event
  *   fires whenever any one of the trigger conditions is met.
  * @param language
  ...
  * @param copyright
  *   - A copyright statement relating to the event definition and/or its contents. Copyright statements are generally
  *   legal restrictions on the use and publishing of the event definition.
  * @param identifier
  ...
  *   and may be used to assist with indexing and searching for appropriate event definition instances.
  * @param description
