...
object EventDefinition extends CompanionFor[EventDefinition] {
  override val baseType: CompanionFor[EventDefinition] = EventDefinition
  ...
  val subject: FHIRComponentFieldMeta[Option[EventDefinition.SubjectChoice]] =
    FHIRComponentFieldMeta("subject", lTagOf[Option[EventDefinition.SubjectChoice]], true, lTagOf[Union01025009075])
...
/** The EventDefinition resource provides a reusable description of when a particular event can occur.
  ...
  *
  * @constructor Introduces the fields url, name, date, title, usage, topic, status, author, editor, version, contact, purpose, trigger, subtitle, reviewer, endorser, publisher, copyright, identifier, subject, useContext, description, experimental, jurisdiction, approvalDate, lastReviewDate, effectivePeriod, relatedArtifact.
  * @param id - The logical id of the resource, as used in the URL for the resource. Once assigned, this value never changes.
  * @param url - An absolute URI that is used to identify this event definition when it is referenced in a specification, model, design or an instance; also called its canonical identifier. This SHOULD be globally unique and SHOULD be a literal address at which at which an authoritative instance of this event definition is (or will be) published. This URL can be the target of a canonical reference. It SHALL remain the same when the event definition is stored on different servers.
  * @param meta - The metadata about the resource. This is content that is maintained by the infrastructure. Changes to the content might not always be associated with version changes to the resource.
  * @param text - A human-readable narrative that contains a summary of the resource and can be used to represent the content of the resource to a human. The narrative need not encode all the structured data, but is required to contain sufficient detail to make it "clinically safe" for a human to just read the narrative. Resource definitions may define what content should be represented in the narrative to ensure clinical safety.
  * @param name - A natural language name identifying the event definition. This name should be usable as an identifier for the module by machine processing applications such as code generation.
  * @param date - The date  (and optionally time) when the event definition was published. The date must change when the business version changes and it must change if the status code changes. In addition, it should change when the substantive content of the event definition changes.
  * @param title - A short, descriptive, user-friendly title for the event definition.
  * @param usage - A detailed description of how the event definition is used from a clinical perspective.
  * @param topic - Descriptive topics related to the module. Topics provide a high-level categorization of the module that can be useful for filtering and searching.
  * @param status - The status of this event definition. Enables tracking the life-cycle of the content.
  ...
  * @param purpose - Explanation of why this event definition is needed and why it has been designed as it has.
  * @param trigger - The trigger element defines when the event occurs. If more than one trigger condition is specified, the event fires whenever any one of the trigger conditions is met.
  * @param language - The base language in which the resource is written.
  * @param subtitle - An explanatory or alternate title for the event definition giving additional information about its content.
  ...
  * @param publisher - The name of the organization or individual that published the event definition.
  * @param copyright - A copyright statement relating to the event definition and/or its contents. Copyright statements are generally legal restrictions on the use and publishing of the event definition.
  * @param identifier - A formal identifier that is used to identify this event definition when it is represented in other formats, or referenced in a specification, model, design or an instance.
  * @param subject - A code or group definition that describes the intended subject of the event definition.
  * @param useContext - The content was developed with a focus and intent of supporting the contexts that are listed. These contexts may be general categories (gender, age, ...) or may be references to specific programs (insurance plans, studies, ...) and may be used to assist with indexing and searching for appropriate event definition instances.
  * @param description - A free text natural language description of the event definition from a consumer's perspective.
  * @param experimental - A Boolean value to indicate that this event definition is authored for testing purposes (or education/evaluation/marketing) and is not intended to be used for genuine usage.
  * @param jurisdiction - A legal or geographic region in which the event definition is intended to be used.
  ...
  * @param effectivePeriod - The period during which the event definition content was or is planned to be in active use.
  * @param relatedArtifact - Related resources such as additional documentation, justification, or bibliographic references.
