...
/** Actual or potential/avoided event causing unintended physical injury resulting from or contributed to by medical
  ...
  *
  * @constructor
  *   Introduces the fields date, event, study, subject, outcome, category, detected, location, severity, recorder,
  *   actuality, encounter, identifier, seriousness, contributor, recordedDate, referenceDocument, resultingCondition,
  *   subjectMedicalHistory, suspectEntity.
  * @param id
  ...
  * @param severity
  *   - Describes the severity of the adverse event, in relation to the subject. Contrast to AdverseEvent.seriousness -
  *   a severe rash might not be serious, but a mild heart problem is.
  * @param recorder
  ...
  * @param encounter
  *   - The Encounter during which AdverseEvent was created or to which the creation of this record is tightly
  *   associated.
  * @param identifier
  *   - Business identifiers assigned to this adverse event by the performer or other systems which remain constant as
  *   the resource is updated and propagates from server to server.
  * @param seriousness
  *   - Assessment whether this event was of real importance.
  * @param contributor
  *   - Parties that may or should contribute or have contributed information to the adverse event, which can consist of
  *   one or more activities. Such information includes information leading to the decision to perform the activity and
  *   how to perform the activity (e.g. consultant), information that the activity itself seeks to reveal (e.g.
  *   informant of clinical history), or information about what activity was performed (e.g. informant witness).
  * @param recordedDate
  ...
  *   - Includes information about the reaction that occurred as a result of exposure to a substance (for example, a
  *   drug or a chemical).
