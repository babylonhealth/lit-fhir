...
object AdverseEvent extends CompanionFor[AdverseEvent] {
  ...
  val suspectEntity: FHIRComponentFieldMeta[LitSeq[AdverseEvent.SuspectEntity]] =
    FHIRComponentFieldMeta(
      "suspectEntity",
      lTagOf[LitSeq[AdverseEvent.SuspectEntity]],
      false,
      lTagOf[AdverseEvent.SuspectEntity])
...
/** Actual or  potential/avoided event causing unintended physical injury resulting from or contributed to by medical care, a research study or other healthcare setting factors that requires additional monitoring, treatment, or hospitalization, or that results in death.
  ...
  *
  * @constructor Introduces the fields date, event, study, subject, outcome, category, detected, location, severity, recorder, actuality, encounter, identifier, seriousness, contributor, recordedDate, referenceDocument, resultingCondition, subjectMedicalHistory, suspectEntity.
  ...
  * @param event - This element defines the specific type of event that occurred or that was prevented from occurring.
  ...
  * @param detected - Estimated or actual date the AdverseEvent began, in the opinion of the reporter.
  * @param location - The information about where the adverse event occurred.
  * @param severity - Describes the severity of the adverse event, in relation to the subject. Contrast to AdverseEvent.seriousness - a severe rash might not be serious, but a mild heart problem is.
  * @param recorder - Information on who recorded the adverse event.  May be the patient or a practitioner.
  * @param contained - These resources do not have an independent existence apart from the resource that contains them - they cannot be identified independently, and nor can they have their own independent transaction scope.
  * @param extension - May be used to represent additional information that is not part of the basic definition of the resource. To make the use of extensions safe and manageable, there is a strict set of governance  applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
  * @param actuality - Whether the event actually happened, or just had the potential to. Note that this is independent of whether anyone was affected or harmed or how severely.
  * @param encounter - The Encounter during which AdverseEvent was created or to which the creation of this record is tightly associated.
  * @param identifier - Business identifiers assigned to this adverse event by the performer or other systems which remain constant as the resource is updated and propagates from server to server.
  * @param seriousness - Assessment whether this event was of real importance.
  * @param contributor - Parties that may or should contribute or have contributed information to the adverse event, which can consist of one or more activities.  Such information includes information leading to the decision to perform the activity and how to perform the activity (e.g. consultant), information that the activity itself seeks to reveal (e.g. informant of clinical history), or information about what activity was performed (e.g. informant witness).
  ...
  * @param resultingCondition - Includes information about the reaction that occurred as a result of exposure to a substance (for example, a drug or a chemical).
