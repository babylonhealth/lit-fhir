...
/** A specific set of Roles/Locations/specialties/services that a practitioner may perform at an organization for a
  ...
  *
  * @constructor
  *   Introduces the fields code, active, period, telecom, location, endpoint, specialty, identifier, practitioner,
  *   organization, healthcareService, availabilityExceptions, notAvailable, availableTime.
  * @param id
