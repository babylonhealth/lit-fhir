...
/** A specific set of Roles/Locations/specialties/services that a practitioner may perform at an organization for a period of time.
  ...
  *
  * @constructor Introduces the fields code, active, period, telecom, location, endpoint, specialty, identifier, practitioner, organization, healthcareService, availabilityExceptions, notAvailable, availableTime.
  ...
  * @param notAvailable - The practitioner is not available or performing this role during this period of time due to the provided reason.
  * @param availableTime - A collection of times the practitioner is available or performing this role at the location and/or healthcareservice.
  */
@POJOBoilerplate
