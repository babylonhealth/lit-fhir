...
object Immunization extends CompanionFor[Immunization] {
  ...
  object ProtocolApplied extends CompanionFor[ProtocolApplied] {
    ...
    def unapply(
        o: ProtocolApplied): Option[(Option[String], Option[String], LitSeq[Extension], Option[Reference], String, Option[String], LitSeq[CodeableConcept], LitSeq[Extension])] =
      Some((o.id, o.series, o.extension, o.authority, o.doseNumber, o.seriesDoses, o.targetDisease, o.modifierExtension))
    ...
    val doseNumber: FHIRComponentFieldMeta[String] =
      FHIRComponentFieldMeta("doseNumber", lTagOf[String], false, lTagOf[String])
    ...
    val fieldsMeta: Seq[FHIRComponentFieldMeta[_]] =
      Seq(id, series, extension, authority, doseNumber, seriesDoses, targetDisease, modifierExtension)
    ...
    override def fields(t: ProtocolApplied): Seq[FHIRComponentField[_]] = Seq(
      ...
      FHIRComponentField[String](doseNumber, t.doseNumber),
      ...
      checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
        Try(
          new ProtocolApplied(
            ...
            cursor.decodeAs[String]("doseNumber", None),
  ...
  type InformationSourceChoice = Choice[UnionCodeableConceptOrReference]
  def apply(
      id: Option[String] = None,
      ...
      informationSource: Option[Immunization.InformationSourceChoice] = None,
  ...
  val informationSource: FHIRComponentFieldMeta[Option[Immunization.InformationSourceChoice]] =
    FHIRComponentFieldMeta(
      "informationSource",
      lTagOf[Option[Immunization.InformationSourceChoice]],
      true,
  ...
  override def fields(t: Immunization): Seq[FHIRComponentField[_]] = Seq(
    ...
    FHIRComponentField[Option[Immunization.InformationSourceChoice]](informationSource, t.informationSource),
  ...
  def extractReason(t: Immunization): LitSeq[CodeableReference]                               = t.reason
  def extractBasedOn(t: Immunization): LitSeq[Reference]                                      = t.basedOn
  ...
  def extractInstantiatesUri(t: Immunization): LitSeq[UriStr]                                 = t.instantiatesUri
  ...
  def extractInformationSource(t: Immunization): Option[Immunization.InformationSourceChoice] = t.informationSource
  def extractInstantiatesCanonical(t: Immunization): LitSeq[Canonical]                        = t.instantiatesCanonical
  ...
  override val searchParams: Map[String, Immunization => Seq[Any]] = Map(
    ...
    "date"             -> (obj => obj.occurrence.as[FHIRDateTime].toSeq),
    ...
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Immunization(
          ...
          cursor.decodeOptRef[UnionCodeableConceptOrReference]("informationSource"),
...
/** Describes the event of a patient being administered a vaccine or a record of an immunization as reported by a patient, a
  ...
  *
  * @constructor
  *   Introduces the fields site, note, route, status, reason, basedOn, patient, recorded, location, lotNumber, encounter,
  *   identifier, vaccineCode, isSubpotent, statusReason, manufacturer, doseQuantity, occurrence, primarySource, fundingSource,
  *   expirationDate, instantiatesUri, subpotentReason, programEligibility, informationSource, instantiatesCanonical, reaction,
  *   performer, education, protocolApplied.
  * @param id
  ...
  * @param reason
  *   - Describes why the immunization occurred in coded or textual form, or Indicates another resource (Condition, Observation or
  ...
  *   or in part by this Immunization.
  ...
  *   - Typically the source of the data when the report of the immunization event is not based on information from the person who
...
class Immunization(
    ...
    val informationSource: Option[Immunization.InformationSourceChoice] = None,
