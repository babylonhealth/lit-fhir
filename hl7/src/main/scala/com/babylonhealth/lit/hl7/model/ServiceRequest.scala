...
/** A record of a request for service such as diagnostic investigations, treatments, or operations to be performed.
  ...
  *
  * @constructor
  *   Introduces the fields code, note, status, intent, basedOn, subject, replaces, category, priority, specimen,
  *   bodySite, encounter, requester, performer, insurance, identifier, authoredOn, reasonCode, requisition,
  *   orderDetail, quantity, asNeeded, doNotPerform, locationCode, occurrence, performerType, supportingInfo,
  *   instantiatesUri, reasonReference, relevantHistory, locationReference, patientInstruction, instantiatesCanonical.
  * @param id
  ...
  * @param code
  *   - A code that identifies a particular service (i.e., procedure, diagnostic investigation, or panel of
  ...
  * @param subject
  *   - On whom or what the service is to be performed. This is usually a human patient, but can also be requested on
  *   animals, groups of humans or animals, devices such as dialysis machines, or even locations (typically for
  *   environmental scans).
  * @param language
  ...
  *   endoscopist, etc.
  * @param insurance
  *   - Insurance plans, coverage extensions, pre-authorizations and/or pre-determinations that may be needed for
  ...
  * @param reasonCode
  *   - An explanation or justification for why this service is being requested in coded or textual form. This is often
  *   for billing purposes. May relate to the resources referred to in `supportingInfo`.
  * @param requisition
  ...
  * @param quantity
  *   - An amount of service being requested which can be a quantity ( for example $1,500 home modification), a ratio (
  *   for example, 20 half day visits per month), or a range (2.0 to 1.8 Gy per fraction).
  * @param asNeeded
  *   - If a CodeableConcept is present, it indicates the pre-condition for performing the service. For example "pain",
  *   "on flare-up", etc.
  * @param doNotPerform
  ...
  *   interpretations. This information includes diagnosis, clinical findings and other observations. In laboratory
  *   ordering these are typically referred to as "ask at order entry questions (AOEs)". This includes observations
  *   explicitly requested by the producer (filler) to provide context or supporting information needed to complete the
  *   order. For example, reporting the amount of inspired oxygen for blood gas measurements.
  ...
  *   - Indicates another resource that provides a justification for why this service is being requested. May relate to
  ...
  *   - A reference to the the preferred location(s) where the procedure should actually happen. E.g. at home or nursing
  *   day care center.
