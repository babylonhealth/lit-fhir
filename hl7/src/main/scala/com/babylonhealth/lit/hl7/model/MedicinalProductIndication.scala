...
object MedicinalProductIndication extends CompanionFor[MedicinalProductIndication] {
  ...
  override type ParentType   = MedicinalProductIndication
  override val baseType: CompanionFor[ResourceType] = MedicinalProductIndication
  ...
  object OtherTherapy extends CompanionFor[OtherTherapy] {
    ...
    val fieldsMeta: Seq[FHIRComponentFieldMeta[_]] = Seq(id, extension, medication, modifierExtension, therapyRelationshipType)
  ...
  def extractOtherTherapy(t: MedicinalProductIndication): LitSeq[MedicinalProductIndication.OtherTherapy] = t.otherTherapy
...
/** Indication for the Medicinal Product.
  ...
  *
  * @constructor
  *   Introduces the fields subject, duration, population, comorbidity, diseaseStatus, intendedEffect, undesirableEffect,
  *   diseaseSymptomProcedure, otherTherapy.
  * @param id
