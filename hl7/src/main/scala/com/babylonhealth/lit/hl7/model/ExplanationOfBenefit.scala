...
object ExplanationOfBenefit extends CompanionFor[ExplanationOfBenefit] {
  implicit def summonObjectAndCompanionExplanationOfBenefit1137222044(
      o: ExplanationOfBenefit): ObjectAndCompanion[ExplanationOfBenefit, ExplanationOfBenefit.type] =
  ...
  object BenefitBalance extends CompanionFor[BenefitBalance] {
    ...
    object Financial extends CompanionFor[Financial] {
      implicit def summonObjectAndCompanionFinancial256227458(
          o: Financial): ObjectAndCompanion[Financial, Financial.type] = ObjectAndCompanion(o, this)
  ...
  object AddItem extends CompanionFor[AddItem] {
    ...
    object Detail extends CompanionFor[Detail] {
      ...
      object SubDetail extends CompanionFor[SubDetail] {
        implicit def summonObjectAndCompanionSubDetail_612886513(
  ...
  object Item extends CompanionFor[Item] {
    ...
    object Detail extends CompanionFor[Detail] {
      ...
      override val parentType: CompanionFor[ResourceType] = Detail
      object SubDetail extends CompanionFor[SubDetail] {
        implicit def summonObjectAndCompanionSubDetail9857119(
            o: SubDetail): ObjectAndCompanion[SubDetail, SubDetail.type] = ObjectAndCompanion(o, this)
        override type ResourceType = SubDetail
        override type ParentType   = SubDetail
        override val parentType: CompanionFor[ResourceType] = SubDetail
  ...
  object Insurance extends CompanionFor[Insurance] {
    implicit def summonObjectAndCompanionInsurance1800608113(
  ...
  object Procedure extends CompanionFor[Procedure] {
    implicit def summonObjectAndCompanionProcedure_1567965308(
  ...
  object Diagnosis extends CompanionFor[Diagnosis] {
    implicit def summonObjectAndCompanionDiagnosis2136564251(
...
/** This resource provides: the claim details; adjudication details from the processing of a Claim; and optionally
  ...
  *
  * @constructor
  *   Introduces the fields use, `type`, form, claim, status, subType, patient, created, enterer, insurer, outcome,
  *   provider, priority, referral, facility, formCode, identifier, preAuthRef, precedence, disposition, fundsReserve,
  *   prescription, adjudication, claimResponse, benefitPeriod, billablePeriod, preAuthRefPeriod, originalPrescription,
  *   fundsReserveRequested, payee, total, related, payment, careTeam, accident, diagnosis, procedure, insurance,
  *   processNote, supportingInfo, item, addItem, benefitBalance.
  * @param id
  ...
  * @param subType
  *   - A finer grained suite of claim type codes which may convey additional information such as Inpatient vs
  *   Outpatient and/or a specialty service.
  * @param patient
  *   - The party to whom the professional services and/or products have been supplied or are being considered and for
  *   whom actual for forecast reimbursement is sought.
  * @param created
  ...
  * @param precedence
  *   - This indicates the relative order of a series of EOBs related to different coverages for the same suite of
  *   services.
  * @param disposition
  *   - A human readable description of the status of the adjudication.
  * @param fundsReserve
  *   - A code, used only on a response to a preauthorization, to indicate whether the benefits payable have been
  *   reserved and for whom.
  * @param prescription
  *   - Prescription to support the dispensing of pharmacy, device or vision products.
  * @param adjudication
  *   - The adjudication results which are presented at the header level rather than at the line-item or add-item
  *   levels.
  * @param implicitRules
  ...
  * @param claimResponse
  *   - The business identifier for the instance of the adjudication response: claim, predetermination or
  ...
  *   - The timeframe during which the supplied preauthorization reference may be quoted on claims to obtain the
  ...
  *   - Original prescription which has been superseded by this prescription to support the dispensing of pharmacy
  ...
  * @param related
  *   - Other claims which are related to this claim such as prior submissions or claims for related services or for the
  *   same event.
  * @param payment
