...
object Coverage extends CompanionFor[Coverage] {
  ...
  object CostToBeneficiary extends CompanionFor[CostToBeneficiary] {
    ...
    object Exception extends CompanionFor[Exception] {
      ...
      def unapply(o: Exception): Option[(Option[String], CodeableConcept, Option[Period], LitSeq[Extension], LitSeq[Extension])] =
    ...
    val exception: FHIRComponentFieldMeta[LitSeq[CostToBeneficiary.Exception]] =
      FHIRComponentFieldMeta("exception", lTagOf[LitSeq[CostToBeneficiary.Exception]], false, lTagOf[CostToBeneficiary.Exception])
...
/** Financial instrument which may be used to reimburse or pay for health care products and services. Includes both insurance and
  * self-payment.
  *
  ...
  *     gaps in the numbering and this does not imply primary, secondary etc. as the specific positioning of coverages depends
  *     upon the episode of care.
  * @param status
  ...
  *     which will be covered at the 'in-network' rate, otherwise 'out of network' terms and conditions apply.
  * @param language
  ...
  * @param subscriber
  *   - The party who has signed-up for or 'owns' the contractual relationship to the policy or to whom the benefit of the policy
  *     for services rendered to them or their family is due.
  * @param beneficiary
  *   - The party who benefits from the insurance coverage; the patient when products and/or services are provided.
  * @param subrogation
  *   - When 'subrogation=true' this insurance instance has been included not for adjudication but to provide insurers with the
