...
object Coverage extends CompanionFor[Coverage] {
  ...
  object CostToBeneficiary extends CompanionFor[CostToBeneficiary] {
    implicit def summonObjectAndCompanionCostToBeneficiary_532912780(
        o: CostToBeneficiary): ObjectAndCompanion[CostToBeneficiary, CostToBeneficiary.type] =
      ObjectAndCompanion(o, this)
    ...
    object Exception extends CompanionFor[Exception] {
      implicit def summonObjectAndCompanionException_1679940211(
          o: Exception): ObjectAndCompanion[Exception, Exception.type] = ObjectAndCompanion(o, this)
...
/** Financial instrument which may be used to reimburse or pay for health care products and services. Includes both
  ...
  *
  * @constructor
  *   Introduces the fields `type`, payor, order, status, period, network, contract, dependent, identifier, subscriber,
  *   beneficiary, subrogation, policyHolder, subscriberId, relationship, `class`, costToBeneficiary.
  * @param id
  ...
  *   or payment by an individual or organization.
  * @param payor
  *   - The program or plan underwriter or payor including both insurance and non-insurance agreements, such as
  *   patient-pay agreements.
  * @param order
  *   - The order of applicability of this coverage relative to other coverages which are currently in force. Note,
  *   there may be gaps in the numbering and this does not imply primary, secondary etc. as the specific positioning of
  ...
  * @param subscriber
  *   - The party who has signed-up for or 'owns' the contractual relationship to the policy or to whom the benefit of
  *   the policy for services rendered to them or their family is due.
  * @param beneficiary
  *   - The party who benefits from the insurance coverage; the patient when products and/or services are provided.
  * @param subrogation
  *   - When 'subrogation=true' this insurance instance has been included not for adjudication but to provide insurers
  *   with the details to recover costs.
  * @param policyHolder
