...
/** A group of related requests that can be used to capture intended activities that have inter-dependencies such as "give this medication after that one".
  ...
  *
  * @constructor Introduces the fields code, note, status, intent, author, basedOn, subject, replaces, priority, encounter, identifier, authoredOn, reasonCode, instantiatesUri, groupIdentifier, reasonReference, instantiatesCanonical, action.
  ...
  * @param status - The current state of the request. For request groups, the status reflects the status of all the requests in the group.
  * @param intent - Indicates the level of authority/intentionality associated with the request and where the request fits into the workflow chain.
  * @param author - Provides a reference to the author of the request group.
  * @param basedOn - A plan, proposal or order that is fulfilled in whole or in part by this request.
  ...
  * @param priority - Indicates how quickly the request should be addressed with respect to other requests.
  ...
  * @param instantiatesUri - A URL referencing an externally defined protocol, guideline, orderset or other definition that is adhered to in whole or in part by this request.
  ...
  * @param instantiatesCanonical - A canonical URL referencing a FHIR-defined protocol, guideline, orderset or other definition that is adhered to in whole or in part by this request.
