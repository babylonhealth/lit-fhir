...
object BiologicallyDerivedProduct extends CompanionFor[BiologicallyDerivedProduct] {
  override val baseType: CompanionFor[BiologicallyDerivedProduct] = BiologicallyDerivedProduct
  ...
  def extractManipulation(t: BiologicallyDerivedProduct): Option[BiologicallyDerivedProduct.Manipulation] =
    t.manipulation
...
/** A material substance originating from a biological entity intended to be transplanted or infused
  ...
  *
  * @constructor Introduces the fields status, parent, request, quantity, identifier, productCode, productCategory, storage, collection, processing, manipulation.
  ...
  * @param identifier - This records identifiers associated with this biologically derived product instance that are defined by business processes and/or used to refer to it when a direct URL reference to the resource itself is not appropriate (e.g. in CDA documents, or in written / printed documentation).
  * @param productCode - A code that identifies the kind of this biologically derived product (SNOMED Ctcode).
  ...
  * @param processing - Any processing of the product during collection that does not change the fundamental nature of the product. For example adding anti-coagulants during the collection of Peripheral Blood Stem Cells.
  * @param manipulation - Any manipulation of product post-collection that is intended to alter the product.  For example a buffy-coat enrichment or CD8 reduction of Peripheral Blood Stem Cells to make it more suitable for infusion.
  */
@POJOBoilerplate
