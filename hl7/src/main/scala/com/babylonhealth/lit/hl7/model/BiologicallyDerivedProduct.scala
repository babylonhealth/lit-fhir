...
/** A material substance originating from a biological entity intended to be transplanted or infused into another
  * (possibly the same) biological entity.
  *
  * Subclass of [[hl7.model.DomainResource]] (A resource that includes narrative, extensions, and contained resources.)
  *
  * @constructor
  *   Introduces the fields status, parent, request, quantity, identifier, productCode, productCategory, storage,
  *   collection, processing, manipulation.
  * @param id
  ...
  * @param manipulation
  *   - Any manipulation of product post-collection that is intended to alter the product. For example a buffy-coat
  *   enrichment or CD8 reduction of Peripheral Blood Stem Cells to make it more suitable for infusion.
  */
@POJOBoilerplate
