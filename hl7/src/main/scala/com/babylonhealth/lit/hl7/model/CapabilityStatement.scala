...
object CapabilityStatement extends CompanionFor[CapabilityStatement] {
  ...
  object Messaging extends CompanionFor[Messaging] {
    implicit def summonObjectAndCompanionMessaging969496665(o: Messaging): ObjectAndCompanion[Messaging, Messaging.type] =
  ...
  object Rest extends CompanionFor[Rest] {
    ...
    object Security extends CompanionFor[Security] {
      implicit def summonObjectAndCompanionSecurity_1266850277(o: Security): ObjectAndCompanion[Security, Security.type] =
        ObjectAndCompanion(o, this)
    ...
    object Resource extends CompanionFor[Resource] {
      implicit def summonObjectAndCompanionResource1730547414(o: Resource): ObjectAndCompanion[Resource, Resource.type] =
        ObjectAndCompanion(o, this)
      ...
      object Operation extends CompanionFor[Operation] {
        implicit def summonObjectAndCompanionOperation629236977(o: Operation): ObjectAndCompanion[Operation, Operation.type] =
          ObjectAndCompanion(o, this)
...
/** A Capability Statement documents a set of capabilities (behaviors) of a FHIR Server for a particular version of FHIR that may
  ...
  * @param url
  *   - An absolute URI that is used to identify this capability statement when it is referenced in a specification, model, design
  *   or an instance; also called its canonical identifier. This SHOULD be globally unique and SHOULD be a literal address at
  *   which at which an authoritative instance of this capability statement is (or will be) published. This URL can be the target
  *   of a canonical reference. It SHALL remain the same when the capability statement is stored on different servers.
  * @param meta
  ...
  * @param date
  *   - The date (and optionally time) when the capability statement was published. The date must change when the business version
  ...
  * @param version
  *   - The identifier that is used to identify this version of the capability statement when it is referenced in a specification,
  *   model, design or instance. This is an arbitrary value managed by the capability statement author and is not expected to be
  ...
  * @param fhirVersion
  *   - The version of the FHIR specification that this CapabilityStatement describes (which SHALL be the same as the FHIR version
  ...
  * @param software
  *   - Software that is covered by this capability statement. It is used when the capability statement describes the capabilities
