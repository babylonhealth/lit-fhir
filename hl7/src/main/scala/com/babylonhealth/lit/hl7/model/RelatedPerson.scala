...
/** Information about a person that is involved in the care for a patient, but who is not the target of healthcare, nor
  ...
  *
  * @constructor
  *   Introduces the fields name, photo, active, gender, period, patient, telecom, address, birthDate, identifier,
  ...
  *   purposes.
  * @param period
  *   - The period of time during which this relationship is or was active. If there are no dates defined, then the
  *   interval is unknown.
  * @param patient
