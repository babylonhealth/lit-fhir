...
object RelatedPerson extends CompanionFor[RelatedPerson] {
  implicit def summonObjectAndCompanionRelatedPerson_98921282(
  ...
  object Communication extends CompanionFor[Communication] {
    implicit def summonObjectAndCompanionCommunication_2141686372(
...
/** Information about a person that is involved in the care for a patient, but who is not the target of healthcare, nor has a formal responsibility in the care process.
  ...
  *
  * @constructor Introduces the fields name, photo, active, gender, period, patient, telecom, address, birthDate, identifier, relationship, communication.
  ...
  * @param period - The period of time during which this relationship is or was active. If there are no dates defined, then the interval is unknown.
