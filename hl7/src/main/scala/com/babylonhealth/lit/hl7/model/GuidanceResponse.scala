...
/** A guidance response is the formal response to a guidance request, including any output parameters returned by the
  ...
  *
  * @constructor
  *   Introduces the fields note, status, result, subject, module, encounter, performer, identifier, reasonCode,
  *   reasonReference, dataRequirement, outputParameters, requestIdentifier, evaluationMessage, occurrenceDateTime.
  * @param id
