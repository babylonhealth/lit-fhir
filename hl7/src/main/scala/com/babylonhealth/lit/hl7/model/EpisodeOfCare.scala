...
object EpisodeOfCare extends CompanionFor[EpisodeOfCare] {
  override val baseType: CompanionFor[EpisodeOfCare] = EpisodeOfCare
  ...
  object StatusHistory extends CompanionFor[StatusHistory] {
    ...
    def unapply(
        o: StatusHistory): Option[(Option[String], EPISODE_OF_CARE_STATUS, Period, LitSeq[Extension], LitSeq[Extension])] =
...
/** An association between a patient and an organization / healthcare provider(s) during which time encounters may occur. The managing organization assumes a level of responsibility for the patient during this time.
  ...
  *
  * @constructor Introduces the fields `type`, team, status, period, patient, account, identifier, careManager, referralRequest, managingOrganization, diagnosis, statusHistory.
  ...
  * @param `type` - A classification of the type of episode of care; e.g. specialist referral, disease management, type of funded care.
  * @param team - The list of practitioners that may be facilitating this episode of care for specific purposes.
  * @param status - planned | waitlist | active | onhold | finished | cancelled.
  * @param period - The interval during which the managing organization assumes the defined responsibility.
  ...
  * @param identifier - The EpisodeOfCare may be known by different identifiers for different contexts of use, such as when an external agency is tracking the Episode for funding purposes.
  ...
  * @param referralRequest - Referral Request(s) that are fulfilled by this EpisodeOfCare, incoming referrals.
  ...
  * @param managingOrganization - The organization that has assumed the specific responsibilities for the specified duration.
  * @param diagnosis - The list of diagnosis relevant to this episode of care.
  * @param statusHistory - The history of statuses that the EpisodeOfCare has been through (without requiring processing the history of the resource).
  */
@POJOBoilerplate
class EpisodeOfCare(
    override val id: Option[String] = None,
