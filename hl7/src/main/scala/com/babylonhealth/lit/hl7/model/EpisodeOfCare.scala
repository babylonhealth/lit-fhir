...
/** An association between a patient and an organization / healthcare provider(s) during which time encounters may
  ...
  * @param `type`
  *   - A classification of the type of episode of care; e.g. specialist referral, disease management, type of funded
  *   care.
  * @param team
  ...
  * @param identifier
  *   - The EpisodeOfCare may be known by different identifiers for different contexts of use, such as when an external
  *   agency is tracking the Episode for funding purposes.
  * @param careManager
