...
object FHIRList extends CompanionFor[FHIRList] {
  implicit def summonObjectAndCompanionFHIRList_2065682925(o: FHIRList): ObjectAndCompanion[FHIRList, FHIRList.type] =
  ...
  object Entry extends CompanionFor[Entry] {
    implicit def summonObjectAndCompanionEntry4737404(o: Entry): ObjectAndCompanion[Entry, Entry.type] =
      ObjectAndCompanion(o, this)
...
/** A list is a curated collection of resources.
  ...
  *
  * @constructor
  *   Introduces the fields mode, code, date, note, title, status, source, subject, encounter, orderedBy, identifier, emptyReason,
  *   entry.
  * @param id
  ...
  * @param mode
  *   \- How this list was prepared - whether it is a working list that is suitable for being maintained on an ongoing basis, or
  *   if it represents a snapshot of a list of items from another source, or whether it is a prepared list where items may be
