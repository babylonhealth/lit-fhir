...
/** A list is a curated collection of resources.
  ...
  *
  * @constructor
  *   Introduces the fields mode, code, date, note, title, status, source, subject, encounter, orderedBy, identifier,
  *   emptyReason, entry.
  * @param id
  ...
  * @param source
  *   - The entity responsible for deciding what the contents of the list were. Where the list was created by a human,
