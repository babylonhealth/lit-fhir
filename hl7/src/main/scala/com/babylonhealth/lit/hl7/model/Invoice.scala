  ...
  object LineItem extends CompanionFor[LineItem] {
    ...
    val priceComponent: FHIRComponentFieldMeta[LitSeq[LineItem.PriceComponent]] =
      FHIRComponentFieldMeta(
        "priceComponent",
        lTagOf[LitSeq[LineItem.PriceComponent]],
        false,
...
/** Invoice containing collected ChargeItems from an Account with calculated individual and total price for Billing purpose.
  ...
  *
  * @constructor Introduces the fields `type`, date, note, status, issuer, subject, account, totalNet, recipient, identifier, totalGross, paymentTerms, cancelledReason, totalPriceComponent, participant, lineItem.
  ...
  * @param `type` - Type of Invoice depending on domain, realm an usage (e.g. internal/external, dental, preliminary).
  ...
  * @param subject - The individual or set of individuals receiving the goods and services billed in this invoice.
  ...
  * @param identifier - Identifier of this Invoice, often used for reference in correspondence about this invoice or for tracking of payments.
  * @param totalGross - Invoice total, tax included.
  * @param paymentTerms - Payment details such as banking details, period of payment, deductibles, methods of payment.
  * @param implicitRules - A reference to a set of rules that were followed when the resource was constructed, and which must be understood when processing the content. Often, this is a reference to an implementation guide that defines the special rules along with other profiles etc.
  * @param cancelledReason - In case of Invoice cancellation a reason must be given (entered in error, superseded by corrected invoice etc.).
  ...
  * @param totalPriceComponent - The total amount for the Invoice may be calculated as the sum of the line items with surcharges/deductions that apply in certain conditions.  The priceComponent element can be used to offer transparency to the recipient of the Invoice of how the total price was calculated.
  * @param participant - Indicates who or what performed or participated in the charged service.
  * @param lineItem - Each line item represents one charge for goods and services rendered. Details such as date, code and amount are found in the referenced ChargeItem resource.
  */
@POJOBoilerplate
class Invoice(
    override val id: Option[String] = None,
