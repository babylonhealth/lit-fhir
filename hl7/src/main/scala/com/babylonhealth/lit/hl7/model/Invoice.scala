...
/** Invoice containing collected ChargeItems from an Account with calculated individual and total price for Billing
  ...
  *
  * @constructor
  *   Introduces the fields `type`, date, note, status, issuer, subject, account, totalNet, recipient, identifier,
  *   totalGross, paymentTerms, cancelledReason, totalPriceComponent, participant, lineItem.
  * @param id
  ...
  * @param identifier
  *   - Identifier of this Invoice, often used for reference in correspondence about this invoice or for tracking of
  *   payments.
  * @param totalGross
  ...
  *   - The total amount for the Invoice may be calculated as the sum of the line items with surcharges/deductions that
  *   apply in certain conditions. The priceComponent element can be used to offer transparency to the recipient of the
  *   Invoice of how the total price was calculated.
  * @param participant
  *   - Indicates who or what performed or participated in the charged service.
  * @param lineItem
  *   - Each line item represents one charge for goods and services rendered. Details such as date, code and amount are
