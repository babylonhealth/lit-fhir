...
/** An assessment of the likely outcome(s) for a patient or other subject as well as the likelihood of each outcome.
  ...
  *
  * @constructor
  *   Introduces the fields code, note, basis, parent, status, method, basedOn, subject, encounter, condition,
  *   performer, identifier, reasonCode, mitigation, occurrence, reasonReference, prediction.
  * @param id
  ...
  * @param basis
  *   - Indicates the source data considered as part of the assessment (for example, FamilyHistory, Observations,
