...
object RiskAssessment extends CompanionFor[RiskAssessment] {
  implicit def summonObjectAndCompanionRiskAssessment_2084192793(
  ...
  object Prediction extends CompanionFor[Prediction] {
    implicit def summonObjectAndCompanionPrediction1468618818(
        o: Prediction): ObjectAndCompanion[Prediction, Prediction.type] = ObjectAndCompanion(o, this)
    ...
    val probability: FHIRComponentFieldMeta[Option[Prediction.ProbabilityChoice]] =
      FHIRComponentFieldMeta(
        "probability",
        lTagOf[Option[Prediction.ProbabilityChoice]],
        true,
        lTagOf[Union_0831630297])
  ...
  val occurrence: FHIRComponentFieldMeta[Option[RiskAssessment.OccurrenceChoice]] =
    FHIRComponentFieldMeta(
      "occurrence",
      lTagOf[Option[RiskAssessment.OccurrenceChoice]],
      true,
  ...
  val prediction: FHIRComponentFieldMeta[LitSeq[RiskAssessment.Prediction]] =
    FHIRComponentFieldMeta(
      "prediction",
      lTagOf[LitSeq[RiskAssessment.Prediction]],
      false,
      lTagOf[RiskAssessment.Prediction])
...
/** An assessment of the likely outcome(s) for a patient or other subject as well as the likelihood of each outcome.
  ...
  *
  * @constructor Introduces the fields code, note, basis, parent, status, method, basedOn, subject, encounter, condition, performer, identifier, reasonCode, mitigation, occurrence, reasonReference, prediction.
  ...
  * @param basis - Indicates the source data considered as part of the assessment (for example, FamilyHistory, Observations, Procedures, Conditions, etc.).
  * @param parent - A reference to a resource that this risk assessment is part of, such as a Procedure.
  ...
  * @param condition - For assessments or prognosis specific to a particular condition, indicates the condition being assessed.
  ...
  * @param mitigation - A description of the steps that might be taken to reduce the identified risk(s).
  * @param implicitRules - A reference to a set of rules that were followed when the resource was constructed, and which must be understood when processing the content. Often, this is a reference to an implementation guide that defines the special rules along with other profiles etc.
  * @param occurrence - The date (and possibly time) the risk assessment was performed.
