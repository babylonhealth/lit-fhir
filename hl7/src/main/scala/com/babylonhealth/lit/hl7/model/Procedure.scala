...
/** An action that is or was performed on or for a patient. This can be a physical intervention like an operation, or
  ...
  *
  * @constructor
  *   Introduces the fields code, note, partOf, status, report, basedOn, subject, outcome, category, recorder, asserter,
  *   location, bodySite, followUp, usedCode, encounter, identifier, reasonCode, statusReason, performed, complication,
  *   usedReference, instantiatesUri, reasonReference, complicationDetail, instantiatesCanonical, performer,
  *   focalDevice.
  * @param id
  ...
  * @param followUp
  *   - If the procedure required specific follow up - e.g. removal of sutures. The follow up may be represented as a
  *   simple note or could potentially be more complex, in which case the CarePlan resource can be used.
  * @param usedCode
  ...
  * @param encounter
  *   - The Encounter during which this Procedure was created or performed or to which the creation of this record is
  *   tightly associated.
  * @param identifier
  ...
  * @param reasonCode
  *   - The coded reason why the procedure was performed. This may be a coded entity of some type, or may simply be
  *   present as text.
  * @param statusReason
  ...
  * @param complication
  *   - Any complications that occurred during the procedure, or in the immediate post-performance period. These are
  *   generally tracked separately from the notes, which will typically describe the procedure itself rather than any
  ...
  *   - The URL pointing to an externally maintained protocol, guideline, order set or other definition that is adhered
  ...
  *   - The URL pointing to a FHIR-defined protocol, guideline, order set or other definition that is adhered to in
