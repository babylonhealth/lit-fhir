...
/** The Care Team includes all the people and organizations who plan to participate in the coordination and delivery of care for a patient.
  ...
  *
  * @constructor Introduces the fields name, note, status, period, subject, telecom, category, encounter, identifier, reasonCode, reasonReference, managingOrganization, participant.
