...
object CareTeam extends CompanionFor[CareTeam] {
  ...
  object Participant extends CompanionFor[Participant] {
    ...
    type CoverageChoice = Choice[UnionPeriodOrTiming]
    def apply(
        ...
        coverage: Option[Participant.CoverageChoice] = None,
    ...
    def unapply(
        o: Participant): Option[(Option[String], Option[CodeableConcept], Option[Reference], LitSeq[Extension], Option[Reference], Option[Participant.CoverageChoice], LitSeq[Extension])] =
      Some((o.id, o.role, o.member, o.extension, o.onBehalfOf, o.coverage, o.modifierExtension))
    ...
    val coverage: FHIRComponentFieldMeta[Option[Participant.CoverageChoice]] =
      FHIRComponentFieldMeta("coverage", lTagOf[Option[Participant.CoverageChoice]], true, lTagOf[UnionPeriodOrTiming])
    val modifierExtension: FHIRComponentFieldMeta[LitSeq[Extension]] =
      FHIRComponentFieldMeta("modifierExtension", lTagOf[LitSeq[Extension]], false, lTagOf[Extension])
    val fieldsMeta: Seq[FHIRComponentFieldMeta[_]] = Seq(id, role, member, extension, onBehalfOf, coverage, modifierExtension)
    ...
    override def fields(t: Participant): Seq[FHIRComponentField[_]] = Seq(
      ...
      FHIRComponentField[Option[Participant.CoverageChoice]](coverage, t.coverage),
      ...
      checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
        Try(
          new Participant(
            ...
            cursor.decodeOptRef[UnionPeriodOrTiming]("coverage"),
  ...
  class Participant(
      ...
      val coverage: Option[Participant.CoverageChoice] = None,
  ...
  def extractReason(t: CareTeam): LitSeq[CodeableReference]         = t.reason
  ...
  override val searchParams: Map[String, CareTeam => Seq[Any]] = Map(
    ...
    "name" -> (obj =>
      obj.name.toSeq ++
        obj.extension.filter(_.url == "http://hl7.org/fhir/StructureDefinition/careteam-alias").toSeq),
  ...
  def unapply(
      o: CareTeam): Option[(Option[String], Option[Meta], Option[Narrative], Option[String], LitSeq[Annotation], Option[CARE_TEAM_STATUS], Option[Period], LitSeq[CodeableReference], Option[Reference], LitSeq[ContactPoint], Option[LANGUAGES], LitSeq[CodeableConcept], LitSeq[Resource], LitSeq[Extension], LitSeq[Identifier], Option[UriStr], LitSeq[Extension], LitSeq[Reference], LitSeq[CareTeam.Participant])] =
    Some(
      (
        o.id,
        o.meta,
...
/** The Care Team includes all the people and organizations who plan to participate in the coordination and delivery of care.
  ...
  *
  * @constructor
  *   Introduces the fields name, note, status, period, reason, subject, telecom, category, identifier, managingOrganization,
  *   participant.
  * @param id
