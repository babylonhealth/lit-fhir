...
/** The Library resource is a general-purpose container for knowledge asset definitions. It can be used to describe and
  * expose existing knowledge assets such as logic libraries and information model descriptions, as well as to describe
  * a collection of knowledge assets.
  *
  * Subclass of [[hl7.model.DomainResource]] (A resource that includes narrative, extensions, and contained resources.)
  *
  * @constructor
  *   Introduces the fields url, name, `type`, date, title, usage, topic, status, author, editor, version, contact,
  *   purpose, content, subtitle, reviewer, endorser, publisher, copyright, parameter, identifier, subject, useContext,
  *   description, experimental, jurisdiction, approvalDate, lastReviewDate, effectivePeriod, relatedArtifact,
  *   dataRequirement.
  * @param id
