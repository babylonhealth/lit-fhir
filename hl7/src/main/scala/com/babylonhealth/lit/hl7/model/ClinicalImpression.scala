...
/** A record of a clinical assessment performed to determine what problem(s) may affect the patient and before planning
  ...
  *
  * @constructor
  *   Introduces the fields code, date, note, status, subject, problem, summary, assessor, previous, protocol,
  *   encounter, identifier, description, statusReason, effective, supportingInfo, prognosisReference,
  *   prognosisCodeableConcept, finding, investigation.
  * @param id
  ...
  * @param note
  *   - Commentary about the impression, typically recorded after the impression itself was made, though supplemental
  *   notes by the original author could also appear.
  * @param status
  ...
  *   nature; a care provider (practitioner or team) will make new assessments on an ongoing basis as new data arises or
  *   the patient's conditions changes.
  * @param protocol
  *   - Reference to a specific published clinical protocol that was followed during this assessment, and/or that
  ...
  * @param encounter
  *   - The Encounter during which this ClinicalImpression was created or to which the creation of this record is
  *   tightly associated.
  * @param identifier
  *   - Business identifiers assigned to this clinical impression by the performer or other systems which remain
  *   constant as the resource is updated and propagates from server to server.
  * @param description
  *   - A summary of the context and/or cause of the assessment - why / where it was performed, and what patient
