...
/** A structured set of questions intended to guide the collection of answers from end-users. Questionnaires provide detailed control over order, presentation, phraseology and grouping to allow coherent, consistent data collection.
  ...
  *
  * @constructor Introduces the fields url, name, date, code, title, status, version, contact, purpose, publisher, copyright, identifier, useContext, derivedFrom, subjectType, description, experimental, jurisdiction, approvalDate, lastReviewDate, effectivePeriod, item.
