...
object Questionnaire extends CompanionFor[Questionnaire] {
  ...
  object Item extends CompanionFor[Item] {
    ...
    object Initial extends CompanionFor[Initial] {
      ...
      def unapply(o: Initial): Option[(Option[String], Initial.ValueChoice, LitSeq[Extension], LitSeq[Extension])] =
      ...
      val value: FHIRComponentFieldMeta[Initial.ValueChoice] =
        FHIRComponentFieldMeta("value", lTagOf[Initial.ValueChoice], true, lTagOf[Union_2101127777])
    ...
    object EnableWhen extends CompanionFor[EnableWhen] {
      ...
      val operator: FHIRComponentFieldMeta[QUESTIONNAIRE_ENABLE_OPERATOR] =
        FHIRComponentFieldMeta(
          "operator",
          lTagOf[QUESTIONNAIRE_ENABLE_OPERATOR],
          false,
          lTagOf[QUESTIONNAIRE_ENABLE_OPERATOR])
      val extension: FHIRComponentFieldMeta[LitSeq[Extension]] =
        FHIRComponentFieldMeta("extension", lTagOf[LitSeq[Extension]], false, lTagOf[Extension])
      val answer: FHIRComponentFieldMeta[EnableWhen.AnswerChoice] =
        FHIRComponentFieldMeta("answer", lTagOf[EnableWhen.AnswerChoice], true, lTagOf[Union_0388264667])
      val modifierExtension: FHIRComponentFieldMeta[LitSeq[Extension]] =
        FHIRComponentFieldMeta("modifierExtension", lTagOf[LitSeq[Extension]], false, lTagOf[Extension])
        ...
        checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
          Try(
            new EnableWhen(
              ...
              cursor.decodeAs[LitSeq[Extension]]("extension", Some(LitSeq.empty)),
              cursor.decodeRef[Union_0388264667]("answer"),
              cursor.decodeAs[LitSeq[Extension]]("modifierExtension", Some(LitSeq.empty)),
              decodeAttributes(cursor)
            )
          ))
    ...
    object AnswerOption extends CompanionFor[AnswerOption] {
      ...
      val value: FHIRComponentFieldMeta[AnswerOption.ValueChoice] =
        FHIRComponentFieldMeta("value", lTagOf[AnswerOption.ValueChoice], true, lTagOf[Union_1132894602])
      val extension: FHIRComponentFieldMeta[LitSeq[Extension]] =
        FHIRComponentFieldMeta("extension", lTagOf[LitSeq[Extension]], false, lTagOf[Extension])
      ...
      def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[AnswerOption] =
        checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
          Try(
            new AnswerOption(
              cursor.decodeAs[Option[String]]("id", Some(None)),
              cursor.decodeRef[Union_1132894602]("value"),
              cursor.decodeAs[LitSeq[Extension]]("extension", Some(LitSeq.empty)),
...
/** A structured set of questions intended to guide the collection of answers from end-users. Questionnaires provide
  ...
  *
  * @constructor
  *   Introduces the fields url, name, date, code, title, status, version, contact, purpose, publisher, copyright,
  *   identifier, useContext, derivedFrom, subjectType, description, experimental, jurisdiction, approvalDate,
  *   lastReviewDate, effectivePeriod, item.
  * @param id
  ...
  *   literal address at which at which an authoritative instance of this questionnaire is (or will be) published. This
  *   URL can be the target of a canonical reference. It SHALL remain the same when the questionnaire is stored on
  *   different servers.
  * @param meta
  ...
  * @param name
  *   - A natural language name identifying the questionnaire. This name should be usable as an identifier for the
  *   module by machine processing applications such as code generation.
  * @param date
  *   - The date (and optionally time) when the questionnaire was published. The date must change when the business
  ...
  * @param version
  *   - The identifier that is used to identify this version of the questionnaire when it is referenced in a
  *   specification, model, design or instance. This is an arbitrary value managed by the questionnaire author and is
  ...
  * @param copyright
  *   - A copyright statement relating to the questionnaire and/or its contents. Copyright statements are generally
  *   legal restrictions on the use and publishing of the questionnaire.
  * @param identifier
  *   - A formal identifier that is used to identify this questionnaire when it is represented in other formats, or
  ...
  *   and may be used to assist with indexing and searching for appropriate questionnaire instances.
  * @param derivedFrom
