...
object DiagnosticReport extends CompanionFor[DiagnosticReport] {
  ...
  object Media extends CompanionFor[Media] {
    ...
    def unapply(o: Media): Option[(Option[String], Reference, Option[String], LitSeq[Extension], LitSeq[Extension])] =
      Some((o.id, o.link, o.comment, o.extension, o.modifierExtension))
  ...
  val effective: FHIRComponentFieldMeta[Option[DiagnosticReport.EffectiveChoice]] =
    FHIRComponentFieldMeta(
      "effective",
      lTagOf[Option[DiagnosticReport.EffectiveChoice]],
      true,
  ...
  override val searchParams: Map[String, DiagnosticReport => Seq[Any]] = Map(
    "assessed-condition" -> (obj =>
      obj.extension
        .filter(_.url == "http://hl7.org/fhir/StructureDefinition/DiagnosticReport-geneticsAssessedCondition")
        .toSeq),
...
/** The findings and interpretation of diagnostic  tests performed on patients, groups of patients, devices, and locations, and/or specimens derived from these. The report includes clinical context such as requesting and provider information, and some mix of atomic results, images, textual and coded interpretations, and formatted representation of diagnostic reports.
  ...
  *
  * @constructor Introduces the fields code, status, issued, result, basedOn, subject, category, specimen, encounter, performer, identifier, conclusion, effective, imagingStudy, presentedForm, conclusionCode, resultsInterpreter, media.
