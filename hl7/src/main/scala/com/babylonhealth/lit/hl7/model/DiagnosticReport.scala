...
/** The findings and interpretation of diagnostic tests performed on patients, groups of patients, devices, and
  ...
  *
  * @constructor
  *   Introduces the fields code, status, issued, result, basedOn, subject, category, specimen, encounter, performer,
  *   identifier, conclusion, effective, imagingStudy, presentedForm, conclusionCode, resultsInterpreter, media.
  * @param id
