...
/** Representation of the content produced in a DICOM imaging study. A study comprises a set of series, each of which
  ...
  *   identifier, reasonCode, interpreter, description, procedureCode, numberOfSeries, reasonReference,
  *   numberOfInstances, procedureReference, series.
  * @param id
  ...
  *   Observations or findings about the imaging study should be recorded in another resource, e.g. Observation, and not
  *   in this element.
  * @param status
  ...
  * @param modality
  *   - A list of all the series.modality values that are actual acquisition modalities, i.e. those in the DICOM Context
  *   Group 29 (value set OID 1.2.840.10008.6.1.19).
  * @param referrer
  *   - The requesting/referring physician.
  * @param endpoint
  *   - The network service providing access (e.g., query, view, or retrieval) for the study. See implementation notes
  *   for information about using DICOM endpoints. A study-level endpoint applies to each series in the study, unless
  ...
  * @param encounter
  *   - The healthcare event (e.g. a patient and healthcare provider interaction) during which this ImagingStudy is
  *   made.
  * @param identifier
  ...
  *   - Number of SOP Instances in Study. This value given may be larger than the number of instance elements this
  *   resource contains due to resource availability, security, or other factors. This element should be present if any
