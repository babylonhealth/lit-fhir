...
/** Representation of the content produced in a DICOM imaging study. A study comprises a set of series, each of which includes a set of Service-Object Pair Instances (SOP Instances - images or other data) acquired or produced in a common context.  A series is of only one modality (e.g. X-ray, CT, MR, ultrasound), but a study may have multiple series of different modalities.
  ...
  *
  * @constructor Introduces the fields note, status, subject, started, basedOn, modality, referrer, endpoint, location, encounter, identifier, reasonCode, interpreter, description, procedureCode, numberOfSeries, reasonReference, numberOfInstances, procedureReference, series.
  ...
  * @param note - Per the recommended DICOM mapping, this element is derived from the Study Description attribute (0008,1030). Observations or findings about the imaging study should be recorded in another resource, e.g. Observation, and not in this element.
  ...
  * @param basedOn - A list of the diagnostic requests that resulted in this imaging study being performed.
  * @param language - The base language in which the resource is written.
  * @param modality - A list of all the series.modality values that are actual acquisition modalities, i.e. those in the DICOM Context Group 29 (value set OID 1.2.840.10008.6.1.19).
  * @param referrer - The requesting/referring physician.
  * @param endpoint - The network service providing access (e.g., query, view, or retrieval) for the study. See implementation notes for information about using DICOM endpoints. A study-level endpoint applies to each series in the study, unless overridden by a series-level endpoint with the same Endpoint.connectionType.
  ...
  * @param encounter - The healthcare event (e.g. a patient and healthcare provider interaction) during which this ImagingStudy is made.
  * @param identifier - Identifiers for the ImagingStudy such as DICOM Study Instance UID, and Accession Number.
  * @param reasonCode - Description of clinical condition indicating why the ImagingStudy was requested.
  * @param interpreter - Who read the study and interpreted the images or other content.
  * @param description - The Imaging Manager description of the study. Institution-generated description or classification of the Study (component) performed.
  * @param implicitRules - A reference to a set of rules that were followed when the resource was constructed, and which must be understood when processing the content. Often, this is a reference to an implementation guide that defines the special rules along with other profiles etc.
  * @param procedureCode - The code for the performed procedure type.
  * @param numberOfSeries - Number of Series in the Study. This value given may be larger than the number of series elements this Resource contains due to resource availability, security, or other factors. This element should be present if any series elements are present.
  ...
  * @param numberOfInstances - Number of SOP Instances in Study. This value given may be larger than the number of instance elements this resource contains due to resource availability, security, or other factors. This element should be present if any instance elements are present.
