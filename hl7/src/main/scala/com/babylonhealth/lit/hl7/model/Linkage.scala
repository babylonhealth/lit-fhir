...
object Linkage extends CompanionFor[Linkage] {
  ...
  object Item extends CompanionFor[Item] {
    ...
    def unapply(o: Item): Option[(Option[String], LINKAGE_TYPE, Reference, LitSeq[Extension], LitSeq[Extension])] =
      Some((o.id, o.`type`, o.resource, o.extension, o.modifierExtension))
...
/** Identifies two or more records (resource instances) that refer to the same real-world "occurrence".
  ...
  *
  * @constructor Introduces the fields active, author, item.
  ...
  * @param active - Indicates whether the asserted set of linkages are considered to be "in effect".
  * @param author - Identifies the user or organization responsible for asserting the linkages as well as the user or organization who establishes the context in which the nature of each linkage is evaluated.
  ...
  * @param item - Identifies which record considered as the reference to the same real-world occurrence as well as how the items should be evaluated within the collection of linked items.
  */
@POJOBoilerplate
class Linkage(
    override val id: Option[String] = None,
