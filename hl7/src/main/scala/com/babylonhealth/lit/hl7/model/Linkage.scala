...
/** Identifies two or more records (resource instances) that refer to the same real-world "occurrence".
  ...
  * @param author
  *   - Identifies the user or organization responsible for asserting the linkages as well as the user or organization
  *   who establishes the context in which the nature of each linkage is evaluated.
  * @param language
  ...
  * @param item
  *   - Identifies which record considered as the reference to the same real-world occurrence as well as how the items
