...
/** Represents a request for a patient to employ a medical device. The device may be an implantable device, or an
  ...
  *
  * @constructor
  *   Introduces the fields note, status, intent, basedOn, code, subject, priority, encounter, requester, performer,
  *   insurance, identifier, authoredOn, reasonCode, priorRequest, occurrence, performerType, supportingInfo,
  *   instantiatesUri, groupIdentifier, reasonReference, relevantHistory, instantiatesCanonical, parameter.
  * @param id
  ...
  * @param note
  *   - Details about this request that were not represented at all or sufficiently in one of the attributes provided in
  *   a class. These may include for example a comment, an instruction, or a note associated with the statement.
  * @param status
  ...
  * @param occurrence
  *   - The timing schedule for the use of the device. The Schedule data type allows many different expressions, for
  *   example. "Every 8 hours"; "Three times a day"; "1/2 an hour before breakfast for 10 days from 23-Dec 2011:"; "15
  *   Oct 2013, 17 Oct 2013 and 1 Nov 2013".
  * @param performerType
  *   - Desired type of performer for doing the diagnostic testing.
  * @param supportingInfo
  *   - Additional clinical information about the patient that may influence the request fulfilment. For example, this
  *   may include where on the subject's body the device will be used (i.e. the target site).
  * @param instantiatesUri
  *   - The URL pointing to an externally maintained protocol, guideline, orderset or other definition that is adhered
  *   to in whole or in part by this DeviceRequest.
