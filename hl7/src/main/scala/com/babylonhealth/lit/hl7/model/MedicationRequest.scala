...
/** An order or request for both supply of the medication and the instructions for administration of the medication to a
  ...
  *
  * @constructor
  *   Introduces the fields note, status, intent, subject, basedOn, category, priority, recorder, encounter, requester,
  *   performer, insurance, identifier, authoredOn, reasonCode, reported, statusReason, doNotPerform, eventHistory,
  *   medication, performerType, detectedIssue, reasonReference, instantiatesUri, groupIdentifier, dosageInstruction,
  *   priorPrescription, courseOfTherapyType, supportingInformation, instantiatesCanonical, substitution,
  *   dispenseRequest.
  * @param id
