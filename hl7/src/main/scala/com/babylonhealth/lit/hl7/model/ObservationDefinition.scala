...
/** Set of definitional characteristics for a kind of observation or measurement produced or consumed by an orderable
  ...
  *
  * @constructor
  *   Introduces the fields code, method, category, identifier, permittedDataType, validCodedValueSet,
  *   preferredReportName, normalCodedValueSet, abnormalCodedValueSet, criticalCodedValueSet, multipleResultsAllowed,
  *   qualifiedInterval, quantitativeDetails.
  * @param id
  ...
  *   - Multiple ranges of results qualified by different contexts for ordinal or continuous observations conforming to
