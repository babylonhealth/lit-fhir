...
object ObservationDefinition extends CompanionFor[ObservationDefinition] {
  ...
  def extractQualifiedInterval(t: ObservationDefinition): LitSeq[ObservationDefinition.QualifiedInterval] =
    t.qualifiedInterval
...
/** Set of definitional characteristics for a kind of observation or measurement produced or consumed by an orderable health care service.
  ...
  *
  * @constructor Introduces the fields code, method, category, identifier, permittedDataType, validCodedValueSet, preferredReportName, normalCodedValueSet, abnormalCodedValueSet, criticalCodedValueSet, multipleResultsAllowed, qualifiedInterval, quantitativeDetails.
  ...
  * @param permittedDataType - The data types allowed for the value element of the instance observations conforming to this ObservationDefinition.
  * @param validCodedValueSet - The set of valid coded results for the observations  conforming to this ObservationDefinition.
  * @param preferredReportName - The preferred name to be used when reporting the results of observations conforming to this ObservationDefinition.
  * @param normalCodedValueSet - The set of normal coded results for the observations conforming to this ObservationDefinition.
  * @param abnormalCodedValueSet - The set of abnormal coded results for the observation conforming to this ObservationDefinition.
  * @param criticalCodedValueSet - The set of critical coded results for the observation conforming to this ObservationDefinition.
  * @param multipleResultsAllowed - Multiple results allowed for observations conforming to this ObservationDefinition.
  * @param qualifiedInterval - Multiple  ranges of results qualified by different contexts for ordinal or continuous observations conforming to this ObservationDefinition.
