...
/** Enforces the minimum information set for the value set metadata required by HL7 and other organizations that share
  * and publish value sets
  *
  * Subclass of [[hl7.model.CodeSystem]] (The CodeSystem resource is used to declare the existence of and describe a
  ...
  *   version, publisher, description, experimental, concept.
  * @param id
  ...
  *   different servers. This is used in [Coding](http://hl7.org/fhir/datatypes.html#Coding).system.
  * @param meta
