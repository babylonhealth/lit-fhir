...
object MolecularSequence extends CompanionFor[MolecularSequence] {
  implicit def summonObjectAndCompanionMolecularSequence1775667900(
  ...
  object StructureVariant extends CompanionFor[StructureVariant] {
    implicit def summonObjectAndCompanionStructureVariant615515106(
    ...
    object Outer extends CompanionFor[Outer] {
      implicit def summonObjectAndCompanionOuter_2010738347(o: Outer): ObjectAndCompanion[Outer, Outer.type] =
      ...
      def unapply(o: Outer): Option[(Option[String], Option[Int], Option[Int], LitSeq[Extension], LitSeq[Extension])] = Some(
        (o.id, o.end, o.start, o.extension, o.modifierExtension))
    ...
    object Inner extends CompanionFor[Inner] {
      implicit def summonObjectAndCompanionInner_2010738347(o: Inner): ObjectAndCompanion[Inner, Inner.type] =
        ObjectAndCompanion(o, this)
      ...
      def unapply(o: Inner): Option[(Option[String], Option[Int], Option[Int], LitSeq[Extension], LitSeq[Extension])] = Some(
        (o.id, o.end, o.start, o.extension, o.modifierExtension))
      val id: FHIRComponentFieldMeta[Option[String]] =
        FHIRComponentFieldMeta("id", lTagOf[Option[String]], false, lTagOf[String])
      val end: FHIRComponentFieldMeta[Option[Int]] =
  ...
  object ReferenceSeq extends CompanionFor[ReferenceSeq] {
    implicit def summonObjectAndCompanionReferenceSeq615515106(
  ...
  object Quality extends CompanionFor[Quality] {
    implicit def summonObjectAndCompanionQuality615515106(o: Quality): ObjectAndCompanion[Quality, Quality.type] =
      ObjectAndCompanion(o, this)
    ...
    object Roc extends CompanionFor[Roc] {
      implicit def summonObjectAndCompanionRoc_1502956625(o: Roc): ObjectAndCompanion[Roc, Roc.type] = ObjectAndCompanion(o, this)
      ...
      def unapply(
        ...
        Some((o.id, o.score, o.numTP, o.numFP, o.numFN, o.fMeasure, o.extension, o.precision, o.sensitivity, o.modifierExtension))
      val id: FHIRComponentFieldMeta[Option[String]] =
        FHIRComponentFieldMeta("id", lTagOf[Option[String]], false, lTagOf[String])
  ...
  object Repository extends CompanionFor[Repository] {
    implicit def summonObjectAndCompanionRepository615515106(o: Repository): ObjectAndCompanion[Repository, Repository.type] =
      ObjectAndCompanion(o, this)
  ...
  object Variant extends CompanionFor[Variant] {
    implicit def summonObjectAndCompanionVariant615515106(o: Variant): ObjectAndCompanion[Variant, Variant.type] =
      ObjectAndCompanion(o, this)
  ...
  val variant: FHIRComponentFieldMeta[LitSeq[MolecularSequence.Variant]] =
    FHIRComponentFieldMeta("variant", lTagOf[LitSeq[MolecularSequence.Variant]], false, lTagOf[MolecularSequence.Variant])
  ...
  val quality: FHIRComponentFieldMeta[LitSeq[MolecularSequence.Quality]] =
    FHIRComponentFieldMeta("quality", lTagOf[LitSeq[MolecularSequence.Quality]], false, lTagOf[MolecularSequence.Quality])
...
/** Raw data describing a biological sequence.
  ...
  *
  * @constructor
  *   Introduces the fields `type`, device, patient, pointer, specimen, quantity, performer, identifier, observedSeq,
  *   readCoverage, coordinateSystem, variant, repository, quality, referenceSeq, structureVariant.
  * @param id
  ...
  * @param observedSeq
  *   - Sequence that was observed. It is the result marked by referenceSeq along with variant records on referenceSeq. This shall
  *     start from referenceSeq.windowStart and end by referenceSeq.windowEnd.
  * @param readCoverage
  ...
  *     ([variant_of](http://www.sequenceontology.org/browser/current_svn/term/variant_of)). This element can represent amino acid
  *     or nucleic sequence change(including insertion,deletion,SNP,etc.) It can represent some complex mutation or segment
