...
/** Raw data describing a biological sequence.
  ...
  * @param observedSeq
  *   - Sequence that was observed. It is the result marked by referenceSeq along with variant records on referenceSeq.
  *   This shall start from referenceSeq.windowStart and end by referenceSeq.windowEnd.
  * @param readCoverage
  *   - Coverage (read depth or depth) is the average number of reads representing a given nucleotide in the
  ...
  *   - Whether the sequence is numbered starting at 0 (0-based numbering or coordinates, inclusive start, exclusive
  *   end) or starting at 1 (1-based numbering, inclusive start and inclusive end).
  ...
  *   ([variant_of](http://www.sequenceontology.org/browser/current_svn/term/variant_of)). This element can represent
  *   amino acid or nucleic sequence change(including insertion,deletion,SNP,etc.) It can represent some complex
  *   mutation or segment variation with the assist of CIGAR string.
  * @param repository
  *   - Configurations of the external repository. The repository shall store target's observedSeq or records related
  *   with target's observedSeq.
  * @param quality
