...
/** A record of a device being used by a patient where the record is the result of a report from the patient or another
  ...
  *
  * @constructor
  *   Introduces the fields note, status, source, device, basedOn, subject, bodySite, timing, identifier, recordedOn,
  *   reasonCode, derivedFrom, reasonReference.
  * @param id
  ...
  *   provided in a class. These may include for example a comment, an instruction, or a note associated with the
  *   statement.
  * @param status
  ...
  * @param derivedFrom
  *   - Allows linking the DeviceUseStatement to the underlying Request, or to other information that supports or is
  *   used to derive the DeviceUseStatement.
  * @param implicitRules
