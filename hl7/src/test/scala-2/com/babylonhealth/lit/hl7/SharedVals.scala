...
object SharedVals {
  ...
  val zdt1Ref: Option[Choice[FHIRDateTime \/ Period \/ Timing \/ ZonedDateTime]] = Some(choose(zdt1))
  val zdt2Ref: Option[Choice[FHIRDateTime \/ Period \/ Timing \/ ZonedDateTime]] = Some(choose(zdt2))
}
