...
import com.babylonhealth.lit.core.model.{ Age, Coding, Count, Distance, Duration, Expression, Quantity, Reference, Resource }
import com.babylonhealth.lit.hl7.model.{ MoneyQuantity, SimpleQuantity }

class Tst extends AnyFreeSpec with Matchers {
  "instantiate" in {
    val x = Seq(Age, Coding, Count, Distance, Duration, Expression, Quantity, Reference, Resource, MoneyQuantity, SimpleQuantity)
