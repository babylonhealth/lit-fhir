...
public interface UKCore_PractitionerBuilder extends PractitionerBuilder {
  public UKCore_Practitioner build();
  ...
  public class Impl implements UKCore_PractitionerBuilder {
    private Optional<String> id = Optional.empty();
    private Optional<Meta> meta =
        Optional.of(
            MetaBuilder.init()
                .withProfile("https://fhir.hl7.org.uk/StructureDefinition/UKCore-Practitioner")
                .build());
    ...
    /** Required fields for {@link UKCore_Practitioner} */
    public Impl() {}
     ...
     */
    public UKCore_PractitionerBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public UKCore_PractitionerBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public UKCore_PractitionerBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public UKCore_PractitionerBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public UKCore_PractitionerBuilder.Impl withText(@NonNull NarrativeBuilder text) {
      this.text = Optional.of(text.build());
      return this;
    }
    /** @param name - The name(s) associated with the practitioner. */
    public UKCore_PractitionerBuilder.Impl withName(@NonNull HumanName... name) {
      this.name = Arrays.asList(name);
      return this;
    }
    /** @param name - The name(s) associated with the practitioner. */
    public UKCore_PractitionerBuilder.Impl withName(@NonNull Collection<HumanName> name) {
      this.name = Collections.unmodifiableCollection(name);
      return this;
    }

    public UKCore_PractitionerBuilder.Impl withName(@NonNull HumanNameBuilder... name) {
      this.name = Arrays.stream(name).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param photo - Image of the person. */
    public UKCore_PractitionerBuilder.Impl withPhoto(@NonNull Attachment... photo) {
      this.photo = Arrays.asList(photo);
      return this;
    }
    /** @param photo - Image of the person. */
    public UKCore_PractitionerBuilder.Impl withPhoto(@NonNull Collection<Attachment> photo) {
      this.photo = Collections.unmodifiableCollection(photo);
      return this;
    }

    public UKCore_PractitionerBuilder.Impl withPhoto(@NonNull AttachmentBuilder... photo) {
    ...
    public UKCore_PractitionerBuilder.Impl withActive(@NonNull Boolean active) {
     ...
     */
    public UKCore_PractitionerBuilder.Impl withGender(@NonNull ADMINISTRATIVE_GENDER gender) {
     ...
     *     address.
     */
    public UKCore_PractitionerBuilder.Impl withTelecom(@NonNull ContactPoint... telecom) {
     ...
     *     address.
     */
    public UKCore_PractitionerBuilder.Impl withTelecom(@NonNull Collection<ContactPoint> telecom) {
      this.telecom = Collections.unmodifiableCollection(telecom);
      return this;
    }

    public UKCore_PractitionerBuilder.Impl withTelecom(@NonNull ContactPointBuilder... telecom) {
     ...
     *     role dependent.
     */
    public UKCore_PractitionerBuilder.Impl withAddress(@NonNull Address... address) {
     ...
     *     role dependent.
     */
    public UKCore_PractitionerBuilder.Impl withAddress(@NonNull Collection<Address> address) {
      this.address = Collections.unmodifiableCollection(address);
      return this;
    }

    public UKCore_PractitionerBuilder.Impl withAddress(@NonNull AddressBuilder... address) {
      this.address = Arrays.stream(address).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public UKCore_PractitionerBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public UKCore_PractitionerBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public UKCore_PractitionerBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
      this.contained = Collections.unmodifiableCollection(contained);
      return this;
    }

    public UKCore_PractitionerBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public UKCore_PractitionerBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public UKCore_PractitionerBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public UKCore_PractitionerBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
      this.extension = Arrays.stream(extension).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param birthDate - The date of birth for the practitioner. */
    public UKCore_PractitionerBuilder.Impl withBirthDate(@NonNull FHIRDate birthDate) {
     ...
     *     profiles etc.
     */
    public UKCore_PractitionerBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
      this.implicitRules = Optional.of(implicitRules);
      return this;
    }
    /** @param communication - A language the practitioner can use in patient communication. */
    public UKCore_PractitionerBuilder.Impl withCommunication(
     ...
     */
    public UKCore_PractitionerBuilder.Impl withModifierExtension(
    ...
    public UKCore_PractitionerBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
      this.identifier = Arrays.asList(identifier);
      return this;
    }
    /** @param identifier - An identifier that applies to this person in this role. */
    public UKCore_PractitionerBuilder.Impl withIdentifier(
     ...
     */
    public UKCore_PractitionerBuilder.Impl withQualification(
    ...
    public UKCore_PractitionerBuilder.Impl withoutMeta() {
      this.meta = Optional.empty();
      return this;
    }

    public UKCore_Practitioner build() {
      return new UKCore_Practitioner(
