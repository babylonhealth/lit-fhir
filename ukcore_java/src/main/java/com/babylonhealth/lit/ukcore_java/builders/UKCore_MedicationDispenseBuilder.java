...
public interface UKCore_MedicationDispenseBuilder extends MedicationDispenseBuilder {
  public UKCore_MedicationDispense build();
  ...
  public class Impl implements UKCore_MedicationDispenseBuilder {
    ...
    /**
     * Required fields for {@link UKCore_MedicationDispense}
     *
     ...
     *     one of the UKCore_MedicationDispenseBuilder.medication static methods
     */
    public Impl(
        MEDICATIONDISPENSE_STATUS status, @NonNull ChoiceCodeableConceptOrReference medication) {
      this.status = status;
     ...
     */
    public UKCore_MedicationDispenseBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public UKCore_MedicationDispenseBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public UKCore_MedicationDispenseBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public UKCore_MedicationDispenseBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public UKCore_MedicationDispenseBuilder.Impl withText(@NonNull NarrativeBuilder text) {
     ...
     */
    public UKCore_MedicationDispenseBuilder.Impl withType(@NonNull CodeableConcept _type) {
      this._type = Optional.of(_type);
      return this;
    }

    public UKCore_MedicationDispenseBuilder.Impl withType(@NonNull CodeableConceptBuilder _type) {
      this._type = Optional.of(_type.build());
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public UKCore_MedicationDispenseBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public UKCore_MedicationDispenseBuilder.Impl withCategory(@NonNull CodeableConcept category) {
      this.category = Optional.of(category);
      return this;
    }

    public UKCore_MedicationDispenseBuilder.Impl withCategory(
     ...
     */
    public UKCore_MedicationDispenseBuilder.Impl withQuantity(@NonNull Quantity quantity) {
      this.quantity = Optional.of(quantity);
      return this;
    }

    public UKCore_MedicationDispenseBuilder.Impl withQuantity(@NonNull QuantityBuilder quantity) {
     ...
     */
    public UKCore_MedicationDispenseBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public UKCore_MedicationDispenseBuilder.Impl withContained(
     ...
     */
    public UKCore_MedicationDispenseBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public UKCore_MedicationDispenseBuilder.Impl withExtension(
    ...
    public UKCore_MedicationDispenseBuilder.Impl withDaysSupply(@NonNull Quantity daysSupply) {
      this.daysSupply = Optional.of(daysSupply);
      return this;
    }

    public UKCore_MedicationDispenseBuilder.Impl withDaysSupply(
        @NonNull QuantityBuilder daysSupply) {
    ...
    public UKCore_MedicationDispenseBuilder.Impl withWhenPrepared(
        @NonNull FHIRDateTime whenPrepared) {
     ...
     *     profiles etc.
     */
    public UKCore_MedicationDispenseBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     *     representative.
     */
    public UKCore_MedicationDispenseBuilder.Impl withWhenHandedOver(
        @NonNull FHIRDateTime whenHandedOver) {
     ...
     *     attributes.
     */
    public UKCore_MedicationDispenseBuilder.Impl withNote(@NonNull Annotation... note) {
     ...
     *     attributes.
     */
    public UKCore_MedicationDispenseBuilder.Impl withNote(@NonNull Collection<Annotation> note) {
      this.note = Collections.unmodifiableCollection(note);
      return this;
    }

    public UKCore_MedicationDispenseBuilder.Impl withNote(@NonNull AnnotationBuilder... note) {
     ...
     *     wrap with one of the UKCore_MedicationDispenseBuilder.statusReason static methods
     */
    public UKCore_MedicationDispenseBuilder.Impl withStatusReason(
     ...
     */
    public UKCore_MedicationDispenseBuilder.Impl withModifierExtension(
     ...
     */
    public UKCore_MedicationDispenseBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     *     from server to server.
     */
    public UKCore_MedicationDispenseBuilder.Impl withIdentifier(
    ...
    public UKCore_MedicationDispenseBuilder.Impl withPartOf(@NonNull Reference... partOf) {
      this.partOf = Arrays.asList(partOf);
      return this;
    }
    /** @param partOf - The procedure that trigger the dispense. */
    public UKCore_MedicationDispenseBuilder.Impl withPartOf(@NonNull Collection<Reference> partOf) {
      this.partOf = Collections.unmodifiableCollection(partOf);
      return this;
    }

    public UKCore_MedicationDispenseBuilder.Impl withPartOf(@NonNull ReferenceBuilder... partOf) {
     ...
     */
    public UKCore_MedicationDispenseBuilder.Impl withSubject(@NonNull Reference subject) {
      this.subject = Optional.of(subject);
      return this;
    }

    public UKCore_MedicationDispenseBuilder.Impl withSubject(@NonNull ReferenceBuilder subject) {
     ...
     *     event.
     */
    public UKCore_MedicationDispenseBuilder.Impl withContext(@NonNull Reference context) {
      this.context = Optional.of(context);
      return this;
    }

    public UKCore_MedicationDispenseBuilder.Impl withContext(@NonNull ReferenceBuilder context) {
      this.context = Optional.of(context.build());
      return this;
    }
    /** @param location - The principal physical location where the dispense was performed. */
    public UKCore_MedicationDispenseBuilder.Impl withLocation(@NonNull Reference location) {
      this.location = Optional.of(location);
      return this;
    }

    public UKCore_MedicationDispenseBuilder.Impl withLocation(@NonNull ReferenceBuilder location) {
     ...
     *     professional.
     */
    public UKCore_MedicationDispenseBuilder.Impl withReceiver(@NonNull Reference... receiver) {
     ...
     *     professional.
     */
    public UKCore_MedicationDispenseBuilder.Impl withReceiver(
        @NonNull Collection<Reference> receiver) {
      this.receiver = Collections.unmodifiableCollection(receiver);
      return this;
    }

    public UKCore_MedicationDispenseBuilder.Impl withReceiver(
        @NonNull ReferenceBuilder... receiver) {
     ...
     */
    public UKCore_MedicationDispenseBuilder.Impl withDestination(@NonNull Reference destination) {
      this.destination = Optional.of(destination);
      return this;
    }

    public UKCore_MedicationDispenseBuilder.Impl withDestination(
     ...
     */
    public UKCore_MedicationDispenseBuilder.Impl withEventHistory(
     ...
     */
    public UKCore_MedicationDispenseBuilder.Impl withDetectedIssue(
    ...
    public UKCore_MedicationDispenseBuilder.Impl withPerformer(
     ...
     *     dispensed.
     */
    public UKCore_MedicationDispenseBuilder.Impl withSupportingInformation(
    ...
    public UKCore_MedicationDispenseBuilder.Impl withDosageInstruction(
     ...
     *     against.
     */
    public UKCore_MedicationDispenseBuilder.Impl withAuthorizingPrescription(
     ...
     */
    public UKCore_MedicationDispenseBuilder.Impl withSubstitution(
    ...
    public UKCore_MedicationDispenseBuilder.Impl withoutMeta() {
      this.meta = Optional.empty();
      return this;
    }

    public UKCore_MedicationDispense build() {
      return new UKCore_MedicationDispense(
