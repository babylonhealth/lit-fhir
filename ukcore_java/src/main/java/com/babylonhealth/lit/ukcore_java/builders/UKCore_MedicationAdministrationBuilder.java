...
public interface UKCore_MedicationAdministrationBuilder extends MedicationAdministrationBuilder {
  public UKCore_MedicationAdministration build();
  ...
  public static Impl init(
      ...
      Reference subject) {
    return new Impl(status, effective, medication, subject);
  }
  ...
  public static Impl builder(
    ...
    return new Impl(status, effective, medication, subject.build());
  }
  ...
  public class Impl implements UKCore_MedicationAdministrationBuilder {
    ...
    /**
     * Required fields for {@link UKCore_MedicationAdministration}
     *
     ...
     *     in, wrap with one of the UKCore_MedicationAdministrationBuilder.effective static methods
     ...
     *     one of the UKCore_MedicationAdministrationBuilder.medication static methods
     ...
     */
    public UKCore_MedicationAdministrationBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public UKCore_MedicationAdministrationBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public UKCore_MedicationAdministrationBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public UKCore_MedicationAdministrationBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public UKCore_MedicationAdministrationBuilder.Impl withText(@NonNull NarrativeBuilder text) {
      this.text = Optional.of(text.build());
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public UKCore_MedicationAdministrationBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public UKCore_MedicationAdministrationBuilder.Impl withCategory(
     ...
     */
    public UKCore_MedicationAdministrationBuilder.Impl withContained(
     ...
     */
    public UKCore_MedicationAdministrationBuilder.Impl withExtension(
    ...
    public UKCore_MedicationAdministrationBuilder.Impl withReasonCode(
     ...
     */
    public UKCore_MedicationAdministrationBuilder.Impl withInstantiates(
        @NonNull String... instantiates) {
    ...
    public UKCore_MedicationAdministrationBuilder.Impl withStatusReason(
     ...
     *     profiles etc.
     */
    public UKCore_MedicationAdministrationBuilder.Impl withImplicitRules(
     ...
     */
    public UKCore_MedicationAdministrationBuilder.Impl withNote(@NonNull Annotation... note) {
     ...
     *     the other attributes.
     */
    public UKCore_MedicationAdministrationBuilder.Impl withNote(
     ...
     */
    public UKCore_MedicationAdministrationBuilder.Impl withModifierExtension(
     ...
     */
    public UKCore_MedicationAdministrationBuilder.Impl withIdentifier(
     ...
     *     route, etc.
     */
    public UKCore_MedicationAdministrationBuilder.Impl withDosage(
    ...
    public UKCore_MedicationAdministrationBuilder.Impl withPartOf(@NonNull Reference... partOf) {
      this.partOf = Arrays.asList(partOf);
      return this;
    }
    /** @param partOf - A larger event of which this particular event is a component or step. */
    public UKCore_MedicationAdministrationBuilder.Impl withPartOf(
     ...
     */
    public UKCore_MedicationAdministrationBuilder.Impl withDevice(@NonNull Reference... device) {
     ...
     *     a particular infusion pump.
     */
    public UKCore_MedicationAdministrationBuilder.Impl withDevice(
     ...
     */
    public UKCore_MedicationAdministrationBuilder.Impl withContext(@NonNull Reference context) {
      this.context = Optional.of(context);
      return this;
    }

    public UKCore_MedicationAdministrationBuilder.Impl withContext(
        @NonNull ReferenceBuilder context) {
     ...
     *     administration.
     */
    public UKCore_MedicationAdministrationBuilder.Impl withRequest(@NonNull Reference request) {
      this.request = Optional.of(request);
      return this;
    }

    public UKCore_MedicationAdministrationBuilder.Impl withRequest(
     ...
     */
    public UKCore_MedicationAdministrationBuilder.Impl withEventHistory(
     ...
     *     were involved.
     */
    public UKCore_MedicationAdministrationBuilder.Impl withPerformer(
     ...
     *     administered.
     */
    public UKCore_MedicationAdministrationBuilder.Impl withReasonReference(
     ...
     */
    public UKCore_MedicationAdministrationBuilder.Impl withSupportingInformation(
    ...
    public UKCore_MedicationAdministrationBuilder.Impl withoutMeta() {
      this.meta = Optional.empty();
      return this;
    }

    public UKCore_MedicationAdministration build() {
      return new UKCore_MedicationAdministration(
