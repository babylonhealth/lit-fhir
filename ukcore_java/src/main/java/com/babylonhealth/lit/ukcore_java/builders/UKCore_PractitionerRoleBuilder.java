...
public interface UKCore_PractitionerRoleBuilder extends PractitionerRoleBuilder {
  public UKCore_PractitionerRole build();
  ...
  public class Impl implements UKCore_PractitionerRoleBuilder {
    private Optional<String> id = Optional.empty();
    private Optional<Meta> meta =
        Optional.of(
            MetaBuilder.init()
                .withProfile("https://fhir.hl7.org.uk/StructureDefinition/UKCore-PractitionerRole")
                .build());
    ...
    /** Required fields for {@link UKCore_PractitionerRole} */
    public Impl() {}
     ...
     */
    public UKCore_PractitionerRoleBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public UKCore_PractitionerRoleBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public UKCore_PractitionerRoleBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public UKCore_PractitionerRoleBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public UKCore_PractitionerRoleBuilder.Impl withText(@NonNull NarrativeBuilder text) {
     ...
     */
    public UKCore_PractitionerRoleBuilder.Impl withCode(@NonNull CodeableConcept... code) {
     ...
     * @param code - Roles which this practitioner is authorized to perform for the organization.
     */
    public UKCore_PractitionerRoleBuilder.Impl withCode(@NonNull Collection<CodeableConcept> code) {
      this.code = Collections.unmodifiableCollection(code);
      return this;
    }

    public UKCore_PractitionerRoleBuilder.Impl withCode(@NonNull CodeableConceptBuilder... code) {
    ...
    public UKCore_PractitionerRoleBuilder.Impl withActive(@NonNull Boolean active) {
     ...
     */
    public UKCore_PractitionerRoleBuilder.Impl withPeriod(@NonNull Period period) {
      this.period = Optional.of(period);
      return this;
    }

    public UKCore_PractitionerRoleBuilder.Impl withPeriod(@NonNull PeriodBuilder period) {
      this.period = Optional.of(period.build());
      return this;
    }
    /** @param telecom - Contact details that are specific to the role/location/service. */
    public UKCore_PractitionerRoleBuilder.Impl withTelecom(@NonNull ContactPoint... telecom) {
      this.telecom = Arrays.asList(telecom);
      return this;
    }
    /** @param telecom - Contact details that are specific to the role/location/service. */
    public UKCore_PractitionerRoleBuilder.Impl withTelecom(
    ...
    public UKCore_PractitionerRoleBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public UKCore_PractitionerRoleBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public UKCore_PractitionerRoleBuilder.Impl withContained(
     ...
     */
    public UKCore_PractitionerRoleBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public UKCore_PractitionerRoleBuilder.Impl withExtension(
    ...
    public UKCore_PractitionerRoleBuilder.Impl withSpecialty(
     ...
     *     profiles etc.
     */
    public UKCore_PractitionerRoleBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public UKCore_PractitionerRoleBuilder.Impl withModifierExtension(
    ...
    public UKCore_PractitionerRoleBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
      this.identifier = Arrays.asList(identifier);
      return this;
    }
    /** @param identifier - An identifier that applies to this person in this role. */
    public UKCore_PractitionerRoleBuilder.Impl withIdentifier(
     ...
     */
    public UKCore_PractitionerRoleBuilder.Impl withAvailabilityExceptions(
    ...
    public UKCore_PractitionerRoleBuilder.Impl withLocation(@NonNull Reference... location) {
      this.location = Arrays.asList(location);
      return this;
    }
    /** @param location - The location(s) at which this practitioner provides care. */
    public UKCore_PractitionerRoleBuilder.Impl withLocation(
        @NonNull Collection<Reference> location) {
      this.location = Collections.unmodifiableCollection(location);
      return this;
    }

    public UKCore_PractitionerRoleBuilder.Impl withLocation(@NonNull ReferenceBuilder... location) {
     ...
     */
    public UKCore_PractitionerRoleBuilder.Impl withEndpoint(@NonNull Reference... endpoint) {
     ...
     *     practitioner with this role.
     */
    public UKCore_PractitionerRoleBuilder.Impl withEndpoint(
        @NonNull Collection<Reference> endpoint) {
      this.endpoint = Collections.unmodifiableCollection(endpoint);
      return this;
    }

    public UKCore_PractitionerRoleBuilder.Impl withEndpoint(@NonNull ReferenceBuilder... endpoint) {
     ...
     */
    public UKCore_PractitionerRoleBuilder.Impl withNotAvailable(
     ...
     */
    public UKCore_PractitionerRoleBuilder.Impl withAvailableTime(
     ...
     *     organization.
     */
    public UKCore_PractitionerRoleBuilder.Impl withPractitioner(@NonNull Reference practitioner) {
      this.practitioner = Optional.of(practitioner);
      return this;
    }

    public UKCore_PractitionerRoleBuilder.Impl withPractitioner(
        @NonNull ReferenceBuilder practitioner) {
     ...
     */
    public UKCore_PractitionerRoleBuilder.Impl withOrganization(@NonNull Reference organization) {
      this.organization = Optional.of(organization);
      return this;
    }

    public UKCore_PractitionerRoleBuilder.Impl withOrganization(
     ...
     */
    public UKCore_PractitionerRoleBuilder.Impl withHealthcareService(
    ...
    public UKCore_PractitionerRoleBuilder.Impl withoutMeta() {
      this.meta = Optional.empty();
      return this;
    }

    public UKCore_PractitionerRole build() {
      return new UKCore_PractitionerRole(
