...
public interface UKCore_VitalSigns_ObservationBuilder extends UKCore_ObservationBuilder {
  public UKCore_VitalSigns_Observation build();
  ...
  public class Impl implements UKCore_VitalSigns_ObservationBuilder {
    private Optional<String> id = Optional.empty();
    private Optional<Meta> meta =
        Optional.of(
            MetaBuilder.init()
                .withProfile(
                    "https://fhir.hl7.org.uk/StructureDefinition/UKCore-VitalSigns-Observation")
                .build());
    ...
    /**
     * Required fields for {@link UKCore_VitalSigns_Observation}
     *
     ...
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public UKCore_VitalSigns_ObservationBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public UKCore_VitalSigns_ObservationBuilder.Impl withText(@NonNull NarrativeBuilder text) {
     ...
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withIssued(@NonNull ZonedDateTime issued) {
      this.issued = Optional.of(issued);
      return this;
    }
    /** @param method - Indicates the mechanism used to perform the observation. */
    public UKCore_VitalSigns_ObservationBuilder.Impl withMethod(@NonNull CodeableConcept method) {
      this.method = Optional.of(method);
      return this;
    }

    public UKCore_VitalSigns_ObservationBuilder.Impl withMethod(
        @NonNull CodeableConceptBuilder method) {
      this.method = Optional.of(method.build());
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public UKCore_VitalSigns_ObservationBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
      this.language = Optional.of(language);
      return this;
    }
    /** @param category - A code that classifies the general type of observation being made. */
    public UKCore_VitalSigns_ObservationBuilder.Impl withCategory(
     ...
     *     UKCore_VitalSigns_ObservationBuilder.value static methods
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withValue(@NonNull Choice02118820890 value) {
     ...
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withContained(
     ...
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withExtension(
     ...
     *     UKCore_VitalSigns_ObservationBuilder.effective static methods
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withEffective(
        @NonNull Choice00107722725 effective) {
     ...
     *     profiles etc.
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withImplicitRules(
     ...
     *     low, normal.
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withInterpretation(
    ...
    public UKCore_VitalSigns_ObservationBuilder.Impl withNote(@NonNull Annotation... note) {
      this.note = Arrays.asList(note);
      return this;
    }
    /** @param note - Comments about the observation or the results. */
    public UKCore_VitalSigns_ObservationBuilder.Impl withNote(
        @NonNull Collection<Annotation> note) {
      this.note = Collections.unmodifiableCollection(note);
      return this;
    }

    public UKCore_VitalSigns_ObservationBuilder.Impl withNote(@NonNull AnnotationBuilder... note) {
     ...
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withDataAbsentReason(
     ...
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withModifierExtension(
     ...
     *     (i.e. the target site).
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withBodySite(
     ...
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withFocus(@NonNull Reference... focus) {
     ...
     *     is the patient of record and the mother is the focus.
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withFocus(
        @NonNull Collection<Reference> focus) {
      this.focus = Collections.unmodifiableCollection(focus);
      return this;
    }

    public UKCore_VitalSigns_ObservationBuilder.Impl withFocus(@NonNull ReferenceBuilder... focus) {
     ...
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withPartOf(@NonNull Reference... partOf) {
     ...
     *     For example, an observation as part of a procedure.
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withPartOf(
    ...
    public UKCore_VitalSigns_ObservationBuilder.Impl withDevice(@NonNull Reference device) {
      this.device = Optional.of(device);
      return this;
    }

    public UKCore_VitalSigns_ObservationBuilder.Impl withDevice(@NonNull ReferenceBuilder device) {
     ...
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withComponent(
     ...
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withBasedOn(@NonNull Reference... basedOn) {
     ...
     *     performed before it is dispensed.
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withBasedOn(
     ...
     *     observation.
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withSubject(@NonNull Reference subject) {
      this.subject = Optional.of(subject);
      return this;
    }

    public UKCore_VitalSigns_ObservationBuilder.Impl withSubject(
    ...
    public UKCore_VitalSigns_ObservationBuilder.Impl withSpecimen(@NonNull Reference specimen) {
      this.specimen = Optional.of(specimen);
      return this;
    }

    public UKCore_VitalSigns_ObservationBuilder.Impl withSpecimen(
     ...
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withEncounter(@NonNull Reference encounter) {
      this.encounter = Optional.of(encounter);
      return this;
    }

    public UKCore_VitalSigns_ObservationBuilder.Impl withEncounter(
        @NonNull ReferenceBuilder encounter) {
      this.encounter = Optional.of(encounter.build());
      return this;
    }
    /** @param performer - Who was responsible for asserting the observed value as "true". */
    public UKCore_VitalSigns_ObservationBuilder.Impl withPerformer(
     ...
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withHasMember(
        @NonNull Reference... hasMember) {
     ...
     *     used.
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withReferenceRange(
     ...
     */
    public UKCore_VitalSigns_ObservationBuilder.Impl withDerivedFrom(
        @NonNull Reference... derivedFrom) {
    ...
    public UKCore_VitalSigns_ObservationBuilder.Impl withIdentifier(
    ...
    public UKCore_VitalSigns_ObservationBuilder.Impl withoutMeta() {
      this.meta = Optional.empty();
      return this;
    }

    public UKCore_VitalSigns_Observation build() {
      return new UKCore_VitalSigns_Observation(
