...
public interface UKCore_ServiceRequestBuilder extends ServiceRequestBuilder {
  public UKCore_ServiceRequest build();
  ...
  public class Impl implements UKCore_ServiceRequestBuilder {
    private Optional<String> id = Optional.empty();
    private Optional<Meta> meta =
        Optional.of(
            MetaBuilder.init()
                .withProfile("https://fhir.hl7.org.uk/StructureDefinition/UKCore-ServiceRequest")
                .build());
    ...
    /**
     * Required fields for {@link UKCore_ServiceRequest}
     *
     ...
     */
    public UKCore_ServiceRequestBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public UKCore_ServiceRequestBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public UKCore_ServiceRequestBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public UKCore_ServiceRequestBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public UKCore_ServiceRequestBuilder.Impl withText(@NonNull NarrativeBuilder text) {
     ...
     */
    public UKCore_ServiceRequestBuilder.Impl withCode(@NonNull CodeableConcept code) {
      this.code = Optional.of(code);
      return this;
    }

    public UKCore_ServiceRequestBuilder.Impl withCode(@NonNull CodeableConceptBuilder code) {
     ...
     */
    public UKCore_ServiceRequestBuilder.Impl withNote(@NonNull Annotation... note) {
     ...
     *     internal billing notes.
     */
    public UKCore_ServiceRequestBuilder.Impl withNote(@NonNull Collection<Annotation> note) {
      this.note = Collections.unmodifiableCollection(note);
      return this;
    }

    public UKCore_ServiceRequestBuilder.Impl withNote(@NonNull AnnotationBuilder... note) {
      this.note = Arrays.stream(note).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public UKCore_ServiceRequestBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public UKCore_ServiceRequestBuilder.Impl withCategory(@NonNull CodeableConcept... category) {
     ...
     *     purposes (e.g. "Surgical Procedure").
     */
    public UKCore_ServiceRequestBuilder.Impl withCategory(
     ...
     *     to other requests.
     */
    public UKCore_ServiceRequestBuilder.Impl withPriority(@NonNull REQUEST_PRIORITY priority) {
     ...
     *     target site.
     */
    public UKCore_ServiceRequestBuilder.Impl withBodySite(@NonNull CodeableConcept... bodySite) {
     ...
     *     target site.
     */
    public UKCore_ServiceRequestBuilder.Impl withBodySite(
     ...
     */
    public UKCore_ServiceRequestBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public UKCore_ServiceRequestBuilder.Impl withContained(
        @NonNull Collection<Resource> contained) {
      this.contained = Collections.unmodifiableCollection(contained);
      return this;
    }

    public UKCore_ServiceRequestBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public UKCore_ServiceRequestBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public UKCore_ServiceRequestBuilder.Impl withExtension(
        @NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public UKCore_ServiceRequestBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
      this.extension = Arrays.stream(extension).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param authoredOn - When the request transitioned to being actionable. */
    public UKCore_ServiceRequestBuilder.Impl withAuthoredOn(@NonNull FHIRDateTime authoredOn) {
     ...
     */
    public UKCore_ServiceRequestBuilder.Impl withReasonCode(
     ...
     */
    public UKCore_ServiceRequestBuilder.Impl withOrderDetail(
     ...
     *     UKCore_ServiceRequestBuilder.quantity static methods
     */
    public UKCore_ServiceRequestBuilder.Impl withQuantity(
     ...
     *     one of the UKCore_ServiceRequestBuilder.asNeeded static methods
     */
    public UKCore_ServiceRequestBuilder.Impl withAsNeeded(
     ...
     */
    public UKCore_ServiceRequestBuilder.Impl withDoNotPerform(@NonNull Boolean doNotPerform) {
     ...
     */
    public UKCore_ServiceRequestBuilder.Impl withLocationCode(
     ...
     *     profiles etc.
     */
    public UKCore_ServiceRequestBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     *     wrap with one of the UKCore_ServiceRequestBuilder.occurrence static methods
     */
    public UKCore_ServiceRequestBuilder.Impl withOccurrence(
    ...
    public UKCore_ServiceRequestBuilder.Impl withPerformerType(
     ...
     *     ServiceRequest.
     */
    public UKCore_ServiceRequestBuilder.Impl withInstantiatesUri(
     ...
     */
    public UKCore_ServiceRequestBuilder.Impl withModifierExtension(
     ...
     *     consumer.
     */
    public UKCore_ServiceRequestBuilder.Impl withPatientInstruction(
     ...
     */
    public UKCore_ServiceRequestBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     *     receiver and/or order fulfiller.
     */
    public UKCore_ServiceRequestBuilder.Impl withIdentifier(
     ...
     *     ServiceRequest.
     */
    public UKCore_ServiceRequestBuilder.Impl withInstantiatesCanonical(
     ...
     *     identifier.
     */
    public UKCore_ServiceRequestBuilder.Impl withRequisition(@NonNull Identifier requisition) {
      this.requisition = Optional.of(requisition);
      return this;
    }

    public UKCore_ServiceRequestBuilder.Impl withRequisition(
    ...
    public UKCore_ServiceRequestBuilder.Impl withBasedOn(@NonNull Reference... basedOn) {
      this.basedOn = Arrays.asList(basedOn);
      return this;
    }
    /** @param basedOn - Plan/proposal/order fulfilled by this request. */
    public UKCore_ServiceRequestBuilder.Impl withBasedOn(@NonNull Collection<Reference> basedOn) {
      this.basedOn = Collections.unmodifiableCollection(basedOn);
      return this;
    }

    public UKCore_ServiceRequestBuilder.Impl withBasedOn(@NonNull ReferenceBuilder... basedOn) {
     ...
     *     request(s).
     */
    public UKCore_ServiceRequestBuilder.Impl withReplaces(@NonNull Reference... replaces) {
     ...
     *     request(s).
     */
    public UKCore_ServiceRequestBuilder.Impl withReplaces(@NonNull Collection<Reference> replaces) {
      this.replaces = Collections.unmodifiableCollection(replaces);
      return this;
    }

    public UKCore_ServiceRequestBuilder.Impl withReplaces(@NonNull ReferenceBuilder... replaces) {
    ...
    public UKCore_ServiceRequestBuilder.Impl withSpecimen(@NonNull Reference... specimen) {
      this.specimen = Arrays.asList(specimen);
      return this;
    }
    /** @param specimen - One or more specimens that the laboratory procedure will use. */
    public UKCore_ServiceRequestBuilder.Impl withSpecimen(@NonNull Collection<Reference> specimen) {
      this.specimen = Collections.unmodifiableCollection(specimen);
      return this;
    }

    public UKCore_ServiceRequestBuilder.Impl withSpecimen(@NonNull ReferenceBuilder... specimen) {
     ...
     */
    public UKCore_ServiceRequestBuilder.Impl withEncounter(@NonNull Reference encounter) {
      this.encounter = Optional.of(encounter);
      return this;
    }

    public UKCore_ServiceRequestBuilder.Impl withEncounter(@NonNull ReferenceBuilder encounter) {
     ...
     *     activation.
     */
    public UKCore_ServiceRequestBuilder.Impl withRequester(@NonNull Reference requester) {
      this.requester = Optional.of(requester);
      return this;
    }

    public UKCore_ServiceRequestBuilder.Impl withRequester(@NonNull ReferenceBuilder requester) {
     ...
     */
    public UKCore_ServiceRequestBuilder.Impl withPerformer(@NonNull Reference... performer) {
     ...
     *     surgeon, dermatopathologist, endoscopist, etc.
     */
    public UKCore_ServiceRequestBuilder.Impl withPerformer(
        @NonNull Collection<Reference> performer) {
      this.performer = Collections.unmodifiableCollection(performer);
      return this;
    }

    public UKCore_ServiceRequestBuilder.Impl withPerformer(@NonNull ReferenceBuilder... performer) {
     ...
     */
    public UKCore_ServiceRequestBuilder.Impl withInsurance(@NonNull Reference... insurance) {
     ...
     *     pre-determinations that may be needed for delivering the requested service.
     */
    public UKCore_ServiceRequestBuilder.Impl withInsurance(
        @NonNull Collection<Reference> insurance) {
      this.insurance = Collections.unmodifiableCollection(insurance);
      return this;
    }

    public UKCore_ServiceRequestBuilder.Impl withInsurance(@NonNull ReferenceBuilder... insurance) {
     ...
     */
    public UKCore_ServiceRequestBuilder.Impl withSupportingInfo(
     ...
     *     `supportingInfo`.
     */
    public UKCore_ServiceRequestBuilder.Impl withReasonReference(
    ...
    public UKCore_ServiceRequestBuilder.Impl withRelevantHistory(
     ...
     */
    public UKCore_ServiceRequestBuilder.Impl withLocationReference(
    ...
    public UKCore_ServiceRequestBuilder.Impl withoutMeta() {
      this.meta = Optional.empty();
      return this;
    }

    public UKCore_ServiceRequest build() {
      return new UKCore_ServiceRequest(
