...
public interface UKCore_PatientBuilder extends PatientBuilder {
  public UKCore_Patient build();
  ...
  public class Impl implements UKCore_PatientBuilder {
    private Optional<String> id = Optional.empty();
    private Optional<Meta> meta =
        Optional.of(
            MetaBuilder.init()
                .withProfile("https://fhir.hl7.org.uk/StructureDefinition/UKCore-Patient")
                .build());
    ...
    /** Required fields for {@link UKCore_Patient} */
    public Impl() {}
     ...
     */
    public UKCore_PatientBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public UKCore_PatientBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public UKCore_PatientBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public UKCore_PatientBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public UKCore_PatientBuilder.Impl withText(@NonNull NarrativeBuilder text) {
      this.text = Optional.of(text.build());
      return this;
    }
    /** @param name - A name associated with the individual. */
    public UKCore_PatientBuilder.Impl withName(@NonNull HumanName... name) {
      this.name = Arrays.asList(name);
      return this;
    }
    /** @param name - A name associated with the individual. */
    public UKCore_PatientBuilder.Impl withName(@NonNull Collection<HumanName> name) {
      this.name = Collections.unmodifiableCollection(name);
      return this;
    }

    public UKCore_PatientBuilder.Impl withName(@NonNull HumanNameBuilder... name) {
      this.name = Arrays.stream(name).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param photo - Image of the patient. */
    public UKCore_PatientBuilder.Impl withPhoto(@NonNull Attachment... photo) {
      this.photo = Arrays.asList(photo);
      return this;
    }
    /** @param photo - Image of the patient. */
    public UKCore_PatientBuilder.Impl withPhoto(@NonNull Collection<Attachment> photo) {
      this.photo = Collections.unmodifiableCollection(photo);
      return this;
    }

    public UKCore_PatientBuilder.Impl withPhoto(@NonNull AttachmentBuilder... photo) {
     ...
     */
    public UKCore_PatientBuilder.Impl withActive(@NonNull Boolean active) {
     ...
     */
    public UKCore_PatientBuilder.Impl withGender(@NonNull ADMINISTRATIVE_GENDER gender) {
      this.gender = Optional.of(gender);
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public UKCore_PatientBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public UKCore_PatientBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public UKCore_PatientBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
      this.contained = Collections.unmodifiableCollection(contained);
      return this;
    }

    public UKCore_PatientBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public UKCore_PatientBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public UKCore_PatientBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public UKCore_PatientBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
      this.extension = Arrays.stream(extension).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param identifier - An identifier for this patient. */
    public UKCore_PatientBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
      this.identifier = Arrays.asList(identifier);
      return this;
    }
    /** @param identifier - An identifier for this patient. */
    public UKCore_PatientBuilder.Impl withIdentifier(@NonNull Collection<Identifier> identifier) {
      this.identifier = Collections.unmodifiableCollection(identifier);
      return this;
    }

    public UKCore_PatientBuilder.Impl withIdentifier(@NonNull IdentifierBuilder... identifier) {
     ...
     *     UKCore_PatientBuilder.deceased static methods
     */
    public UKCore_PatientBuilder.Impl withDeceased(@NonNull ChoiceBooleanOrDateTime deceased) {
     ...
     *     profiles etc.
     */
    public UKCore_PatientBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public UKCore_PatientBuilder.Impl withMaritalStatus(@NonNull CodeableConcept maritalStatus) {
      this.maritalStatus = Optional.of(maritalStatus);
      return this;
    }

    public UKCore_PatientBuilder.Impl withMaritalStatus(
     ...
     *     UKCore_PatientBuilder.multipleBirth static methods
     */
    public UKCore_PatientBuilder.Impl withMultipleBirth(
     ...
     */
    public UKCore_PatientBuilder.Impl withModifierExtension(
    ...
    public UKCore_PatientBuilder.Impl withAddress(@NonNull Address... address) {
      this.address = Arrays.asList(address);
      return this;
    }
    /** @param address - An address for the individual */
    public UKCore_PatientBuilder.Impl withAddress(@NonNull Collection<Address> address) {
      this.address = Collections.unmodifiableCollection(address);
      return this;
    }

    public UKCore_PatientBuilder.Impl withAddress(@NonNull AddressBuilder... address) {
      this.address = Arrays.stream(address).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param birthDate - The date of birth for the individual. */
    public UKCore_PatientBuilder.Impl withBirthDate(@NonNull FHIRDate birthDate) {
     ...
     */
    public UKCore_PatientBuilder.Impl withTelecom(@NonNull ContactPoint... telecom) {
     ...
     *     individual may be contacted.
     */
    public UKCore_PatientBuilder.Impl withTelecom(@NonNull Collection<ContactPoint> telecom) {
      this.telecom = Collections.unmodifiableCollection(telecom);
      return this;
    }

    public UKCore_PatientBuilder.Impl withTelecom(@NonNull ContactPointBuilder... telecom) {
     ...
     *     or her health.
     */
    public UKCore_PatientBuilder.Impl withCommunication(
    ...
    public UKCore_PatientBuilder.Impl withLink(@NonNull Patient.Link... link) {
      this.link = Arrays.asList(link);
      return this;
    }
    /** @param link - Link to another patient resource that concerns the same actual patient. */
    public UKCore_PatientBuilder.Impl withLink(@NonNull Collection<Patient.Link> link) {
      this.link = Collections.unmodifiableCollection(link);
      return this;
    }

    public UKCore_PatientBuilder.Impl withLink(@NonNull Patient_LinkBuilder... link) {
      this.link = Arrays.stream(link).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param generalPractitioner - Patient's nominated care provider. */
    public UKCore_PatientBuilder.Impl withGeneralPractitioner(
    ...
    public UKCore_PatientBuilder.Impl withContact(@NonNull Patient.Contact... contact) {
      this.contact = Arrays.asList(contact);
      return this;
    }
    /** @param contact - A contact party (e.g. guardian, partner, friend) for the patient. */
    public UKCore_PatientBuilder.Impl withContact(@NonNull Collection<Patient.Contact> contact) {
      this.contact = Collections.unmodifiableCollection(contact);
      return this;
    }

    public UKCore_PatientBuilder.Impl withContact(@NonNull Patient_ContactBuilder... contact) {
      this.contact = Arrays.stream(contact).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param managingOrganization - Organization that is the custodian of the patient record. */
    public UKCore_PatientBuilder.Impl withManagingOrganization(
    ...
    public UKCore_PatientBuilder.Impl withoutMeta() {
      this.meta = Optional.empty();
      return this;
    }

    public UKCore_Patient build() {
      return new UKCore_Patient(
