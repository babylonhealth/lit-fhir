...
public interface UKCore_DiagnosticReportBuilder extends DiagnosticReportBuilder {
  public UKCore_DiagnosticReport build();

  public static Impl init(DIAGNOSTIC_REPORT_STATUS status, CodeableConcept code) {
    return new Impl(status, code);
  }

  public static Impl builder(DIAGNOSTIC_REPORT_STATUS status, CodeableConceptBuilder code) {
  ...
  public class Impl implements UKCore_DiagnosticReportBuilder {
    private Optional<String> id = Optional.empty();
    private Optional<Meta> meta =
        Optional.of(
            MetaBuilder.init()
                .withProfile("https://fhir.hl7.org.uk/StructureDefinition/UKCore-DiagnosticReport")
                .build());
    ...
    /**
     * Required fields for {@link UKCore_DiagnosticReport}
     *
     * @param status - The status of the diagnostic report.
     * @param code - A code or name that describes this diagnostic report.
     */
    public Impl(DIAGNOSTIC_REPORT_STATUS status, CodeableConcept code) {
      this.status = status;
      this.code = code;
    }
     ...
     */
    public UKCore_DiagnosticReportBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public UKCore_DiagnosticReportBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public UKCore_DiagnosticReportBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public UKCore_DiagnosticReportBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public UKCore_DiagnosticReportBuilder.Impl withText(@NonNull NarrativeBuilder text) {
     ...
     */
    public UKCore_DiagnosticReportBuilder.Impl withIssued(@NonNull ZonedDateTime issued) {
      this.issued = Optional.of(issued);
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public UKCore_DiagnosticReportBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public UKCore_DiagnosticReportBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public UKCore_DiagnosticReportBuilder.Impl withContained(
     ...
     */
    public UKCore_DiagnosticReportBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public UKCore_DiagnosticReportBuilder.Impl withExtension(
     ...
     */
    public UKCore_DiagnosticReportBuilder.Impl withConclusion(@NonNull String conclusion) {
     ...
     *     UKCore_DiagnosticReportBuilder.effective static methods
     */
    public UKCore_DiagnosticReportBuilder.Impl withEffective(
     ...
     *     profiles etc.
     */
    public UKCore_DiagnosticReportBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     *     equivalent.
     */
    public UKCore_DiagnosticReportBuilder.Impl withPresentedForm(
     ...
     */
    public UKCore_DiagnosticReportBuilder.Impl withModifierExtension(
     ...
     */
    public UKCore_DiagnosticReportBuilder.Impl withCategory(@NonNull CodeableConcept... category) {
     ...
     *     used for searching, sorting and display purposes.
     */
    public UKCore_DiagnosticReportBuilder.Impl withCategory(
     ...
     */
    public UKCore_DiagnosticReportBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     * @param identifier - Identifiers assigned to this report by the performer or other systems.
     */
    public UKCore_DiagnosticReportBuilder.Impl withIdentifier(
     ...
     *     (interpretation/impression) of the diagnostic report.
     */
    public UKCore_DiagnosticReportBuilder.Impl withConclusionCode(
    ...
    public UKCore_DiagnosticReportBuilder.Impl withResult(@NonNull Reference... result) {
      this.result = Arrays.asList(result);
      return this;
    }
    /** @param result - [Observations](observation.html) that are part of this diagnostic report. */
    public UKCore_DiagnosticReportBuilder.Impl withResult(@NonNull Collection<Reference> result) {
      this.result = Collections.unmodifiableCollection(result);
      return this;
    }

    public UKCore_DiagnosticReportBuilder.Impl withResult(@NonNull ReferenceBuilder... result) {
      this.result = Arrays.stream(result).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param basedOn - Details concerning a service requested. */
    public UKCore_DiagnosticReportBuilder.Impl withBasedOn(@NonNull Reference... basedOn) {
      this.basedOn = Arrays.asList(basedOn);
      return this;
    }
    /** @param basedOn - Details concerning a service requested. */
    public UKCore_DiagnosticReportBuilder.Impl withBasedOn(@NonNull Collection<Reference> basedOn) {
      this.basedOn = Collections.unmodifiableCollection(basedOn);
      return this;
    }

    public UKCore_DiagnosticReportBuilder.Impl withBasedOn(@NonNull ReferenceBuilder... basedOn) {
     ...
     *     of other sources.
     */
    public UKCore_DiagnosticReportBuilder.Impl withSubject(@NonNull Reference subject) {
      this.subject = Optional.of(subject);
      return this;
    }

    public UKCore_DiagnosticReportBuilder.Impl withSubject(@NonNull ReferenceBuilder subject) {
    ...
    public UKCore_DiagnosticReportBuilder.Impl withSpecimen(@NonNull Reference... specimen) {
      this.specimen = Arrays.asList(specimen);
      return this;
    }
    /** @param specimen - Details about the specimens on which this diagnostic report is based. */
    public UKCore_DiagnosticReportBuilder.Impl withSpecimen(
        @NonNull Collection<Reference> specimen) {
      this.specimen = Collections.unmodifiableCollection(specimen);
      return this;
    }

    public UKCore_DiagnosticReportBuilder.Impl withSpecimen(@NonNull ReferenceBuilder... specimen) {
     ...
     */
    public UKCore_DiagnosticReportBuilder.Impl withEncounter(@NonNull Reference encounter) {
      this.encounter = Optional.of(encounter);
      return this;
    }

    public UKCore_DiagnosticReportBuilder.Impl withEncounter(@NonNull ReferenceBuilder encounter) {
      this.encounter = Optional.of(encounter.build());
      return this;
    }
    /** @param performer - The diagnostic service that is responsible for issuing the report. */
    public UKCore_DiagnosticReportBuilder.Impl withPerformer(@NonNull Reference... performer) {
      this.performer = Arrays.asList(performer);
      return this;
    }
    /** @param performer - The diagnostic service that is responsible for issuing the report. */
    public UKCore_DiagnosticReportBuilder.Impl withPerformer(
     ...
     */
    public UKCore_DiagnosticReportBuilder.Impl withMedia(@NonNull DiagnosticReport.Media... media) {
     ...
     *     specimens (i.e. slides of interest).
     */
    public UKCore_DiagnosticReportBuilder.Impl withMedia(
     ...
     */
    public UKCore_DiagnosticReportBuilder.Impl withImagingStudy(
     ...
     */
    public UKCore_DiagnosticReportBuilder.Impl withResultsInterpreter(
    ...
    public UKCore_DiagnosticReportBuilder.Impl withoutMeta() {
      this.meta = Optional.empty();
      return this;
    }

    public UKCore_DiagnosticReport build() {
      return new UKCore_DiagnosticReport(
