...
public interface UKCore_CommunicationBuilder extends CommunicationBuilder {
  public UKCore_Communication build();
  ...
  public class Impl implements UKCore_CommunicationBuilder {
    private Optional<String> id = Optional.empty();
    private Optional<Meta> meta =
        Optional.of(
            MetaBuilder.init()
                .withProfile("https://fhir.hl7.org.uk/StructureDefinition/UKCore-Communication")
                .build());
    ...
    /**
     * Required fields for {@link UKCore_Communication}
     *
     ...
     */
    public UKCore_CommunicationBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public UKCore_CommunicationBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public UKCore_CommunicationBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public UKCore_CommunicationBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public UKCore_CommunicationBuilder.Impl withText(@NonNull NarrativeBuilder text) {
      this.text = Optional.of(text.build());
      return this;
    }
    /** @param sent - The time when this communication was sent. */
    public UKCore_CommunicationBuilder.Impl withSent(@NonNull FHIRDateTime sent) {
      this.sent = Optional.of(sent);
      return this;
    }
    /** @param topic - Description of the purpose/content, similar to a subject line in an email. */
    public UKCore_CommunicationBuilder.Impl withTopic(@NonNull CodeableConcept topic) {
      this.topic = Optional.of(topic);
      return this;
    }

    public UKCore_CommunicationBuilder.Impl withTopic(@NonNull CodeableConceptBuilder topic) {
      this.topic = Optional.of(topic.build());
      return this;
    }
    /** @param medium - A channel that was used for this communication (e.g. email, fax). */
    public UKCore_CommunicationBuilder.Impl withMedium(@NonNull CodeableConcept... medium) {
      this.medium = Arrays.asList(medium);
      return this;
    }
    /** @param medium - A channel that was used for this communication (e.g. email, fax). */
    public UKCore_CommunicationBuilder.Impl withMedium(
        @NonNull Collection<CodeableConcept> medium) {
      this.medium = Collections.unmodifiableCollection(medium);
      return this;
    }

    public UKCore_CommunicationBuilder.Impl withMedium(@NonNull CodeableConceptBuilder... medium) {
      this.medium = Arrays.stream(medium).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public UKCore_CommunicationBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     *     instruction, etc.
     */
    public UKCore_CommunicationBuilder.Impl withCategory(@NonNull CodeableConcept... category) {
     ...
     *     instruction, etc.
     */
    public UKCore_CommunicationBuilder.Impl withCategory(
     ...
     */
    public UKCore_CommunicationBuilder.Impl withPriority(@NonNull REQUEST_PRIORITY priority) {
      this.priority = Optional.of(priority);
      return this;
    }
    /** @param received - The time when this communication arrived at the destination. */
    public UKCore_CommunicationBuilder.Impl withReceived(@NonNull FHIRDateTime received) {
     ...
     */
    public UKCore_CommunicationBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public UKCore_CommunicationBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
      this.contained = Collections.unmodifiableCollection(contained);
      return this;
    }

    public UKCore_CommunicationBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public UKCore_CommunicationBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public UKCore_CommunicationBuilder.Impl withExtension(
        @NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public UKCore_CommunicationBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
      this.extension = Arrays.stream(extension).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param reasonCode - The reason or justification for the communication. */
    public UKCore_CommunicationBuilder.Impl withReasonCode(@NonNull CodeableConcept... reasonCode) {
      this.reasonCode = Arrays.asList(reasonCode);
      return this;
    }
    /** @param reasonCode - The reason or justification for the communication. */
    public UKCore_CommunicationBuilder.Impl withReasonCode(
    ...
    public UKCore_CommunicationBuilder.Impl withStatusReason(
     ...
     *     profiles etc.
     */
    public UKCore_CommunicationBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public UKCore_CommunicationBuilder.Impl withNote(@NonNull Annotation... note) {
     ...
     *     or other interested parties.
     */
    public UKCore_CommunicationBuilder.Impl withNote(@NonNull Collection<Annotation> note) {
      this.note = Collections.unmodifiableCollection(note);
      return this;
    }

    public UKCore_CommunicationBuilder.Impl withNote(@NonNull AnnotationBuilder... note) {
     ...
     *     Communication.
     */
    public UKCore_CommunicationBuilder.Impl withInstantiatesUri(
     ...
     */
    public UKCore_CommunicationBuilder.Impl withModifierExtension(
     ...
     *     to server.
     */
    public UKCore_CommunicationBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     *     to server.
     */
    public UKCore_CommunicationBuilder.Impl withIdentifier(
     ...
     *     Communication.
     */
    public UKCore_CommunicationBuilder.Impl withInstantiatesCanonical(
     ...
     */
    public UKCore_CommunicationBuilder.Impl withPayload(@NonNull Communication.Payload... payload) {
     ...
     * @param payload - Text, attachment(s), or resource(s) that was communicated to the recipient.
     */
    public UKCore_CommunicationBuilder.Impl withPayload(
    ...
    public UKCore_CommunicationBuilder.Impl withPayload(
        @NonNull Communication_PayloadBuilder... payload) {
     ...
     */
    public UKCore_CommunicationBuilder.Impl withAbout(@NonNull Reference... about) {
     ...
     *     communication should be associated.
     */
    public UKCore_CommunicationBuilder.Impl withAbout(@NonNull Collection<Reference> about) {
      this.about = Collections.unmodifiableCollection(about);
      return this;
    }

    public UKCore_CommunicationBuilder.Impl withAbout(@NonNull ReferenceBuilder... about) {
      this.about = Arrays.stream(about).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param partOf - Part of this action. */
    public UKCore_CommunicationBuilder.Impl withPartOf(@NonNull Reference... partOf) {
      this.partOf = Arrays.asList(partOf);
      return this;
    }
    /** @param partOf - Part of this action. */
    public UKCore_CommunicationBuilder.Impl withPartOf(@NonNull Collection<Reference> partOf) {
      this.partOf = Collections.unmodifiableCollection(partOf);
      return this;
    }

    public UKCore_CommunicationBuilder.Impl withPartOf(@NonNull ReferenceBuilder... partOf) {
     ...
     */
    public UKCore_CommunicationBuilder.Impl withSender(@NonNull Reference sender) {
      this.sender = Optional.of(sender);
      return this;
    }

    public UKCore_CommunicationBuilder.Impl withSender(@NonNull ReferenceBuilder sender) {
     ...
     *     Communication.
     */
    public UKCore_CommunicationBuilder.Impl withBasedOn(@NonNull Reference... basedOn) {
     ...
     *     Communication.
     */
    public UKCore_CommunicationBuilder.Impl withBasedOn(@NonNull Collection<Reference> basedOn) {
      this.basedOn = Collections.unmodifiableCollection(basedOn);
      return this;
    }

    public UKCore_CommunicationBuilder.Impl withBasedOn(@NonNull ReferenceBuilder... basedOn) {
      this.basedOn = Arrays.stream(basedOn).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param subject - The patient or group that was the focus of this communication. */
    public UKCore_CommunicationBuilder.Impl withSubject(@NonNull Reference subject) {
      this.subject = Optional.of(subject);
      return this;
    }

    public UKCore_CommunicationBuilder.Impl withSubject(@NonNull ReferenceBuilder subject) {
     ...
     */
    public UKCore_CommunicationBuilder.Impl withEncounter(@NonNull Reference encounter) {
      this.encounter = Optional.of(encounter);
      return this;
    }

    public UKCore_CommunicationBuilder.Impl withEncounter(@NonNull ReferenceBuilder encounter) {
     ...
     */
    public UKCore_CommunicationBuilder.Impl withRecipient(@NonNull Reference... recipient) {
     ...
     *     confirmed received by a particular time).
     */
    public UKCore_CommunicationBuilder.Impl withRecipient(
        @NonNull Collection<Reference> recipient) {
      this.recipient = Collections.unmodifiableCollection(recipient);
      return this;
    }

    public UKCore_CommunicationBuilder.Impl withRecipient(@NonNull ReferenceBuilder... recipient) {
    ...
    public UKCore_CommunicationBuilder.Impl withInResponseTo(@NonNull Reference... inResponseTo) {
      this.inResponseTo = Arrays.asList(inResponseTo);
      return this;
    }
    /** @param inResponseTo - Prior communication that this communication is in response to. */
    public UKCore_CommunicationBuilder.Impl withInResponseTo(
        @NonNull Collection<Reference> inResponseTo) {
      this.inResponseTo = Collections.unmodifiableCollection(inResponseTo);
      return this;
    }

    public UKCore_CommunicationBuilder.Impl withInResponseTo(
        @NonNull ReferenceBuilder... inResponseTo) {
     ...
     *     communication.
     */
    public UKCore_CommunicationBuilder.Impl withReasonReference(
    ...
    public UKCore_CommunicationBuilder.Impl withoutMeta() {
      this.meta = Optional.empty();
      return this;
    }

    public UKCore_Communication build() {
      return new UKCore_Communication(
