...
public interface UKCore_MedicationStatementBuilder extends MedicationStatementBuilder {
  public UKCore_MedicationStatement build();

  public static Impl init(
      MEDICATION_STATEMENT_STATUS status,
      @NonNull ChoiceCodeableConceptOrReference medication,
      Reference subject) {
    return new Impl(status, medication, subject);
  }
  ...
  public static Impl builder(
    ...
    return new Impl(status, medication, subject.build());
  }
  ...
  public class Impl implements UKCore_MedicationStatementBuilder {
    ...
    /**
     * Required fields for {@link UKCore_MedicationStatement}
     *
     ...
     *     one of the UKCore_MedicationStatementBuilder.medication static methods
     ...
     */
    public UKCore_MedicationStatementBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public UKCore_MedicationStatementBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public UKCore_MedicationStatementBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public UKCore_MedicationStatementBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public UKCore_MedicationStatementBuilder.Impl withText(@NonNull NarrativeBuilder text) {
      this.text = Optional.of(text.build());
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public UKCore_MedicationStatementBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public UKCore_MedicationStatementBuilder.Impl withCategory(@NonNull CodeableConcept category) {
      this.category = Optional.of(category);
      return this;
    }

    public UKCore_MedicationStatementBuilder.Impl withCategory(
     ...
     */
    public UKCore_MedicationStatementBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public UKCore_MedicationStatementBuilder.Impl withContained(
     ...
     */
    public UKCore_MedicationStatementBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public UKCore_MedicationStatementBuilder.Impl withExtension(
    ...
    public UKCore_MedicationStatementBuilder.Impl withReasonCode(
     ...
     */
    public UKCore_MedicationStatementBuilder.Impl withStatusReason(
     ...
     *     UKCore_MedicationStatementBuilder.effective static methods
     */
    public UKCore_MedicationStatementBuilder.Impl withEffective(
     ...
     *     source.
     */
    public UKCore_MedicationStatementBuilder.Impl withDateAsserted(
        @NonNull FHIRDateTime dateAsserted) {
     ...
     *     profiles etc.
     */
    public UKCore_MedicationStatementBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public UKCore_MedicationStatementBuilder.Impl withNote(@NonNull Annotation... note) {
     ...
     *     by the other attributes.
     */
    public UKCore_MedicationStatementBuilder.Impl withNote(@NonNull Collection<Annotation> note) {
      this.note = Collections.unmodifiableCollection(note);
      return this;
    }

    public UKCore_MedicationStatementBuilder.Impl withNote(@NonNull AnnotationBuilder... note) {
     ...
     */
    public UKCore_MedicationStatementBuilder.Impl withModifierExtension(
     ...
     */
    public UKCore_MedicationStatementBuilder.Impl withIdentifier(
    ...
    public UKCore_MedicationStatementBuilder.Impl withPartOf(@NonNull Reference... partOf) {
      this.partOf = Arrays.asList(partOf);
      return this;
    }
    /** @param partOf - A larger event of which this particular event is a component or step. */
    public UKCore_MedicationStatementBuilder.Impl withPartOf(
        @NonNull Collection<Reference> partOf) {
      this.partOf = Collections.unmodifiableCollection(partOf);
      return this;
    }

    public UKCore_MedicationStatementBuilder.Impl withPartOf(@NonNull ReferenceBuilder... partOf) {
     ...
     *     event.
     */
    public UKCore_MedicationStatementBuilder.Impl withBasedOn(@NonNull Reference... basedOn) {
     ...
     *     event.
     */
    public UKCore_MedicationStatementBuilder.Impl withBasedOn(
     ...
     *     MedicationStatement.
     */
    public UKCore_MedicationStatementBuilder.Impl withContext(@NonNull Reference context) {
      this.context = Optional.of(context);
      return this;
    }

    public UKCore_MedicationStatementBuilder.Impl withContext(@NonNull ReferenceBuilder context) {
      this.context = Optional.of(context.build());
      return this;
    }
    /** @param dosage - Indicates how the medication is/was or should be taken by the patient. */
    public UKCore_MedicationStatementBuilder.Impl withDosage(@NonNull Dosage... dosage) {
      this.dosage = Arrays.asList(dosage);
      return this;
    }
    /** @param dosage - Indicates how the medication is/was or should be taken by the patient. */
    public UKCore_MedicationStatementBuilder.Impl withDosage(@NonNull Collection<Dosage> dosage) {
      this.dosage = Collections.unmodifiableCollection(dosage);
      return this;
    }

    public UKCore_MedicationStatementBuilder.Impl withDosage(@NonNull DosageBuilder... dosage) {
     ...
     *     MedicationStatement.
     */
    public UKCore_MedicationStatementBuilder.Impl withDerivedFrom(
     ...
     *     being/was taken.
     */
    public UKCore_MedicationStatementBuilder.Impl withReasonReference(
     ...
     */
    public UKCore_MedicationStatementBuilder.Impl withInformationSource(
    ...
    public UKCore_MedicationStatementBuilder.Impl withoutMeta() {
      this.meta = Optional.empty();
      return this;
    }

    public UKCore_MedicationStatement build() {
      return new UKCore_MedicationStatement(
