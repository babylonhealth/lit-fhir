...
public interface UKCore_AuditEventBuilder extends AuditEventBuilder {
  public UKCore_AuditEvent build();
  ...
  public static Impl init(
    ...
    return new Impl(_type, recorded, agent, source);
  }
  ...
  public class Impl implements UKCore_AuditEventBuilder {
    private Optional<String> id = Optional.empty();
    private Optional<Meta> meta =
        Optional.of(
            MetaBuilder.init()
                .withProfile("https://fhir.hl7.org.uk/StructureDefinition/UKCore-AuditEvent")
                .build());
    ...
    /**
     * Required fields for {@link UKCore_AuditEvent}
     *
     ...
     */
    public UKCore_AuditEventBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public UKCore_AuditEventBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public UKCore_AuditEventBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public UKCore_AuditEventBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public UKCore_AuditEventBuilder.Impl withText(@NonNull NarrativeBuilder text) {
     ...
     *     audit.
     */
    public UKCore_AuditEventBuilder.Impl withAction(@NonNull AUDIT_EVENT_ACTION action) {
      this.action = Optional.of(action);
      return this;
    }
    /** @param period - The period during which the activity occurred. */
    public UKCore_AuditEventBuilder.Impl withPeriod(@NonNull Period period) {
      this.period = Optional.of(period);
      return this;
    }

    public UKCore_AuditEventBuilder.Impl withPeriod(@NonNull PeriodBuilder period) {
      this.period = Optional.of(period.build());
      return this;
    }
    /** @param subtype - Identifier for the category of event. */
    public UKCore_AuditEventBuilder.Impl withSubtype(@NonNull Coding... subtype) {
      this.subtype = Arrays.asList(subtype);
      return this;
    }
    /** @param subtype - Identifier for the category of event. */
    public UKCore_AuditEventBuilder.Impl withSubtype(@NonNull Collection<Coding> subtype) {
      this.subtype = Collections.unmodifiableCollection(subtype);
      return this;
    }

    public UKCore_AuditEventBuilder.Impl withSubtype(@NonNull CodingBuilder... subtype) {
    ...
    public UKCore_AuditEventBuilder.Impl withOutcome(@NonNull AUDIT_EVENT_OUTCOME outcome) {
      this.outcome = Optional.of(outcome);
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public UKCore_AuditEventBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public UKCore_AuditEventBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public UKCore_AuditEventBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
      this.contained = Collections.unmodifiableCollection(contained);
      return this;
    }

    public UKCore_AuditEventBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public UKCore_AuditEventBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public UKCore_AuditEventBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public UKCore_AuditEventBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
      this.extension = Arrays.stream(extension).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param outcomeDesc - A free text description of the outcome of the event. */
    public UKCore_AuditEventBuilder.Impl withOutcomeDesc(@NonNull String outcomeDesc) {
     ...
     *     profiles etc.
     */
    public UKCore_AuditEventBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     *     recorded.
     */
    public UKCore_AuditEventBuilder.Impl withPurposeOfEvent(
     ...
     */
    public UKCore_AuditEventBuilder.Impl withModifierExtension(
    ...
    public UKCore_AuditEventBuilder.Impl withEntity(@NonNull AuditEvent.Entity... entity) {
      this.entity = Arrays.asList(entity);
      return this;
    }
    /** @param entity - Specific instances of data or objects that have been accessed. */
    public UKCore_AuditEventBuilder.Impl withEntity(@NonNull Collection<AuditEvent.Entity> entity) {
      this.entity = Collections.unmodifiableCollection(entity);
      return this;
    }

    public UKCore_AuditEventBuilder.Impl withEntity(@NonNull AuditEvent_EntityBuilder... entity) {
      this.entity = Arrays.stream(entity).map(e -> e.build()).collect(toList());
      return this;
    }

    public UKCore_AuditEventBuilder.Impl withoutMeta() {
      this.meta = Optional.empty();
      return this;
    }

    public UKCore_AuditEvent build() {
      return new UKCore_AuditEvent(
