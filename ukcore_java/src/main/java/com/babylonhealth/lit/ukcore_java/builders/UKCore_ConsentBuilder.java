...
public interface UKCore_ConsentBuilder extends ConsentBuilder {
  public UKCore_Consent build();
  ...
  public class Impl implements UKCore_ConsentBuilder {
    private Optional<String> id = Optional.empty();
    private Optional<Meta> meta =
        Optional.of(
            MetaBuilder.init()
                .withProfile("https://fhir.hl7.org.uk/StructureDefinition/UKCore-Consent")
                .build());
    ...
    /**
     * Required fields for {@link UKCore_Consent}
     *
     ...
     */
    public UKCore_ConsentBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public UKCore_ConsentBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public UKCore_ConsentBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public UKCore_ConsentBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public UKCore_ConsentBuilder.Impl withText(@NonNull NarrativeBuilder text) {
      this.text = Optional.of(text.build());
      return this;
    }
    /** @param patient - The patient/healthcare consumer to whom this consent applies. */
    public UKCore_ConsentBuilder.Impl withPatient(@NonNull Reference patient) {
      this.patient = Optional.of(patient);
      return this;
    }

    public UKCore_ConsentBuilder.Impl withPatient(@NonNull ReferenceBuilder patient) {
      this.patient = Optional.of(patient.build());
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public UKCore_ConsentBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
      this.language = Optional.of(language);
      return this;
    }
    /** @param dateTime - When this Consent was issued / created / indexed. */
    public UKCore_ConsentBuilder.Impl withDateTime(@NonNull FHIRDateTime dateTime) {
     ...
     */
    public UKCore_ConsentBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public UKCore_ConsentBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
      this.contained = Collections.unmodifiableCollection(contained);
      return this;
    }

    public UKCore_ConsentBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public UKCore_ConsentBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public UKCore_ConsentBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public UKCore_ConsentBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
     ...
     */
    public UKCore_ConsentBuilder.Impl withPerformer(@NonNull Reference... performer) {
     ...
     *     authorizations and enforcement of prohibitions.
     */
    public UKCore_ConsentBuilder.Impl withPerformer(@NonNull Collection<Reference> performer) {
      this.performer = Collections.unmodifiableCollection(performer);
      return this;
    }

    public UKCore_ConsentBuilder.Impl withPerformer(@NonNull ReferenceBuilder... performer) {
     ...
     *     the value in, wrap with one of the UKCore_ConsentBuilder.source static methods
     */
    public UKCore_ConsentBuilder.Impl withSource(@NonNull ChoiceAttachmentOrReference source) {
      this.source = Optional.of(source);
      return this;
    }
    /** @param policyRule - A reference to the specific base computable regulation or policy. */
    public UKCore_ConsentBuilder.Impl withPolicyRule(@NonNull CodeableConcept policyRule) {
      this.policyRule = Optional.of(policyRule);
      return this;
    }

    public UKCore_ConsentBuilder.Impl withPolicyRule(@NonNull CodeableConceptBuilder policyRule) {
     ...
     */
    public UKCore_ConsentBuilder.Impl withOrganization(@NonNull Reference... organization) {
     ...
     *     which it is executed.
     */
    public UKCore_ConsentBuilder.Impl withOrganization(
        @NonNull Collection<Reference> organization) {
      this.organization = Collections.unmodifiableCollection(organization);
      return this;
    }

    public UKCore_ConsentBuilder.Impl withOrganization(@NonNull ReferenceBuilder... organization) {
     ...
     *     profiles etc.
     */
    public UKCore_ConsentBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public UKCore_ConsentBuilder.Impl withModifierExtension(
    ...
    public UKCore_ConsentBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
      this.identifier = Arrays.asList(identifier);
      return this;
    }
    /** @param identifier - Unique identifier for this copy of the Consent Statement. */
    public UKCore_ConsentBuilder.Impl withIdentifier(@NonNull Collection<Identifier> identifier) {
      this.identifier = Collections.unmodifiableCollection(identifier);
      return this;
    }

    public UKCore_ConsentBuilder.Impl withIdentifier(@NonNull IdentifierBuilder... identifier) {
     ...
     */
    public UKCore_ConsentBuilder.Impl withPolicy(@NonNull Consent.Policy... policy) {
     ...
     *     Policies may be organizational, but are often defined jurisdictionally, or in law.
     */
    public UKCore_ConsentBuilder.Impl withPolicy(@NonNull Collection<Consent.Policy> policy) {
      this.policy = Collections.unmodifiableCollection(policy);
      return this;
    }

    public UKCore_ConsentBuilder.Impl withPolicy(@NonNull Consent_PolicyBuilder... policy) {
     ...
     */
    public UKCore_ConsentBuilder.Impl withVerification(
        @NonNull Consent.Verification... verification) {
     ...
     */
    public UKCore_ConsentBuilder.Impl withProvision(@NonNull Consent.Provision provision) {
      this.provision = Optional.of(provision);
      return this;
    }

    public UKCore_ConsentBuilder.Impl withProvision(@NonNull Consent_ProvisionBuilder provision) {
      this.provision = Optional.of(provision.build());
      return this;
    }

    public UKCore_ConsentBuilder.Impl withoutMeta() {
      this.meta = Optional.empty();
      return this;
    }

    public UKCore_Consent build() {
      return new UKCore_Consent(
