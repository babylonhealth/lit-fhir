...
public interface UKCore_QuestionnaireBuilder extends QuestionnaireBuilder {
  public UKCore_Questionnaire build();
  ...
  public class Impl implements UKCore_QuestionnaireBuilder {
    private Optional<String> id = Optional.empty();
    private Optional<String> url = Optional.empty();
    private Optional<Meta> meta =
        Optional.of(
            MetaBuilder.init()
                .withProfile("https://fhir.hl7.org.uk/StructureDefinition/UKCore-Questionnaire")
                .build());
    ...
    /**
     * Required fields for {@link UKCore_Questionnaire}
     *
     ...
     */
    public UKCore_QuestionnaireBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public UKCore_QuestionnaireBuilder.Impl withUrl(@NonNull String url) {
     ...
     */
    public UKCore_QuestionnaireBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public UKCore_QuestionnaireBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public UKCore_QuestionnaireBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public UKCore_QuestionnaireBuilder.Impl withText(@NonNull NarrativeBuilder text) {
     ...
     *     generation.
     */
    public UKCore_QuestionnaireBuilder.Impl withName(@NonNull String name) {
     ...
     *     changes.
     */
    public UKCore_QuestionnaireBuilder.Impl withDate(@NonNull FHIRDateTime date) {
     ...
     */
    public UKCore_QuestionnaireBuilder.Impl withCode(@NonNull Coding... code) {
     ...
     *     terminology such as LOINC.
     */
    public UKCore_QuestionnaireBuilder.Impl withCode(@NonNull Collection<Coding> code) {
      this.code = Collections.unmodifiableCollection(code);
      return this;
    }

    public UKCore_QuestionnaireBuilder.Impl withCode(@NonNull CodingBuilder... code) {
    ...
    public UKCore_QuestionnaireBuilder.Impl withTitle(@NonNull String title) {
      this.title = Optional.of(title);
      return this;
    }
    /**
     * @param version - The identifier that is used to identify this version of the questionnaire
     *     when it is referenced in a specification, model, design or instance. This is an arbitrary
     *     value managed by the questionnaire author and is not expected to be globally unique. For
     ...
     */
    public UKCore_QuestionnaireBuilder.Impl withVersion(@NonNull String version) {
     ...
     *     publisher.
     */
    public UKCore_QuestionnaireBuilder.Impl withContact(@NonNull ContactDetail... contact) {
     ...
     *     publisher.
     */
    public UKCore_QuestionnaireBuilder.Impl withContact(
        @NonNull Collection<ContactDetail> contact) {
      this.contact = Collections.unmodifiableCollection(contact);
      return this;
    }

    public UKCore_QuestionnaireBuilder.Impl withContact(@NonNull ContactDetailBuilder... contact) {
     ...
     *     as it has.
     */
    public UKCore_QuestionnaireBuilder.Impl withPurpose(@NonNull String purpose) {
      this.purpose = Optional.of(purpose);
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public UKCore_QuestionnaireBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public UKCore_QuestionnaireBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public UKCore_QuestionnaireBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
      this.contained = Collections.unmodifiableCollection(contained);
      return this;
    }

    public UKCore_QuestionnaireBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public UKCore_QuestionnaireBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public UKCore_QuestionnaireBuilder.Impl withExtension(
        @NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public UKCore_QuestionnaireBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
      this.extension = Arrays.stream(extension).map(e -> e.build()).collect(toList());
      return this;
    }
    /**
     * @param publisher - The name of the organization or individual that published the
     *     questionnaire.
     */
    public UKCore_QuestionnaireBuilder.Impl withPublisher(@NonNull String publisher) {
     ...
     *     questionnaire.
     */
    public UKCore_QuestionnaireBuilder.Impl withCopyright(@NonNull String copyright) {
     ...
     */
    public UKCore_QuestionnaireBuilder.Impl withUseContext(@NonNull UsageContext... useContext) {
     ...
     *     assist with indexing and searching for appropriate questionnaire instances.
     */
    public UKCore_QuestionnaireBuilder.Impl withUseContext(
    ...
    public UKCore_QuestionnaireBuilder.Impl withDerivedFrom(@NonNull String... derivedFrom) {
      this.derivedFrom = Arrays.asList(derivedFrom);
      return this;
    }
    /** @param derivedFrom - The URL of a Questionnaire that this Questionnaire is based on. */
    public UKCore_QuestionnaireBuilder.Impl withDerivedFrom(
        @NonNull Collection<String> derivedFrom) {
      this.derivedFrom = Collections.unmodifiableCollection(derivedFrom);
      return this;
    }
    /**
     * @param subjectType - The types of subjects that can be the subject of responses created for
     *     the questionnaire.
     */
    public UKCore_QuestionnaireBuilder.Impl withSubjectType(
        @NonNull RESOURCE_TYPES... subjectType) {
     ...
     */
    public UKCore_QuestionnaireBuilder.Impl withSubjectType(
        @NonNull Collection<RESOURCE_TYPES> subjectType) {
     ...
     */
    public UKCore_QuestionnaireBuilder.Impl withDescription(@NonNull String description) {
     ...
     *     genuine usage.
     */
    public UKCore_QuestionnaireBuilder.Impl withExperimental(@NonNull Boolean experimental) {
      this.experimental = Optional.of(experimental);
      return this;
    }
    /**
     * @param jurisdiction - A legal or geographic region in which the questionnaire is intended to
     *     be used.
     */
    public UKCore_QuestionnaireBuilder.Impl withJurisdiction(
     ...
     */
    public UKCore_QuestionnaireBuilder.Impl withApprovalDate(@NonNull FHIRDate approvalDate) {
     ...
     *     profiles etc.
     */
    public UKCore_QuestionnaireBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public UKCore_QuestionnaireBuilder.Impl withLastReviewDate(@NonNull FHIRDate lastReviewDate) {
      this.lastReviewDate = Optional.of(lastReviewDate);
      return this;
    }
    /**
     * @param effectivePeriod - The period during which the questionnaire content was or is planned
     *     to be in active use.
     */
    public UKCore_QuestionnaireBuilder.Impl withEffectivePeriod(@NonNull Period effectivePeriod) {
      this.effectivePeriod = Optional.of(effectivePeriod);
      return this;
    }

    public UKCore_QuestionnaireBuilder.Impl withEffectivePeriod(
     ...
     */
    public UKCore_QuestionnaireBuilder.Impl withModifierExtension(
    ...
    /**
     * @param identifier - A formal identifier that is used to identify this questionnaire when it
     *     is represented in other formats, or referenced in a specification, model, design or an
     *     instance.
     */
    public UKCore_QuestionnaireBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     *     instance.
     */
    public UKCore_QuestionnaireBuilder.Impl withIdentifier(
     ...
     *     questionnaire.
     */
    public UKCore_QuestionnaireBuilder.Impl withItem(@NonNull Questionnaire.Item... item) {
     ...
     *     questionnaire.
     */
    public UKCore_QuestionnaireBuilder.Impl withItem(@NonNull Collection<Questionnaire.Item> item) {
      this.item = Collections.unmodifiableCollection(item);
      return this;
    }

    public UKCore_QuestionnaireBuilder.Impl withItem(@NonNull Questionnaire_ItemBuilder... item) {
      this.item = Arrays.stream(item).map(e -> e.build()).collect(toList());
      return this;
    }

    public UKCore_QuestionnaireBuilder.Impl withoutMeta() {
      this.meta = Optional.empty();
      return this;
    }

    public UKCore_Questionnaire build() {
      return new UKCore_Questionnaire(
