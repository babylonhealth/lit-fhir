...
public interface UKCore_ObservationBuilder extends ObservationBuilder {
  public UKCore_Observation build();

  public static Impl init(OBSERVATION_STATUS status, CodeableConcept code) {
    return new Impl(status, code);
  }

  public static Impl builder(OBSERVATION_STATUS status, CodeableConceptBuilder code) {
    return new Impl(status, code.build());
  }
  ...
  public class Impl implements UKCore_ObservationBuilder {
    private Optional<String> id = Optional.empty();
    private Optional<Meta> meta =
        Optional.of(
            MetaBuilder.init()
                .withProfile("https://fhir.hl7.org.uk/StructureDefinition/UKCore-Observation")
                .build());
    ...
    /**
     * Required fields for {@link UKCore_Observation}
     *
     ...
     */
    public Impl(OBSERVATION_STATUS status, CodeableConcept code) {
      this.status = status;
      this.code = code;
    }
     ...
     */
    public UKCore_ObservationBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public UKCore_ObservationBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public UKCore_ObservationBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public UKCore_ObservationBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public UKCore_ObservationBuilder.Impl withText(@NonNull NarrativeBuilder text) {
     ...
     */
    public UKCore_ObservationBuilder.Impl withIssued(@NonNull ZonedDateTime issued) {
      this.issued = Optional.of(issued);
      return this;
    }
    /** @param method - Indicates the mechanism used to perform the observation. */
    public UKCore_ObservationBuilder.Impl withMethod(@NonNull CodeableConcept method) {
      this.method = Optional.of(method);
      return this;
    }

    public UKCore_ObservationBuilder.Impl withMethod(@NonNull CodeableConceptBuilder method) {
      this.method = Optional.of(method.build());
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public UKCore_ObservationBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
      this.language = Optional.of(language);
      return this;
    }
    /** @param category - A code that classifies the general type of observation being made. */
    public UKCore_ObservationBuilder.Impl withCategory(@NonNull CodeableConcept... category) {
      this.category = Arrays.asList(category);
      return this;
    }
    /** @param category - A code that classifies the general type of observation being made. */
    public UKCore_ObservationBuilder.Impl withCategory(
     ...
     *     UKCore_ObservationBuilder.value static methods
     */
    public UKCore_ObservationBuilder.Impl withValue(@NonNull Choice02118820890 value) {
     ...
     */
    public UKCore_ObservationBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public UKCore_ObservationBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
      this.contained = Collections.unmodifiableCollection(contained);
      return this;
    }

    public UKCore_ObservationBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public UKCore_ObservationBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public UKCore_ObservationBuilder.Impl withExtension(@NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public UKCore_ObservationBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
     ...
     *     UKCore_ObservationBuilder.effective static methods
     */
    public UKCore_ObservationBuilder.Impl withEffective(@NonNull Choice00107722725 effective) {
     ...
     *     profiles etc.
     */
    public UKCore_ObservationBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     *     low, normal.
     */
    public UKCore_ObservationBuilder.Impl withInterpretation(
    ...
    public UKCore_ObservationBuilder.Impl withNote(@NonNull Annotation... note) {
      this.note = Arrays.asList(note);
      return this;
    }
    /** @param note - Comments about the observation or the results. */
    public UKCore_ObservationBuilder.Impl withNote(@NonNull Collection<Annotation> note) {
      this.note = Collections.unmodifiableCollection(note);
      return this;
    }

    public UKCore_ObservationBuilder.Impl withNote(@NonNull AnnotationBuilder... note) {
     ...
     */
    public UKCore_ObservationBuilder.Impl withDataAbsentReason(
     ...
     */
    public UKCore_ObservationBuilder.Impl withModifierExtension(
     ...
     *     (i.e. the target site).
     */
    public UKCore_ObservationBuilder.Impl withBodySite(@NonNull CodeableConcept bodySite) {
      this.bodySite = Optional.of(bodySite);
      return this;
    }

    public UKCore_ObservationBuilder.Impl withBodySite(@NonNull CodeableConceptBuilder bodySite) {
      this.bodySite = Optional.of(bodySite.build());
      return this;
    }
    /** @param identifier - A unique identifier assigned to this observation. */
    public UKCore_ObservationBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
      this.identifier = Arrays.asList(identifier);
      return this;
    }
    /** @param identifier - A unique identifier assigned to this observation. */
    public UKCore_ObservationBuilder.Impl withIdentifier(
        @NonNull Collection<Identifier> identifier) {
      this.identifier = Collections.unmodifiableCollection(identifier);
      return this;
    }

    public UKCore_ObservationBuilder.Impl withIdentifier(@NonNull IdentifierBuilder... identifier) {
     ...
     */
    public UKCore_ObservationBuilder.Impl withFocus(@NonNull Reference... focus) {
     ...
     *     is the patient of record and the mother is the focus.
     */
    public UKCore_ObservationBuilder.Impl withFocus(@NonNull Collection<Reference> focus) {
      this.focus = Collections.unmodifiableCollection(focus);
      return this;
    }

    public UKCore_ObservationBuilder.Impl withFocus(@NonNull ReferenceBuilder... focus) {
     ...
     */
    public UKCore_ObservationBuilder.Impl withPartOf(@NonNull Reference... partOf) {
     ...
     *     For example, an observation as part of a procedure.
     */
    public UKCore_ObservationBuilder.Impl withPartOf(@NonNull Collection<Reference> partOf) {
      this.partOf = Collections.unmodifiableCollection(partOf);
      return this;
    }

    public UKCore_ObservationBuilder.Impl withPartOf(@NonNull ReferenceBuilder... partOf) {
    ...
    public UKCore_ObservationBuilder.Impl withDevice(@NonNull Reference device) {
      this.device = Optional.of(device);
      return this;
    }

    public UKCore_ObservationBuilder.Impl withDevice(@NonNull ReferenceBuilder device) {
     ...
     */
    public UKCore_ObservationBuilder.Impl withComponent(
     ...
     */
    public UKCore_ObservationBuilder.Impl withBasedOn(@NonNull Reference... basedOn) {
     ...
     *     performed before it is dispensed.
     */
    public UKCore_ObservationBuilder.Impl withBasedOn(@NonNull Collection<Reference> basedOn) {
      this.basedOn = Collections.unmodifiableCollection(basedOn);
      return this;
    }

    public UKCore_ObservationBuilder.Impl withBasedOn(@NonNull ReferenceBuilder... basedOn) {
     ...
     *     observation.
     */
    public UKCore_ObservationBuilder.Impl withSubject(@NonNull Reference subject) {
      this.subject = Optional.of(subject);
      return this;
    }

    public UKCore_ObservationBuilder.Impl withSubject(@NonNull ReferenceBuilder subject) {
      this.subject = Optional.of(subject.build());
      return this;
    }
    /** @param specimen - The specimen that was used when this observation was made. */
    public UKCore_ObservationBuilder.Impl withSpecimen(@NonNull Reference specimen) {
      this.specimen = Optional.of(specimen);
      return this;
    }

    public UKCore_ObservationBuilder.Impl withSpecimen(@NonNull ReferenceBuilder specimen) {
     ...
     */
    public UKCore_ObservationBuilder.Impl withEncounter(@NonNull Reference encounter) {
      this.encounter = Optional.of(encounter);
      return this;
    }

    public UKCore_ObservationBuilder.Impl withEncounter(@NonNull ReferenceBuilder encounter) {
      this.encounter = Optional.of(encounter.build());
      return this;
    }
    /** @param performer - Who was responsible for asserting the observed value as "true". */
    public UKCore_ObservationBuilder.Impl withPerformer(@NonNull Reference... performer) {
      this.performer = Arrays.asList(performer);
      return this;
    }
    /** @param performer - Who was responsible for asserting the observed value as "true". */
    public UKCore_ObservationBuilder.Impl withPerformer(@NonNull Collection<Reference> performer) {
      this.performer = Collections.unmodifiableCollection(performer);
      return this;
    }

    public UKCore_ObservationBuilder.Impl withPerformer(@NonNull ReferenceBuilder... performer) {
     ...
     */
    public UKCore_ObservationBuilder.Impl withHasMember(@NonNull Reference... hasMember) {
     ...
     *     a set of vital sign measurements) that includes the target as a member of the group.
     */
    public UKCore_ObservationBuilder.Impl withHasMember(@NonNull Collection<Reference> hasMember) {
      this.hasMember = Collections.unmodifiableCollection(hasMember);
      return this;
    }

    public UKCore_ObservationBuilder.Impl withHasMember(@NonNull ReferenceBuilder... hasMember) {
     ...
     *     used.
     */
    public UKCore_ObservationBuilder.Impl withReferenceRange(
     ...
     */
    public UKCore_ObservationBuilder.Impl withDerivedFrom(@NonNull Reference... derivedFrom) {
     ...
     *     based on an ultrasound image.
     */
    public UKCore_ObservationBuilder.Impl withDerivedFrom(
    ...
    public UKCore_ObservationBuilder.Impl withoutMeta() {
      this.meta = Optional.empty();
      return this;
    }

    public UKCore_Observation build() {
      return new UKCore_Observation(
