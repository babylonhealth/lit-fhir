...
public interface UKCore_MessageHeaderBuilder extends MessageHeaderBuilder {
  public UKCore_MessageHeader build();

  public static Impl init(Coding event, MessageHeader.Source source) {
    return new Impl(event, source);
  }

  public static Impl builder(CodingBuilder event, MessageHeader_SourceBuilder source) {
    return new Impl(event.build(), source.build());
  }

  public class Impl implements UKCore_MessageHeaderBuilder {
    private Optional<String> id = Optional.empty();
    private Optional<Meta> meta =
        Optional.of(
            MetaBuilder.init()
                .withProfile("https://fhir.hl7.org.uk/StructureDefinition/UKCore-MessageHeader")
                .build());
    ...
    /**
     * Required fields for {@link UKCore_MessageHeader}
     *
     ...
     */
    public Impl(Coding event, MessageHeader.Source source) {
      this.event = event;
      this.source = source;
    }
     ...
     */
    public UKCore_MessageHeaderBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public UKCore_MessageHeaderBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public UKCore_MessageHeaderBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public UKCore_MessageHeaderBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public UKCore_MessageHeaderBuilder.Impl withText(@NonNull NarrativeBuilder text) {
     ...
     */
    public UKCore_MessageHeaderBuilder.Impl withReason(@NonNull CodeableConcept reason) {
      this.reason = Optional.of(reason);
      return this;
    }

    public UKCore_MessageHeaderBuilder.Impl withReason(@NonNull CodeableConceptBuilder reason) {
      this.reason = Optional.of(reason.build());
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public UKCore_MessageHeaderBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public UKCore_MessageHeaderBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public UKCore_MessageHeaderBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
      this.contained = Collections.unmodifiableCollection(contained);
      return this;
    }

    public UKCore_MessageHeaderBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public UKCore_MessageHeaderBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public UKCore_MessageHeaderBuilder.Impl withExtension(
        @NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public UKCore_MessageHeaderBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
      this.extension = Arrays.stream(extension).map(e -> e.build()).collect(toList());
      return this;
    }
    /** @param definition - Permanent link to the MessageDefinition for this message. */
    public UKCore_MessageHeaderBuilder.Impl withDefinition(@NonNull String definition) {
     ...
     *     profiles etc.
     */
    public UKCore_MessageHeaderBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public UKCore_MessageHeaderBuilder.Impl withModifierExtension(
     ...
     *     event.
     */
    public UKCore_MessageHeaderBuilder.Impl withFocus(@NonNull Reference... focus) {
     ...
     *     event.
     */
    public UKCore_MessageHeaderBuilder.Impl withFocus(@NonNull Collection<Reference> focus) {
      this.focus = Collections.unmodifiableCollection(focus);
      return this;
    }

    public UKCore_MessageHeaderBuilder.Impl withFocus(@NonNull ReferenceBuilder... focus) {
    ...
    public UKCore_MessageHeaderBuilder.Impl withSender(@NonNull Reference sender) {
      this.sender = Optional.of(sender);
      return this;
    }

    public UKCore_MessageHeaderBuilder.Impl withSender(@NonNull ReferenceBuilder sender) {
     ...
     */
    public UKCore_MessageHeaderBuilder.Impl withAuthor(@NonNull Reference author) {
      this.author = Optional.of(author);
      return this;
    }

    public UKCore_MessageHeaderBuilder.Impl withAuthor(@NonNull ReferenceBuilder author) {
     ...
     */
    public UKCore_MessageHeaderBuilder.Impl withEnterer(@NonNull Reference enterer) {
      this.enterer = Optional.of(enterer);
      return this;
    }

    public UKCore_MessageHeaderBuilder.Impl withEnterer(@NonNull ReferenceBuilder enterer) {
     ...
     */
    public UKCore_MessageHeaderBuilder.Impl withResponsible(@NonNull Reference responsible) {
      this.responsible = Optional.of(responsible);
      return this;
    }

    public UKCore_MessageHeaderBuilder.Impl withResponsible(@NonNull ReferenceBuilder responsible) {
     ...
     */
    public UKCore_MessageHeaderBuilder.Impl withResponse(@NonNull MessageHeader.Response response) {
      this.response = Optional.of(response);
      return this;
    }

    public UKCore_MessageHeaderBuilder.Impl withResponse(
        @NonNull MessageHeader_ResponseBuilder response) {
      this.response = Optional.of(response.build());
      return this;
    }
    /** @param destination - The destination application which the message is intended for. */
    public UKCore_MessageHeaderBuilder.Impl withDestination(
    ...
    public UKCore_MessageHeaderBuilder.Impl withoutMeta() {
      this.meta = Optional.empty();
      return this;
    }

    public UKCore_MessageHeader build() {
      return new UKCore_MessageHeader(
