...
public interface UKCore_EpisodeOfCareBuilder extends EpisodeOfCareBuilder {
  public UKCore_EpisodeOfCare build();
  ...
  public class Impl implements UKCore_EpisodeOfCareBuilder {
    private Optional<String> id = Optional.empty();
    private Optional<Meta> meta =
        Optional.of(
            MetaBuilder.init()
                .withProfile("https://fhir.hl7.org.uk/StructureDefinition/UKCore-EpisodeOfCare")
                .build());
    ...
    /**
     * Required fields for {@link UKCore_EpisodeOfCare}
     *
     ...
     */
    public UKCore_EpisodeOfCareBuilder.Impl withId(@NonNull String id) {
     ...
     */
    public UKCore_EpisodeOfCareBuilder.Impl withMeta(@NonNull Meta meta) {
      this.meta = Optional.of(meta);
      return this;
    }

    public UKCore_EpisodeOfCareBuilder.Impl withMeta(@NonNull MetaBuilder meta) {
     ...
     */
    public UKCore_EpisodeOfCareBuilder.Impl withText(@NonNull Narrative text) {
      this.text = Optional.of(text);
      return this;
    }

    public UKCore_EpisodeOfCareBuilder.Impl withText(@NonNull NarrativeBuilder text) {
     ...
     */
    public UKCore_EpisodeOfCareBuilder.Impl withType(@NonNull CodeableConcept... _type) {
     ...
     *     disease management, type of funded care.
     */
    public UKCore_EpisodeOfCareBuilder.Impl withType(@NonNull Collection<CodeableConcept> _type) {
      this._type = Collections.unmodifiableCollection(_type);
      return this;
    }

    public UKCore_EpisodeOfCareBuilder.Impl withType(@NonNull CodeableConceptBuilder... _type) {
     ...
     *     responsibility.
     */
    public UKCore_EpisodeOfCareBuilder.Impl withPeriod(@NonNull Period period) {
      this.period = Optional.of(period);
      return this;
    }

    public UKCore_EpisodeOfCareBuilder.Impl withPeriod(@NonNull PeriodBuilder period) {
      this.period = Optional.of(period.build());
      return this;
    }
    /** @param language - The base language in which the resource is written. */
    public UKCore_EpisodeOfCareBuilder.Impl withLanguage(@NonNull LANGUAGES language) {
     ...
     */
    public UKCore_EpisodeOfCareBuilder.Impl withContained(@NonNull Resource... contained) {
     ...
     *     have their own independent transaction scope.
     */
    public UKCore_EpisodeOfCareBuilder.Impl withContained(@NonNull Collection<Resource> contained) {
      this.contained = Collections.unmodifiableCollection(contained);
      return this;
    }

    public UKCore_EpisodeOfCareBuilder.Impl withContained(@NonNull ResourceBuilder... contained) {
     ...
     */
    public UKCore_EpisodeOfCareBuilder.Impl withExtension(@NonNull Extension... extension) {
     ...
     *     be met as part of the definition of the extension.
     */
    public UKCore_EpisodeOfCareBuilder.Impl withExtension(
        @NonNull Collection<Extension> extension) {
      this.extension = Collections.unmodifiableCollection(extension);
      return this;
    }

    public UKCore_EpisodeOfCareBuilder.Impl withExtension(@NonNull ExtensionBuilder... extension) {
     ...
     *     profiles etc.
     */
    public UKCore_EpisodeOfCareBuilder.Impl withImplicitRules(@NonNull String implicitRules) {
     ...
     */
    public UKCore_EpisodeOfCareBuilder.Impl withModifierExtension(
     ...
     *     purposes.
     */
    public UKCore_EpisodeOfCareBuilder.Impl withIdentifier(@NonNull Identifier... identifier) {
     ...
     *     purposes.
     */
    public UKCore_EpisodeOfCareBuilder.Impl withIdentifier(
     ...
     *     specific purposes.
     */
    public UKCore_EpisodeOfCareBuilder.Impl withTeam(@NonNull Reference... team) {
     ...
     *     specific purposes.
     */
    public UKCore_EpisodeOfCareBuilder.Impl withTeam(@NonNull Collection<Reference> team) {
      this.team = Collections.unmodifiableCollection(team);
      return this;
    }

    public UKCore_EpisodeOfCareBuilder.Impl withTeam(@NonNull ReferenceBuilder... team) {
    ...
    public UKCore_EpisodeOfCareBuilder.Impl withAccount(@NonNull Reference... account) {
      this.account = Arrays.asList(account);
      return this;
    }
    /** @param account - The set of accounts that may be used for billing for this EpisodeOfCare. */
    public UKCore_EpisodeOfCareBuilder.Impl withAccount(@NonNull Collection<Reference> account) {
      this.account = Collections.unmodifiableCollection(account);
      return this;
    }

    public UKCore_EpisodeOfCareBuilder.Impl withAccount(@NonNull ReferenceBuilder... account) {
     ...
     */
    public UKCore_EpisodeOfCareBuilder.Impl withStatusHistory(
     ...
     *     patient.
     */
    public UKCore_EpisodeOfCareBuilder.Impl withCareManager(@NonNull Reference careManager) {
      this.careManager = Optional.of(careManager);
      return this;
    }

    public UKCore_EpisodeOfCareBuilder.Impl withCareManager(@NonNull ReferenceBuilder careManager) {
     ...
     *     incoming referrals.
     */
    public UKCore_EpisodeOfCareBuilder.Impl withReferralRequest(
        @NonNull Reference... referralRequest) {
    ...
    public UKCore_EpisodeOfCareBuilder.Impl withDiagnosis(
        @NonNull EpisodeOfCare.Diagnosis... diagnosis) {
     ...
     */
    public UKCore_EpisodeOfCareBuilder.Impl withManagingOrganization(
    ...
    public UKCore_EpisodeOfCareBuilder.Impl withoutMeta() {
      this.meta = Optional.empty();
      return this;
    }

    public UKCore_EpisodeOfCare build() {
      return new UKCore_EpisodeOfCare(
