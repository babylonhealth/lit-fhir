...
object Elementdefinition_bestpractice_explanation extends CompanionFor[Elementdefinition_bestpractice_explanation] {
  implicit def summonObjectAndCompanionElementdefinition_bestpractice_explanation_1734245186(
  ...
  override def fields(t: Elementdefinition_bestpractice_explanation): Seq[FHIRComponentField[_]] = fieldsFromParent(t).get
  ...
  override val searchParams: Map[String, Elementdefinition_bestpractice_explanation => Seq[Any]] = Extension.searchParams
