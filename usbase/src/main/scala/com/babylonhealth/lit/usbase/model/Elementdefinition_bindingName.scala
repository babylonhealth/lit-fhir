...
object Elementdefinition_bindingName extends CompanionFor[Elementdefinition_bindingName] {
  ...
  override def fields(t: Elementdefinition_bindingName): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Elementdefinition_bindingName): Option[String]                   = t.id
  def extractUrl(t: Elementdefinition_bindingName): String                          = t.url
  ...
  def unapply(o: Elementdefinition_bindingName): Option[(Option[String], String, String)] = Some(
