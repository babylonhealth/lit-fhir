...
object Auditevent_Accession extends CompanionFor[Auditevent_Accession] {
  implicit def summonObjectAndCompanionAuditevent_Accession2141210283(
      o: Auditevent_Accession): ObjectAndCompanion[Auditevent_Accession, Auditevent_Accession.type] = ObjectAndCompanion(o, this)
  ...
  ): Auditevent_Accession = new Auditevent_Accession(
    id,
    value,
