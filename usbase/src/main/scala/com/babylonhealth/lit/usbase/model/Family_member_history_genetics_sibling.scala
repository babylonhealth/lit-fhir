...
object Family_member_history_genetics_sibling extends CompanionFor[Family_member_history_genetics_sibling] {
  ...
  override def fields(t: Family_member_history_genetics_sibling): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Family_member_history_genetics_sibling): String                          = t.url
  ...
  def unapply(o: Family_member_history_genetics_sibling): Option[(Option[String], String, NonEmptyLitSeq[Extension])] =
