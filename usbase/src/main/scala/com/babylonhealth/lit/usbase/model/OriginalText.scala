...
object OriginalText extends CompanionFor[OriginalText] {
  ...
  override def fields(t: OriginalText): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: OriginalText): Option[String]                   = t.id
  def extractUrl(t: OriginalText): String                          = t.url
  ...
  def unapply(o: OriginalText): Option[(Option[String], String, String)] = Some(
