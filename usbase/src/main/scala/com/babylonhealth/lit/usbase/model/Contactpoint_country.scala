...
object Contactpoint_country extends CompanionFor[Contactpoint_country] {
  ...
  override def fields(t: Contactpoint_country): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Contactpoint_country): Option[String]                   = t.id
  def extractUrl(t: Contactpoint_country): String                          = t.url
  ...
  def unapply(o: Contactpoint_country): Option[(Option[String], String, String)] = Some(
