...
object Cdshooksserviceplandefinition extends CompanionFor[Cdshooksserviceplandefinition] {
  ...
  def apply(
      ...
      meta: Option[Meta] = Some(
        new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/cdshooksserviceplandefinition"))),
      ...
      subject: Option[Cdshooksserviceplandefinition.SubjectChoice] = None,
  ...
  ): Cdshooksserviceplandefinition = new Cdshooksserviceplandefinition(
    id,
    url,
    meta,
    text,
  ...
  override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Try(
    Seq(
      ...
      FHIRComponentField[Option[Cdshooksserviceplandefinition.SubjectChoice]](subject, t.subject),
  ...
  override def fields(t: Cdshooksserviceplandefinition): Seq[FHIRComponentField[_]] = fieldsFromParent(t).get
  def extractId(t: Cdshooksserviceplandefinition): Option[String]                   = t.id
  def extractUrl(t: Cdshooksserviceplandefinition): Option[UriStr]                  = t.url
  def extractMeta(t: Cdshooksserviceplandefinition): Option[Meta]                   = t.meta
  def extractText(t: Cdshooksserviceplandefinition): Option[Narrative]              = t.text
  def extractName(t: Cdshooksserviceplandefinition): Option[String]                 = t.name
  def extractType(t: Cdshooksserviceplandefinition): Option[CodeableConcept]        = t.`type`
  def extractDate(t: Cdshooksserviceplandefinition): Option[FHIRDateTime]           = t.date
  def extractTitle(t: Cdshooksserviceplandefinition): Option[String]                = t.title
  def extractUsage(t: Cdshooksserviceplandefinition): Option[String]                = t.usage
  def extractTopic(t: Cdshooksserviceplandefinition): LitSeq[CodeableConcept]       = t.topic
  def extractStatus(t: Cdshooksserviceplandefinition): PUBLICATION_STATUS           = t.status
  def extractAuthor(t: Cdshooksserviceplandefinition): LitSeq[ContactDetail]        = t.author
  def extractEditor(t: Cdshooksserviceplandefinition): LitSeq[ContactDetail]        = t.editor
  def extractVersion(t: Cdshooksserviceplandefinition): Option[String]              = t.version
  def extractContact(t: Cdshooksserviceplandefinition): LitSeq[ContactDetail]       = t.contact
  def extractPurpose(t: Cdshooksserviceplandefinition): Option[Markdown]            = t.purpose
  def extractLibrary(t: Cdshooksserviceplandefinition): LitSeq[Canonical]           = t.library
  def extractLanguage(t: Cdshooksserviceplandefinition): Option[LANGUAGES]          = t.language
  def extractSubtitle(t: Cdshooksserviceplandefinition): Option[String]             = t.subtitle
  def extractReviewer(t: Cdshooksserviceplandefinition): LitSeq[ContactDetail]      = t.reviewer
  def extractEndorser(t: Cdshooksserviceplandefinition): LitSeq[ContactDetail]      = t.endorser
  def extractContained(t: Cdshooksserviceplandefinition): LitSeq[Resource]          = t.contained
  def extractExtension(t: Cdshooksserviceplandefinition): NonEmptyLitSeq[Extension] = t.extension.asNonEmpty
  def extractPublisher(t: Cdshooksserviceplandefinition): Option[String]            = t.publisher
  def extractCopyright(t: Cdshooksserviceplandefinition): Option[Markdown]          = t.copyright
  def extractIdentifier(t: Cdshooksserviceplandefinition): LitSeq[Identifier]       = t.identifier
  def extractSubject(t: Cdshooksserviceplandefinition): Option[Cdshooksserviceplandefinition.SubjectChoice] = t.subject
  def extractUseContext(t: Cdshooksserviceplandefinition): LitSeq[UsageContext]         = t.useContext
  def extractDescription(t: Cdshooksserviceplandefinition): Option[Markdown]            = t.description
  def extractExperimental(t: Cdshooksserviceplandefinition): Option[Boolean]            = t.experimental
  def extractJurisdiction(t: Cdshooksserviceplandefinition): LitSeq[CodeableConcept]    = t.jurisdiction
  def extractApprovalDate(t: Cdshooksserviceplandefinition): Option[FHIRDate]           = t.approvalDate
  def extractImplicitRules(t: Cdshooksserviceplandefinition): Option[UriStr]            = t.implicitRules
  def extractLastReviewDate(t: Cdshooksserviceplandefinition): Option[FHIRDate]         = t.lastReviewDate
  def extractEffectivePeriod(t: Cdshooksserviceplandefinition): Option[Period]          = t.effectivePeriod
  def extractRelatedArtifact(t: Cdshooksserviceplandefinition): LitSeq[RelatedArtifact] = t.relatedArtifact
  def extractModifierExtension(t: Cdshooksserviceplandefinition): LitSeq[Extension]     = t.modifierExtension
  def extractGoal(t: Cdshooksserviceplandefinition): LitSeq[PlanDefinition.Goal]        = t.goal
  def extractAction(t: Cdshooksserviceplandefinition): LitSeq[PlanDefinition.Action]    = t.action
  override val thisName: String                                                     = "Cdshooksserviceplandefinition"
  override val searchParams: Map[String, Cdshooksserviceplandefinition => Seq[Any]] = PlanDefinition.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Cdshooksserviceplandefinition] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Cdshooksserviceplandefinition(
...
/** Defines a PlanDefinition that implements the behavior for a CDS Hooks service
  *
  * Subclass of [[hl7.model.PlanDefinition]] (This resource allows for the definition of various types of plans as a
  * sharable, consumable, and executable artifact. The resource is general enough to support the description of a broad
  * range of clinical artifacts such as clinical decision support rules, order sets and protocols.)
  *
  * @constructor
  ...
  *   literal address at which at which an authoritative instance of this plan definition is (or will be) published.
  *   This URL can be the target of a canonical reference. It SHALL remain the same when the plan definition is stored
  ...
  * @param name
  *   - A natural language name identifying the plan definition. This name should be usable as an identifier for the
  ...
  * @param date
  *   - The date (and optionally time) when the plan definition was published. The date must change when the business
  ...
  * @param topic
  *   - Descriptive topics related to the content of the plan definition. Topics provide a high-level categorization of
  *   the definition that can be useful for filtering and searching.
  * @param status
  ...
  * @param version
  *   - The identifier that is used to identify this version of the plan definition when it is referenced in a
  *   specification, model, design or instance. This is an arbitrary value managed by the plan definition author and is
  ...
  * @param copyright
  *   - A copyright statement relating to the plan definition and/or its contents. Copyright statements are generally
  *   legal restrictions on the use and publishing of the plan definition.
  * @param identifier
  ...
  *   and may be used to assist with indexing and searching for appropriate plan definition instances.
  * @param description
  ...
  * @param goal
  *   - Goals that describe what the activities within the plan are intended to achieve. For example, weight loss,
...
class Cdshooksserviceplandefinition(
    ...
    override val subject: Option[Cdshooksserviceplandefinition.SubjectChoice] = None,
