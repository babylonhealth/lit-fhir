...
object Valueset_usage extends CompanionFor[Valueset_usage] {
  ...
  override def fields(t: Valueset_usage): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Valueset_usage): String                          = t.url
  ...
  def unapply(o: Valueset_usage): Option[(Option[String], String, NonEmptyLitSeq[Extension])] = Some(
