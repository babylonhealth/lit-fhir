...
object Observation_geneticsDNARegionName extends CompanionFor[Observation_geneticsDNARegionName] {
  implicit def summonObjectAndCompanionObservation_geneticsDNARegionName_841139226(
  ...
  override val profileUrl: Option[String] = Some("http://hl7.org/fhir/StructureDefinition/observation-geneticsDNARegionName")
  def apply(
...
/** A human readable name for the region of interest. Typically Exon #, Intron # or other. NOTE: This is not standardized and is
  * mainly for convenience and display purposes. LOINC Code: ([47999-8](http://loinc.org/47999-8)).
  *
