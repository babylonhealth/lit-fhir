...
object Organizationaffiliation_primaryInd extends CompanionFor[Organizationaffiliation_primaryInd] {
  ...
  override def fields(t: Organizationaffiliation_primaryInd): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Organizationaffiliation_primaryInd): String                          = t.url
  ...
  def unapply(o: Organizationaffiliation_primaryInd): Option[(Option[String], String, Boolean)] = Some(
