...
object Valueset_expand_rules extends CompanionFor[Valueset_expand_rules] {
  implicit def summonObjectAndCompanionValueset_expand_rules8204875(
  ...
  override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Try(
    Seq(
      ...
      FHIRComponentField[EXPANSION_PROCESSING_RULE](value, EXPANSION_PROCESSING_RULE.withName(t.value.get.toSubRefNonUnion[Code]))
    ))
