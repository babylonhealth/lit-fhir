...
object Questionnaireresponse_author extends CompanionFor[Questionnaireresponse_author] {
  ...
  ): Questionnaireresponse_author = new Questionnaireresponse_author(
    id,
    url,
    value,
  ...
  override def fields(t: Questionnaireresponse_author): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Questionnaireresponse_author): String                          = t.url
  ...
  def unapply(o: Questionnaireresponse_author): Option[(Option[String], String, Reference)] = Some(
  ...
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Questionnaireresponse_author] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Questionnaireresponse_author(
...
/** Allows capturing, on a specific question or group of questions, exactly who was responsible for providing the answer(s).
  ...
  */
@POJOBoilerplate
class Questionnaireresponse_author(
