...
object DiagnosticReport_geneticsFamilyMemberHistory extends CompanionFor[DiagnosticReport_geneticsFamilyMemberHistory] {
  ...
  override def fields(t: DiagnosticReport_geneticsFamilyMemberHistory): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: DiagnosticReport_geneticsFamilyMemberHistory): String        = t.url
  ...
  def unapply(o: DiagnosticReport_geneticsFamilyMemberHistory): Option[(Option[String], String, Reference)] = Some(
