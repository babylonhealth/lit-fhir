...
object Procedure_approachBodyStructure extends CompanionFor[Procedure_approachBodyStructure] {
  implicit def summonObjectAndCompanionProcedure_approachBodyStructure_1653965510(
      o: Procedure_approachBodyStructure): ObjectAndCompanion[Procedure_approachBodyStructure, Procedure_approachBodyStructure.type] =
  ...
  ): Procedure_approachBodyStructure = new Procedure_approachBodyStructure(
    id,
    value,
  ...
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Procedure_approachBodyStructure] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Procedure_approachBodyStructure(
...
/** The approach body site used for this procedure. Multiple locations are allowed.
  ...
  */
@POJOBoilerplate
class Procedure_approachBodyStructure(
