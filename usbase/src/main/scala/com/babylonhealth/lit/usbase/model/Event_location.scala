...
object Event_location extends CompanionFor[Event_location] {
  ...
  override def fields(t: Event_location): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Event_location): String                          = t.url
  ...
  def unapply(o: Event_location): Option[(Option[String], String, Reference)] = Some(
