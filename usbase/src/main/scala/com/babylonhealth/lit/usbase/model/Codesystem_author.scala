...
object Codesystem_author extends CompanionFor[Codesystem_author] {
  ...
  override def fields(t: Codesystem_author): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Codesystem_author): Option[String]                   = t.id
  def extractUrl(t: Codesystem_author): String                          = t.url
  ...
  def unapply(o: Codesystem_author): Option[(Option[String], String, String)] = Some(
