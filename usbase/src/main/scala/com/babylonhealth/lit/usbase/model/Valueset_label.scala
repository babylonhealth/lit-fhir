...
object Valueset_label extends CompanionFor[Valueset_label] {
  ...
  override val profileUrl: Option[String]        = Some("http://hl7.org/fhir/StructureDefinition/valueset-label")
  def apply(
      id: Option[String] = None,
      url: String,
      value: String,
      primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
  ): Valueset_label = new Valueset_label(
    id,
    url,
    value,
  ...
  override def fields(t: Valueset_label): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Valueset_label): Option[String]                   = t.id
  def extractUrl(t: Valueset_label): String                          = t.url
  ...
  def unapply(o: Valueset_label): Option[(Option[String], String, String)] = Some(
