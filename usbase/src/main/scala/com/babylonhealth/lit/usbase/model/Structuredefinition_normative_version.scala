...
object Structuredefinition_normative_version extends CompanionFor[Structuredefinition_normative_version] {
  ...
  override def fields(t: Structuredefinition_normative_version): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Structuredefinition_normative_version): String                          = t.url
  def extractValue(t: Structuredefinition_normative_version): FHIR_VERSION                  = t.value.get.toSubRefNonUnion[FHIR_VERSION]
  ...
  def unapply(o: Structuredefinition_normative_version): Option[(Option[String], String, FHIR_VERSION)] = Some(
    (o.id, o.url, o.value.get.toSubRefNonUnion[FHIR_VERSION]))
