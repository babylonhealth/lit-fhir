...
object Questionnaire_optionPrefix extends CompanionFor[Questionnaire_optionPrefix] {
  ...
  override def fields(t: Questionnaire_optionPrefix): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Questionnaire_optionPrefix): Option[String]                   = t.id
  def extractUrl(t: Questionnaire_optionPrefix): String                          = t.url
  ...
  def unapply(o: Questionnaire_optionPrefix): Option[(Option[String], String, String)] = Some(
