...
object Structuredefinition_table_name extends CompanionFor[Structuredefinition_table_name] {
  ...
  override def fields(t: Structuredefinition_table_name): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Structuredefinition_table_name): Option[String]                   = t.id
  def extractUrl(t: Structuredefinition_table_name): String                          = t.url
  ...
  def unapply(o: Structuredefinition_table_name): Option[(Option[String], String, String)] = Some(
