...
object Valueset_system extends CompanionFor[Valueset_system] {
  ...
  override def fields(t: Valueset_system): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Valueset_system): String                          = t.url
  ...
  def unapply(o: Valueset_system): Option[(Option[String], String, Canonical)] = Some(
