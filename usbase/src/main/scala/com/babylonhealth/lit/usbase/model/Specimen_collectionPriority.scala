...
object Specimen_collectionPriority extends CompanionFor[Specimen_collectionPriority] {
  ...
  ): Specimen_collectionPriority = new Specimen_collectionPriority(
    id,
    url,
    value,
  ...
  override def fields(t: Specimen_collectionPriority): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Specimen_collectionPriority): String                          = t.url
  ...
  def unapply(o: Specimen_collectionPriority): Option[(Option[String], String, CodeableConcept)] = Some(
    (o.id, o.url, o.value.get.toSubRefNonUnion[CodeableConcept]))
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Specimen_collectionPriority] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Specimen_collectionPriority(
...
/** The urgency of sample collection, such as STAT, ASAP, ASAP-ED, ROUTINE, ROUTINE-AM, etc….
  ...
  */
@POJOBoilerplate
class Specimen_collectionPriority(
