...
object Replaces extends CompanionFor[Replaces] {
  ...
  override def fields(t: Replaces): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Replaces): String                          = t.url
  ...
  def unapply(o: Replaces): Option[(Option[String], String, Canonical)] = Some(
