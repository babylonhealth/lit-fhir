...
object Questionnaire_optionExclusive extends CompanionFor[Questionnaire_optionExclusive] {
  implicit def summonObjectAndCompanionQuestionnaire_optionExclusive828711370(
  ...
  override val profileUrl: Option[String] = Some("http://hl7.org/fhir/StructureDefinition/questionnaire-optionExclusive")
  def apply(
...
/** If true, indicates that if this answerOption is selected, no other possible answers may be selected, even if the item is a
  * repeating question.
  *
