...
object Structuredefinition_hierarchy extends CompanionFor[Structuredefinition_hierarchy] {
  ...
  override def fields(t: Structuredefinition_hierarchy): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Structuredefinition_hierarchy): String                          = t.url
  ...
  def unapply(o: Structuredefinition_hierarchy): Option[(Option[String], String, Boolean)] = Some(
