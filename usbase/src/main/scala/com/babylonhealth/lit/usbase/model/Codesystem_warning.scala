...
object Codesystem_warning extends CompanionFor[Codesystem_warning] {
  ...
  override val profileUrl: Option[String]        = Some("http://hl7.org/fhir/StructureDefinition/codesystem-warning")
  def apply(
      id: Option[String] = None,
      url: String,
      value: Markdown,
      primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
  ): Codesystem_warning = new Codesystem_warning(
    id,
    url,
    value,
  ...
  override def fields(t: Codesystem_warning): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Codesystem_warning): String                          = t.url
  ...
  def unapply(o: Codesystem_warning): Option[(Option[String], String, Markdown)] = Some(
