...
object Cqf_recipientLanguage extends CompanionFor[Cqf_recipientLanguage] {
  ...
  ): Cqf_recipientLanguage = new Cqf_recipientLanguage(
    id,
    url,
    value,
  ...
  override def fields(t: Cqf_recipientLanguage): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Cqf_recipientLanguage): String                          = t.url
  ...
  def unapply(o: Cqf_recipientLanguage): Option[(Option[String], String, CodeableConcept)] = Some(
    (o.id, o.url, o.value.get.toSubRefNonUnion[CodeableConcept]))
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Cqf_recipientLanguage] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Cqf_recipientLanguage(
