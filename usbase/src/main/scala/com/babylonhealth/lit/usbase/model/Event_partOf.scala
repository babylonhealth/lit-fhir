...
object Event_partOf extends CompanionFor[Event_partOf] {
  ...
  override def fields(t: Event_partOf): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Event_partOf): String                          = t.url
  ...
  def unapply(o: Event_partOf): Option[(Option[String], String, Reference)] = Some(
