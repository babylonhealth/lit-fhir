...
/** Explanation of what this profile contains/is for.
  *
  * Subclass of [[hl7.model.Evidence]] (The Evidence resource describes the conditional state (population and any exposures being
  * compared within the population) and outcome (if specified) that the knowledge (evidence, assertion, recommendation) is about.)
  *
  * @constructor
