...
object Iso21090_ADXP_streetNameBase extends CompanionFor[Iso21090_ADXP_streetNameBase] {
  ...
  override val profileUrl: Option[String]        = Some("http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-streetNameBase")
  def apply(
      id: Option[String] = None,
      url: String,
      value: String,
      primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
  ): Iso21090_ADXP_streetNameBase = new Iso21090_ADXP_streetNameBase(
    id,
    url,
    value,
  ...
  override def fields(t: Iso21090_ADXP_streetNameBase): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Iso21090_ADXP_streetNameBase): Option[String]                   = t.id
  def extractUrl(t: Iso21090_ADXP_streetNameBase): String                          = t.url
  ...
  def unapply(o: Iso21090_ADXP_streetNameBase): Option[(Option[String], String, String)] = Some(
  ...
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Iso21090_ADXP_streetNameBase] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Iso21090_ADXP_streetNameBase(
...
/** The base name of a roadway or artery recognized by a municipality (excluding street type and direction).
  ...
  */
@POJOBoilerplate
class Iso21090_ADXP_streetNameBase(
