...
object Patient_religion extends CompanionFor[Patient_religion] {
  ...
  override def fields(t: Patient_religion): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Patient_religion): String                          = t.url
  ...
  def unapply(o: Patient_religion): Option[(Option[String], String, CodeableConcept)] = Some(
