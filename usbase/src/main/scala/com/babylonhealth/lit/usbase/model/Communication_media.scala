...
object Communication_media extends CompanionFor[Communication_media] {
  implicit def summonObjectAndCompanionCommunication_media_1966946846(
      o: Communication_media): ObjectAndCompanion[Communication_media, Communication_media.type] =
...
/** It contains enriched media representation of the alert message, such as a voice recording. This may be used, for
  * example for compliance with jurisdictional accessibility requirements, literacy issues, or translations of the
  * unstructured text content in other languages.
  *
