...
object Valueset_author extends CompanionFor[Valueset_author] {
  implicit def summonObjectAndCompanionValueset_author1662645522(
      o: Valueset_author): ObjectAndCompanion[Valueset_author, Valueset_author.type] = ObjectAndCompanion(o, this)
...
/** The entity or set of entities that create and may modify the Value Set Definition content. The name of a group or an
  * individual, along with contact details.
  *
...
class Valueset_author(
    ...
    override val primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
      ...
      id = id,
      value = Some(new Choice("ContactDetail", value)(UnionAllTag)),
