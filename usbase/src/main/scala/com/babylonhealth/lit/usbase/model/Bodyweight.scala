...
object Bodyweight extends CompanionFor[Bodyweight] {
  implicit def summonObjectAndCompanionBodyweight_475713489(o: Bodyweight): ObjectAndCompanion[Bodyweight, Bodyweight.type] =
  ...
  def apply(
      ...
      meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/bodyweight"))),
      ...
      effective: Bodyweight.EffectiveChoice,
  ...
  val effective: FHIRComponentFieldMeta[Bodyweight.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Bodyweight.EffectiveChoice], true, lTagOf[UnionDateTimeOrPeriod])
  ...
  override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Try(
    Seq(
      ...
      FHIRComponentField[Bodyweight.EffectiveChoice](effective, t.effective.get.toSubRef),
  ...
  override def fields(t: Bodyweight): Seq[FHIRComponentField[_]]               = fieldsFromParent(t).get
  def extractId(t: Bodyweight): Option[String]                                 = t.id
  def extractMeta(t: Bodyweight): Option[Meta]                                 = t.meta
  def extractText(t: Bodyweight): Option[Narrative]                            = t.text
  def extractNote(t: Bodyweight): LitSeq[Annotation]                           = t.note
  def extractFocus(t: Bodyweight): LitSeq[Reference]                           = t.focus
  def extractPartOf(t: Bodyweight): LitSeq[Reference]                          = t.partOf
  def extractStatus(t: Bodyweight): OBSERVATION_STATUS                         = t.status
  def extractIssued(t: Bodyweight): Option[ZonedDateTime]                      = t.issued
  def extractMethod(t: Bodyweight): Option[CodeableConcept]                    = t.method
  def extractDevice(t: Bodyweight): Option[Reference]                          = t.device
  def extractBasedOn(t: Bodyweight): LitSeq[Reference]                         = t.basedOn
  def extractSubject(t: Bodyweight): Reference                                 = t.subject.get
  def extractLanguage(t: Bodyweight): Option[LANGUAGES]                        = t.language
  def extractCategory(t: Bodyweight): NonEmptyLitSeq[CodeableConcept]          = t.category.asNonEmpty
  def extractValue(t: Bodyweight): Option[Quantity]                            = t.value.map(_.toSubRefNonUnion[Quantity])
  def extractBodySite(t: Bodyweight): Option[CodeableConcept]                  = t.bodySite
  def extractSpecimen(t: Bodyweight): Option[Reference]                        = t.specimen
  def extractContained(t: Bodyweight): LitSeq[Resource]                        = t.contained
  def extractExtension(t: Bodyweight): LitSeq[Extension]                       = t.extension
  def extractEncounter(t: Bodyweight): Option[Reference]                       = t.encounter
  def extractPerformer(t: Bodyweight): LitSeq[Reference]                       = t.performer
  def extractHasMember(t: Bodyweight): LitSeq[Reference]                       = t.hasMember
  def extractIdentifier(t: Bodyweight): LitSeq[Identifier]                     = t.identifier
  def extractDerivedFrom(t: Bodyweight): LitSeq[Reference]                     = t.derivedFrom
  def extractEffective(t: Bodyweight): Bodyweight.EffectiveChoice              = t.effective.get.toSubRef
  def extractImplicitRules(t: Bodyweight): Option[UriStr]                      = t.implicitRules
  def extractCode(t: Bodyweight): CodeableConcept                              = t.code
  def extractInterpretation(t: Bodyweight): LitSeq[CodeableConcept]            = t.interpretation
  def extractDataAbsentReason(t: Bodyweight): Option[CodeableConcept]          = t.dataAbsentReason
  def extractModifierExtension(t: Bodyweight): LitSeq[Extension]               = t.modifierExtension
  def extractComponent(t: Bodyweight): LitSeq[Observation.Component]           = t.component
  def extractReferenceRange(t: Bodyweight): LitSeq[Observation.ReferenceRange] = t.referenceRange
  override val thisName: String                                                = "Bodyweight"
  override val searchParams: Map[String, Bodyweight => Seq[Any]]               = Vitalsigns.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Bodyweight] =
...
class Bodyweight(
    ...
    override val meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/bodyweight"))),
