...
object Codesystem_label extends CompanionFor[Codesystem_label] {
  ...
  override val profileUrl: Option[String]        = Some("http://hl7.org/fhir/StructureDefinition/codesystem-label")
  def apply(
      id: Option[String] = None,
      url: String,
      value: String,
      primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
  ): Codesystem_label = new Codesystem_label(
    id,
    url,
    value,
  ...
  override def fields(t: Codesystem_label): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Codesystem_label): Option[String]                   = t.id
  def extractUrl(t: Codesystem_label): String                          = t.url
  ...
  def unapply(o: Codesystem_label): Option[(Option[String], String, String)] = Some(
