...
object Observation_geneticsAncestry extends CompanionFor[Observation_geneticsAncestry] {
  ...
  override def fields(t: Observation_geneticsAncestry): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Observation_geneticsAncestry): String                          = t.url
  ...
  def unapply(o: Observation_geneticsAncestry): Option[(Option[String], String, NonEmptyLitSeq[Extension])] = Some(
