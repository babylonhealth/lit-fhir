...
object Codesystem_replacedby extends CompanionFor[Codesystem_replacedby] {
  ...
  override def fields(t: Codesystem_replacedby): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Codesystem_replacedby): String                          = t.url
  ...
  def unapply(o: Codesystem_replacedby): Option[(Option[String], String, Coding)] = Some(
