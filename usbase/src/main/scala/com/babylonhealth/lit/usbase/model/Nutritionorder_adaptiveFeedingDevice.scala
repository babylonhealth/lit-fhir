...
object Nutritionorder_adaptiveFeedingDevice extends CompanionFor[Nutritionorder_adaptiveFeedingDevice] {
  implicit def summonObjectAndCompanionNutritionorder_adaptiveFeedingDevice2018477986(
      o: Nutritionorder_adaptiveFeedingDevice): ObjectAndCompanion[Nutritionorder_adaptiveFeedingDevice, Nutritionorder_adaptiveFeedingDevice.type] =
    ObjectAndCompanion(o, this)
  override type ResourceType = Extension
  override type ParentType   = Extension
  override val baseType: CompanionFor[ResourceType] = Extension
  override val parentType: CompanionFor[ParentType] = Extension
  override val profileUrl: Option[String] = Some("http://hl7.org/fhir/StructureDefinition/nutritionorder-adaptiveFeedingDevice")
  def apply(
      id: Option[String] = None,
      value: CodeableConcept,
      primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
  ): Nutritionorder_adaptiveFeedingDevice = new Nutritionorder_adaptiveFeedingDevice(
    id,
    value,
  ...
  def extractValue(t: Nutritionorder_adaptiveFeedingDevice): CodeableConcept = t.value.get.toSubRefNonUnion[CodeableConcept]
  ...
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Nutritionorder_adaptiveFeedingDevice] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Nutritionorder_adaptiveFeedingDevice(
...
/** Materials used or needed to feed the patient.
  ...
  */
@POJOBoilerplate
class Nutritionorder_adaptiveFeedingDevice(
