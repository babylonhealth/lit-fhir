...
object Nutritionorder_adaptiveFeedingDevice extends CompanionFor[Nutritionorder_adaptiveFeedingDevice] {
  ...
  def extractUrl(t: Nutritionorder_adaptiveFeedingDevice): String        = t.url
  ...
  def unapply(o: Nutritionorder_adaptiveFeedingDevice): Option[(Option[String], String, CodeableConcept)] = Some(
