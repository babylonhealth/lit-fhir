...
object Iso21090_ADXP_censusTract extends CompanionFor[Iso21090_ADXP_censusTract] {
  ...
  override def fields(t: Iso21090_ADXP_censusTract): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Iso21090_ADXP_censusTract): Option[String]                   = t.id
  def extractUrl(t: Iso21090_ADXP_censusTract): String                          = t.url
  ...
  def unapply(o: Iso21090_ADXP_censusTract): Option[(Option[String], String, String)] = Some(
