...
object Iso21090_ADXP_censusTract extends CompanionFor[Iso21090_ADXP_censusTract] {
  ...
  def extractValue(t: Iso21090_ADXP_censusTract): String                        = t.value.get.value.asInstanceOf[String]
  ...
  def unapply(o: Iso21090_ADXP_censusTract): Option[(Option[String], String)] = Some(
