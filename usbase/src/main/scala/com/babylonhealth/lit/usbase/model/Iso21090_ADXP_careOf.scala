...
object Iso21090_ADXP_careOf extends CompanionFor[Iso21090_ADXP_careOf] {
  ...
  override def fields(t: Iso21090_ADXP_careOf): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Iso21090_ADXP_careOf): Option[String]                   = t.id
  def extractUrl(t: Iso21090_ADXP_careOf): String                          = t.url
  ...
  def unapply(o: Iso21090_ADXP_careOf): Option[(Option[String], String, String)] = Some(
