...
/** This is an equivalent of the string on which the extension is sent, but includes additional markdown (see
  * documentation about [markdown](datatypes.html#markdown). Note that using HTML
  * [xhtml](extension-rendering-xhtml.html) can allow for greater precision of display.
  *
