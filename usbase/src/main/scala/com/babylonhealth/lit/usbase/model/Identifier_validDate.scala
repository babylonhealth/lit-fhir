...
object Identifier_validDate extends CompanionFor[Identifier_validDate] {
  ...
  override def fields(t: Identifier_validDate): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Identifier_validDate): String                          = t.url
  ...
  def unapply(o: Identifier_validDate): Option[(Option[String], String, FHIRDateTime)] = Some(
