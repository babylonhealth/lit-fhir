...
object Valueset_conceptOrder extends CompanionFor[Valueset_conceptOrder] {
  ...
  override val profileUrl: Option[String]        = Some("http://hl7.org/fhir/StructureDefinition/valueset-conceptOrder")
  def apply(
      id: Option[String] = None,
      url: String,
      value: Int,
      primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
  ): Valueset_conceptOrder = new Valueset_conceptOrder(
    id,
    url,
    value,
  ...
  override def fields(t: Valueset_conceptOrder): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Valueset_conceptOrder): String                          = t.url
  ...
  def unapply(o: Valueset_conceptOrder): Option[(Option[String], String, Int)] = Some(
