...
object Goal_acceptance extends CompanionFor[Goal_acceptance] {
  ...
  override def fields(t: Goal_acceptance): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Goal_acceptance): String                          = t.url
  ...
  def unapply(o: Goal_acceptance): Option[(Option[String], String, NonEmptyLitSeq[Extension])] = Some(
