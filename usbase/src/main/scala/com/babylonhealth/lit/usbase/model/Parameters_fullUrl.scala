...
object Parameters_fullUrl extends CompanionFor[Parameters_fullUrl] {
  ...
  override def fields(t: Parameters_fullUrl): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Parameters_fullUrl): String                          = t.url
  ...
  def unapply(o: Parameters_fullUrl): Option[(Option[String], String, UriStr)] = Some(
