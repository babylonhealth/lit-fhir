...
object MarketingStatus extends CompanionFor[MarketingStatus] {
  implicit def summonObjectAndCompanionMarketingStatus56281379(
  ...
  override val parentType: CompanionFor[ParentType] = MarketingStatus
...
/** Base StructureDefinition for MarketingStatus Type: The marketing status describes the date when a medicinal product is
  ...
  * @param country
  *   - The country in which the marketing authorisation has been granted shall be specified It should be specified using the ISO
  ...
  *   the manufacturer/distributor) in a country and/or jurisdiction shall be provided A complete date consisting of day, month
  *   and year shall be specified using the ISO 8601 date format NOTE “Placed on the market” refers to the release of the
  ...
  *   jurisdiction apply, the jurisdiction can be specified using an appropriate controlled terminology The controlled term and
