...
/** Base StructureDefinition for MarketingStatus Type: The marketing status describes the date when a medicinal product
  * is actually put on the market or the date as of which it is no longer available.
  *
