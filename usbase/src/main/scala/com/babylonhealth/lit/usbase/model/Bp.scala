...
object Bp extends CompanionFor[Bp] {
  implicit def summonObjectAndCompanionBp_2023837900(o: Bp): ObjectAndCompanion[Bp, Bp.type] =
  ...
  val effective: FHIRComponentFieldMeta[Bp.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Bp.EffectiveChoice], true, lTagOf[Union_0934386166])
  ...
  val component: FHIRComponentFieldMeta[NonEmptyLitSeq[Observation.Component]] =
    FHIRComponentFieldMeta(
      "component",
      lTagOf[NonEmptyLitSeq[Observation.Component]],
      false,
      lTagOf[Observation.Component])
