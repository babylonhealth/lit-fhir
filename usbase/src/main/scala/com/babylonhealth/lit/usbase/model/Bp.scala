...
object Bp extends CompanionFor[Bp] {
  implicit def summonObjectAndCompanionBp1030252259(o: Bp): ObjectAndCompanion[Bp, Bp.type] = ObjectAndCompanion(o, this)
  ...
  override val profileUrl: Option[String]           = Some("http://hl7.org/fhir/StructureDefinition/bp")
  type EffectiveChoice = Choice[UnionDateTimeOrPeriod]
  def apply(
      id: Option[String] = None,
      meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/bp"))),
  ...
  val effective: FHIRComponentFieldMeta[Bp.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Bp.EffectiveChoice], true, lTagOf[UnionDateTimeOrPeriod])
  ...
  val component: FHIRComponentFieldMeta[NonEmptyLitSeq[Observation.Component]] =
    FHIRComponentFieldMeta("component", lTagOf[NonEmptyLitSeq[Observation.Component]], false, lTagOf[Observation.Component])
  ...
  override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Try(
    Seq(
      ...
      FHIRComponentField[Bp.EffectiveChoice](effective, t.effective.get.toSubRef),
      ...
      FHIRComponentField[NonEmptyLitSeq[Observation.Component]](component, t.component.asNonEmpty),
      FHIRComponentField[LitSeq[Observation.ReferenceRange]](referenceRange, t.referenceRange)
    ))
  override def fields(t: Bp): Seq[FHIRComponentField[_]]               = fieldsFromParent(t).get
  def extractId(t: Bp): Option[String]                                 = t.id
  def extractMeta(t: Bp): Option[Meta]                                 = t.meta
  def extractText(t: Bp): Option[Narrative]                            = t.text
  def extractNote(t: Bp): LitSeq[Annotation]                           = t.note
  def extractFocus(t: Bp): LitSeq[Reference]                           = t.focus
  def extractPartOf(t: Bp): LitSeq[Reference]                          = t.partOf
  def extractStatus(t: Bp): OBSERVATION_STATUS                         = t.status
  def extractIssued(t: Bp): Option[ZonedDateTime]                      = t.issued
  def extractMethod(t: Bp): Option[CodeableConcept]                    = t.method
  def extractDevice(t: Bp): Option[Reference]                          = t.device
  def extractBasedOn(t: Bp): LitSeq[Reference]                         = t.basedOn
  ...
  def extractExtension(t: Bp): LitSeq[Extension]                       = t.extension
  def extractEncounter(t: Bp): Option[Reference]                       = t.encounter
  def extractPerformer(t: Bp): LitSeq[Reference]                       = t.performer
  def extractHasMember(t: Bp): LitSeq[Reference]                       = t.hasMember
  def extractIdentifier(t: Bp): LitSeq[Identifier]                     = t.identifier
  def extractDerivedFrom(t: Bp): LitSeq[Reference]                     = t.derivedFrom
  def extractEffective(t: Bp): Bp.EffectiveChoice                      = t.effective.get.toSubRef
  def extractImplicitRules(t: Bp): Option[UriStr]                      = t.implicitRules
  def extractCode(t: Bp): CodeableConcept                              = t.code
  def extractInterpretation(t: Bp): LitSeq[CodeableConcept]            = t.interpretation
  def extractDataAbsentReason(t: Bp): Option[CodeableConcept]          = t.dataAbsentReason
  def extractModifierExtension(t: Bp): LitSeq[Extension]               = t.modifierExtension
  def extractComponent(t: Bp): NonEmptyLitSeq[Observation.Component]   = t.component.asNonEmpty
  def extractReferenceRange(t: Bp): LitSeq[Observation.ReferenceRange] = t.referenceRange
  override val thisName: String                                        = "Bp"
  override val searchParams: Map[String, Bp => Seq[Any]]               = Vitalsigns.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Bp] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Bp(
          ...
          cursor.decodeAs[NonEmptyLitSeq[Observation.Component]]("component", None),
...
class Bp(
    ...
    override val meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/bp"))),
