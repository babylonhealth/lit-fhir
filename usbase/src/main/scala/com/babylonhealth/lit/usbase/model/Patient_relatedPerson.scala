...
object Patient_relatedPerson extends CompanionFor[Patient_relatedPerson] {
  implicit def summonObjectAndCompanionPatient_relatedPerson_1377306372(
...
/** In some cases a Patient.contact will also be populated as a RelatedPerson resource. This linkage permits the linkage
  * between the 2 resources to be able to accurately indicate a representation of the same individual, and updating
  * details between could be appropriate.
  *
