...
object Elementdefinition_isCommonBinding extends CompanionFor[Elementdefinition_isCommonBinding] {
  ...
  def extractUrl(t: Elementdefinition_isCommonBinding): String                          = t.url
  ...
  def unapply(o: Elementdefinition_isCommonBinding): Option[(Option[String], String, Boolean)] = Some(
