...
object Patient_cadavericDonor extends CompanionFor[Patient_cadavericDonor] {
  implicit def summonObjectAndCompanionPatient_cadavericDonor_1668737567(
      o: Patient_cadavericDonor): ObjectAndCompanion[Patient_cadavericDonor, Patient_cadavericDonor.type] =
    ObjectAndCompanion(o, this)
  override type ResourceType = Extension
  override type ParentType   = Extension
  override val baseType: CompanionFor[ResourceType] = Extension
  override val parentType: CompanionFor[ParentType] = Extension
  override val profileUrl: Option[String]           = Some("http://hl7.org/fhir/StructureDefinition/patient-cadavericDonor")
  def apply(
  ...
  override def fields(t: Patient_cadavericDonor): Seq[FHIRComponentField[_]] = fieldsFromParent(t).get
  ...
  def unapply(o: Patient_cadavericDonor): Option[(Option[String], Boolean)]  = Some((o.id, o.value.get.toSubRefNonUnion[Boolean]))
