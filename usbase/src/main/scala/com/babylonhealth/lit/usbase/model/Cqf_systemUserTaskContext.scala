...
object Cqf_systemUserTaskContext extends CompanionFor[Cqf_systemUserTaskContext] {
  ...
  override def fields(t: Cqf_systemUserTaskContext): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Cqf_systemUserTaskContext): String                          = t.url
  ...
  def unapply(o: Cqf_systemUserTaskContext): Option[(Option[String], String, CodeableConcept)] = Some(
