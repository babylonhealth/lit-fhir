...
object Cqf_systemUserTaskContext extends CompanionFor[Cqf_systemUserTaskContext] {
  implicit def summonObjectAndCompanionCqf_systemUserTaskContext327935771(
...
/** The task the system user is performing, e.g. laboratory results review, medication list review, etc. This
  * information can be used to tailor decision support outputs, such as recommended information resources.
  *
