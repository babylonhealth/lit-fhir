...
object Observation_geneticsCopyNumberEvent extends CompanionFor[Observation_geneticsCopyNumberEvent] {
  implicit def summonObjectAndCompanionObservation_geneticsCopyNumberEvent_347973140(
      o: Observation_geneticsCopyNumberEvent): ObjectAndCompanion[Observation_geneticsCopyNumberEvent, Observation_geneticsCopyNumberEvent.type] =
    ObjectAndCompanion(o, this)
  override type ResourceType = Extension
  override type ParentType   = Extension
  override val baseType: CompanionFor[ResourceType] = Extension
  override val parentType: CompanionFor[ParentType] = Extension
  override val profileUrl: Option[String] = Some("http://hl7.org/fhir/StructureDefinition/observation-geneticsCopyNumberEvent")
  def apply(
      id: Option[String] = None,
      value: CodeableConcept,
      primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
  ): Observation_geneticsCopyNumberEvent = new Observation_geneticsCopyNumberEvent(
    id,
    value,
  ...
  def extractValue(t: Observation_geneticsCopyNumberEvent): CodeableConcept = t.value.get.toSubRefNonUnion[CodeableConcept]
  ...
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Observation_geneticsCopyNumberEvent] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Observation_geneticsCopyNumberEvent(
...
/** A variation that increases or decreases the copy number of a given region
  * ([SO:0001019](http://www.sequenceontology.org/browser/current_svn/term/SO:0001019)). Values: amplification/deletion/LOH.
  *
  ...
  */
@POJOBoilerplate
class Observation_geneticsCopyNumberEvent(
