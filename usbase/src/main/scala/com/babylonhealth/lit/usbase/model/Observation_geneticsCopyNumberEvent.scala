...
object Observation_geneticsCopyNumberEvent extends CompanionFor[Observation_geneticsCopyNumberEvent] {
  ...
  override def fields(t: Observation_geneticsCopyNumberEvent): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Observation_geneticsCopyNumberEvent): String        = t.url
  ...
  def unapply(o: Observation_geneticsCopyNumberEvent): Option[(Option[String], String, CodeableConcept)] = Some(
