...
object MinValue extends CompanionFor[MinValue] {
  ...
  type ValueChoice = Choice[Union01845407622]
  def apply(
  ...
  val value: FHIRComponentFieldMeta[MinValue.ValueChoice] =
    FHIRComponentFieldMeta("value", lTagOf[MinValue.ValueChoice], true, lTagOf[Union01845407622])
  ...
  def unapply(o: MinValue): Option[(Option[String], MinValue.ValueChoice)] = Some((o.id, o.value.get.toSubRef))
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[MinValue] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new MinValue(
          cursor.decodeAs[Option[String]]("id", Some(None)),
          cursor.decodeRef[Union01845407622]("value"),
