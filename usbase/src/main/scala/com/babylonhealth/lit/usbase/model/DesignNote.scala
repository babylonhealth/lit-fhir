...
object DesignNote extends CompanionFor[DesignNote] {
  implicit def summonObjectAndCompanionDesignNote_1915315631(
      o: DesignNote): ObjectAndCompanion[DesignNote, DesignNote.type] = ObjectAndCompanion(o, this)
  override type ResourceType = Extension
  override type ParentType   = Extension
  override val baseType: CompanionFor[ResourceType] = Extension
  override val parentType: CompanionFor[ParentType] = Extension
  override val profileUrl: Option[String]           = Some("http://hl7.org/fhir/StructureDefinition/designNote")
  def apply(
...
/** Information captured by the author/maintainer of the questionnaire for development purposes, not intended to be seen
  * by users.
  *
