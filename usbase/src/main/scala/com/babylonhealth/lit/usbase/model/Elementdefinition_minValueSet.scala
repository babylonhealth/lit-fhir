...
object Elementdefinition_minValueSet extends CompanionFor[Elementdefinition_minValueSet] {
  implicit def summonObjectAndCompanionElementdefinition_minValueSet_1001437180(
...
/** The minimum allowable value set, for use when the binding strength is 'required' or 'extensible'. This value set is
  * the minimum value set that any conformant system SHALL support.
  *
