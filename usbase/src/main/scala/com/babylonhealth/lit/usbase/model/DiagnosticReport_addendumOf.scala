...
object DiagnosticReport_addendumOf extends CompanionFor[DiagnosticReport_addendumOf] {
  ...
  override def fields(t: DiagnosticReport_addendumOf): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: DiagnosticReport_addendumOf): String                          = t.url
  ...
  def unapply(o: DiagnosticReport_addendumOf): Option[(Option[String], String, Reference)] = Some(
