...
object Iso21090_SC_coding extends CompanionFor[Iso21090_SC_coding] {
  ...
  override def fields(t: Iso21090_SC_coding): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Iso21090_SC_coding): String                          = t.url
  ...
  def unapply(o: Iso21090_SC_coding): Option[(Option[String], String, Coding)] = Some(
