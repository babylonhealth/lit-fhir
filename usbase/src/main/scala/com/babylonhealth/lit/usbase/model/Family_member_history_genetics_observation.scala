...
object Family_member_history_genetics_observation extends CompanionFor[Family_member_history_genetics_observation] {
  ...
  override def fields(t: Family_member_history_genetics_observation): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Family_member_history_genetics_observation): String        = t.url
  ...
  def unapply(o: Family_member_history_genetics_observation): Option[(Option[String], String, Reference)] = Some(
