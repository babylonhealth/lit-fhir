...
object Questionnaireresponse_completionMode extends CompanionFor[Questionnaireresponse_completionMode] {
  implicit def summonObjectAndCompanionQuestionnaireresponse_completionMode_2040106243(
      o: Questionnaireresponse_completionMode): ObjectAndCompanion[Questionnaireresponse_completionMode, Questionnaireresponse_completionMode.type] =
    ObjectAndCompanion(o, this)
  override type ResourceType = Extension
  override type ParentType   = Extension
  override val baseType: CompanionFor[ResourceType] = Extension
  override val parentType: CompanionFor[ParentType] = Extension
  override val profileUrl: Option[String] = Some("http://hl7.org/fhir/StructureDefinition/questionnaireresponse-completionMode")
  def apply(
      id: Option[String] = None,
      value: CodeableConcept,
      primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
  ): Questionnaireresponse_completionMode = new Questionnaireresponse_completionMode(
    id,
    value,
  ...
  def extractValue(t: Questionnaireresponse_completionMode): CodeableConcept = t.value.get.toSubRefNonUnion[CodeableConcept]
  ...
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Questionnaireresponse_completionMode] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Questionnaireresponse_completionMode(
...
/** Indicates how the individual completing the QuestionnaireResponse provided their responses.
  ...
  */
@POJOBoilerplate
class Questionnaireresponse_completionMode(
