...
object Rendering_xhtml extends CompanionFor[Rendering_xhtml] {
  ...
  override def fields(t: Rendering_xhtml): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Rendering_xhtml): Option[String]                   = t.id
  def extractUrl(t: Rendering_xhtml): String                          = t.url
  ...
  def unapply(o: Rendering_xhtml): Option[(Option[String], String, String)] = Some(
