...
object Contactpoint_area extends CompanionFor[Contactpoint_area] {
  implicit def summonObjectAndCompanionContactpoint_area_1565411624(
      o: Contactpoint_area): ObjectAndCompanion[Contactpoint_area, Contactpoint_area.type] = ObjectAndCompanion(o, this)
  ...
  def unapply(o: Contactpoint_area): Option[(Option[String], String)] = Some(
...
/** The area/zone/city code that, in some areas, may be omitted when dialing locally within the zone. This extension is
  * used when a system wishes to designate specific parts of a phone number (and potentially place constraints on which
  * components must be present and how they're filled in).
  *
