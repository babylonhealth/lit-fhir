...
object Resource_effectivePeriod extends CompanionFor[Resource_effectivePeriod] {
  ...
  ): Resource_effectivePeriod = new Resource_effectivePeriod(
    id,
    url,
    value,
  ...
  def extractUrl(t: Resource_effectivePeriod): String                          = t.url
  ...
  def unapply(o: Resource_effectivePeriod): Option[(Option[String], String, Period)] = Some(
    (o.id, o.url, o.value.get.toSubRefNonUnion[Period]))
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Resource_effectivePeriod] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Resource_effectivePeriod(
...
/** The period during which the resource content was or is planned to be effective.
  ...
  */
@POJOBoilerplate
class Resource_effectivePeriod(
