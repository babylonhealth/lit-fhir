...
object Resource_effectivePeriod extends CompanionFor[Resource_effectivePeriod] {
  ...
  def unapply(o: Resource_effectivePeriod): Option[(Option[String], Period)] = Some((o.id, o.value.get.toSubRefNonUnion[Period]))
...
class Resource_effectivePeriod(
    ...
    override val primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
      ...
      id = id,
      value = Some(new Choice("Period", value)(UnionAllTag)),
