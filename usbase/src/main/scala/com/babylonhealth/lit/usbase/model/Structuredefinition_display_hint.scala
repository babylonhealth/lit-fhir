...
object Structuredefinition_display_hint extends CompanionFor[Structuredefinition_display_hint] {
  ...
  override def fields(t: Structuredefinition_display_hint): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Structuredefinition_display_hint): Option[String]                   = t.id
  def extractUrl(t: Structuredefinition_display_hint): String                          = t.url
  ...
  def unapply(o: Structuredefinition_display_hint): Option[(Option[String], String, String)] = Some(
