...
object Observation_secondaryFinding extends CompanionFor[Observation_secondaryFinding] {
  ...
  override def fields(t: Observation_secondaryFinding): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Observation_secondaryFinding): String                          = t.url
  ...
  def unapply(o: Observation_secondaryFinding): Option[(Option[String], String, CodeableConcept)] = Some(
