...
object Valueset_caseSensitive extends CompanionFor[Valueset_caseSensitive] {
  ...
  override def fields(t: Valueset_caseSensitive): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Valueset_caseSensitive): String                          = t.url
  ...
  def unapply(o: Valueset_caseSensitive): Option[(Option[String], String, Boolean)] = Some(
