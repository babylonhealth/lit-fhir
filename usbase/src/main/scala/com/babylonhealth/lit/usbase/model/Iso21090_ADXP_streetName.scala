...
object Iso21090_ADXP_streetName extends CompanionFor[Iso21090_ADXP_streetName] {
  ...
  def extractValue(t: Iso21090_ADXP_streetName): String                        = t.value.get.value.asInstanceOf[String]
  ...
  def unapply(o: Iso21090_ADXP_streetName): Option[(Option[String], String)] = Some(
