...
object Iso21090_ADXP_streetName extends CompanionFor[Iso21090_ADXP_streetName] {
  ...
  override def fields(t: Iso21090_ADXP_streetName): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Iso21090_ADXP_streetName): Option[String]                   = t.id
  def extractUrl(t: Iso21090_ADXP_streetName): String                          = t.url
  ...
  def unapply(o: Iso21090_ADXP_streetName): Option[(Option[String], String, String)] = Some(
