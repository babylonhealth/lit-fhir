...
object Rendered_value extends CompanionFor[Rendered_value] {
  ...
  override def fields(t: Rendered_value): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Rendered_value): Option[String]                   = t.id
  def extractUrl(t: Rendered_value): String                          = t.url
  ...
  def unapply(o: Rendered_value): Option[(Option[String], String, String)] = Some(
