...
object Devicerequest_patientInstruction extends CompanionFor[Devicerequest_patientInstruction] {
  ...
  override def fields(t: Devicerequest_patientInstruction): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Devicerequest_patientInstruction): String                          = t.url
  ...
  def unapply(o: Devicerequest_patientInstruction): Option[(Option[String], String, NonEmptyLitSeq[Extension])] = Some(
