...
object Ldlcholesterol extends CompanionFor[Ldlcholesterol] {
  implicit def summonObjectAndCompanionLdlcholesterol_1875075281(
      o: Ldlcholesterol): ObjectAndCompanion[Ldlcholesterol, Ldlcholesterol.type] = ObjectAndCompanion(o, this)
  ...
  def apply(
      ...
      effective: Option[Ldlcholesterol.EffectiveChoice] = None,
  ...
  ): Ldlcholesterol = new Ldlcholesterol(
    id,
    meta,
    text,
    code,
  ...
  val referenceRange: FHIRComponentFieldMeta[Observation.ReferenceRange] =
    FHIRComponentFieldMeta("referenceRange", lTagOf[Observation.ReferenceRange], false, lTagOf[Observation.ReferenceRange])
  ...
  override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Try(
    Seq(
      ...
      FHIRComponentField[Option[Ldlcholesterol.EffectiveChoice]](effective, t.effective),
  ...
  override def fields(t: Ldlcholesterol): Seq[FHIRComponentField[_]]              = fieldsFromParent(t).get
  def extractId(t: Ldlcholesterol): Option[String]                                = t.id
  def extractMeta(t: Ldlcholesterol): Option[Meta]                                = t.meta
  def extractText(t: Ldlcholesterol): Option[Narrative]                           = t.text
  def extractCode(t: Ldlcholesterol): CodeableConcept                             = t.code
  def extractNote(t: Ldlcholesterol): LitSeq[Annotation]                          = t.note
  def extractFocus(t: Ldlcholesterol): LitSeq[Reference]                          = t.focus
  def extractPartOf(t: Ldlcholesterol): LitSeq[Reference]                         = t.partOf
  def extractStatus(t: Ldlcholesterol): OBSERVATION_STATUS                        = t.status
  def extractIssued(t: Ldlcholesterol): Option[ZonedDateTime]                     = t.issued
  def extractMethod(t: Ldlcholesterol): Option[CodeableConcept]                   = t.method
  def extractDevice(t: Ldlcholesterol): Option[Reference]                         = t.device
  def extractBasedOn(t: Ldlcholesterol): LitSeq[Reference]                        = t.basedOn
  ...
  def extractValue(t: Ldlcholesterol): Option[Quantity]                           = t.value.map(x => x.toSubRefNonUnion[Quantity])
  ...
  def extractExtension(t: Ldlcholesterol): LitSeq[Extension]                      = t.extension
  def extractEncounter(t: Ldlcholesterol): Option[Reference]                      = t.encounter
  def extractPerformer(t: Ldlcholesterol): LitSeq[Reference]                      = t.performer
  def extractIdentifier(t: Ldlcholesterol): LitSeq[Identifier]                    = t.identifier
  def extractEffective(t: Ldlcholesterol): Option[Ldlcholesterol.EffectiveChoice] = t.effective
  def extractImplicitRules(t: Ldlcholesterol): Option[UriStr]                     = t.implicitRules
  def extractInterpretation(t: Ldlcholesterol): Option[CodeableConcept]           = t.interpretation.headOption
  def extractDataAbsentReason(t: Ldlcholesterol): Option[CodeableConcept]         = t.dataAbsentReason
  def extractModifierExtension(t: Ldlcholesterol): LitSeq[Extension]              = t.modifierExtension
  def extractComponent(t: Ldlcholesterol): LitSeq[Observation.Component]          = t.component
  def extractReferenceRange(t: Ldlcholesterol): Observation.ReferenceRange        = t.referenceRange.head
  override val thisName: String                                                   = "Ldlcholesterol"
  override val searchParams: Map[String, Ldlcholesterol => Seq[Any]]              = Observation.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Ldlcholesterol] =
...
/** LDL Cholesterol Result
  ...
  *   parent: referenceRange. Forbids the use of the following fields which were optional in the parent: hasMember, derivedFrom.
  * @param id
...
class Ldlcholesterol(
    ...
    override val meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/ldlcholesterol"))),
    ...
    override val effective: Option[Ldlcholesterol.EffectiveChoice] = None,
