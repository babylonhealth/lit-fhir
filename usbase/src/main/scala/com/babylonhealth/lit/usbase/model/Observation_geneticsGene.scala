...
object Observation_geneticsGene extends CompanionFor[Observation_geneticsGene] {
  ...
  override def fields(t: Observation_geneticsGene): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Observation_geneticsGene): String                          = t.url
  ...
  def unapply(o: Observation_geneticsGene): Option[(Option[String], String, CodeableConcept)] = Some(
