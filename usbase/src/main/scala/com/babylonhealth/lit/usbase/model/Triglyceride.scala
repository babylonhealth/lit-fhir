...
object Triglyceride extends CompanionFor[Triglyceride] {
  ...
  def apply(
      ...
      effective: Option[Triglyceride.EffectiveChoice] = None,
  ...
  val effective: FHIRComponentFieldMeta[Option[Triglyceride.EffectiveChoice]] =
    FHIRComponentFieldMeta("effective", lTagOf[Option[Triglyceride.EffectiveChoice]], true, lTagOf[Union00107722725])
  ...
  override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Try(
    Seq(
      ...
      FHIRComponentField[Option[Triglyceride.EffectiveChoice]](effective, t.effective),
  ...
  override def fields(t: Triglyceride): Seq[FHIRComponentField[_]]            = fieldsFromParent(t).get
  def extractId(t: Triglyceride): Option[String]                              = t.id
  def extractMeta(t: Triglyceride): Option[Meta]                              = t.meta
  def extractText(t: Triglyceride): Option[Narrative]                         = t.text
  def extractCode(t: Triglyceride): CodeableConcept                           = t.code
  def extractNote(t: Triglyceride): LitSeq[Annotation]                        = t.note
  def extractFocus(t: Triglyceride): LitSeq[Reference]                        = t.focus
  def extractPartOf(t: Triglyceride): LitSeq[Reference]                       = t.partOf
  def extractStatus(t: Triglyceride): OBSERVATION_STATUS                      = t.status
  def extractIssued(t: Triglyceride): Option[ZonedDateTime]                   = t.issued
  def extractMethod(t: Triglyceride): Option[CodeableConcept]                 = t.method
  def extractDevice(t: Triglyceride): Option[Reference]                       = t.device
  def extractBasedOn(t: Triglyceride): LitSeq[Reference]                      = t.basedOn
  ...
  def extractExtension(t: Triglyceride): LitSeq[Extension]                    = t.extension
  def extractEncounter(t: Triglyceride): Option[Reference]                    = t.encounter
  def extractPerformer(t: Triglyceride): LitSeq[Reference]                    = t.performer
  def extractIdentifier(t: Triglyceride): LitSeq[Identifier]                  = t.identifier
  def extractEffective(t: Triglyceride): Option[Triglyceride.EffectiveChoice] = t.effective
  def extractImplicitRules(t: Triglyceride): Option[UriStr]                   = t.implicitRules
  def extractInterpretation(t: Triglyceride): Option[CodeableConcept]         = t.interpretation.headOption
  def extractDataAbsentReason(t: Triglyceride): Option[CodeableConcept]       = t.dataAbsentReason
  def extractModifierExtension(t: Triglyceride): LitSeq[Extension]            = t.modifierExtension
  def extractComponent(t: Triglyceride): LitSeq[Observation.Component]        = t.component
  def extractReferenceRange(t: Triglyceride): Observation.ReferenceRange      = t.referenceRange.head
  override val thisName: String                                               = "Triglyceride"
  override val searchParams: Map[String, Triglyceride => Seq[Any]]            = Observation.searchParams
...
class Triglyceride(
    ...
    override val meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/triglyceride"))),
    ...
    override val effective: Option[Triglyceride.EffectiveChoice] = None,
