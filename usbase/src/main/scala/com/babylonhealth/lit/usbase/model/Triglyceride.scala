...
object Triglyceride extends CompanionFor[Triglyceride] {
  ...
  def extractValue(t: Triglyceride): Option[Quantity]                         = t.value.map(_.value.asInstanceOf[Quantity])
...
class Triglyceride(
    ...
    override val meta: Option[Meta] = Some(
      new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/triglyceride"))),
