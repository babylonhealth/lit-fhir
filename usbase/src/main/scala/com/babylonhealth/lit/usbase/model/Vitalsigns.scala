...
object Vitalsigns extends CompanionFor[Vitalsigns] {
  implicit def summonObjectAndCompanionVitalsigns_163272865(o: Vitalsigns): ObjectAndCompanion[Vitalsigns, Vitalsigns.type] =
  ...
  def apply(
      ...
      value: Option[Vitalsigns.ValueChoice] = None,
      ...
      effective: Vitalsigns.EffectiveChoice,
  ...
  val value: FHIRComponentFieldMeta[Option[Vitalsigns.ValueChoice]] =
    FHIRComponentFieldMeta("value", lTagOf[Option[Vitalsigns.ValueChoice]], true, lTagOf[Union02118820890])
  ...
  val effective: FHIRComponentFieldMeta[Vitalsigns.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Vitalsigns.EffectiveChoice], true, lTagOf[UnionDateTimeOrPeriod])
  ...
  override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Try(
    Seq(
      ...
      FHIRComponentField[Option[Vitalsigns.ValueChoice]](value, t.value),
      ...
      FHIRComponentField[Vitalsigns.EffectiveChoice](effective, t.effective.get.toSubRef),
  ...
  override def fields(t: Vitalsigns): Seq[FHIRComponentField[_]]               = fieldsFromParent(t).get
  def extractId(t: Vitalsigns): Option[String]                                 = t.id
  def extractMeta(t: Vitalsigns): Option[Meta]                                 = t.meta
  def extractText(t: Vitalsigns): Option[Narrative]                            = t.text
  def extractCode(t: Vitalsigns): CodeableConcept                              = t.code
  def extractNote(t: Vitalsigns): LitSeq[Annotation]                           = t.note
  def extractFocus(t: Vitalsigns): LitSeq[Reference]                           = t.focus
  def extractPartOf(t: Vitalsigns): LitSeq[Reference]                          = t.partOf
  def extractStatus(t: Vitalsigns): OBSERVATION_STATUS                         = t.status
  def extractIssued(t: Vitalsigns): Option[ZonedDateTime]                      = t.issued
  def extractMethod(t: Vitalsigns): Option[CodeableConcept]                    = t.method
  def extractDevice(t: Vitalsigns): Option[Reference]                          = t.device
  def extractBasedOn(t: Vitalsigns): LitSeq[Reference]                         = t.basedOn
  def extractSubject(t: Vitalsigns): Reference                                 = t.subject.get
  def extractLanguage(t: Vitalsigns): Option[LANGUAGES]                        = t.language
  def extractCategory(t: Vitalsigns): NonEmptyLitSeq[CodeableConcept]          = t.category.asNonEmpty
  def extractValue(t: Vitalsigns): Option[Vitalsigns.ValueChoice]              = t.value
  def extractBodySite(t: Vitalsigns): Option[CodeableConcept]                  = t.bodySite
  def extractSpecimen(t: Vitalsigns): Option[Reference]                        = t.specimen
  def extractContained(t: Vitalsigns): LitSeq[Resource]                        = t.contained
  def extractExtension(t: Vitalsigns): LitSeq[Extension]                       = t.extension
  def extractEncounter(t: Vitalsigns): Option[Reference]                       = t.encounter
  def extractPerformer(t: Vitalsigns): LitSeq[Reference]                       = t.performer
  def extractHasMember(t: Vitalsigns): LitSeq[Reference]                       = t.hasMember
  def extractIdentifier(t: Vitalsigns): LitSeq[Identifier]                     = t.identifier
  def extractDerivedFrom(t: Vitalsigns): LitSeq[Reference]                     = t.derivedFrom
  def extractEffective(t: Vitalsigns): Vitalsigns.EffectiveChoice              = t.effective.get.toSubRef
  def extractImplicitRules(t: Vitalsigns): Option[UriStr]                      = t.implicitRules
  def extractInterpretation(t: Vitalsigns): LitSeq[CodeableConcept]            = t.interpretation
  def extractDataAbsentReason(t: Vitalsigns): Option[CodeableConcept]          = t.dataAbsentReason
  def extractModifierExtension(t: Vitalsigns): LitSeq[Extension]               = t.modifierExtension
  def extractComponent(t: Vitalsigns): LitSeq[Observation.Component]           = t.component
  def extractReferenceRange(t: Vitalsigns): LitSeq[Observation.ReferenceRange] = t.referenceRange
  override val thisName: String                                                = "Vitalsigns"
  override val searchParams: Map[String, Vitalsigns => Seq[Any]]               = Observation.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Vitalsigns] =
...
/** FHIR Vital Signs Profile
  ...
  *   parent: subject, category, effective.
  * @param id
  ...
  * @param value
  *   - Vital Signs value are recorded using the Quantity data type. For supporting observations such as Cuff size could use
  *   other datatypes such as CodeableConcept.
  * @param bodySite
...
class Vitalsigns(
    ...
    override val meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/vitalsigns"))),
    ...
    category: NonEmptyLitSeq[CodeableConcept],
    override val value: Option[Vitalsigns.ValueChoice] = None,
