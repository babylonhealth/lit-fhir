...
object Vitalsigns extends CompanionFor[Vitalsigns] {
  implicit def summonObjectAndCompanionVitalsigns_319118484(
      o: Vitalsigns): ObjectAndCompanion[Vitalsigns, Vitalsigns.type] = ObjectAndCompanion(o, this)
...
/** FHIR Vital Signs Profile
  ...
  *
  * @constructor
  *   Inherits all params from parent. Refines the types of: effective. Requires the following fields which were
  *   optional in the parent: subject, category, effective.
  * @param id
  ...
  * @param value
  *   - Vital Signs value are recorded using the Quantity data type. For supporting observations such as Cuff size could
  *   use other datatypes such as CodeableConcept.
  * @param bodySite
...
class Vitalsigns(
    ...
    override val meta: Option[Meta] = Some(
      new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/vitalsigns"))),
