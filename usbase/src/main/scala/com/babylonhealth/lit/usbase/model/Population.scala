...
/** Base StructureDefinition for Population Type: A populatioof people with some set of grouping criteria.
  ...
  *
  * @constructor Introduces the fields race, age, gender, physiologicalCondition.
  * @param id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
  * @param race - Race of the specific population.
  * @param age - The age of the specific population.
  ...
  * @param physiologicalCondition - The existing physiological conditions of the specific population to which this applies.
  */
@POJOBoilerplate
class Population(
