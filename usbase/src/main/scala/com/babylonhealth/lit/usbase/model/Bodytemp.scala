...
object Bodytemp extends CompanionFor[Bodytemp] {
  implicit def summonObjectAndCompanionBodytemp1257104203(o: Bodytemp): ObjectAndCompanion[Bodytemp, Bodytemp.type] =
  ...
  val effective: FHIRComponentFieldMeta[Bodytemp.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Bodytemp.EffectiveChoice], true, lTagOf[Union_0934386166])
...
class Bodytemp(
    ...
    override val meta: Option[Meta] = Some(
      new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/bodytemp"))),
