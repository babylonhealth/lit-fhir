...
object Bodytemp extends CompanionFor[Bodytemp] {
  implicit def summonObjectAndCompanionBodytemp_1345834165(o: Bodytemp): ObjectAndCompanion[Bodytemp, Bodytemp.type] =
  ...
  override val profileUrl: Option[String]           = Some("http://hl7.org/fhir/StructureDefinition/bodytemp")
  type EffectiveChoice = Choice[UnionDateTimeOrPeriod]
  def apply(
      id: Option[String] = None,
      meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/bodytemp"))),
      ...
      effective: Bodytemp.EffectiveChoice,
  ...
  val effective: FHIRComponentFieldMeta[Bodytemp.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Bodytemp.EffectiveChoice], true, lTagOf[UnionDateTimeOrPeriod])
  ...
  override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Try(
    Seq(
      ...
      FHIRComponentField[Bodytemp.EffectiveChoice](effective, t.effective.get.toSubRef),
  ...
  override def fields(t: Bodytemp): Seq[FHIRComponentField[_]]               = fieldsFromParent(t).get
  def extractId(t: Bodytemp): Option[String]                                 = t.id
  def extractMeta(t: Bodytemp): Option[Meta]                                 = t.meta
  def extractText(t: Bodytemp): Option[Narrative]                            = t.text
  def extractNote(t: Bodytemp): LitSeq[Annotation]                           = t.note
  def extractFocus(t: Bodytemp): LitSeq[Reference]                           = t.focus
  def extractPartOf(t: Bodytemp): LitSeq[Reference]                          = t.partOf
  def extractStatus(t: Bodytemp): OBSERVATION_STATUS                         = t.status
  def extractIssued(t: Bodytemp): Option[ZonedDateTime]                      = t.issued
  def extractMethod(t: Bodytemp): Option[CodeableConcept]                    = t.method
  def extractDevice(t: Bodytemp): Option[Reference]                          = t.device
  def extractBasedOn(t: Bodytemp): LitSeq[Reference]                         = t.basedOn
  ...
  def extractExtension(t: Bodytemp): LitSeq[Extension]                       = t.extension
  def extractEncounter(t: Bodytemp): Option[Reference]                       = t.encounter
  def extractPerformer(t: Bodytemp): LitSeq[Reference]                       = t.performer
  def extractHasMember(t: Bodytemp): LitSeq[Reference]                       = t.hasMember
  def extractIdentifier(t: Bodytemp): LitSeq[Identifier]                     = t.identifier
  def extractDerivedFrom(t: Bodytemp): LitSeq[Reference]                     = t.derivedFrom
  def extractEffective(t: Bodytemp): Bodytemp.EffectiveChoice                = t.effective.get.toSubRef
  def extractImplicitRules(t: Bodytemp): Option[UriStr]                      = t.implicitRules
  def extractCode(t: Bodytemp): CodeableConcept                              = t.code
  def extractInterpretation(t: Bodytemp): LitSeq[CodeableConcept]            = t.interpretation
  def extractDataAbsentReason(t: Bodytemp): Option[CodeableConcept]          = t.dataAbsentReason
  def extractModifierExtension(t: Bodytemp): LitSeq[Extension]               = t.modifierExtension
  def extractComponent(t: Bodytemp): LitSeq[Observation.Component]           = t.component
  def extractReferenceRange(t: Bodytemp): LitSeq[Observation.ReferenceRange] = t.referenceRange
  override val thisName: String                                              = "Bodytemp"
  override val searchParams: Map[String, Bodytemp => Seq[Any]]               = Vitalsigns.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Bodytemp] =
...
class Bodytemp(
    ...
    override val meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/bodytemp"))),
