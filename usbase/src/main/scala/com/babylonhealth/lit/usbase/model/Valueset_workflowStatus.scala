...
object Valueset_workflowStatus extends CompanionFor[Valueset_workflowStatus] {
  ...
  ): Valueset_workflowStatus = new Valueset_workflowStatus(
    id,
    url,
    value,
  ...
  override def fields(t: Valueset_workflowStatus): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Valueset_workflowStatus): Option[String]                   = t.id
  def extractUrl(t: Valueset_workflowStatus): String                          = t.url
  ...
  def unapply(o: Valueset_workflowStatus): Option[(Option[String], String, String)] = Some(
