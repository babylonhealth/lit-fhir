...
object Questionnaire_unitOption extends CompanionFor[Questionnaire_unitOption] {
  implicit def summonObjectAndCompanionQuestionnaire_unitOption_2127349963(
      o: Questionnaire_unitOption): ObjectAndCompanion[Questionnaire_unitOption, Questionnaire_unitOption.type] =
  ...
  ): Questionnaire_unitOption = new Questionnaire_unitOption(
    id,
    value,
  ...
  def unapply(o: Questionnaire_unitOption): Option[(Option[String], Coding)] = Some((o.id, o.value.get.toSubRefNonUnion[Coding]))
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Questionnaire_unitOption] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Questionnaire_unitOption(
...
/** A unit that the user may choose when providing a quantity value.
  ...
  */
@POJOBoilerplate
class Questionnaire_unitOption(
