...
object Consent_Transcriber extends CompanionFor[Consent_Transcriber] {
  ...
  override val profileUrl: Option[String]        = Some("http://hl7.org/fhir/StructureDefinition/consent-Transcriber")
  def apply(
      id: Option[String] = None,
      url: String,
      value: Reference,
      primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
  ): Consent_Transcriber = new Consent_Transcriber(
    id,
    url,
    value,
  ...
  override def fields(t: Consent_Transcriber): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Consent_Transcriber): String                          = t.url
  ...
  def unapply(o: Consent_Transcriber): Option[(Option[String], String, Reference)] = Some(
