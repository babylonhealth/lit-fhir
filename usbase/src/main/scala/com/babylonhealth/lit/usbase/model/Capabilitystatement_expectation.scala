...
object Capabilitystatement_expectation extends CompanionFor[Capabilitystatement_expectation] {
  implicit def summonObjectAndCompanionCapabilitystatement_expectation724102737(
  ...
  override val profileUrl: Option[String] = Some("http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation")
  def apply(
  ...
  override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Try(
    Seq(
      ...
      FHIRComponentField[CONFORMANCE_EXPECTATION](value, CONFORMANCE_EXPECTATION.withName(t.value.get.toSubRefNonUnion[Code]))
    ))
