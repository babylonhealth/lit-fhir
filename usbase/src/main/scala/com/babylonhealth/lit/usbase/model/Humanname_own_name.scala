...
object Humanname_own_name extends CompanionFor[Humanname_own_name] {
  implicit def summonObjectAndCompanionHumanname_own_name_1832081924(
      o: Humanname_own_name): ObjectAndCompanion[Humanname_own_name, Humanname_own_name.type] = ObjectAndCompanion(o, this)
  ...
  def unapply(o: Humanname_own_name): Option[(Option[String], String)]   = Some((o.id, o.value.get.toSubRefNonUnion[String]))
...
/** The portion of the family name that is derived from the person's own surname, as distinguished from any portion that is
  * derived from the surname of the person's partner or spouse.
  *
