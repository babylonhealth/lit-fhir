...
object Humanname_fathers_family extends CompanionFor[Humanname_fathers_family] {
  ...
  override def fields(t: Humanname_fathers_family): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Humanname_fathers_family): Option[String]                   = t.id
  def extractUrl(t: Humanname_fathers_family): String                          = t.url
  ...
  def unapply(o: Humanname_fathers_family): Option[(Option[String], String, String)] = Some(
