...
object Encounter_modeOfArrival extends CompanionFor[Encounter_modeOfArrival] {
  ...
  override def fields(t: Encounter_modeOfArrival): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Encounter_modeOfArrival): String                          = t.url
  ...
  def unapply(o: Encounter_modeOfArrival): Option[(Option[String], String, Coding)] = Some(
