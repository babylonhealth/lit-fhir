...
object Cqf_initialValue extends CompanionFor[Cqf_initialValue] {
  ...
  override def fields(t: Cqf_initialValue): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Cqf_initialValue): Option[String]                   = t.id
  def extractUrl(t: Cqf_initialValue): String                          = t.url
  ...
  def unapply(o: Cqf_initialValue): Option[(Option[String], String, String)] = Some(
