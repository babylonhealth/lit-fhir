...
object Resource_approvalDate extends CompanionFor[Resource_approvalDate] {
  implicit def summonObjectAndCompanionResource_approvalDate892732219(
  ...
  override def fields(t: Resource_approvalDate): Seq[FHIRComponentField[_]] = fieldsFromParent(t).get
  ...
  def unapply(o: Resource_approvalDate): Option[(Option[String], FHIRDate)] = Some((o.id, o.value.get.toSubRefNonUnion[FHIRDate]))
