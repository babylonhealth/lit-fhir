...
object Specimen_isDryWeight extends CompanionFor[Specimen_isDryWeight] {
  ...
  override def fields(t: Specimen_isDryWeight): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Specimen_isDryWeight): String                          = t.url
  ...
  def unapply(o: Specimen_isDryWeight): Option[(Option[String], String, Boolean)] = Some(
