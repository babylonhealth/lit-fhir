...
object Ehrsrle_provenance extends CompanionFor[Ehrsrle_provenance] {
  implicit def summonObjectAndCompanionEhrsrle_provenance_1431391364(
      o: Ehrsrle_provenance): ObjectAndCompanion[Ehrsrle_provenance, Ehrsrle_provenance.type] = ObjectAndCompanion(o, this)
  ...
  val occurred: FHIRComponentFieldMeta[Option[Ehrsrle_provenance.OccurredChoice]] =
    FHIRComponentFieldMeta("occurred", lTagOf[Option[Ehrsrle_provenance.OccurredChoice]], true, lTagOf[UnionDateTimeOrPeriod])
...
/** Defines the elements to be supported within the Provenance resource in order to conform with the Electronic Health Record
  * System Functional Model Record Lifecycle Event standard
  *
