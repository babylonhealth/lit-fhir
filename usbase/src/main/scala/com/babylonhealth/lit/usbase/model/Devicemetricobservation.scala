...
object Devicemetricobservation extends CompanionFor[Devicemetricobservation] {
  ...
  override def fields(t: Devicemetricobservation): Seq[FHIRComponentField[_]] = Seq(
...
/** This profile describes the direct or derived, qualitative or quantitative physiological measurement, setting, or calculation data produced by a medical device or a device component.
  ...
  *              Refines the types of: value, effective.
  *              Requires the following fields which were optional in the parent: device, subject, effective.
  *              Forbids the use of the following fields which were optional in the parent: issued, specimen, encounter, dataAbsentReason.
