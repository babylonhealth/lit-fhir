...
object Devicemetricobservation extends CompanionFor[Devicemetricobservation] {
  ...
  def extractReferenceRange(t: Devicemetricobservation): Option[Observation.ReferenceRange] =
    t.referenceRange.headOption
...
/** This profile describes the direct or derived, qualitative or quantitative physiological measurement, setting, or
  * calculation data produced by a medical device or a device component.
  *
  * Subclass of [[hl7.model.Observation]] (Measurements and simple assertions made about a patient, device or other
  * subject.)
  *
  * @constructor
  *   Inherits all params from parent. Refines the types of: value, effective. Requires the following fields which were
  *   optional in the parent: device, subject, effective. Forbids the use of the following fields which were optional in
  *   the parent: issued, specimen, encounter, dataAbsentReason.
  * @param id
