...
object Observation_geneticsPhaseSet extends CompanionFor[Observation_geneticsPhaseSet] {
  ...
  override def fields(t: Observation_geneticsPhaseSet): Seq[FHIRComponentField[_]] = fieldsFromParent(t).get
  ...
  def unapply(o: Observation_geneticsPhaseSet): Option[(Option[String], NonEmptyLitSeq[Extension])] = Some(
