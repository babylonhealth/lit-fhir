...
object Cqf_measureInfo extends CompanionFor[Cqf_measureInfo] {
  ...
  override val profileUrl: Option[String]           = Some("http://hl7.org/fhir/StructureDefinition/cqf-measureInfo")
  def apply(
  ...
  override def fields(t: Cqf_measureInfo): Seq[FHIRComponentField[_]]          = fieldsFromParent(t).get
  ...
  def unapply(o: Cqf_measureInfo): Option[(Option[String], LitSeq[Extension])] = Some((o.id, o.extension))
