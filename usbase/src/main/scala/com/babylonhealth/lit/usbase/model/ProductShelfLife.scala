...
object ProductShelfLife extends CompanionFor[ProductShelfLife] {
  implicit def summonObjectAndCompanionProductShelfLife1381111865(
...
/** Base StructureDefinition for ProductShelfLife Type: The shelf-life and storage information for a medicinal product
  ...
  *   of a bottle, etc. The shelf life type shall be specified using an appropriate controlled vocabulary The controlled
  ...
  *   measurement The unit of measurement shall be specified in accordance with ISO 11240 and the resulting terminology
