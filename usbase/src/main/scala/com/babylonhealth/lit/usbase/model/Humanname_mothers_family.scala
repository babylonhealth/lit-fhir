...
object Humanname_mothers_family extends CompanionFor[Humanname_mothers_family] {
  implicit def summonObjectAndCompanionHumanname_mothers_family_635216949(
      o: Humanname_mothers_family): ObjectAndCompanion[Humanname_mothers_family, Humanname_mothers_family.type] =
    ObjectAndCompanion(o, this)
  override type ResourceType = Extension
  override type ParentType   = Extension
  override val baseType: CompanionFor[ResourceType] = Extension
  override val parentType: CompanionFor[ParentType] = Extension
  override val profileUrl: Option[String]           = Some("http://hl7.org/fhir/StructureDefinition/humanname-mothers-family")
  def apply(
      id: Option[String] = None,
      value: String,
      primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
  ): Humanname_mothers_family = new Humanname_mothers_family(
    id,
    value,
  ...
  def unapply(o: Humanname_mothers_family): Option[(Option[String], String)] = Some((o.id, o.value.get.toSubRefNonUnion[String]))
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Humanname_mothers_family] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Humanname_mothers_family(
...
/** The portion of the family name that is derived from the person's mother.
  ...
  */
@POJOBoilerplate
class Humanname_mothers_family(
