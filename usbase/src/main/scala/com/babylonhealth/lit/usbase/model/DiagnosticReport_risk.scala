...
object DiagnosticReport_risk extends CompanionFor[DiagnosticReport_risk] {
  ...
  override def fields(t: DiagnosticReport_risk): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: DiagnosticReport_risk): String                          = t.url
  ...
  def unapply(o: DiagnosticReport_risk): Option[(Option[String], String, Reference)] = Some(
