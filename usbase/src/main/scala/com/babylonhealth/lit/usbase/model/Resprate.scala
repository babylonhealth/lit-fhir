...
object Resprate extends CompanionFor[Resprate] {
  ...
  override def fields(t: Resprate): Seq[FHIRComponentField[_]]               = fieldsFromParent(t).get
...
class Resprate(
    ...
    override val meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/resprate"))),
