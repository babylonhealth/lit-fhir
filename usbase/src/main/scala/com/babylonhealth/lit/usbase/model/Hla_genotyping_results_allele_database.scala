...
object Hla_genotyping_results_allele_database extends CompanionFor[Hla_genotyping_results_allele_database] {
  ...
  def extractUrl(t: Hla_genotyping_results_allele_database): String        = t.url
  ...
  def unapply(o: Hla_genotyping_results_allele_database): Option[(Option[String], String, CodeableConcept)] = Some(
