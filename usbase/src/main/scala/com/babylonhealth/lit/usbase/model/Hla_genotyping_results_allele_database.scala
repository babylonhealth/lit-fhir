...
object Hla_genotyping_results_allele_database extends CompanionFor[Hla_genotyping_results_allele_database] {
  implicit def summonObjectAndCompanionHla_genotyping_results_allele_database_505289054(
  ...
  override val profileUrl: Option[String] = Some("http://hl7.org/fhir/StructureDefinition/hla-genotyping-results-allele-database")
  def apply(
  ...
  def extractValue(t: Hla_genotyping_results_allele_database): CodeableConcept = t.value.get.toSubRefNonUnion[CodeableConcept]
