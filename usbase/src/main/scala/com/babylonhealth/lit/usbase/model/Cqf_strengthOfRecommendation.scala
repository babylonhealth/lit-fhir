...
object Cqf_strengthOfRecommendation extends CompanionFor[Cqf_strengthOfRecommendation] {
  ...
  override def fields(t: Cqf_strengthOfRecommendation): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Cqf_strengthOfRecommendation): String                          = t.url
  ...
  def unapply(o: Cqf_strengthOfRecommendation): Option[(Option[String], String, CodeableConcept)] = Some(
