...
object Cqf_strengthOfRecommendation extends CompanionFor[Cqf_strengthOfRecommendation] {
  implicit def summonObjectAndCompanionCqf_strengthOfRecommendation_807728997(
  ...
  override val profileUrl: Option[String]           = Some("http://hl7.org/fhir/StructureDefinition/cqf-strengthOfRecommendation")
  def apply(
      id: Option[String] = None,
      value: CodeableConcept,
      primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
  ): Cqf_strengthOfRecommendation = new Cqf_strengthOfRecommendation(
    id,
    value,
  ...
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Cqf_strengthOfRecommendation] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Cqf_strengthOfRecommendation(
...
/** The strength of the recommendation assigned to this reference. The code system used specifies the rating scale used to rate
  * this recommendation while the code specifies the actual recommendation rating (represented as a coded value) associated with
  * this recommendation.
  *
  ...
  */
@POJOBoilerplate
class Cqf_strengthOfRecommendation(
