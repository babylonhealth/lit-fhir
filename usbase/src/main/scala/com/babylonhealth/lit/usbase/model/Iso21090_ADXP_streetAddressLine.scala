...
object Iso21090_ADXP_streetAddressLine extends CompanionFor[Iso21090_ADXP_streetAddressLine] {
  ...
  ): Iso21090_ADXP_streetAddressLine = new Iso21090_ADXP_streetAddressLine(
    id,
    url,
    value,
  ...
  override def fields(t: Iso21090_ADXP_streetAddressLine): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Iso21090_ADXP_streetAddressLine): Option[String]                   = t.id
  def extractUrl(t: Iso21090_ADXP_streetAddressLine): String                          = t.url
  ...
  def unapply(o: Iso21090_ADXP_streetAddressLine): Option[(Option[String], String, String)] = Some(
    (o.id, o.url, o.value.get.toSubRefNonUnion[String]))
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Iso21090_ADXP_streetAddressLine] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Iso21090_ADXP_streetAddressLine(
...
/** A street address line is frequently used instead of breaking out building number, street name, street type, etc. An address generally has only a delivery address line or a street address line, but not both.
  ...
  */
@POJOBoilerplate
class Iso21090_ADXP_streetAddressLine(
