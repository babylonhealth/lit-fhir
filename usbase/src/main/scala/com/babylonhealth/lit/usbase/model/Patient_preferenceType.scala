...
object Patient_preferenceType extends CompanionFor[Patient_preferenceType] {
  implicit def summonObjectAndCompanionPatient_preferenceType_300494702(
  ...
  def unapply(o: Patient_preferenceType): Option[(Option[String], Coding)]   = Some((o.id, o.value.get.toSubRefNonUnion[Coding]))
