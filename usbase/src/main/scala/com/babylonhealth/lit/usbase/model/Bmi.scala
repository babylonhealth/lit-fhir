...
object Bmi extends CompanionFor[Bmi] {
  implicit def summonObjectAndCompanionBmi_1087752981(o: Bmi): ObjectAndCompanion[Bmi, Bmi.type] = ObjectAndCompanion(o, this)
  ...
  val effective: FHIRComponentFieldMeta[Bmi.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Bmi.EffectiveChoice], true, lTagOf[UnionFHIRDateTimeOrPeriod])
