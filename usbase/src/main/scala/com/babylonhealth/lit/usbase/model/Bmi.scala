...
object Bmi extends CompanionFor[Bmi] {
  implicit def summonObjectAndCompanionBmi1873048969(o: Bmi): ObjectAndCompanion[Bmi, Bmi.type] = ObjectAndCompanion(o, this)
  ...
  override val profileUrl: Option[String]           = Some("http://hl7.org/fhir/StructureDefinition/bmi")
  type EffectiveChoice = Choice[UnionDateTimeOrPeriod]
  def apply(
      id: Option[String] = None,
      meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/bmi"))),
  ...
  val effective: FHIRComponentFieldMeta[Bmi.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Bmi.EffectiveChoice], true, lTagOf[UnionDateTimeOrPeriod])
  ...
  override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Try(
    Seq(
      ...
      FHIRComponentField[Bmi.EffectiveChoice](effective, t.effective.get.toSubRef),
  ...
  override def fields(t: Bmi): Seq[FHIRComponentField[_]]               = fieldsFromParent(t).get
  def extractId(t: Bmi): Option[String]                                 = t.id
  def extractMeta(t: Bmi): Option[Meta]                                 = t.meta
  def extractText(t: Bmi): Option[Narrative]                            = t.text
  def extractNote(t: Bmi): LitSeq[Annotation]                           = t.note
  def extractFocus(t: Bmi): LitSeq[Reference]                           = t.focus
  def extractPartOf(t: Bmi): LitSeq[Reference]                          = t.partOf
  def extractStatus(t: Bmi): OBSERVATION_STATUS                         = t.status
  def extractIssued(t: Bmi): Option[ZonedDateTime]                      = t.issued
  def extractMethod(t: Bmi): Option[CodeableConcept]                    = t.method
  def extractDevice(t: Bmi): Option[Reference]                          = t.device
  def extractBasedOn(t: Bmi): LitSeq[Reference]                         = t.basedOn
  def extractSubject(t: Bmi): Reference                                 = t.subject.get
  def extractLanguage(t: Bmi): Option[LANGUAGES]                        = t.language
  def extractCategory(t: Bmi): NonEmptyLitSeq[CodeableConcept]          = t.category.asNonEmpty
  def extractValue(t: Bmi): Quantity                                    = t.value.get.toSubRefNonUnion[Quantity]
  def extractBodySite(t: Bmi): Option[CodeableConcept]                  = t.bodySite
  def extractSpecimen(t: Bmi): Option[Reference]                        = t.specimen
  def extractContained(t: Bmi): LitSeq[Resource]                        = t.contained
  def extractExtension(t: Bmi): LitSeq[Extension]                       = t.extension
  def extractEncounter(t: Bmi): Option[Reference]                       = t.encounter
  def extractPerformer(t: Bmi): LitSeq[Reference]                       = t.performer
  def extractHasMember(t: Bmi): LitSeq[Reference]                       = t.hasMember
  def extractIdentifier(t: Bmi): LitSeq[Identifier]                     = t.identifier
  def extractDerivedFrom(t: Bmi): LitSeq[Reference]                     = t.derivedFrom
  def extractEffective(t: Bmi): Bmi.EffectiveChoice                     = t.effective.get.toSubRef
  def extractImplicitRules(t: Bmi): Option[UriStr]                      = t.implicitRules
  def extractCode(t: Bmi): CodeableConcept                              = t.code
  def extractInterpretation(t: Bmi): LitSeq[CodeableConcept]            = t.interpretation
  def extractDataAbsentReason(t: Bmi): Option[CodeableConcept]          = t.dataAbsentReason
  def extractModifierExtension(t: Bmi): LitSeq[Extension]               = t.modifierExtension
  def extractComponent(t: Bmi): LitSeq[Observation.Component]           = t.component
  def extractReferenceRange(t: Bmi): LitSeq[Observation.ReferenceRange] = t.referenceRange
  override val thisName: String                                         = "Bmi"
  override val searchParams: Map[String, Bmi => Seq[Any]]               = Vitalsigns.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Bmi] =
...
class Bmi(
    ...
    override val meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/bmi"))),
