...
object Bmi extends CompanionFor[Bmi] {
  implicit def summonObjectAndCompanionBmi_1087752981(o: Bmi): ObjectAndCompanion[Bmi, Bmi.type] =
  ...
  val effective: FHIRComponentFieldMeta[Bmi.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Bmi.EffectiveChoice], true, lTagOf[Union_0934386166])
