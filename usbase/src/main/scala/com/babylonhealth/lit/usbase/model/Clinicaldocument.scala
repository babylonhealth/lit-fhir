...
object Clinicaldocument extends CompanionFor[Clinicaldocument] {
  implicit def summonObjectAndCompanionClinicaldocument768971375(
...
/** The Clinical Document profile constrains Composition to specify a clinical document (matching CDA). The base
  * Composition is a general resource for compositions or documents about any kind of subject that might be encountered
  * in healthcare including such things as guidelines, medicines, etc. A clinical document is focused on documents
  * related to the provision of care process, where the subject is a patient, a group of patients, or a closely related
  * concept. A clinical document has additional requirements around confidentiality that do not apply in the same way to
  * other kinds of documents.
  *
  * Subclass of [[hl7.model.Composition]] (A set of healthcare-related information that is assembled together into a
  * single logical package that provides a single coherent statement of meaning, establishes its own context and that
  * has clinical attestation with regard to who is making the statement. A Composition defines the structure and
  * narrative content necessary for a document. However, a Composition alone does not constitute a document. Rather, the
  * Composition must be the first entry in a Bundle where Bundle.type=document, and any other resources referenced from
  * Composition must be included as subsequent entries in the Bundle (for example Patient, Practitioner, Encounter,
  * etc.).)
  *
  * @constructor
  ...
  * @param subject
  *   - Who or what the composition is about. The composition can be about a person, (patient or healthcare
  *   practitioner), a device (e.g. a machine) or even a group of subjects (such as a document about a herd of
  *   livestock, or a set of patients that share a common exposure).
  * @param language
  *   - The base language in which the resource is written.
  * @param category
  *   - A categorization for the type of the composition - helps for indexing and searching. This may be implied by or
  ...
  * @param identifier
  *   - A version-independent identifier for the Composition. This identifier stays constant as the composition is
  *   changed over time.
  * @param implicitRules
