...
/** Defines a GuidanceResponse that represents the response container for a CDS Hooks response
  *
  * Subclass of [[hl7.model.GuidanceResponse]] (A guidance response is the formal response to a guidance request,
  * including any output parameters returned by the evaluation, as well as the description of any proposed actions to be
  * taken.)
  *
  * @constructor
  *   Inherits all params from parent. Refines the types of: module. Requires the following fields which were optional
  *   in the parent: extension, identifier, requestIdentifier.
  * @param id
  ...
  *   will be data-required, and the response will contain a description of the additional required information. If the
  *   evaluation completed successfully, but the engine determines that a potentially more accurate response could be
  *   provided if more data was available, the status will be data-requested, and the response will contain a
  ...
  * @param encounter
  *   - The encounter during which this response was created or to which the creation of this record is tightly
  *   associated.
  * @param performer
  ...
  *   - Indicates the reason the request was initiated. This is typically provided as a parameter to the evaluation and
  *   echoed by the service, although for some use cases, such as subscription- or event-based scenarios, it may provide
  ...
  *   result in a more accurate response, this element will a description of the data required in order to proceed with
  *   the evaluation. A subsequent request to the service should include this data.
  * @param outputParameters
  *   - The output parameters of the evaluation, if any. Many modules will result in the return of specific resources
  *   such as procedure or communication requests that are returned as part of the operation result. However, modules
  *   may define specific outputs that would be returned as the result of the evaluation, and these would be returned in
  *   this element.
  ...
  *   - The identifier of the request associated with this response. If an identifier was given as part of the request,
  *   it will be reproduced here to enable the requester to more easily identify the response in a multi-request
  *   scenario.
  * @param evaluationMessage
  *   - Messages resulting from the evaluation of the artifact or artifacts. As part of evaluating the request, the
  *   engine may produce informational or warning messages. These messages will be provided by this element.
