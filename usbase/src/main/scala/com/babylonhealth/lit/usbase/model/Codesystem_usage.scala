...
object Codesystem_usage extends CompanionFor[Codesystem_usage] {
  ...
  override def fields(t: Codesystem_usage): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Codesystem_usage): String                          = t.url
  ...
  def unapply(o: Codesystem_usage): Option[(Option[String], String, NonEmptyLitSeq[Extension])] = Some(
