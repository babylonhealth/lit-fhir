...
object Iso21090_EN_qualifier extends CompanionFor[Iso21090_EN_qualifier] {
  ...
  def extractUrl(t: Iso21090_EN_qualifier): String                          = t.url
  ...
  def unapply(o: Iso21090_EN_qualifier): Option[(Option[String], String, NAME_PART_QUALIFIER)] = Some(
    (o.id, o.url, o.value.get.toSubRefNonUnion[NAME_PART_QUALIFIER]))
