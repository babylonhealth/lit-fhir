...
object Event_statusReason extends CompanionFor[Event_statusReason] {
  ...
  override val profileUrl: Option[String]        = Some("http://hl7.org/fhir/StructureDefinition/event-statusReason")
  def apply(
      id: Option[String] = None,
      url: String,
      value: CodeableConcept,
      primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
  ): Event_statusReason = new Event_statusReason(
    id,
    url,
    value,
  ...
  override def fields(t: Event_statusReason): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Event_statusReason): String                          = t.url
  ...
  def unapply(o: Event_statusReason): Option[(Option[String], String, CodeableConcept)] = Some(
