...
object Patient_birthTime extends CompanionFor[Patient_birthTime] {
  implicit def summonObjectAndCompanionPatient_birthTime2112935983(
...
/** The time of day that the Patient was born. This includes the date to ensure that the timezone information can be communicated
  * effectively.
  *
