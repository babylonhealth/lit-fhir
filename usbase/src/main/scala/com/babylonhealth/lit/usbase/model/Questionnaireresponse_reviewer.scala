...
object Questionnaireresponse_reviewer extends CompanionFor[Questionnaireresponse_reviewer] {
  implicit def summonObjectAndCompanionQuestionnaireresponse_reviewer_1518986269(
      o: Questionnaireresponse_reviewer): ObjectAndCompanion[Questionnaireresponse_reviewer, Questionnaireresponse_reviewer.type] =
    ObjectAndCompanion(o, this)
  override type ResourceType = Extension
  override type ParentType   = Extension
  override val baseType: CompanionFor[ResourceType] = Extension
  override val parentType: CompanionFor[ParentType] = Extension
  override val profileUrl: Option[String] = Some("http://hl7.org/fhir/StructureDefinition/questionnaireresponse-reviewer")
  def apply(
  ...
  override def fields(t: Questionnaireresponse_reviewer): Seq[FHIRComponentField[_]] = fieldsFromParent(t).get
  ...
  def unapply(o: Questionnaireresponse_reviewer): Option[(Option[String], Reference)] = Some(
...
/** Individual responsible for ensuring that the questionnaire response have been completed appropriately and signs off on the
  * content.
  *
