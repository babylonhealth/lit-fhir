...
object Iso21090_ADXP_deliveryInstallationQualifier extends CompanionFor[Iso21090_ADXP_deliveryInstallationQualifier] {
  ...
  override def fields(t: Iso21090_ADXP_deliveryInstallationQualifier): Seq[FHIRComponentField[_]] = fieldsFromParent(
    t).get
  def extractId(t: Iso21090_ADXP_deliveryInstallationQualifier): Option[String] = t.id
  def extractValue(t: Iso21090_ADXP_deliveryInstallationQualifier): String      = t.value.get.value.asInstanceOf[String]
