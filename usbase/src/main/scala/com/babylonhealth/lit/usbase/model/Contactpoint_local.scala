...
object Contactpoint_local extends CompanionFor[Contactpoint_local] {
  implicit def summonObjectAndCompanionContactpoint_local1498920535(
      o: Contactpoint_local): ObjectAndCompanion[Contactpoint_local, Contactpoint_local.type] =
...
/** The local number that must be dialed to connect within the area/city/zone. This extension is used when a system
  * wishes to designate specific parts of a phone number (and potentially place constraints on which components must be
