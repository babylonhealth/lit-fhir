...
object Contactpoint_local extends CompanionFor[Contactpoint_local] {
  ...
  override def fields(t: Contactpoint_local): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Contactpoint_local): Option[String]                   = t.id
  def extractUrl(t: Contactpoint_local): String                          = t.url
  ...
  def unapply(o: Contactpoint_local): Option[(Option[String], String, String)] = Some(
