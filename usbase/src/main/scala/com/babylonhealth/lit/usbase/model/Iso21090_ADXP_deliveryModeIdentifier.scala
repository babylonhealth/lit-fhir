...
object Iso21090_ADXP_deliveryModeIdentifier extends CompanionFor[Iso21090_ADXP_deliveryModeIdentifier] {
  ...
  ): Iso21090_ADXP_deliveryModeIdentifier = new Iso21090_ADXP_deliveryModeIdentifier(
    id,
    url,
    value,
  ...
  override def fields(t: Iso21090_ADXP_deliveryModeIdentifier): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Iso21090_ADXP_deliveryModeIdentifier): Option[String]                   = t.id
  def extractUrl(t: Iso21090_ADXP_deliveryModeIdentifier): String                          = t.url
  ...
  def unapply(o: Iso21090_ADXP_deliveryModeIdentifier): Option[(Option[String], String, String)] = Some(
    (o.id, o.url, o.value.get.toSubRefNonUnion[String]))
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Iso21090_ADXP_deliveryModeIdentifier] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Iso21090_ADXP_deliveryModeIdentifier(
...
/** Represents the routing information such as a letter carrier route number. It is the identifying number of the designator (the box number or rural route number).
  ...
  */
@POJOBoilerplate
class Iso21090_ADXP_deliveryModeIdentifier(
