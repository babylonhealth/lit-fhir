...
object Codesystem_sourceReference extends CompanionFor[Codesystem_sourceReference] {
  implicit def summonObjectAndCompanionCodesystem_sourceReference_449338922(
...
/** This text is intended to act as a citation to work done elsewhere that is not part of the current stewarding process
  * where the referenced source is in some way a basis of the current value set definition.
  *
