...
object Cqf_expression extends CompanionFor[Cqf_expression] {
  implicit def summonObjectAndCompanionCqf_expression_1232741150(
      o: Cqf_expression): ObjectAndCompanion[Cqf_expression, Cqf_expression.type] = ObjectAndCompanion(o, this)
  ...
  def unapply(o: Cqf_expression): Option[(Option[String], Expression)] = Some((o.id, o.value.get.toSubRefNonUnion[Expression]))
...
class Cqf_expression(
    ...
    override val primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
      ...
      id = id,
      value = Some(new Choice("Expression", value)(UnionAllTag)),
