...
object Cqf_initiatingPerson extends CompanionFor[Cqf_initiatingPerson] {
  ...
  override def fields(t: Cqf_initiatingPerson): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Cqf_initiatingPerson): String                          = t.url
  ...
  def unapply(o: Cqf_initiatingPerson): Option[(Option[String], String, Reference)] = Some(
