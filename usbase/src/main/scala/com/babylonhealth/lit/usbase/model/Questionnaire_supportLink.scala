...
object Questionnaire_supportLink extends CompanionFor[Questionnaire_supportLink] {
  implicit def summonObjectAndCompanionQuestionnaire_supportLink_1858374390(
      o: Questionnaire_supportLink): ObjectAndCompanion[Questionnaire_supportLink, Questionnaire_supportLink.type] =
    ObjectAndCompanion(o, this)
  override type ResourceType = Extension
  override type ParentType   = Extension
  override val baseType: CompanionFor[ResourceType] = Extension
  override val parentType: CompanionFor[ParentType] = Extension
  override val profileUrl: Option[String]           = Some("http://hl7.org/fhir/StructureDefinition/questionnaire-supportLink")
  def apply(
  ...
  override def fields(t: Questionnaire_supportLink): Seq[FHIRComponentField[_]] = fieldsFromParent(t).get
  ...
  def unapply(o: Questionnaire_supportLink): Option[(Option[String], UriStr)] = Some((o.id, o.value.get.toSubRefNonUnion[UriStr]))
