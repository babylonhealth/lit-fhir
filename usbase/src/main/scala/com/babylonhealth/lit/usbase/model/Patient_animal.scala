...
object Patient_animal extends CompanionFor[Patient_animal] {
  implicit def summonObjectAndCompanionPatient_animal_1822941337(
      o: Patient_animal): ObjectAndCompanion[Patient_animal, Patient_animal.type] = ObjectAndCompanion(o, this)
  override type ResourceType = Extension
  override type ParentType   = Extension
  override val baseType: CompanionFor[ResourceType] = Extension
  override val parentType: CompanionFor[ParentType] = Extension
  override val profileUrl: Option[String]           = Some("http://hl7.org/fhir/StructureDefinition/patient-animal")
  def apply(
  ...
  override def fields(t: Patient_animal): Seq[FHIRComponentField[_]]                  = fieldsFromParent(t).get
  ...
  def unapply(o: Patient_animal): Option[(Option[String], NonEmptyLitSeq[Extension])] = Some((o.id, o.extension.asNonEmpty))
