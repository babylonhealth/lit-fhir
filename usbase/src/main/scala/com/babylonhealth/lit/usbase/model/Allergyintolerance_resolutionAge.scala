...
object Allergyintolerance_resolutionAge extends CompanionFor[Allergyintolerance_resolutionAge] {
  implicit def summonObjectAndCompanionAllergyintolerance_resolutionAge295103619(
  ...
  override val profileUrl: Option[String] = Some("http://hl7.org/fhir/StructureDefinition/allergyintolerance-resolutionAge")
  def apply(
...
class Allergyintolerance_resolutionAge(
    ...
    override val primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
      ...
      id = id,
      value = Some(new Choice("Age", value)(UnionAllTag)),
