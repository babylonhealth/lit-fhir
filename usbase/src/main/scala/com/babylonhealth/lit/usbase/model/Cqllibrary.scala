...
object Cqllibrary extends CompanionFor[Cqllibrary] {
  ...
  def apply(
      ...
      meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/cqllibrary"))),
      ...
      subject: Option[Cqllibrary.SubjectChoice] = None,
  ...
  override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Try(
    Seq(
      ...
      FHIRComponentField[Option[Cqllibrary.SubjectChoice]](subject, t.subject),
  ...
  override def fields(t: Cqllibrary): Seq[FHIRComponentField[_]]      = fieldsFromParent(t).get
  def extractId(t: Cqllibrary): Option[String]                        = t.id
  def extractUrl(t: Cqllibrary): Option[UriStr]                       = t.url
  def extractMeta(t: Cqllibrary): Option[Meta]                        = t.meta
  def extractText(t: Cqllibrary): Option[Narrative]                   = t.text
  def extractName(t: Cqllibrary): Option[String]                      = t.name
  def extractType(t: Cqllibrary): CodeableConcept                     = t.`type`
  def extractDate(t: Cqllibrary): Option[FHIRDateTime]                = t.date
  def extractTitle(t: Cqllibrary): Option[String]                     = t.title
  def extractUsage(t: Cqllibrary): Option[String]                     = t.usage
  def extractTopic(t: Cqllibrary): LitSeq[CodeableConcept]            = t.topic
  def extractStatus(t: Cqllibrary): PUBLICATION_STATUS                = t.status
  def extractAuthor(t: Cqllibrary): LitSeq[ContactDetail]             = t.author
  def extractEditor(t: Cqllibrary): LitSeq[ContactDetail]             = t.editor
  def extractVersion(t: Cqllibrary): Option[String]                   = t.version
  def extractContact(t: Cqllibrary): LitSeq[ContactDetail]            = t.contact
  def extractPurpose(t: Cqllibrary): Option[Markdown]                 = t.purpose
  def extractContent(t: Cqllibrary): LitSeq[Attachment]               = t.content
  def extractLanguage(t: Cqllibrary): Option[LANGUAGES]               = t.language
  def extractSubtitle(t: Cqllibrary): Option[String]                  = t.subtitle
  def extractReviewer(t: Cqllibrary): LitSeq[ContactDetail]           = t.reviewer
  def extractEndorser(t: Cqllibrary): LitSeq[ContactDetail]           = t.endorser
  def extractContained(t: Cqllibrary): LitSeq[Resource]               = t.contained
  def extractExtension(t: Cqllibrary): LitSeq[Extension]              = t.extension
  def extractPublisher(t: Cqllibrary): Option[String]                 = t.publisher
  def extractCopyright(t: Cqllibrary): Option[Markdown]               = t.copyright
  def extractParameter(t: Cqllibrary): LitSeq[ParameterDefinition]    = t.parameter
  def extractIdentifier(t: Cqllibrary): LitSeq[Identifier]            = t.identifier
  def extractSubject(t: Cqllibrary): Option[Cqllibrary.SubjectChoice] = t.subject
  def extractUseContext(t: Cqllibrary): LitSeq[UsageContext]          = t.useContext
  def extractDescription(t: Cqllibrary): Option[Markdown]             = t.description
  def extractExperimental(t: Cqllibrary): Option[Boolean]             = t.experimental
  def extractJurisdiction(t: Cqllibrary): LitSeq[CodeableConcept]     = t.jurisdiction
  def extractApprovalDate(t: Cqllibrary): Option[FHIRDate]            = t.approvalDate
  def extractImplicitRules(t: Cqllibrary): Option[UriStr]             = t.implicitRules
  def extractLastReviewDate(t: Cqllibrary): Option[FHIRDate]          = t.lastReviewDate
  def extractEffectivePeriod(t: Cqllibrary): Option[Period]           = t.effectivePeriod
  def extractRelatedArtifact(t: Cqllibrary): LitSeq[RelatedArtifact]  = t.relatedArtifact
  def extractDataRequirement(t: Cqllibrary): LitSeq[DataRequirement]  = t.dataRequirement
  def extractModifierExtension(t: Cqllibrary): LitSeq[Extension]      = t.modifierExtension
  override val thisName: String                                       = "Cqllibrary"
  override val searchParams: Map[String, Cqllibrary => Seq[Any]]      = Library.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Cqllibrary] =
...
/** Represents a CQL logic library
  *
  * Subclass of [[hl7.model.Library]] (The Library resource is a general-purpose container for knowledge asset
  * definitions. It can be used to describe and expose existing knowledge assets such as logic libraries and information
  ...
  * @param url
  *   - An absolute URI that is used to identify this library when it is referenced in a specification, model, design or
  *   an instance; also called its canonical identifier. This SHOULD be globally unique and SHOULD be a literal address
  *   at which at which an authoritative instance of this library is (or will be) published. This URL can be the target
  *   of a canonical reference. It SHALL remain the same when the library is stored on different servers.
  * @param meta
  ...
  * @param name
  *   - A natural language name identifying the library. This name should be usable as an identifier for the module by
  *   machine processing applications such as code generation.
  * @param `type`
  *   - Identifies the type of library such as a Logic Library, Model Definition, Asset Collection, or Module
  *   Definition.
  * @param date
  *   - The date (and optionally time) when the library was published. The date must change when the business version
  ...
  * @param topic
  *   - Descriptive topics related to the content of the library. Topics provide a high-level categorization of the
  *   library that can be useful for filtering and searching.
  * @param status
  ...
  * @param version
  *   - The identifier that is used to identify this version of the library when it is referenced in a specification,
  *   model, design or instance. This is an arbitrary value managed by the library author and is not expected to be
  ...
  * @param content
  *   - The content of the library as an Attachment. The content may be a reference to a url, or may be directly
  *   embedded as a base-64 string. Either way, the contentType of the attachment determines how to interpret the
  *   content.
  * @param language
  ...
  * @param identifier
  *   - A formal identifier that is used to identify this library when it is represented in other formats, or referenced
  *   in a specification, model, design or an instance. e.g. CMS or NQF identifiers for a measure artifact. Note that at
  ...
  *   and may be used to assist with indexing and searching for appropriate library instances.
  * @param description
...
class Cqllibrary(
    ...
    override val meta: Option[Meta] = Some(
      new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/cqllibrary"))),
    ...
    override val subject: Option[Cqllibrary.SubjectChoice] = None,
