...
object Oxygensat extends CompanionFor[Oxygensat] {
  implicit def summonObjectAndCompanionOxygensat_1359029743(o: Oxygensat): ObjectAndCompanion[Oxygensat, Oxygensat.type] =
  ...
  def apply(
      ...
      meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/oxygensat"))),
      ...
      effective: Oxygensat.EffectiveChoice,
  ...
  val effective: FHIRComponentFieldMeta[Oxygensat.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Oxygensat.EffectiveChoice], true, lTagOf[UnionDateTimeOrPeriod])
  ...
  override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Try(
    Seq(
      ...
      FHIRComponentField[Oxygensat.EffectiveChoice](effective, t.effective.get.toSubRef),
  ...
  override def fields(t: Oxygensat): Seq[FHIRComponentField[_]]               = fieldsFromParent(t).get
  def extractId(t: Oxygensat): Option[String]                                 = t.id
  def extractMeta(t: Oxygensat): Option[Meta]                                 = t.meta
  def extractText(t: Oxygensat): Option[Narrative]                            = t.text
  def extractNote(t: Oxygensat): LitSeq[Annotation]                           = t.note
  def extractFocus(t: Oxygensat): LitSeq[Reference]                           = t.focus
  def extractPartOf(t: Oxygensat): LitSeq[Reference]                          = t.partOf
  def extractStatus(t: Oxygensat): OBSERVATION_STATUS                         = t.status
  def extractIssued(t: Oxygensat): Option[ZonedDateTime]                      = t.issued
  def extractMethod(t: Oxygensat): Option[CodeableConcept]                    = t.method
  def extractDevice(t: Oxygensat): Option[Reference]                          = t.device
  def extractBasedOn(t: Oxygensat): LitSeq[Reference]                         = t.basedOn
  ...
  def extractExtension(t: Oxygensat): LitSeq[Extension]                       = t.extension
  def extractEncounter(t: Oxygensat): Option[Reference]                       = t.encounter
  def extractPerformer(t: Oxygensat): LitSeq[Reference]                       = t.performer
  def extractHasMember(t: Oxygensat): LitSeq[Reference]                       = t.hasMember
  def extractIdentifier(t: Oxygensat): LitSeq[Identifier]                     = t.identifier
  def extractDerivedFrom(t: Oxygensat): LitSeq[Reference]                     = t.derivedFrom
  def extractEffective(t: Oxygensat): Oxygensat.EffectiveChoice               = t.effective.get.toSubRef
  def extractImplicitRules(t: Oxygensat): Option[UriStr]                      = t.implicitRules
  def extractCode(t: Oxygensat): CodeableConcept                              = t.code
  def extractInterpretation(t: Oxygensat): LitSeq[CodeableConcept]            = t.interpretation
  def extractDataAbsentReason(t: Oxygensat): Option[CodeableConcept]          = t.dataAbsentReason
  def extractModifierExtension(t: Oxygensat): LitSeq[Extension]               = t.modifierExtension
  def extractComponent(t: Oxygensat): LitSeq[Observation.Component]           = t.component
  def extractReferenceRange(t: Oxygensat): LitSeq[Observation.ReferenceRange] = t.referenceRange
  override val thisName: String                                               = "Oxygensat"
  override val searchParams: Map[String, Oxygensat => Seq[Any]]               = Vitalsigns.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Oxygensat] =
...
class Oxygensat(
    ...
    override val meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/oxygensat"))),
