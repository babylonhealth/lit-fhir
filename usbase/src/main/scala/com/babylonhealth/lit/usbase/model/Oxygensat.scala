...
object Oxygensat extends CompanionFor[Oxygensat] {
  ...
  val effective: FHIRComponentFieldMeta[Oxygensat.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Oxygensat.EffectiveChoice], true, lTagOf[Union_0934386166])
...
class Oxygensat(
    ...
    override val meta: Option[Meta] = Some(
      new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/oxygensat"))),
