...
object Oxygensat extends CompanionFor[Oxygensat] {
  implicit def summonObjectAndCompanionOxygensat_334583885(o: Oxygensat): ObjectAndCompanion[Oxygensat, Oxygensat.type] =
  ...
  val effective: FHIRComponentFieldMeta[Oxygensat.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Oxygensat.EffectiveChoice], true, lTagOf[UnionFHIRDateTimeOrPeriod])
