...
/** The target of the extension is a distinct actor from the requester and has decision-making authority over the service and
  * takes direct responsibility to manage the service.
  *
