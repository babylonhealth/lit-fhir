...
object DiagnosticReport_geneticsAssessedCondition extends CompanionFor[DiagnosticReport_geneticsAssessedCondition] {
  implicit def summonObjectAndCompanionDiagnosticReport_geneticsAssessedCondition1468564577(
      o: DiagnosticReport_geneticsAssessedCondition): ObjectAndCompanion[DiagnosticReport_geneticsAssessedCondition, DiagnosticReport_geneticsAssessedCondition.type] =
  ...
  override def fields(t: DiagnosticReport_geneticsAssessedCondition): Seq[FHIRComponentField[_]] = fieldsFromParent(t).get
  ...
  override val searchParams: Map[String, DiagnosticReport_geneticsAssessedCondition => Seq[Any]] = Extension.searchParams
...
/** Used to denote condition context for genetic testing, which may influence reported variants and interpretation for large
  * genomic testing panels e.g. lung cancer or familial breast cancer.
  *
