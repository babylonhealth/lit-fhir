...
object DiagnosticReport_geneticsAssessedCondition extends CompanionFor[DiagnosticReport_geneticsAssessedCondition] {
  ...
  override def fields(t: DiagnosticReport_geneticsAssessedCondition): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: DiagnosticReport_geneticsAssessedCondition): String        = t.url
  ...
  def unapply(o: DiagnosticReport_geneticsAssessedCondition): Option[(Option[String], String, Reference)] = Some(
