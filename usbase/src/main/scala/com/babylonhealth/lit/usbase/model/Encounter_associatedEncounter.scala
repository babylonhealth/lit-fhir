...
object Encounter_associatedEncounter extends CompanionFor[Encounter_associatedEncounter] {
  ...
  override def fields(t: Encounter_associatedEncounter): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Encounter_associatedEncounter): String                          = t.url
  ...
  def unapply(o: Encounter_associatedEncounter): Option[(Option[String], String, Reference)] = Some(
