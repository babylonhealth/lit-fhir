...
object Encounter_associatedEncounter extends CompanionFor[Encounter_associatedEncounter] {
  implicit def summonObjectAndCompanionEncounter_associatedEncounter_701684866(
      o: Encounter_associatedEncounter): ObjectAndCompanion[Encounter_associatedEncounter, Encounter_associatedEncounter.type] =
    ObjectAndCompanion(o, this)
  override type ResourceType = Extension
  override type ParentType   = Extension
  override val baseType: CompanionFor[ResourceType] = Extension
  override val parentType: CompanionFor[ParentType] = Extension
  override val profileUrl: Option[String] = Some("http://hl7.org/fhir/StructureDefinition/encounter-associatedEncounter")
  def apply(
      id: Option[String] = None,
      value: Reference,
      primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
  ): Encounter_associatedEncounter = new Encounter_associatedEncounter(
    id,
    value,
  ...
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Encounter_associatedEncounter] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Encounter_associatedEncounter(
...
/** This encounter occurs within the scope of the referenced encounter.
  ...
  */
@POJOBoilerplate
class Encounter_associatedEncounter(
