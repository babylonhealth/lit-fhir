...
object Observation_replaces extends CompanionFor[Observation_replaces] {
  implicit def summonObjectAndCompanionObservation_replaces_1000767467(
      o: Observation_replaces): ObjectAndCompanion[Observation_replaces, Observation_replaces.type] = ObjectAndCompanion(o, this)
