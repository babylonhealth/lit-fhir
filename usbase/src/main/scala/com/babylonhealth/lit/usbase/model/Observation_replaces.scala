...
object Observation_replaces extends CompanionFor[Observation_replaces] {
  ...
  override val profileUrl: Option[String]        = Some("http://hl7.org/fhir/StructureDefinition/observation-replaces")
  def apply(
      id: Option[String] = None,
      url: String,
      value: Reference,
      primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
  ): Observation_replaces = new Observation_replaces(
    id,
    url,
    value,
  ...
  override def fields(t: Observation_replaces): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Observation_replaces): String                          = t.url
  ...
  def unapply(o: Observation_replaces): Option[(Option[String], String, Reference)] = Some(
