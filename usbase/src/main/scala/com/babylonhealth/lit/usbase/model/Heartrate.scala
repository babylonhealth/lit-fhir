...
object Heartrate extends CompanionFor[Heartrate] {
  implicit def summonObjectAndCompanionHeartrate_288546700(o: Heartrate): ObjectAndCompanion[Heartrate, Heartrate.type] =
  ...
  val effective: FHIRComponentFieldMeta[Heartrate.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Heartrate.EffectiveChoice], true, lTagOf[UnionFHIRDateTimeOrPeriod])
