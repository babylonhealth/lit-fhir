...
object Heartrate extends CompanionFor[Heartrate] {
  ...
  val effective: FHIRComponentFieldMeta[Heartrate.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Heartrate.EffectiveChoice], true, lTagOf[Union_0934386166])
...
class Heartrate(
    ...
    override val meta: Option[Meta] = Some(
      new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/heartrate"))),
