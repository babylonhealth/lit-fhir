...
object Heartrate extends CompanionFor[Heartrate] {
  implicit def summonObjectAndCompanionHeartrate158215665(o: Heartrate): ObjectAndCompanion[Heartrate, Heartrate.type] =
  ...
  override val profileUrl: Option[String]           = Some("http://hl7.org/fhir/StructureDefinition/heartrate")
  type EffectiveChoice = Choice[UnionDateTimeOrPeriod]
  def apply(
      id: Option[String] = None,
      meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/heartrate"))),
      ...
      effective: Heartrate.EffectiveChoice,
  ...
  val effective: FHIRComponentFieldMeta[Heartrate.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Heartrate.EffectiveChoice], true, lTagOf[UnionDateTimeOrPeriod])
  ...
  override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Try(
    Seq(
      ...
      FHIRComponentField[Heartrate.EffectiveChoice](effective, t.effective.get.toSubRef),
  ...
  override def fields(t: Heartrate): Seq[FHIRComponentField[_]]               = fieldsFromParent(t).get
  def extractId(t: Heartrate): Option[String]                                 = t.id
  def extractMeta(t: Heartrate): Option[Meta]                                 = t.meta
  def extractText(t: Heartrate): Option[Narrative]                            = t.text
  def extractNote(t: Heartrate): LitSeq[Annotation]                           = t.note
  def extractFocus(t: Heartrate): LitSeq[Reference]                           = t.focus
  def extractPartOf(t: Heartrate): LitSeq[Reference]                          = t.partOf
  def extractStatus(t: Heartrate): OBSERVATION_STATUS                         = t.status
  def extractIssued(t: Heartrate): Option[ZonedDateTime]                      = t.issued
  def extractMethod(t: Heartrate): Option[CodeableConcept]                    = t.method
  def extractDevice(t: Heartrate): Option[Reference]                          = t.device
  def extractBasedOn(t: Heartrate): LitSeq[Reference]                         = t.basedOn
  def extractSubject(t: Heartrate): Reference                                 = t.subject.get
  def extractLanguage(t: Heartrate): Option[LANGUAGES]                        = t.language
  def extractCategory(t: Heartrate): NonEmptyLitSeq[CodeableConcept]          = t.category.asNonEmpty
  def extractValue(t: Heartrate): Option[Quantity]                            = t.value.map(_.toSubRefNonUnion[Quantity])
  def extractBodySite(t: Heartrate): Option[CodeableConcept]                  = t.bodySite
  def extractSpecimen(t: Heartrate): Option[Reference]                        = t.specimen
  def extractContained(t: Heartrate): LitSeq[Resource]                        = t.contained
  def extractExtension(t: Heartrate): LitSeq[Extension]                       = t.extension
  def extractEncounter(t: Heartrate): Option[Reference]                       = t.encounter
  def extractPerformer(t: Heartrate): LitSeq[Reference]                       = t.performer
  def extractHasMember(t: Heartrate): LitSeq[Reference]                       = t.hasMember
  def extractIdentifier(t: Heartrate): LitSeq[Identifier]                     = t.identifier
  def extractDerivedFrom(t: Heartrate): LitSeq[Reference]                     = t.derivedFrom
  def extractEffective(t: Heartrate): Heartrate.EffectiveChoice               = t.effective.get.toSubRef
  def extractImplicitRules(t: Heartrate): Option[UriStr]                      = t.implicitRules
  def extractCode(t: Heartrate): CodeableConcept                              = t.code
  def extractInterpretation(t: Heartrate): LitSeq[CodeableConcept]            = t.interpretation
  def extractDataAbsentReason(t: Heartrate): Option[CodeableConcept]          = t.dataAbsentReason
  def extractModifierExtension(t: Heartrate): LitSeq[Extension]               = t.modifierExtension
  def extractComponent(t: Heartrate): LitSeq[Observation.Component]           = t.component
  def extractReferenceRange(t: Heartrate): LitSeq[Observation.ReferenceRange] = t.referenceRange
  override val thisName: String                                               = "Heartrate"
  override val searchParams: Map[String, Heartrate => Seq[Any]]               = Vitalsigns.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Heartrate] =
...
class Heartrate(
    ...
    override val meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/heartrate"))),
