...
object BodySite extends CompanionFor[BodySite] {
  implicit def summonObjectAndCompanionBodySite_1346813218(o: BodySite): ObjectAndCompanion[BodySite, BodySite.type] =
...
/** Record details about the anatomical location of a specimen or body part. This resource may be used when a coded concept does
