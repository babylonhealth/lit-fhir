...
object BodySite extends CompanionFor[BodySite] {
  ...
  override def fields(t: BodySite): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: BodySite): String                          = t.url
  ...
  def unapply(o: BodySite): Option[(Option[String], String, Reference)] = Some(
