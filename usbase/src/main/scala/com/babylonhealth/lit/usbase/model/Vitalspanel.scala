...
object Vitalspanel extends CompanionFor[Vitalspanel] {
  implicit def summonObjectAndCompanionVitalspanel1155523574(o: Vitalspanel): ObjectAndCompanion[Vitalspanel, Vitalspanel.type] =
  ...
  def apply(
      ...
      meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/vitalspanel"))),
      ...
      hasMember: NonEmptyLitSeq[Reference],
      identifier: LitSeq[Identifier] = LitSeq.empty,
      derivedFrom: LitSeq[Reference] = LitSeq.empty,
      effective: Vitalspanel.EffectiveChoice,
  ...
  val hasMember: FHIRComponentFieldMeta[NonEmptyLitSeq[Reference]] =
    FHIRComponentFieldMeta("hasMember", lTagOf[NonEmptyLitSeq[Reference]], false, lTagOf[Reference])
  ...
  val effective: FHIRComponentFieldMeta[Vitalspanel.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Vitalspanel.EffectiveChoice], true, lTagOf[UnionFHIRDateTimeOrPeriod])
  ...
  def extractNote(t: Vitalspanel): LitSeq[Annotation]                           = t.note
  def extractFocus(t: Vitalspanel): LitSeq[Reference]                           = t.focus
  def extractPartOf(t: Vitalspanel): LitSeq[Reference]                          = t.partOf
  def extractStatus(t: Vitalspanel): OBSERVATION_STATUS                         = t.status
  def extractIssued(t: Vitalspanel): Option[ZonedDateTime]                      = t.issued
  def extractMethod(t: Vitalspanel): Option[CodeableConcept]                    = t.method
  def extractDevice(t: Vitalspanel): Option[Reference]                          = t.device
  def extractBasedOn(t: Vitalspanel): LitSeq[Reference]                         = t.basedOn
  def extractSubject(t: Vitalspanel): Reference                                 = t.subject.get
  def extractLanguage(t: Vitalspanel): Option[LANGUAGES]                        = t.language
  def extractCategory(t: Vitalspanel): NonEmptyLitSeq[CodeableConcept]          = t.category.asNonEmpty
  def extractBodySite(t: Vitalspanel): Option[CodeableConcept]                  = t.bodySite
  def extractSpecimen(t: Vitalspanel): Option[Reference]                        = t.specimen
  def extractContained(t: Vitalspanel): LitSeq[Resource]                        = t.contained
  def extractExtension(t: Vitalspanel): LitSeq[Extension]                       = t.extension
  def extractEncounter(t: Vitalspanel): Option[Reference]                       = t.encounter
  def extractPerformer(t: Vitalspanel): LitSeq[Reference]                       = t.performer
  def extractHasMember(t: Vitalspanel): NonEmptyLitSeq[Reference]               = t.hasMember.asNonEmpty
  def extractIdentifier(t: Vitalspanel): LitSeq[Identifier]                     = t.identifier
  def extractDerivedFrom(t: Vitalspanel): LitSeq[Reference]                     = t.derivedFrom
  def extractEffective(t: Vitalspanel): Vitalspanel.EffectiveChoice             = t.effective.get.toSubRef
  def extractImplicitRules(t: Vitalspanel): Option[UriStr]                      = t.implicitRules
  def extractCode(t: Vitalspanel): CodeableConcept                              = t.code
  def extractInterpretation(t: Vitalspanel): LitSeq[CodeableConcept]            = t.interpretation
  def extractDataAbsentReason(t: Vitalspanel): Option[CodeableConcept]          = t.dataAbsentReason
  def extractModifierExtension(t: Vitalspanel): LitSeq[Extension]               = t.modifierExtension
  def extractComponent(t: Vitalspanel): LitSeq[Observation.Component]           = t.component
  def extractReferenceRange(t: Vitalspanel): LitSeq[Observation.ReferenceRange] = t.referenceRange
  override val thisName: String                                                 = "Vitalspanel"
  override val searchParams: Map[String, Vitalspanel => Seq[Any]]               = Vitalsigns.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Vitalspanel] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Vitalspanel(
          ...
          cursor.decodeAs[NonEmptyLitSeq[Reference]]("hasMember", None),
...
/** FHIR Vital Signs Panel Profile
  ...
  *
  * @constructor
  *   Inherits all params from parent. Requires the following fields which were optional in the parent: hasMember. Forbids the use
  *   of the following fields which were optional in the parent: value.
  * @param id
...
class Vitalspanel(
    ...
    override val meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/vitalspanel"))),
