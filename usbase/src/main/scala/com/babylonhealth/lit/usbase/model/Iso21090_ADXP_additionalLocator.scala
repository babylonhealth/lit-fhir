...
object Iso21090_ADXP_additionalLocator extends CompanionFor[Iso21090_ADXP_additionalLocator] {
  ...
  override def fields(t: Iso21090_ADXP_additionalLocator): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Iso21090_ADXP_additionalLocator): Option[String]                   = t.id
  def extractUrl(t: Iso21090_ADXP_additionalLocator): String                          = t.url
  ...
  def unapply(o: Iso21090_ADXP_additionalLocator): Option[(Option[String], String, String)] = Some(
