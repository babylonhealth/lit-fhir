...
object Valueset_map extends CompanionFor[Valueset_map] {
  ...
  override def fields(t: Valueset_map): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Valueset_map): String                          = t.url
  ...
  def unapply(o: Valueset_map): Option[(Option[String], String, Canonical)] = Some(
