...
object Valueset_systemName extends CompanionFor[Valueset_systemName] {
  implicit def summonObjectAndCompanionValueset_systemName738748769(
      o: Valueset_systemName): ObjectAndCompanion[Valueset_systemName, Valueset_systemName.type] = ObjectAndCompanion(o, this)
  ...
  override def fields(t: Valueset_systemName): Seq[FHIRComponentField[_]] = fieldsFromParent(t).get
  ...
  def unapply(o: Valueset_systemName): Option[(Option[String], String)]   = Some((o.id, o.value.get.toSubRefNonUnion[String]))
