...
object Valueset_systemName extends CompanionFor[Valueset_systemName] {
  ...
  override def fields(t: Valueset_systemName): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Valueset_systemName): Option[String]                   = t.id
  def extractUrl(t: Valueset_systemName): String                          = t.url
  ...
  def unapply(o: Valueset_systemName): Option[(Option[String], String, String)] = Some(
