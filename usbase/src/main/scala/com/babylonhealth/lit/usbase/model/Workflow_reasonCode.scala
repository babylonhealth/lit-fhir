...
object Workflow_reasonCode extends CompanionFor[Workflow_reasonCode] {
  implicit def summonObjectAndCompanionWorkflow_reasonCode1739590442(
      o: Workflow_reasonCode): ObjectAndCompanion[Workflow_reasonCode, Workflow_reasonCode.type] = ObjectAndCompanion(o, this)
  override type ResourceType = Extension
  override type ParentType   = Extension
  override val baseType: CompanionFor[ResourceType] = Extension
  override val parentType: CompanionFor[ParentType] = Extension
  override val profileUrl: Option[String]           = Some("http://hl7.org/fhir/StructureDefinition/workflow-reasonCode")
  def apply(
  ...
  override def fields(t: Workflow_reasonCode): Seq[FHIRComponentField[_]] = fieldsFromParent(t).get
  ...
  def unapply(o: Workflow_reasonCode): Option[(Option[String], CodeableConcept)] = Some(
