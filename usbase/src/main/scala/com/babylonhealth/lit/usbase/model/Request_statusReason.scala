...
object Request_statusReason extends CompanionFor[Request_statusReason] {
  ...
  ): Request_statusReason = new Request_statusReason(
    id,
    url,
    value,
  ...
  override def fields(t: Request_statusReason): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Request_statusReason): String                          = t.url
  ...
  def unapply(o: Request_statusReason): Option[(Option[String], String, CodeableConcept)] = Some(
