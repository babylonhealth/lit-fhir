...
object Cholesterol extends CompanionFor[Cholesterol] {
  implicit def summonObjectAndCompanionCholesterol36268419(
      o: Cholesterol): ObjectAndCompanion[Cholesterol, Cholesterol.type] = ObjectAndCompanion(o, this)
...
/** Describes how the lab report is used for a standard Lipid Profile - Cholesterol, Triglyceride and Cholesterol fractions. Uses LOINC codes
  ...
  *              Requires the following fields which were optional in the parent: referenceRange.
  *              Forbids the use of the following fields which were optional in the parent: hasMember, derivedFrom.
  ...
  * @param note - May include statements about significant, unexpected or unreliable. values, or information about the source of the value where this may be relevant to the interpretation of the result.
...
class Cholesterol(
    ...
    override val meta: Option[Meta] = Some(
      new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/cholesterol"))),
