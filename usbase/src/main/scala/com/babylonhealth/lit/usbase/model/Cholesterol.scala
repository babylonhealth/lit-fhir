...
/** Describes how the lab report is used for a standard Lipid Profile - Cholesterol, Triglyceride and Cholesterol
  * fractions. Uses LOINC codes
  *
  ...
  *   - Cholesterol.
  * @param note
  *   - May include statements about significant, unexpected or unreliable. values, or information about the source of
  *   the value where this may be relevant to the interpretation of the result.
  * @param focus
