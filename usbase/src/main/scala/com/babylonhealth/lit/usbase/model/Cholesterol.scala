...
object Cholesterol extends CompanionFor[Cholesterol] {
  ...
  def apply(
      ...
      effective: Option[Cholesterol.EffectiveChoice] = None,
  ...
  val effective: FHIRComponentFieldMeta[Option[Cholesterol.EffectiveChoice]] =
    FHIRComponentFieldMeta("effective", lTagOf[Option[Cholesterol.EffectiveChoice]], true, lTagOf[UnionObservation_Effective])
  ...
  override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Try(
    Seq(
      ...
      FHIRComponentField[Option[Cholesterol.EffectiveChoice]](effective, t.effective),
  ...
  override def fields(t: Cholesterol): Seq[FHIRComponentField[_]]           = fieldsFromParent(t).get
  def extractId(t: Cholesterol): Option[String]                             = t.id
  def extractMeta(t: Cholesterol): Option[Meta]                             = t.meta
  def extractText(t: Cholesterol): Option[Narrative]                        = t.text
  def extractCode(t: Cholesterol): CodeableConcept                          = t.code
  def extractNote(t: Cholesterol): LitSeq[Annotation]                       = t.note
  def extractFocus(t: Cholesterol): LitSeq[Reference]                       = t.focus
  def extractPartOf(t: Cholesterol): LitSeq[Reference]                      = t.partOf
  def extractStatus(t: Cholesterol): OBSERVATION_STATUS                     = t.status
  def extractIssued(t: Cholesterol): Option[ZonedDateTime]                  = t.issued
  def extractMethod(t: Cholesterol): Option[CodeableConcept]                = t.method
  def extractDevice(t: Cholesterol): Option[Reference]                      = t.device
  def extractBasedOn(t: Cholesterol): LitSeq[Reference]                     = t.basedOn
  ...
  def extractExtension(t: Cholesterol): LitSeq[Extension]                   = t.extension
  def extractEncounter(t: Cholesterol): Option[Reference]                   = t.encounter
  def extractPerformer(t: Cholesterol): LitSeq[Reference]                   = t.performer
  def extractIdentifier(t: Cholesterol): LitSeq[Identifier]                 = t.identifier
  def extractEffective(t: Cholesterol): Option[Cholesterol.EffectiveChoice] = t.effective
  def extractImplicitRules(t: Cholesterol): Option[UriStr]                  = t.implicitRules
  def extractInterpretation(t: Cholesterol): Option[CodeableConcept]        = t.interpretation.headOption
  def extractDataAbsentReason(t: Cholesterol): Option[CodeableConcept]      = t.dataAbsentReason
  def extractModifierExtension(t: Cholesterol): LitSeq[Extension]           = t.modifierExtension
  def extractComponent(t: Cholesterol): LitSeq[Observation.Component]       = t.component
  def extractReferenceRange(t: Cholesterol): Observation.ReferenceRange     = t.referenceRange.head
  override val thisName: String                                             = "Cholesterol"
  override val searchParams: Map[String, Cholesterol => Seq[Any]]           = Observation.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Cholesterol] =
...
/** Describes how the lab report is used for a standard Lipid Profile - Cholesterol, Triglyceride and Cholesterol fractions. Uses
  * LOINC codes
  *
  ...
  *   - Cholesterol.
  * @param note
  *   - May include statements about significant, unexpected or unreliable. values, or information about the source of the value
...
class Cholesterol(
    ...
    override val meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/cholesterol"))),
    ...
    override val effective: Option[Cholesterol.EffectiveChoice] = None,
