...
object Cqf_encounterClass extends CompanionFor[Cqf_encounterClass] {
  implicit def summonObjectAndCompanionCqf_encounterClass_1756156593(
      o: Cqf_encounterClass): ObjectAndCompanion[Cqf_encounterClass, Cqf_encounterClass.type] = ObjectAndCompanion(o, this)
