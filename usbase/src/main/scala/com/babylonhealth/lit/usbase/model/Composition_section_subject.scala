...
object Composition_section_subject extends CompanionFor[Composition_section_subject] {
  ...
  override val profileUrl: Option[String]        = Some("http://hl7.org/fhir/StructureDefinition/composition-section-subject")
  def apply(
      id: Option[String] = None,
      url: String,
      value: String,
      primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
  ): Composition_section_subject = new Composition_section_subject(
    id,
    url,
    value,
  ...
  override def fields(t: Composition_section_subject): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Composition_section_subject): Option[String]                   = t.id
  def extractUrl(t: Composition_section_subject): String                          = t.url
  ...
  def unapply(o: Composition_section_subject): Option[(Option[String], String, String)] = Some(
  ...
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Composition_section_subject] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Composition_section_subject(
...
/** Specifies that the section has a different subject that the Composition, or it's container section.
  ...
  */
@POJOBoilerplate
class Composition_section_subject(
