...
object Cqf_receivingPerson extends CompanionFor[Cqf_receivingPerson] {
  ...
  override def fields(t: Cqf_receivingPerson): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Cqf_receivingPerson): String                          = t.url
  ...
  def unapply(o: Cqf_receivingPerson): Option[(Option[String], String, Reference)] = Some(
