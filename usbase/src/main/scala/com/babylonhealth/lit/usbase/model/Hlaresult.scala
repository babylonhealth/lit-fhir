...
object Hlaresult extends CompanionFor[Hlaresult] {
  implicit def summonObjectAndCompanionHlaresult_156723936(
      o: Hlaresult): ObjectAndCompanion[Hlaresult, Hlaresult.type] = ObjectAndCompanion(o, this)
  ...
  override def fields(t: Hlaresult): Seq[FHIRComponentField[_]]         = fieldsFromParent(t).get
  def extractId(t: Hlaresult): Option[String]                           = t.id
  def extractMeta(t: Hlaresult): Option[Meta]                           = t.meta
  def extractText(t: Hlaresult): Option[Narrative]                      = t.text
  def extractCode(t: Hlaresult): CodeableConcept                        = t.code
  def extractStatus(t: Hlaresult): DIAGNOSTIC_REPORT_STATUS             = t.status
  def extractIssued(t: Hlaresult): Option[ZonedDateTime]                = t.issued
  def extractResult(t: Hlaresult): LitSeq[Reference]                    = t.result
  def extractBasedOn(t: Hlaresult): LitSeq[Reference]                   = t.basedOn
  def extractSubject(t: Hlaresult): Option[Reference]                   = t.subject
  def extractLanguage(t: Hlaresult): Option[LANGUAGES]                  = t.language
  def extractCategory(t: Hlaresult): LitSeq[CodeableConcept]            = t.category
  def extractSpecimen(t: Hlaresult): LitSeq[Reference]                  = t.specimen
  def extractContained(t: Hlaresult): LitSeq[Resource]                  = t.contained
  def extractExtension(t: Hlaresult): LitSeq[Extension]                 = t.extension
  ...
  def extractPresentedForm(t: Hlaresult): LitSeq[Attachment]            = t.presentedForm
  def extractConclusionCode(t: Hlaresult): LitSeq[CodeableConcept]      = t.conclusionCode
  def extractModifierExtension(t: Hlaresult): LitSeq[Extension]         = t.modifierExtension
  def extractResultsInterpreter(t: Hlaresult): LitSeq[Reference]        = t.resultsInterpreter
  def extractMedia(t: Hlaresult): LitSeq[DiagnosticReport.Media]        = t.media
  override val thisName: String                                         = "Hlaresult"
  override val searchParams: Map[String, Hlaresult => Seq[Any]]         = DiagnosticReport.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Hlaresult] =
...
class Hlaresult(
    ...
    override val meta: Option[Meta] = Some(
      new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/hlaresult"))),
