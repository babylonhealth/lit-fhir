...
object Groupdefinition extends CompanionFor[Groupdefinition] {
  ...
  def extractType(t: Groupdefinition): GROUP_TYPE                             = t.`type`
  def extractCode(t: Groupdefinition): Option[CodeableConcept]                = t.code
  def extractName(t: Groupdefinition): Option[String]                         = t.name
  def extractActive(t: Groupdefinition): Option[Boolean]                      = t.active
  def extractActual(t: Groupdefinition): Boolean                              = t.actual
  def extractLanguage(t: Groupdefinition): Option[LANGUAGES]                  = t.language
  def extractQuantity(t: Groupdefinition): Option[UnsignedInt]                = t.quantity
  def extractContained(t: Groupdefinition): LitSeq[Resource]                  = t.contained
  def extractExtension(t: Groupdefinition): LitSeq[Extension]                 = t.extension
  def extractIdentifier(t: Groupdefinition): LitSeq[Identifier]               = t.identifier
  def extractImplicitRules(t: Groupdefinition): Option[UriStr]                = t.implicitRules
  def extractManagingEntity(t: Groupdefinition): Option[Reference]            = t.managingEntity
  def extractModifierExtension(t: Groupdefinition): LitSeq[Extension]         = t.modifierExtension
  def extractCharacteristic(t: Groupdefinition): LitSeq[Group.Characteristic] = t.characteristic
  override val thisName: String                                               = "Groupdefinition"
  override val searchParams: Map[String, Groupdefinition => Seq[Any]]         = Group.searchParams
  def unapply(
      o: Groupdefinition): Option[(Option[String], Option[Meta], Option[Narrative], GROUP_TYPE, Option[CodeableConcept], Option[String], Option[Boolean], Boolean, Option[LANGUAGES], Option[UnsignedInt], LitSeq[Resource], LitSeq[Extension], LitSeq[Identifier], Option[UriStr], Option[Reference], LitSeq[Extension], LitSeq[Group.Characteristic])] =
    Some(
      (
        o.id,
        o.meta,
        ...
        o.modifierExtension,
        o.characteristic))
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Groupdefinition] =
...
/** Enforces a descriptive group that can be used in definitional resources
  *
  * Subclass of [[hl7.model.Group]] (Represents a defined collection of entities that may be discussed or acted upon
  * collectively but which are not expected to act collectively, and are not formally or legally recognized; i.e. a
  ...
  * @param active
  *   - Indicates whether the record for the group is available for use or is merely being retained for historical
  *   purposes.
  * @param actual
  *   - If true, indicates that the resource refers to a specific group of real individuals. If false, the group defines
  *   a set of intended individuals.
  * @param language
...
class Groupdefinition(
    ...
    override val meta: Option[Meta] = Some(
      new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/groupdefinition"))),
    ...
    override val characteristic: LitSeq[Group.Characteristic] = LitSeq.empty,
