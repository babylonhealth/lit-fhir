...
object Groupdefinition extends CompanionFor[Groupdefinition] {
  implicit def summonObjectAndCompanionGroupdefinition_852256611(
...
/** Enforces a descriptive group that can be used in definitional resources
  *
  * Subclass of [[hl7.model.Group]] (Represents a defined collection of entities that may be discussed or acted upon collectively
  * but which are not expected to act collectively, and are not formally or legally recognized; i.e. a collection of entities that
...
class Groupdefinition(
    ...
    override val meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/groupdefinition"))),
