...
object Request_replaces extends CompanionFor[Request_replaces] {
  ...
  override val profileUrl: Option[String]        = Some("http://hl7.org/fhir/StructureDefinition/request-replaces")
  def apply(
      id: Option[String] = None,
      url: String,
      value: Reference,
      primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
  ): Request_replaces = new Request_replaces(
    id,
    url,
    value,
  ...
  override def fields(t: Request_replaces): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Request_replaces): String                          = t.url
  ...
  def unapply(o: Request_replaces): Option[(Option[String], String, Reference)] = Some(
