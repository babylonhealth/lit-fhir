...
object Careplan_activity_title extends CompanionFor[Careplan_activity_title] {
  ...
  def extractValue(t: Careplan_activity_title): String                        = t.value.get.value.asInstanceOf[String]
  ...
  def unapply(o: Careplan_activity_title): Option[(Option[String], String)] = Some(
