...
object Careplan_activity_title extends CompanionFor[Careplan_activity_title] {
  ...
  override def fields(t: Careplan_activity_title): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Careplan_activity_title): Option[String]                   = t.id
  def extractUrl(t: Careplan_activity_title): String                          = t.url
  ...
  def unapply(o: Careplan_activity_title): Option[(Option[String], String, String)] = Some(
