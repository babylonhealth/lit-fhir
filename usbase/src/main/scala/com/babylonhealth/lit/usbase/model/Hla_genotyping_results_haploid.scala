...
object Hla_genotyping_results_haploid extends CompanionFor[Hla_genotyping_results_haploid] {
  implicit def summonObjectAndCompanionHla_genotyping_results_haploid_1858480980(
  ...
  override val profileUrl: Option[String] = Some("http://hl7.org/fhir/StructureDefinition/hla-genotyping-results-haploid")
  def apply(
  ...
  def unapply(o: Hla_genotyping_results_haploid): Option[(Option[String], LitSeq[Extension])] = Some((o.id, o.extension))
