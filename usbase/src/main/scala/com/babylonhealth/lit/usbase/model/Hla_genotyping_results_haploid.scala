...
object Hla_genotyping_results_haploid extends CompanionFor[Hla_genotyping_results_haploid] {
  ...
  override def fields(t: Hla_genotyping_results_haploid): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[LitSeq[Extension]](extension, t.extension)
  )
  def extractId(t: Hla_genotyping_results_haploid): Option[String]                   = t.id
  def extractUrl(t: Hla_genotyping_results_haploid): String                          = t.url
  ...
  def unapply(o: Hla_genotyping_results_haploid): Option[(Option[String], String, LitSeq[Extension])] = Some(
