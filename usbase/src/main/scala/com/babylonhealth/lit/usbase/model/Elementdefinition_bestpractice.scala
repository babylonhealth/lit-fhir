...
object Elementdefinition_bestpractice extends CompanionFor[Elementdefinition_bestpractice] {
  ...
  def unapply(o: Elementdefinition_bestpractice): Option[(Option[String], Elementdefinition_bestpractice.ValueChoice)] = Some(
...
/** Mark that an invariant represents 'best practice' rule - a rule that implementers may choose to enforce at error level in some
