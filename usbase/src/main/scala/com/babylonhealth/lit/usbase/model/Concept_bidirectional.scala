...
object Concept_bidirectional extends CompanionFor[Concept_bidirectional] {
  ...
  ): Concept_bidirectional = new Concept_bidirectional(
    id,
    url,
    value,
  ...
  override def fields(t: Concept_bidirectional): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Concept_bidirectional): String                          = t.url
  ...
  def unapply(o: Concept_bidirectional): Option[(Option[String], String, Boolean)] = Some(
