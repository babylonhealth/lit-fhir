...
object Timing_daysOfCycle extends CompanionFor[Timing_daysOfCycle] {
  ...
  override def fields(t: Timing_daysOfCycle): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Timing_daysOfCycle): String                          = t.url
  ...
  def unapply(o: Timing_daysOfCycle): Option[(Option[String], String, NonEmptyLitSeq[Extension])] = Some(
