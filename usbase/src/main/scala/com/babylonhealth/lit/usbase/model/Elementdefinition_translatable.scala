...
object Elementdefinition_translatable extends CompanionFor[Elementdefinition_translatable] {
  ...
  override def fields(t: Elementdefinition_translatable): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Elementdefinition_translatable): String                          = t.url
  ...
  def unapply(o: Elementdefinition_translatable): Option[(Option[String], String, Boolean)] = Some(
