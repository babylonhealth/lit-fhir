...
object Elementdefinition_translatable extends CompanionFor[Elementdefinition_translatable] {
  implicit def summonObjectAndCompanionElementdefinition_translatable1408703652(
      o: Elementdefinition_translatable): ObjectAndCompanion[Elementdefinition_translatable, Elementdefinition_translatable.type] =
    ObjectAndCompanion(o, this)
  override type ResourceType = Extension
  override type ParentType   = Extension
  override val baseType: CompanionFor[ResourceType] = Extension
  override val parentType: CompanionFor[ParentType] = Extension
  override val profileUrl: Option[String] = Some("http://hl7.org/fhir/StructureDefinition/elementdefinition-translatable")
  def apply(
      id: Option[String] = None,
      value: Boolean,
      primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
  ): Elementdefinition_translatable = new Elementdefinition_translatable(
    id,
    value,
  ...
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Elementdefinition_translatable] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Elementdefinition_translatable(
...
/** Whether translations might be expected for this element in resource instances.
  ...
  */
@POJOBoilerplate
class Elementdefinition_translatable(
