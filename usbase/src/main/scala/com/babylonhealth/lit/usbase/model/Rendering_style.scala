...
object Rendering_style extends CompanionFor[Rendering_style] {
  ...
  override def fields(t: Rendering_style): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Rendering_style): Option[String]                   = t.id
  def extractUrl(t: Rendering_style): String                          = t.url
  ...
  def unapply(o: Rendering_style): Option[(Option[String], String, String)] = Some(
