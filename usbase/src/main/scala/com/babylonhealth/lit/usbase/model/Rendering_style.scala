...
object Rendering_style extends CompanionFor[Rendering_style] {
  ...
  def extractValue(t: Rendering_style): String                        = t.value.get.value.asInstanceOf[String]
  ...
  def unapply(o: Rendering_style): Option[(Option[String], String)]   = Some((o.id, o.value.get.value.asInstanceOf[String]))
