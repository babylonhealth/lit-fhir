...
object Ehrsrle_auditevent extends CompanionFor[Ehrsrle_auditevent] {
  implicit def summonObjectAndCompanionEhrsrle_auditevent_1148493658(
      o: Ehrsrle_auditevent): ObjectAndCompanion[Ehrsrle_auditevent, Ehrsrle_auditevent.type] =
...
/** Defines the elements to be supported within the AuditEvent resource in order to conform with the Electronic Health
  * Record System Functional Model Record Lifecycle Event standard
  *
  * Subclass of [[hl7.model.AuditEvent]] (A record of an event made for purposes of maintaining a security log. Typical
