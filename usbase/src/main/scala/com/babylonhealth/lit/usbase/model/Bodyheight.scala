...
object Bodyheight extends CompanionFor[Bodyheight] {
  implicit def summonObjectAndCompanionBodyheight_905150754(o: Bodyheight): ObjectAndCompanion[Bodyheight, Bodyheight.type] =
  ...
  override val profileUrl: Option[String]           = Some("http://hl7.org/fhir/StructureDefinition/bodyheight")
  type EffectiveChoice = Choice[UnionDateTimeOrPeriod]
  def apply(
      id: Option[String] = None,
      meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/bodyheight"))),
      ...
      effective: Bodyheight.EffectiveChoice,
  ...
  val effective: FHIRComponentFieldMeta[Bodyheight.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Bodyheight.EffectiveChoice], true, lTagOf[UnionDateTimeOrPeriod])
  ...
  override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Try(
    Seq(
      ...
      FHIRComponentField[Bodyheight.EffectiveChoice](effective, t.effective.get.toSubRef),
  ...
  override def fields(t: Bodyheight): Seq[FHIRComponentField[_]]               = fieldsFromParent(t).get
  def extractId(t: Bodyheight): Option[String]                                 = t.id
  def extractMeta(t: Bodyheight): Option[Meta]                                 = t.meta
  def extractText(t: Bodyheight): Option[Narrative]                            = t.text
  def extractNote(t: Bodyheight): LitSeq[Annotation]                           = t.note
  def extractFocus(t: Bodyheight): LitSeq[Reference]                           = t.focus
  def extractPartOf(t: Bodyheight): LitSeq[Reference]                          = t.partOf
  def extractStatus(t: Bodyheight): OBSERVATION_STATUS                         = t.status
  def extractIssued(t: Bodyheight): Option[ZonedDateTime]                      = t.issued
  def extractMethod(t: Bodyheight): Option[CodeableConcept]                    = t.method
  def extractDevice(t: Bodyheight): Option[Reference]                          = t.device
  def extractBasedOn(t: Bodyheight): LitSeq[Reference]                         = t.basedOn
  ...
  def extractExtension(t: Bodyheight): LitSeq[Extension]                       = t.extension
  def extractEncounter(t: Bodyheight): Option[Reference]                       = t.encounter
  def extractPerformer(t: Bodyheight): LitSeq[Reference]                       = t.performer
  def extractHasMember(t: Bodyheight): LitSeq[Reference]                       = t.hasMember
  def extractIdentifier(t: Bodyheight): LitSeq[Identifier]                     = t.identifier
  def extractDerivedFrom(t: Bodyheight): LitSeq[Reference]                     = t.derivedFrom
  def extractEffective(t: Bodyheight): Bodyheight.EffectiveChoice              = t.effective.get.toSubRef
  def extractImplicitRules(t: Bodyheight): Option[UriStr]                      = t.implicitRules
  def extractCode(t: Bodyheight): CodeableConcept                              = t.code
  def extractInterpretation(t: Bodyheight): LitSeq[CodeableConcept]            = t.interpretation
  def extractDataAbsentReason(t: Bodyheight): Option[CodeableConcept]          = t.dataAbsentReason
  def extractModifierExtension(t: Bodyheight): LitSeq[Extension]               = t.modifierExtension
  def extractComponent(t: Bodyheight): LitSeq[Observation.Component]           = t.component
  def extractReferenceRange(t: Bodyheight): LitSeq[Observation.ReferenceRange] = t.referenceRange
  override val thisName: String                                                = "Bodyheight"
  override val searchParams: Map[String, Bodyheight => Seq[Any]]               = Vitalsigns.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Bodyheight] =
...
class Bodyheight(
    ...
    override val meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/bodyheight"))),
