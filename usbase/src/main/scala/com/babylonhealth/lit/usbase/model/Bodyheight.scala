...
object Bodyheight extends CompanionFor[Bodyheight] {
  implicit def summonObjectAndCompanionBodyheight_2027949598(
      o: Bodyheight): ObjectAndCompanion[Bodyheight, Bodyheight.type] = ObjectAndCompanion(o, this)
  ...
  val effective: FHIRComponentFieldMeta[Bodyheight.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Bodyheight.EffectiveChoice], true, lTagOf[Union_0934386166])
...
class Bodyheight(
    ...
    override val meta: Option[Meta] = Some(
      new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/bodyheight"))),
