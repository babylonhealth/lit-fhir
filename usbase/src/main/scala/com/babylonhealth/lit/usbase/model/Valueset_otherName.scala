...
object Valueset_otherName extends CompanionFor[Valueset_otherName] {
  implicit def summonObjectAndCompanionValueset_otherName331411530(
      o: Valueset_otherName): ObjectAndCompanion[Valueset_otherName, Valueset_otherName.type] =
  ...
  def unapply(o: Valueset_otherName): Option[(Option[String], NonEmptyLitSeq[Extension])] = Some(
