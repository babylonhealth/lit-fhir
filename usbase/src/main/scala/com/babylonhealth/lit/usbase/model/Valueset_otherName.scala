...
object Valueset_otherName extends CompanionFor[Valueset_otherName] {
  ...
  override def fields(t: Valueset_otherName): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Valueset_otherName): String                          = t.url
  ...
  def unapply(o: Valueset_otherName): Option[(Option[String], String, NonEmptyLitSeq[Extension])] = Some(
