...
object Humanname_partner_name extends CompanionFor[Humanname_partner_name] {
  ...
  override def fields(t: Humanname_partner_name): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Humanname_partner_name): Option[String]                   = t.id
  def extractUrl(t: Humanname_partner_name): String                          = t.url
  ...
  def unapply(o: Humanname_partner_name): Option[(Option[String], String, String)] = Some(
