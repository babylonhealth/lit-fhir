...
object Humanname_partner_name extends CompanionFor[Humanname_partner_name] {
  implicit def summonObjectAndCompanionHumanname_partner_name466185061(
  ...
  def unapply(o: Humanname_partner_name): Option[(Option[String], String)] = Some(
...
/** The portion of the family name that is derived from the person's partner's surname, as distinguished from any
  * portion that is derived from the surname of the person's own name.
  *
