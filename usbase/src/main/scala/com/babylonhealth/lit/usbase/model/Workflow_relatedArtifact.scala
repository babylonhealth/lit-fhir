...
object Workflow_relatedArtifact extends CompanionFor[Workflow_relatedArtifact] {
  ...
  override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Try(
    Seq(
      ...
      FHIRComponentField[RelatedArtifact](value, t.value.get.value.asInstanceOf[RelatedArtifact])
    ))
  ...
  def extractValue(t: Workflow_relatedArtifact): RelatedArtifact               = t.value.get.value.asInstanceOf[RelatedArtifact]
  ...
  def unapply(o: Workflow_relatedArtifact): Option[(Option[String], RelatedArtifact)] = Some(
    (o.id, o.value.get.value.asInstanceOf[RelatedArtifact]))
