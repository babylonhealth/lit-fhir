...
object Workflow_relatedArtifact extends CompanionFor[Workflow_relatedArtifact] {
  implicit def summonObjectAndCompanionWorkflow_relatedArtifact_157434611(
...
/** Documentation or 'knowledge artifacts' relevant to the base resource such as citations, supporting evidence,
  * documentation of processes, caveats around testing methodology.
  *
