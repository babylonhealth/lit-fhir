...
object Diagnosticreport_genetics extends CompanionFor[Diagnosticreport_genetics] {
  ...
  def apply(
      ...
      meta: Option[Meta] = Some(
        new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/diagnosticreport-genetics"))),
      ...
      effective: Option[Diagnosticreport_genetics.EffectiveChoice] = None,
  ...
  ): Diagnosticreport_genetics = new Diagnosticreport_genetics(
    id,
    meta,
    text,
    code,
  ...
  val effective: FHIRComponentFieldMeta[Option[Diagnosticreport_genetics.EffectiveChoice]] =
  ...
  override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Try(
    Seq(
      ...
      FHIRComponentField[Option[Diagnosticreport_genetics.EffectiveChoice]](effective, t.effective),
  ...
  override def fields(t: Diagnosticreport_genetics): Seq[FHIRComponentField[_]]                         = fieldsFromParent(t).get
  def extractId(t: Diagnosticreport_genetics): Option[String]                                           = t.id
  def extractMeta(t: Diagnosticreport_genetics): Option[Meta]                                           = t.meta
  def extractText(t: Diagnosticreport_genetics): Option[Narrative]                                      = t.text
  def extractCode(t: Diagnosticreport_genetics): CodeableConcept                                        = t.code
  def extractStatus(t: Diagnosticreport_genetics): DIAGNOSTIC_REPORT_STATUS                             = t.status
  def extractIssued(t: Diagnosticreport_genetics): Option[ZonedDateTime]                                = t.issued
  def extractResult(t: Diagnosticreport_genetics): LitSeq[Reference]                                    = t.result
  def extractBasedOn(t: Diagnosticreport_genetics): LitSeq[Reference]                                   = t.basedOn
  def extractSubject(t: Diagnosticreport_genetics): Option[Reference]                                   = t.subject
  def extractLanguage(t: Diagnosticreport_genetics): Option[LANGUAGES]                                  = t.language
  def extractCategory(t: Diagnosticreport_genetics): LitSeq[CodeableConcept]                            = t.category
  def extractSpecimen(t: Diagnosticreport_genetics): LitSeq[Reference]                                  = t.specimen
  def extractContained(t: Diagnosticreport_genetics): LitSeq[Resource]                                  = t.contained
  def extractExtension(t: Diagnosticreport_genetics): LitSeq[Extension]                                 = t.extension
  def extractEncounter(t: Diagnosticreport_genetics): Option[Reference]                                 = t.encounter
  def extractPerformer(t: Diagnosticreport_genetics): LitSeq[Reference]                                 = t.performer
  def extractIdentifier(t: Diagnosticreport_genetics): LitSeq[Identifier]                               = t.identifier
  def extractConclusion(t: Diagnosticreport_genetics): Option[String]                                   = t.conclusion
  def extractEffective(t: Diagnosticreport_genetics): Option[Diagnosticreport_genetics.EffectiveChoice] = t.effective
  def extractImagingStudy(t: Diagnosticreport_genetics): LitSeq[Reference]                              = t.imagingStudy
  def extractImplicitRules(t: Diagnosticreport_genetics): Option[UriStr]                                = t.implicitRules
  def extractPresentedForm(t: Diagnosticreport_genetics): LitSeq[Attachment]                            = t.presentedForm
  def extractModifierExtension(t: Diagnosticreport_genetics): LitSeq[Extension]                         = t.modifierExtension
  def extractResultsInterpreter(t: Diagnosticreport_genetics): LitSeq[Reference]                        = t.resultsInterpreter
  def extractMedia(t: Diagnosticreport_genetics): LitSeq[DiagnosticReport.Media]                        = t.media
  override val thisName: String                                                                         = "Diagnosticreport_genetics"
  override val searchParams: Map[String, Diagnosticreport_genetics => Seq[Any]]                         = DiagnosticReport.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Diagnosticreport_genetics] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Diagnosticreport_genetics(
...
/** Describes how the DiagnosticReport resource is used to report structured genetic test results
  ...
  *              Forbids the use of the following fields which were optional in the parent: conclusionCode.
  ...
  * @param result - [Observations](http://hl7.org/fhir/observation.html)  that are part of this diagnostic report.
  ...
  * @param effective - The time or time-period the observed values are related to. When the subject of the report is a patient, this is usually either the time of the procedure or of specimen collection(s), but very often the source of the date/time is not known, only the date/time itself.
...
class Diagnosticreport_genetics(
    ...
    override val effective: Option[Diagnosticreport_genetics.EffectiveChoice] = None,
