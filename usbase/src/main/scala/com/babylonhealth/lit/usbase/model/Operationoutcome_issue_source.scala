...
object Operationoutcome_issue_source extends CompanionFor[Operationoutcome_issue_source] {
  ...
  override def fields(t: Operationoutcome_issue_source): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Operationoutcome_issue_source): Option[String]                   = t.id
  def extractUrl(t: Operationoutcome_issue_source): String                          = t.url
  ...
  def unapply(o: Operationoutcome_issue_source): Option[(Option[String], String, String)] = Some(
