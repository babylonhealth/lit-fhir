...
object Operationoutcome_issue_source extends CompanionFor[Operationoutcome_issue_source] {
  implicit def summonObjectAndCompanionOperationoutcome_issue_source_2145312728(
      o: Operationoutcome_issue_source): ObjectAndCompanion[Operationoutcome_issue_source, Operationoutcome_issue_source.type] =
    ObjectAndCompanion(o, this)
  override type ResourceType = Extension
  override type ParentType   = Extension
  override val baseType: CompanionFor[ResourceType] = Extension
  override val parentType: CompanionFor[ParentType] = Extension
  override val profileUrl: Option[String] = Some("http://hl7.org/fhir/StructureDefinition/operationoutcome-issue-source")
  def apply(
      id: Option[String] = None,
      value: String,
      primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
  ): Operationoutcome_issue_source = new Operationoutcome_issue_source(
    id,
    value,
  ...
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Operationoutcome_issue_source] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Operationoutcome_issue_source(
...
/** Helps a user track down the source of the problem.
  ...
  */
@POJOBoilerplate
class Operationoutcome_issue_source(
