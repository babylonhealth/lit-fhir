...
object Headcircum extends CompanionFor[Headcircum] {
  ...
  val effective: FHIRComponentFieldMeta[Headcircum.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Headcircum.EffectiveChoice], true, lTagOf[Union_0934386166])
...
class Headcircum(
    ...
    override val meta: Option[Meta] = Some(
      new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/headcircum"))),
