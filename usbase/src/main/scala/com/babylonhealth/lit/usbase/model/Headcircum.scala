...
object Headcircum extends CompanionFor[Headcircum] {
  implicit def summonObjectAndCompanionHeadcircum1281014741(o: Headcircum): ObjectAndCompanion[Headcircum, Headcircum.type] =
  ...
  val effective: FHIRComponentFieldMeta[Headcircum.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Headcircum.EffectiveChoice], true, lTagOf[UnionFHIRDateTimeOrPeriod])
