...
object Headcircum extends CompanionFor[Headcircum] {
  implicit def summonObjectAndCompanionHeadcircum575052132(o: Headcircum): ObjectAndCompanion[Headcircum, Headcircum.type] =
  ...
  def apply(
      ...
      meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/headcircum"))),
      ...
      effective: Headcircum.EffectiveChoice,
  ...
  val effective: FHIRComponentFieldMeta[Headcircum.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Headcircum.EffectiveChoice], true, lTagOf[UnionDateTimeOrPeriod])
  ...
  override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Try(
    Seq(
      ...
      FHIRComponentField[Headcircum.EffectiveChoice](effective, t.effective.get.toSubRef),
  ...
  override def fields(t: Headcircum): Seq[FHIRComponentField[_]]               = fieldsFromParent(t).get
  def extractId(t: Headcircum): Option[String]                                 = t.id
  def extractMeta(t: Headcircum): Option[Meta]                                 = t.meta
  def extractText(t: Headcircum): Option[Narrative]                            = t.text
  def extractNote(t: Headcircum): LitSeq[Annotation]                           = t.note
  def extractFocus(t: Headcircum): LitSeq[Reference]                           = t.focus
  def extractPartOf(t: Headcircum): LitSeq[Reference]                          = t.partOf
  def extractStatus(t: Headcircum): OBSERVATION_STATUS                         = t.status
  def extractIssued(t: Headcircum): Option[ZonedDateTime]                      = t.issued
  def extractMethod(t: Headcircum): Option[CodeableConcept]                    = t.method
  def extractDevice(t: Headcircum): Option[Reference]                          = t.device
  def extractBasedOn(t: Headcircum): LitSeq[Reference]                         = t.basedOn
  def extractSubject(t: Headcircum): Reference                                 = t.subject.get
  def extractLanguage(t: Headcircum): Option[LANGUAGES]                        = t.language
  def extractCategory(t: Headcircum): NonEmptyLitSeq[CodeableConcept]          = t.category.asNonEmpty
  def extractValue(t: Headcircum): Option[Quantity]                            = t.value.map(_.toSubRefNonUnion[Quantity])
  def extractBodySite(t: Headcircum): Option[CodeableConcept]                  = t.bodySite
  def extractSpecimen(t: Headcircum): Option[Reference]                        = t.specimen
  def extractContained(t: Headcircum): LitSeq[Resource]                        = t.contained
  def extractExtension(t: Headcircum): LitSeq[Extension]                       = t.extension
  def extractEncounter(t: Headcircum): Option[Reference]                       = t.encounter
  def extractPerformer(t: Headcircum): LitSeq[Reference]                       = t.performer
  def extractHasMember(t: Headcircum): LitSeq[Reference]                       = t.hasMember
  def extractIdentifier(t: Headcircum): LitSeq[Identifier]                     = t.identifier
  def extractDerivedFrom(t: Headcircum): LitSeq[Reference]                     = t.derivedFrom
  def extractEffective(t: Headcircum): Headcircum.EffectiveChoice              = t.effective.get.toSubRef
  def extractImplicitRules(t: Headcircum): Option[UriStr]                      = t.implicitRules
  def extractCode(t: Headcircum): CodeableConcept                              = t.code
  def extractInterpretation(t: Headcircum): LitSeq[CodeableConcept]            = t.interpretation
  def extractDataAbsentReason(t: Headcircum): Option[CodeableConcept]          = t.dataAbsentReason
  def extractModifierExtension(t: Headcircum): LitSeq[Extension]               = t.modifierExtension
  def extractComponent(t: Headcircum): LitSeq[Observation.Component]           = t.component
  def extractReferenceRange(t: Headcircum): LitSeq[Observation.ReferenceRange] = t.referenceRange
  override val thisName: String                                                = "Headcircum"
  override val searchParams: Map[String, Headcircum => Seq[Any]]               = Vitalsigns.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Headcircum] =
...
class Headcircum(
    ...
    override val meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/StructureDefinition/headcircum"))),
