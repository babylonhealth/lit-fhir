...
object Codesystem_conceptOrder extends CompanionFor[Codesystem_conceptOrder] {
  ...
  override val profileUrl: Option[String]        = Some("http://hl7.org/fhir/StructureDefinition/codesystem-conceptOrder")
  def apply(
      id: Option[String] = None,
      url: String,
      value: Int,
      primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
  ): Codesystem_conceptOrder = new Codesystem_conceptOrder(
    id,
    url,
    value,
  ...
  override def fields(t: Codesystem_conceptOrder): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Codesystem_conceptOrder): String                          = t.url
  ...
  def unapply(o: Codesystem_conceptOrder): Option[(Option[String], String, Int)] = Some(
