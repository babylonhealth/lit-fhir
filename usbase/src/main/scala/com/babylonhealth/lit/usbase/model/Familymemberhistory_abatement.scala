...
object Familymemberhistory_abatement extends CompanionFor[Familymemberhistory_abatement] {
  ...
  def extractUrl(t: Familymemberhistory_abatement): String                                      = t.url
  ...
  def unapply(
      o: Familymemberhistory_abatement): Option[(Option[String], String, Familymemberhistory_abatement.ValueChoice)] =
