...
object Patient_mothersMaidenName extends CompanionFor[Patient_mothersMaidenName] {
  ...
  override def fields(t: Patient_mothersMaidenName): Seq[FHIRComponentField[_]] = Seq(
    FHIRComponentField[Option[String]](id, t.id),
    FHIRComponentField[String](url, t.url),
    FHIRComponentField[String](value, t.value.get.toSubRefNonUnion[String])
  )
  def extractId(t: Patient_mothersMaidenName): Option[String]                   = t.id
  def extractUrl(t: Patient_mothersMaidenName): String                          = t.url
  ...
  def unapply(o: Patient_mothersMaidenName): Option[(Option[String], String, String)] = Some(
