...
object Patient_mothersMaidenName extends CompanionFor[Patient_mothersMaidenName] {
  implicit def summonObjectAndCompanionPatient_mothersMaidenName_2140254634(
      o: Patient_mothersMaidenName): ObjectAndCompanion[Patient_mothersMaidenName, Patient_mothersMaidenName.type] =
  ...
  ): Patient_mothersMaidenName = new Patient_mothersMaidenName(
    id,
    value,
  ...
  override def fields(t: Patient_mothersMaidenName): Seq[FHIRComponentField[_]] = fieldsFromParent(t).get
  def extractId(t: Patient_mothersMaidenName): Option[String]                   = t.id
...
/** Mother's maiden (unmarried) name, commonly collected to help verify patient identity.
  ...
  */
@POJOBoilerplate
class Patient_mothersMaidenName(
