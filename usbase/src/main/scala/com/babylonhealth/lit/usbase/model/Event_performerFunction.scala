...
object Event_performerFunction extends CompanionFor[Event_performerFunction] {
  ...
  override def fields(t: Event_performerFunction): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Event_performerFunction): String                          = t.url
  ...
  def unapply(o: Event_performerFunction): Option[(Option[String], String, CodeableConcept)] = Some(
