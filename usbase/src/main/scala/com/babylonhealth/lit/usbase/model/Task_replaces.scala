...
object Task_replaces extends CompanionFor[Task_replaces] {
  ...
  override val profileUrl: Option[String]        = Some("http://hl7.org/fhir/StructureDefinition/task-replaces")
  def apply(
      id: Option[String] = None,
      url: String,
      value: Reference,
      primitiveAttributes: TreeMap[FHIRComponentFieldMeta[_], PrimitiveElementInfo] = FHIRObject.emptyAtts
  ): Task_replaces = new Task_replaces(
    id,
    url,
    value,
  ...
  override def fields(t: Task_replaces): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Task_replaces): String                          = t.url
  ...
  def unapply(o: Task_replaces): Option[(Option[String], String, Reference)] = Some(
