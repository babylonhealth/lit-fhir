...
object Observation_reagent extends CompanionFor[Observation_reagent] {
  ...
  ): Observation_reagent = new Observation_reagent(
    id,
    url,
    value,
  ...
  override def fields(t: Observation_reagent): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Observation_reagent): String                          = t.url
  ...
  def unapply(o: Observation_reagent): Option[(Option[String], String, Reference)] = Some(
