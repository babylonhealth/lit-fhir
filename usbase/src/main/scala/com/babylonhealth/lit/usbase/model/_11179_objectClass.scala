...
/** A concept that represents a set of ideas, abstractions, or things in the real world that can be identified with
  * explicit boundaries and meaning and whose properties and behavior follow the same rules. It may be either a single
  * concept or a group of associated concepts, abstractions, or things.
  *
