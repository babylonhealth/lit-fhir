...
import com.babylonhealth.lit.hl7.{ RESOURCE_TYPES, PUBLICATION_STATUS, REQUEST_PRIORITY, REQUEST_INTENT, REQUEST_RESOURCE_TYPES }
...
object Shareableactivitydefinition extends CompanionFor[Shareableactivitydefinition] {
  ...
  val timing: FHIRComponentFieldMeta[Option[Shareableactivitydefinition.TimingChoice]] =
    FHIRComponentFieldMeta("timing", lTagOf[Option[Shareableactivitydefinition.TimingChoice]], true, lTagOf[Union01405873694])
  ...
  def extractObservationResultRequirement(t: Shareableactivitydefinition): LitSeq[Reference]     = t.observationResultRequirement
...
/** Enforces the minimum information set for the activity definition metadata required by HL7 and other organizations that share
  * and publish activity definitions
  *
  * Subclass of [[hl7.model.ActivityDefinition]] (This resource allows for the definition of some activity to be performed,
  ...
  *   of a medication must be computed based on the patient's weight, a dynamic value would be used to specify an expression that
