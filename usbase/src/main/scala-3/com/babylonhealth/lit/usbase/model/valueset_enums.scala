...
enum DATA_ABSENT_REASON(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case MASKED extends DATA_ABSENT_REASON("masked", Some("Masked"), Some("http://terminology.hl7.org/CodeSystem/data-absent-reason"))
  case NEGATIVE_INFINITY extends DATA_ABSENT_REASON("negative-infinity", Some("Negative Infinity (NINF)"), Some("http://terminology.hl7.org/CodeSystem/data-absent-reason"))
  case NOT_APPLICABLE extends DATA_ABSENT_REASON("not-applicable", Some("Not Applicable"), Some("http://terminology.hl7.org/CodeSystem/data-absent-reason"))
  case NOT_ASKED extends DATA_ABSENT_REASON("not-asked", Some("Not Asked"), Some("http://terminology.hl7.org/CodeSystem/data-absent-reason"))
  case NOT_A_NUMBER extends DATA_ABSENT_REASON("not-a-number", Some("Not a Number (NaN)"), Some("http://terminology.hl7.org/CodeSystem/data-absent-reason"))
  case NOT_PERFORMED extends DATA_ABSENT_REASON("not-performed", Some("Not Performed"), Some("http://terminology.hl7.org/CodeSystem/data-absent-reason"))
  case NOT_PERMITTED extends DATA_ABSENT_REASON("not-permitted", Some("Not Permitted"), Some("http://terminology.hl7.org/CodeSystem/data-absent-reason"))
  case POSITIVE_INFINITY extends DATA_ABSENT_REASON("positive-infinity", Some("Positive Infinity (PINF)"), Some("http://terminology.hl7.org/CodeSystem/data-absent-reason"))
  case TEMPORARILY_UNKNOWN extends DATA_ABSENT_REASON("temp-unknown", Some("Temporarily Unknown"), Some("http://terminology.hl7.org/CodeSystem/data-absent-reason"))
  case UNKNOWN extends DATA_ABSENT_REASON("unknown", Some("Unknown"), Some("http://terminology.hl7.org/CodeSystem/data-absent-reason"))
  case UNSUPPORTED extends DATA_ABSENT_REASON("unsupported", Some("Unsupported"), Some("http://terminology.hl7.org/CodeSystem/data-absent-reason"))
}
...
enum DATA_TYPES(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case BACKBONEELEMENT extends DATA_TYPES("BackboneElement", Some("BackboneElement"), Some("http://hl7.org/fhir/data-types"))
  ...
  case CODEABLECONCEPT extends DATA_TYPES("CodeableConcept", Some("CodeableConcept"), Some("http://hl7.org/fhir/data-types"))
  ...
  case DATAREQUIREMENT extends DATA_TYPES("DataRequirement", Some("DataRequirement"), Some("http://hl7.org/fhir/data-types"))
  ...
  case ELEMENTDEFINITION extends DATA_TYPES("ElementDefinition", Some("ElementDefinition"), Some("http://hl7.org/fhir/data-types"))
  ...
  case MARKETINGSTATUS extends DATA_TYPES("MarketingStatus", Some("MarketingStatus"), Some("http://hl7.org/fhir/data-types"))
  ...
  case PARAMETERDEFINITION extends DATA_TYPES("ParameterDefinition", Some("ParameterDefinition"), Some("http://hl7.org/fhir/data-types"))
  ...
  case PRODCHARACTERISTIC extends DATA_TYPES("ProdCharacteristic", Some("ProdCharacteristic"), Some("http://hl7.org/fhir/data-types"))
  case PRODUCTSHELFLIFE extends DATA_TYPES("ProductShelfLife", Some("ProductShelfLife"), Some("http://hl7.org/fhir/data-types"))
  ...
  case RELATEDARTIFACT extends DATA_TYPES("RelatedArtifact", Some("RelatedArtifact"), Some("http://hl7.org/fhir/data-types"))
  ...
  case SIMPLEQUANTITY extends DATA_TYPES("SimpleQuantity", Some("SimpleQuantity"), Some("http://hl7.org/fhir/data-types"))
  case STRING extends DATA_TYPES("string", Some("string"), Some("http://hl7.org/fhir/data-types"))
  case SUBSTANCEAMOUNT extends DATA_TYPES("SubstanceAmount", Some("SubstanceAmount"), Some("http://hl7.org/fhir/data-types"))
  ...
  case TRIGGERDEFINITION extends DATA_TYPES("TriggerDefinition", Some("TriggerDefinition"), Some("http://hl7.org/fhir/data-types"))
...
enum HL7_WORK_GROUP(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case CG extends HL7_WORK_GROUP("cg", Some("Clinical Genomics"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case CQI extends HL7_WORK_GROUP("cqi", Some("Clinical Quality Information"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case DEV extends HL7_WORK_GROUP("dev", Some("Health Care Devices"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case EHR extends HL7_WORK_GROUP("ehr", Some("Electronic Health Records"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case FHIR extends HL7_WORK_GROUP("fhir", Some("FHIR Infrastructure"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case FM extends HL7_WORK_GROUP("fm", Some("Financial Management"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case HSI extends HL7_WORK_GROUP("hsi", Some("Health Standards Integration"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case II extends HL7_WORK_GROUP("ii", Some("Imaging Integration"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case INM extends HL7_WORK_GROUP("inm", Some("Infrastructure And Messaging"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case ITS extends HL7_WORK_GROUP("its", Some("Implementable Technology Specifications"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case MNM extends HL7_WORK_GROUP("mnm", Some("Modeling and Methodology"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case OO extends HL7_WORK_GROUP("oo", Some("Orders and Observations"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case PA extends HL7_WORK_GROUP("pa", Some("Patient Administration"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case PC extends HL7_WORK_GROUP("pc", Some("Patient Care"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case PHER extends HL7_WORK_GROUP("pher", Some("Public Health and Emergency Response"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case PHX extends HL7_WORK_GROUP("phx", Some("Pharmacy"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case SD extends HL7_WORK_GROUP("sd", Some("Structured Documents"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case SEC extends HL7_WORK_GROUP("sec", Some("Security"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case US extends HL7_WORK_GROUP("us", Some("US Realm Taskforce"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case VOCAB extends HL7_WORK_GROUP("vocab", Some("Vocabulary"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
}
...
enum NAME_ASSEMBLY_ORDER(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case NL3 extends NAME_ASSEMBLY_ORDER("NL3", Some("Partner Name followed by Maiden Name"), Some("http://terminology.hl7.org/CodeSystem/name-assembly-order"))
  case NL4 extends NAME_ASSEMBLY_ORDER("NL4", Some("Own Name followed by Partner Name"), Some("http://terminology.hl7.org/CodeSystem/name-assembly-order"))
  case UNK extends NAME_ASSEMBLY_ORDER("UNK", Some("Unknown"), Some("http://terminology.hl7.org/CodeSystem/v3-NullFlavor"))
}
...
enum NAME_PART_QUALIFIER(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case HON extends NAME_PART_QUALIFIER("HON", Some("Honorific"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNamePartQualifierR2"))
  case IN extends NAME_PART_QUALIFIER("IN", Some("Initial"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNamePartQualifierR2"))
  case LS extends NAME_PART_QUALIFIER("LS", Some("Legal status"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNamePartQualifierR2"))
  case MID extends NAME_PART_QUALIFIER("MID", Some("Middle Name"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNamePartQualifierR2"))
  case NB extends NAME_PART_QUALIFIER("NB", Some("Nobility"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNamePartQualifierR2"))
  case PR extends NAME_PART_QUALIFIER("PR", Some("Professional"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNamePartQualifierR2"))
  case SP extends NAME_PART_QUALIFIER("SP", Some("Spouse"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNamePartQualifierR2"))
  case VV extends NAME_PART_QUALIFIER("VV", Some("Voorvoegsel"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNamePartQualifier"))
}
...
enum POSTAL_ADDRESS_USE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case HV extends POSTAL_ADDRESS_USE("HV", Some("vacation home"), Some("http://terminology.hl7.org/CodeSystem/v3-AddressUse"))
  case PHYS extends POSTAL_ADDRESS_USE("PHYS", Some("physical visit address"), Some("http://terminology.hl7.org/CodeSystem/v3-AddressUse"))
  case PST extends POSTAL_ADDRESS_USE("PST", Some("postal address"), Some("http://terminology.hl7.org/CodeSystem/v3-AddressUse"))
  case PUB extends POSTAL_ADDRESS_USE("PUB", Some("public"), Some("http://terminology.hl7.org/CodeSystem/v3-AddressUse"))
}
...
enum PROBABILITY_DISTRIBUTION_TYPE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case LN extends PROBABILITY_DISTRIBUTION_TYPE("LN", Some("log-normal"), Some("http://terminology.hl7.org/CodeSystem/v3-ProbabilityDistributionType"))
  case N extends PROBABILITY_DISTRIBUTION_TYPE("N", Some("normal (Gaussian)"), Some("http://terminology.hl7.org/CodeSystem/v3-ProbabilityDistributionType"))
  case T extends PROBABILITY_DISTRIBUTION_TYPE("T", Some("T"), Some("http://terminology.hl7.org/CodeSystem/v3-ProbabilityDistributionType"))
  case U extends PROBABILITY_DISTRIBUTION_TYPE("U", Some("uniform"), Some("http://terminology.hl7.org/CodeSystem/v3-ProbabilityDistributionType"))
  case X2 extends PROBABILITY_DISTRIBUTION_TYPE("X2", Some("chi square"), Some("http://terminology.hl7.org/CodeSystem/v3-ProbabilityDistributionType"))
}
...
enum QUESTIONNAIRE_USAGE_MODE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case DISPLAY_WHEN_ANSWERED extends QUESTIONNAIRE_USAGE_MODE("display-non-empty", Some("Display when Answered"), Some("http://terminology.hl7.org/CodeSystem/questionnaire-usage-mode"))
}
...
enum RESOURCE_SECURITY_CATEGORY(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case PATIENT extends RESOURCE_SECURITY_CATEGORY("patient", Some("Patient Sensitive"), Some("http://terminology.hl7.org/CodeSystem/resource-security-category"))
}
...
enum SMART_CAPABILITIES(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case CONTEXT_PASSTHROUGH_STYLE extends SMART_CAPABILITIES("context-passthrough-style", Some("Allows \"Smart Style Style\""), Some("http://terminology.hl7.org/CodeSystem/smart-capabilities"))
  case CONTEXT_STANDALONE_ENCOUNTER extends SMART_CAPABILITIES("context-standalone-encounter", Some("Allows \"Encounter Level Launch Context (STANDALONE)\""), Some("http://terminology.hl7.org/CodeSystem/smart-capabilities"))
  case CONTEXT_STANDALONE_PATIENT extends SMART_CAPABILITIES("context-standalone-patient", Some("Allows \"Patient Level Launch Context (STANDALONE)\""), Some("http://terminology.hl7.org/CodeSystem/smart-capabilities"))
  case EHR_LAUNCH_MODE extends SMART_CAPABILITIES("launch-ehr", Some("EHR Launch Mode"), Some("http://terminology.hl7.org/CodeSystem/smart-capabilities"))
  case PUBLIC_CLIENT_PROFILE extends SMART_CAPABILITIES("client-public", Some("Public Client Profile"), Some("http://terminology.hl7.org/CodeSystem/smart-capabilities"))
  case STANDALONE_LAUNCH_MODE extends SMART_CAPABILITIES("launch-standalone", Some("Standalone Launch Mode"), Some("http://terminology.hl7.org/CodeSystem/smart-capabilities"))
  case SUPPORTS_OPENID_CONNECT extends SMART_CAPABILITIES("sso-openid-connect", Some("Supports OpenID Connect"), Some("http://terminology.hl7.org/CodeSystem/smart-capabilities"))
  case SUPPORTS_PATIENT_LEVEL_SCOPES extends SMART_CAPABILITIES("permission-patient", Some("Supports Patient Level Scopes"), Some("http://terminology.hl7.org/CodeSystem/smart-capabilities"))
  case SUPPORTS_REFRESH_TOKEN extends SMART_CAPABILITIES("permission-offline", Some("Supports Refresh Token"), Some("http://terminology.hl7.org/CodeSystem/smart-capabilities"))
  case SUPPORTS_USER_LEVEL_SCOPES extends SMART_CAPABILITIES("permission-user", Some("Supports User Level Scopes"), Some("http://terminology.hl7.org/CodeSystem/smart-capabilities"))
}
...
enum STANDARDS_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case NORMATIVE extends STANDARDS_STATUS("normative", Some("Normative"), Some("http://terminology.hl7.org/CodeSystem/standards-status"))
  case TRIAL_USE extends STANDARDS_STATUS("trial-use", Some("Trial-Use"), Some("http://terminology.hl7.org/CodeSystem/standards-status"))
}
...
enum TEMPLATE_STATUS_CODE(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case REJECTED extends TEMPLATE_STATUS_CODE("rejected", Some("Rejected"), Some("urn:oid:2.16.840.1.113883.3.1937.98.5.8"))
  ...
  case TERMINATED extends TEMPLATE_STATUS_CODE("terminated", Some("Terminated"), Some("urn:oid:2.16.840.1.113883.3.1937.98.5.8"))
}
...
enum V3_ENTITYNAMEUSER2(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case C extends V3_ENTITYNAMEUSER2("C", Some("customary"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNameUseR2"))
  case DN extends V3_ENTITYNAMEUSER2("DN", Some("do not use"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNameUseR2"))
  case I extends V3_ENTITYNAMEUSER2("I", Some("Indigenous/Tribal"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNameUseR2"))
  case IDE extends V3_ENTITYNAMEUSER2("IDE", Some("ideographic"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNameUseR2"))
  case M extends V3_ENTITYNAMEUSER2("M", Some("maiden name"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNameUseR2"))
  case NAMEREPRESENTATIONUSE extends V3_ENTITYNAMEUSER2("NameRepresentationUse", Some("NameRepresentationUse"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNameUseR2"))
  case OLD extends V3_ENTITYNAMEUSER2("OLD", Some("no longer in use"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNameUseR2"))
  case OR extends V3_ENTITYNAMEUSER2("OR", Some("official registry name"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNameUseR2"))
  case P extends V3_ENTITYNAMEUSER2("P", Some("Other/Pseudonym/Alias"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNameUseR2"))
  case PHON extends V3_ENTITYNAMEUSER2("PHON", Some("phonetic"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNameUseR2"))
  case R extends V3_ENTITYNAMEUSER2("R", Some("religious"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNameUseR2"))
  case SRCH extends V3_ENTITYNAMEUSER2("SRCH", Some("search"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNameUseR2"))
  case SYL extends V3_ENTITYNAMEUSER2("SYL", Some("syllabic"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNameUseR2"))
  case T extends V3_ENTITYNAMEUSER2("T", Some("temporary"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNameUseR2"))
}
...
enum V3_NULLFLAVOR(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case NA extends V3_NULLFLAVOR("NA", Some("not applicable"), Some("http://terminology.hl7.org/CodeSystem/v3-NullFlavor"))
  case NASK extends V3_NULLFLAVOR("NASK", Some("not asked"), Some("http://terminology.hl7.org/CodeSystem/v3-NullFlavor"))
  case NAV extends V3_NULLFLAVOR("NAV", Some("temporarily unavailable"), Some("http://terminology.hl7.org/CodeSystem/v3-NullFlavor"))
  case NAVU extends V3_NULLFLAVOR("NAVU", Some("Not available"), Some("http://terminology.hl7.org/CodeSystem/v3-NullFlavor"))
  case NI extends V3_NULLFLAVOR("NI", Some("NoInformation"), Some("http://terminology.hl7.org/CodeSystem/v3-NullFlavor"))
  case NINF extends V3_NULLFLAVOR("NINF", Some("negative infinity"), Some("http://terminology.hl7.org/CodeSystem/v3-NullFlavor"))
  ...
  case PINF extends V3_NULLFLAVOR("PINF", Some("positive infinity"), Some("http://terminology.hl7.org/CodeSystem/v3-NullFlavor"))
  case QS extends V3_NULLFLAVOR("QS", Some("Sufficient Quantity"), Some("http://terminology.hl7.org/CodeSystem/v3-NullFlavor"))
