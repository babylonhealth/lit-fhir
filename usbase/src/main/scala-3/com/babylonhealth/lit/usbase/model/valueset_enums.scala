...
enum CONFORMANCE_EXPECTATION(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case MAY
      extends CONFORMANCE_EXPECTATION("MAY", Some("MAY"), Some("http://terminology.hl7.org/CodeSystem/conformance-expectation"))
  case SHALL
...
enum DATA_ABSENT_REASON(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ASKED_BUT_UNKNOWN
      extends DATA_ABSENT_REASON(
        ...
        Some("http://terminology.hl7.org/CodeSystem/data-absent-reason"))
  case AS_TEXT
      extends DATA_ABSENT_REASON("as-text", Some("As Text"), Some("http://terminology.hl7.org/CodeSystem/data-absent-reason"))
  case ERROR extends DATA_ABSENT_REASON("error", Some("Error"), Some("http://terminology.hl7.org/CodeSystem/data-absent-reason"))
  case MASKED
      extends DATA_ABSENT_REASON("masked", Some("Masked"), Some("http://terminology.hl7.org/CodeSystem/data-absent-reason"))
  ...
  case NOT_APPLICABLE
      extends DATA_ABSENT_REASON(
        ...
        Some("http://terminology.hl7.org/CodeSystem/data-absent-reason"))
  case NOT_ASKED
      extends DATA_ABSENT_REASON("not-asked", Some("Not Asked"), Some("http://terminology.hl7.org/CodeSystem/data-absent-reason"))
  case NOT_A_NUMBER
      extends DATA_ABSENT_REASON(
        "not-a-number",
  ...
  case TEMPORARILY_UNKNOWN
      extends DATA_ABSENT_REASON(
        ...
        Some("http://terminology.hl7.org/CodeSystem/data-absent-reason"))
  case UNKNOWN
      extends DATA_ABSENT_REASON("unknown", Some("Unknown"), Some("http://terminology.hl7.org/CodeSystem/data-absent-reason"))
  case UNSUPPORTED
      extends DATA_ABSENT_REASON(
        "unsupported",
        Some("Unsupported"),
...
enum HL7_WORK_GROUP(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case CQI
      extends HL7_WORK_GROUP(
        ...
        Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case DEV
      extends HL7_WORK_GROUP("dev", Some("Health Care Devices"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case EHR
      extends HL7_WORK_GROUP(
        "ehr",
        ...
        Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case FHIR
      extends HL7_WORK_GROUP("fhir", Some("FHIR Infrastructure"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  ...
  case MNM
      extends HL7_WORK_GROUP(
        ...
        Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case OO
      extends HL7_WORK_GROUP("oo", Some("Orders and Observations"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
  case PA
      extends HL7_WORK_GROUP("pa", Some("Patient Administration"), Some("http://terminology.hl7.org/CodeSystem/hl7-work-group"))
...
enum IMPLANTSTATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case FUNCTIONAL
      extends IMPLANTSTATUS("functional", Some("Functional"), Some("http://terminology.hl7.org/CodeSystem/implantStatus"))
  case NON_FUNCTIONAL
      extends IMPLANTSTATUS("non-functional", Some("Non-Functional"), Some("http://terminology.hl7.org/CodeSystem/implantStatus"))
...
enum NAME_ASSEMBLY_ORDER(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case F
      extends NAME_ASSEMBLY_ORDER("F", Some("Prefix Family Given Suffix"), Some("http://terminology.hl7.org/CodeSystem/v2-0444"))
  case G
      extends NAME_ASSEMBLY_ORDER("G", Some("Prefix Given Family Suffix"), Some("http://terminology.hl7.org/CodeSystem/v2-0444"))
  case NL1 extends NAME_ASSEMBLY_ORDER("NL1", Some("Own Name"), Some("http://terminology.hl7.org/CodeSystem/name-assembly-order"))
  case NL2
      extends NAME_ASSEMBLY_ORDER("NL2", Some("Partner Name"), Some("http://terminology.hl7.org/CodeSystem/name-assembly-order"))
  case NL3
...
enum NAME_PART_QUALIFIER(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case AD
      extends NAME_PART_QUALIFIER(
        ...
        Some("http://terminology.hl7.org/CodeSystem/v3-EntityNamePartQualifierR2"))
  case BR
      extends NAME_PART_QUALIFIER("BR", Some("Birth"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNamePartQualifierR2"))
  case CL
      extends NAME_PART_QUALIFIER(
        "CL",
        Some("Call me"),
...
enum STANDARDS_STATUS(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  case DEPRECATED
      extends STANDARDS_STATUS("deprecated", Some("Deprecated"), Some("http://terminology.hl7.org/CodeSystem/standards-status"))
  case DRAFT extends STANDARDS_STATUS("draft", Some("Draft"), Some("http://terminology.hl7.org/CodeSystem/standards-status"))
  case EXTERNAL
      extends STANDARDS_STATUS("external", Some("External"), Some("http://terminology.hl7.org/CodeSystem/standards-status"))
  case INFORMATIVE
      extends STANDARDS_STATUS("informative", Some("Informative"), Some("http://terminology.hl7.org/CodeSystem/standards-status"))
  case NORMATIVE
      extends STANDARDS_STATUS("normative", Some("Normative"), Some("http://terminology.hl7.org/CodeSystem/standards-status"))
  case TRIAL_USE
      extends STANDARDS_STATUS("trial-use", Some("Trial-Use"), Some("http://terminology.hl7.org/CodeSystem/standards-status"))
}
...
enum V3_ENTITYNAMEUSER2(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case ANON
      extends V3_ENTITYNAMEUSER2("ANON", Some("Anonymous"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNameUseR2"))
  case ASSUMED
      extends V3_ENTITYNAMEUSER2("Assumed", Some("Assumed"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNameUseR2"))
  ...
  case I
      extends V3_ENTITYNAMEUSER2("I", Some("Indigenous/Tribal"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNameUseR2"))
  case IDE
      extends V3_ENTITYNAMEUSER2("IDE", Some("ideographic"), Some("http://terminology.hl7.org/CodeSystem/v3-EntityNameUseR2"))
...
enum V3_NULLFLAVOR(val name: String, val display: Option[String], val system: Option[String]) extends ToCodingAble {
  ...
  case NAV
      extends V3_NULLFLAVOR("NAV", Some("temporarily unavailable"), Some("http://terminology.hl7.org/CodeSystem/v3-NullFlavor"))
