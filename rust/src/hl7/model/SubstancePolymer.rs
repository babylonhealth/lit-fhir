...
pub trait SubstancePolymer : DomainResource {
  ...
  fn monomerSet(&self) -> &Vector<SubstancePolymer_MonomerSet>;
  fn repeat(&self) -> &Vector<SubstancePolymer_Repeat>;
}
...
impl SubstancePolymer for SubstancePolymerRaw {
  ...
  fn monomerSet(&self) -> &Vector<SubstancePolymer_MonomerSet> { &self.monomerSet }
  fn repeat(&self) -> &Vector<SubstancePolymer_Repeat> { &self.repeat }
}
