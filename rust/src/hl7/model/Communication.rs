...
impl Communication for CommunicationRaw {
  fn sent(&self) -> &Option<DateTime<FixedOffset>> { &self.sent }
  fn note(&self) -> &Vector<Box<dyn Annotation>> { &self.note }
  fn topic(&self) -> &Option<Box<dyn CodeableConcept>> { &self.topic }
  ...
  fn received(&self) -> &Option<DateTime<FixedOffset>> { &self.received }
