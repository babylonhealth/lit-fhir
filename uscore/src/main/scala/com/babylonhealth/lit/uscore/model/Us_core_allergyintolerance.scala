...
object Us_core_allergyintolerance extends CompanionFor[Us_core_allergyintolerance] {
  ...
  val onset: FHIRComponentFieldMeta[Option[Us_core_allergyintolerance.OnsetChoice]] =
    FHIRComponentFieldMeta("onset", lTagOf[Option[Us_core_allergyintolerance.OnsetChoice]], true, lTagOf[Union01474038381])
...
/** Defines constraints and extensions on the AllergyIntolerance resource for the minimal set of data to query and retrieve
  * allergy information.
  *
