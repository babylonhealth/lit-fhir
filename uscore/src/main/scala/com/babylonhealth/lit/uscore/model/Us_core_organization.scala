...
object Us_core_organization extends CompanionFor[Us_core_organization] {
  implicit def summonObjectAndCompanionUs_core_organization_59307459(
      o: Us_core_organization): ObjectAndCompanion[Us_core_organization, Us_core_organization.type] =
...
/** Defines basic constraints and extensions on the Organization resource for use with other US Core resources
  ...
  *              Requires the following fields which were optional in the parent: name, active.
  ...
  * @param identifier - Identifier for the organization that is used to identify the organization across multiple disparate systems.
