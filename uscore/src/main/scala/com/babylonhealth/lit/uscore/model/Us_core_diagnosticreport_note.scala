...
object Us_core_diagnosticreport_note extends CompanionFor[Us_core_diagnosticreport_note] {
  implicit def summonObjectAndCompanionUs_core_diagnosticreport_note1192811283(
      o: Us_core_diagnosticreport_note): ObjectAndCompanion[Us_core_diagnosticreport_note, Us_core_diagnosticreport_note.type] =
  ...
  def apply(
      ...
      meta: Option[Meta] = Some(
        new Meta(profile = LitSeq("http://hl7.org/fhir/us/core/StructureDefinition/us-core-diagnosticreport-note"))),
  ...
  ): Us_core_diagnosticreport_note = new Us_core_diagnosticreport_note(
    id,
    meta,
    text,
    code,
  ...
  override def fields(t: Us_core_diagnosticreport_note): Seq[FHIRComponentField[_]]      = fieldsFromParent(t).get
  def extractId(t: Us_core_diagnosticreport_note): Option[String]                        = t.id
  def extractMeta(t: Us_core_diagnosticreport_note): Option[Meta]                        = t.meta
  def extractText(t: Us_core_diagnosticreport_note): Option[Narrative]                   = t.text
  def extractCode(t: Us_core_diagnosticreport_note): CodeableConcept                     = t.code
  def extractStatus(t: Us_core_diagnosticreport_note): DIAGNOSTIC_REPORT_STATUS          = t.status
  def extractIssued(t: Us_core_diagnosticreport_note): Option[ZonedDateTime]             = t.issued
  def extractResult(t: Us_core_diagnosticreport_note): LitSeq[Reference]                 = t.result
  def extractBasedOn(t: Us_core_diagnosticreport_note): LitSeq[Reference]                = t.basedOn
  def extractSubject(t: Us_core_diagnosticreport_note): Reference                        = t.subject.get
  def extractLanguage(t: Us_core_diagnosticreport_note): Option[LANGUAGES]               = t.language
  def extractCategory(t: Us_core_diagnosticreport_note): NonEmptyLitSeq[CodeableConcept] = t.category.asNonEmpty
  def extractSpecimen(t: Us_core_diagnosticreport_note): LitSeq[Reference]               = t.specimen
  def extractContained(t: Us_core_diagnosticreport_note): LitSeq[Resource]               = t.contained
  def extractExtension(t: Us_core_diagnosticreport_note): LitSeq[Extension]              = t.extension
  ...
  def extractEffective(t: Us_core_diagnosticreport_note): Us_core_diagnosticreport_note.EffectiveChoice =
    t.effective.get
  ...
  def extractPresentedForm(t: Us_core_diagnosticreport_note): LitSeq[Attachment]       = t.presentedForm
  def extractConclusionCode(t: Us_core_diagnosticreport_note): LitSeq[CodeableConcept] = t.conclusionCode
  def extractModifierExtension(t: Us_core_diagnosticreport_note): LitSeq[Extension]    = t.modifierExtension
  def extractResultsInterpreter(t: Us_core_diagnosticreport_note): LitSeq[Reference]   = t.resultsInterpreter
  def extractMedia(t: Us_core_diagnosticreport_note): LitSeq[DiagnosticReport.Media]   = t.media
  override val thisName: String                                                        = "Us_core_diagnosticreport_note"
  override val searchParams: Map[String, Us_core_diagnosticreport_note => Seq[Any]]    = DiagnosticReport.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Us_core_diagnosticreport_note] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Us_core_diagnosticreport_note(
...
/** Defines constraints and extensions on the DiagnosticReport resource for the minimal set of data to query and
  * retrieve diagnostic reports associated with clinical notes for a patient
  *
  ...
  *
  * @constructor
  *   Inherits all params from parent. Requires the following fields which were optional in the parent: subject,
  *   category, effective.
  * @param id
  ...
  */
@POJOBoilerplate
class Us_core_diagnosticreport_note(
