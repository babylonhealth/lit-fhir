...
/** Defines constraints and extensions on the Condition resource for the minimal set of data to query and retrieve
  * problems and health concerns information.
  *
  * Subclass of [[hl7.model.Condition]] (A clinical condition, problem, diagnosis, or other event, situation, issue, or
  ...
  * @param note
  *   - Additional information about the Condition. This is a general notes/comments entry for description of the
  ...
  * @param encounter
  *   - The Encounter during which this Condition was created or to which the creation of this record is tightly
  *   associated.
  * @param identifier
