...
object Us_core_ethnicity extends CompanionFor[Us_core_ethnicity] {
  ...
  ): Us_core_ethnicity = new Us_core_ethnicity(
    id,
    url,
    extension,
  ...
  override def fields(t: Us_core_ethnicity): Seq[FHIRComponentField[_]] = Seq(
  ...
  def extractUrl(t: Us_core_ethnicity): String                          = t.url
  ...
  def unapply(o: Us_core_ethnicity): Option[(Option[String], String, NonEmptyLitSeq[Extension])] = Some(
