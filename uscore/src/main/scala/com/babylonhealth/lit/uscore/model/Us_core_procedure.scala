...
/** Defines constraints and extensions on the Procedure resource for the minimal set of data to query and retrieve
  ...
  *
  * @constructor
  *   Inherits all params from parent. Refines the types of: performed. Requires the following fields which were
  *   optional in the parent: code, performed.
  * @param id
