...
object Pediatric_weight_for_height extends CompanionFor[Pediatric_weight_for_height] {
  ...
  val effective: FHIRComponentFieldMeta[Pediatric_weight_for_height.EffectiveChoice] =
    FHIRComponentFieldMeta(
      "effective",
      lTagOf[Pediatric_weight_for_height.EffectiveChoice],
      true,
  ...
  def extractEffective(t: Pediatric_weight_for_height): Pediatric_weight_for_height.EffectiveChoice =
    t.effective.get.toSubRef
...
/** Defines constraints and extensions on the Observation resource for use in querying and retrieving pediatric
  * Weight-for-length per age and gender observations.
  *
