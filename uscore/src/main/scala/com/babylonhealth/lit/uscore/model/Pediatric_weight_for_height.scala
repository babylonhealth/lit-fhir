...
object Pediatric_weight_for_height extends CompanionFor[Pediatric_weight_for_height] {
  ...
  def extractValue(t: Pediatric_weight_for_height): Quantity                           = t.value.get.value.asInstanceOf[Quantity]
...
/** Defines constraints and extensions on the Observation resource for use in querying and retrieving pediatric Weight-for-length per age and gender observations.
  *
