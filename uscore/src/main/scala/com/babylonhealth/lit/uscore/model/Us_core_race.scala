...
object Us_core_race extends CompanionFor[Us_core_race] {
  ...
  def unapply(o: Us_core_race): Option[(Option[String], NonEmptyLitSeq[Extension])] = Some(
...
/** Concepts classifying the person into a named category of humans sharing common history, traits, geographical origin
  * or nationality. The race codes used to represent these concepts are based upon the [CDC Race and Ethnicity Code Set
