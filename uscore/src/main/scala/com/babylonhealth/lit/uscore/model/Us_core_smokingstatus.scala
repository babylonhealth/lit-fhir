...
object Us_core_smokingstatus extends CompanionFor[Us_core_smokingstatus] {
  ...
  val effective: FHIRComponentFieldMeta[Option[Us_core_smokingstatus.EffectiveChoice]] =
    FHIRComponentFieldMeta("effective", lTagOf[Option[Us_core_smokingstatus.EffectiveChoice]], true, lTagOf[Union01473702374])
...
/** Defines constraints and extensions on the Observation resource for the minimal set of data to query and retrieve patient's
