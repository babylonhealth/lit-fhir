...
object Us_core_encounter extends CompanionFor[Us_core_encounter] {
  implicit def summonObjectAndCompanionUs_core_encounter1833309696(
  ...
  def apply(
      ...
      meta: Option[Meta] = Some(new Meta(profile = LitSeq("http://hl7.org/fhir/us/core/StructureDefinition/us-core-encounter"))),
...
/** The Encounter referenced in the US Core profiles.
  ...
  *     patient and not require re-processing and not get lost or cancelled during a kind of discharge from emergency to
  *     inpatient.
  * @param statusHistory
