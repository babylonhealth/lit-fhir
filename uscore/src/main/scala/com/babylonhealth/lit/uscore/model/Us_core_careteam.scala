...
object Us_core_careteam extends CompanionFor[Us_core_careteam] {
  implicit def summonObjectAndCompanionUs_core_careteam1804718721(
  ...
  val participant: FHIRComponentFieldMeta[NonEmptyLitSeq[CareTeam.Participant]] =
    FHIRComponentFieldMeta("participant", lTagOf[NonEmptyLitSeq[CareTeam.Participant]], false, lTagOf[CareTeam.Participant])
...
/** Defines constraints and extensions on the CareTeam resource for the minimal set of data to query and retrieve a patient's Care
  * Team.
  *
