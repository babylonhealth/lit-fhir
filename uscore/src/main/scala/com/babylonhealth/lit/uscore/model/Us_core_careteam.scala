...
object Us_core_careteam extends CompanionFor[Us_core_careteam] {
  implicit def summonObjectAndCompanionUs_core_careteam1215165486(
      o: Us_core_careteam): ObjectAndCompanion[Us_core_careteam, Us_core_careteam.type] = ObjectAndCompanion(o, this)
  ...
  override val profileUrl: Option[String] = Some("http://hl7.org/fhir/us/core/StructureDefinition/us-core-careteam")
  def apply(
  ...
  override def fields(t: Us_core_careteam): Seq[FHIRComponentField[_]]              = fieldsFromParent(t).get
...
/** Defines constraints and extensions on the CareTeam resource for the minimal set of data to query and retrieve a
  * patient's Care Team.
  *
  * Subclass of [[hl7.model.CareTeam]] (The Care Team includes all the people and organizations who plan to participate
  ...
  * @param category
  *   - Identifies what kind of team. This is to support differentiation between multiple co-existing teams, such as
  *   care plan team, episode of care team, longitudinal care team.
  * @param contained
  ...
  * @param encounter
  *   - The Encounter during which this CareTeam was created or to which the creation of this record is tightly
  *   associated.
  * @param identifier
