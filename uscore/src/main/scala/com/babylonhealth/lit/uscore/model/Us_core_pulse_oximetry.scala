...
object Us_core_pulse_oximetry extends CompanionFor[Us_core_pulse_oximetry] {
  implicit def summonObjectAndCompanionUs_core_pulse_oximetry1049849994(
  ...
  def apply(
      ...
      meta: Option[Meta] = Some(
        new Meta(profile = LitSeq("http://hl7.org/fhir/us/core/StructureDefinition/us-core-pulse-oximetry"))),
      ...
      effective: Us_core_pulse_oximetry.EffectiveChoice,
  ...
  ): Us_core_pulse_oximetry = new Us_core_pulse_oximetry(
    id,
    meta,
    text,
    note,
  ...
  val effective: FHIRComponentFieldMeta[Us_core_pulse_oximetry.EffectiveChoice] =
    FHIRComponentFieldMeta("effective", lTagOf[Us_core_pulse_oximetry.EffectiveChoice], true, lTagOf[UnionDateTimeOrPeriod])
  ...
  override def fieldsFromParent(t: ResourceType): Try[Seq[FHIRComponentField[_]]] = Try(
    Seq(
      ...
      FHIRComponentField[Us_core_pulse_oximetry.EffectiveChoice](effective, t.effective.get.toSubRef),
  ...
  override def fields(t: Us_core_pulse_oximetry): Seq[FHIRComponentField[_]]      = fieldsFromParent(t).get
  def extractId(t: Us_core_pulse_oximetry): Option[String]                        = t.id
  def extractMeta(t: Us_core_pulse_oximetry): Option[Meta]                        = t.meta
  def extractText(t: Us_core_pulse_oximetry): Option[Narrative]                   = t.text
  def extractNote(t: Us_core_pulse_oximetry): LitSeq[Annotation]                  = t.note
  def extractFocus(t: Us_core_pulse_oximetry): LitSeq[Reference]                  = t.focus
  def extractPartOf(t: Us_core_pulse_oximetry): LitSeq[Reference]                 = t.partOf
  def extractStatus(t: Us_core_pulse_oximetry): OBSERVATION_STATUS                = t.status
  def extractIssued(t: Us_core_pulse_oximetry): Option[ZonedDateTime]             = t.issued
  def extractMethod(t: Us_core_pulse_oximetry): Option[CodeableConcept]           = t.method
  def extractDevice(t: Us_core_pulse_oximetry): Option[Reference]                 = t.device
  def extractBasedOn(t: Us_core_pulse_oximetry): LitSeq[Reference]                = t.basedOn
  ...
  def extractExtension(t: Us_core_pulse_oximetry): LitSeq[Extension]              = t.extension
  def extractEncounter(t: Us_core_pulse_oximetry): Option[Reference]              = t.encounter
  def extractPerformer(t: Us_core_pulse_oximetry): LitSeq[Reference]              = t.performer
  def extractHasMember(t: Us_core_pulse_oximetry): LitSeq[Reference]              = t.hasMember
  def extractIdentifier(t: Us_core_pulse_oximetry): LitSeq[Identifier]            = t.identifier
  def extractDerivedFrom(t: Us_core_pulse_oximetry): LitSeq[Reference]            = t.derivedFrom
  def extractEffective(t: Us_core_pulse_oximetry): Us_core_pulse_oximetry.EffectiveChoice  = t.effective.get.toSubRef
  def extractImplicitRules(t: Us_core_pulse_oximetry): Option[UriStr]                      = t.implicitRules
  def extractCode(t: Us_core_pulse_oximetry): CodeableConcept                              = t.code
  def extractInterpretation(t: Us_core_pulse_oximetry): LitSeq[CodeableConcept]            = t.interpretation
  def extractDataAbsentReason(t: Us_core_pulse_oximetry): Option[CodeableConcept]          = t.dataAbsentReason
  def extractModifierExtension(t: Us_core_pulse_oximetry): LitSeq[Extension]               = t.modifierExtension
  def extractComponent(t: Us_core_pulse_oximetry): LitSeq[Observation.Component]           = t.component
  def extractReferenceRange(t: Us_core_pulse_oximetry): LitSeq[Observation.ReferenceRange] = t.referenceRange
  override val thisName: String                                                            = "Us_core_pulse_oximetry"
  override val searchParams: Map[String, Us_core_pulse_oximetry => Seq[Any]]               = Oxygensat.searchParams
  def decodeThis(cursor: HCursor)(implicit params: DecoderParams): Try[Us_core_pulse_oximetry] =
    checkUnknownFields(cursor, otherMetas, refMetas) flatMap (_ =>
      Try(
        new Us_core_pulse_oximetry(
...
/** Defines constraints and extensions on the Observation resource for use in querying and retrieving inspired O2 by pulse
  * oximetry observations.
  *
  * Subclass of [[usbase.model.Oxygensat]] (FHIR Oxygen Saturation Profile)
  *
  * @constructor
