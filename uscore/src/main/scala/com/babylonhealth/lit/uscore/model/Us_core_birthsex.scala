...
object Us_core_birthsex extends CompanionFor[Us_core_birthsex] {
  implicit def summonObjectAndCompanionUs_core_birthsex1214070886(
...
/** A code classifying the person's sex assigned at birth as specified by the [Office of the National Coordinator for
  * Health IT (ONC)](https://www.healthit.gov/newsroom/about-onc). This extension aligns with the C-CDA Birth Sex
  * Observation (LOINC 76689-9).
  *
