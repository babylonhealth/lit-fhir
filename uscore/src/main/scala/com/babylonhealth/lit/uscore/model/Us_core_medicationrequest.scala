...
object Us_core_medicationrequest extends CompanionFor[Us_core_medicationrequest] {
  ...
  def extractDispenseRequest(t: Us_core_medicationrequest): Option[MedicationRequest.DispenseRequest] =
    t.dispenseRequest
...
/** Defines constraints and extensions on the MedicationRequest resource for the minimal set of data to query and retrieve prescription information.
  ...
  *              Requires the following fields which were optional in the parent: requester, authoredOn.
