...
/** Defines constraints and extensions on the patient resource for the minimal set of data to query and retrieve patient demographic information.
  ...
  *              Requires the following fields which were optional in the parent: gender, name, identifier.
  ...
  * @param multipleBirth - Indicates whether the patient is part of a multiple (boolean) or indicates the actual birth order (integer).
