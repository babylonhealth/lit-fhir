...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DiagnosticReport">
      <sch:assert test="true()">A resource referenced in a Composition entry must also be included in the DiagnosticReport result (Observation resources or nested resources via Observation.hasMember) (inherited)</sch:assert>
  ...
  <sch:pattern>
    <sch:title>DiagnosticReport.composition</sch:title>
